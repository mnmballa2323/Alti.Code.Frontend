...
class SecretRotationManager {
    ...
    createSecret(options) {
        ...
        const secretId = `secret_${Date.now()}_${crypto.randomBytes(4).toString('hex')}`;

        // Encrypt the secret value with envelope encryption
        const encryptedValue = this._encrypt(value || crypto.randomBytes(32).toString('hex'));
    ...
    rotateSecret(secretId, options = {}) {
        ...
        // Update secret
        secret.encryptedValue = this._encrypt(newValue);
