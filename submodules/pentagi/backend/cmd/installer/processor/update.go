...
func (u *updateOperationsImpl) buildUpdateCheckRequest() checker.CheckUpdatesRequest {
	...
	return checker.CheckUpdatesRequest{
		...
		NoopTraceConnected:      u.processor.checker.NoopTraceConnected,
		NoopTraceExternal:       u.processor.checker.NoopTraceExternal,
		NoopTraceInstalled:      u.processor.checker.NoopTraceInstalled,
