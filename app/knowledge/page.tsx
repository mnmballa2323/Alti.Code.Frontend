...
export default function KnowledgePage() {
  ...
  const agentId = activeProject?.id ?? null;
        ...
        <div className="flex-1 overflow-y-auto p-8 font-sans scrollbar-hide flex flex-col items-center justify-center">
          <div className="w-full max-w-2xl mb-14">
            ...
            >
              ...
              <Button
                isIconOnly
                className="absolute right-2 rounded-xl h-10 w-10 bg-primary text-primary-foreground flex items-center justify-center transition-all shrink-0 cursor-pointer min-w-0 px-0"
