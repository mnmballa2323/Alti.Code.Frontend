...
export default function BalancePage() {
  const currentBalance = 4250.0;
  const [isAutoRechargeEnabled, setIsAutoRechargeEnabled] =
    React.useState(true);
  const [isAutoRechargeOpen, setIsAutoRechargeOpen] = React.useState(false);
  const [modalAutoRechargeEnabled, setModalAutoRechargeEnabled] =
    React.useState(true);
  const [autoRechargeThreshold, setAutoRechargeThreshold] =
    React.useState<string>("");
  const [autoRechargeAmount, setAutoRechargeAmount] =
    React.useState<string>("");
  ...
  const [isCustomAmountFocused, setIsCustomAmountFocused] =
            ...
            <div className="mb-8">
              <div className="relative">
                {(isCustomAmountFocused || customAmount) && (
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-black dark:text-white font-bold text-lg">
                    $
                  </span>
                )}
                <input
                  ...
                  placeholder={
                    isCustomAmountFocused ? "" : "Enter Custom Amount"
                  }
                  type="text"
                  value={
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-3xl p-8 max-w-md w-full shadow-2xl border border-neutral-200 dark:border-neutral-800 animate-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between mb-8 p-4 rounded-xl bg-neutral-100 dark:bg-neutral-800 border border-transparent">
              ...
              <button
                ...
                onClick={() =>
                  setModalAutoRechargeEnabled(!modalAutoRechargeEnabled)
                }
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white dark:bg-black transition-transform ${modalAutoRechargeEnabled ? "translate-x-6" : "translate-x-1"}`}
                />
              </button>
            </div>

            <div
              className={`transition-opacity duration-300 ${modalAutoRechargeEnabled ? "opacity-100" : "opacity-40 pointer-events-none"}`}
            >
              <div className="mb-6">
                <div className="relative">
                  ...
                  <input
                    ...
                    value={
                      autoRechargeThreshold
                        ? Number(autoRechargeThreshold).toLocaleString()
                        : ""
                    }
              ...
              <div className="mb-8">
                <div className="relative">
                  ...
                  <input
                    ...
                    value={
                      autoRechargeAmount
                        ? Number(autoRechargeAmount).toLocaleString()
                        : ""
                    }
