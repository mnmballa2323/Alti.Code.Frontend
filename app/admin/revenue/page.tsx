      ...
      <div className="w-full flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-3">
          {mockTransactions.map((txn) => (
            <div
              key={txn.id}
              className="grid grid-cols-12 gap-4 px-6 py-4 bg-white dark:bg-[#161b22] border border-neutral-200 dark:border-neutral-800 rounded-2xl items-center hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors shadow-sm"
            >
              <div className="col-span-2 font-medium text-sm text-neutral-900 dark:text-white">
                {txn.id}
              </div>
              ...
              <div className="col-span-2 pl-8 text-sm text-neutral-600 dark:text-neutral-300">
                {txn.amount}
              </div>
