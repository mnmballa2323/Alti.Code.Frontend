...
type Provider = "Claude" | "Gemini" | "Grok" | "Llama" | "Mistral";
    ...
    <div className="flex-1 bg-[#F4F4F6] dark:bg-background min-h-screen overflow-y-auto">
      <div className="p-8 max-w-6xl mx-auto space-y-6">
        <div className="flex justify-center mb-8">
          <div className="flex p-1 space-x-1 bg-default-200/50 dark:bg-default-50/10 rounded-xl shadow-inner overflow-x-auto max-w-full">
            {(
              ["Gemini", "Claude", "Grok", "Llama", "Mistral"] as Provider[]
            ).map((prov) => (
              <button
                key={prov}
                className={`flex-1 flex items-center justify-center gap-2 py-2 px-4 rounded-lg text-sm font-semibold transition-all whitespace-nowrap ${
