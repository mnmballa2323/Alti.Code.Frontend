    ...
    <ChatBotLayout>
      <div className="flex flex-col h-full bg-default-100 dark:bg-default-50 w-full font-sans">
        ...
        <div className="flex-1 overflow-y-auto p-8 font-sans scrollbar-hide flex flex-col items-center justify-center">
          <div className="flex w-full flex-col items-center gap-5 z-20 px-6 max-w-2xl">
            {!selectedSecretId && (
              <div className="relative z-30 pointer-events-auto flex items-center gap-1 bg-white dark:bg-black border border-default-200 dark:border-default-100 p-1 rounded-lg shadow-sm">
                {VAULT_TABS.map((tab) => (
                  <button
                    key={tab.id}
