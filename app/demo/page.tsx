        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-5xl mx-auto gap-8 w-full">
          <div className="flex flex-col items-center gap-2 relative top-2 md:top-4 w-full">
            ...
            <div className="max-w-5xl flex flex-col items-center gap-10 text-zinc-400 text-lg font-normal leading-relaxed mt-2 px-4 text-center">
              <p>
                Inso code is deployed exclusively for enterprise engineering
                teams. Schedule a technical
                <br className="hidden md:block" /> deep dive with our solutions
                architects to evaluate our sovereign swarm infrastructure.
              </p>
              ...
              <button
                ...
                onClick={() => {
                  // TODO: Wire up Cal.com or Calendly modal trigger here
                  console.log("Trigger calendar modal");
                }}
              >
                select a time
              </button>
