...
async function runTest() {
    ...
    // 3. Execution Isolation Test
    console.log('\n🏃 Test 3: Executing secure sandbox code block inside user Docker container...');
    const code = `
        const x = 50;
        const y = 150;
    ...
    // 4. Zero-Trust Path Traversal Scope Guardrail Test
    console.log('\n🏃 Test 4: Testing path traversal guardrail block...');
    try {
    ...
    // 5. Secure Teardown and Resource Pruning
    console.log('\n🏃 Test 5: Stopping and tearing down user Docker environment...');
