...
router.post('/:id/design', (req, res) =>
  specKitController.createDesign(req, res),
);
router.post('/:id/tasks', (req, res) =>
  specKitController.createTasks(req, res),
);
router.post('/:id/tasks/:idx/execute', (req, res) =>
  specKitController.executeTask(req, res),
);

// Bugfix specs
router.post('/bugfix/create', (req, res) =>
  specKitController.createBugfixSpec(req, res),
);
