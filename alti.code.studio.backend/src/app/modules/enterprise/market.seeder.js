...
class MarketSeeder {
  ...
  async seed() {
    ...
    for (const entry of CAPABILITY_TABLE) {
      try {
        ...
        const agentName =
          entry.agent.name || entry.agent.constructor.name || 'UnknownAgent';
  ...
  _inferCategory(cap, agent) {
    ...
    if (str.includes('secur') || str.includes('auth') || str.includes('cve'))
      return 'security';
    if (str.includes('test') || str.includes('qa') || str.includes('assert'))
      return 'testing';
    if (
      str.includes('deploy') ||
      str.includes('cloud') ||
    ...
    if (
      ...
      str.includes('sql') ||
      str.includes('etl') ||
      str.includes('snowflake')
    )
      return 'data-analysis';
    if (
      str.includes('compliant') ||
      str.includes('audit') ||
      str.includes('legal') ||
      str.includes('gdpr')
    )
    ...
    if (
      ...
      str.includes('log') ||
      str.includes('datadog') ||
      str.includes('splunk')
    )
      return 'monitoring';
    if (str.includes('doc') || str.includes('wiki') || str.includes('readme'))
