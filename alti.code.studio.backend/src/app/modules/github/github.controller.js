...
export const markNotificationsAsRead = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error marking notifications as read:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const listRepoNotifications = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error listing repo notifications:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const markRepoNotificationsAsRead = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error marking repo notifications as read:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const getThread = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error getting notification thread:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const getThreadSubscription = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error getting thread subscription:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const setThreadSubscription = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error setting thread subscription:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const deleteThreadSubscription = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error deleting thread subscription:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const addGpgKeyForAuthenticatedUser = async (req, res) => {
  try {
    ...
    const result =
      await GithubService.addGpgKeyForAuthenticatedUser(armoredPublicKey);
    res.status(httpStatus.CREATED).json({ success: true, data: result });
  } catch (error) {
...
export const addSocialAccountsForAuthenticatedUser = async (req, res) => {
  try {
    ...
    const result =
      await GithubService.addSocialAccountsForAuthenticatedUser(accountUrls);
    res.status(httpStatus.CREATED).json({ success: true, data: result });
  } catch (error) {
...
export const deleteSocialAccountsForAuthenticatedUser = async (req, res) => {
  try {
    const { accountUrls } = req.body;
    const result =
      await GithubService.deleteSocialAccountsForAuthenticatedUser(accountUrls);
    res.status(httpStatus.OK).json({ success: true, data: result });
  } catch (error) {
...
export const listFollowingForUser = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error listing followed users for target user:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const listPendingOrgInvitations = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error listing pending invitations:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const createOrgInvitation = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error creating organization invitation:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const cancelOrgInvitation = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error canceling organization invitation:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const updateRepository = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error updating repository settings:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const getRequiredStatusChecks = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error getting required status checks:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const updateRequiredStatusChecks = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error updating required status checks:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const deleteRequiredStatusChecks = async (req, res) => {
  try {
    const { owner, repo, branch } = req.params;
    const result = await GithubService.deleteRequiredStatusChecks(
      owner,
      repo,
      branch,
    );
    ...
    logger.error(
      `[GitHub Controller] Error deleting required status checks:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const listRequiredStatusChecksContexts = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error listing status checks contexts:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const addRequiredStatusChecksContexts = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error adding status checks contexts:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const setRequiredStatusChecksContexts = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error setting status checks contexts:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const removeRequiredStatusChecksContexts = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error removing status checks contexts:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const getPullRequestReviewBypassRestrictions = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error getting PR review bypass restrictions:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const addPullRequestReviewBypassRestrictions = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error adding PR review bypass restrictions:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const setPullRequestReviewBypassRestrictions = async (req, res) => {
  try {
    const { owner, repo, branch } = req.params;
    const { users, teams, apps } = req.body;
    const result = await GithubService.setPullRequestReviewBypassRestrictions(
      owner,
      repo,
      branch,
      users,
    ...
    logger.error(
      `[GitHub Controller] Error setting PR review bypass restrictions:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const removePullRequestReviewBypassRestrictions = async (req, res) => {
  try {
    ...
    const { users, teams, apps } = req.body;
    const result =
      await GithubService.removePullRequestReviewBypassRestrictions(
        owner,
        repo,
        branch,
        users,
    ...
    logger.error(
      `[GitHub Controller] Error removing PR review bypass restrictions:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const addOrUpdateTeamMembershipForUser = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error adding/updating team membership:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const checkTeamPermissionsForRepo = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error checking team permissions for repository:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const addOrUpdateTeamRepoPermissions = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error adding/updating team repository permissions:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const removeTeamRepo = async (req, res) => {
  try {
    ...
    logger.error(
      `[GitHub Controller] Error removing team repository access:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const deleteAppInstallation = async (req, res) => {
  try {
    const { installationId } = req.params;
    const result = await GithubService.deleteAppInstallation(
...
export const suspendAppInstallation = async (req, res) => {
  try {
    const { installationId } = req.params;
    const result = await GithubService.suspendAppInstallation(
      parseInt(installationId),
    );
    res.status(httpStatus.OK).json({ success: true, data: result });
  } catch (error) {
    logger.error(
      `[GitHub Controller] Error suspending app installation:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
...
export const unsuspendAppInstallation = async (req, res) => {
  try {
    const { installationId } = req.params;
    const result = await GithubService.unsuspendAppInstallation(
      parseInt(installationId),
    );
    res.status(httpStatus.OK).json({ success: true, data: result });
  } catch (error) {
    logger.error(
      `[GitHub Controller] Error unsuspending app installation:`,
      error,
    );
    res
      .status(httpStatus.INTERNAL_SERVER_ERROR)
