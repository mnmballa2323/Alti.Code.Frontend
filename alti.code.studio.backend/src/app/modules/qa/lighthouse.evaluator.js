...
class LighthouseEvaluator {
  ...
  async evaluate(url) {
    logger.info(
      `🚦 [Lighthouse] Swarm initiating mathematical audit of frontend output at ${url}...`,
    );
    ...
    try {
      ...
      logger.info(
        `✅ [Lighthouse] Audit complete. Scores: PERF: ${report.performance}, A11Y: ${report.accessibility}, SEO: ${report.seo}`,
      );
