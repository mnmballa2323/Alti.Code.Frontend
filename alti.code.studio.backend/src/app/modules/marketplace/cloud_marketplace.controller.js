...
const resolveGcp = catchAsync(async (req, res) => {
    ...
    if (!token || !userId) {
        return sendResponse(res, {
            ...
            success: false,
            message: 'Both "token" (x-gcp-marketplace-token) and "userId" are required.'
        });
    }
    ...
    sendResponse(res, {
        ...
        success: true,
        message: 'GCP Marketplace subscription resolved and activated successfully.',
        data: result
    });
});
...
const resolveAws = catchAsync(async (req, res) => {
    ...
    if (!token || !userId) {
        return sendResponse(res, {
            statusCode: httpStatus.BAD_REQUEST,
            success: false,
            message: 'Both "token" (x-amzn-marketplace-token) and "userId" are required.'
        });
    }
    ...
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
        message: 'AWS Marketplace subscription resolved and activated successfully.',
        data: result
    });
});
...
const resolveAzure = catchAsync(async (req, res) => {
    ...
    if (!token || !userId) {
        return sendResponse(res, {
            statusCode: httpStatus.BAD_REQUEST,
            success: false,
            message: 'Both "token" (azure-marketplace-token) and "userId" are required.'
        });
    }
    ...
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
        message: 'Azure Marketplace subscription resolved and activated successfully.',
        data: result
    });
});
...
const getEntitlements = catchAsync(async (req, res) => {
    ...
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
        message: 'User cloud marketplace entitlement status retrieved successfully.',
        data: result
    });
});
...
const syncBilling = catchAsync(async (req, res) => {
    ...
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
        message: 'Marketplace metered billing logs successfully synchronized with cloud providers.',
        data: result
    });
});
