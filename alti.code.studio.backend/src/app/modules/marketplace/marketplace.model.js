...
const MarketplacePluginSchema = new mongoose.Schema(
    {
        ...
        category: {
            type: String,
            enum: ['data', 'systems', 'security', 'mobile', 'infrastructure', 'backend', 'frontend', 'other'],
            default: 'other',
        },
        description: {
            type: String,
...
export const MarketplacePlugin = mongoose.model('MarketplacePlugin', MarketplacePluginSchema);
