...
const COMMUNITY_CATALOG = [
    ...
    },
    {
        ...
        description: 'Writes memory-safe, performant bare-metal and embedded Rust code.',
        author: 'RustyBot',
        category: 'systems',
        price: 'Free',
        version: '2.0.1',
    ...
    },
    {
        ...
        description: 'Detects reentrancy attacks, integer overflows, and EVM vulnerabilities.',
        author: 'CryptoSec',
        category: 'security',
        price: '$4.99/mo',
        version: '1.0.4',
    ...
    },
    {
        ...
        description: 'Expert in SwiftUI, Combine, async/await, and UIKit for Apple platforms.',
        author: 'AppleCraft',
        category: 'mobile',
        price: 'Free',
        version: '1.1.0',
    ...
    },
    {
        ...
        description: 'Jetpack Compose, Coroutines, Hilt DI, and Material 3 specialist.',
        author: 'DroidLabs',
        category: 'mobile',
        price: 'Free',
        version: '1.0.2',
    ...
    },
    {
        ...
        description: 'Writes production-grade Terraform for AWS, GCP, and Azure with modules.',
        author: 'InfraWizard',
    ...
    },
    {
        ...
        description: 'Schema-first design, subscriptions, DataLoader batching, and federation.',
        author: 'APIFirst',
        category: 'backend',
        price: 'Free',
        version: '1.0.0',
    ...
    },
    {
        ...
        description: 'Composition API, Pinia, Nuxt 3, and Vite optimisation expert.',
        author: 'VueMasters',
        category: 'frontend',
        price: 'Free',
        version: '2.1.0',
...
class MarketplaceService {
    constructor() {
        this.pluginsDir = path.join(process.cwd(), 'src/app/modules/agents/plugins');
    ...
    async getAgentDetails(agentId) {
        ...
        if (!catalogEntry) throw new Error(`Agent "${agentId}" not found in catalog.`);
    ...
    async installAgent(agentId, requestedVersion) {
        ...
        const catalogEntry = COMMUNITY_CATALOG.find((a) => a.id === agentId);
        if (!catalogEntry) {
            return { success: false, message: `Agent "${agentId}" not found in community catalog.` };
        }

        const registry = await this._readRegistry();
        if (registry[agentId]) {
            return { success: false, message: `Agent "${agentId}" is already installed (v${registry[agentId].version}).` };
        }
...
`;
    ...
    async uninstallAgent(agentId) {
        ...
        if (!registry[agentId]) {
            return { success: false, message: `Agent "${agentId}" is not installed.` };
        }
        ...
        try {
            ...
            logger.warn(`⚠️  Could not remove plugin file for ${agentId}: ${e.message}`);
        }
