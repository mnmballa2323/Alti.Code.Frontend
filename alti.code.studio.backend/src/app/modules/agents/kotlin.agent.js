/**
 * "The Kotlin Master" - Tier 17 Systems Language Specialist
 * Expert in Kotlin 2.0, coroutines, Flow, Arrow, and Android/KMP development.
 */
...
class KotlinAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Language specialist for Kotlin 2.0, coroutines, Flow, KMP (Kotlin Multiplatform), and Android.';
...
When writing code, output pure Kotlin 2.0+. Maintain strict adherence to ktlint formatting guidelines. Prioritize functional paradigms (map, filter, reduce) over imperative looping.`;
  ...
  async consult(prompt, contextData = []) {
    ...
    try {
      ...
      throw new Error(`Kotlin Synthesis Failed: ${e.message}`);
    }
  }
}
export const kotlinAgent = new KotlinAgent();
