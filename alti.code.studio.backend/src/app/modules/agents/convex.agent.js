 ...
 * schema, file storage, scheduled functions, and auth integrations.
 */
...
class ConvexAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Reactive backend specialist for Convex: queries (real-time subscriptions), mutations (ACID transactions), actions (external APIs), schema definition, file storage, scheduled functions, and Clerk/Auth0 auth integration.';
...
export const convexAgent = new ConvexAgent();
