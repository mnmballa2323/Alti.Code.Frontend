 ...
 * DEX volumes, options, protocol comparison, and chain analytics.
 */
...
class DefiLlamaAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'DeFi data specialist for DefiLlama: TVL (protocol + chain), yields (APY ranking), stablecoin supply/peg health, bridge volume tracking, coin price history, DEX volumes, and options data via free REST APIs.';
...
export const defiLlamaAgent = new DefiLlamaAgent();
