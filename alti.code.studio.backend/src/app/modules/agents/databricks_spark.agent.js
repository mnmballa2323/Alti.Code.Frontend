...
export class DatabricksSparkAgent extends BaseSpecialistAgent {
    constructor() {
        super({
            ...
            description: "Databricks Apache Spark ETL pipelines and Delta Lake data engineering expert.",
            capabilities: ["databricks", "spark", "delta_lake", "pyspark", "scala", "etl", "data_engineering"],
            tier: 14,
