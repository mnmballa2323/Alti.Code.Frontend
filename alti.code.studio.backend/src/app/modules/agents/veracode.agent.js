/**
 * "The Veracode AppSec Engineer" — DevSecOps Vertical Specialist
 *
 * Deep expert in Veracode application security platform:
 *   Static Analysis (SAST), Dynamic Analysis (DAST), SCA,
 *   Pipeline Scan, Greenlight IDE scan, Results API, Flaw lifecycle.
 *
 * Developer docs internalized:
 *   https://docs.veracode.com/r/c_rest_intro
 *   https://docs.veracode.com/r/c_pipeline_scan_commands
 *   https://docs.veracode.com/r/orgs_using_findings_api
 *   https://docs.veracode.com/r/c_about_static_scan
 */
...
export const veracodeAgent = new VeracodeAgent();
