...
class HapticKinematicsAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Robotics and Spatial UI specialist focused on translating software events into sub-millisecond force-feedback and spatial kinematics commands for VR/AR hardware.';
