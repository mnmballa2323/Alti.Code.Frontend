/**
 * "The Tailwind Master" - Tier 15 Creative Dev Specialist
 * Expert in Tailwind CSS v4, design systems, component variants, and performance.
 */
...
class TailwindAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Creative specialist for Tailwind CSS v4, custom design tokens, CVA component variants, and animation.';
...
export const tailwindAgent = new TailwindAgent();
