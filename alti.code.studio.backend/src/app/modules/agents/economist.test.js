...
describe('The Economist (Phase 13 Autonomic FinOps Agent)', () => {
  ...
  it('should identify bloated GKE nodes and synthesize a Terraform patch', async () => {
    ...
    const mockReport = {
      ...
      currentAssessment:
        'The GKE node pool is heavily over-provisioned using e2-standard-32 instances despite massive idle capacity.',
      recommendation:
        'Downscale node pool instance class from e2-standard-32 to e2-standard-4.',
  ...
  it('should report optimal architecture if no savings are detected', async () => {
    ...
    const mockReport = {
      ...
      currentAssessment:
        'Cloud Run instances are auto-scaling perfectly and maintaining high utilization.',
