...
class WshobsonAgentsAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'The wshobson/agents Plugin Marketplace Specialist. Compiles portable Markdown-based agents, commands, and progressive skills to 5 distinct harnesses (Claude Code, Codex, Cursor, OpenCode, Gemini, Copilot).';
