 ...
 *
 * "The PlayFab Master" — Tier 16 Game Backend-as-a-Service Specialist
 * Expert in Azure PlayFab: player authentication, CloudScript, player
 * economy, leaderboards, matchmaking, GDK integration, and LiveOps.
 */
...
class PlayFabAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Azure PlayFab game backend specialist: player registration/auth, CloudScript serverless game logic, player economy (virtual currencies, catalog, inventory), leaderboards, matchmaking, GDK Xbox Live integration, analytics, and A/B testing.';
...
export const playFabAgent = new PlayFabAgent();
