...
export class PeoplesoftHcmBridgeAgent extends BaseSpecialistAgent {
    constructor() {
        super({
            ...
            description: "Oracle PeopleSoft HCM integration and cloud migration specialist, working with PeopleCode and Component Interfaces.",
            capabilities: ["peoplesoft", "hcm", "oracle", "peoplecode", "component_interface", "erp_migration"],
            tier: 14,
