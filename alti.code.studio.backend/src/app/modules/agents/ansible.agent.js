 ...
 *
 * "The Ansible Master" - Tier 13 DevEx Specialist
 * Expert in Ansible playbooks, roles, dynamic inventories,
 * vault encryption, and idempotent infrastructure automation.
 */
...
class AnsibleAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'IaC specialist for Ansible playbooks, roles, group_vars, Vault, and dynamic inventories.';
...
export const ansibleAgent = new AnsibleAgent();
