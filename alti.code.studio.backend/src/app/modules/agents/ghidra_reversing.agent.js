/**
 * GhidraReversingAgent — Cybersecurity & Malware Analysis Specialist
 * Translates x86/ARM decompilations, IDA Pro FLAIR, and static binary payloads.
 */
...
class GhidraReversingAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Deep Cybersecurity specialist dealing exclusively in NSA Ghidra scripting, bare-metal x86/ARM disassembly abstractions, and reverse-engineering obfuscated ELF/PE binaries.';
...
export const ghidraReversingAgent = new GhidraReversingAgent();
