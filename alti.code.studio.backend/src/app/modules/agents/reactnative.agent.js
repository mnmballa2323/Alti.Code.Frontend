/**
 * "The React Native Master" - Tier 14 Mobile Specialist
 * Expert in React Native + Expo, native modules, EAS builds, and performance.
 */
...
class ReactnativeAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Mobile specialist for React Native + Expo, native modules, EAS builds, and performance profiling.';
...
export const reactnativeAgent = new ReactnativeAgent();
