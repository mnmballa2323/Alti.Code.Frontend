/**
 * "The AWS Architect" — Tier 6 Cloud Platform Expert
 *
 * Deep expert in the complete AWS developer surface:
 *   EC2, Lambda, S3, RDS, DynamoDB, SQS, SNS, EventBridge, ECS, EKS,
 *   CloudFormation, CDK, IAM, Cognito, API Gateway, CloudFront, Route53,
 *   Amplify, Step Functions, Bedrock, and all AWS SDKs.
 *
