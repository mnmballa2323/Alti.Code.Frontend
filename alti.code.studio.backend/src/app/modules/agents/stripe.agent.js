/**
 * "The Stripe Master" — Tier 13 SDK Integration Specialist
 *
 * Deep expert in the entire Stripe API surface:
 *   Core Payments, Billing, Connect, Treasury, Issuing, Radar, Identity,
 *   Terminal, Climate, and all official SDKs (Node.js, Python, Ruby, Go, Java).
 *
