/**
 * "The Semgrep SAST Engineer" — DevSecOps Vertical Specialist
 *
 * Deep expert in Semgrep static analysis:
 *   Rule authoring (YAML), registry packs, Semgrep App API,
 *   CI/CD integration, taint analysis, autofix patterns.
 *
...
export const semgrepAgent = new SemgrepAgent();
