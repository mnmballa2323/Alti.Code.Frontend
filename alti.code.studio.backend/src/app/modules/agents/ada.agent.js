/**
 * "The Ada Master" - Tier 20 Legacy Language Specialist
 * Expert in Ada 2022, strong typing, tasking model, SPARK formal verification, and safety-critical systems.
 */
...
class AdaAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Safety-critical specialist for Ada 2022/SPARK: strong typing, tasking, RAVENSCAR, DO-178C/IEC 61508, and formal verification.';
...
Output Ada with proper package specs (.ads) and bodies (.adb) separation, self-documenting identifier names, and \`--\` comments. All numeric literals use underscores for readability (e.g., 1_000_000).`;
  ...
  async consult(prompt, contextData = []) {
    ...
    try {
      ...
      throw new Error(`Ada Synthesis Failed: ${e.message}`);
    }
  }
}
export const adaAgent = new AdaAgent();
