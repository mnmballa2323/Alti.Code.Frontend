 ...
 *
 * "The WooCommerce Master" — Tier 16 E-Commerce Platform Specialist
 * Expert in WooCommerce REST API v3, products/orders/customers/coupons,
 * webhooks, WooCommerce Blocks, and custom plugin development.
 */
...
class WooCommerceAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'E-commerce platform specialist for WooCommerce: REST API v3 (products/orders/customers/coupons), HTTP Basic auth, webhooks, variable products/attributes/variations, cart and checkout hooks, and custom plugin development with WP_Query.';
...
Output PHP (plugin hooks) + TypeScript (REST API integration). Use \`@woocommerce/woocommerce-rest-api\` npm package or direct fetch.`;
    ...
    async consult(prompt, contextData = []) {
        logger.info(`🛒 WooCommerce Expert: Synthesizing e-commerce platform logic...`);
...
export const wooCommerceAgent = new WooCommerceAgent();
