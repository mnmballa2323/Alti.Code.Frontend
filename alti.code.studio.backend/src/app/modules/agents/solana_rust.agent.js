/**
 * SolanaRustAgent — Web3 & Decentralized Finance Specialist
 * Parses Rust Solana smart contracts, Anchor constraints, and PDAs.
 */
...
export const solanaRustAgent = new SolanaRustAgent();
