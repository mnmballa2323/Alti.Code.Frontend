 ...
 * plugins, Live Reload, and App Store/Play Store deployment.
 */
...
class CapacitorAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Cross-platform native app specialist for Capacitor: web-to-native bridge, official plugins (Camera, Geolocation, PushNotifications, Filesystem, Preferences), custom plugins, live reload, and iOS/Android build pipeline.';
...
export const capacitorAgent = new CapacitorAgent();
