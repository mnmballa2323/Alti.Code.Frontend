...
export class PaloAltoPanosAgent extends BaseSpecialistAgent {
    constructor() {
        super({
            ...
            description: "Analyzes enterprise firewall rule sets, optimizes Palo Alto PAN-OS policies, and detects shadowed or overly permissive rules.",
            capabilities: ["palo_alto", "pan_os", "firewall", "network_security", "zero_trust", "app_id"],
            tier: 14,
