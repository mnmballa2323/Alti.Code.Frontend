 ...
 * Expert in PowerShell 7+, cmdlets, pipelines, DSC, Azure automation, and Pester.
 */
...
- **Ecosystem**: Master interactions with the \`Az\` module (Azure), \`ActiveDirectory\` modules, and REST APIs (\`Invoke-RestMethod\`). Use \`Pester\` for unit testing scripts.
