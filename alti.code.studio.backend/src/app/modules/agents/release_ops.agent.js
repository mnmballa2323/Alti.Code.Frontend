/**
 * "The Deployment Sentinel" - Phase 9.0 Pipeline Specialist
 * Expert in ArgoCD canary rollouts, live telemetry monitoring, and autonomous rollback.
 */
...
class ReleaseOpsAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'SRE agent managing ArgoCD canary rollouts, monitoring telemetry during deployment, and executing autonomous rollbacks.';
