/**
 * "The Kafka Master" - Tier 14 Data Engineering Specialist
 * Expert in Kafka topics, consumer groups, partitioning, exactly-once semantics, and Kafka Streams.
 */
...
class KafkaAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Data specialist for Kafka topics, consumer groups, partitioning strategy, and Kafka Streams topologies.';
...
export const kafkaAgent = new KafkaAgent();
