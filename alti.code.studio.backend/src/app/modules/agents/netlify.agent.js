 ...
 * 
 * "The Netlify Master" - Tier 16 Cloud Provider Specialist
 * Expert in Netlify Functions, Edge Functions, netlify.toml, and deploy previews.
 */
...
class NetlifyAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Deployment specialist for Netlify Functions, Edge Functions, netlify.toml, and Blobs storage.';
...
export const netlifyAgent = new NetlifyAgent();
