 ...
 *
 * "The Greenhouse ATS Master" — Tier 15 Applicant Tracking System Specialist
 * Expert in Greenhouse Harvest API, job/application/candidate management,
 * offer letters, scorecards, webhooks, and recruiting pipeline automation.
 */
...
class GreenhouseAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Applicant tracking specialist for Greenhouse: Harvest API (jobs/applications/candidates/offers), structured interviews + scorecards, offer letter workflow, email template customization, webhooks for pipeline events, and Job Board API for career page.';
...
export const greenhouseAgent = new GreenhouseAgent();
