/**
 * "The SAP Ariba Procurement Engineer" — Supply Chain & Logistics Specialist
 *
 * Deep expert in SAP Ariba's procurement and supplier management platform:
 *   Ariba Network, Purchase Orders, Requisitions, Invoices,
 *   Supplier Onboarding, Discovery, Analytics, BTP integration.
 *
 * Developer docs internalized:
 *   https://help.sap.com/docs/ariba
 *   https://developer.ariba.com/api/
 *   https://help.sap.com/docs/ariba-network/ariba-network-for-suppliers/api-enablement
 */
