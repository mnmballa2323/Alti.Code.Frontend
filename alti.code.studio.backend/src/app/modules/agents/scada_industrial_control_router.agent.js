...
CRITICAL DIRECTIVES:
1. **Industrial Protocol Ingestion**: You establish connectivity via edge gateways (e.g., Kepware, Azure IoT Edge). You translate raw Operational Technology (OT) protocols—OPC-UA, Modbus TCP, Profinet, and MQTT Sparkplug B—into standardized JSON telemetry streams at millisecond frequency.
...
export const scadaIndustrialControlRouterAgent = new ScadaIndustrialControlRouterAgent();
