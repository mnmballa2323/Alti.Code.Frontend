...
class RufloAgent extends BaseSpecialistAgent {
    constructor() {
        super();
        this.name = 'ruflo';
        this.description = 'The Ruflo Swarm Coordination & Multi-Agent Orchestrator Specialist. Harnesses multi-agent Raft/Byzantine/Gossip consensus topologies and SONA neural learning loops.';
