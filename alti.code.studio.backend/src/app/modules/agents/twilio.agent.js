 ...
 *
 * "The Twilio Master" — Tier 15 Messaging & Voice Integration Specialist
 * Expert in Twilio SMS, Voice, WhatsApp, Verify OTP, and Studio Flows.
 */
...
class TwilioAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Communications specialist for Twilio SMS, Voice, WhatsApp, Verify OTP, and programmable Studio Flows.';
...
export const twilioAgent = new TwilioAgent();
