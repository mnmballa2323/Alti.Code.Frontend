...
4. **Omni Integration**: If the enterprise spans multiple clouds, you provision BigQuery Omni configurations to execute federated queries against AWS S3 or GCP Cloud Storage without egressing the underlying data.
