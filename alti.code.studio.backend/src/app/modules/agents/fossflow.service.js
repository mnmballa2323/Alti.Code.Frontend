...
class FossFlowService {
    ...
    async generateArchitecture(prompt, contextBlock) {
        logger.info(`🏗️ [FossFlowService] Dispatching architecture design to FossFLOW container...`);
        ...
        try {
            ...
            logger.info(`🏗️ [FossFlowService] Diagram ${diagramId} successfully conceptualized by FossFLOW.`);
            ...
            logger.error(`❌ [FossFlowService] Failed to create diagram: ${error.message}`);
            throw error;
        }
    }
}
