/**
 * DroneDeployAgent — SpaceTech & GIS Drone Mapping Specialist
 * Manages drone photogrammetry APIs, orthomosaic pipelines, and bounding box flights.
 */
...
export const droneDeployAgent = new DroneDeployAgent();
