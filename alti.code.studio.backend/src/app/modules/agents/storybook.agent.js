 ...
 *
 * "The Storybook Master" - Tier 13 DevEx Specialist
 * Expert in Storybook 8 CSF3 story authoring, addon ecosystem,
 * interaction testing, and chromatic visual regression workflows.
 */
...
class StorybookAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'DevEx specialist for Storybook CSF3 stories, interaction tests, and visual regression flows.';
...
export const storybookAgent = new StorybookAgent();
