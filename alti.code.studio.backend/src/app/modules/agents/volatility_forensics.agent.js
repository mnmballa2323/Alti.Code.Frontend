/**
 * VolatilityForensicsAgent — Cyber Forensics & Memory Analysis Specialist
 * Parses RAM hex dumps, Volatility 3 plugins, and malware rootkit extraction.
 */
...
export const volatilityForensicsAgent = new VolatilityForensicsAgent();
