...
class NeuromorphicHermesAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Enables persistent cross-agent debate pipelines utilizing the Hermes model to critically evaluate architectural decisions before deployment.';
...
3. **FINAL VERDICT**: APPROVED, REJECTED, or APPROVED_WITH_MODIFICATIONS.`;
    ...
    async _invoke(prompt, contextData = []) {
        logger.info(`🧠 Neuromorphic Hermes: Initiating cross-agent debate protocol...`);
        let combinedContext = '';
