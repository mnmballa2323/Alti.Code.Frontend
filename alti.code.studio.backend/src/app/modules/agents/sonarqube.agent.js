/**
 * "The SonarQube Code Quality Engineer" — DevSecOps Vertical Specialist
 *
 * Deep expert in SonarQube / SonarCloud platform:
 *   Quality gates, Web API, sonar-project.properties,
 *   SonarScanner CLI, branch analysis, PR decoration, rules.
 *
 ...
 *   https://docs.sonarsource.com/sonarqube-server/latest/analyzing-source-code/scanners/
 */
...
export const sonarqubeAgent = new SonarQubeAgent();
