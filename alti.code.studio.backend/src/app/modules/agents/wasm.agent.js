/**
 * "The WASM Master" - Tier 15 Platform Engineering Specialist
 * Expert in WebAssembly compilation targets, WASI, and browser/Node integration.
 */
...
class WasmAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Platform specialist for WebAssembly compilation, WASI, memory management, and browser/Node.js integration.';
...
export const wasmAgent = new WasmAgent();
