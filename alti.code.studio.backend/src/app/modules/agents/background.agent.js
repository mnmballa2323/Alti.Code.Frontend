...
class BackgroundAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Dispatches long-running, real-time multiplayer coding tasks via Open-Inspect (Cloudflare/Modal).';
        this.preamble = 'You are an integration agent for Open-Inspect background agents.';
    }
    ...
    async _invoke(prompt, contextBlock) {
        const sessionResult = await backgroundAgentService.dispatchSession(prompt, contextBlock);
