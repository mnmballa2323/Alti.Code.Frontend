...
class AntigravityAwesomeSkillsAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'The Antigravity Awesome Skills Specialist. Selects, processes, and injects from a curated collection of 1,400+ agentic playbooks and workflows.';
...
export const antigravityAwesomeSkillsAgent =
  new AntigravityAwesomeSkillsAgent();
