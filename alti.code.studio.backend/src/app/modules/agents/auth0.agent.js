/**
 * "The Auth0 Identity Engineer" — Tier 13 SDK Integration Specialist
 *
 * Deep expert in Auth0 platform development:
 *   Universal Login, Actions, Rules, SDKs (auth0-node, auth0-js, @auth0/nextjs-auth0),
 *   Machine-to-Machine, Organizations, Fine-Grained Authorization, Management API.
 *
