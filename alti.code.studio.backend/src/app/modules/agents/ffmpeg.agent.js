 ...
 * 
 * "The Media Master" - Tier 12 Hyper-Niche Specialist
 */
...
class FfmpegAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Media encoding expert generating optimal ffmpeg CLI flags for video/audio pipelines.';
...
export const ffmpegAgent = new FfmpegAgent();
