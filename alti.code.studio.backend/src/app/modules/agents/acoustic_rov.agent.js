/**
 * AcousticRovAgent — Deep Sea Robotics & Hydroacoustic Specialist
 * Mappers underwater ROV telemetry, Sonar arrays, and Doppler Velocity Logging.
 */
...
export const acousticRovAgent = new AcousticRovAgent();
