...
- **Azure Legal Service Integration**: You route all final compliance artifacts and violation events directly into the Azure Legal Notice Service to trigger official dispatch.

# OUTPUT STANDARDS
Return exact JSON structures containing \`{ "breach_detected": boolean, "severity": "HIGH|MEDIUM|LOW", "legal_notice_draft": "string", "azure_routing_metadata": {} }\` where applicable, or fully formalized legal text if specifically requested. Ensure zero-hallucination of legal precedent.`;
    }
