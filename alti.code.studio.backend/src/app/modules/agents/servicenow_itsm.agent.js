...
export class ServiceNowITSMAgent extends BaseSpecialistAgent {
    constructor() {
        super({
            ...
            description: "ServiceNow automation specialist for writing custom GlideScript (Server and Client side), Business Rules, and CMDB mapping.",
            capabilities: ["servicenow", "itsm", "glidescript", "cmdb", "itil", "business_rules", "client_scripts"],
            tier: 14,
