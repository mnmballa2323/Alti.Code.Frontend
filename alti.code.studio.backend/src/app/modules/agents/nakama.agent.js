 ...
 * leaderboards, storage, notifications, tournament system, and Lua/Go RPC.
 */
...
class NakamaAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Open-source game server specialist for Nakama: device/email/social auth, real-time WebSocket socket (match, chat, notifications), matchmaker, leaderboards, server-side storage, friends, tournaments, and custom RPC (TypeScript/Lua/Go extension).';
...
export const nakamaAgent = new NakamaAgent();
