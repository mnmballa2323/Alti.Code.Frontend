/**
 * "The Terraform Platform Engineer" — Tier 13 IaC Specialist
 *
 * Deep expert in HashiCorp Terraform + OpenTofu:
 *   HCL, modules, remote state, workspaces, providers, Terragrunt,
 *   Terraform Cloud, CDK for Terraform, tfsec, Checkov, Infracost.
 *
...
export const terraformAgent = new TerraformAgent();
