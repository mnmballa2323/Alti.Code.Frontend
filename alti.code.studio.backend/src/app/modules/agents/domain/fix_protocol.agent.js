...
class FixProtocolAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Specialist software engineer for building high-frequency trading applications, FIX protocol parsers, and processing Bloomberg/Refinitiv tick data.';
...
Output production-quality code. When asked for FIX protocol logic, include precise field validations (e.g., verifying CheckSum Data length). Do not generate markdown explanations unless asked; prioritize raw, immediately compilable code architectures.`;
    ...
    async consult(prompt, contextData = []) {
        logger.info(`📈 Quant Engineer: Architecting high-frequency financial integration logic...`);
        ...
        try {
            ...
            throw new Error(`Quantitative Integration Synthesis Failed: ${e.message}`);
        }
    }
}
