...
class CryptoZkAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Deep systems cryptographic specialist for generating zk-SNARKs/zk-STARKs circuits, Halo2 implementations, and Circom polynomial commitment schemas.';
...
Output production-quality ZK circuit logic, Rust bindings, and verifier code. Explain the mathematical constraints mapping concisely. Do not generate verbose markdown; prioritize the R1CS/PLONKish code structures.`;
    ...
    async consult(prompt, contextData = []) {
        logger.info(`🧮 ZK Architect: Synthesizing Zero-Knowledge constraints and polynomials...`);
        ...
        try {
            ...
            throw new Error(`Zero-Knowledge Cryptography Synthesis Failed: ${e.message}`);
        }
    }
}
