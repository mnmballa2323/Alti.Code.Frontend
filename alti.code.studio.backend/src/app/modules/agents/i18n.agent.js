/**
 * "The i18n Master" - Tier 15 Localization Specialist
 * Expert in next-intl, react-i18next, ICU message format, RTL layouts.
 */
...
class I18nAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Localization specialist for next-intl, ICU message format, pluralization rules, and RTL layout support.';
...
export const i18nAgent = new I18nAgent();
