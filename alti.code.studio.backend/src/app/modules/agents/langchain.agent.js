 ...
 *
 * "The Local Subagent Delegator" — Tier 12 Micro-Specialist
 * A Swarm Agent dedicated natively to translating cloud goals into LangChain / 
 * deepagentsjs execution plans, explicitly for the OpenWork desktop companion.
 */
...
export const langchainAgent = new LangChainOpenWorkAgent();
