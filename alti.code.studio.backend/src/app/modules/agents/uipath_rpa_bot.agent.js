...
export class UiPathRpaBotAgent extends BaseSpecialistAgent {
    constructor() {
        super({
            ...
            description: "UiPath Robotic Process Automation (RPA) bot generator for legacy systems and screen scraping.",
            capabilities: ["uipath", "rpa", "robotic_process_automation", "xaml", "bot", "screen_scraping"],
            tier: 14,
