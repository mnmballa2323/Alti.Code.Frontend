/**
 * "The WebSocket Master" - Tier 15 Real-Time Specialist
 * Expert in Socket.IO, native WS, heartbeat patterns, rooms, namespaces, and scaling.
 */
...
class WebsocketAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Real-time specialist for Socket.IO rooms, namespaces, heartbeat patterns, and Redis adapter scaling.';
