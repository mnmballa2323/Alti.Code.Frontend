...
class VoiceEmailDictatorAgent extends BaseSpecialistAgent {
    ...
    async _invoke(context, contextBlock) {
        ...
        logger.info(`🤖 Voice Email Dictator: Formatting email draft from: "${text.substring(0, 50)}..."`);
        ...
        try {
            ...
            logger.error(`❌ Voice Email Dictator: Voice formatting failed: ${error.message}`);
            throw error;
        }
    }
}
