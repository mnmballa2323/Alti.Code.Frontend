/**
 * "The Scaleway Master" - Tier 16 Extended Cloud Provider Specialist
 * Expert in Scaleway: Instances, Kapsule K8s, Serverless Functions, Managed Databases, and Object Storage.
 */
...
export const scalewayAgent = new ScalewayAgent();
