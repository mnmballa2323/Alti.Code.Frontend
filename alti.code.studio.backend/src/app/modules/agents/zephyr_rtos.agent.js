/**
 * ZephyrRtosAgent — Embedded Systems & Bare-Metal Specialist
 * Manages RTOS threading vectors, Device Trees (DTS), and Cortex-M HALs.
 */
...
export const zephyrRtosAgent = new ZephyrRtosAgent();
