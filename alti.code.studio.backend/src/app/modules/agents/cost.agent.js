 ...
 * 
 * "The Cloud Cost Agent" - Tier 2 Infra Specialist
 * Possesses deep semantic context regarding FinOps, resource utilization,
 * infrastructure right-sizing, and Spot pricing strategies.
 */
...
class CostAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Cloud FinOps specialist analyzing telemetry to aggressively right-size infrastructure budgets.';
