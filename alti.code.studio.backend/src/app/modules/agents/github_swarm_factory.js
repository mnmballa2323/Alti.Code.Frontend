...
export const GITHUB_SPECIALISTS_TAXONOMY = [
  ...
  },
  {
    ...
    description:
      'Specialist GitHub Collaborator Manager expert in handling repository access rights, direct collaborator invites, and privilege tiers.',
  },
  {
    id: 'githubBranchProtector',
    capabilities: [
      'github-create-branch-protection',
      'github-update-branch-protection',
    ],
    domain: 'Repositories',
    focus: 'branch protections, status check rules, signed commits',
    description:
      'Specialist GitHub Branch Protector expert in configuring strict branch protections, mandatory pull request rules, and commit signature requirements.',
  },
  {
    ...
    description:
      'Specialist GitHub Deploy Keys Manager expert in configuring read/write deployment keys and secure deploy credential bindings.',
  },
  {
    ...
    description:
      'Specialist GitHub Environments Manager expert in creating deployment environments, configuring protection rules, and setting reviewer gates.',
  },
  {
    ...
    description:
      'Specialist GitHub Autolinks Manager expert in configuring external autolink references and third-party ticket trackers sync.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Specialist GitHub CODEOWNERS Administrator expert in mapping precise repository ownership, syntax rules, and auto-assigned reviewers.',
  },
  {
  ...
  // === 2. Pull Requests Domain (10 Specialists) ===
  {
    ...
    description:
      'Specialist GitHub PR Creator expert in generating pull requests, drafting proposals, and managing branch comparisons.',
  },
  {
    id: 'githubPrReviewer',
    ...
    description:
      'Specialist GitHub PR Reviewer expert in executing code reviews, leaving inline feedback, and deciding approval/rejection states.',
  },
  {
    id: 'githubPrMerger',
    ...
    domain: 'Pull Requests',
    focus:
      'merging pull requests, squash merges, rebase merges, merge conflict checks',
    description:
  ...
  },
  {
    ...
    description:
      'Specialist GitHub PR Review Commenter expert in managing specific code diff comments and resolving conversational review threads.',
  },
  {
    ...
    description:
      'Specialist GitHub PR Draft Manager expert in transitioning pull requests between draft and formal review-ready states.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Specialist GitHub PR Requested Reviews Manager expert in assignation of required individual and team reviewers.',
  },
  {
    ...
    description:
      'Specialist GitHub PR Comments Manager expert in handling generic pull request conversation comments and issue-comment linkages.',
  },
  {
    ...
    domain: 'Pull Requests',
    focus:
      'pull request commits history, timeline events, review history audits',
    description:
      'Specialist GitHub PR Timeline Auditor expert in scraping pull request activity trails, review history logs, and commit sequences.',
  },
  ...
  // === 3. Actions CI/CD Domain (10 Specialists) ===
  {
    ...
    description:
      'Specialist GitHub Actions Workflow Compiler expert in designing high-performance event-driven workflow YAML definitions.',
  },
  {
    id: 'githubActionsSecretsManager',
    capabilities: [
      'github-create-actions-secret',
      'github-delete-actions-secret',
    ],
    domain: 'Actions CI/CD',
    focus:
      'encrypted actions secrets, organization secrets, environment secrets',
    description:
      'Specialist GitHub Actions Secrets Manager expert in provisioning repository, organization, and environment encrypted secret vaults.',
  },
  {
    id: 'githubActionsVariablesManager',
    capabilities: [
      'github-create-actions-variable',
      'github-delete-actions-variable',
    ],
    domain: 'Actions CI/CD',
    focus:
      'actions configuration variables, organization variables, environment variables',
    description:
      'Specialist GitHub Actions Variables Manager expert in setting non-sensitive configuration values across actions.',
  },
  {
    ...
    domain: 'Actions CI/CD',
    focus:
      'actions artifacts lifecycle, upload/download actions, storage rules',
    description:
      'Specialist GitHub Actions Artifacts Exporter expert in configuring CI/CD artifact uploads, downloads, and custom expiration limits.',
  },
  {
    ...
    domain: 'Actions CI/CD',
    focus:
      'workflow cache keys, cache invalidation, setup-node/setup-python caches',
    description:
      'Specialist GitHub Actions Cache Optimizer expert in implementing dynamic package caches to accelerate workflow compile speeds.',
  },
  {
    ...
    domain: 'Actions CI/CD',
    focus:
      'self-hosted runner deployment, runner installation scripts, runner scaling',
    description:
      'Specialist GitHub Actions Runner Provisioner expert in deploying self-hosted runners and scaling automated workflow worker nodes.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Specialist GitHub Actions Concurrency Gatekeeper expert in configuring concurrency limits and stale job auto-cancellation.',
  },
  {
    ...
    domain: 'Actions CI/CD',
    focus:
      'OpenID Connect keys, keyless authentication, AWS/GCP role assumption',
    description:
      'Specialist GitHub Actions OIDC Federator expert in keyless AWS/GCP role assumptions using OpenID Connect authentication.',
  },
  {
    ...
    description:
      'Specialist GitHub Actions Matrix Builder expert in crafting optimized multi-environment and cross-platform build matrices.',
  },
  ...
  // === 4. Apps & Integrations Domain (10 Specialists) ===
  {
    ...
    description:
      'Specialist GitHub App Configurator expert in scaffoldings and modifications of manifest-driven GitHub Applications.',
  },
  {
    ...
    domain: 'Apps & Integrations',
    focus:
      'x-hub-signature-256 header validation, HMAC-SHA256 secret verification',
    description:
      'Specialist GitHub App Webhook Verifier expert in cryptographically verifying incoming event headers using HMAC-SHA256.',
  },
  {
    ...
    domain: 'Apps & Integrations',
    focus:
      'oauth web flow tokens, authorization code flow, user-to-server exchanges',
    description:
      'Specialist GitHub App OAuth Exchange expert in user-authorization code exchanges and access tokens generation.',
  },
  {
    ...
    description:
      'Specialist GitHub App Installation Manager expert in managing installation lifecycles and temporary workspace credentials.',
  },
  {
    ...
    description:
      'Specialist GitHub App Permissions Auditor expert in regulating app access scopes and auditing security boundaries.',
  },
  {
    ...
    domain: 'Apps & Integrations',
    focus:
      'webhook deliveries history, redelivery triggering, webhook failures logs',
    description:
      'Specialist GitHub App Webhook Delivery Auditor expert in tracking delivery histories, payload failures, and manual retry triggers.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Specialist GitHub App Manifest Regulator expert in validating and parsing declarative app manifest configuration schemas.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Specialist GitHub App Client Credentials Manager expert in resetting and rotating OAuth client credentials securely.',
  },
  ...
  // === 5. Projects v2 Domain (10 Specialists) ===
  {
    ...
    description:
      'Specialist GitHub Projects Creator expert in establishing customizable organizational Projects v2 kanban boards.',
  },
  {
    ...
    domain: 'Projects v2',
    focus:
      'projects v2 custom fields, single select fields, number/date fields',
    description:
  ...
  },
  {
    ...
    domain: 'Projects v2',
    focus:
      'projects v2 built-in automation, auto-add items, status transitions',
    description:
      'Specialist GitHub Projects Status Automator expert in setting project-level workflows and state transition triggers.',
  },
  {
    ...
    description:
      'Specialist GitHub Projects Item Archiver expert in cleaning boards through card archiving and item restoration.',
  },
  {
    ...
    description:
      'Specialist GitHub Projects Board Syncer expert in automating card state changes mapping to repository issues and PRs.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Specialist GitHub Projects Views Manager expert in creating distinct team views using custom filters and grouping.',
  },
  {
    ...
    description:
      'Specialist GitHub Projects Collaboration Syncer expert in shared projects configuration and member read/write permissions.',
  },
  {
    ...
    description:
      'Specialist GitHub Projects Limits Auditor expert in tracking project limits, checking field caps, and monitoring card metrics.',
  },
  ...
  // === 6. Governance & Enterprise Domain (10 Specialists) ===
  {
    ...
    description:
      'Specialist GitHub Enterprise SAML Configurator expert in SSO identity providers (IdP) integration.',
  },
  {
    ...
    description:
      'Specialist GitHub Enterprise SCIM Provisioner expert in user directory integrations and lifecycle management.',
  },
  {
    ...
    description:
      'Specialist GitHub Enterprise SSH CA Administrator expert in configuring signed certificate restrictions.',
  },
  {
    ...
    description:
      'Specialist GitHub Enterprise Audit Log Parser expert in security audit log queries and event parsing.',
  },
  {
    ...
    description:
      'Specialist GitHub Enterprise IP Allow List Rules expert in configuring CIDR block access security bounds.',
  },
  {
    ...
    description:
      'Specialist GitHub Enterprise Billing Auditor expert in licensing usage records and spent optimizations.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Specialist GitHub Enterprise Org Manager expert in setting up new child organizations and administrative rules.',
  },
  {
    ...
    description:
      'Specialist GitHub Enterprise Member Manager expert in managing membership invitations and organization privilege structures.',
  },
  {
    ...
    description:
      'Specialist GitHub Enterprise Policy Enforcer expert in setting global branch checks and action rules across organizations.',
  },
  ...
  // === 7. Gists & Snippets Domain (10 Specialists) ===
  {
    ...
    description:
      'Specialist GitHub Gist Creator expert in publishing secret and public code snippets dynamically.',
  },
  {
    ...
    description:
      'Specialist GitHub Gist Embed Builder expert in generating client-side script integrations for third-party embeds.',
  },
  {
    ...
    description:
      'Specialist GitHub Gist Snippet Syncer expert in synchronizing scratchpads and tracking revision histories.',
  },
  {
    ...
    description:
      'Specialist GitHub Gist Deleter expert in cleaning and removing active code snippets.',
  },
  {
    ...
    description:
      'Specialist GitHub Gist Updater expert in refactoring gist contents and maintaining multi-file revisions.',
  },
  {
    ...
    description:
      'Specialist GitHub Gist Forks Manager expert in copying public snippets and tracking snippet lineages.',
  },
  {
    ...
    description:
      'Specialist GitHub Gist Comments Manager expert in managing snippet conversations and feedback.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Specialist GitHub Gist Access Regulator expert in auditing secret snippet links and credential leakage vectors.',
  },
  {
  ...
  // === 8. Discussions Domain (10 Specialists) ===
  {
    ...
    description:
      'Specialist GitHub Discussions Category Manager expert in categorizing community threads and announcements.',
  },
  {
    ...
    description:
      'Specialist GitHub Discussions Comment Responder expert in managing thread comments and community feedback.',
  },
  {
    ...
    description:
      'Specialist GitHub Discussions Q&A Solver expert in resolving open questions and tracking community solutions.',
  },
  {
    ...
    description:
      'Specialist GitHub Discussions Creator expert in generating community discussions and starting structured threads.',
  },
  {
    ...
    description:
      'Specialist GitHub Discussions Deleter expert in pruning and moderating community topics.',
  },
  {
    ...
    description:
      'Specialist GitHub Discussions Updater expert in updating discussion subjects, metadata, and body structures.',
  },
  {
    ...
    description:
      'Specialist GitHub Discussions Reaction Manager expert in toggling reactions and monitoring feedback indicators.',
  },
  {
    ...
    description:
      'Specialist GitHub Discussions Labeler expert in applying community tags and categorization filters.',
  },
  {
    ...
    description:
      'Specialist GitHub Discussions Lock Manager expert in moderating and locking mature community threads.',
  },
  {
    ...
    description:
      'Specialist GitHub Discussions Pin Manager expert in spotlighting priority community announcements.',
  },
  ...
  // === 9. Issues Domain (10 Specialists) ===
  {
    ...
    description:
      'Specialist GitHub Issues Triage Manager expert in auto-labeling and assignee allocation algorithms.',
  },
  {
    ...
    description:
      'Specialist GitHub Issues Label Standardizer expert in color schemes and labels taxonomy management.',
  },
  {
    ...
    description:
      'Specialist GitHub Issues Milestone Tracker expert in configuring project release cycles and due dates.',
  },
  {
    ...
    description:
      'Specialist GitHub Issues Pinned Issue Manager expert in dashboard organization and issue spotlighting.',
  },
  {
    ...
    description:
      'Specialist GitHub Issues Creator expert in issue templates design and initial bug report creations.',
  },
  {
    ...
    description:
      'Specialist GitHub Issues Deleter expert in pruning spam and deleting issues.',
  },
  {
    ...
    description:
      'Specialist GitHub Issues Lock Manager expert in issue moderation and thread locking policies.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Specialist GitHub Issues Events Auditor expert in tracking issue state transitions and event trails.',
  },
  {
    ...
    description:
      'Specialist GitHub Issues Reactions Manager expert in applying emoji reactions and aggregating user feedback.',
  },
  ...
  // === 10. Security & Compliance Domain (10 Specialists) ===
  {
    ...
    focus:
      'codeql security analyses, static application security testing (SAST)',
    description:
      'Specialist GitHub Security CodeQL Scanner expert in SAST analysis and CodeQL configurations.',
  },
  {
    ...
    description:
      'Specialist GitHub Security Dependabot Alerts Patcher expert in automated vulnerability patch reviews.',
  },
  {
    ...
    description:
      'Specialist GitHub Security Secret Scanning Regulator expert in credentials leakage rules and push protections.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Specialist GitHub Security Branch Protection Auditor expert in commit signature audit compliance checking.',
  },
  {
    ...
    description:
      'Specialist GitHub Security Secret Scanning Bypass expert in auditing push protection override history logs.',
  },
  {
    ...
    description:
      'Specialist GitHub Security Code Scanning Alerts expert in parsing scanning reports and alerts histories.',
  },
  {
  ...
  },
  {
    ...
    domain: 'Security & Compliance',
    focus:
      'private security advisory disclosures, collaborative vulnerability fixes',
    description:
  ...
  },
  {
    ...
    description:
      'Specialist GitHub Security SSH Keys Auditor expert in user SSH keys compliance checking.',
  },
  ...
  // === 11. Copilot Domain (10 Specialists) ===
  {
    ...
    description:
      'Specialist GitHub Copilot Extension Builder expert in custom chat extension API endpoints scaffolds.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Specialist GitHub Copilot JWT Decoder expert in verifying copilot signature headers and public keys.',
  },
  {
    ...
    description:
      'Specialist GitHub Copilot Conversational Prompt Parser expert in chat context processing.',
  },
  {
    ...
    description:
      'Specialist GitHub Copilot Skills Configurator expert in custom declarative skills.yml schemas.',
  },
  {
    ...
    description:
      'Specialist GitHub Copilot Token Manager expert in OAuth tokens exchanges and license authorization.',
  },
  {
    ...
    description:
      'Specialist GitHub Copilot Agent Schemas expert in validating dynamic agent JSON response structures.',
  },
  {
    ...
    description:
      'Specialist GitHub Copilot Reference Resolvers expert in mapping files and commits.',
  },
  {
    ...
    description:
      'Specialist GitHub Copilot Metrics Exporter expert in scraping license analytics and usage statistics.',
  },
  {
    ...
    description:
      'Specialist GitHub Copilot Seat Allocator expert in seat provisioning rules.',
  },
  ...
  // === 12. Billing & Administration Domain (10 Specialists) ===
  {
    ...
    description:
      'Specialist GitHub Admin Seat Allocator expert in license provisioning across organization members.',
  },
  {
    ...
    description:
      'Specialist GitHub Admin Billing Export Cron expert in scheduling billing usage exports.',
  },
  {
    ...
    description:
      'Specialist GitHub Admin Invoice Analyzer expert in cost allocation audits.',
  },
  {
    ...
    description:
      'Specialist GitHub Admin GPG Keys Manager expert in revoking and auditing commit keys.',
  },
  {
    ...
    description:
      'Specialist GitHub Admin Invites Manager expert in invitation lifecycles and expiration regulations.',
  },
  {
    ...
    description:
      'Specialist GitHub Admin Teams Manager expert in nesting organizational teams and structuring team privileges.',
  },
  {
    ...
    description:
      'Specialist GitHub Admin Webhooks Manager expert in administering organizational webhook endpoints.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Specialist GitHub Admin Self Hosted Runner Limits expert in actions spending caps and usage metrics.',
  },
  {
    ...
    description:
      'Specialist GitHub Admin Enterprise Licensing expert in license synchronizations and seats allocation audits.',
  },
];
...
export class GithubSwarmFactory {
  ...
  async generateAllSpecialists() {
    logger.info(
      `🔥 [SwarmFactory] Initiating compilation sequence for 120+ specialized GitHub agents...`,
    );
...
`;
        ...
        logger.error(
          `❌ [SwarmFactory] Failed to compile specialized agent [${spec.id}]: ${err.message}`,
        );
        throw err;
      }
    }
    ...
    logger.info(
      `✅ [SwarmFactory] Successfully compiled and deployed ${compiled} specialized agents on disk.`,
    );
    return compiled;
  }
}
