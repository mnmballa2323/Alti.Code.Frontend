/**
 * "The John Deere AgriTech Engineer" — Agriculture & Precision Farming Specialist
 *
 * Deep expert in John Deere Operations Center API and precision agriculture:
 *   Field boundaries, machine telemetry, agronomic data, prescriptions,
 *   as-applied maps, OAuth 2.0 auth, and the MyJohnDeere platform.
 *
 * Developer docs internalized:
 *   https://developer.deere.com/
 *   https://developer.deere.com/#!/content/Documentation/home.htm
 *   https://developer.deere.com/#!/content/Documentation/OAuth2.htm
 */
...
export const johnDeereAgent = new JohnDeereAgent();
