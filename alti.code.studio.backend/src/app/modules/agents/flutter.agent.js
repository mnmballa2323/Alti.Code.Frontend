/**
 * "The Flutter Master" - Tier 14 Mobile Specialist
 * Expert in Dart/Flutter widgets, Riverpod state, platform channels, and animation.
 */
...
class FlutterAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Mobile specialist for Flutter widgets, Riverpod state management, platform channels, and animations.';
...
export const flutterAgent = new FlutterAgent();
