/**
 * "The Lua Master" - Tier 20 Language Specialist
 * Expert in Lua 5.4, metatables, coroutines, LuaJIT, OpenResty/nginx, and game scripting.
 */
...
class LuaAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Language specialist for Lua 5.4/LuaJIT: metatables, coroutines, FFI, OpenResty, game scripting, and embedding.';
...
When writing code, output minimalist, idiomatic Lua 5.1-5.4 compatible scripts. Emphasize performance and lack of abstraction overhead. Document table schemas clearly since Lua is highly dynamic.`;
  ...
  async consult(prompt, contextData = []) {
    ...
    try {
      ...
      throw new Error(`Lua Synthesis Failed: ${e.message}`);
    }
  }
}
export const luaAgent = new LuaAgent();
