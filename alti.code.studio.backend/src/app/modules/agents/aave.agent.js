 ...
 * health factor, e-mode, isolation mode, and Aave Governance.
 */
...
class AaveAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'DeFi lending specialist for Aave v3: supply/borrow/repay/withdraw, flash loans (simple + multi-asset), health factor monitoring, e-mode, isolation mode, rate switching, Safety Module, and AaveJS SDK.';
...
export const aaveAgent = new AaveAgent();
