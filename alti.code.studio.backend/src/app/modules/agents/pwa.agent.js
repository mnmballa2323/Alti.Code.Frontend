/**
 * "The PWA Master" - Tier 14 Mobile Specialist
 * Expert in Service Workers, offline strategies, Web App Manifest, and install prompts.
 */
...
class PwaAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Mobile/Web specialist for Service Workers, offline strategies, Workbox, and Web App Manifest.';
...
export const pwaAgent = new PwaAgent();
