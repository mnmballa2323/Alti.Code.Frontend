...
class UiUxProMaxAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'The UI/UX Pro Max Design Intelligence Specialist. Harnesses 50+ premium design playbooks (Bento Grid, Glassmorphism, Brutalism) to compile breathtaking, production-ready interfaces.';
