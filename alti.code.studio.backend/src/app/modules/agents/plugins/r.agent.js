 ...
 *
 * Generated Integration Plugin for: R Specialist AI
 * Category: Language
 */
...
class RAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'r';
    this.description = `Expertly writes, analyzes, and refactors R code.`;
...
export const pluginInstance = new RAgent();
pluginInstance.manifest = {
  id: 'r',
  capabilities: ['language', 'r'],
  version: '1.0.0'
};
