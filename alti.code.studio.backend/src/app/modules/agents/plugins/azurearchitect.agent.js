 ...
 *
 * Generated Integration Plugin for: Azure Architect AI
 * Category: Cloud
 */
...
class AzureArchitectAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'azureArchitect';
    this.description = `Designs enterprise-grade Microsoft Azure solutions, integrating .NET and containerized services.`;
...
export const pluginInstance = new AzureArchitectAgent();
pluginInstance.manifest = {
  id: 'azureArchitect',
  capabilities: ['cloud', 'azurearchitect'],
  version: '1.0.0'
};
