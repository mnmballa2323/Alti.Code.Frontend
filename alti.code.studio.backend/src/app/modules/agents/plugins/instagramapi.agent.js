 ...
 *
 * Generated Integration Plugin for: Instagram API Specialist AI
 * Category: Social
 */
...
class InstagramAPIAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'instagramAPI';
    this.description = `Builds Instagram integrations with Graph API for content publishing, analytics, and webhook automation.`;
...
export const pluginInstance = new InstagramAPIAgent();
pluginInstance.manifest = {
  id: 'instagramAPI',
  capabilities: ['social', 'instagramapi'],
  version: '1.0.0'
};
