 ...
 *
 * Generated Integration Plugin for: Klaviyo Specialist AI
...
class KlaviyoAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'klaviyo';
    this.description = `Expertly integrates and manages Klaviyo workflows for your stack.`;
...
export const pluginInstance = new KlaviyoAgent();
pluginInstance.manifest = {
  id: 'klaviyo',
  capabilities: ['integration', 'klaviyo'],
  version: '1.0.0'
};
