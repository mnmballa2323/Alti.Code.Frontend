 ...
 *
 * Generated Integration Plugin for: Together AI Specialist AI
...
class TogetherAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'together';
    this.description = `Expertly integrates and manages Together AI workflows for your stack.`;
...
export const pluginInstance = new TogetherAgent();
pluginInstance.manifest = {
  id: 'together',
  capabilities: ['integration', 'together'],
  version: '1.0.0'
};
