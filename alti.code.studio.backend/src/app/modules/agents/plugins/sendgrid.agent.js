 ...
 *
 * Generated Integration Plugin for: SendGrid Specialist AI
...
class SendGridAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'sendGrid';
    this.description = `Integrates and configures SendGrid services into your application.`;
...
export const pluginInstance = new SendGridAgent();
pluginInstance.manifest = {
  id: 'sendGrid',
  capabilities: ['communications', 'sendgrid'],
  version: '1.0.0'
};
