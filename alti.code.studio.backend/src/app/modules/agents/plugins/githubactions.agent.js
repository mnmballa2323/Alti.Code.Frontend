 ...
 *
 * Generated Integration Plugin for: GitHub Actions Specialist AI
...
class GitHubActionsAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'gitHubActions';
    this.description = `Expertly integrates and manages GitHub Actions workflows for your stack.`;
...
pluginInstance.manifest = {
  id: 'gitHubActions',
  capabilities: ['integration', 'githubactions'],
  version: '1.0.0'
};
