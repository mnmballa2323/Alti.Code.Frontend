 ...
 *
 * Generated Integration Plugin for: Coda Specialist AI
...
class CodaAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'coda';
    this.description = `Expertly integrates and manages Coda workflows for your stack.`;
...
export const pluginInstance = new CodaAgent();
pluginInstance.manifest = {
  id: 'coda',
  capabilities: ['integration', 'coda'],
  version: '1.0.0'
};
