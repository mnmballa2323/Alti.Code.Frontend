 ...
 *
 * Generated Integration Plugin for: Kelsey Hightower AI
 * Category: DevOps
 */
...
class KelseyHightowerAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'kelseyHightower';
    this.description = `Orchestrates microservices clusters, writing clean YAML specifications and managing networking.`;
...
export const pluginInstance = new KelseyHightowerAgent();
pluginInstance.manifest = {
  id: 'kelseyHightower',
  capabilities: ['devops', 'kelseyhightower'],
  version: '1.0.0'
};
