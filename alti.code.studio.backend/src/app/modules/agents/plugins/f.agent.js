 ...
 *
 * Generated Integration Plugin for: F# Specialist AI
 * Category: Language
 */
...
class FAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'f';
    this.description = `Expertly writes, analyzes, and refactors F# code.`;
...
export const pluginInstance = new FAgent();
pluginInstance.manifest = {
  id: 'f',
  capabilities: ['language', 'f'],
  version: '1.0.0'
};
