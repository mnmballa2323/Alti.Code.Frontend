 ...
 *
 * Generated Integration Plugin for: Vertex AI Pipeline AI
 * Category: AI
 */
...
class VertexPipelineAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'vertexPipeline';
    this.description = `Deploys machine learning models to GCP runtimes, checking prediction logs for drift.`;
...
export const pluginInstance = new VertexPipelineAgent();
pluginInstance.manifest = {
  id: 'vertexPipeline',
  capabilities: ['ai', 'vertexpipeline'],
  version: '1.0.0'
};
