 ...
 *
 * Generated Integration Plugin for: Xero Specialist AI
...
class XeroAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'xero';
    this.description = `Expertly integrates and manages Xero workflows for your stack.`;
...
export const pluginInstance = new XeroAgent();
pluginInstance.manifest = {
  id: 'xero',
  capabilities: ['integration', 'xero'],
  version: '1.0.0'
};
