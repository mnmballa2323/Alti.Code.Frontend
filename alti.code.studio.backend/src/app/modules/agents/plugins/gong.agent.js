 ...
 *
 * Generated Integration Plugin for: Gong Specialist AI
...
class GongAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'gong';
    this.description = `Expertly integrates and manages Gong workflows for your stack.`;
...
export const pluginInstance = new GongAgent();
pluginInstance.manifest = {
  id: 'gong',
  capabilities: ['integration', 'gong'],
  version: '1.0.0'
};
