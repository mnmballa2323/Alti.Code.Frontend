 ...
 *
 * Generated Integration Plugin for: Release Notes AI
...
class ReleaseNotesAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'releaseNotes';
    this.description = `Generates clear release notes, changelogs, migration guides, and developer communications.`;
...
export const pluginInstance = new ReleaseNotesAgent();
pluginInstance.manifest = {
  id: 'releaseNotes',
  capabilities: ['documentation', 'releasenotes'],
  version: '1.0.0'
};
