 ...
 *
 * Generated Integration Plugin for: Ecwid Specialist AI
...
class EcwidAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'ecwid';
    this.description = `Expertly integrates and manages Ecwid workflows for your stack.`;
...
export const pluginInstance = new EcwidAgent();
pluginInstance.manifest = {
  id: 'ecwid',
  capabilities: ['integration', 'ecwid'],
  version: '1.0.0'
};
