 ...
 *
 * Generated Integration Plugin for: AWS Specialist AI
 * Category: Cloud
 */
...
class AWSAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'aWS';
    this.description = `Integrates and configures AWS services into your application.`;
...
export const pluginInstance = new AWSAgent();
