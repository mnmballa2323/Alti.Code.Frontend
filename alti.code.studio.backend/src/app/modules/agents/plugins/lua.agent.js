 ...
 *
 * Generated Integration Plugin for: Lua Specialist AI
 * Category: Language
 */
...
class LuaAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'lua';
    this.description = `Expertly writes, analyzes, and refactors Lua code.`;
...
export const pluginInstance = new LuaAgent();
pluginInstance.manifest = {
  id: 'lua',
  capabilities: ['language', 'lua'],
  version: '1.0.0'
};
