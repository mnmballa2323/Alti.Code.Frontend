 ...
 *
 * Generated Integration Plugin for: DigitalOcean Specialist AI
 * Category: Cloud
 */
...
class DigitalOceanAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description = `Integrates and configures DigitalOcean services into your application.`;
...
export const pluginInstance = new DigitalOceanAgent();
pluginInstance.manifest = {
  id: 'digitalOcean',
  capabilities: ['cloud', 'digitalocean'],
  version: '1.0.0'
};
