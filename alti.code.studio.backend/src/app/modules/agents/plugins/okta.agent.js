 ...
 *
 * Generated Integration Plugin for: Okta Specialist AI
...
class OktaAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'okta';
    this.description = `Integrates and configures Okta services into your application.`;
...
export const pluginInstance = new OktaAgent();
pluginInstance.manifest = {
  id: 'okta',
  capabilities: ['authentication', 'okta'],
  version: '1.0.0'
};
