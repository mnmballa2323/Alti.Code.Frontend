 ...
 *
 * Generated Integration Plugin for: Google Cloud Specialist AI
 * Category: Cloud
 */
...
class GoogleCloudAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'googleCloud';
    this.description = `Integrates and configures Google Cloud services into your application.`;
...
export const pluginInstance = new GoogleCloudAgent();
pluginInstance.manifest = {
  id: 'googleCloud',
  capabilities: ['cloud', 'googlecloud'],
  version: '1.0.0'
};
