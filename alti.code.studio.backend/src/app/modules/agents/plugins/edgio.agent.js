 ...
 *
 * Generated Integration Plugin for: Edgio Specialist AI
 * Category: Cloud
 */
...
class EdgioAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'edgio';
    this.description = `Provisions and maintains robust systems on Edgio.`;
...
export const pluginInstance = new EdgioAgent();
pluginInstance.manifest = {
  id: 'edgio',
  capabilities: ['cloud', 'edgio'],
  version: '1.0.0'
};
