 ...
 *
 * Generated Integration Plugin for: Dynatrace Specialist AI
...
class DynatraceAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'dynatrace';
    this.description = `Expertly integrates and manages Dynatrace workflows for your stack.`;
...
export const pluginInstance = new DynatraceAgent();
pluginInstance.manifest = {
  id: 'dynatrace',
  capabilities: ['integration', 'dynatrace'],
  version: '1.0.0'
};
