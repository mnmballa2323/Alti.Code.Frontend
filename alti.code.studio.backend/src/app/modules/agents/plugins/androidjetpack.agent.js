 ...
 *
 * Generated Integration Plugin for: Android/Jetpack Specialist AI
 * Category: Mobile
 */
...
class AndroidJetpackAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'androidJetpack';
    this.description = `Builds native Android apps with Jetpack Compose, Hilt DI, Room persistence, and Play Store optimization.`;
...
export const pluginInstance = new AndroidJetpackAgent();
pluginInstance.manifest = {
  id: 'androidJetpack',
  capabilities: ['mobile', 'androidjetpack'],
  version: '1.0.0'
};
