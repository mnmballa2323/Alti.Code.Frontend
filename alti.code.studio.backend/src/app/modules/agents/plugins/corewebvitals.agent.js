 ...
 *
 * Generated Integration Plugin for: Core Web Vitals AI
 * Category: Frontend
 */
...
class CoreWebVitalsAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'coreWebVitals';
    this.description = `Diagnoses laggy client pages, reducing script payloads and optimizing render times.`;
...
export const pluginInstance = new CoreWebVitalsAgent();
pluginInstance.manifest = {
  id: 'coreWebVitals',
  capabilities: ['frontend', 'corewebvitals'],
  version: '1.0.0'
};
