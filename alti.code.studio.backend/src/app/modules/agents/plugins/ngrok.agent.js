 ...
 *
 * Generated Integration Plugin for: Ngrok Specialist AI
...
class NgrokAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'ngrok';
    this.description = `Expertly integrates and manages Ngrok workflows for your stack.`;
...
export const pluginInstance = new NgrokAgent();
pluginInstance.manifest = {
  id: 'ngrok',
  capabilities: ['integration', 'ngrok'],
  version: '1.0.0'
};
