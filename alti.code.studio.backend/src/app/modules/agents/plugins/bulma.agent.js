 ...
 *
 * Generated Integration Plugin for: Bulma Specialist AI
 * Category: Framework
 */
...
class BulmaAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'bulma';
    this.description = `Designs and implements robust applications using Bulma.`;
...
export const pluginInstance = new BulmaAgent();
pluginInstance.manifest = {
  id: 'bulma',
  capabilities: ['framework', 'bulma'],
  version: '1.0.0'
};
