 ...
 *
 * Generated Integration Plugin for: Builder.io Specialist AI
...
class BuilderioAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'builderio';
    this.description = `Expertly integrates and manages Builder.io workflows for your stack.`;
...
export const pluginInstance = new BuilderioAgent();
pluginInstance.manifest = {
  id: 'builderio',
  capabilities: ['integration', 'builderio'],
  version: '1.0.0'
};
