 ...
 *
 * Generated Integration Plugin for: SigNoz Specialist AI
 * Category: Monitoring
 */
...
class SigNozAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'sigNoz';
    this.description = `Builds full-stack observability with SigNoz for APM, logs, metrics, and infrastructure monitoring.`;
...
export const pluginInstance = new SigNozAgent();
pluginInstance.manifest = {
  id: 'sigNoz',
  capabilities: ['monitoring', 'signoz'],
  version: '1.0.0'
};
