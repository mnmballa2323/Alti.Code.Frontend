 ...
 *
 * Generated Integration Plugin for: HiBob Specialist AI
...
class HiBobAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'hiBob';
    this.description = `Expertly integrates and manages HiBob workflows for your stack.`;
...
export const pluginInstance = new HiBobAgent();
pluginInstance.manifest = {
  id: 'hiBob',
  capabilities: ['integration', 'hibob'],
  version: '1.0.0'
};
