 ...
 *
 * Generated Integration Plugin for: GameMaker Specialist AI
 * Category: Game Dev
 */
...
class GameMakerAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'gameMaker';
    this.description = `Expert in GameMaker development, specializing in gameplay, physics, and rendering optimization.`;
...
export const pluginInstance = new GameMakerAgent();
pluginInstance.manifest = {
  id: 'gameMaker',
  capabilities: ['game dev', 'gamemaker'],
  version: '1.0.0'
};
