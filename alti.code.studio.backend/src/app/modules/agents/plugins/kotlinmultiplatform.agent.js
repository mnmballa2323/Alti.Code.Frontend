 ...
 *
 * Generated Integration Plugin for: Kotlin Multiplatform AI
 * Category: Mobile
 */
...
class KotlinMultiplatformAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'kotlinMultiplatform';
    this.description = `Architects Kotlin Multiplatform projects for shared business logic across iOS, Android, Web, and Desktop.`;
...
export const pluginInstance = new KotlinMultiplatformAgent();
pluginInstance.manifest = {
  id: 'kotlinMultiplatform',
  capabilities: ['mobile', 'kotlinmultiplatform'],
  version: '1.0.0'
};
