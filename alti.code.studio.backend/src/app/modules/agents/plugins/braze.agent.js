 ...
 *
 * Generated Integration Plugin for: Braze Specialist AI
...
class BrazeAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'braze';
    this.description = `Expertly integrates and manages Braze workflows for your stack.`;
...
export const pluginInstance = new BrazeAgent();
pluginInstance.manifest = {
  id: 'braze',
  capabilities: ['integration', 'braze'],
  version: '1.0.0'
};
