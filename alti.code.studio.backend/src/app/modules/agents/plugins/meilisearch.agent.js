 ...
 *
 * Generated Integration Plugin for: Meilisearch Specialist AI
 * Category: Search
 */
...
class MeilisearchAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description = `Integrates and configures Meilisearch services into your application.`;
...
export const pluginInstance = new MeilisearchAgent();
pluginInstance.manifest = {
  id: 'meilisearch',
  capabilities: ['search', 'meilisearch'],
  version: '1.0.0'
};
