 ...
 *
 * Generated Integration Plugin for: Oracle NetSuite Specialist AI
 * Category: Cloud
 */
...
class OracleNetSuiteAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'oracleNetSuite';
    this.description = `Provisions and maintains robust systems on Oracle NetSuite.`;
...
export const pluginInstance = new OracleNetSuiteAgent();
pluginInstance.manifest = {
  id: 'oracleNetSuite',
  capabilities: ['cloud', 'oraclenetsuite'],
  version: '1.0.0'
};
