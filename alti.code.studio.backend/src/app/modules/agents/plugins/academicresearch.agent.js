 ...
 *
 * Generated Integration Plugin for: Academic Research AI
 * Category: Research
 */
...
class AcademicResearchAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'academicResearch';
    this.description = `Conducts systematic literature reviews, citation analysis, and meta-analyses across academic databases.`;
...
export const pluginInstance = new AcademicResearchAgent();
pluginInstance.manifest = {
  id: 'academicResearch',
  capabilities: ['research', 'academicresearch'],
  version: '1.0.0'
};
