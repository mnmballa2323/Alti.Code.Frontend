 ...
 *
 * Generated Integration Plugin for: Customer.io Specialist AI
...
class CustomerioAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'customerio';
    this.description = `Expertly integrates and manages Customer.io workflows for your stack.`;
...
export const pluginInstance = new CustomerioAgent();
pluginInstance.manifest = {
  id: 'customerio',
  capabilities: ['integration', 'customerio'],
  version: '1.0.0'
};
