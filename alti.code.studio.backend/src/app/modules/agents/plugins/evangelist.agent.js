 ...
 *
 * Generated Integration Plugin for: Evangelist AI
...
class EvangelistAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'evangelist';
    this.description = `Ensures APIs are developer-friendly, building walkthrough resources and testing integration steps.`;
...
export const pluginInstance = new EvangelistAgent();
pluginInstance.manifest = {
  id: 'evangelist',
  capabilities: ['architecture', 'evangelist'],
  version: '1.0.0'
};
