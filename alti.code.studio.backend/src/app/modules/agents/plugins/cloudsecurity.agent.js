 ...
 *
 * Generated Integration Plugin for: Cloud Security AI
 * Category: Security
 */
...
class CloudSecurityAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'cloudSecurity';
    this.description = `Secures cloud environments with CSPM, workload protection, identity entitlement management, and compliance automation.`;
...
export const pluginInstance = new CloudSecurityAgent();
pluginInstance.manifest = {
  id: 'cloudSecurity',
  capabilities: ['security', 'cloudsecurity'],
  version: '1.0.0'
};
