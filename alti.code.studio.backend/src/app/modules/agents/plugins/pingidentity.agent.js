 ...
 *
 * Generated Integration Plugin for: Ping Identity Specialist AI
...
class PingIdentityAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'pingIdentity';
    this.description = `Expertly integrates and manages Ping Identity workflows for your stack.`;
...
export const pluginInstance = new PingIdentityAgent();
pluginInstance.manifest = {
  id: 'pingIdentity',
  capabilities: ['integration', 'pingidentity'],
  version: '1.0.0'
};
