 ...
 *
 * Generated Integration Plugin for: Convex Specialist AI
...
class ConvexAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'convex';
    this.description = `Develops reactive backends with Convex for real-time queries, mutations, and scheduled functions.`;
...
export const pluginInstance = new ConvexAgent();
pluginInstance.manifest = {
  id: 'convex',
  capabilities: ['backend as a service', 'convex'],
  version: '1.0.0'
};
