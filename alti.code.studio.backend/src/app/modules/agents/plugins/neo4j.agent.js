 ...
 *
 * Generated Integration Plugin for: Neo4j Specialist AI
...
class Neo4jAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'neo4j';
    this.description = `Expertly integrates and manages Neo4j workflows for your stack.`;
...
export const pluginInstance = new Neo4jAgent();
pluginInstance.manifest = {
  id: 'neo4j',
  capabilities: ['integration', 'neo4j'],
  version: '1.0.0'
};
