 ...
 *
 * Generated Integration Plugin for: LlamaIndex Specialist AI
 * Category: AI
 */
...
class LlamaIndexAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'llamaIndex';
    this.description = `Builds intelligent data retrieval systems with LlamaIndex for LLM-powered applications.`;
...
export const pluginInstance = new LlamaIndexAgent();
pluginInstance.manifest = {
  id: 'llamaIndex',
  capabilities: ['ai', 'llamaindex'],
  version: '1.0.0'
};
