 ...
 *
 * Generated Integration Plugin for: Parse Server Specialist AI
...
class ParseServerAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'parseServer';
    this.description = `Deploys Parse Server backends with Cloud Code, live queries, push notifications, and GraphQL support.`;
...
export const pluginInstance = new ParseServerAgent();
pluginInstance.manifest = {
  id: 'parseServer',
  capabilities: ['backend as a service', 'parseserver'],
  version: '1.0.0'
};
