 ...
 *
 * Generated Integration Plugin for: TypeScript Specialist AI
 * Category: Language
 */
...
class TypeScriptAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'typeScript';
    this.description = `Expertly writes, analyzes, and refactors TypeScript code.`;
...
export const pluginInstance = new TypeScriptAgent();
