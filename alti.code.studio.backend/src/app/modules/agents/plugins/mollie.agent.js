 ...
 *
 * Generated Integration Plugin for: Mollie Specialist AI
...
class MollieAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'mollie';
    this.description = `Expertly integrates and manages Mollie workflows for your stack.`;
...
export const pluginInstance = new MollieAgent();
pluginInstance.manifest = {
  id: 'mollie',
  capabilities: ['integration', 'mollie'],
  version: '1.0.0'
};
