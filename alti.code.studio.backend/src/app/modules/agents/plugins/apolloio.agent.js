 ...
 *
 * Generated Integration Plugin for: Apollo.io Specialist AI
...
class ApolloioAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'apolloio';
    this.description = `Expertly integrates and manages Apollo.io workflows for your stack.`;
...
export const pluginInstance = new ApolloioAgent();
pluginInstance.manifest = {
  id: 'apolloio',
  capabilities: ['integration', 'apolloio'],
  version: '1.0.0'
};
