 ...
 *
 * Generated Integration Plugin for: Technical Writing AI
...
class TechnicalWritingAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'technicalWriting';
    this.description = `Creates comprehensive technical documentation including API references, ADRs, runbooks, and style guides.`;
...
export const pluginInstance = new TechnicalWritingAgent();
pluginInstance.manifest = {
  id: 'technicalWriting',
  capabilities: ['documentation', 'technicalwriting'],
  version: '1.0.0'
};
