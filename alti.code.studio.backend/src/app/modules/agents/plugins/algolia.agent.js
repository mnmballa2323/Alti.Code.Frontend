 ...
 *
 * Generated Integration Plugin for: Algolia Specialist AI
 * Category: Search
 */
...
class AlgoliaAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'algolia';
    this.description = `Integrates and configures Algolia services into your application.`;
...
export const pluginInstance = new AlgoliaAgent();
pluginInstance.manifest = {
  id: 'algolia',
  capabilities: ['search', 'algolia'],
  version: '1.0.0'
};
