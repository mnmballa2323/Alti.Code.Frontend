 ...
 *
 * Generated Integration Plugin for: Koa Specialist AI
 * Category: Framework
 */
...
class KoaAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'koa';
    this.description = `Designs and implements robust applications using Koa.`;
...
export const pluginInstance = new KoaAgent();
pluginInstance.manifest = {
  id: 'koa',
  capabilities: ['framework', 'koa'],
  version: '1.0.0'
};
