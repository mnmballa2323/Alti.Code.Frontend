 ...
 *
 * Generated Integration Plugin for: Groovy Specialist AI
 * Category: Language
 */
...
class GroovyAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'groovy';
    this.description = `Expertly writes, analyzes, and refactors Groovy code.`;
...
export const pluginInstance = new GroovyAgent();
pluginInstance.manifest = {
  id: 'groovy',
  capabilities: ['language', 'groovy'],
  version: '1.0.0'
};
