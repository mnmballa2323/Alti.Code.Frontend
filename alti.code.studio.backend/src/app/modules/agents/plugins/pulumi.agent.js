 ...
 *
 * Generated Integration Plugin for: Pulumi Specialist AI
...
class PulumiAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'pulumi';
    this.description = `Expertly integrates and manages Pulumi workflows for your stack.`;
...
export const pluginInstance = new PulumiAgent();
pluginInstance.manifest = {
  id: 'pulumi',
  capabilities: ['integration', 'pulumi'],
  version: '1.0.0'
};
