 ...
 *
 * Generated Integration Plugin for: MongoDB Atlas Specialist AI
 * Category: Cloud
 */
...
class MongoDBAtlasAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'mongoDBAtlas';
    this.description = `Provisions and maintains robust systems on MongoDB Atlas.`;
...
export const pluginInstance = new MongoDBAtlasAgent();
pluginInstance.manifest = {
  id: 'mongoDBAtlas',
  capabilities: ['cloud', 'mongodbatlas'],
  version: '1.0.0'
};
