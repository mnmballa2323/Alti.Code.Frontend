 ...
 *
 * Generated Integration Plugin for: Apex Specialist AI
 * Category: Language
 */
...
class ApexAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'apex';
    this.description = `Expertly writes, analyzes, and refactors Apex code.`;
...
export const pluginInstance = new ApexAgent();
pluginInstance.manifest = {
  id: 'apex',
  capabilities: ['language', 'apex'],
  version: '1.0.0'
};
