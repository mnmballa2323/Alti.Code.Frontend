 ...
 *
 * Generated Integration Plugin for: BigCommerce Specialist AI
...
class BigCommerceAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'bigCommerce';
    this.description = `Expertly integrates and manages BigCommerce workflows for your stack.`;
...
export const pluginInstance = new BigCommerceAgent();
pluginInstance.manifest = {
  id: 'bigCommerce',
  capabilities: ['integration', 'bigcommerce'],
  version: '1.0.0'
};
