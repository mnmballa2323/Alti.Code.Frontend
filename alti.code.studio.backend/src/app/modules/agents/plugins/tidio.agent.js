 ...
 *
 * Generated Integration Plugin for: Tidio Specialist AI
...
class TidioAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'tidio';
    this.description = `Expertly integrates and manages Tidio workflows for your stack.`;
...
export const pluginInstance = new TidioAgent();
pluginInstance.manifest = {
  id: 'tidio',
  capabilities: ['integration', 'tidio'],
  version: '1.0.0'
};
