 ...
 *
 * Generated Integration Plugin for: Tableau Specialist AI
 * Category: Analytics
 */
...
class TableauAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'tableau';
    this.description = `Creates compelling data visualizations and enterprise dashboards with Tableau.`;
...
export const pluginInstance = new TableauAgent();
pluginInstance.manifest = {
  id: 'tableau',
  capabilities: ['analytics', 'tableau'],
  version: '1.0.0'
};
