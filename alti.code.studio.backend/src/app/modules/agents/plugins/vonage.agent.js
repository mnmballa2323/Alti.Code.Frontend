 ...
 *
 * Generated Integration Plugin for: Vonage Specialist AI
...
class VonageAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'vonage';
    this.description = `Expertly integrates and manages Vonage workflows for your stack.`;
...
export const pluginInstance = new VonageAgent();
pluginInstance.manifest = {
  id: 'vonage',
  capabilities: ['integration', 'vonage'],
  version: '1.0.0'
};
