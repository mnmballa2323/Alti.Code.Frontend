 ...
 *
 * Generated Integration Plugin for: Clearbit Specialist AI
...
class ClearbitAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'clearbit';
    this.description = `Expertly integrates and manages Clearbit workflows for your stack.`;
...
export const pluginInstance = new ClearbitAgent();
pluginInstance.manifest = {
  id: 'clearbit',
  capabilities: ['integration', 'clearbit'],
  version: '1.0.0'
};
