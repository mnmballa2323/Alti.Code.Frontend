 ...
 *
 * Generated Integration Plugin for: Asana Specialist AI
...
class AsanaAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'asana';
    this.description = `Integrates and configures Asana services into your application.`;
...
export const pluginInstance = new AsanaAgent();
pluginInstance.manifest = {
  id: 'asana',
  capabilities: ['productivity', 'asana'],
  version: '1.0.0'
};
