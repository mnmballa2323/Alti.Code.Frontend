 ...
 *
 * Generated Integration Plugin for: Jest Testing Specialist AI
 * Category: QA
 */
...
class JestTestingAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'jestTesting';
    this.description = `Creates comprehensive unit test suites with Jest including mocks, snapshots, and coverage analysis.`;
...
export const pluginInstance = new JestTestingAgent();
pluginInstance.manifest = {
  id: 'jestTesting',
  capabilities: ['qa', 'jesttesting'],
  version: '1.0.0'
};
