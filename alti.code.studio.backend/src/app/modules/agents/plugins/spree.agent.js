 ...
 *
 * Generated Integration Plugin for: Spree Specialist AI
...
class SpreeAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'spree';
    this.description = `Expertly integrates and manages Spree workflows for your stack.`;
...
export const pluginInstance = new SpreeAgent();
pluginInstance.manifest = {
  id: 'spree',
  capabilities: ['integration', 'spree'],
  version: '1.0.0'
};
