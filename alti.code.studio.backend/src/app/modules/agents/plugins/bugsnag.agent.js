 ...
 *
 * Generated Integration Plugin for: Bugsnag Specialist AI
...
class BugsnagAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'bugsnag';
    this.description = `Expertly integrates and manages Bugsnag workflows for your stack.`;
...
export const pluginInstance = new BugsnagAgent();
pluginInstance.manifest = {
  id: 'bugsnag',
  capabilities: ['integration', 'bugsnag'],
  version: '1.0.0'
};
