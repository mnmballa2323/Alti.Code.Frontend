 ...
 *
 * Generated Integration Plugin for: MonoGame Specialist AI
 * Category: Game Dev
 */
...
class MonoGameAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'monoGame';
    this.description = `Expert in MonoGame development, specializing in gameplay, physics, and rendering optimization.`;
...
export const pluginInstance = new MonoGameAgent();
pluginInstance.manifest = {
  id: 'monoGame',
  capabilities: ['game dev', 'monogame'],
  version: '1.0.0'
};
