 ...
 *
 * Generated Integration Plugin for: Tencent Cloud Specialist AI
 * Category: Cloud
 */
...
class TencentCloudAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'tencentCloud';
    this.description = `Provisions and maintains robust systems on Tencent Cloud.`;
...
export const pluginInstance = new TencentCloudAgent();
pluginInstance.manifest = {
  id: 'tencentCloud',
  capabilities: ['cloud', 'tencentcloud'],
  version: '1.0.0'
};
