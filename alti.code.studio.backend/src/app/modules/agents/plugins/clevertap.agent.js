 ...
 *
 * Generated Integration Plugin for: Clevertap Specialist AI
...
class ClevertapAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'clevertap';
    this.description = `Expertly integrates and manages Clevertap workflows for your stack.`;
...
export const pluginInstance = new ClevertapAgent();
pluginInstance.manifest = {
  id: 'clevertap',
  capabilities: ['integration', 'clevertap'],
  version: '1.0.0'
};
