 ...
 *
 * Generated Integration Plugin for: Notion Specialist AI
...
class NotionAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'notion';
    this.description = `Integrates and configures Notion services into your application.`;
...
export const pluginInstance = new NotionAgent();
pluginInstance.manifest = {
  id: 'notion',
  capabilities: ['productivity', 'notion'],
  version: '1.0.0'
};
