 ...
 *
 * Generated Integration Plugin for: Typesense Specialist AI
...
class TypesenseAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'typesense';
    this.description = `Expertly integrates and manages Typesense workflows for your stack.`;
...
export const pluginInstance = new TypesenseAgent();
pluginInstance.manifest = {
  id: 'typesense',
  capabilities: ['integration', 'typesense'],
  version: '1.0.0'
};
