 ...
 *
 * Generated Integration Plugin for: Breezy Specialist AI
...
class BreezyAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'breezy';
    this.description = `Expertly integrates and manages Breezy workflows for your stack.`;
...
export const pluginInstance = new BreezyAgent();
pluginInstance.manifest = {
  id: 'breezy',
  capabilities: ['integration', 'breezy'],
  version: '1.0.0'
};
