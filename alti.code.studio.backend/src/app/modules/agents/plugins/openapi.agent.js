 ...
 *
 * Generated Integration Plugin for: OpenAPI Specialist AI
 * Category: API
 */
...
class OpenAPIAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'openAPI';
    this.description = `Designs contract-first APIs with OpenAPI specifications, code generation, and interactive documentation.`;
...
export const pluginInstance = new OpenAPIAgent();
