 ...
 *
 * Generated Integration Plugin for: Help Center AI
...
class HelpCenterAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'helpCenter';
    this.description = `Designs help center knowledge bases with content taxonomy, search optimization, and ticket deflection.`;
...
export const pluginInstance = new HelpCenterAgent();
pluginInstance.manifest = {
  id: 'helpCenter',
  capabilities: ['customer support', 'helpcenter'],
  version: '1.0.0'
};
