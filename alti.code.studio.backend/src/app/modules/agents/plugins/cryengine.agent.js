 ...
 *
 * Generated Integration Plugin for: CryEngine Specialist AI
 * Category: Game Dev
 */
...
class CryEngineAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'cryEngine';
    this.description = `Expert in CryEngine development, specializing in gameplay, physics, and rendering optimization.`;
...
export const pluginInstance = new CryEngineAgent();
pluginInstance.manifest = {
  id: 'cryEngine',
  capabilities: ['game dev', 'cryengine'],
  version: '1.0.0'
};
