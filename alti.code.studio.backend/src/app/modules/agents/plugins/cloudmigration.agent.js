 ...
 *
 * Generated Integration Plugin for: Cloud Migration AI
...
class CloudMigrationAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'cloudMigration';
    this.description = `Plans and executes cloud migrations using 6R strategy, landing zone design, and total cost of ownership analysis.`;
...
export const pluginInstance = new CloudMigrationAgent();
pluginInstance.manifest = {
  id: 'cloudMigration',
  capabilities: ['architecture', 'cloudmigration'],
  version: '1.0.0'
};
