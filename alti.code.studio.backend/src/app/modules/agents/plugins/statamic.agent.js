 ...
 *
 * Generated Integration Plugin for: Statamic Specialist AI
...
class StatamicAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'statamic';
    this.description = `Expertly integrates and manages Statamic workflows for your stack.`;
...
export const pluginInstance = new StatamicAgent();
pluginInstance.manifest = {
  id: 'statamic',
  capabilities: ['integration', 'statamic'],
  version: '1.0.0'
};
