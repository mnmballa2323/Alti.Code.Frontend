 ...
 *
 * Generated Integration Plugin for: WP Engine Specialist AI
 * Category: Cloud
 */
...
class WPEngineAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'wPEngine';
    this.description = `Provisions and maintains robust systems on WP Engine.`;
...
export const pluginInstance = new WPEngineAgent();
pluginInstance.manifest = {
  id: 'wPEngine',
  capabilities: ['cloud', 'wpengine'],
  version: '1.0.0'
};
