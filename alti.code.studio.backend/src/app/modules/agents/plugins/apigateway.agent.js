 ...
 *
 * Generated Integration Plugin for: API Gateway Specialist AI
 * Category: API
 */
...
class APIGatewayAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'aPIGateway';
    this.description = `Designs API gateway architectures for rate limiting, auth, transformation, and version management.`;
...
export const pluginInstance = new APIGatewayAgent();
pluginInstance.manifest = {
  id: 'aPIGateway',
  capabilities: ['api', 'apigateway'],
  version: '1.0.0'
};
