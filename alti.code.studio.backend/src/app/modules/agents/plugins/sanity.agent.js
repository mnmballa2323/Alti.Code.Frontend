 ...
 *
 * Generated Integration Plugin for: Sanity Specialist AI
 * Category: CMS
 */
...
class SanityAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'sanity';
    this.description = `Integrates and configures Sanity services into your application.`;
...
export const pluginInstance = new SanityAgent();
pluginInstance.manifest = {
  id: 'sanity',
  capabilities: ['cms', 'sanity'],
  version: '1.0.0'
};
