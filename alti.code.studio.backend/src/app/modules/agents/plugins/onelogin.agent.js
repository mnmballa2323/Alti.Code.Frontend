 ...
 *
 * Generated Integration Plugin for: OneLogin Specialist AI
...
class OneLoginAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'oneLogin';
    this.description = `Expertly integrates and manages OneLogin workflows for your stack.`;
...
export const pluginInstance = new OneLoginAgent();
pluginInstance.manifest = {
  id: 'oneLogin',
  capabilities: ['integration', 'onelogin'],
  version: '1.0.0'
};
