 ...
 *
 * Generated Integration Plugin for: Contentful Specialist AI
 * Category: CMS
 */
...
class ContentfulAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description = `Integrates and configures Contentful services into your application.`;
...
export const pluginInstance = new ContentfulAgent();
pluginInstance.manifest = {
  id: 'contentful',
  capabilities: ['cms', 'contentful'],
  version: '1.0.0'
};
