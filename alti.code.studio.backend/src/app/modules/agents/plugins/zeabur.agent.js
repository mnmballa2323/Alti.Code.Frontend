 ...
 *
 * Generated Integration Plugin for: Zeabur Specialist AI
 * Category: Cloud
 */
...
class ZeaburAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'zeabur';
    this.description = `Provisions and maintains robust systems on Zeabur.`;
...
export const pluginInstance = new ZeaburAgent();
pluginInstance.manifest = {
  id: 'zeabur',
  capabilities: ['cloud', 'zeabur'],
  version: '1.0.0'
};
