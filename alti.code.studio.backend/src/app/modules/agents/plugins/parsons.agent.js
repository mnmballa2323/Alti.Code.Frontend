 ...
 *
 * Generated Integration Plugin for: Parsons AI
 * Category: Systems
 */
...
class ParsonsAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'parsons';
    this.description = `Translates digital designs into precise physical movements for manufacturing hardware.`;
...
export const pluginInstance = new ParsonsAgent();
pluginInstance.manifest = {
  id: 'parsons',
  capabilities: ['systems', 'parsons'],
  version: '1.0.0'
};
