 ...
 *
 * Generated Integration Plugin for: Basecamp Specialist AI
...
class BasecampAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'basecamp';
    this.description = `Expertly integrates and manages Basecamp workflows for your stack.`;
...
export const pluginInstance = new BasecampAgent();
pluginInstance.manifest = {
  id: 'basecamp',
  capabilities: ['integration', 'basecamp'],
  version: '1.0.0'
};
