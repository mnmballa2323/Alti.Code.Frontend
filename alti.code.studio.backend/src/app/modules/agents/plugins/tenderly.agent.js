 ...
 *
 * Generated Integration Plugin for: Tenderly Specialist AI
...
class TenderlyAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'tenderly';
    this.description = `Expertly integrates and manages Tenderly workflows for your stack.`;
...
export const pluginInstance = new TenderlyAgent();
pluginInstance.manifest = {
  id: 'tenderly',
  capabilities: ['integration', 'tenderly'],
  version: '1.0.0'
};
