 ...
 *
 * Generated Integration Plugin for: Crash Analysis AI
 * Category: Debugging
 */
...
class CrashAnalysisAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'crashAnalysis';
    this.description = `Analyzes crash dumps, stack traces, and signal handlers to identify root causes of application crashes.`;
...
export const pluginInstance = new CrashAnalysisAgent();
pluginInstance.manifest = {
  id: 'crashAnalysis',
  capabilities: ['debugging', 'crashanalysis'],
  version: '1.0.0'
};
