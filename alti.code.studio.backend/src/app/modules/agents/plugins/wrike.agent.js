 ...
 *
 * Generated Integration Plugin for: Wrike Specialist AI
...
class WrikeAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'wrike';
    this.description = `Expertly integrates and manages Wrike workflows for your stack.`;
...
export const pluginInstance = new WrikeAgent();
pluginInstance.manifest = {
  id: 'wrike',
  capabilities: ['integration', 'wrike'],
  version: '1.0.0'
};
