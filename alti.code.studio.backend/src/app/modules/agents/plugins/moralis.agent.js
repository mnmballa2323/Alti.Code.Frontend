 ...
 *
 * Generated Integration Plugin for: Moralis Specialist AI
...
class MoralisAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'moralis';
    this.description = `Expertly integrates and manages Moralis workflows for your stack.`;
...
export const pluginInstance = new MoralisAgent();
pluginInstance.manifest = {
  id: 'moralis',
  capabilities: ['integration', 'moralis'],
  version: '1.0.0'
};
