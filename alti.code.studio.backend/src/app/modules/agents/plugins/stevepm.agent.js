 ...
 *
 * Generated Integration Plugin for: Steve AI (PM)
...
class StevePMAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'stevePM';
    this.description = `Prunes unnecessary bloat, scoping the minimal viable feature set to validate quickly.`;
...
export const pluginInstance = new StevePMAgent();
pluginInstance.manifest = {
  id: 'stevePM',
  capabilities: ['architecture', 'stevepm'],
  version: '1.0.0'
};
