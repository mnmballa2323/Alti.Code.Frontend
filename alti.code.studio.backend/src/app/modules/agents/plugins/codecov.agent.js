 ...
 *
 * Generated Integration Plugin for: Codecov Specialist AI
...
class CodecovAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'codecov';
    this.description = `Expertly integrates and manages Codecov workflows for your stack.`;
...
export const pluginInstance = new CodecovAgent();
pluginInstance.manifest = {
  id: 'codecov',
  capabilities: ['integration', 'codecov'],
  version: '1.0.0'
};
