 ...
 *
 * Generated Integration Plugin for: SEO Specialist AI
 * Category: Marketing
 */
...
class SEOAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'sEO';
    this.description = `Optimizes websites for search engine visibility with technical SEO, schema markup, and content strategy.`;
...
export const pluginInstance = new SEOAgent();
