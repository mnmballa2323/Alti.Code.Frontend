 ...
 *
 * Generated Integration Plugin for: ServiceNow Workflow Dev AI
 * Category: Backend
 */
...
class ServiceNowWorkflowDevAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'serviceNowWorkflowDev';
    this.description = `Automates IT management scripts, designing record tables and business rules.`;
...
export const pluginInstance = new ServiceNowWorkflowDevAgent();
pluginInstance.manifest = {
  id: 'serviceNowWorkflowDev',
  capabilities: ['backend', 'servicenowworkflowdev'],
  version: '1.0.0'
};
