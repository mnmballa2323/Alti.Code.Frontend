 ...
 *
 * Generated Integration Plugin for: Zoho CRM Specialist AI
 * Category: CRM
 */
...
class ZohoCRMAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'zohoCRM';
    this.description = `Develops Zoho CRM customizations with Deluge scripting, blueprints, and multi-module integrations.`;
...
export const pluginInstance = new ZohoCRMAgent();
pluginInstance.manifest = {
  id: 'zohoCRM',
  capabilities: ['crm', 'zohocrm'],
  version: '1.0.0'
};
