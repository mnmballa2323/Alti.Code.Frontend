 ...
 *
 * Generated Integration Plugin for: Istio Service Mesh AI
...
class IstioServiceMeshAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'istioServiceMesh';
    this.description = `Designs service mesh architectures with Istio for traffic management, security, and observability.`;
...
export const pluginInstance = new IstioServiceMeshAgent();
pluginInstance.manifest = {
  id: 'istioServiceMesh',
  capabilities: ['infrastructure', 'istioservicemesh'],
  version: '1.0.0'
};
