 ...
 *
 * Generated Integration Plugin for: Sylius Specialist AI
...
class SyliusAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'sylius';
    this.description = `Expertly integrates and manages Sylius workflows for your stack.`;
...
export const pluginInstance = new SyliusAgent();
pluginInstance.manifest = {
  id: 'sylius',
  capabilities: ['integration', 'sylius'],
  version: '1.0.0'
};
