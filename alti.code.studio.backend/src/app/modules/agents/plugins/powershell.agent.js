 ...
 *
 * Generated Integration Plugin for: PowerShell Specialist AI
 * Category: Language
 */
...
class PowerShellAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description = `Expertly writes, analyzes, and refactors PowerShell code.`;
...
export const pluginInstance = new PowerShellAgent();
pluginInstance.manifest = {
  id: 'powerShell',
  capabilities: ['language', 'powershell'],
  version: '1.0.0'
};
