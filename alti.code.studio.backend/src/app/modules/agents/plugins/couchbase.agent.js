 ...
 *
 * Generated Integration Plugin for: Couchbase Specialist AI
...
class CouchbaseAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'couchbase';
    this.description = `Expertly integrates and manages Couchbase workflows for your stack.`;
...
export const pluginInstance = new CouchbaseAgent();
pluginInstance.manifest = {
  id: 'couchbase',
  capabilities: ['integration', 'couchbase'],
  version: '1.0.0'
};
