 ...
 *
 * Generated Integration Plugin for: Milvus Specialist AI
...
class MilvusAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'milvus';
    this.description = `Expertly integrates and manages Milvus workflows for your stack.`;
...
export const pluginInstance = new MilvusAgent();
pluginInstance.manifest = {
  id: 'milvus',
  capabilities: ['integration', 'milvus'],
  version: '1.0.0'
};
