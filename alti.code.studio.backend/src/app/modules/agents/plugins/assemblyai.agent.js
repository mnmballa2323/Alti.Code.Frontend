 ...
 *
 * Generated Integration Plugin for: AssemblyAI Specialist AI
...
class AssemblyAIAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'assemblyAI';
    this.description = `Expertly integrates and manages AssemblyAI workflows for your stack.`;
...
export const pluginInstance = new AssemblyAIAgent();
pluginInstance.manifest = {
  id: 'assemblyAI',
  capabilities: ['integration', 'assemblyai'],
  version: '1.0.0'
};
