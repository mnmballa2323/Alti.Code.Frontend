 ...
 *
 * Generated Integration Plugin for: Adyen Specialist AI
 * Category: Payments
 */
...
class AdyenAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'adyen';
    this.description = `Integrates and configures Adyen services into your application.`;
...
export const pluginInstance = new AdyenAgent();
pluginInstance.manifest = {
  id: 'adyen',
  capabilities: ['payments', 'adyen'],
  version: '1.0.0'
};
