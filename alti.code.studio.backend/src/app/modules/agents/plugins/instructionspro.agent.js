 ...
 *
 * Generated Integration Plugin for: Instructions Pro AI
 * Category: AI
 */
...
class InstructionsProAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'instructionsPro';
    this.description = `Writes system directives and structures markdown outputs for foundational models.`;
...
export const pluginInstance = new InstructionsProAgent();
pluginInstance.manifest = {
  id: 'instructionsPro',
  capabilities: ['ai', 'instructionspro'],
  version: '1.0.0'
};
