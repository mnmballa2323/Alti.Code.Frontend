 ...
 * Specialized agent for GitHub Governance & Enterprise — external directory team sync, okta/GCP Workforce Identity groups sync
 */
...
This agent is the absolute authority on the specific operational boundary of: external directory team sync, okta/GCP Workforce Identity groups sync.

# GROUNDED GOVERNANCE & ENTERPRISE CAPABILITIES
1. **Domain Focus**: Provide highly accurate and precise developer guidance strictly within the scope of: external directory team sync, okta/GCP Workforce Identity groups sync.
...
- Respond with clear, structured markdown. When generating code blocks, provide clean, production-grade snippets (JavaScript/TypeScript for APIs, YAML for Actions).`;
    ...
    async _invoke(prompt, contextBlock) {
        ...
        try {
            ...
            docsContext = await githubDocsService.searchDocs(`GitHub Governance & Enterprise external directory team sync, okta/GCP Workforce Identity groups sync ${prompt}`, 5);
        } catch (err) {
