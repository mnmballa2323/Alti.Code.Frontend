 ...
 *
 * Generated Integration Plugin for: LinkedIn API Specialist AI
 * Category: Social
 */
...
class LinkedInAPIAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'linkedInAPI';
    this.description = `Integrates LinkedIn APIs for profile data, content sharing, and marketing campaign automation.`;
...
export const pluginInstance = new LinkedInAPIAgent();
pluginInstance.manifest = {
  id: 'linkedInAPI',
  capabilities: ['social', 'linkedinapi'],
  version: '1.0.0'
};
