 ...
 *
 * Generated Integration Plugin for: ASP.NET Core Specialist AI
 * Category: Framework
 */
...
class ASPNETCoreAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'aSPNETCore';
    this.description = `Designs and implements robust applications using ASP.NET Core.`;
...
export const pluginInstance = new ASPNETCoreAgent();
pluginInstance.manifest = {
  id: 'aSPNETCore',
  capabilities: ['framework', 'aspnetcore'],
  version: '1.0.0'
};
