 ...
 *
 * Generated Integration Plugin for: Assembly Specialist AI
 * Category: Language
 */
...
class AssemblyAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'assembly';
    this.description = `Expertly writes, analyzes, and refactors Assembly code.`;
...
export const pluginInstance = new AssemblyAgent();
pluginInstance.manifest = {
  id: 'assembly',
  capabilities: ['language', 'assembly'],
  version: '1.0.0'
};
