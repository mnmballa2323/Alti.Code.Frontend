 ...
 *
 * Generated Integration Plugin for: David AI
 * Category: Creative
 */
...
class DavidAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'david';
    this.description = `Builds immersive cross-platform interactive experiences and games.`;
...
export const pluginInstance = new DavidAgent();
pluginInstance.manifest = {
  id: 'david',
  capabilities: ['creative', 'david'],
  version: '1.0.0'
};
