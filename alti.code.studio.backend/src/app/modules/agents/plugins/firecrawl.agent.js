 ...
 *
 * Generated Integration Plugin for: Firecrawl Specialist AI
 * Category: Scraping
 */
...
class FirecrawlAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'firecrawl';
    this.description = `Manages Firecrawl workflows seamlessly, operating natively within its ecosystem.`;
...
export const pluginInstance = new FirecrawlAgent();
pluginInstance.manifest = {
  id: 'firecrawl',
  capabilities: ['scraping', 'firecrawl'],
  version: '1.0.0'
};
