 ...
 *
 * Generated Integration Plugin for: Gusto Specialist AI
...
class GustoAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'gusto';
    this.description = `Expertly integrates and manages Gusto workflows for your stack.`;
...
export const pluginInstance = new GustoAgent();
pluginInstance.manifest = {
  id: 'gusto',
  capabilities: ['integration', 'gusto'],
  version: '1.0.0'
};
