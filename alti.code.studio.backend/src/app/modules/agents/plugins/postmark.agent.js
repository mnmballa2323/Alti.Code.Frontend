 ...
 *
 * Generated Integration Plugin for: Postmark Specialist AI
...
class PostmarkAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'postmark';
    this.description = `Expertly integrates and manages Postmark workflows for your stack.`;
...
export const pluginInstance = new PostmarkAgent();
pluginInstance.manifest = {
  id: 'postmark',
  capabilities: ['integration', 'postmark'],
  version: '1.0.0'
};
