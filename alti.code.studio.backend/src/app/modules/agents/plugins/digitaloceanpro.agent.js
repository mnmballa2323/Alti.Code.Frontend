 ...
 *
 * Generated Integration Plugin for: DigitalOcean Pro AI
 * Category: Cloud
 */
...
class DigitalOceanProAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'digitalOceanPro';
    this.description = `Builds simple, scalable virtual private servers and Kubernetes clusters on DigitalOcean.`;
...
export const pluginInstance = new DigitalOceanProAgent();
pluginInstance.manifest = {
  id: 'digitalOceanPro',
  capabilities: ['cloud', 'digitaloceanpro'],
  version: '1.0.0'
};
