...
- Respond with clear, structured markdown. When generating code blocks, provide clean, production-grade snippets (JavaScript/TypeScript for APIs).`;
    ...
    async _invoke(prompt, contextBlock) {
        ...
        try {
            ...
            docsContext = await gitlabDocsService.searchDocs(`GitLab Packages & Registry container registry, docker image repositories, deletion of registry repositories ${prompt}`, 5);
        } catch (err) {
