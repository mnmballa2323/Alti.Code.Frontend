 ...
 *
 * Generated Integration Plugin for: ActiveCampaign Specialist AI
...
class ActiveCampaignAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'activeCampaign';
    this.description = `Expertly integrates and manages ActiveCampaign workflows for your stack.`;
...
export const pluginInstance = new ActiveCampaignAgent();
pluginInstance.manifest = {
  id: 'activeCampaign',
  capabilities: ['integration', 'activecampaign'],
  version: '1.0.0'
};
