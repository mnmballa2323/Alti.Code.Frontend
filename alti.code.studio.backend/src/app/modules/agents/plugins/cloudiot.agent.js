 ...
 *
 * Generated Integration Plugin for: Cloud IoT Specialist AI
 * Category: IoT
 */
...
class CloudIoTAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'cloudIoT';
    this.description = `Builds cloud IoT platforms for device provisioning, telemetry processing, and over-the-air updates.`;
...
export const pluginInstance = new CloudIoTAgent();
pluginInstance.manifest = {
  id: 'cloudIoT',
  capabilities: ['iot', 'cloudiot'],
  version: '1.0.0'
};
