 ...
 *
 * Generated Integration Plugin for: New Relic Specialist AI
...
class NewRelicAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'newRelic';
    this.description = `Expertly integrates and manages New Relic workflows for your stack.`;
...
export const pluginInstance = new NewRelicAgent();
pluginInstance.manifest = {
  id: 'newRelic',
  capabilities: ['integration', 'newrelic'],
  version: '1.0.0'
};
