 ...
 *
 * Generated Integration Plugin for: ZoomInfo Specialist AI
...
class ZoomInfoAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'zoomInfo';
    this.description = `Expertly integrates and manages ZoomInfo workflows for your stack.`;
...
export const pluginInstance = new ZoomInfoAgent();
pluginInstance.manifest = {
  id: 'zoomInfo',
  capabilities: ['integration', 'zoominfo'],
  version: '1.0.0'
};
