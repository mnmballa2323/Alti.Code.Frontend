 ...
 *
 * Generated Integration Plugin for: Linear Specialist AI
...
class LinearAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'linear';
    this.description = `Integrates and configures Linear services into your application.`;
...
export const pluginInstance = new LinearAgent();
pluginInstance.manifest = {
  id: 'linear',
  capabilities: ['productivity', 'linear'],
  version: '1.0.0'
};
