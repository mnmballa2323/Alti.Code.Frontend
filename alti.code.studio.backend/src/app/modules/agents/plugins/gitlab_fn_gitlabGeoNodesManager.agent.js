...
- Respond with clear, structured markdown. When generating code blocks, provide clean, production-grade snippets (JavaScript/TypeScript for APIs).`;
    ...
    async _invoke(prompt, contextBlock) {
        ...
        try {
            ...
            docsContext = await gitlabDocsService.searchDocs(`GitLab Geo & Replication Geo replication nodes, multi-region database setup, replication configurations ${prompt}`, 5);
        } catch (err) {
