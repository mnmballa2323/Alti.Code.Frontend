 ...
 *
 * Generated Integration Plugin for: Storyblok Specialist AI
...
class StoryblokAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'storyblok';
    this.description = `Expertly integrates and manages Storyblok workflows for your stack.`;
...
export const pluginInstance = new StoryblokAgent();
pluginInstance.manifest = {
  id: 'storyblok',
  capabilities: ['integration', 'storyblok'],
  version: '1.0.0'
};
