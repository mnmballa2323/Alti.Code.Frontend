 ...
 *
 * Generated Integration Plugin for: Ada Specialist AI
 * Category: Language
 */
...
class AdaAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'ada';
    this.description = `Expertly writes, analyzes, and refactors Ada code.`;
...
export const pluginInstance = new AdaAgent();
pluginInstance.manifest = {
  id: 'ada',
  capabilities: ['language', 'ada'],
  version: '1.0.0'
};
