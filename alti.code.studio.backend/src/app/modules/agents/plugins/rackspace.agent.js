 ...
 *
 * Generated Integration Plugin for: Rackspace Specialist AI
 * Category: Cloud
 */
...
class RackspaceAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'rackspace';
    this.description = `Provisions and maintains robust systems on Rackspace.`;
...
export const pluginInstance = new RackspaceAgent();
pluginInstance.manifest = {
  id: 'rackspace',
  capabilities: ['cloud', 'rackspace'],
  version: '1.0.0'
};
