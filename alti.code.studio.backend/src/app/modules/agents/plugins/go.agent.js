 ...
 *
 * Generated Integration Plugin for: Go Specialist AI
 * Category: Language
 */
...
class GoAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'go';
    this.description = `Expertly writes, analyzes, and refactors Go code.`;
...
export const pluginInstance = new GoAgent();
pluginInstance.manifest = {
  id: 'go',
  capabilities: ['language', 'go'],
  version: '1.0.0'
};
