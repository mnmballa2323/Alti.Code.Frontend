 ...
 *
 * Generated Integration Plugin for: Unity Specialist AI
 * Category: Game Dev
 */
...
class UnityAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'unity';
    this.description = `Expert in Unity development, specializing in gameplay, physics, and rendering optimization.`;
...
export const pluginInstance = new UnityAgent();
pluginInstance.manifest = {
  id: 'unity',
  capabilities: ['game dev', 'unity'],
  version: '1.0.0'
};
