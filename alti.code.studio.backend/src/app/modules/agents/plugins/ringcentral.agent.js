 ...
 *
 * Generated Integration Plugin for: RingCentral Specialist AI
...
class RingCentralAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'ringCentral';
    this.description = `Expertly integrates and manages RingCentral workflows for your stack.`;
...
export const pluginInstance = new RingCentralAgent();
pluginInstance.manifest = {
  id: 'ringCentral',
  capabilities: ['integration', 'ringcentral'],
  version: '1.0.0'
};
