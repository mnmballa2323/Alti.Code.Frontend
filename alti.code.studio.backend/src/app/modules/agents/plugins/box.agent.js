 ...
 *
 * Generated Integration Plugin for: Box Specialist AI
...
class BoxAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'box';
    this.description = `Expertly integrates and manages Box workflows for your stack.`;
...
export const pluginInstance = new BoxAgent();
pluginInstance.manifest = {
  id: 'box',
  capabilities: ['integration', 'box'],
  version: '1.0.0'
};
