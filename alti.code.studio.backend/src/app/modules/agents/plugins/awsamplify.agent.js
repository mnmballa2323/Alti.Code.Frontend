 ...
 *
 * Generated Integration Plugin for: AWS Amplify Specialist AI
...
class AWSAmplifyAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'aWSAmplify';
    this.description = `Builds full-stack apps with AWS Amplify including authentication, GraphQL APIs, storage, and hosting.`;
...
export const pluginInstance = new AWSAmplifyAgent();
pluginInstance.manifest = {
  id: 'aWSAmplify',
  capabilities: ['backend as a service', 'awsamplify'],
  version: '1.0.0'
};
