 ...
 *
 * Generated Integration Plugin for: Help Scout Specialist AI
...
class HelpScoutAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'helpScout';
    this.description = `Expertly integrates and manages Help Scout workflows for your stack.`;
...
export const pluginInstance = new HelpScoutAgent();
pluginInstance.manifest = {
  id: 'helpScout',
  capabilities: ['integration', 'helpscout'],
  version: '1.0.0'
};
