 ...
 *
 * Generated Integration Plugin for: Affirm Specialist AI
...
class AffirmAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'affirm';
    this.description = `Expertly integrates and manages Affirm workflows for your stack.`;
...
export const pluginInstance = new AffirmAgent();
pluginInstance.manifest = {
  id: 'affirm',
  capabilities: ['integration', 'affirm'],
  version: '1.0.0'
};
