 ...
 *
 * Generated Integration Plugin for: FinOps Specialist AI
 * Category: Cost
 */
...
class FinOpsAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'finOps';
    this.description = `Optimizes cloud spend through FinOps practices including cost allocation, rightsizing, and commitment planning.`;
...
export const pluginInstance = new FinOpsAgent();
pluginInstance.manifest = {
  id: 'finOps',
  capabilities: ['cost', 'finops'],
  version: '1.0.0'
};
