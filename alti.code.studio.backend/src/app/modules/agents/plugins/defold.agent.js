 ...
 *
 * Generated Integration Plugin for: Defold Specialist AI
 * Category: Game Dev
 */
...
class DefoldAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'defold';
    this.description = `Expert in Defold development, specializing in gameplay, physics, and rendering optimization.`;
...
export const pluginInstance = new DefoldAgent();
pluginInstance.manifest = {
  id: 'defold',
  capabilities: ['game dev', 'defold'],
  version: '1.0.0'
};
