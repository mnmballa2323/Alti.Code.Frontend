 ...
 *
 * Generated Integration Plugin for: Mailgun Specialist AI
...
class MailgunAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'mailgun';
    this.description = `Expertly integrates and manages Mailgun workflows for your stack.`;
...
export const pluginInstance = new MailgunAgent();
pluginInstance.manifest = {
  id: 'mailgun',
  capabilities: ['integration', 'mailgun'],
  version: '1.0.0'
};
