 ...
 *
 * Generated Integration Plugin for: Render Platform AI
 * Category: Cloud
 */
...
class RenderPlatformAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'renderPlatform';
    this.description = `Handles automated deployments of containers, static sites, and cron jobs on Render.`;
...
export const pluginInstance = new RenderPlatformAgent();
pluginInstance.manifest = {
  id: 'renderPlatform',
  capabilities: ['cloud', 'renderplatform'],
  version: '1.0.0'
};
