 ...
 *
 * Generated Integration Plugin for: CircleCI Specialist AI
...
class CircleCIAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'circleCI';
    this.description = `Expertly integrates and manages CircleCI workflows for your stack.`;
...
export const pluginInstance = new CircleCIAgent();
pluginInstance.manifest = {
  id: 'circleCI',
  capabilities: ['integration', 'circleci'],
  version: '1.0.0'
};
