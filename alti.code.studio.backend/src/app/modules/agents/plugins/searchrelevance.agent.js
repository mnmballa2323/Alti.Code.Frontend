 ...
 *
 * Generated Integration Plugin for: Search Relevance AI
 * Category: Search
 */
...
class SearchRelevanceAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'searchRelevance';
    this.description = `Tunes search relevance with BM25, learning to rank, query understanding, and synonym management.`;
...
export const pluginInstance = new SearchRelevanceAgent();
pluginInstance.manifest = {
  id: 'searchRelevance',
  capabilities: ['search', 'searchrelevance'],
  version: '1.0.0'
};
