 ...
 *
 * Generated Integration Plugin for: Gorgias Specialist AI
...
class GorgiasAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'gorgias';
    this.description = `Expertly integrates and manages Gorgias workflows for your stack.`;
...
export const pluginInstance = new GorgiasAgent();
pluginInstance.manifest = {
  id: 'gorgias',
  capabilities: ['integration', 'gorgias'],
  version: '1.0.0'
};
