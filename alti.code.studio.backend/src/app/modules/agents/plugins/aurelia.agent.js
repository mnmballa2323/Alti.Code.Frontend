 ...
 *
 * Generated Integration Plugin for: Aurelia Specialist AI
 * Category: Framework
 */
...
class AureliaAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'aurelia';
    this.description = `Designs and implements robust applications using Aurelia.`;
...
export const pluginInstance = new AureliaAgent();
pluginInstance.manifest = {
  id: 'aurelia',
  capabilities: ['framework', 'aurelia'],
  version: '1.0.0'
};
