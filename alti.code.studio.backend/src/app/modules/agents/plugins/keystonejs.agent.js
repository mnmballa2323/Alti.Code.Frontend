 ...
 *
 * Generated Integration Plugin for: KeystoneJS Specialist AI
...
class KeystoneJSAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'keystoneJS';
    this.description = `Expertly integrates and manages KeystoneJS workflows for your stack.`;
...
export const pluginInstance = new KeystoneJSAgent();
pluginInstance.manifest = {
  id: 'keystoneJS',
  capabilities: ['integration', 'keystonejs'],
  version: '1.0.0'
};
