 ...
 *
 * Generated Integration Plugin for: UpCloud Specialist AI
 * Category: Cloud
 */
...
class UpCloudAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'upCloud';
    this.description = `Provisions and maintains robust systems on UpCloud.`;
...
export const pluginInstance = new UpCloudAgent();
pluginInstance.manifest = {
  id: 'upCloud',
  capabilities: ['cloud', 'upcloud'],
  version: '1.0.0'
};
