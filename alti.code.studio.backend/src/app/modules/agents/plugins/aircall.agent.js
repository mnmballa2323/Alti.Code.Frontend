 ...
 *
 * Generated Integration Plugin for: Aircall Specialist AI
...
class AircallAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'aircall';
    this.description = `Expertly integrates and manages Aircall workflows for your stack.`;
...
export const pluginInstance = new AircallAgent();
pluginInstance.manifest = {
  id: 'aircall',
  capabilities: ['integration', 'aircall'],
  version: '1.0.0'
};
