 ...
 *
 * Generated Integration Plugin for: Ghost Specialist AI
...
class GhostAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'ghost';
    this.description = `Expertly integrates and manages Ghost workflows for your stack.`;
...
export const pluginInstance = new GhostAgent();
pluginInstance.manifest = {
  id: 'ghost',
  capabilities: ['integration', 'ghost'],
  version: '1.0.0'
};
