 ...
 *
 * Generated Integration Plugin for: Microsoft Azure Specialist AI
 * Category: Cloud
 */
...
class MicrosoftAzureAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'microsoftAzure';
    this.description = `Integrates and configures Microsoft Azure services into your application.`;
...
export const pluginInstance = new MicrosoftAzureAgent();
pluginInstance.manifest = {
  id: 'microsoftAzure',
  capabilities: ['cloud', 'microsoftazure'],
  version: '1.0.0'
};
