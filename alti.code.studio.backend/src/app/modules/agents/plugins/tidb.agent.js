 ...
 *
 * Generated Integration Plugin for: TiDB Specialist AI
...
class TiDBAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'tiDB';
    this.description = `Expertly integrates and manages TiDB workflows for your stack.`;
...
export const pluginInstance = new TiDBAgent();
pluginInstance.manifest = {
  id: 'tiDB',
  capabilities: ['integration', 'tidb'],
  version: '1.0.0'
};
