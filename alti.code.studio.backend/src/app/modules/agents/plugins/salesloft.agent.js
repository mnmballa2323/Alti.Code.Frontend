 ...
 *
 * Generated Integration Plugin for: Salesloft Specialist AI
...
class SalesloftAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'salesloft';
    this.description = `Expertly integrates and manages Salesloft workflows for your stack.`;
...
export const pluginInstance = new SalesloftAgent();
pluginInstance.manifest = {
  id: 'salesloft',
  capabilities: ['integration', 'salesloft'],
  version: '1.0.0'
};
