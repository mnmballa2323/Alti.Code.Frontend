 ...
 *
 * Generated Integration Plugin for: Zoom Specialist AI
...
class ZoomAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'zoom';
    this.description = `Integrates and configures Zoom services into your application.`;
...
export const pluginInstance = new ZoomAgent();
pluginInstance.manifest = {
  id: 'zoom',
  capabilities: ['communication', 'zoom'],
  version: '1.0.0'
};
