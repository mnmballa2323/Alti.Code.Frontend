 ...
 *
 * Generated Integration Plugin for: Scale AI Specialist AI
...
class ScaleAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'scale';
    this.description = `Expertly integrates and manages Scale AI workflows for your stack.`;
...
export const pluginInstance = new ScaleAgent();
pluginInstance.manifest = {
  id: 'scale',
  capabilities: ['integration', 'scale'],
  version: '1.0.0'
};
