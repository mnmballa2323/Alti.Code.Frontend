 ...
 *
 * Generated Integration Plugin for: Content Strategy AI
 * Category: Marketing
 */
...
class ContentStrategyAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'contentStrategy';
    this.description = `Develops content marketing strategies with editorial calendars, brand voice guidelines, and distribution plans.`;
...
export const pluginInstance = new ContentStrategyAgent();
pluginInstance.manifest = {
  id: 'contentStrategy',
  capabilities: ['marketing', 'contentstrategy'],
  version: '1.0.0'
};
