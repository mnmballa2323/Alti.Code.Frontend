 ...
 *
 * Generated Integration Plugin for: Drone CI AI
 * Category: DevOps
 */
...
class DroneCIAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'droneCI';
    this.description = `Connects repository commits directly to deployment systems using test verification steps.`;
...
export const pluginInstance = new DroneCIAgent();
pluginInstance.manifest = {
  id: 'droneCI',
  capabilities: ['devops', 'droneci'],
  version: '1.0.0'
};
