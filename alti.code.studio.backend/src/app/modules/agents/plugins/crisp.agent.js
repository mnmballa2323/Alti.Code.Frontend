 ...
 *
 * Generated Integration Plugin for: Crisp Specialist AI
...
class CrispAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'crisp';
    this.description = `Expertly integrates and manages Crisp workflows for your stack.`;
...
export const pluginInstance = new CrispAgent();
pluginInstance.manifest = {
  id: 'crisp',
  capabilities: ['integration', 'crisp'],
  version: '1.0.0'
};
