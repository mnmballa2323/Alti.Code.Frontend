 ...
 *
 * Generated Integration Plugin for: OVHcloud Specialist AI
 * Category: Cloud
 */
...
class OVHcloudAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'oVHcloud';
    this.description = `Provisions and maintains robust systems on OVHcloud.`;
...
export const pluginInstance = new OVHcloudAgent();
pluginInstance.manifest = {
  id: 'oVHcloud',
  capabilities: ['cloud', 'ovhcloud'],
  version: '1.0.0'
};
