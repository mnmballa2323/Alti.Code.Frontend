 ...
 *
 * Generated Integration Plugin for: Kinsta Specialist AI
 * Category: Cloud
 */
...
class KinstaAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'kinsta';
    this.description = `Provisions and maintains robust systems on Kinsta.`;
...
export const pluginInstance = new KinstaAgent();
pluginInstance.manifest = {
  id: 'kinsta',
  capabilities: ['cloud', 'kinsta'],
  version: '1.0.0'
};
