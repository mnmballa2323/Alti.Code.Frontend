 ...
 *
 * Generated Integration Plugin for: Ant Design Specialist AI
 * Category: Framework
 */
...
class AntDesignAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'antDesign';
    this.description = `Designs and implements robust applications using Ant Design.`;
...
export const pluginInstance = new AntDesignAgent();
pluginInstance.manifest = {
  id: 'antDesign',
  capabilities: ['framework', 'antdesign'],
  version: '1.0.0'
};
