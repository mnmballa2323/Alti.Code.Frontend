 ...
 *
 * Generated Integration Plugin for: Braintree Specialist AI
 * Category: Payments
 */
...
class BraintreeAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'braintree';
    this.description = `Integrates and configures Braintree services into your application.`;
...
export const pluginInstance = new BraintreeAgent();
pluginInstance.manifest = {
  id: 'braintree',
  capabilities: ['payments', 'braintree'],
  version: '1.0.0'
};
