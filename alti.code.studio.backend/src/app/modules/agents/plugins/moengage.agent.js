 ...
 *
 * Generated Integration Plugin for: MoEngage Specialist AI
...
class MoEngageAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'moEngage';
    this.description = `Expertly integrates and manages MoEngage workflows for your stack.`;
...
export const pluginInstance = new MoEngageAgent();
pluginInstance.manifest = {
  id: 'moEngage',
  capabilities: ['integration', 'moengage'],
  version: '1.0.0'
};
