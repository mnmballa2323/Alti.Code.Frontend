 ...
 *
 * Generated Integration Plugin for: Koyeb Specialist AI
 * Category: Cloud
 */
...
class KoyebAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'koyeb';
    this.description = `Provisions and maintains robust systems on Koyeb.`;
...
export const pluginInstance = new KoyebAgent();
pluginInstance.manifest = {
  id: 'koyeb',
  capabilities: ['cloud', 'koyeb'],
  version: '1.0.0'
};
