 ...
 *
 * Generated Integration Plugin for: PocketBase Specialist AI
...
class PocketBaseAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'pocketBase';
    this.description = `Builds applications with PocketBase for real-time data, authentication, and file storage in a single binary.`;
...
export const pluginInstance = new PocketBaseAgent();
pluginInstance.manifest = {
  id: 'pocketBase',
  capabilities: ['backend as a service', 'pocketbase'],
  version: '1.0.0'
};
