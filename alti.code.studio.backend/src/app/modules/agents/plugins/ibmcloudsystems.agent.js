 ...
 *
 * Generated Integration Plugin for: IBM Cloud Systems AI
 * Category: Cloud
 */
...
class IBMCloudSystemsAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'iBMCloudSystems';
    this.description = `Deploys hybrid cloud solutions utilizing IBM Cloud and enterprise-grade data services.`;
...
export const pluginInstance = new IBMCloudSystemsAgent();
pluginInstance.manifest = {
  id: 'iBMCloudSystems',
  capabilities: ['cloud', 'ibmcloudsystems'],
  version: '1.0.0'
};
