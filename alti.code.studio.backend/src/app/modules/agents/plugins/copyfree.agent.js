 ...
 *
 * Generated Integration Plugin for: Copyfree AI
 * Category: Security
 */
...
class CopyfreeAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'copyfree';
    this.description = `Blocks non-permissive library imports (GPL/AGPL), verifying legal parameters in package lists.`;
...
export const pluginInstance = new CopyfreeAgent();
pluginInstance.manifest = {
  id: 'copyfree',
  capabilities: ['security', 'copyfree'],
  version: '1.0.0'
};
