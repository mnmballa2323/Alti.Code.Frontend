 ...
 *
 * Generated Integration Plugin for: dbt Specialist AI
 * Category: Data
 */
...
class dbtAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'dbt';
    this.description = `Builds production-grade dbt projects with modular models, tests, and documentation.`;
...
export const pluginInstance = new dbtAgent();
pluginInstance.manifest = {
  id: 'dbt',
  capabilities: ['data', 'dbt'],
  version: '1.0.0'
};
