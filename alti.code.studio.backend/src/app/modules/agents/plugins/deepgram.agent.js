 ...
 *
 * Generated Integration Plugin for: Deepgram Specialist AI
...
class DeepgramAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'deepgram';
    this.description = `Expertly integrates and manages Deepgram workflows for your stack.`;
...
export const pluginInstance = new DeepgramAgent();
pluginInstance.manifest = {
  id: 'deepgram',
  capabilities: ['integration', 'deepgram'],
  version: '1.0.0'
};
