 ...
 *
 * Generated Integration Plugin for: Perl Specialist AI
 * Category: Language
 */
...
class PerlAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'perl';
    this.description = `Expertly writes, analyzes, and refactors Perl code.`;
...
export const pluginInstance = new PerlAgent();
pluginInstance.manifest = {
  id: 'perl',
  capabilities: ['language', 'perl'],
  version: '1.0.0'
};
