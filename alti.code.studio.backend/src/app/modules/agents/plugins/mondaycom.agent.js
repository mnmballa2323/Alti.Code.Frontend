 ...
 *
 * Generated Integration Plugin for: Monday.com Specialist AI
...
class MondaycomAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'mondaycom';
    this.description = `Expertly integrates and manages Monday.com workflows for your stack.`;
...
export const pluginInstance = new MondaycomAgent();
pluginInstance.manifest = {
  id: 'mondaycom',
  capabilities: ['integration', 'mondaycom'],
  version: '1.0.0'
};
