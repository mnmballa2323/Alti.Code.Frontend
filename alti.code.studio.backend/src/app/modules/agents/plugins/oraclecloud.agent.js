 ...
 *
 * Generated Integration Plugin for: Oracle Cloud Specialist AI
 * Category: Cloud
 */
...
class OracleCloudAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'oracleCloud';
    this.description = `Maintains high-performance Oracle Cloud Infrastructure (OCI) and enterprise databases.`;
...
export const pluginInstance = new OracleCloudAgent();
pluginInstance.manifest = {
  id: 'oracleCloud',
  capabilities: ['cloud', 'oraclecloud'],
  version: '1.0.0'
};
