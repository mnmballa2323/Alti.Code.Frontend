 ...
 *
 * Generated Integration Plugin for: Ory Specialist AI
...
class OryAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'ory';
    this.description = `Expertly integrates and manages Ory workflows for your stack.`;
...
export const pluginInstance = new OryAgent();
pluginInstance.manifest = {
  id: 'ory',
  capabilities: ['integration', 'ory'],
  version: '1.0.0'
};
