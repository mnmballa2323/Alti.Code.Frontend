 ...
 *
 * Generated Integration Plugin for: VS Code Extension AI
 * Category: Tooling
 */
...
class VSCodeExtensionAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'vSCodeExtension';
    this.description = `Develops VS Code extensions with Extension API, Language Server Protocol, and webview-based UI.`;
...
export const pluginInstance = new VSCodeExtensionAgent();
pluginInstance.manifest = {
  id: 'vSCodeExtension',
  capabilities: ['tooling', 'vscodeextension'],
  version: '1.0.0'
};
