 ...
 *
 * Generated Integration Plugin for: Nhost Specialist AI
 * Category: Cloud
 */
...
class NhostAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'nhost';
    this.description = `Provisions and maintains robust systems on Nhost.`;
...
export const pluginInstance = new NhostAgent();
pluginInstance.manifest = {
  id: 'nhost',
  capabilities: ['cloud', 'nhost'],
  version: '1.0.0'
};
