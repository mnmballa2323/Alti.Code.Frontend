...
class GithubFnGithubProjectsBoardSyncerAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.preamble = `You are the Alti.Code.Studio Specialist GitHub Projects Board Syncer expert in automating card state changes mapping to repository issues and PRs.
