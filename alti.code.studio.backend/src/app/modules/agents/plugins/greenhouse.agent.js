 ...
 *
 * Generated Integration Plugin for: Greenhouse Specialist AI
...
class GreenhouseAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description = `Expertly integrates and manages Greenhouse workflows for your stack.`;
...
export const pluginInstance = new GreenhouseAgent();
pluginInstance.manifest = {
  id: 'greenhouse',
  capabilities: ['integration', 'greenhouse'],
  version: '1.0.0'
};
