 ...
 *
 * Generated Integration Plugin for: Delphi Specialist AI
 * Category: Language
 */
...
class DelphiAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'delphi';
    this.description = `Expertly writes, analyzes, and refactors Delphi code.`;
...
export const pluginInstance = new DelphiAgent();
pluginInstance.manifest = {
  id: 'delphi',
  capabilities: ['language', 'delphi'],
  version: '1.0.0'
};
