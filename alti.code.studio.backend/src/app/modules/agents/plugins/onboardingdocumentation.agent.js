 ...
 *
 * Generated Integration Plugin for: Onboarding Documentation AI
...
class OnboardingDocumentationAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'onboardingDocumentation';
    this.description = `Creates engineering onboarding documentation with setup guides, architecture tours, and codebase maps.`;
...
export const pluginInstance = new OnboardingDocumentationAgent();
pluginInstance.manifest = {
  id: 'onboardingDocumentation',
  capabilities: ['documentation', 'onboardingdocumentation'],
  version: '1.0.0'
};
