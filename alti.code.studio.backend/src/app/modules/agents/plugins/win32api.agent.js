 ...
 *
 * Generated Integration Plugin for: Win32 API AI
 * Category: DevOps
 */
...
class Win32APIAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'win32API';
    this.description = `Debugs desktop bindings and builds background services for Windows client environments.`;
...
export const pluginInstance = new Win32APIAgent();
pluginInstance.manifest = {
  id: 'win32API',
  capabilities: ['devops', 'win32api'],
  version: '1.0.0'
};
