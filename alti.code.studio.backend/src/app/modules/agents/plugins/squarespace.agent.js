 ...
 *
 * Generated Integration Plugin for: Squarespace Specialist AI
...
class SquarespaceAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'squarespace';
    this.description = `Expertly integrates and manages Squarespace workflows for your stack.`;
...
export const pluginInstance = new SquarespaceAgent();
pluginInstance.manifest = {
  id: 'squarespace',
  capabilities: ['integration', 'squarespace'],
  version: '1.0.0'
};
