 ...
 *
 * Generated Integration Plugin for: OpenTelemetry Specialist AI
 * Category: Monitoring
 */
...
class OpenTelemetryAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description = `Instruments applications with OpenTelemetry for end-to-end distributed tracing, metrics, and logging.`;
...
export const pluginInstance = new OpenTelemetryAgent();
pluginInstance.manifest = {
  id: 'openTelemetry',
  capabilities: ['monitoring', 'opentelemetry'],
  version: '1.0.0'
};
