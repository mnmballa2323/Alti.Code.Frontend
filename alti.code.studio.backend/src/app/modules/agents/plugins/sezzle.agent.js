 ...
 *
 * Generated Integration Plugin for: Sezzle Specialist AI
...
class SezzleAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'sezzle';
    this.description = `Expertly integrates and manages Sezzle workflows for your stack.`;
...
export const pluginInstance = new SezzleAgent();
pluginInstance.manifest = {
  id: 'sezzle',
  capabilities: ['integration', 'sezzle'],
  version: '1.0.0'
};
