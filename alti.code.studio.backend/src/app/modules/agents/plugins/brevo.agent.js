 ...
 *
 * Generated Integration Plugin for: Brevo Specialist AI
...
class BrevoAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'brevo';
    this.description = `Expertly integrates and manages Brevo workflows for your stack.`;
...
export const pluginInstance = new BrevoAgent();
pluginInstance.manifest = {
  id: 'brevo',
  capabilities: ['integration', 'brevo'],
  version: '1.0.0'
};
