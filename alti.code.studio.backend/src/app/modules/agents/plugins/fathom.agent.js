 ...
 *
 * Generated Integration Plugin for: Fathom Specialist AI
...
class FathomAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'fathom';
    this.description = `Expertly integrates and manages Fathom workflows for your stack.`;
...
export const pluginInstance = new FathomAgent();
pluginInstance.manifest = {
  id: 'fathom',
  capabilities: ['integration', 'fathom'],
  version: '1.0.0'
};
