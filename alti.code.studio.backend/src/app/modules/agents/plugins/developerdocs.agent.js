 ...
 *
 * Generated Integration Plugin for: Developer Docs AI
...
class DeveloperDocsAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'developerDocs';
    this.description = `Builds developer documentation sites with Docusaurus, Mintlify, code samples, and SDK quick-start guides.`;
...
export const pluginInstance = new DeveloperDocsAgent();
pluginInstance.manifest = {
  id: 'developerDocs',
  capabilities: ['documentation', 'developerdocs'],
  version: '1.0.0'
};
