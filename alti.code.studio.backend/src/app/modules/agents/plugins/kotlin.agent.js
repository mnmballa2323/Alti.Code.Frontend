 ...
 *
 * Generated Integration Plugin for: Kotlin Specialist AI
 * Category: Language
 */
...
class KotlinAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'kotlin';
    this.description = `Expertly writes, analyzes, and refactors Kotlin code.`;
...
export const pluginInstance = new KotlinAgent();
pluginInstance.manifest = {
  id: 'kotlin',
  capabilities: ['language', 'kotlin'],
  version: '1.0.0'
};
