 ...
 *
 * Generated Integration Plugin for: Mailchimp Specialist AI
 * Category: Marketing
 */
...
class MailchimpAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'mailchimp';
    this.description = `Integrates and configures Mailchimp services into your application.`;
...
export const pluginInstance = new MailchimpAgent();
pluginInstance.manifest = {
  id: 'mailchimp',
  capabilities: ['marketing', 'mailchimp'],
  version: '1.0.0'
};
