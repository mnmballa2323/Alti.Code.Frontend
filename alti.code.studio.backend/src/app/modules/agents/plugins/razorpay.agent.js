 ...
 *
 * Generated Integration Plugin for: Razorpay Specialist AI
...
class RazorpayAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'razorpay';
    this.description = `Expertly integrates and manages Razorpay workflows for your stack.`;
...
export const pluginInstance = new RazorpayAgent();
pluginInstance.manifest = {
  id: 'razorpay',
  capabilities: ['integration', 'razorpay'],
  version: '1.0.0'
};
