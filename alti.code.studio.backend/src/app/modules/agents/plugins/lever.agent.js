 ...
 *
 * Generated Integration Plugin for: Lever Specialist AI
...
class LeverAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'lever';
    this.description = `Expertly integrates and manages Lever workflows for your stack.`;
...
export const pluginInstance = new LeverAgent();
pluginInstance.manifest = {
  id: 'lever',
  capabilities: ['integration', 'lever'],
  version: '1.0.0'
};
