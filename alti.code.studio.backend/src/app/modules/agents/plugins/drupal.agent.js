 ...
 *
 * Generated Integration Plugin for: Drupal Specialist AI
...
class DrupalAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'drupal';
    this.description = `Expertly integrates and manages Drupal workflows for your stack.`;
...
export const pluginInstance = new DrupalAgent();
pluginInstance.manifest = {
  id: 'drupal',
  capabilities: ['integration', 'drupal'],
  version: '1.0.0'
};
