 ...
 *
 * Generated Integration Plugin for: Bitbucket Specialist AI
 * Category: DevOps
 */
...
class BitbucketAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'bitbucket';
    this.description = `Integrates and configures Bitbucket services into your application.`;
...
export const pluginInstance = new BitbucketAgent();
pluginInstance.manifest = {
  id: 'bitbucket',
  capabilities: ['devops', 'bitbucket'],
  version: '1.0.0'
};
