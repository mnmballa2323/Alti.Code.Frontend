 ...
 *
 * Generated Integration Plugin for: Cypress Specialist AI
 * Category: QA
 */
...
class CypressAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'cypress';
    this.description = `Builds robust E2E and component test suites with Cypress for frontend reliability.`;
...
export const pluginInstance = new CypressAgent();
pluginInstance.manifest = {
  id: 'cypress',
  capabilities: ['qa', 'cypress'],
  version: '1.0.0'
};
