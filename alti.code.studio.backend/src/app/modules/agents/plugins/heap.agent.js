 ...
 *
 * Generated Integration Plugin for: Heap Specialist AI
...
class HeapAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'heap';
    this.description = `Expertly integrates and manages Heap workflows for your stack.`;
...
export const pluginInstance = new HeapAgent();
pluginInstance.manifest = {
  id: 'heap',
  capabilities: ['integration', 'heap'],
  version: '1.0.0'
};
