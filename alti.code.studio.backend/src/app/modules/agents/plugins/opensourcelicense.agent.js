 ...
 *
 * Generated Integration Plugin for: Open Source License AI
 * Category: Legal
 */
...
class OpenSourceLicenseAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'openSourceLicense';
    this.description = `Automates open source license compliance scanning, SPDX documentation, and copyleft risk detection.`;
...
export const pluginInstance = new OpenSourceLicenseAgent();
pluginInstance.manifest = {
  id: 'openSourceLicense',
  capabilities: ['legal', 'opensourcelicense'],
  version: '1.0.0'
};
