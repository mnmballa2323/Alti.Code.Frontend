 ...
 *
 * Generated Integration Plugin for: API Documentation AI
...
class APIDocumentationAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'aPIDocumentation';
    this.description = `Creates comprehensive API documentation with OpenAPI specs, Redoc, Swagger UI, and interactive examples.`;
...
export const pluginInstance = new APIDocumentationAgent();
pluginInstance.manifest = {
  id: 'aPIDocumentation',
  capabilities: ['documentation', 'apidocumentation'],
  version: '1.0.0'
};
