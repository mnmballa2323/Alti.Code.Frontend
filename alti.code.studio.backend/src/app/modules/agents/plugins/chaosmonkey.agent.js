 ...
 *
 * Generated Integration Plugin for: ChaosMonkey AI
 * Category: DevOps
 */
...
class ChaosMonkeyAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'chaosMonkey';
    this.description = `Scans runtime logs, tracking telemetry metrics, and tracing error stacks to their origin.`;
...
export const pluginInstance = new ChaosMonkeyAgent();
pluginInstance.manifest = {
  id: 'chaosMonkey',
  capabilities: ['devops', 'chaosmonkey'],
  version: '1.0.0'
};
