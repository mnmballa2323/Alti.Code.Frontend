 ...
 *
 * Generated Integration Plugin for: Sentry Specialist AI
 * Category: Monitoring
 */
...
class SentryAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'sentry';
    this.description = `Integrates and configures Sentry services into your application.`;
...
export const pluginInstance = new SentryAgent();
pluginInstance.manifest = {
  id: 'sentry',
  capabilities: ['monitoring', 'sentry'],
  version: '1.0.0'
};
