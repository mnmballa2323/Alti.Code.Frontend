 ...
 *
 * Generated Integration Plugin for: Dart Specialist AI
 * Category: Language
 */
...
class DartAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'dart';
    this.description = `Expertly writes, analyzes, and refactors Dart code.`;
...
export const pluginInstance = new DartAgent();
