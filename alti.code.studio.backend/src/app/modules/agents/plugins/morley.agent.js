 ...
 *
 * Generated Integration Plugin for: Morley AI
 * Category: Systems
 */
...
class MorleyAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'morley';
    this.description = `Programs robust controllers for manufacturing pipelines and physical automation.`;
...
export const pluginInstance = new MorleyAgent();
pluginInstance.manifest = {
  id: 'morley',
  capabilities: ['systems', 'morley'],
  version: '1.0.0'
};
