 ...
 *
 * Generated Integration Plugin for: Joomla Specialist AI
...
class JoomlaAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'joomla';
    this.description = `Expertly integrates and manages Joomla workflows for your stack.`;
...
export const pluginInstance = new JoomlaAgent();
pluginInstance.manifest = {
  id: 'joomla',
  capabilities: ['integration', 'joomla'],
  version: '1.0.0'
};
