 ...
 *
 * Generated Integration Plugin for: Dropbox Specialist AI
 * Category: Storage
 */
...
class DropboxAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'dropbox';
    this.description = `Integrates and configures Dropbox services into your application.`;
...
export const pluginInstance = new DropboxAgent();
pluginInstance.manifest = {
  id: 'dropbox',
  capabilities: ['storage', 'dropbox'],
  version: '1.0.0'
};
