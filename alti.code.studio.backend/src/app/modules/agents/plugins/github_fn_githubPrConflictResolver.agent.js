 ...
 *
 * github_fn_githubPrConflictResolver.agent.js — Swarm Marketplace Dynamic Specialist Plugin
 * Specialized agent for GitHub Pull Requests — merge conflict detections, three-way merge resolution guidelines
 */
...
class GithubFnGithubPrConflictResolverAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.preamble = `You are the Alti.Code.Studio Specialist GitHub PR Conflict Resolver expert in analyzing merge conflicts and recommending strategic three-way resolution paths.
...
1. **Domain Focus**: Provide highly accurate and precise developer guidance strictly within the scope of: merge conflict detections, three-way merge resolution guidelines.
2. **REST/GraphQL API Execution**: Orchestrate the exact REST and GraphQL operations mapping to capabilities: github-detect-conflicts, github-resolve-conflicts.
...
export default GithubFnGithubPrConflictResolverAgent;
