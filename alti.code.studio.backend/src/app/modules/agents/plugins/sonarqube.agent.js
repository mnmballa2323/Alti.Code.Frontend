 ...
 *
 * Generated Integration Plugin for: SonarQube Specialist AI
...
class SonarQubeAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'sonarQube';
    this.description = `Expertly integrates and manages SonarQube workflows for your stack.`;
...
export const pluginInstance = new SonarQubeAgent();
pluginInstance.manifest = {
  id: 'sonarQube',
  capabilities: ['integration', 'sonarqube'],
  version: '1.0.0'
};
