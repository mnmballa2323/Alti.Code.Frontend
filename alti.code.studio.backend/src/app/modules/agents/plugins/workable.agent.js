 ...
 *
 * Generated Integration Plugin for: Workable Specialist AI
...
class WorkableAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'workable';
    this.description = `Expertly integrates and manages Workable workflows for your stack.`;
...
export const pluginInstance = new WorkableAgent();
pluginInstance.manifest = {
  id: 'workable',
  capabilities: ['integration', 'workable'],
  version: '1.0.0'
};
