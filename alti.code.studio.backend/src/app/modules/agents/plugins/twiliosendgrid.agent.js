 ...
 *
 * Generated Integration Plugin for: Twilio SendGrid Specialist AI
...
class TwilioSendGridAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'twilioSendGrid';
    this.description = `Expertly integrates and manages Twilio SendGrid workflows for your stack.`;
...
export const pluginInstance = new TwilioSendGridAgent();
pluginInstance.manifest = {
  id: 'twilioSendGrid',
  capabilities: ['integration', 'twiliosendgrid'],
  version: '1.0.0'
};
