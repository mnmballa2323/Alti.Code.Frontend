 ...
 *
 * Generated Integration Plugin for: AdonisJS Specialist AI
 * Category: Framework
 */
...
class AdonisJSAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'adonisJS';
    this.description = `Designs and implements robust applications using AdonisJS.`;
...
export const pluginInstance = new AdonisJSAgent();
pluginInstance.manifest = {
  id: 'adonisJS',
  capabilities: ['framework', 'adonisjs'],
  version: '1.0.0'
};
