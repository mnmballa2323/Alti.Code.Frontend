 ...
 *
 * Generated Integration Plugin for: IONOS Specialist AI
 * Category: Cloud
 */
...
class IONOSAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'iONOS';
    this.description = `Provisions and maintains robust systems on IONOS.`;
...
export const pluginInstance = new IONOSAgent();
pluginInstance.manifest = {
  id: 'iONOS',
  capabilities: ['cloud', 'ionos'],
  version: '1.0.0'
};
