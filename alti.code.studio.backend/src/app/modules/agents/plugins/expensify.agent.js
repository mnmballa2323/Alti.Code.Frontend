 ...
 *
 * Generated Integration Plugin for: Expensify Specialist AI
...
class ExpensifyAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'expensify';
    this.description = `Expertly integrates and manages Expensify workflows for your stack.`;
...
export const pluginInstance = new ExpensifyAgent();
pluginInstance.manifest = {
  id: 'expensify',
  capabilities: ['integration', 'expensify'],
  version: '1.0.0'
};
