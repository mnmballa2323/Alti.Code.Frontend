 ...
 *
 * Generated Integration Plugin for: Opsgenie Specialist AI
...
class OpsgenieAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'opsgenie';
    this.description = `Expertly integrates and manages Opsgenie workflows for your stack.`;
...
export const pluginInstance = new OpsgenieAgent();
pluginInstance.manifest = {
  id: 'opsgenie',
  capabilities: ['integration', 'opsgenie'],
  version: '1.0.0'
};
