 ...
 *
 * Generated Integration Plugin for: Strapi Specialist AI
 * Category: CMS
 */
...
class StrapiAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'strapi';
    this.description = `Integrates and configures Strapi services into your application.`;
...
export const pluginInstance = new StrapiAgent();
pluginInstance.manifest = {
  id: 'strapi',
  capabilities: ['cms', 'strapi'],
  version: '1.0.0'
};
