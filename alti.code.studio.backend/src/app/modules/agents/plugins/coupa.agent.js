 ...
 *
 * Generated Integration Plugin for: Coupa Specialist AI
 * Category: Enterprise
 */
...
class CoupaAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'coupa';
    this.description = `Integrates and customizes Coupa for enterprise procurement, invoicing, and supply chain management.`;
...
export const pluginInstance = new CoupaAgent();
pluginInstance.manifest = {
  id: 'coupa',
  capabilities: ['enterprise', 'coupa'],
  version: '1.0.0'
};
