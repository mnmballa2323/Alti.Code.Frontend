 ...
 *
 * Generated Integration Plugin for: Terms of Service AI
 * Category: Legal
 */
...
class TermsofServiceAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'termsofService';
    this.description = `Generates legally sound terms of service, privacy policies, cookie consent banners, and EULAs.`;
...
export const pluginInstance = new TermsofServiceAgent();
pluginInstance.manifest = {
  id: 'termsofService',
  capabilities: ['legal', 'termsofservice'],
  version: '1.0.0'
};
