 ...
 *
 * Generated Integration Plugin for: WorkOS Specialist AI
...
class WorkOSAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'workOS';
    this.description = `Expertly integrates and manages WorkOS workflows for your stack.`;
...
export const pluginInstance = new WorkOSAgent();
pluginInstance.manifest = {
  id: 'workOS',
  capabilities: ['integration', 'workos'],
  version: '1.0.0'
};
