 ...
 *
 * Generated Integration Plugin for: ClickUp Specialist AI
...
class ClickUpAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'clickUp';
    this.description = `Expertly integrates and manages ClickUp workflows for your stack.`;
...
export const pluginInstance = new ClickUpAgent();
pluginInstance.manifest = {
  id: 'clickUp',
  capabilities: ['integration', 'clickup'],
  version: '1.0.0'
};
