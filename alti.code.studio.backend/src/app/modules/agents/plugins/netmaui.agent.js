 ...
 *
 * Generated Integration Plugin for: .NET MAUI Specialist AI
 * Category: Desktop
 */
...
class NETMAUIAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'nETMAUI';
    this.description = `Creates cross-platform desktop and mobile apps with .NET MAUI, Blazor Hybrid, and platform-specific services.`;
...
export const pluginInstance = new NETMAUIAgent();
pluginInstance.manifest = {
  id: 'nETMAUI',
  capabilities: ['desktop', 'netmaui'],
  version: '1.0.0'
};
