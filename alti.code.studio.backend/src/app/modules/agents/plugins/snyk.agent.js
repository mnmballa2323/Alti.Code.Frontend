 ...
 *
 * Generated Integration Plugin for: Snyk Specialist AI
...
class SnykAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'snyk';
    this.description = `Expertly integrates and manages Snyk workflows for your stack.`;
...
export const pluginInstance = new SnykAgent();
pluginInstance.manifest = {
  id: 'snyk',
  capabilities: ['integration', 'snyk'],
  version: '1.0.0'
};
