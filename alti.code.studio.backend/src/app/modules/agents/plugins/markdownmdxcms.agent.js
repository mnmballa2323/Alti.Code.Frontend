 ...
 *
 * Generated Integration Plugin for: Markdown/MDX CMS AI
 * Category: CMS
 */
...
class MarkdownMDXCMSAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'markdownMDXCMS';
    this.description = `Builds content systems with MDX, Markdown processing, static site generation, and content collections.`;
...
export const pluginInstance = new MarkdownMDXCMSAgent();
pluginInstance.manifest = {
  id: 'markdownMDXCMS',
  capabilities: ['cms', 'markdownmdxcms'],
  version: '1.0.0'
};
