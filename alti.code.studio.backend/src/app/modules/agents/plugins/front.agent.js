 ...
 *
 * Generated Integration Plugin for: Front Specialist AI
...
class FrontAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'front';
    this.description = `Expertly integrates and manages Front workflows for your stack.`;
...
export const pluginInstance = new FrontAgent();
pluginInstance.manifest = {
  id: 'front',
  capabilities: ['integration', 'front'],
  version: '1.0.0'
};
