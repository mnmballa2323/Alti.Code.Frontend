 ...
 *
 * Generated Integration Plugin for: Next.js Specialist AI
 * Category: Frontend
 */
...
class NextjsAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'nextjs';
    this.description = `Manages Next.js workflows seamlessly, operating natively within its ecosystem.`;
...
export const pluginInstance = new NextjsAgent();
