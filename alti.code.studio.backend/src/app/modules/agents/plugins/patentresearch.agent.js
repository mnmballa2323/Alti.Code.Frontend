 ...
 *
 * Generated Integration Plugin for: Patent Research AI
 * Category: Research
 */
...
class PatentResearchAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'patentResearch';
    this.description = `Conducts patent research including prior art searches, landscape analysis, and freedom to operate assessments.`;
...
export const pluginInstance = new PatentResearchAgent();
pluginInstance.manifest = {
  id: 'patentResearch',
  capabilities: ['research', 'patentresearch'],
  version: '1.0.0'
};
