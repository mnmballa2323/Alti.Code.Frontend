 ...
 *
 * Generated Integration Plugin for: Pardot Specialist AI
...
class PardotAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'pardot';
    this.description = `Expertly integrates and manages Pardot workflows for your stack.`;
...
export const pluginInstance = new PardotAgent();
pluginInstance.manifest = {
  id: 'pardot',
  capabilities: ['integration', 'pardot'],
  version: '1.0.0'
};
