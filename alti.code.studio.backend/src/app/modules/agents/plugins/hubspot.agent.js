 ...
 *
 * Generated Integration Plugin for: HubSpot Specialist AI
 * Category: CRM
 */
...
class HubSpotAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'hubSpot';
    this.description = `Integrates and configures HubSpot services into your application.`;
...
export const pluginInstance = new HubSpotAgent();
pluginInstance.manifest = {
  id: 'hubSpot',
  capabilities: ['crm', 'hubspot'],
  version: '1.0.0'
};
