 ...
 *
 * Generated Integration Plugin for: Hapi Specialist AI
 * Category: Framework
 */
...
class HapiAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'hapi';
    this.description = `Designs and implements robust applications using Hapi.`;
...
export const pluginInstance = new HapiAgent();
pluginInstance.manifest = {
  id: 'hapi',
  capabilities: ['framework', 'hapi'],
  version: '1.0.0'
};
