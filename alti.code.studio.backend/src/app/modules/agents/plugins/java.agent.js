 ...
 *
 * Generated Integration Plugin for: Java Specialist AI
 * Category: Language
 */
...
class JavaAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'java';
    this.description = `Expertly writes, analyzes, and refactors Java code.`;
...
export const pluginInstance = new JavaAgent();
