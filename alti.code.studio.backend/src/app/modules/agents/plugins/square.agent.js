 ...
 *
 * Generated Integration Plugin for: Square Specialist AI
 * Category: Payments
 */
...
class SquareAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'square';
    this.description = `Integrates and configures Square services into your application.`;
...
export const pluginInstance = new SquareAgent();
pluginInstance.manifest = {
  id: 'square',
  capabilities: ['payments', 'square'],
  version: '1.0.0'
};
