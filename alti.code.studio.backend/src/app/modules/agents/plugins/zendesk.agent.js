 ...
 *
 * Generated Integration Plugin for: Zendesk Specialist AI
...
class ZendeskAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'zendesk';
    this.description = `Integrates and configures Zendesk services into your application.`;
...
export const pluginInstance = new ZendeskAgent();
pluginInstance.manifest = {
  id: 'zendesk',
  capabilities: ['customer support', 'zendesk'],
  version: '1.0.0'
};
