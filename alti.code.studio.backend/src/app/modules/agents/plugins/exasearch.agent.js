 ...
 *
 * Generated Integration Plugin for: Exa Search Specialist AI
 * Category: Search
 */
...
class ExaSearchAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'exaSearch';
    this.description = `Manages Exa Search workflows seamlessly, operating natively within its ecosystem.`;
...
export const pluginInstance = new ExaSearchAgent();
pluginInstance.manifest = {
  id: 'exaSearch',
  capabilities: ['search', 'exasearch'],
  version: '1.0.0'
};
