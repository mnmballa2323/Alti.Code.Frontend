 ...
 *
 * Generated Integration Plugin for: Intercom Specialist AI
...
class IntercomAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'intercom';
    this.description = `Integrates and configures Intercom services into your application.`;
...
export const pluginInstance = new IntercomAgent();
pluginInstance.manifest = {
  id: 'intercom',
  capabilities: ['customer support', 'intercom'],
  version: '1.0.0'
};
