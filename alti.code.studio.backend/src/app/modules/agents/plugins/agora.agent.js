 ...
 *
 * Generated Integration Plugin for: Agora Specialist AI
...
class AgoraAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'agora';
    this.description = `Expertly integrates and manages Agora workflows for your stack.`;
...
export const pluginInstance = new AgoraAgent();
pluginInstance.manifest = {
  id: 'agora',
  capabilities: ['integration', 'agora'],
  version: '1.0.0'
};
