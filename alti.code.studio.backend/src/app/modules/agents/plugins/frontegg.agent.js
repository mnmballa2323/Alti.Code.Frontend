 ...
 *
 * Generated Integration Plugin for: Frontegg Specialist AI
...
class FronteggAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'frontegg';
    this.description = `Expertly integrates and manages Frontegg workflows for your stack.`;
...
export const pluginInstance = new FronteggAgent();
pluginInstance.manifest = {
  id: 'frontegg',
  capabilities: ['integration', 'frontegg'],
  version: '1.0.0'
};
