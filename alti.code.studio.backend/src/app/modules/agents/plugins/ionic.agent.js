 ...
 *
 * Generated Integration Plugin for: Ionic Specialist AI
 * Category: Framework
 */
...
class IonicAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'ionic';
    this.description = `Designs and implements robust applications using Ionic.`;
...
export const pluginInstance = new IonicAgent();
pluginInstance.manifest = {
  id: 'ionic',
  capabilities: ['framework', 'ionic'],
  version: '1.0.0'
};
