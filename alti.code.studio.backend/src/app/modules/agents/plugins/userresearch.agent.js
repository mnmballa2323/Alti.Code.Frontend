 ...
 *
 * Generated Integration Plugin for: User Research AI
 * Category: Research
 */
...
class UserResearchAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'userResearch';
    this.description = `Conducts user research through interviews, surveys, usability testing, and customer journey mapping.`;
...
export const pluginInstance = new UserResearchAgent();
pluginInstance.manifest = {
  id: 'userResearch',
  capabilities: ['research', 'userresearch'],
  version: '1.0.0'
};
