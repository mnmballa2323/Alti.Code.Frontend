 ...
 *
 * Generated Integration Plugin for: Drift Specialist AI
...
class DriftAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'drift';
    this.description = `Expertly integrates and manages Drift workflows for your stack.`;
...
export const pluginInstance = new DriftAgent();
pluginInstance.manifest = {
  id: 'drift',
  capabilities: ['integration', 'drift'],
  version: '1.0.0'
};
