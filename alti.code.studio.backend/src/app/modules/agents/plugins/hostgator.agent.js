 ...
 *
 * Generated Integration Plugin for: HostGator Specialist AI
 * Category: Cloud
 */
...
class HostGatorAgent extends BaseSpecialistAgent {
  constructor() {
    super();
    this.name = 'hostGator';
    this.description = `Provisions and maintains robust systems on HostGator.`;
...
export const pluginInstance = new HostGatorAgent();
pluginInstance.manifest = {
  id: 'hostGator',
  capabilities: ['cloud', 'hostgator'],
  version: '1.0.0'
};
