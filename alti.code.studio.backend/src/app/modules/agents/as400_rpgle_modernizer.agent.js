...
export class As400RpgleModernizerAgent extends BaseSpecialistAgent {
    constructor() {
        super({
            ...
            description: "Specialized transpiler for reading legacy AS/400 IBM iSeries RPG/RPGLE business logic and modernizing it to Java/Spring Boot or Go.",
            capabilities: ["as400", "iseries", "rpg", "rpgle", "legacy_modernization", "transpilation"],
            tier: 14,
