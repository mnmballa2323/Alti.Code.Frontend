/**
 * MonaiDicomAgent — Medical Imaging AI Specialist
 * Segments DICOM matrices, MONAI/PyTorch bindings, and MRI contrast logic.
 */
...
export const monaiDicomAgent = new MonaiDicomAgent();
