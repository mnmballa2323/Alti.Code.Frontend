 ...
 * (serverless FHIR automations), subscriptions, and SMART app integration.
 */
...
class MedplumAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'FHIR platform specialist for Medplum: TypeScript SDK (createResource/readResource/searchOne), Medplum Bots (serverless FHIR event automation), Subscriptions (REST hooks), Questionnaires (clinical forms), Task workflows, and React form components.';
...
export const medplumAgent = new MedplumAgent();
