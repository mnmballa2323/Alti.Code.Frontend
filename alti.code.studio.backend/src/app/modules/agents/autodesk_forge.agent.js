/**
 * AutodeskForgeAgent — AEC CAD & Platform Services Specialist
 * Formulates Revit API extraction strategies, WebGL viewers, and BIM 360 logic.
 */
...
export const autodeskForgeAgent = new AutodeskForgeAgent();
