 ...
 * custom model deployment (Cog), and fine-tuning with LoRA/DreamBooth.
 */
...
class ReplicateAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Model deployment specialist for Replicate: predictions API, streaming, image/video/audio generation models, Cog containerisation, LoRA fine-tuning, and webhook handling.';
...
export const replicateAgent = new ReplicateAgent();
