...
class PerformanceETLTesterAgent extends GeminiCliBaseAgent {
    ...
    async generatePerformanceETLSystem(objective) {
        logger.info(`💻 [PerformanceETLTesterAgent] Analyzing Performance ETL Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Performance ETL Tester Target");
...
export const performanceETLTesterAgent = Object.freeze(new PerformanceETLTesterAgent());
