...
class PerformanceTestingTesterAgent extends GeminiCliBaseAgent {
    ...
    async generatePerformanceTestingSystem(objective) {
        logger.info(`💻 [PerformanceTestingTesterAgent] Analyzing Performance Testing Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Performance Testing Tester Target");
...
export const performanceTestingTesterAgent = Object.freeze(new PerformanceTestingTesterAgent());
