...
class PureDataSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generatePureDataSystem(objective) {
        logger.info(`💻 [PureDataSpecialistAgent] Analyzing Pure Data requirements...`);
...
export const PureDataSpecialistAgentInstance = Object.freeze(new PureDataSpecialistAgent());
