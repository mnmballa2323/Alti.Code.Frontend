...
class PerformanceDataLakeLeadAgent extends GeminiCliBaseAgent {
  ...
  async generatePerformanceDataLakeSystem(objective) {
    logger.info(
      `💻 [PerformanceDataLakeLeadAgent] Analyzing Performance DataLake Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Performance DataLake Lead Target',
      );
...
export const performanceDataLakeLeadAgent = Object.freeze(
  new PerformanceDataLakeLeadAgent(),
);
