...
class PerformanceETLManagerAgent extends GeminiCliBaseAgent {
  ...
  async generatePerformanceETLSystem(objective) {
    logger.info(
      `💻 [PerformanceETLManagerAgent] Analyzing Performance ETL Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Performance ETL Manager Target',
      );
...
export const performanceETLManagerAgent = Object.freeze(
  new PerformanceETLManagerAgent(),
);
