...
class PlaywrightAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'E2E testing specialist for Playwright Page Object Model, parallelization, and network mocking.';
...
export const playwrightAgent = Object.freeze(new PlaywrightAgent());
