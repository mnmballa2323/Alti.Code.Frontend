...
class PerformanceETLDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generatePerformanceETLSystem(objective) {
    logger.info(
      `💻 [PerformanceETLDesignerAgent] Analyzing Performance ETL Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Performance ETL Designer Target',
      );
...
export const performanceETLDesignerAgent = Object.freeze(
  new PerformanceETLDesignerAgent(),
);
