...
class PerformanceETLStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generatePerformanceETLSystem(objective) {
    logger.info(
      `💻 [PerformanceETLStrategistAgent] Analyzing Performance ETL Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Performance ETL Strategist Target',
      );
...
export const performanceETLStrategistAgent = Object.freeze(
  new PerformanceETLStrategistAgent(),
);
