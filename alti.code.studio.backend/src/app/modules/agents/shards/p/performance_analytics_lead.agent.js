...
class PerformanceAnalyticsLeadAgent extends GeminiCliBaseAgent {
  ...
  async generatePerformanceAnalyticsSystem(objective) {
    logger.info(
      `💻 [PerformanceAnalyticsLeadAgent] Analyzing Performance Analytics Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Performance Analytics Lead Target',
      );
...
export const performanceAnalyticsLeadAgent = Object.freeze(
  new PerformanceAnalyticsLeadAgent(),
);
