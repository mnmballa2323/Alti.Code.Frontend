...
class PerformanceETLEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generatePerformanceETLSystem(objective) {
    logger.info(
      `💻 [PerformanceETLEngineerAgent] Analyzing Performance ETL Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Performance ETL Engineer Target',
      );
...
export const performanceETLEngineerAgent = Object.freeze(
  new PerformanceETLEngineerAgent(),
);
