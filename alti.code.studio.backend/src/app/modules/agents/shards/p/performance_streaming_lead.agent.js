...
class PerformanceStreamingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generatePerformanceStreamingSystem(objective) {
    logger.info(
      `💻 [PerformanceStreamingLeadAgent] Analyzing Performance Streaming Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Performance Streaming Lead Target',
      );
...
export const performanceStreamingLeadAgent = Object.freeze(
  new PerformanceStreamingLeadAgent(),
);
