...
class PerformanceScalingTesterAgent extends GeminiCliBaseAgent {
    ...
    async generatePerformanceScalingSystem(objective) {
        logger.info(`💻 [PerformanceScalingTesterAgent] Analyzing Performance Scaling Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Performance Scaling Tester Target");
...
export const performanceScalingTesterAgent = Object.freeze(new PerformanceScalingTesterAgent());
