...
class PerformanceETLDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generatePerformanceETLSystem(objective) {
        logger.info(`💻 [PerformanceETLDirectorAgent] Analyzing Performance ETL Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Performance ETL Director Target");
...
export const performanceETLDirectorAgent = Object.freeze(new PerformanceETLDirectorAgent());
