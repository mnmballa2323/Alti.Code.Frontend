...
class PerformanceCachingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generatePerformanceCachingSystem(objective) {
    logger.info(
      `💻 [PerformanceCachingLeadAgent] Analyzing Performance Caching Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Performance Caching Lead Target',
      );
...
export const performanceCachingLeadAgent = Object.freeze(
  new PerformanceCachingLeadAgent(),
);
