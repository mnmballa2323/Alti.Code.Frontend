...
class PerformanceETLAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generatePerformanceETLSystem(objective) {
    logger.info(
      `💻 [PerformanceETLAnalystAgent] Analyzing Performance ETL Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Performance ETL Analyst Target',
      );
...
export const performanceETLAnalystAgent = Object.freeze(
  new PerformanceETLAnalystAgent(),
);
