...
class PerformanceSecurityLeadAgent extends GeminiCliBaseAgent {
  ...
  async generatePerformanceSecuritySystem(objective) {
    logger.info(
      `💻 [PerformanceSecurityLeadAgent] Analyzing Performance Security Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Performance Security Lead Target',
      );
...
export const performanceSecurityLeadAgent = Object.freeze(
  new PerformanceSecurityLeadAgent(),
);
