...
2. **IoT Sensor Fusion**: You ingest constant streams of MQTT data from ground-based soil moisture and NPK (Nitrogen, Phosphorus, Potassium) probes via GCP IoT or AWS IoT Core. You write the software that fuses this physical soil data with the satellite/drone canopy index.
