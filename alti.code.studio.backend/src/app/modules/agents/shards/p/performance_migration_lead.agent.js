...
class PerformanceMigrationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generatePerformanceMigrationSystem(objective) {
        logger.info(`💻 [PerformanceMigrationLeadAgent] Analyzing Performance Migration Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Performance Migration Lead Target");
...
export const performanceMigrationLeadAgent = Object.freeze(new PerformanceMigrationLeadAgent());
