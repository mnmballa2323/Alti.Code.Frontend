...
class PerformanceETLPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generatePerformanceETLSystem(objective) {
        logger.info(`💻 [PerformanceETLPlannerAgent] Analyzing Performance ETL Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Performance ETL Planner Target");
...
export const performanceETLPlannerAgent = Object.freeze(new PerformanceETLPlannerAgent());
