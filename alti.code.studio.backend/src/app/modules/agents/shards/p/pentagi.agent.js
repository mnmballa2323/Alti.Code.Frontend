...
class PentagiAgent extends BaseSpecialistAgent {
    constructor() {
        super();
        this.name = 'pentagi';
        this.description = 'Autonomous Deep Penetration Testing and Security Auditing via isolated PentAGI containers.';
        this.preamble = 'You are an integration agent for the PentAGI (Penetration testing AGI) framework. You coordinate automated red-teaming, vulnerability scanning, and exploitation tests inside a secure Docker sandbox.';
    }
