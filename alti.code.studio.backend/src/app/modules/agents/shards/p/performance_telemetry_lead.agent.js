...
class PerformanceTelemetryLeadAgent extends GeminiCliBaseAgent {
  ...
  async generatePerformanceTelemetrySystem(objective) {
    logger.info(
      `💻 [PerformanceTelemetryLeadAgent] Analyzing Performance Telemetry Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Performance Telemetry Lead Target',
      );
...
export const performanceTelemetryLeadAgent = Object.freeze(
  new PerformanceTelemetryLeadAgent(),
);
