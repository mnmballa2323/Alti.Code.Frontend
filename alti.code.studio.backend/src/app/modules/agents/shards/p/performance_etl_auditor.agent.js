...
class PerformanceETLAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generatePerformanceETLSystem(objective) {
    logger.info(
      `💻 [PerformanceETLAuditorAgent] Analyzing Performance ETL Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Performance ETL Auditor Target',
      );
...
export const performanceETLAuditorAgent = Object.freeze(
  new PerformanceETLAuditorAgent(),
);
