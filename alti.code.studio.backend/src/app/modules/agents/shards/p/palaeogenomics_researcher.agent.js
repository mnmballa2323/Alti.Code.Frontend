...
class PalaeogenomicsResearcherAgent extends GeminiCliBaseAgent {
  ...
  async generateGenomicsSystem(objective) {
    logger.info(
      `🦖 [PalaeogenomicsResearcher] Analyzing ancient DNA fragments and phylogenetic trees...`,
    );
...
export const palaeogenomicsResearcherAgent = Object.freeze(
  new PalaeogenomicsResearcherAgent(),
);
