...
class PlanetaryDefenseCoordinatorAgent extends GeminiCliBaseAgent {
    ...
    async generateDeflectionSystem(objective) {
        logger.info(`🛡️ [PlanetaryDefenseCoordinator] Analyzing kinetic impactor mass and deep space telemetry...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Planetary Defense Target");
...
export const planetaryDefenseCoordinatorAgent = Object.freeze(new PlanetaryDefenseCoordinatorAgent());
