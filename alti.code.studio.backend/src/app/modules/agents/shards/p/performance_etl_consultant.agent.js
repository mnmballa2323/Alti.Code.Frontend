...
class PerformanceETLConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generatePerformanceETLSystem(objective) {
    logger.info(
      `💻 [PerformanceETLConsultantAgent] Analyzing Performance ETL Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Performance ETL Consultant Target',
      );
...
export const performanceETLConsultantAgent = Object.freeze(
  new PerformanceETLConsultantAgent(),
);
