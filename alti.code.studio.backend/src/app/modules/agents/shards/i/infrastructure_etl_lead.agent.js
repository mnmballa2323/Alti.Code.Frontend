...
class InfrastructureETLLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateInfrastructureETLSystem(objective) {
    logger.info(
      `💻 [InfrastructureETLLeadAgent] Analyzing Infrastructure ETL Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Infrastructure ETL Lead Target',
      );
...
export const infrastructureETLLeadAgent = Object.freeze(
  new InfrastructureETLLeadAgent(),
);
