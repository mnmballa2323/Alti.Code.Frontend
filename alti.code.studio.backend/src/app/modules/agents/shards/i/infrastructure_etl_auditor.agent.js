...
class InfrastructureETLAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateInfrastructureETLSystem(objective) {
    logger.info(
      `💻 [InfrastructureETLAuditorAgent] Analyzing Infrastructure ETL Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Infrastructure ETL Auditor Target',
      );
...
export const infrastructureETLAuditorAgent = Object.freeze(
  new InfrastructureETLAuditorAgent(),
);
