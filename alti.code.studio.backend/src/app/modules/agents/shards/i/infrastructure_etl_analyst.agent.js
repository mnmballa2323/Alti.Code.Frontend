...
class InfrastructureETLAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateInfrastructureETLSystem(objective) {
    logger.info(
      `💻 [InfrastructureETLAnalystAgent] Analyzing Infrastructure ETL Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Infrastructure ETL Analyst Target',
      );
...
export const infrastructureETLAnalystAgent = Object.freeze(
  new InfrastructureETLAnalystAgent(),
);
