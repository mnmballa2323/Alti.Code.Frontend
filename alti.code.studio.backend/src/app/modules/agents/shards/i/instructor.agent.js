...
class InstructorAgent {
    ...
    async analyzeAndTeach(originalCode, fixedCode, context) {
        ...
        try {
            ...
            if (context.includes("SQL")) lesson = "SECURITY: Use parameterized queries to prevent SQL injection.";
...
export const instructorAgent = Object.freeze(new InstructorAgent());
