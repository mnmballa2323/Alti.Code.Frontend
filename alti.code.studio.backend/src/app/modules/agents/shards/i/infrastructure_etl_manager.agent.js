...
class InfrastructureETLManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateInfrastructureETLSystem(objective) {
    logger.info(
      `💻 [InfrastructureETLManagerAgent] Analyzing Infrastructure ETL Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Infrastructure ETL Manager Target',
      );
...
export const infrastructureETLManagerAgent = Object.freeze(
  new InfrastructureETLManagerAgent(),
);
