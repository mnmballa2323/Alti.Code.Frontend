...
class InfrastructureETLTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateInfrastructureETLSystem(objective) {
    logger.info(
      `💻 [InfrastructureETLTesterAgent] Analyzing Infrastructure ETL Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Infrastructure ETL Tester Target',
      );
...
export const infrastructureETLTesterAgent = Object.freeze(
  new InfrastructureETLTesterAgent(),
);
