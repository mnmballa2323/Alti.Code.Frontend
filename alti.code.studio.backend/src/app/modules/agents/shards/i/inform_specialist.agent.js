...
class Inform7SpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateInform7System(objective) {
        logger.info(`💻 [Inform7SpecialistAgent] Analyzing Inform 7 requirements...`);
...
export const Inform7SpecialistAgentInstance = Object.freeze(new Inform7SpecialistAgent());
