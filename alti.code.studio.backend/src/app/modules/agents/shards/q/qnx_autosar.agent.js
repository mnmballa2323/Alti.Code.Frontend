...
class QnxAutosarAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Automotive software architect specializing in the QNX Neutrino RTOS, AUTOSAR Classic/Adaptive platforms, and MISRA-C compliant CAN bus telemetrics.';
...
export const qnxAutosarAgent = Object.freeze(new QnxAutosarAgent());
