...
class QuantumComputeAgent extends GeminiCliBaseAgent {
    ...
    async generateQuantumCircuit(classicalAlgorithm) {
        logger.info(`⚛️ [QuantumCompute] Analyzing classical algorithm for quantum circuit translation...`);
...
${classicalAlgorithm}
        ...
        try {
            ...
            logger.info(`✅ [QuantumCompute] Quantum Circuit generated successfully.`);
            return cleanCode;
        } catch (err) {
            logger.error(`❌ [QuantumCompute] Failed to generate Quantum Circuit: ${err.message}`);
            throw err;
        }
    }
}
