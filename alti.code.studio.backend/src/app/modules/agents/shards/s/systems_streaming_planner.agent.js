...
class SystemsStreamingPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsStreamingSystem(objective) {
        logger.info(`💻 [SystemsStreamingPlannerAgent] Analyzing Systems Streaming Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Streaming Planner Target");
...
export const systemsStreamingPlannerAgent = Object.freeze(new SystemsStreamingPlannerAgent());
