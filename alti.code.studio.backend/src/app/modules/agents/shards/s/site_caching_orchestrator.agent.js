...
class SiteCachingOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteCachingSystem(objective) {
    logger.info(
      `💻 [SiteCachingOrchestratorAgent] Analyzing Site Caching Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Caching Orchestrator Target',
      );
...
export const siteCachingOrchestratorAgent = Object.freeze(
  new SiteCachingOrchestratorAgent(),
);
