...
class SREObservabilityLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateSREObservabilitySystem(objective) {
        logger.info(`💻 [SREObservabilityLeadAgent] Analyzing SRE Observability Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Observability Lead Target");
...
export const sREObservabilityLeadAgent = Object.freeze(new SREObservabilityLeadAgent());
