...
class SREGovernanceDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSREGovernanceSystem(objective) {
    logger.info(
      `💻 [SREGovernanceDeveloperAgent] Analyzing SRE Governance Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Governance Developer Target',
      );
...
export const sREGovernanceDeveloperAgent = Object.freeze(
  new SREGovernanceDeveloperAgent(),
);
