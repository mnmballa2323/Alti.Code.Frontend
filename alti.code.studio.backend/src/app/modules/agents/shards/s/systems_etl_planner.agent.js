...
class SystemsETLPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsETLSystem(objective) {
    logger.info(
      `💻 [SystemsETLPlannerAgent] Analyzing Systems ETL Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems ETL Planner Target',
      );
...
export const systemsETLPlannerAgent = Object.freeze(
  new SystemsETLPlannerAgent(),
);
