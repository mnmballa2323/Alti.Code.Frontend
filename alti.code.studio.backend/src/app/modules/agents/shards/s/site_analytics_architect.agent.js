...
class SiteAnalyticsArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteAnalyticsSystem(objective) {
    logger.info(
      `💻 [SiteAnalyticsArchitectAgent] Analyzing Site Analytics Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Analytics Architect Target',
      );
...
export const siteAnalyticsArchitectAgent = Object.freeze(
  new SiteAnalyticsArchitectAgent(),
);
