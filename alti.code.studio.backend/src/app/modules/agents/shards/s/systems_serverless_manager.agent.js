...
class SystemsServerlessManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsServerlessSystem(objective) {
        logger.info(`💻 [SystemsServerlessManagerAgent] Analyzing Systems Serverless Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Serverless Manager Target");
...
export const systemsServerlessManagerAgent = Object.freeze(new SystemsServerlessManagerAgent());
