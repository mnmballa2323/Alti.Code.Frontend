...
class SiteArchitectureEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteArchitectureSystem(objective) {
    logger.info(
      `💻 [SiteArchitectureEngineerAgent] Analyzing Site Architecture Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Architecture Engineer Target',
      );
...
export const siteArchitectureEngineerAgent = Object.freeze(
  new SiteArchitectureEngineerAgent(),
);
