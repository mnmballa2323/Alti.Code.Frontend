...
class SiteEngineeringArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteEngineeringSystem(objective) {
    logger.info(
      `💻 [SiteEngineeringArchitectAgent] Analyzing Site Engineering Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Engineering Architect Target',
      );
...
export const siteEngineeringArchitectAgent = Object.freeze(
  new SiteEngineeringArchitectAgent(),
);
