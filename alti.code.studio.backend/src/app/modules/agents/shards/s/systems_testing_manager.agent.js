...
class SystemsTestingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsTestingSystem(objective) {
    logger.info(
      `💻 [SystemsTestingManagerAgent] Analyzing Systems Testing Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Testing Manager Target',
      );
...
export const systemsTestingManagerAgent = Object.freeze(
  new SystemsTestingManagerAgent(),
);
