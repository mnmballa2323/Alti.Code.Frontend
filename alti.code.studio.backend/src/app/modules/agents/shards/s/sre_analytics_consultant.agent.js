...
class SREAnalyticsConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateSREAnalyticsSystem(objective) {
    logger.info(
      `💻 [SREAnalyticsConsultantAgent] Analyzing SRE Analytics Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Analytics Consultant Target',
      );
...
export const sREAnalyticsConsultantAgent = Object.freeze(
  new SREAnalyticsConsultantAgent(),
);
