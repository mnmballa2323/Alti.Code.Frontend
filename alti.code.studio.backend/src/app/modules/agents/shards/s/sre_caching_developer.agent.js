...
class SRECachingDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSRECachingSystem(objective) {
    logger.info(
      `💻 [SRECachingDeveloperAgent] Analyzing SRE Caching Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Caching Developer Target',
      );
...
export const sRECachingDeveloperAgent = Object.freeze(
  new SRECachingDeveloperAgent(),
);
