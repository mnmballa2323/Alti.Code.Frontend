...
class SREFaultToleranceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSREFaultToleranceSystem(objective) {
    logger.info(
      `💻 [SREFaultToleranceTesterAgent] Analyzing SRE FaultTolerance Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE FaultTolerance Tester Target',
      );
...
export const sREFaultToleranceTesterAgent = Object.freeze(
  new SREFaultToleranceTesterAgent(),
);
