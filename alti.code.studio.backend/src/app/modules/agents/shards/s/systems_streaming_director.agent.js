...
class SystemsStreamingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsStreamingSystem(objective) {
    logger.info(
      `💻 [SystemsStreamingDirectorAgent] Analyzing Systems Streaming Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Streaming Director Target',
      );
...
export const systemsStreamingDirectorAgent = Object.freeze(
  new SystemsStreamingDirectorAgent(),
);
