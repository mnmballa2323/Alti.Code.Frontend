...
class SiteVirtualizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteVirtualizationSystem(objective) {
    logger.info(
      `💻 [SiteVirtualizationLeadAgent] Analyzing Site Virtualization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Virtualization Lead Target',
      );
...
export const siteVirtualizationLeadAgent = Object.freeze(
  new SiteVirtualizationLeadAgent(),
);
