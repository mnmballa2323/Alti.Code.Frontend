...
class SiteDataWarehouseManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteDataWarehouseSystem(objective) {
        logger.info(`💻 [SiteDataWarehouseManagerAgent] Analyzing Site DataWarehouse Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site DataWarehouse Manager Target");
...
export const siteDataWarehouseManagerAgent = Object.freeze(new SiteDataWarehouseManagerAgent());
