...
class SiteServerlessConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteServerlessSystem(objective) {
    logger.info(
      `💻 [SiteServerlessConsultantAgent] Analyzing Site Serverless Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Serverless Consultant Target',
      );
...
export const siteServerlessConsultantAgent = Object.freeze(
  new SiteServerlessConsultantAgent(),
);
