...
class SRETestingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSRETestingSystem(objective) {
    logger.info(
      `💻 [SRETestingDesignerAgent] Analyzing SRE Testing Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Testing Designer Target',
      );
...
export const sRETestingDesignerAgent = Object.freeze(
  new SRETestingDesignerAgent(),
);
