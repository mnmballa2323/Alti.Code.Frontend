...
class SREEngineeringConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateSREEngineeringSystem(objective) {
    logger.info(
      `💻 [SREEngineeringConsultantAgent] Analyzing SRE Engineering Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Engineering Consultant Target',
      );
...
export const sREEngineeringConsultantAgent = Object.freeze(
  new SREEngineeringConsultantAgent(),
);
