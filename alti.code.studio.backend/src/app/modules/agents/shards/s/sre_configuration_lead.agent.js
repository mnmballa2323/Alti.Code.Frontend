...
class SREConfigurationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSREConfigurationSystem(objective) {
    logger.info(
      `💻 [SREConfigurationLeadAgent] Analyzing SRE Configuration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Configuration Lead Target',
      );
...
export const sREConfigurationLeadAgent = Object.freeze(
  new SREConfigurationLeadAgent(),
);
