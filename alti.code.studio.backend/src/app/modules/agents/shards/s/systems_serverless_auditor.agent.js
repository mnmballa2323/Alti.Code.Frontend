...
class SystemsServerlessAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsServerlessSystem(objective) {
        logger.info(`💻 [SystemsServerlessAuditorAgent] Analyzing Systems Serverless Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Serverless Auditor Target");
...
export const systemsServerlessAuditorAgent = Object.freeze(new SystemsServerlessAuditorAgent());
