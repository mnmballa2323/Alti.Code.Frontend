...
class SiteObservabilityPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteObservabilitySystem(objective) {
    logger.info(
      `💻 [SiteObservabilityPlannerAgent] Analyzing Site Observability Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Observability Planner Target',
      );
...
export const siteObservabilityPlannerAgent = Object.freeze(
  new SiteObservabilityPlannerAgent(),
);
