...
class SiteOptimizationEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteOptimizationSystem(objective) {
        logger.info(`💻 [SiteOptimizationEngineerAgent] Analyzing Site Optimization Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Optimization Engineer Target");
...
export const siteOptimizationEngineerAgent = Object.freeze(new SiteOptimizationEngineerAgent());
