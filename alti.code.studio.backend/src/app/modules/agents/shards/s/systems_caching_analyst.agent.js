...
class SystemsCachingAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsCachingSystem(objective) {
    logger.info(
      `💻 [SystemsCachingAnalystAgent] Analyzing Systems Caching Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Caching Analyst Target',
      );
...
export const systemsCachingAnalystAgent = Object.freeze(
  new SystemsCachingAnalystAgent(),
);
