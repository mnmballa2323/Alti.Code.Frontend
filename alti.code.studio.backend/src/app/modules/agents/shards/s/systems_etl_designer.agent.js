...
class SystemsETLDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsETLSystem(objective) {
    logger.info(
      `💻 [SystemsETLDesignerAgent] Analyzing Systems ETL Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems ETL Designer Target',
      );
...
export const systemsETLDesignerAgent = Object.freeze(
  new SystemsETLDesignerAgent(),
);
