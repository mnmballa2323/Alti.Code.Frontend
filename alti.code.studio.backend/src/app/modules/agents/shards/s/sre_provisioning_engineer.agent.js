...
class SREProvisioningEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateSREProvisioningSystem(objective) {
        logger.info(`💻 [SREProvisioningEngineerAgent] Analyzing SRE Provisioning Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Provisioning Engineer Target");
...
export const sREProvisioningEngineerAgent = Object.freeze(new SREProvisioningEngineerAgent());
