...
class SiteScalingConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteScalingSystem(objective) {
    logger.info(
      `💻 [SiteScalingConsultantAgent] Analyzing Site Scaling Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Scaling Consultant Target',
      );
...
export const siteScalingConsultantAgent = Object.freeze(
  new SiteScalingConsultantAgent(),
);
