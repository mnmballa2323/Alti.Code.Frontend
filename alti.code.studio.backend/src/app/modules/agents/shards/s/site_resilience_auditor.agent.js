...
class SiteResilienceAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteResilienceSystem(objective) {
        logger.info(`💻 [SiteResilienceAuditorAgent] Analyzing Site Resilience Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Resilience Auditor Target");
...
export const siteResilienceAuditorAgent = Object.freeze(new SiteResilienceAuditorAgent());
