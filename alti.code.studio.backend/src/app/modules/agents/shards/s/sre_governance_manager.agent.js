...
class SREGovernanceManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREGovernanceSystem(objective) {
    logger.info(
      `💻 [SREGovernanceManagerAgent] Analyzing SRE Governance Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Governance Manager Target',
      );
...
export const sREGovernanceManagerAgent = Object.freeze(
  new SREGovernanceManagerAgent(),
);
