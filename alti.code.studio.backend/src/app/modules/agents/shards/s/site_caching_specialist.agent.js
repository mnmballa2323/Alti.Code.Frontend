...
class SiteCachingSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteCachingSystem(objective) {
    logger.info(
      `💻 [SiteCachingSpecialistAgent] Analyzing Site Caching Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Caching Specialist Target',
      );
...
export const siteCachingSpecialistAgent = Object.freeze(
  new SiteCachingSpecialistAgent(),
);
