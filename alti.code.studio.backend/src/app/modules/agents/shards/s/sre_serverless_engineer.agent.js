...
class SREServerlessEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREServerlessSystem(objective) {
    logger.info(
      `💻 [SREServerlessEngineerAgent] Analyzing SRE Serverless Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Serverless Engineer Target',
      );
...
export const sREServerlessEngineerAgent = Object.freeze(
  new SREServerlessEngineerAgent(),
);
