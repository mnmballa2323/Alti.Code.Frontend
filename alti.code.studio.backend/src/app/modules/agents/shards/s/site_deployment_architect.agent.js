...
class SiteDeploymentArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteDeploymentSystem(objective) {
    logger.info(
      `💻 [SiteDeploymentArchitectAgent] Analyzing Site Deployment Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Deployment Architect Target',
      );
...
export const siteDeploymentArchitectAgent = Object.freeze(
  new SiteDeploymentArchitectAgent(),
);
