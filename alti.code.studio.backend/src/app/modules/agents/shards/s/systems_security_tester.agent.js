...
class SystemsSecurityTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsSecuritySystem(objective) {
        logger.info(`💻 [SystemsSecurityTesterAgent] Analyzing Systems Security Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Security Tester Target");
...
export const systemsSecurityTesterAgent = Object.freeze(new SystemsSecurityTesterAgent());
