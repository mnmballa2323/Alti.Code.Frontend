...
class SystemsETLDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsETLSystem(objective) {
        logger.info(`💻 [SystemsETLDirectorAgent] Analyzing Systems ETL Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems ETL Director Target");
...
export const systemsETLDirectorAgent = Object.freeze(new SystemsETLDirectorAgent());
