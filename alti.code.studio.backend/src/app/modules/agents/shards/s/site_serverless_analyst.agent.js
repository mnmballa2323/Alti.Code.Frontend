...
class SiteServerlessAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteServerlessSystem(objective) {
    logger.info(
      `💻 [SiteServerlessAnalystAgent] Analyzing Site Serverless Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Serverless Analyst Target',
      );
...
export const siteServerlessAnalystAgent = Object.freeze(
  new SiteServerlessAnalystAgent(),
);
