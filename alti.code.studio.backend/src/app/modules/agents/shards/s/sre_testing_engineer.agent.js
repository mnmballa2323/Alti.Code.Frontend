...
class SRETestingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSRETestingSystem(objective) {
    logger.info(
      `💻 [SRETestingEngineerAgent] Analyzing SRE Testing Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Testing Engineer Target',
      );
...
export const sRETestingEngineerAgent = Object.freeze(
  new SRETestingEngineerAgent(),
);
