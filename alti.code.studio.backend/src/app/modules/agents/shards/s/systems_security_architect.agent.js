...
class SystemsSecurityArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsSecuritySystem(objective) {
    logger.info(
      `💻 [SystemsSecurityArchitectAgent] Analyzing Systems Security Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Security Architect Target',
      );
...
export const systemsSecurityArchitectAgent = Object.freeze(
  new SystemsSecurityArchitectAgent(),
);
