...
class SiteGovernanceAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteGovernanceSystem(objective) {
    logger.info(
      `💻 [SiteGovernanceAuditorAgent] Analyzing Site Governance Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Governance Auditor Target',
      );
...
export const siteGovernanceAuditorAgent = Object.freeze(
  new SiteGovernanceAuditorAgent(),
);
