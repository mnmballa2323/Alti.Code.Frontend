...
class SiteGovernanceDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteGovernanceSystem(objective) {
    logger.info(
      `💻 [SiteGovernanceDirectorAgent] Analyzing Site Governance Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Governance Director Target',
      );
...
export const siteGovernanceDirectorAgent = Object.freeze(
  new SiteGovernanceDirectorAgent(),
);
