...
class SiteResiliencePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteResilienceSystem(objective) {
        logger.info(`💻 [SiteResiliencePlannerAgent] Analyzing Site Resilience Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Resilience Planner Target");
...
export const siteResiliencePlannerAgent = Object.freeze(new SiteResiliencePlannerAgent());
