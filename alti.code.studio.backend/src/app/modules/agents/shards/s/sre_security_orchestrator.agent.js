...
class SRESecurityOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateSRESecuritySystem(objective) {
    logger.info(
      `💻 [SRESecurityOrchestratorAgent] Analyzing SRE Security Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Security Orchestrator Target',
      );
...
export const sRESecurityOrchestratorAgent = Object.freeze(
  new SRESecurityOrchestratorAgent(),
);
