...
class SiteObservabilityAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteObservabilitySystem(objective) {
    logger.info(
      `💻 [SiteObservabilityAuditorAgent] Analyzing Site Observability Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Observability Auditor Target',
      );
...
export const siteObservabilityAuditorAgent = Object.freeze(
  new SiteObservabilityAuditorAgent(),
);
