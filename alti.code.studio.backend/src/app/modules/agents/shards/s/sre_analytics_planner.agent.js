...
class SREAnalyticsPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREAnalyticsSystem(objective) {
    logger.info(
      `💻 [SREAnalyticsPlannerAgent] Analyzing SRE Analytics Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Analytics Planner Target',
      );
...
export const sREAnalyticsPlannerAgent = Object.freeze(
  new SREAnalyticsPlannerAgent(),
);
