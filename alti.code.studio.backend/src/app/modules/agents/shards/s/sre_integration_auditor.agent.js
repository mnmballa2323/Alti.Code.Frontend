...
class SREIntegrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREIntegrationSystem(objective) {
    logger.info(
      `💻 [SREIntegrationAuditorAgent] Analyzing SRE Integration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Integration Auditor Target',
      );
...
export const sREIntegrationAuditorAgent = Object.freeze(
  new SREIntegrationAuditorAgent(),
);
