...
class SiteScalingTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteScalingSystem(objective) {
        logger.info(`💻 [SiteScalingTesterAgent] Analyzing Site Scaling Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Scaling Tester Target");
...
export const siteScalingTesterAgent = Object.freeze(new SiteScalingTesterAgent());
