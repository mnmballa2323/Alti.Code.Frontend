...
class SiteAutomationDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteAutomationSystem(objective) {
        logger.info(`💻 [SiteAutomationDirectorAgent] Analyzing Site Automation Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Automation Director Target");
...
export const siteAutomationDirectorAgent = Object.freeze(new SiteAutomationDirectorAgent());
