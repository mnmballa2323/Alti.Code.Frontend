...
class SiteStreamingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteStreamingSystem(objective) {
    logger.info(
      `💻 [SiteStreamingDesignerAgent] Analyzing Site Streaming Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Streaming Designer Target',
      );
...
export const siteStreamingDesignerAgent = Object.freeze(
  new SiteStreamingDesignerAgent(),
);
