...
class SREMigrationEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREMigrationSystem(objective) {
    logger.info(
      `💻 [SREMigrationEngineerAgent] Analyzing SRE Migration Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Migration Engineer Target',
      );
...
export const sREMigrationEngineerAgent = Object.freeze(
  new SREMigrationEngineerAgent(),
);
