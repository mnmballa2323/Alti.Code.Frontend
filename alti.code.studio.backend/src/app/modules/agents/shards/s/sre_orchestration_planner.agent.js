...
class SREOrchestrationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREOrchestrationSystem(objective) {
    logger.info(
      `💻 [SREOrchestrationPlannerAgent] Analyzing SRE Orchestration Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Orchestration Planner Target',
      );
...
export const sREOrchestrationPlannerAgent = Object.freeze(
  new SREOrchestrationPlannerAgent(),
);
