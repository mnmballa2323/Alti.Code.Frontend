...
class SiteAutomationDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteAutomationSystem(objective) {
    logger.info(
      `💻 [SiteAutomationDeveloperAgent] Analyzing Site Automation Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Automation Developer Target',
      );
...
export const siteAutomationDeveloperAgent = Object.freeze(
  new SiteAutomationDeveloperAgent(),
);
