...
class SiteOptimizationDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteOptimizationSystem(objective) {
    logger.info(
      `💻 [SiteOptimizationDesignerAgent] Analyzing Site Optimization Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Optimization Designer Target',
      );
...
export const siteOptimizationDesignerAgent = Object.freeze(
  new SiteOptimizationDesignerAgent(),
);
