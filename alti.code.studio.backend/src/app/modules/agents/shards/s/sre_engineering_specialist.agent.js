...
class SREEngineeringSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateSREEngineeringSystem(objective) {
    logger.info(
      `💻 [SREEngineeringSpecialistAgent] Analyzing SRE Engineering Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Engineering Specialist Target',
      );
...
export const sREEngineeringSpecialistAgent = Object.freeze(
  new SREEngineeringSpecialistAgent(),
);
