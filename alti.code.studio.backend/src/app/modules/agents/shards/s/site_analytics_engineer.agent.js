...
class SiteAnalyticsEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteAnalyticsSystem(objective) {
    logger.info(
      `💻 [SiteAnalyticsEngineerAgent] Analyzing Site Analytics Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Analytics Engineer Target',
      );
...
export const siteAnalyticsEngineerAgent = Object.freeze(
  new SiteAnalyticsEngineerAgent(),
);
