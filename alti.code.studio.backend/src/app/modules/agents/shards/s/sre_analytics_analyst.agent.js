...
class SREAnalyticsAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSREAnalyticsSystem(objective) {
    logger.info(
      `💻 [SREAnalyticsAnalystAgent] Analyzing SRE Analytics Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Analytics Analyst Target',
      );
...
export const sREAnalyticsAnalystAgent = Object.freeze(
  new SREAnalyticsAnalystAgent(),
);
