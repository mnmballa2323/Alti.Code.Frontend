...
class SecurityTestingArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateSecurityTestingSystem(objective) {
    logger.info(
      `💻 [SecurityTestingArchitectAgent] Analyzing Security Testing Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Security Testing Architect Target',
      );
...
export const securityTestingArchitectAgent = Object.freeze(
  new SecurityTestingArchitectAgent(),
);
