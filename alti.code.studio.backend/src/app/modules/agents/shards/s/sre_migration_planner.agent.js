...
class SREMigrationPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateSREMigrationSystem(objective) {
        logger.info(`💻 [SREMigrationPlannerAgent] Analyzing SRE Migration Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Migration Planner Target");
...
export const sREMigrationPlannerAgent = Object.freeze(new SREMigrationPlannerAgent());
