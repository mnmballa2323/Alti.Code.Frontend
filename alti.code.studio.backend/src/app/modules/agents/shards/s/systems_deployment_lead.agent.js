...
class SystemsDeploymentLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsDeploymentSystem(objective) {
    logger.info(
      `💻 [SystemsDeploymentLeadAgent] Analyzing Systems Deployment Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Deployment Lead Target',
      );
...
export const systemsDeploymentLeadAgent = Object.freeze(
  new SystemsDeploymentLeadAgent(),
);
