...
class SiteDataLakeArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteDataLakeSystem(objective) {
    logger.info(
      `💻 [SiteDataLakeArchitectAgent] Analyzing Site DataLake Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site DataLake Architect Target',
      );
...
export const siteDataLakeArchitectAgent = Object.freeze(
  new SiteDataLakeArchitectAgent(),
);
