...
class SREOptimizationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateSREOptimizationSystem(objective) {
        logger.info(`💻 [SREOptimizationLeadAgent] Analyzing SRE Optimization Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Optimization Lead Target");
...
export const sREOptimizationLeadAgent = Object.freeze(new SREOptimizationLeadAgent());
