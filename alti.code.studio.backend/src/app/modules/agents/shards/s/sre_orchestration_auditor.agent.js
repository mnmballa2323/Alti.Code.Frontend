...
class SREOrchestrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREOrchestrationSystem(objective) {
    logger.info(
      `💻 [SREOrchestrationAuditorAgent] Analyzing SRE Orchestration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Orchestration Auditor Target',
      );
...
export const sREOrchestrationAuditorAgent = Object.freeze(
  new SREOrchestrationAuditorAgent(),
);
