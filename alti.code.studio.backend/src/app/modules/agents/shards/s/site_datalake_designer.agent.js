...
class SiteDataLakeDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteDataLakeSystem(objective) {
    logger.info(
      `💻 [SiteDataLakeDesignerAgent] Analyzing Site DataLake Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site DataLake Designer Target',
      );
...
export const siteDataLakeDesignerAgent = Object.freeze(
  new SiteDataLakeDesignerAgent(),
);
