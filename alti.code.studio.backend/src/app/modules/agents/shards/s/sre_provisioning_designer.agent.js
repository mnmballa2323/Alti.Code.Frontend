...
class SREProvisioningDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREProvisioningSystem(objective) {
    logger.info(
      `💻 [SREProvisioningDesignerAgent] Analyzing SRE Provisioning Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Provisioning Designer Target',
      );
...
export const sREProvisioningDesignerAgent = Object.freeze(
  new SREProvisioningDesignerAgent(),
);
