...
class SiteOptimizationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteOptimizationSystem(objective) {
    logger.info(
      `💻 [SiteOptimizationAuditorAgent] Analyzing Site Optimization Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Optimization Auditor Target',
      );
...
export const siteOptimizationAuditorAgent = Object.freeze(
  new SiteOptimizationAuditorAgent(),
);
