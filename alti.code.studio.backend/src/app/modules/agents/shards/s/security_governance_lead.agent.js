...
class SecurityGovernanceLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateSecurityGovernanceSystem(objective) {
        logger.info(`💻 [SecurityGovernanceLeadAgent] Analyzing Security Governance Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Security Governance Lead Target");
...
export const securityGovernanceLeadAgent = Object.freeze(new SecurityGovernanceLeadAgent());
