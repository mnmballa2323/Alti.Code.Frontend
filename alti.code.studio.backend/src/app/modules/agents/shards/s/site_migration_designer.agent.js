...
class SiteMigrationDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteMigrationSystem(objective) {
    logger.info(
      `💻 [SiteMigrationDesignerAgent] Analyzing Site Migration Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Migration Designer Target',
      );
...
export const siteMigrationDesignerAgent = Object.freeze(
  new SiteMigrationDesignerAgent(),
);
