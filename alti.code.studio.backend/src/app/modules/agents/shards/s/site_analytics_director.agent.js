...
class SiteAnalyticsDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteAnalyticsSystem(objective) {
    logger.info(
      `💻 [SiteAnalyticsDirectorAgent] Analyzing Site Analytics Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Analytics Director Target',
      );
...
export const siteAnalyticsDirectorAgent = Object.freeze(
  new SiteAnalyticsDirectorAgent(),
);
