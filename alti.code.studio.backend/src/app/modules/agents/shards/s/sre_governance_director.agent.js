...
class SREGovernanceDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREGovernanceSystem(objective) {
    logger.info(
      `💻 [SREGovernanceDirectorAgent] Analyzing SRE Governance Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Governance Director Target',
      );
...
export const sREGovernanceDirectorAgent = Object.freeze(
  new SREGovernanceDirectorAgent(),
);
