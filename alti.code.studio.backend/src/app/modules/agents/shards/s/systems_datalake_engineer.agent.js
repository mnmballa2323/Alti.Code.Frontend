...
class SystemsDataLakeEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsDataLakeSystem(objective) {
        logger.info(`💻 [SystemsDataLakeEngineerAgent] Analyzing Systems DataLake Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems DataLake Engineer Target");
...
export const systemsDataLakeEngineerAgent = Object.freeze(new SystemsDataLakeEngineerAgent());
