...
class SiteStreamingAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteStreamingSystem(objective) {
        logger.info(`💻 [SiteStreamingAnalystAgent] Analyzing Site Streaming Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Streaming Analyst Target");
...
export const siteStreamingAnalystAgent = Object.freeze(new SiteStreamingAnalystAgent());
