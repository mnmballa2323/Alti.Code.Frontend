...
class SREComplianceAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREComplianceSystem(objective) {
    logger.info(
      `💻 [SREComplianceAuditorAgent] Analyzing SRE Compliance Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Compliance Auditor Target',
      );
...
export const sREComplianceAuditorAgent = Object.freeze(
  new SREComplianceAuditorAgent(),
);
