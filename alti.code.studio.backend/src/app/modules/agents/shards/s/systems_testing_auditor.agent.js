...
class SystemsTestingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsTestingSystem(objective) {
    logger.info(
      `💻 [SystemsTestingAuditorAgent] Analyzing Systems Testing Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Testing Auditor Target',
      );
...
export const systemsTestingAuditorAgent = Object.freeze(
  new SystemsTestingAuditorAgent(),
);
