...
class SystemsETLConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsETLSystem(objective) {
        logger.info(`💻 [SystemsETLConsultantAgent] Analyzing Systems ETL Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems ETL Consultant Target");
...
export const systemsETLConsultantAgent = Object.freeze(new SystemsETLConsultantAgent());
