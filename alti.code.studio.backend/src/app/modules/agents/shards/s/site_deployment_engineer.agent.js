...
class SiteDeploymentEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteDeploymentSystem(objective) {
    logger.info(
      `💻 [SiteDeploymentEngineerAgent] Analyzing Site Deployment Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Deployment Engineer Target',
      );
...
export const siteDeploymentEngineerAgent = Object.freeze(
  new SiteDeploymentEngineerAgent(),
);
