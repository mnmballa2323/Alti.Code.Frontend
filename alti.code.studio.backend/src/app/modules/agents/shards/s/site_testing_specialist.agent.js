...
class SiteTestingSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteTestingSystem(objective) {
        logger.info(`💻 [SiteTestingSpecialistAgent] Analyzing Site Testing Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Testing Specialist Target");
...
export const siteTestingSpecialistAgent = Object.freeze(new SiteTestingSpecialistAgent());
