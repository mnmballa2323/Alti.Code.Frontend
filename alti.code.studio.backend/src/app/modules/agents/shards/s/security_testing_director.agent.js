...
class SecurityTestingDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateSecurityTestingSystem(objective) {
        logger.info(`💻 [SecurityTestingDirectorAgent] Analyzing Security Testing Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Security Testing Director Target");
...
export const securityTestingDirectorAgent = Object.freeze(new SecurityTestingDirectorAgent());
