...
class SiteOrchestrationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteOrchestrationSystem(objective) {
    logger.info(
      `💻 [SiteOrchestrationManagerAgent] Analyzing Site Orchestration Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Orchestration Manager Target',
      );
...
export const siteOrchestrationManagerAgent = Object.freeze(
  new SiteOrchestrationManagerAgent(),
);
