...
class SecurityAutomationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSecurityAutomationSystem(objective) {
    logger.info(
      `💻 [SecurityAutomationLeadAgent] Analyzing Security Automation Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Security Automation Lead Target',
      );
...
export const securityAutomationLeadAgent = Object.freeze(
  new SecurityAutomationLeadAgent(),
);
