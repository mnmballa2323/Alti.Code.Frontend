...
class SystemsTelemetryManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsTelemetrySystem(objective) {
    logger.info(
      `💻 [SystemsTelemetryManagerAgent] Analyzing Systems Telemetry Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Telemetry Manager Target',
      );
...
export const systemsTelemetryManagerAgent = Object.freeze(
  new SystemsTelemetryManagerAgent(),
);
