...
class SiteStreamingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteStreamingSystem(objective) {
    logger.info(
      `💻 [SiteStreamingDirectorAgent] Analyzing Site Streaming Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Streaming Director Target',
      );
...
export const siteStreamingDirectorAgent = Object.freeze(
  new SiteStreamingDirectorAgent(),
);
