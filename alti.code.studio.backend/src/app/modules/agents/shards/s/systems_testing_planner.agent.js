...
class SystemsTestingPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsTestingSystem(objective) {
    logger.info(
      `💻 [SystemsTestingPlannerAgent] Analyzing Systems Testing Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Testing Planner Target',
      );
...
export const systemsTestingPlannerAgent = Object.freeze(
  new SystemsTestingPlannerAgent(),
);
