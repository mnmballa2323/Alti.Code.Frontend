...
class SiteResilienceSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteResilienceSystem(objective) {
        logger.info(`💻 [SiteResilienceSpecialistAgent] Analyzing Site Resilience Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Resilience Specialist Target");
...
export const siteResilienceSpecialistAgent = Object.freeze(new SiteResilienceSpecialistAgent());
