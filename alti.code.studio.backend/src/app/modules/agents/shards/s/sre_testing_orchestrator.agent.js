...
class SRETestingOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateSRETestingSystem(objective) {
    logger.info(
      `💻 [SRETestingOrchestratorAgent] Analyzing SRE Testing Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Testing Orchestrator Target',
      );
...
export const sRETestingOrchestratorAgent = Object.freeze(
  new SRETestingOrchestratorAgent(),
);
