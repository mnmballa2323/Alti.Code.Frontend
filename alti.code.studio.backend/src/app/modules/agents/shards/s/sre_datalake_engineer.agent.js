...
class SREDataLakeEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREDataLakeSystem(objective) {
    logger.info(
      `💻 [SREDataLakeEngineerAgent] Analyzing SRE DataLake Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE DataLake Engineer Target',
      );
...
export const sREDataLakeEngineerAgent = Object.freeze(
  new SREDataLakeEngineerAgent(),
);
