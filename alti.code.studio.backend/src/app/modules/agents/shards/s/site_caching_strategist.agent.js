...
class SiteCachingStrategistAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteCachingSystem(objective) {
        logger.info(`💻 [SiteCachingStrategistAgent] Analyzing Site Caching Strategist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Caching Strategist Target");
...
export const siteCachingStrategistAgent = Object.freeze(new SiteCachingStrategistAgent());
