...
class SystemsCachingConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsCachingSystem(objective) {
    logger.info(
      `💻 [SystemsCachingConsultantAgent] Analyzing Systems Caching Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Caching Consultant Target',
      );
...
export const systemsCachingConsultantAgent = Object.freeze(
  new SystemsCachingConsultantAgent(),
);
