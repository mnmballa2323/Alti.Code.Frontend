...
class SiteScalingDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteScalingSystem(objective) {
        logger.info(`💻 [SiteScalingDesignerAgent] Analyzing Site Scaling Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Scaling Designer Target");
...
export const siteScalingDesignerAgent = Object.freeze(new SiteScalingDesignerAgent());
