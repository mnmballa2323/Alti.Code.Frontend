...
class SREOptimizationDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREOptimizationSystem(objective) {
    logger.info(
      `💻 [SREOptimizationDesignerAgent] Analyzing SRE Optimization Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Optimization Designer Target',
      );
...
export const sREOptimizationDesignerAgent = Object.freeze(
  new SREOptimizationDesignerAgent(),
);
