...
class SystemsScalingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsScalingSystem(objective) {
    logger.info(
      `💻 [SystemsScalingLeadAgent] Analyzing Systems Scaling Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Scaling Lead Target',
      );
...
export const systemsScalingLeadAgent = Object.freeze(
  new SystemsScalingLeadAgent(),
);
