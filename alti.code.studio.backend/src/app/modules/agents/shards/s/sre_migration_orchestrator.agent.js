...
class SREMigrationOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREMigrationSystem(objective) {
    logger.info(
      `💻 [SREMigrationOrchestratorAgent] Analyzing SRE Migration Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Migration Orchestrator Target',
      );
...
export const sREMigrationOrchestratorAgent = Object.freeze(
  new SREMigrationOrchestratorAgent(),
);
