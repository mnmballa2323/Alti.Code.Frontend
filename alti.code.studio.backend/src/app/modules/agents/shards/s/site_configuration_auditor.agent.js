...
class SiteConfigurationAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteConfigurationSystem(objective) {
        logger.info(`💻 [SiteConfigurationAuditorAgent] Analyzing Site Configuration Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Configuration Auditor Target");
...
export const siteConfigurationAuditorAgent = Object.freeze(new SiteConfigurationAuditorAgent());
