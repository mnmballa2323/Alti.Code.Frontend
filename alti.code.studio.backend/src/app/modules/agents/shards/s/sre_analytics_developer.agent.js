...
class SREAnalyticsDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSREAnalyticsSystem(objective) {
    logger.info(
      `💻 [SREAnalyticsDeveloperAgent] Analyzing SRE Analytics Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Analytics Developer Target',
      );
...
export const sREAnalyticsDeveloperAgent = Object.freeze(
  new SREAnalyticsDeveloperAgent(),
);
