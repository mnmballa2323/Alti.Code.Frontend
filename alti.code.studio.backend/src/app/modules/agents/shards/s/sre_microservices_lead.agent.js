...
class SREMicroservicesLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSREMicroservicesSystem(objective) {
    logger.info(
      `💻 [SREMicroservicesLeadAgent] Analyzing SRE Microservices Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Microservices Lead Target',
      );
...
export const sREMicroservicesLeadAgent = Object.freeze(
  new SREMicroservicesLeadAgent(),
);
