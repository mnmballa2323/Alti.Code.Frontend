...
class SREMicroservicesDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREMicroservicesSystem(objective) {
    logger.info(
      `💻 [SREMicroservicesDesignerAgent] Analyzing SRE Microservices Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Microservices Designer Target',
      );
...
export const sREMicroservicesDesignerAgent = Object.freeze(
  new SREMicroservicesDesignerAgent(),
);
