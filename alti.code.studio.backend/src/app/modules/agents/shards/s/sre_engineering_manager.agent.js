...
class SREEngineeringManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREEngineeringSystem(objective) {
    logger.info(
      `💻 [SREEngineeringManagerAgent] Analyzing SRE Engineering Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Engineering Manager Target',
      );
...
export const sREEngineeringManagerAgent = Object.freeze(
  new SREEngineeringManagerAgent(),
);
