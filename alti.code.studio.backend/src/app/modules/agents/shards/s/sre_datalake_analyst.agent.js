...
class SREDataLakeAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSREDataLakeSystem(objective) {
    logger.info(
      `💻 [SREDataLakeAnalystAgent] Analyzing SRE DataLake Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE DataLake Analyst Target',
      );
...
export const sREDataLakeAnalystAgent = Object.freeze(
  new SREDataLakeAnalystAgent(),
);
