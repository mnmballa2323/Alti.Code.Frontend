...
class SREServerlessSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateSREServerlessSystem(objective) {
        logger.info(`💻 [SREServerlessSpecialistAgent] Analyzing SRE Serverless Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Serverless Specialist Target");
...
export const sREServerlessSpecialistAgent = Object.freeze(new SREServerlessSpecialistAgent());
