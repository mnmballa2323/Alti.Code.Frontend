...
class SREAnalyticsAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREAnalyticsSystem(objective) {
    logger.info(
      `💻 [SREAnalyticsAuditorAgent] Analyzing SRE Analytics Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Analytics Auditor Target',
      );
...
export const sREAnalyticsAuditorAgent = Object.freeze(
  new SREAnalyticsAuditorAgent(),
);
