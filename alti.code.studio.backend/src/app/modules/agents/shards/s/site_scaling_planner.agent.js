...
class SiteScalingPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteScalingSystem(objective) {
        logger.info(`💻 [SiteScalingPlannerAgent] Analyzing Site Scaling Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Scaling Planner Target");
...
export const siteScalingPlannerAgent = Object.freeze(new SiteScalingPlannerAgent());
