...
class SystemsTelemetryTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsTelemetrySystem(objective) {
        logger.info(`💻 [SystemsTelemetryTesterAgent] Analyzing Systems Telemetry Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Telemetry Tester Target");
...
export const systemsTelemetryTesterAgent = Object.freeze(new SystemsTelemetryTesterAgent());
