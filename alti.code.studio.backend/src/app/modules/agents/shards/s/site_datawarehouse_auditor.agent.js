...
class SiteDataWarehouseAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteDataWarehouseSystem(objective) {
    logger.info(
      `💻 [SiteDataWarehouseAuditorAgent] Analyzing Site DataWarehouse Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site DataWarehouse Auditor Target',
      );
...
export const siteDataWarehouseAuditorAgent = Object.freeze(
  new SiteDataWarehouseAuditorAgent(),
);
