...
class SiteContainerizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteContainerizationSystem(objective) {
    logger.info(
      `💻 [SiteContainerizationLeadAgent] Analyzing Site Containerization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Containerization Lead Target',
      );
...
export const siteContainerizationLeadAgent = Object.freeze(
  new SiteContainerizationLeadAgent(),
);
