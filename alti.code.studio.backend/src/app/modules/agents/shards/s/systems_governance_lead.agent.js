...
class SystemsGovernanceLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsGovernanceSystem(objective) {
    logger.info(
      `💻 [SystemsGovernanceLeadAgent] Analyzing Systems Governance Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Governance Lead Target',
      );
...
export const systemsGovernanceLeadAgent = Object.freeze(
  new SystemsGovernanceLeadAgent(),
);
