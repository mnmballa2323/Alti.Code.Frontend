...
class SiteStreamingSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteStreamingSystem(objective) {
    logger.info(
      `💻 [SiteStreamingSpecialistAgent] Analyzing Site Streaming Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Streaming Specialist Target',
      );
...
export const siteStreamingSpecialistAgent = Object.freeze(
  new SiteStreamingSpecialistAgent(),
);
