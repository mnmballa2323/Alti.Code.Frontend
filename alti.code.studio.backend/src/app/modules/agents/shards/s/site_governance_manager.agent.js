...
class SiteGovernanceManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteGovernanceSystem(objective) {
    logger.info(
      `💻 [SiteGovernanceManagerAgent] Analyzing Site Governance Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Governance Manager Target',
      );
...
export const siteGovernanceManagerAgent = Object.freeze(
  new SiteGovernanceManagerAgent(),
);
