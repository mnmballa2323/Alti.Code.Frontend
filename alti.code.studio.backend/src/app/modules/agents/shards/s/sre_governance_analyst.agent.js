...
class SREGovernanceAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSREGovernanceSystem(objective) {
    logger.info(
      `💻 [SREGovernanceAnalystAgent] Analyzing SRE Governance Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Governance Analyst Target',
      );
...
export const sREGovernanceAnalystAgent = Object.freeze(
  new SREGovernanceAnalystAgent(),
);
