...
class SiteComplianceSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteComplianceSystem(objective) {
    logger.info(
      `💻 [SiteComplianceSpecialistAgent] Analyzing Site Compliance Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Compliance Specialist Target',
      );
...
export const siteComplianceSpecialistAgent = Object.freeze(
  new SiteComplianceSpecialistAgent(),
);
