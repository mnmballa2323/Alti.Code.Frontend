...
class SREGovernanceAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateSREGovernanceSystem(objective) {
        logger.info(`💻 [SREGovernanceAuditorAgent] Analyzing SRE Governance Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Governance Auditor Target");
...
export const sREGovernanceAuditorAgent = Object.freeze(new SREGovernanceAuditorAgent());
