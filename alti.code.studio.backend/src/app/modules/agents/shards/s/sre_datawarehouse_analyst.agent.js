...
class SREDataWarehouseAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateSREDataWarehouseSystem(objective) {
        logger.info(`💻 [SREDataWarehouseAnalystAgent] Analyzing SRE DataWarehouse Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE DataWarehouse Analyst Target");
...
export const sREDataWarehouseAnalystAgent = Object.freeze(new SREDataWarehouseAnalystAgent());
