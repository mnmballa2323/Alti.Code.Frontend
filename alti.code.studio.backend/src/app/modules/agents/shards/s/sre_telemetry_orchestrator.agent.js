...
class SRETelemetryOrchestratorAgent extends GeminiCliBaseAgent {
    ...
    async generateSRETelemetrySystem(objective) {
        logger.info(`💻 [SRETelemetryOrchestratorAgent] Analyzing SRE Telemetry Orchestrator specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Telemetry Orchestrator Target");
...
export const sRETelemetryOrchestratorAgent = Object.freeze(new SRETelemetryOrchestratorAgent());
