...
class SREComplianceLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSREComplianceSystem(objective) {
    logger.info(
      `💻 [SREComplianceLeadAgent] Analyzing SRE Compliance Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Compliance Lead Target',
      );
...
export const sREComplianceLeadAgent = Object.freeze(
  new SREComplianceLeadAgent(),
);
