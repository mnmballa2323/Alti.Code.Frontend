...
class SiteScalingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteScalingSystem(objective) {
    logger.info(
      `💻 [SiteScalingDirectorAgent] Analyzing Site Scaling Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Scaling Director Target',
      );
...
export const siteScalingDirectorAgent = Object.freeze(
  new SiteScalingDirectorAgent(),
);
