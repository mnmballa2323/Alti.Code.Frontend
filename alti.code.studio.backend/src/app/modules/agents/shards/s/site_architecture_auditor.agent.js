...
class SiteArchitectureAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteArchitectureSystem(objective) {
    logger.info(
      `💻 [SiteArchitectureAuditorAgent] Analyzing Site Architecture Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Architecture Auditor Target',
      );
...
export const siteArchitectureAuditorAgent = Object.freeze(
  new SiteArchitectureAuditorAgent(),
);
