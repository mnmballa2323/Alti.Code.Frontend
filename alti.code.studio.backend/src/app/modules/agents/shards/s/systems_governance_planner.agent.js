...
class SystemsGovernancePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsGovernanceSystem(objective) {
    logger.info(
      `💻 [SystemsGovernancePlannerAgent] Analyzing Systems Governance Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Governance Planner Target',
      );
...
export const systemsGovernancePlannerAgent = Object.freeze(
  new SystemsGovernancePlannerAgent(),
);
