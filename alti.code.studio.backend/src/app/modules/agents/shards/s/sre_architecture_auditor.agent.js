...
class SREArchitectureAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREArchitectureSystem(objective) {
    logger.info(
      `💻 [SREArchitectureAuditorAgent] Analyzing SRE Architecture Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Architecture Auditor Target',
      );
...
export const sREArchitectureAuditorAgent = Object.freeze(
  new SREArchitectureAuditorAgent(),
);
