...
class SiteCachingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteCachingSystem(objective) {
    logger.info(
      `💻 [SiteCachingAuditorAgent] Analyzing Site Caching Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Caching Auditor Target',
      );
...
export const siteCachingAuditorAgent = Object.freeze(
  new SiteCachingAuditorAgent(),
);
