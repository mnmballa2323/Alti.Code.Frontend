...
class SiteEngineeringTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteEngineeringSystem(objective) {
    logger.info(
      `💻 [SiteEngineeringTesterAgent] Analyzing Site Engineering Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Engineering Tester Target',
      );
...
export const siteEngineeringTesterAgent = Object.freeze(
  new SiteEngineeringTesterAgent(),
);
