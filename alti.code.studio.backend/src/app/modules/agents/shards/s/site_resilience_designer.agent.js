...
class SiteResilienceDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteResilienceSystem(objective) {
        logger.info(`💻 [SiteResilienceDesignerAgent] Analyzing Site Resilience Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Resilience Designer Target");
...
export const siteResilienceDesignerAgent = Object.freeze(new SiteResilienceDesignerAgent());
