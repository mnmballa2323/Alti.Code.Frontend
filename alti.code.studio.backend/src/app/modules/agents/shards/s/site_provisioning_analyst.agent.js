...
class SiteProvisioningAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteProvisioningSystem(objective) {
    logger.info(
      `💻 [SiteProvisioningAnalystAgent] Analyzing Site Provisioning Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Provisioning Analyst Target',
      );
...
export const siteProvisioningAnalystAgent = Object.freeze(
  new SiteProvisioningAnalystAgent(),
);
