...
class SREComplianceConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateSREComplianceSystem(objective) {
    logger.info(
      `💻 [SREComplianceConsultantAgent] Analyzing SRE Compliance Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Compliance Consultant Target',
      );
...
export const sREComplianceConsultantAgent = Object.freeze(
  new SREComplianceConsultantAgent(),
);
