...
class SystemsStreamingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsStreamingSystem(objective) {
    logger.info(
      `💻 [SystemsStreamingTesterAgent] Analyzing Systems Streaming Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Streaming Tester Target',
      );
...
export const systemsStreamingTesterAgent = Object.freeze(
  new SystemsStreamingTesterAgent(),
);
