...
class SiteMicroservicesManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteMicroservicesSystem(objective) {
    logger.info(
      `💻 [SiteMicroservicesManagerAgent] Analyzing Site Microservices Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Microservices Manager Target',
      );
...
export const siteMicroservicesManagerAgent = Object.freeze(
  new SiteMicroservicesManagerAgent(),
);
