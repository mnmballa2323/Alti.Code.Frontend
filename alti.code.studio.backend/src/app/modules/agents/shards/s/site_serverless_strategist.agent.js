...
class SiteServerlessStrategistAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteServerlessSystem(objective) {
        logger.info(`💻 [SiteServerlessStrategistAgent] Analyzing Site Serverless Strategist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Serverless Strategist Target");
...
export const siteServerlessStrategistAgent = Object.freeze(new SiteServerlessStrategistAgent());
