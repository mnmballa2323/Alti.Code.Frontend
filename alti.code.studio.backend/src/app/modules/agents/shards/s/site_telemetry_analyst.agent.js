...
class SiteTelemetryAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteTelemetrySystem(objective) {
        logger.info(`💻 [SiteTelemetryAnalystAgent] Analyzing Site Telemetry Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Telemetry Analyst Target");
...
export const siteTelemetryAnalystAgent = Object.freeze(new SiteTelemetryAnalystAgent());
