...
class SREComplianceDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSREComplianceSystem(objective) {
    logger.info(
      `💻 [SREComplianceDeveloperAgent] Analyzing SRE Compliance Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Compliance Developer Target',
      );
...
export const sREComplianceDeveloperAgent = Object.freeze(
  new SREComplianceDeveloperAgent(),
);
