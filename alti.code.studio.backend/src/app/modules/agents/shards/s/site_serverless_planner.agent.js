...
class SiteServerlessPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteServerlessSystem(objective) {
    logger.info(
      `💻 [SiteServerlessPlannerAgent] Analyzing Site Serverless Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Serverless Planner Target',
      );
...
export const siteServerlessPlannerAgent = Object.freeze(
  new SiteServerlessPlannerAgent(),
);
