...
class SiteServerlessSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteServerlessSystem(objective) {
    logger.info(
      `💻 [SiteServerlessSpecialistAgent] Analyzing Site Serverless Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Serverless Specialist Target',
      );
...
export const siteServerlessSpecialistAgent = Object.freeze(
  new SiteServerlessSpecialistAgent(),
);
