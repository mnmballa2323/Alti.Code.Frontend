...
class SREServerlessPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREServerlessSystem(objective) {
    logger.info(
      `💻 [SREServerlessPlannerAgent] Analyzing SRE Serverless Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Serverless Planner Target',
      );
...
export const sREServerlessPlannerAgent = Object.freeze(
  new SREServerlessPlannerAgent(),
);
