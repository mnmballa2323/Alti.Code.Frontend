...
class SiteSecurityArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteSecuritySystem(objective) {
    logger.info(
      `💻 [SiteSecurityArchitectAgent] Analyzing Site Security Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Security Architect Target',
      );
...
export const siteSecurityArchitectAgent = Object.freeze(
  new SiteSecurityArchitectAgent(),
);
