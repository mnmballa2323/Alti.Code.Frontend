...
class SiteDataLakeDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteDataLakeSystem(objective) {
    logger.info(
      `💻 [SiteDataLakeDeveloperAgent] Analyzing Site DataLake Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site DataLake Developer Target',
      );
...
export const siteDataLakeDeveloperAgent = Object.freeze(
  new SiteDataLakeDeveloperAgent(),
);
