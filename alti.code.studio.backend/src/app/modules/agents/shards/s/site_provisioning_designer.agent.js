...
class SiteProvisioningDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteProvisioningSystem(objective) {
    logger.info(
      `💻 [SiteProvisioningDesignerAgent] Analyzing Site Provisioning Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Provisioning Designer Target',
      );
...
export const siteProvisioningDesignerAgent = Object.freeze(
  new SiteProvisioningDesignerAgent(),
);
