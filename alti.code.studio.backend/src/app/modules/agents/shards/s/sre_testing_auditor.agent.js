...
class SRETestingAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateSRETestingSystem(objective) {
        logger.info(`💻 [SRETestingAuditorAgent] Analyzing SRE Testing Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Testing Auditor Target");
...
export const sRETestingAuditorAgent = Object.freeze(new SRETestingAuditorAgent());
