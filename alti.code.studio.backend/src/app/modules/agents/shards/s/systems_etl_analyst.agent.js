...
class SystemsETLAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsETLSystem(objective) {
    logger.info(
      `💻 [SystemsETLAnalystAgent] Analyzing Systems ETL Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems ETL Analyst Target',
      );
...
export const systemsETLAnalystAgent = Object.freeze(
  new SystemsETLAnalystAgent(),
);
