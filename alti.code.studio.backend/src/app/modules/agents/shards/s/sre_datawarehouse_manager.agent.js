...
class SREDataWarehouseManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateSREDataWarehouseSystem(objective) {
        logger.info(`💻 [SREDataWarehouseManagerAgent] Analyzing SRE DataWarehouse Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE DataWarehouse Manager Target");
...
export const sREDataWarehouseManagerAgent = Object.freeze(new SREDataWarehouseManagerAgent());
