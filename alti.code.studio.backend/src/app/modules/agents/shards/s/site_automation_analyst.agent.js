...
class SiteAutomationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteAutomationSystem(objective) {
    logger.info(
      `💻 [SiteAutomationAnalystAgent] Analyzing Site Automation Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Automation Analyst Target',
      );
...
export const siteAutomationAnalystAgent = Object.freeze(
  new SiteAutomationAnalystAgent(),
);
