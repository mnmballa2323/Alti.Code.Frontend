...
class SystemsAnalyticsLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsAnalyticsSystem(objective) {
    logger.info(
      `💻 [SystemsAnalyticsLeadAgent] Analyzing Systems Analytics Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Analytics Lead Target',
      );
...
export const systemsAnalyticsLeadAgent = Object.freeze(
  new SystemsAnalyticsLeadAgent(),
);
