...
class SystemsMicroservicesLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsMicroservicesSystem(objective) {
        logger.info(`💻 [SystemsMicroservicesLeadAgent] Analyzing Systems Microservices Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Microservices Lead Target");
...
export const systemsMicroservicesLeadAgent = Object.freeze(new SystemsMicroservicesLeadAgent());
