...
class SRETestingDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSRETestingSystem(objective) {
    logger.info(
      `💻 [SRETestingDeveloperAgent] Analyzing SRE Testing Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Testing Developer Target',
      );
...
export const sRETestingDeveloperAgent = Object.freeze(
  new SRETestingDeveloperAgent(),
);
