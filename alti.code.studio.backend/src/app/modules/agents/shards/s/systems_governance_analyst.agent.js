...
class SystemsGovernanceAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsGovernanceSystem(objective) {
    logger.info(
      `💻 [SystemsGovernanceAnalystAgent] Analyzing Systems Governance Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Governance Analyst Target',
      );
...
export const systemsGovernanceAnalystAgent = Object.freeze(
  new SystemsGovernanceAnalystAgent(),
);
