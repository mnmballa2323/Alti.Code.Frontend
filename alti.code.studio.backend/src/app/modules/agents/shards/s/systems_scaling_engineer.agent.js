...
class SystemsScalingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsScalingSystem(objective) {
    logger.info(
      `💻 [SystemsScalingEngineerAgent] Analyzing Systems Scaling Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Scaling Engineer Target',
      );
...
export const systemsScalingEngineerAgent = Object.freeze(
  new SystemsScalingEngineerAgent(),
);
