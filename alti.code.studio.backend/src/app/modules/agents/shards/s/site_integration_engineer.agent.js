...
class SiteIntegrationEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteIntegrationSystem(objective) {
        logger.info(`💻 [SiteIntegrationEngineerAgent] Analyzing Site Integration Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Integration Engineer Target");
...
export const siteIntegrationEngineerAgent = Object.freeze(new SiteIntegrationEngineerAgent());
