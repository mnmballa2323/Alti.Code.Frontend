...
class SiteIntegrationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteIntegrationSystem(objective) {
    logger.info(
      `💻 [SiteIntegrationPlannerAgent] Analyzing Site Integration Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Integration Planner Target',
      );
...
export const siteIntegrationPlannerAgent = Object.freeze(
  new SiteIntegrationPlannerAgent(),
);
