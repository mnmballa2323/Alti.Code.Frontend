...
class SystemsEngineeringTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsEngineeringSystem(objective) {
    logger.info(
      `💻 [SystemsEngineeringTesterAgent] Analyzing Systems Engineering Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Engineering Tester Target',
      );
...
export const systemsEngineeringTesterAgent = Object.freeze(
  new SystemsEngineeringTesterAgent(),
);
