...
class SiteServerlessEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteServerlessSystem(objective) {
        logger.info(`💻 [SiteServerlessEngineerAgent] Analyzing Site Serverless Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Serverless Engineer Target");
...
export const siteServerlessEngineerAgent = Object.freeze(new SiteServerlessEngineerAgent());
