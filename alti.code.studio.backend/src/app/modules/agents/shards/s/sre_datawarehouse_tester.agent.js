...
class SREDataWarehouseTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSREDataWarehouseSystem(objective) {
    logger.info(
      `💻 [SREDataWarehouseTesterAgent] Analyzing SRE DataWarehouse Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE DataWarehouse Tester Target',
      );
...
export const sREDataWarehouseTesterAgent = Object.freeze(
  new SREDataWarehouseTesterAgent(),
);
