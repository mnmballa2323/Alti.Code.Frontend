...
class SiteLoadBalancingAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteLoadBalancingSystem(objective) {
        logger.info(`💻 [SiteLoadBalancingAuditorAgent] Analyzing Site LoadBalancing Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site LoadBalancing Auditor Target");
...
export const siteLoadBalancingAuditorAgent = Object.freeze(new SiteLoadBalancingAuditorAgent());
