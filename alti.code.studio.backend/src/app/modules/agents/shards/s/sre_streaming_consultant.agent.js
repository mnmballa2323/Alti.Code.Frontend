...
class SREStreamingConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateSREStreamingSystem(objective) {
    logger.info(
      `💻 [SREStreamingConsultantAgent] Analyzing SRE Streaming Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Streaming Consultant Target',
      );
...
export const sREStreamingConsultantAgent = Object.freeze(
  new SREStreamingConsultantAgent(),
);
