...
class SiteComplianceStrategistAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteComplianceSystem(objective) {
        logger.info(`💻 [SiteComplianceStrategistAgent] Analyzing Site Compliance Strategist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Compliance Strategist Target");
...
export const siteComplianceStrategistAgent = Object.freeze(new SiteComplianceStrategistAgent());
