...
class SiteGovernanceArchitectAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteGovernanceSystem(objective) {
        logger.info(`💻 [SiteGovernanceArchitectAgent] Analyzing Site Governance Architect specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Governance Architect Target");
...
export const siteGovernanceArchitectAgent = Object.freeze(new SiteGovernanceArchitectAgent());
