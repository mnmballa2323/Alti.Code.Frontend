...
class SecurityIntegrationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSecurityIntegrationSystem(objective) {
    logger.info(
      `💻 [SecurityIntegrationLeadAgent] Analyzing Security Integration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Security Integration Lead Target',
      );
...
export const securityIntegrationLeadAgent = Object.freeze(
  new SecurityIntegrationLeadAgent(),
);
