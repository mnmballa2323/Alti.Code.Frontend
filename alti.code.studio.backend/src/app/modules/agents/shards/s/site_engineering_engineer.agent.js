...
class SiteEngineeringEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteEngineeringSystem(objective) {
    logger.info(
      `💻 [SiteEngineeringEngineerAgent] Analyzing Site Engineering Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Engineering Engineer Target',
      );
...
export const siteEngineeringEngineerAgent = Object.freeze(
  new SiteEngineeringEngineerAgent(),
);
