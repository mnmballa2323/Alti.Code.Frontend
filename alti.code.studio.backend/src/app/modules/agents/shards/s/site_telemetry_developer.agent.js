...
class SiteTelemetryDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteTelemetrySystem(objective) {
        logger.info(`💻 [SiteTelemetryDeveloperAgent] Analyzing Site Telemetry Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Telemetry Developer Target");
...
export const siteTelemetryDeveloperAgent = Object.freeze(new SiteTelemetryDeveloperAgent());
