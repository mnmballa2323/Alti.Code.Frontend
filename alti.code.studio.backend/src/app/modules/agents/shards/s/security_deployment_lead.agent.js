...
class SecurityDeploymentLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSecurityDeploymentSystem(objective) {
    logger.info(
      `💻 [SecurityDeploymentLeadAgent] Analyzing Security Deployment Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Security Deployment Lead Target',
      );
...
export const securityDeploymentLeadAgent = Object.freeze(
  new SecurityDeploymentLeadAgent(),
);
