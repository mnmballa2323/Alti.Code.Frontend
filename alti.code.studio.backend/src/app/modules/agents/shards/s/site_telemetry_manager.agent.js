...
class SiteTelemetryManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteTelemetrySystem(objective) {
        logger.info(`💻 [SiteTelemetryManagerAgent] Analyzing Site Telemetry Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Telemetry Manager Target");
...
export const siteTelemetryManagerAgent = Object.freeze(new SiteTelemetryManagerAgent());
