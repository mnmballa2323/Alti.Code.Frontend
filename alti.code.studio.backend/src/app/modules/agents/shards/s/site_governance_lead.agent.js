...
class SiteGovernanceLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteGovernanceSystem(objective) {
        logger.info(`💻 [SiteGovernanceLeadAgent] Analyzing Site Governance Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Governance Lead Target");
...
export const siteGovernanceLeadAgent = Object.freeze(new SiteGovernanceLeadAgent());
