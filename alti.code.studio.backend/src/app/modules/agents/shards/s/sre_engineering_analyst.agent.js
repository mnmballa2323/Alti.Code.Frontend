...
class SREEngineeringAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSREEngineeringSystem(objective) {
    logger.info(
      `💻 [SREEngineeringAnalystAgent] Analyzing SRE Engineering Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Engineering Analyst Target',
      );
...
export const sREEngineeringAnalystAgent = Object.freeze(
  new SREEngineeringAnalystAgent(),
);
