...
class SiteTelemetryLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteTelemetrySystem(objective) {
    logger.info(
      `💻 [SiteTelemetryLeadAgent] Analyzing Site Telemetry Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Telemetry Lead Target',
      );
...
export const siteTelemetryLeadAgent = Object.freeze(
  new SiteTelemetryLeadAgent(),
);
