...
class SecurityTestingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSecurityTestingSystem(objective) {
    logger.info(
      `💻 [SecurityTestingManagerAgent] Analyzing Security Testing Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Security Testing Manager Target',
      );
...
export const securityTestingManagerAgent = Object.freeze(
  new SecurityTestingManagerAgent(),
);
