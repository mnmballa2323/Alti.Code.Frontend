...
class SiteCachingAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteCachingSystem(objective) {
        logger.info(`💻 [SiteCachingAnalystAgent] Analyzing Site Caching Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Caching Analyst Target");
...
export const siteCachingAnalystAgent = Object.freeze(new SiteCachingAnalystAgent());
