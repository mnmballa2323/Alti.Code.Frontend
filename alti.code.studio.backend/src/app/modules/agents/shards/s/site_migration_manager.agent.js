...
class SiteMigrationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteMigrationSystem(objective) {
    logger.info(
      `💻 [SiteMigrationManagerAgent] Analyzing Site Migration Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Migration Manager Target',
      );
...
export const siteMigrationManagerAgent = Object.freeze(
  new SiteMigrationManagerAgent(),
);
