...
class SystemsTelemetryDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsTelemetrySystem(objective) {
    logger.info(
      `💻 [SystemsTelemetryDirectorAgent] Analyzing Systems Telemetry Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Telemetry Director Target',
      );
...
export const systemsTelemetryDirectorAgent = Object.freeze(
  new SystemsTelemetryDirectorAgent(),
);
