...
class SystemsMigrationEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsMigrationSystem(objective) {
        logger.info(`💻 [SystemsMigrationEngineerAgent] Analyzing Systems Migration Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Migration Engineer Target");
...
export const systemsMigrationEngineerAgent = Object.freeze(new SystemsMigrationEngineerAgent());
