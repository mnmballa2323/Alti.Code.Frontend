...
class SREObservabilityDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREObservabilitySystem(objective) {
    logger.info(
      `💻 [SREObservabilityDirectorAgent] Analyzing SRE Observability Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Observability Director Target',
      );
...
export const sREObservabilityDirectorAgent = Object.freeze(
  new SREObservabilityDirectorAgent(),
);
