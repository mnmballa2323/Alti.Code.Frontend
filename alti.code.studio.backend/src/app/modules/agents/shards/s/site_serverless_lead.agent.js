...
class SiteServerlessLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteServerlessSystem(objective) {
    logger.info(
      `💻 [SiteServerlessLeadAgent] Analyzing Site Serverless Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Serverless Lead Target',
      );
...
export const siteServerlessLeadAgent = Object.freeze(
  new SiteServerlessLeadAgent(),
);
