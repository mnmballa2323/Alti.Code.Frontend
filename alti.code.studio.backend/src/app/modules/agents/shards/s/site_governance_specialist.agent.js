...
class SiteGovernanceSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteGovernanceSystem(objective) {
    logger.info(
      `💻 [SiteGovernanceSpecialistAgent] Analyzing Site Governance Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Governance Specialist Target',
      );
...
export const siteGovernanceSpecialistAgent = Object.freeze(
  new SiteGovernanceSpecialistAgent(),
);
