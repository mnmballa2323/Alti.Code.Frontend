...
class SREStreamingDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSREStreamingSystem(objective) {
    logger.info(
      `💻 [SREStreamingDeveloperAgent] Analyzing SRE Streaming Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Streaming Developer Target',
      );
...
export const sREStreamingDeveloperAgent = Object.freeze(
  new SREStreamingDeveloperAgent(),
);
