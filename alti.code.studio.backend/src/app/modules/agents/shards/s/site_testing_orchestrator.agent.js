...
class SiteTestingOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteTestingSystem(objective) {
    logger.info(
      `💻 [SiteTestingOrchestratorAgent] Analyzing Site Testing Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Testing Orchestrator Target',
      );
...
export const siteTestingOrchestratorAgent = Object.freeze(
  new SiteTestingOrchestratorAgent(),
);
