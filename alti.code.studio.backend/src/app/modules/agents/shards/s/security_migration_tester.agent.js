...
class SecurityMigrationTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSecurityMigrationSystem(objective) {
        logger.info(`💻 [SecurityMigrationTesterAgent] Analyzing Security Migration Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Security Migration Tester Target");
...
export const securityMigrationTesterAgent = Object.freeze(new SecurityMigrationTesterAgent());
