...
class SystemsTestingConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsTestingSystem(objective) {
    logger.info(
      `💻 [SystemsTestingConsultantAgent] Analyzing Systems Testing Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Testing Consultant Target',
      );
...
export const systemsTestingConsultantAgent = Object.freeze(
  new SystemsTestingConsultantAgent(),
);
