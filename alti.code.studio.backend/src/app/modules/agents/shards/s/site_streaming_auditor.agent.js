...
class SiteStreamingAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteStreamingSystem(objective) {
        logger.info(`💻 [SiteStreamingAuditorAgent] Analyzing Site Streaming Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Streaming Auditor Target");
...
export const siteStreamingAuditorAgent = Object.freeze(new SiteStreamingAuditorAgent());
