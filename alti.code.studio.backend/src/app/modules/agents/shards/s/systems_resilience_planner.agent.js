...
class SystemsResiliencePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsResilienceSystem(objective) {
        logger.info(`💻 [SystemsResiliencePlannerAgent] Analyzing Systems Resilience Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Resilience Planner Target");
...
export const systemsResiliencePlannerAgent = Object.freeze(new SystemsResiliencePlannerAgent());
