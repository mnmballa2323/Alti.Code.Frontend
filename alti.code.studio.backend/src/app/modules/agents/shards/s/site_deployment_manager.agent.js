...
class SiteDeploymentManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteDeploymentSystem(objective) {
    logger.info(
      `💻 [SiteDeploymentManagerAgent] Analyzing Site Deployment Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Deployment Manager Target',
      );
...
export const siteDeploymentManagerAgent = Object.freeze(
  new SiteDeploymentManagerAgent(),
);
