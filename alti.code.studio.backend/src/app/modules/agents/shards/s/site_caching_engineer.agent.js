...
class SiteCachingEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteCachingSystem(objective) {
        logger.info(`💻 [SiteCachingEngineerAgent] Analyzing Site Caching Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Caching Engineer Target");
...
export const siteCachingEngineerAgent = Object.freeze(new SiteCachingEngineerAgent());
