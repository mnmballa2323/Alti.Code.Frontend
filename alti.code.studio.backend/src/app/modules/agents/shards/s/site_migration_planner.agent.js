...
class SiteMigrationPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteMigrationSystem(objective) {
        logger.info(`💻 [SiteMigrationPlannerAgent] Analyzing Site Migration Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Migration Planner Target");
...
export const siteMigrationPlannerAgent = Object.freeze(new SiteMigrationPlannerAgent());
