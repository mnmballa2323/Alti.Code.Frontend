...
class SREMigrationDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREMigrationSystem(objective) {
    logger.info(
      `💻 [SREMigrationDesignerAgent] Analyzing SRE Migration Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Migration Designer Target',
      );
...
export const sREMigrationDesignerAgent = Object.freeze(
  new SREMigrationDesignerAgent(),
);
