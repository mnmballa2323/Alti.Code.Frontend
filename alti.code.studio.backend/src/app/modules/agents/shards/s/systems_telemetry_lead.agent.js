...
class SystemsTelemetryLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsTelemetrySystem(objective) {
        logger.info(`💻 [SystemsTelemetryLeadAgent] Analyzing Systems Telemetry Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Telemetry Lead Target");
...
export const systemsTelemetryLeadAgent = Object.freeze(new SystemsTelemetryLeadAgent());
