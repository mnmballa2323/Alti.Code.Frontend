...
class SystemsOptimizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsOptimizationSystem(objective) {
    logger.info(
      `💻 [SystemsOptimizationLeadAgent] Analyzing Systems Optimization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Optimization Lead Target',
      );
...
export const systemsOptimizationLeadAgent = Object.freeze(
  new SystemsOptimizationLeadAgent(),
);
