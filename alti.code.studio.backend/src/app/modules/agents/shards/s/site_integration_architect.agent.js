...
class SiteIntegrationArchitectAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteIntegrationSystem(objective) {
        logger.info(`💻 [SiteIntegrationArchitectAgent] Analyzing Site Integration Architect specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Integration Architect Target");
...
export const siteIntegrationArchitectAgent = Object.freeze(new SiteIntegrationArchitectAgent());
