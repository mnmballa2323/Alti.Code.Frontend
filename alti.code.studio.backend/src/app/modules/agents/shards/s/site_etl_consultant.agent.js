...
class SiteETLConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteETLSystem(objective) {
    logger.info(
      `💻 [SiteETLConsultantAgent] Analyzing Site ETL Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site ETL Consultant Target',
      );
...
export const siteETLConsultantAgent = Object.freeze(
  new SiteETLConsultantAgent(),
);
