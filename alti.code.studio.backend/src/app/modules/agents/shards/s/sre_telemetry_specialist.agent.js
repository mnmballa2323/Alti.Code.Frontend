...
class SRETelemetrySpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateSRETelemetrySystem(objective) {
    logger.info(
      `💻 [SRETelemetrySpecialistAgent] Analyzing SRE Telemetry Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Telemetry Specialist Target',
      );
...
export const sRETelemetrySpecialistAgent = Object.freeze(
  new SRETelemetrySpecialistAgent(),
);
