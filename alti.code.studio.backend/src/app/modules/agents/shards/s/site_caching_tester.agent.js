...
class SiteCachingTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteCachingSystem(objective) {
        logger.info(`💻 [SiteCachingTesterAgent] Analyzing Site Caching Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Caching Tester Target");
...
export const siteCachingTesterAgent = Object.freeze(new SiteCachingTesterAgent());
