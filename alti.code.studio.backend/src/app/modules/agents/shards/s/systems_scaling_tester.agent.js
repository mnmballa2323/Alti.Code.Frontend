...
class SystemsScalingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsScalingSystem(objective) {
    logger.info(
      `💻 [SystemsScalingTesterAgent] Analyzing Systems Scaling Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Scaling Tester Target',
      );
...
export const systemsScalingTesterAgent = Object.freeze(
  new SystemsScalingTesterAgent(),
);
