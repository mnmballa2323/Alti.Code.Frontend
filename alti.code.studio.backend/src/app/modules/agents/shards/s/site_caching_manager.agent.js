...
class SiteCachingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteCachingSystem(objective) {
    logger.info(
      `💻 [SiteCachingManagerAgent] Analyzing Site Caching Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Caching Manager Target',
      );
...
export const siteCachingManagerAgent = Object.freeze(
  new SiteCachingManagerAgent(),
);
