...
class SiteDataLakeManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteDataLakeSystem(objective) {
        logger.info(`💻 [SiteDataLakeManagerAgent] Analyzing Site DataLake Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site DataLake Manager Target");
...
export const siteDataLakeManagerAgent = Object.freeze(new SiteDataLakeManagerAgent());
