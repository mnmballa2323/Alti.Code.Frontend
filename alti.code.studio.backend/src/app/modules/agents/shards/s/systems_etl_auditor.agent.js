...
class SystemsETLAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsETLSystem(objective) {
    logger.info(
      `💻 [SystemsETLAuditorAgent] Analyzing Systems ETL Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems ETL Auditor Target',
      );
...
export const systemsETLAuditorAgent = Object.freeze(
  new SystemsETLAuditorAgent(),
);
