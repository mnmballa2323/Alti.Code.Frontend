...
class SiteIntegrationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteIntegrationSystem(objective) {
    logger.info(
      `💻 [SiteIntegrationManagerAgent] Analyzing Site Integration Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Integration Manager Target',
      );
...
export const siteIntegrationManagerAgent = Object.freeze(
  new SiteIntegrationManagerAgent(),
);
