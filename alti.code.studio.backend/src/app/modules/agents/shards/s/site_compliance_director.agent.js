...
class SiteComplianceDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteComplianceSystem(objective) {
        logger.info(`💻 [SiteComplianceDirectorAgent] Analyzing Site Compliance Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Compliance Director Target");
...
export const siteComplianceDirectorAgent = Object.freeze(new SiteComplianceDirectorAgent());
