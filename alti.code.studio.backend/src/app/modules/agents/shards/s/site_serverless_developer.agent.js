...
class SiteServerlessDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteServerlessSystem(objective) {
        logger.info(`💻 [SiteServerlessDeveloperAgent] Analyzing Site Serverless Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Serverless Developer Target");
...
export const siteServerlessDeveloperAgent = Object.freeze(new SiteServerlessDeveloperAgent());
