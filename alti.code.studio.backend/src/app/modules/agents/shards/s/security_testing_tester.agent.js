...
class SecurityTestingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSecurityTestingSystem(objective) {
    logger.info(
      `💻 [SecurityTestingTesterAgent] Analyzing Security Testing Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Security Testing Tester Target',
      );
...
export const securityTestingTesterAgent = Object.freeze(
  new SecurityTestingTesterAgent(),
);
