...
class SystemsOrchestrationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsOrchestrationSystem(objective) {
    logger.info(
      `💻 [SystemsOrchestrationLeadAgent] Analyzing Systems Orchestration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Orchestration Lead Target',
      );
...
export const systemsOrchestrationLeadAgent = Object.freeze(
  new SystemsOrchestrationLeadAgent(),
);
