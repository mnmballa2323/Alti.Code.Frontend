...
class SecurityMigrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSecurityMigrationSystem(objective) {
    logger.info(
      `💻 [SecurityMigrationAuditorAgent] Analyzing Security Migration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Security Migration Auditor Target',
      );
...
export const securityMigrationAuditorAgent = Object.freeze(
  new SecurityMigrationAuditorAgent(),
);
