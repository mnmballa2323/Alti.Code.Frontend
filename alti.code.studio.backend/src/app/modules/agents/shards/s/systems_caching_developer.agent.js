...
class SystemsCachingDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsCachingSystem(objective) {
    logger.info(
      `💻 [SystemsCachingDeveloperAgent] Analyzing Systems Caching Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Caching Developer Target',
      );
...
export const systemsCachingDeveloperAgent = Object.freeze(
  new SystemsCachingDeveloperAgent(),
);
