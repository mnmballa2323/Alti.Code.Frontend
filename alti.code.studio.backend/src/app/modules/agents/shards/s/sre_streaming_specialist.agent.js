...
class SREStreamingSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateSREStreamingSystem(objective) {
        logger.info(`💻 [SREStreamingSpecialistAgent] Analyzing SRE Streaming Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Streaming Specialist Target");
...
export const sREStreamingSpecialistAgent = Object.freeze(new SREStreamingSpecialistAgent());
