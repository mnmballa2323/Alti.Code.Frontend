...
class SREDataWarehouseEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREDataWarehouseSystem(objective) {
    logger.info(
      `💻 [SREDataWarehouseEngineerAgent] Analyzing SRE DataWarehouse Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE DataWarehouse Engineer Target',
      );
...
export const sREDataWarehouseEngineerAgent = Object.freeze(
  new SREDataWarehouseEngineerAgent(),
);
