...
class SRECachingSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateSRECachingSystem(objective) {
    logger.info(
      `💻 [SRECachingSpecialistAgent] Analyzing SRE Caching Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Caching Specialist Target',
      );
...
export const sRECachingSpecialistAgent = Object.freeze(
  new SRECachingSpecialistAgent(),
);
