...
class SREMicroservicesAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSREMicroservicesSystem(objective) {
    logger.info(
      `💻 [SREMicroservicesAnalystAgent] Analyzing SRE Microservices Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Microservices Analyst Target',
      );
...
export const sREMicroservicesAnalystAgent = Object.freeze(
  new SREMicroservicesAnalystAgent(),
);
