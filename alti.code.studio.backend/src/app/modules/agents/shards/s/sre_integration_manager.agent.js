...
class SREIntegrationManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateSREIntegrationSystem(objective) {
        logger.info(`💻 [SREIntegrationManagerAgent] Analyzing SRE Integration Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Integration Manager Target");
...
export const sREIntegrationManagerAgent = Object.freeze(new SREIntegrationManagerAgent());
