...
class SiteDataWarehouseTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteDataWarehouseSystem(objective) {
        logger.info(`💻 [SiteDataWarehouseTesterAgent] Analyzing Site DataWarehouse Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site DataWarehouse Tester Target");
...
export const siteDataWarehouseTesterAgent = Object.freeze(new SiteDataWarehouseTesterAgent());
