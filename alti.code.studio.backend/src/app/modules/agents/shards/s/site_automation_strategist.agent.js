...
class SiteAutomationStrategistAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteAutomationSystem(objective) {
        logger.info(`💻 [SiteAutomationStrategistAgent] Analyzing Site Automation Strategist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Automation Strategist Target");
...
export const siteAutomationStrategistAgent = Object.freeze(new SiteAutomationStrategistAgent());
