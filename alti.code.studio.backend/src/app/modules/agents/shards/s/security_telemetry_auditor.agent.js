...
class SecurityTelemetryAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateSecurityTelemetrySystem(objective) {
        logger.info(`💻 [SecurityTelemetryAuditorAgent] Analyzing Security Telemetry Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Security Telemetry Auditor Target");
...
export const securityTelemetryAuditorAgent = Object.freeze(new SecurityTelemetryAuditorAgent());
