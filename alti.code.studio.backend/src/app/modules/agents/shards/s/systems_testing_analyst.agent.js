...
class SystemsTestingAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsTestingSystem(objective) {
        logger.info(`💻 [SystemsTestingAnalystAgent] Analyzing Systems Testing Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Testing Analyst Target");
...
export const systemsTestingAnalystAgent = Object.freeze(new SystemsTestingAnalystAgent());
