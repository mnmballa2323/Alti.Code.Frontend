...
class SystemsResilienceLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsResilienceSystem(objective) {
    logger.info(
      `💻 [SystemsResilienceLeadAgent] Analyzing Systems Resilience Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Resilience Lead Target',
      );
...
export const systemsResilienceLeadAgent = Object.freeze(
  new SystemsResilienceLeadAgent(),
);
