...
class SREMigrationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSREMigrationSystem(objective) {
    logger.info(
      `💻 [SREMigrationTesterAgent] Analyzing SRE Migration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Migration Tester Target',
      );
...
export const sREMigrationTesterAgent = Object.freeze(
  new SREMigrationTesterAgent(),
);
