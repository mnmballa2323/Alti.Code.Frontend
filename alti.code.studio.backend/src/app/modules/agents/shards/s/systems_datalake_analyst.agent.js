...
class SystemsDataLakeAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsDataLakeSystem(objective) {
        logger.info(`💻 [SystemsDataLakeAnalystAgent] Analyzing Systems DataLake Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems DataLake Analyst Target");
...
export const systemsDataLakeAnalystAgent = Object.freeze(new SystemsDataLakeAnalystAgent());
