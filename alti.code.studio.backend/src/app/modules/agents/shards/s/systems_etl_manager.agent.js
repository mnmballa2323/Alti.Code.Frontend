...
class SystemsETLManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsETLSystem(objective) {
    logger.info(
      `💻 [SystemsETLManagerAgent] Analyzing Systems ETL Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems ETL Manager Target',
      );
...
export const systemsETLManagerAgent = Object.freeze(
  new SystemsETLManagerAgent(),
);
