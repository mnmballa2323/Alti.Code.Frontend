...
class SREServerlessAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREServerlessSystem(objective) {
    logger.info(
      `💻 [SREServerlessAuditorAgent] Analyzing SRE Serverless Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Serverless Auditor Target',
      );
...
export const sREServerlessAuditorAgent = Object.freeze(
  new SREServerlessAuditorAgent(),
);
