...
class SREMigrationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREMigrationSystem(objective) {
    logger.info(
      `💻 [SREMigrationManagerAgent] Analyzing SRE Migration Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Migration Manager Target',
      );
...
export const sREMigrationManagerAgent = Object.freeze(
  new SREMigrationManagerAgent(),
);
