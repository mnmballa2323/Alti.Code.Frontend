...
class SiteServerlessAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteServerlessSystem(objective) {
        logger.info(`💻 [SiteServerlessAuditorAgent] Analyzing Site Serverless Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Serverless Auditor Target");
...
export const siteServerlessAuditorAgent = Object.freeze(new SiteServerlessAuditorAgent());
