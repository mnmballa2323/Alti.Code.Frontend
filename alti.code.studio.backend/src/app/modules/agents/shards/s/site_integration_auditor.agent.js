...
class SiteIntegrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteIntegrationSystem(objective) {
    logger.info(
      `💻 [SiteIntegrationAuditorAgent] Analyzing Site Integration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Integration Auditor Target',
      );
...
export const siteIntegrationAuditorAgent = Object.freeze(
  new SiteIntegrationAuditorAgent(),
);
