...
class SiteArchitectureAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteArchitectureSystem(objective) {
    logger.info(
      `💻 [SiteArchitectureAnalystAgent] Analyzing Site Architecture Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Architecture Analyst Target',
      );
...
export const siteArchitectureAnalystAgent = Object.freeze(
  new SiteArchitectureAnalystAgent(),
);
