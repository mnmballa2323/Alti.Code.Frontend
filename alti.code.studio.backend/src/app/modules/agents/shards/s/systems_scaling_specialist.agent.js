...
class SystemsScalingSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsScalingSystem(objective) {
    logger.info(
      `💻 [SystemsScalingSpecialistAgent] Analyzing Systems Scaling Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Scaling Specialist Target',
      );
...
export const systemsScalingSpecialistAgent = Object.freeze(
  new SystemsScalingSpecialistAgent(),
);
