...
class SecurityServerlessTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSecurityServerlessSystem(objective) {
        logger.info(`💻 [SecurityServerlessTesterAgent] Analyzing Security Serverless Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Security Serverless Tester Target");
...
export const securityServerlessTesterAgent = Object.freeze(new SecurityServerlessTesterAgent());
