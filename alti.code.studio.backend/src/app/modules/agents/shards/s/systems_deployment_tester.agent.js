...
class SystemsDeploymentTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsDeploymentSystem(objective) {
        logger.info(`💻 [SystemsDeploymentTesterAgent] Analyzing Systems Deployment Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Deployment Tester Target");
...
export const systemsDeploymentTesterAgent = Object.freeze(new SystemsDeploymentTesterAgent());
