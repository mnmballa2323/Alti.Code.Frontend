...
class SiteResilienceStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteResilienceSystem(objective) {
    logger.info(
      `💻 [SiteResilienceStrategistAgent] Analyzing Site Resilience Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Resilience Strategist Target',
      );
...
export const siteResilienceStrategistAgent = Object.freeze(
  new SiteResilienceStrategistAgent(),
);
