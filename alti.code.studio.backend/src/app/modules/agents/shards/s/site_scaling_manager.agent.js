...
class SiteScalingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteScalingSystem(objective) {
    logger.info(
      `💻 [SiteScalingManagerAgent] Analyzing Site Scaling Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Scaling Manager Target',
      );
...
export const siteScalingManagerAgent = Object.freeze(
  new SiteScalingManagerAgent(),
);
