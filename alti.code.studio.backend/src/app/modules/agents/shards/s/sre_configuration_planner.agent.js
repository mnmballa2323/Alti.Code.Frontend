...
class SREConfigurationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREConfigurationSystem(objective) {
    logger.info(
      `💻 [SREConfigurationPlannerAgent] Analyzing SRE Configuration Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Configuration Planner Target',
      );
...
export const sREConfigurationPlannerAgent = Object.freeze(
  new SREConfigurationPlannerAgent(),
);
