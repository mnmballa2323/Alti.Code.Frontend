...
class SREMigrationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSREMigrationSystem(objective) {
    logger.info(
      `💻 [SREMigrationAnalystAgent] Analyzing SRE Migration Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Migration Analyst Target',
      );
...
export const sREMigrationAnalystAgent = Object.freeze(
  new SREMigrationAnalystAgent(),
);
