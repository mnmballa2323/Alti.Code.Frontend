...
class SREServerlessDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREServerlessSystem(objective) {
    logger.info(
      `💻 [SREServerlessDesignerAgent] Analyzing SRE Serverless Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Serverless Designer Target',
      );
...
export const sREServerlessDesignerAgent = Object.freeze(
  new SREServerlessDesignerAgent(),
);
