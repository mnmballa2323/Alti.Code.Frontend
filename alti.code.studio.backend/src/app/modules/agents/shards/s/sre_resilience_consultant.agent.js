...
class SREResilienceConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateSREResilienceSystem(objective) {
    logger.info(
      `💻 [SREResilienceConsultantAgent] Analyzing SRE Resilience Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Resilience Consultant Target',
      );
...
export const sREResilienceConsultantAgent = Object.freeze(
  new SREResilienceConsultantAgent(),
);
