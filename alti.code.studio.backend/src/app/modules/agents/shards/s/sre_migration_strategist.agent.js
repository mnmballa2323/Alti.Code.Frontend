...
class SREMigrationStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateSREMigrationSystem(objective) {
    logger.info(
      `💻 [SREMigrationStrategistAgent] Analyzing SRE Migration Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Migration Strategist Target',
      );
...
export const sREMigrationStrategistAgent = Object.freeze(
  new SREMigrationStrategistAgent(),
);
