...
class SREOrchestrationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSREOrchestrationSystem(objective) {
    logger.info(
      `💻 [SREOrchestrationTesterAgent] Analyzing SRE Orchestration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Orchestration Tester Target',
      );
...
export const sREOrchestrationTesterAgent = Object.freeze(
  new SREOrchestrationTesterAgent(),
);
