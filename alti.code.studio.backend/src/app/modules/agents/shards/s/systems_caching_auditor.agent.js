...
class SystemsCachingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsCachingSystem(objective) {
    logger.info(
      `💻 [SystemsCachingAuditorAgent] Analyzing Systems Caching Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Caching Auditor Target',
      );
...
export const systemsCachingAuditorAgent = Object.freeze(
  new SystemsCachingAuditorAgent(),
);
