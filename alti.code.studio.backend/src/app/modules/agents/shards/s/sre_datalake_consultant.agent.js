...
class SREDataLakeConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateSREDataLakeSystem(objective) {
    logger.info(
      `💻 [SREDataLakeConsultantAgent] Analyzing SRE DataLake Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE DataLake Consultant Target',
      );
...
export const sREDataLakeConsultantAgent = Object.freeze(
  new SREDataLakeConsultantAgent(),
);
