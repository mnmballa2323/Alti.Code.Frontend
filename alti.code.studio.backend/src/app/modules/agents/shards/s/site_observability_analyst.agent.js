...
class SiteObservabilityAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteObservabilitySystem(objective) {
    logger.info(
      `💻 [SiteObservabilityAnalystAgent] Analyzing Site Observability Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Observability Analyst Target',
      );
...
export const siteObservabilityAnalystAgent = Object.freeze(
  new SiteObservabilityAnalystAgent(),
);
