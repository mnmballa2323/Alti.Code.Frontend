...
class SiteTestingArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteTestingSystem(objective) {
    logger.info(
      `💻 [SiteTestingArchitectAgent] Analyzing Site Testing Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Testing Architect Target',
      );
...
export const siteTestingArchitectAgent = Object.freeze(
  new SiteTestingArchitectAgent(),
);
