...
class SiteConfigurationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteConfigurationSystem(objective) {
        logger.info(`💻 [SiteConfigurationLeadAgent] Analyzing Site Configuration Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Configuration Lead Target");
...
export const siteConfigurationLeadAgent = Object.freeze(new SiteConfigurationLeadAgent());
