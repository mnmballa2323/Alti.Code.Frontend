...
class SiteDeploymentDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteDeploymentSystem(objective) {
    logger.info(
      `💻 [SiteDeploymentDirectorAgent] Analyzing Site Deployment Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Deployment Director Target',
      );
...
export const siteDeploymentDirectorAgent = Object.freeze(
  new SiteDeploymentDirectorAgent(),
);
