...
class SecurityTestingAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSecurityTestingSystem(objective) {
    logger.info(
      `💻 [SecurityTestingAnalystAgent] Analyzing Security Testing Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Security Testing Analyst Target',
      );
...
export const securityTestingAnalystAgent = Object.freeze(
  new SecurityTestingAnalystAgent(),
);
