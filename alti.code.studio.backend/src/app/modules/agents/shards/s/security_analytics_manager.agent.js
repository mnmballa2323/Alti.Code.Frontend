...
class SecurityAnalyticsManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSecurityAnalyticsSystem(objective) {
    logger.info(
      `💻 [SecurityAnalyticsManagerAgent] Analyzing Security Analytics Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Security Analytics Manager Target',
      );
...
export const securityAnalyticsManagerAgent = Object.freeze(
  new SecurityAnalyticsManagerAgent(),
);
