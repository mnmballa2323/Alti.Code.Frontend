...
class SREDataWarehouseLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSREDataWarehouseSystem(objective) {
    logger.info(
      `💻 [SREDataWarehouseLeadAgent] Analyzing SRE DataWarehouse Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE DataWarehouse Lead Target',
      );
...
export const sREDataWarehouseLeadAgent = Object.freeze(
  new SREDataWarehouseLeadAgent(),
);
