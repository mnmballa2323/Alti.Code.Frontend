...
class SystemsGovernanceAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsGovernanceSystem(objective) {
        logger.info(`💻 [SystemsGovernanceAuditorAgent] Analyzing Systems Governance Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Governance Auditor Target");
...
export const systemsGovernanceAuditorAgent = Object.freeze(new SystemsGovernanceAuditorAgent());
