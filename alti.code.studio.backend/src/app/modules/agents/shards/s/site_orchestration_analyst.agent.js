...
class SiteOrchestrationAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteOrchestrationSystem(objective) {
        logger.info(`💻 [SiteOrchestrationAnalystAgent] Analyzing Site Orchestration Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Orchestration Analyst Target");
...
export const siteOrchestrationAnalystAgent = Object.freeze(new SiteOrchestrationAnalystAgent());
