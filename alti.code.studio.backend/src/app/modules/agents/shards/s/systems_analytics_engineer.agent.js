...
class SystemsAnalyticsEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsAnalyticsSystem(objective) {
    logger.info(
      `💻 [SystemsAnalyticsEngineerAgent] Analyzing Systems Analytics Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Analytics Engineer Target',
      );
...
export const systemsAnalyticsEngineerAgent = Object.freeze(
  new SystemsAnalyticsEngineerAgent(),
);
