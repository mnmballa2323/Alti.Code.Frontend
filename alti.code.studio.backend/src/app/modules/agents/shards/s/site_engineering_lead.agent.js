...
class SiteEngineeringLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteEngineeringSystem(objective) {
    logger.info(
      `💻 [SiteEngineeringLeadAgent] Analyzing Site Engineering Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Engineering Lead Target',
      );
...
export const siteEngineeringLeadAgent = Object.freeze(
  new SiteEngineeringLeadAgent(),
);
