...
class SystemsETLStrategistAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsETLSystem(objective) {
        logger.info(`💻 [SystemsETLStrategistAgent] Analyzing Systems ETL Strategist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems ETL Strategist Target");
...
export const systemsETLStrategistAgent = Object.freeze(new SystemsETLStrategistAgent());
