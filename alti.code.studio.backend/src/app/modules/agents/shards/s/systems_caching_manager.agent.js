...
class SystemsCachingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsCachingSystem(objective) {
    logger.info(
      `💻 [SystemsCachingManagerAgent] Analyzing Systems Caching Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Caching Manager Target',
      );
...
export const systemsCachingManagerAgent = Object.freeze(
  new SystemsCachingManagerAgent(),
);
