...
class SREStreamingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREStreamingSystem(objective) {
    logger.info(
      `💻 [SREStreamingDesignerAgent] Analyzing SRE Streaming Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Streaming Designer Target',
      );
...
export const sREStreamingDesignerAgent = Object.freeze(
  new SREStreamingDesignerAgent(),
);
