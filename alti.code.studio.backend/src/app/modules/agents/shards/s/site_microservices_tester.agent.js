...
class SiteMicroservicesTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteMicroservicesSystem(objective) {
        logger.info(`💻 [SiteMicroservicesTesterAgent] Analyzing Site Microservices Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Microservices Tester Target");
...
export const siteMicroservicesTesterAgent = Object.freeze(new SiteMicroservicesTesterAgent());
