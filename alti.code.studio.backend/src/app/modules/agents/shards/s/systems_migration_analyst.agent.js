...
class SystemsMigrationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsMigrationSystem(objective) {
    logger.info(
      `💻 [SystemsMigrationAnalystAgent] Analyzing Systems Migration Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Migration Analyst Target',
      );
...
export const systemsMigrationAnalystAgent = Object.freeze(
  new SystemsMigrationAnalystAgent(),
);
