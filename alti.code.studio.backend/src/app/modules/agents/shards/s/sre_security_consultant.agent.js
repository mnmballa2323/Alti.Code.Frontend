...
class SRESecurityConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateSRESecuritySystem(objective) {
        logger.info(`💻 [SRESecurityConsultantAgent] Analyzing SRE Security Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Security Consultant Target");
...
export const sRESecurityConsultantAgent = Object.freeze(new SRESecurityConsultantAgent());
