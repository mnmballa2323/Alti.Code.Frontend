...
class SiteTestingEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteTestingSystem(objective) {
        logger.info(`💻 [SiteTestingEngineerAgent] Analyzing Site Testing Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Testing Engineer Target");
...
export const siteTestingEngineerAgent = Object.freeze(new SiteTestingEngineerAgent());
