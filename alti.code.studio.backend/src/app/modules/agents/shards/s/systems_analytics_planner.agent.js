...
class SystemsAnalyticsPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsAnalyticsSystem(objective) {
    logger.info(
      `💻 [SystemsAnalyticsPlannerAgent] Analyzing Systems Analytics Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Analytics Planner Target',
      );
...
export const systemsAnalyticsPlannerAgent = Object.freeze(
  new SystemsAnalyticsPlannerAgent(),
);
