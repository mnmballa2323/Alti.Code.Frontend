...
class SREProvisioningDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREProvisioningSystem(objective) {
    logger.info(
      `💻 [SREProvisioningDirectorAgent] Analyzing SRE Provisioning Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Provisioning Director Target',
      );
...
export const sREProvisioningDirectorAgent = Object.freeze(
  new SREProvisioningDirectorAgent(),
);
