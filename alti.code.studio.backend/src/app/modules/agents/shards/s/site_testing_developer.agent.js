...
class SiteTestingDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteTestingSystem(objective) {
    logger.info(
      `💻 [SiteTestingDeveloperAgent] Analyzing Site Testing Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Testing Developer Target',
      );
...
export const siteTestingDeveloperAgent = Object.freeze(
  new SiteTestingDeveloperAgent(),
);
