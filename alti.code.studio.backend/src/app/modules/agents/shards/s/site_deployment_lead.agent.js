...
class SiteDeploymentLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteDeploymentSystem(objective) {
        logger.info(`💻 [SiteDeploymentLeadAgent] Analyzing Site Deployment Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Deployment Lead Target");
...
export const siteDeploymentLeadAgent = Object.freeze(new SiteDeploymentLeadAgent());
