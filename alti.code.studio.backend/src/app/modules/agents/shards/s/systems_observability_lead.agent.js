...
class SystemsObservabilityLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsObservabilitySystem(objective) {
    logger.info(
      `💻 [SystemsObservabilityLeadAgent] Analyzing Systems Observability Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Observability Lead Target',
      );
...
export const systemsObservabilityLeadAgent = Object.freeze(
  new SystemsObservabilityLeadAgent(),
);
