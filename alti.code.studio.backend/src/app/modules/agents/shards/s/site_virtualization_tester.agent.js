...
class SiteVirtualizationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteVirtualizationSystem(objective) {
    logger.info(
      `💻 [SiteVirtualizationTesterAgent] Analyzing Site Virtualization Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Virtualization Tester Target',
      );
...
export const siteVirtualizationTesterAgent = Object.freeze(
  new SiteVirtualizationTesterAgent(),
);
