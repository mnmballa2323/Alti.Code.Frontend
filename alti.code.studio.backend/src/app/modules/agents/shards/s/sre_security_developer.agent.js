...
class SRESecurityDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateSRESecuritySystem(objective) {
        logger.info(`💻 [SRESecurityDeveloperAgent] Analyzing SRE Security Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Security Developer Target");
...
export const sRESecurityDeveloperAgent = Object.freeze(new SRESecurityDeveloperAgent());
