...
class SREOrchestrationDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREOrchestrationSystem(objective) {
    logger.info(
      `💻 [SREOrchestrationDesignerAgent] Analyzing SRE Orchestration Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Orchestration Designer Target',
      );
...
export const sREOrchestrationDesignerAgent = Object.freeze(
  new SREOrchestrationDesignerAgent(),
);
