...
class SiteAnalyticsTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteAnalyticsSystem(objective) {
        logger.info(`💻 [SiteAnalyticsTesterAgent] Analyzing Site Analytics Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Analytics Tester Target");
...
export const siteAnalyticsTesterAgent = Object.freeze(new SiteAnalyticsTesterAgent());
