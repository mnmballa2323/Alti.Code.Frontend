...
class SecurityTestingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSecurityTestingSystem(objective) {
    logger.info(
      `💻 [SecurityTestingEngineerAgent] Analyzing Security Testing Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Security Testing Engineer Target',
      );
...
export const securityTestingEngineerAgent = Object.freeze(
  new SecurityTestingEngineerAgent(),
);
