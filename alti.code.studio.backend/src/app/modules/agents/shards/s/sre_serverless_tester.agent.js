...
class SREServerlessTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSREServerlessSystem(objective) {
        logger.info(`💻 [SREServerlessTesterAgent] Analyzing SRE Serverless Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Serverless Tester Target");
...
export const sREServerlessTesterAgent = Object.freeze(new SREServerlessTesterAgent());
