...
class SiteResilienceDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteResilienceSystem(objective) {
        logger.info(`💻 [SiteResilienceDirectorAgent] Analyzing Site Resilience Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Resilience Director Target");
...
export const siteResilienceDirectorAgent = Object.freeze(new SiteResilienceDirectorAgent());
