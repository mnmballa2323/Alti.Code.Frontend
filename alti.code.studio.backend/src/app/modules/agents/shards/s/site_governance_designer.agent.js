...
class SiteGovernanceDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteGovernanceSystem(objective) {
    logger.info(
      `💻 [SiteGovernanceDesignerAgent] Analyzing Site Governance Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Governance Designer Target',
      );
...
export const siteGovernanceDesignerAgent = Object.freeze(
  new SiteGovernanceDesignerAgent(),
);
