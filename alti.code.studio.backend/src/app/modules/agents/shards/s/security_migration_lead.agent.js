...
class SecurityMigrationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateSecurityMigrationSystem(objective) {
        logger.info(`💻 [SecurityMigrationLeadAgent] Analyzing Security Migration Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Security Migration Lead Target");
...
export const securityMigrationLeadAgent = Object.freeze(new SecurityMigrationLeadAgent());
