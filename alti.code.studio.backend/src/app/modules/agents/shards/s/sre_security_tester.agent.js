...
class SRESecurityTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSRESecuritySystem(objective) {
        logger.info(`💻 [SRESecurityTesterAgent] Analyzing SRE Security Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Security Tester Target");
...
export const sRESecurityTesterAgent = Object.freeze(new SRESecurityTesterAgent());
