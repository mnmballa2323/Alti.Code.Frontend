...
class SiteDataLakeTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteDataLakeSystem(objective) {
    logger.info(
      `💻 [SiteDataLakeTesterAgent] Analyzing Site DataLake Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site DataLake Tester Target',
      );
...
export const siteDataLakeTesterAgent = Object.freeze(
  new SiteDataLakeTesterAgent(),
);
