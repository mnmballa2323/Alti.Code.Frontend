...
class SiteServerlessDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteServerlessSystem(objective) {
        logger.info(`💻 [SiteServerlessDirectorAgent] Analyzing Site Serverless Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Serverless Director Target");
...
export const siteServerlessDirectorAgent = Object.freeze(new SiteServerlessDirectorAgent());
