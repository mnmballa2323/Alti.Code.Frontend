...
class SystemsGovernanceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsGovernanceSystem(objective) {
    logger.info(
      `💻 [SystemsGovernanceTesterAgent] Analyzing Systems Governance Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Governance Tester Target',
      );
...
export const systemsGovernanceTesterAgent = Object.freeze(
  new SystemsGovernanceTesterAgent(),
);
