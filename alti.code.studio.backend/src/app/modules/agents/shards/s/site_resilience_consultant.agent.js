...
class SiteResilienceConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteResilienceSystem(objective) {
    logger.info(
      `💻 [SiteResilienceConsultantAgent] Analyzing Site Resilience Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Resilience Consultant Target',
      );
...
export const siteResilienceConsultantAgent = Object.freeze(
  new SiteResilienceConsultantAgent(),
);
