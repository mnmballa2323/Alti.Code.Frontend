...
class SystemsTestingDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsTestingSystem(objective) {
    logger.info(
      `💻 [SystemsTestingDeveloperAgent] Analyzing Systems Testing Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Testing Developer Target',
      );
...
export const systemsTestingDeveloperAgent = Object.freeze(
  new SystemsTestingDeveloperAgent(),
);
