...
class SiteComplianceAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteComplianceSystem(objective) {
    logger.info(
      `💻 [SiteComplianceAnalystAgent] Analyzing Site Compliance Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Compliance Analyst Target',
      );
...
export const siteComplianceAnalystAgent = Object.freeze(
  new SiteComplianceAnalystAgent(),
);
