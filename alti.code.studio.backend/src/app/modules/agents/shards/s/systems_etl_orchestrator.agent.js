...
class SystemsETLOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsETLSystem(objective) {
    logger.info(
      `💻 [SystemsETLOrchestratorAgent] Analyzing Systems ETL Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems ETL Orchestrator Target',
      );
...
export const systemsETLOrchestratorAgent = Object.freeze(
  new SystemsETLOrchestratorAgent(),
);
