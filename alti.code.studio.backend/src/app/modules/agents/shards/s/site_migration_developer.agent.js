...
class SiteMigrationDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteMigrationSystem(objective) {
        logger.info(`💻 [SiteMigrationDeveloperAgent] Analyzing Site Migration Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Migration Developer Target");
...
export const siteMigrationDeveloperAgent = Object.freeze(new SiteMigrationDeveloperAgent());
