...
class SREGovernancePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREGovernanceSystem(objective) {
    logger.info(
      `💻 [SREGovernancePlannerAgent] Analyzing SRE Governance Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Governance Planner Target',
      );
...
export const sREGovernancePlannerAgent = Object.freeze(
  new SREGovernancePlannerAgent(),
);
