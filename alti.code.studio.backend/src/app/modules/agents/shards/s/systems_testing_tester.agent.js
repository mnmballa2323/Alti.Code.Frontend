...
class SystemsTestingTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsTestingSystem(objective) {
        logger.info(`💻 [SystemsTestingTesterAgent] Analyzing Systems Testing Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Testing Tester Target");
...
export const systemsTestingTesterAgent = Object.freeze(new SystemsTestingTesterAgent());
