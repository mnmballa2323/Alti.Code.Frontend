...
class SiteETLSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteETLSystem(objective) {
        logger.info(`💻 [SiteETLSpecialistAgent] Analyzing Site ETL Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site ETL Specialist Target");
...
export const siteETLSpecialistAgent = Object.freeze(new SiteETLSpecialistAgent());
