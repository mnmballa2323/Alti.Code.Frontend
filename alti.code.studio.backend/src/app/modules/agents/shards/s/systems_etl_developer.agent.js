...
class SystemsETLDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsETLSystem(objective) {
        logger.info(`💻 [SystemsETLDeveloperAgent] Analyzing Systems ETL Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems ETL Developer Target");
...
export const systemsETLDeveloperAgent = Object.freeze(new SystemsETLDeveloperAgent());
