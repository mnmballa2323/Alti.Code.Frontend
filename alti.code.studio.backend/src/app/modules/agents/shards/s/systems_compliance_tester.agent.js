...
class SystemsComplianceTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsComplianceSystem(objective) {
        logger.info(`💻 [SystemsComplianceTesterAgent] Analyzing Systems Compliance Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Compliance Tester Target");
...
export const systemsComplianceTesterAgent = Object.freeze(new SystemsComplianceTesterAgent());
