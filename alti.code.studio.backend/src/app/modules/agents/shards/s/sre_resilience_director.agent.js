...
class SREResilienceDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateSREResilienceSystem(objective) {
        logger.info(`💻 [SREResilienceDirectorAgent] Analyzing SRE Resilience Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Resilience Director Target");
...
export const sREResilienceDirectorAgent = Object.freeze(new SREResilienceDirectorAgent());
