...
class SiteMigrationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteMigrationSystem(objective) {
    logger.info(
      `💻 [SiteMigrationTesterAgent] Analyzing Site Migration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Migration Tester Target',
      );
...
export const siteMigrationTesterAgent = Object.freeze(
  new SiteMigrationTesterAgent(),
);
