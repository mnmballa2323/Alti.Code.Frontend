...
class SiteOptimizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteOptimizationSystem(objective) {
    logger.info(
      `💻 [SiteOptimizationLeadAgent] Analyzing Site Optimization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Optimization Lead Target',
      );
...
export const siteOptimizationLeadAgent = Object.freeze(
  new SiteOptimizationLeadAgent(),
);
