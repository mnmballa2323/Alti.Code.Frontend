...
class SiteSecuritySpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteSecuritySystem(objective) {
        logger.info(`💻 [SiteSecuritySpecialistAgent] Analyzing Site Security Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Security Specialist Target");
...
export const siteSecuritySpecialistAgent = Object.freeze(new SiteSecuritySpecialistAgent());
