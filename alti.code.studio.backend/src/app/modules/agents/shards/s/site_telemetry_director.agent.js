...
class SiteTelemetryDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteTelemetrySystem(objective) {
    logger.info(
      `💻 [SiteTelemetryDirectorAgent] Analyzing Site Telemetry Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Telemetry Director Target',
      );
...
export const siteTelemetryDirectorAgent = Object.freeze(
  new SiteTelemetryDirectorAgent(),
);
