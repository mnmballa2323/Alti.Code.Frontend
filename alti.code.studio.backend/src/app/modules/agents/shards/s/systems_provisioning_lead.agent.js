...
class SystemsProvisioningLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsProvisioningSystem(objective) {
    logger.info(
      `💻 [SystemsProvisioningLeadAgent] Analyzing Systems Provisioning Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Provisioning Lead Target',
      );
...
export const systemsProvisioningLeadAgent = Object.freeze(
  new SystemsProvisioningLeadAgent(),
);
