...
class SiteDeploymentSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteDeploymentSystem(objective) {
        logger.info(`💻 [SiteDeploymentSpecialistAgent] Analyzing Site Deployment Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Deployment Specialist Target");
...
export const siteDeploymentSpecialistAgent = Object.freeze(new SiteDeploymentSpecialistAgent());
