...
class SiteTelemetrySpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteTelemetrySystem(objective) {
    logger.info(
      `💻 [SiteTelemetrySpecialistAgent] Analyzing Site Telemetry Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Telemetry Specialist Target',
      );
...
export const siteTelemetrySpecialistAgent = Object.freeze(
  new SiteTelemetrySpecialistAgent(),
);
