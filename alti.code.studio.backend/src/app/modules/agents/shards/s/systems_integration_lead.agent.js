...
class SystemsIntegrationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsIntegrationSystem(objective) {
    logger.info(
      `💻 [SystemsIntegrationLeadAgent] Analyzing Systems Integration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Integration Lead Target',
      );
...
export const systemsIntegrationLeadAgent = Object.freeze(
  new SystemsIntegrationLeadAgent(),
);
