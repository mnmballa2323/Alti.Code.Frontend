...
class SRETestingStrategistAgent extends GeminiCliBaseAgent {
    ...
    async generateSRETestingSystem(objective) {
        logger.info(`💻 [SRETestingStrategistAgent] Analyzing SRE Testing Strategist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Testing Strategist Target");
...
export const sRETestingStrategistAgent = Object.freeze(new SRETestingStrategistAgent());
