...
class SiteDeploymentAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteDeploymentSystem(objective) {
    logger.info(
      `💻 [SiteDeploymentAnalystAgent] Analyzing Site Deployment Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Deployment Analyst Target',
      );
...
export const siteDeploymentAnalystAgent = Object.freeze(
  new SiteDeploymentAnalystAgent(),
);
