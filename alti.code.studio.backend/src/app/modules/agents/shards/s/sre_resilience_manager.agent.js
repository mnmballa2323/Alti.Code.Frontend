...
class SREResilienceManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREResilienceSystem(objective) {
    logger.info(
      `💻 [SREResilienceManagerAgent] Analyzing SRE Resilience Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Resilience Manager Target',
      );
...
export const sREResilienceManagerAgent = Object.freeze(
  new SREResilienceManagerAgent(),
);
