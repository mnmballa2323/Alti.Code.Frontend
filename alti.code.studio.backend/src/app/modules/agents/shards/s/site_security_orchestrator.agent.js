...
class SiteSecurityOrchestratorAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteSecuritySystem(objective) {
        logger.info(`💻 [SiteSecurityOrchestratorAgent] Analyzing Site Security Orchestrator specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Security Orchestrator Target");
...
export const siteSecurityOrchestratorAgent = Object.freeze(new SiteSecurityOrchestratorAgent());
