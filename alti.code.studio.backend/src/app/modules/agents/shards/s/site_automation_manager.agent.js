...
class SiteAutomationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteAutomationSystem(objective) {
    logger.info(
      `💻 [SiteAutomationManagerAgent] Analyzing Site Automation Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Automation Manager Target',
      );
...
export const siteAutomationManagerAgent = Object.freeze(
  new SiteAutomationManagerAgent(),
);
