...
class SystemsTestingStrategistAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsTestingSystem(objective) {
        logger.info(`💻 [SystemsTestingStrategistAgent] Analyzing Systems Testing Strategist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Testing Strategist Target");
...
export const systemsTestingStrategistAgent = Object.freeze(new SystemsTestingStrategistAgent());
