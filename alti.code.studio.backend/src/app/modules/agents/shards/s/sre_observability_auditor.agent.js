...
class SREObservabilityAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREObservabilitySystem(objective) {
    logger.info(
      `💻 [SREObservabilityAuditorAgent] Analyzing SRE Observability Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Observability Auditor Target',
      );
...
export const sREObservabilityAuditorAgent = Object.freeze(
  new SREObservabilityAuditorAgent(),
);
