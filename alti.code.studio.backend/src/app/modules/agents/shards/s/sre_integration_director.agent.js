...
class SREIntegrationDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREIntegrationSystem(objective) {
    logger.info(
      `💻 [SREIntegrationDirectorAgent] Analyzing SRE Integration Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Integration Director Target',
      );
...
export const sREIntegrationDirectorAgent = Object.freeze(
  new SREIntegrationDirectorAgent(),
);
