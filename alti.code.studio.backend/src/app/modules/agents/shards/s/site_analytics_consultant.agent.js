...
class SiteAnalyticsConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteAnalyticsSystem(objective) {
        logger.info(`💻 [SiteAnalyticsConsultantAgent] Analyzing Site Analytics Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Analytics Consultant Target");
...
export const siteAnalyticsConsultantAgent = Object.freeze(new SiteAnalyticsConsultantAgent());
