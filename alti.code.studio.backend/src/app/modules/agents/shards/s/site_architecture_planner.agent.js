...
class SiteArchitecturePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteArchitectureSystem(objective) {
        logger.info(`💻 [SiteArchitecturePlannerAgent] Analyzing Site Architecture Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Architecture Planner Target");
...
export const siteArchitecturePlannerAgent = Object.freeze(new SiteArchitecturePlannerAgent());
