...
class SiteSecurityEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteSecuritySystem(objective) {
    logger.info(
      `💻 [SiteSecurityEngineerAgent] Analyzing Site Security Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Security Engineer Target',
      );
...
export const siteSecurityEngineerAgent = Object.freeze(
  new SiteSecurityEngineerAgent(),
);
