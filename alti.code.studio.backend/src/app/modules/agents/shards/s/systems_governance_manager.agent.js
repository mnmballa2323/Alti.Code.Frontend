...
class SystemsGovernanceManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsGovernanceSystem(objective) {
    logger.info(
      `💻 [SystemsGovernanceManagerAgent] Analyzing Systems Governance Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Governance Manager Target',
      );
...
export const systemsGovernanceManagerAgent = Object.freeze(
  new SystemsGovernanceManagerAgent(),
);
