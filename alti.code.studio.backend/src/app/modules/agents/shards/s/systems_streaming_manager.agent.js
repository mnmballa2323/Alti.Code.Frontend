...
class SystemsStreamingManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsStreamingSystem(objective) {
        logger.info(`💻 [SystemsStreamingManagerAgent] Analyzing Systems Streaming Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Streaming Manager Target");
...
export const systemsStreamingManagerAgent = Object.freeze(new SystemsStreamingManagerAgent());
