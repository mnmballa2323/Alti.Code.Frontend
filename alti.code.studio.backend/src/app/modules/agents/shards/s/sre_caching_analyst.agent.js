...
class SRECachingAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSRECachingSystem(objective) {
    logger.info(
      `💻 [SRECachingAnalystAgent] Analyzing SRE Caching Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Caching Analyst Target',
      );
...
export const sRECachingAnalystAgent = Object.freeze(
  new SRECachingAnalystAgent(),
);
