...
class SystemsComplianceAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsComplianceSystem(objective) {
    logger.info(
      `💻 [SystemsComplianceAuditorAgent] Analyzing Systems Compliance Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Compliance Auditor Target',
      );
...
export const systemsComplianceAuditorAgent = Object.freeze(
  new SystemsComplianceAuditorAgent(),
);
