...
class SiteAutomationPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteAutomationSystem(objective) {
        logger.info(`💻 [SiteAutomationPlannerAgent] Analyzing Site Automation Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Automation Planner Target");
...
export const siteAutomationPlannerAgent = Object.freeze(new SiteAutomationPlannerAgent());
