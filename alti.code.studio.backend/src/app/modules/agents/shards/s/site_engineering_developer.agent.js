...
class SiteEngineeringDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteEngineeringSystem(objective) {
    logger.info(
      `💻 [SiteEngineeringDeveloperAgent] Analyzing Site Engineering Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Engineering Developer Target',
      );
...
export const siteEngineeringDeveloperAgent = Object.freeze(
  new SiteEngineeringDeveloperAgent(),
);
