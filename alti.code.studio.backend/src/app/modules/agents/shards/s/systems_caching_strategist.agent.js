...
class SystemsCachingStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsCachingSystem(objective) {
    logger.info(
      `💻 [SystemsCachingStrategistAgent] Analyzing Systems Caching Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Caching Strategist Target',
      );
...
export const systemsCachingStrategistAgent = Object.freeze(
  new SystemsCachingStrategistAgent(),
);
