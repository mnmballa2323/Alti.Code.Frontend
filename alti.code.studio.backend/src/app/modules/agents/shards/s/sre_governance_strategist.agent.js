...
class SREGovernanceStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateSREGovernanceSystem(objective) {
    logger.info(
      `💻 [SREGovernanceStrategistAgent] Analyzing SRE Governance Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Governance Strategist Target',
      );
...
export const sREGovernanceStrategistAgent = Object.freeze(
  new SREGovernanceStrategistAgent(),
);
