...
class SREDataLakeTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSREDataLakeSystem(objective) {
        logger.info(`💻 [SREDataLakeTesterAgent] Analyzing SRE DataLake Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE DataLake Tester Target");
...
export const sREDataLakeTesterAgent = Object.freeze(new SREDataLakeTesterAgent());
