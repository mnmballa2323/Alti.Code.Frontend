...
class SiteProvisioningLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteProvisioningSystem(objective) {
    logger.info(
      `💻 [SiteProvisioningLeadAgent] Analyzing Site Provisioning Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Provisioning Lead Target',
      );
...
export const siteProvisioningLeadAgent = Object.freeze(
  new SiteProvisioningLeadAgent(),
);
