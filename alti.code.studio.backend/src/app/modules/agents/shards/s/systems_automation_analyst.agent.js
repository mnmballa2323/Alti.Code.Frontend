...
class SystemsAutomationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsAutomationSystem(objective) {
    logger.info(
      `💻 [SystemsAutomationAnalystAgent] Analyzing Systems Automation Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Automation Analyst Target',
      );
...
export const systemsAutomationAnalystAgent = Object.freeze(
  new SystemsAutomationAnalystAgent(),
);
