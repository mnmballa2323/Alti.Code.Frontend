...
class SREDataWarehousePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateSREDataWarehouseSystem(objective) {
        logger.info(`💻 [SREDataWarehousePlannerAgent] Analyzing SRE DataWarehouse Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE DataWarehouse Planner Target");
...
export const sREDataWarehousePlannerAgent = Object.freeze(new SREDataWarehousePlannerAgent());
