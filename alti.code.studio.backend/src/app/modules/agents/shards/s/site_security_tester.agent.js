...
class SiteSecurityTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteSecuritySystem(objective) {
    logger.info(
      `💻 [SiteSecurityTesterAgent] Analyzing Site Security Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Security Tester Target',
      );
...
export const siteSecurityTesterAgent = Object.freeze(
  new SiteSecurityTesterAgent(),
);
