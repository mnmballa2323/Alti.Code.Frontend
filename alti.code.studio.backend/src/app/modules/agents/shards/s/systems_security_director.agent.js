...
class SystemsSecurityDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsSecuritySystem(objective) {
        logger.info(`💻 [SystemsSecurityDirectorAgent] Analyzing Systems Security Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Security Director Target");
...
export const systemsSecurityDirectorAgent = Object.freeze(new SystemsSecurityDirectorAgent());
