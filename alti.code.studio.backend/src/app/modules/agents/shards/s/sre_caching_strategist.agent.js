...
class SRECachingStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateSRECachingSystem(objective) {
    logger.info(
      `💻 [SRECachingStrategistAgent] Analyzing SRE Caching Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Caching Strategist Target',
      );
...
export const sRECachingStrategistAgent = Object.freeze(
  new SRECachingStrategistAgent(),
);
