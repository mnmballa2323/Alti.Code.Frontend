...
class SystemsMigrationPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsMigrationSystem(objective) {
        logger.info(`💻 [SystemsMigrationPlannerAgent] Analyzing Systems Migration Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Migration Planner Target");
...
export const systemsMigrationPlannerAgent = Object.freeze(new SystemsMigrationPlannerAgent());
