...
class SecurityTestingPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateSecurityTestingSystem(objective) {
        logger.info(`💻 [SecurityTestingPlannerAgent] Analyzing Security Testing Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Security Testing Planner Target");
...
export const securityTestingPlannerAgent = Object.freeze(new SecurityTestingPlannerAgent());
