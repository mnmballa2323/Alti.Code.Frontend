...
class SiteObservabilityTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteObservabilitySystem(objective) {
    logger.info(
      `💻 [SiteObservabilityTesterAgent] Analyzing Site Observability Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Observability Tester Target',
      );
...
export const siteObservabilityTesterAgent = Object.freeze(
  new SiteObservabilityTesterAgent(),
);
