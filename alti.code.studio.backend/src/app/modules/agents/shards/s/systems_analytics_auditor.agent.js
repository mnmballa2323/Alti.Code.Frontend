...
class SystemsAnalyticsAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsAnalyticsSystem(objective) {
    logger.info(
      `💻 [SystemsAnalyticsAuditorAgent] Analyzing Systems Analytics Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Analytics Auditor Target',
      );
...
export const systemsAnalyticsAuditorAgent = Object.freeze(
  new SystemsAnalyticsAuditorAgent(),
);
