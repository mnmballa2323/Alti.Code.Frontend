...
class SREComplianceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSREComplianceSystem(objective) {
    logger.info(
      `💻 [SREComplianceTesterAgent] Analyzing SRE Compliance Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Compliance Tester Target',
      );
...
export const sREComplianceTesterAgent = Object.freeze(
  new SREComplianceTesterAgent(),
);
