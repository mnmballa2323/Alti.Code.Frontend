...
class SREAnalyticsTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSREAnalyticsSystem(objective) {
    logger.info(
      `💻 [SREAnalyticsTesterAgent] Analyzing SRE Analytics Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Analytics Tester Target',
      );
...
export const sREAnalyticsTesterAgent = Object.freeze(
  new SREAnalyticsTesterAgent(),
);
