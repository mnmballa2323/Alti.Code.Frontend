...
class SiteStreamingDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteStreamingSystem(objective) {
    logger.info(
      `💻 [SiteStreamingDeveloperAgent] Analyzing Site Streaming Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Streaming Developer Target',
      );
...
export const siteStreamingDeveloperAgent = Object.freeze(
  new SiteStreamingDeveloperAgent(),
);
