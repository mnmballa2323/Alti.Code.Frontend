...
class SRETestingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSRETestingSystem(objective) {
    logger.info(
      `💻 [SRETestingManagerAgent] Analyzing SRE Testing Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Testing Manager Target',
      );
...
export const sRETestingManagerAgent = Object.freeze(
  new SRETestingManagerAgent(),
);
