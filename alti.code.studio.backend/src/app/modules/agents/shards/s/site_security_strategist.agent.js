...
class SiteSecurityStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteSecuritySystem(objective) {
    logger.info(
      `💻 [SiteSecurityStrategistAgent] Analyzing Site Security Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Security Strategist Target',
      );
...
export const siteSecurityStrategistAgent = Object.freeze(
  new SiteSecurityStrategistAgent(),
);
