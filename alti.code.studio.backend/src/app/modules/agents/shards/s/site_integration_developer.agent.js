...
class SiteIntegrationDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteIntegrationSystem(objective) {
    logger.info(
      `💻 [SiteIntegrationDeveloperAgent] Analyzing Site Integration Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Integration Developer Target',
      );
...
export const siteIntegrationDeveloperAgent = Object.freeze(
  new SiteIntegrationDeveloperAgent(),
);
