...
class SiteEngineeringAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteEngineeringSystem(objective) {
    logger.info(
      `💻 [SiteEngineeringAnalystAgent] Analyzing Site Engineering Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Engineering Analyst Target',
      );
...
export const siteEngineeringAnalystAgent = Object.freeze(
  new SiteEngineeringAnalystAgent(),
);
