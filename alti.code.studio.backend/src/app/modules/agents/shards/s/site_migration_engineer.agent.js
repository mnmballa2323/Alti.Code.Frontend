...
class SiteMigrationEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteMigrationSystem(objective) {
        logger.info(`💻 [SiteMigrationEngineerAgent] Analyzing Site Migration Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Migration Engineer Target");
...
export const siteMigrationEngineerAgent = Object.freeze(new SiteMigrationEngineerAgent());
