...
class SecurityDeploymentTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSecurityDeploymentSystem(objective) {
        logger.info(`💻 [SecurityDeploymentTesterAgent] Analyzing Security Deployment Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Security Deployment Tester Target");
...
export const securityDeploymentTesterAgent = Object.freeze(new SecurityDeploymentTesterAgent());
