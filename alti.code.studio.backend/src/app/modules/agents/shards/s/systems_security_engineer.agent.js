...
class SystemsSecurityEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsSecuritySystem(objective) {
        logger.info(`💻 [SystemsSecurityEngineerAgent] Analyzing Systems Security Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Security Engineer Target");
...
export const systemsSecurityEngineerAgent = Object.freeze(new SystemsSecurityEngineerAgent());
