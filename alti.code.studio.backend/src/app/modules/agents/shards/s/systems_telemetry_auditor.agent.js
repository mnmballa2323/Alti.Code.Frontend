...
class SystemsTelemetryAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsTelemetrySystem(objective) {
        logger.info(`💻 [SystemsTelemetryAuditorAgent] Analyzing Systems Telemetry Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Telemetry Auditor Target");
...
export const systemsTelemetryAuditorAgent = Object.freeze(new SystemsTelemetryAuditorAgent());
