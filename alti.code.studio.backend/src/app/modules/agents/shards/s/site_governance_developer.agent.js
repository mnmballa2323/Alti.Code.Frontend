...
class SiteGovernanceDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteGovernanceSystem(objective) {
        logger.info(`💻 [SiteGovernanceDeveloperAgent] Analyzing Site Governance Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Governance Developer Target");
...
export const siteGovernanceDeveloperAgent = Object.freeze(new SiteGovernanceDeveloperAgent());
