...
class SREComplianceManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREComplianceSystem(objective) {
    logger.info(
      `💻 [SREComplianceManagerAgent] Analyzing SRE Compliance Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Compliance Manager Target',
      );
...
export const sREComplianceManagerAgent = Object.freeze(
  new SREComplianceManagerAgent(),
);
