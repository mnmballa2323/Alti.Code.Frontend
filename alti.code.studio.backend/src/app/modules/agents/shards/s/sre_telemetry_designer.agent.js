...
class SRETelemetryDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateSRETelemetrySystem(objective) {
        logger.info(`💻 [SRETelemetryDesignerAgent] Analyzing SRE Telemetry Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Telemetry Designer Target");
...
export const sRETelemetryDesignerAgent = Object.freeze(new SRETelemetryDesignerAgent());
