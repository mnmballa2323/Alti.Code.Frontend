...
class SREProvisioningAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREProvisioningSystem(objective) {
    logger.info(
      `💻 [SREProvisioningAuditorAgent] Analyzing SRE Provisioning Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Provisioning Auditor Target',
      );
...
export const sREProvisioningAuditorAgent = Object.freeze(
  new SREProvisioningAuditorAgent(),
);
