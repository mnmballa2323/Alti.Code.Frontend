...
class SREComplianceSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateSREComplianceSystem(objective) {
    logger.info(
      `💻 [SREComplianceSpecialistAgent] Analyzing SRE Compliance Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Compliance Specialist Target',
      );
...
export const sREComplianceSpecialistAgent = Object.freeze(
  new SREComplianceSpecialistAgent(),
);
