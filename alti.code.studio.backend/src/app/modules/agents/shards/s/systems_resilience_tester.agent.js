...
class SystemsResilienceTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsResilienceSystem(objective) {
        logger.info(`💻 [SystemsResilienceTesterAgent] Analyzing Systems Resilience Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Resilience Tester Target");
...
export const systemsResilienceTesterAgent = Object.freeze(new SystemsResilienceTesterAgent());
