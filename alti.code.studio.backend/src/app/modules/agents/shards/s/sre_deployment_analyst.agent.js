...
class SREDeploymentAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSREDeploymentSystem(objective) {
    logger.info(
      `💻 [SREDeploymentAnalystAgent] Analyzing SRE Deployment Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Deployment Analyst Target',
      );
...
export const sREDeploymentAnalystAgent = Object.freeze(
  new SREDeploymentAnalystAgent(),
);
