...
class SiteComplianceAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteComplianceSystem(objective) {
        logger.info(`💻 [SiteComplianceAuditorAgent] Analyzing Site Compliance Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Compliance Auditor Target");
...
export const siteComplianceAuditorAgent = Object.freeze(new SiteComplianceAuditorAgent());
