...
class SREProvisioningTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSREProvisioningSystem(objective) {
        logger.info(`💻 [SREProvisioningTesterAgent] Analyzing SRE Provisioning Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Provisioning Tester Target");
...
export const sREProvisioningTesterAgent = Object.freeze(new SREProvisioningTesterAgent());
