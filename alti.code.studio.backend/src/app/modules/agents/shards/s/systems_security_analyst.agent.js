...
class SystemsSecurityAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsSecuritySystem(objective) {
    logger.info(
      `💻 [SystemsSecurityAnalystAgent] Analyzing Systems Security Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Security Analyst Target',
      );
...
export const systemsSecurityAnalystAgent = Object.freeze(
  new SystemsSecurityAnalystAgent(),
);
