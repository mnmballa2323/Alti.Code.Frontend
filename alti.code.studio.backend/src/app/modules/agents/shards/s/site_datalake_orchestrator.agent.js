...
class SiteDataLakeOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteDataLakeSystem(objective) {
    logger.info(
      `💻 [SiteDataLakeOrchestratorAgent] Analyzing Site DataLake Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site DataLake Orchestrator Target',
      );
...
export const siteDataLakeOrchestratorAgent = Object.freeze(
  new SiteDataLakeOrchestratorAgent(),
);
