...
class SiteOptimizationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteOptimizationSystem(objective) {
    logger.info(
      `💻 [SiteOptimizationAnalystAgent] Analyzing Site Optimization Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Optimization Analyst Target',
      );
...
export const siteOptimizationAnalystAgent = Object.freeze(
  new SiteOptimizationAnalystAgent(),
);
