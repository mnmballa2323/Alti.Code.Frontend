...
class SiteProvisioningAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteProvisioningSystem(objective) {
        logger.info(`💻 [SiteProvisioningAuditorAgent] Analyzing Site Provisioning Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Provisioning Auditor Target");
...
export const siteProvisioningAuditorAgent = Object.freeze(new SiteProvisioningAuditorAgent());
