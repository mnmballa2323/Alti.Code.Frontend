...
class SREDataWarehouseDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREDataWarehouseSystem(objective) {
    logger.info(
      `💻 [SREDataWarehouseDirectorAgent] Analyzing SRE DataWarehouse Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE DataWarehouse Director Target',
      );
...
export const sREDataWarehouseDirectorAgent = Object.freeze(
  new SREDataWarehouseDirectorAgent(),
);
