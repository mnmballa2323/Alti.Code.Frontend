...
class SiteDataLakeEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteDataLakeSystem(objective) {
    logger.info(
      `💻 [SiteDataLakeEngineerAgent] Analyzing Site DataLake Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site DataLake Engineer Target',
      );
...
export const siteDataLakeEngineerAgent = Object.freeze(
  new SiteDataLakeEngineerAgent(),
);
