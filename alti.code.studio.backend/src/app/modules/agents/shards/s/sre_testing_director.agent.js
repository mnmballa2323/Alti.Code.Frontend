...
class SRETestingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSRETestingSystem(objective) {
    logger.info(
      `💻 [SRETestingDirectorAgent] Analyzing SRE Testing Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Testing Director Target',
      );
...
export const sRETestingDirectorAgent = Object.freeze(
  new SRETestingDirectorAgent(),
);
