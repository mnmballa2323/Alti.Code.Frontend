...
class SystemsETLSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsETLSystem(objective) {
        logger.info(`💻 [SystemsETLSpecialistAgent] Analyzing Systems ETL Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems ETL Specialist Target");
...
export const systemsETLSpecialistAgent = Object.freeze(new SystemsETLSpecialistAgent());
