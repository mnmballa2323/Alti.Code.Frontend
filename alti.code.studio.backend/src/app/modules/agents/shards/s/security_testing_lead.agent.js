...
class SecurityTestingLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateSecurityTestingSystem(objective) {
        logger.info(`💻 [SecurityTestingLeadAgent] Analyzing Security Testing Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Security Testing Lead Target");
...
export const securityTestingLeadAgent = Object.freeze(new SecurityTestingLeadAgent());
