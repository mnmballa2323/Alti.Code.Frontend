...
class SRETelemetryArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateSRETelemetrySystem(objective) {
    logger.info(
      `💻 [SRETelemetryArchitectAgent] Analyzing SRE Telemetry Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Telemetry Architect Target',
      );
...
export const sRETelemetryArchitectAgent = Object.freeze(
  new SRETelemetryArchitectAgent(),
);
