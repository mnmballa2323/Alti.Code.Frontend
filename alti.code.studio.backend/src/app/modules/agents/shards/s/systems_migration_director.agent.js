...
class SystemsMigrationDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsMigrationSystem(objective) {
        logger.info(`💻 [SystemsMigrationDirectorAgent] Analyzing Systems Migration Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Migration Director Target");
...
export const systemsMigrationDirectorAgent = Object.freeze(new SystemsMigrationDirectorAgent());
