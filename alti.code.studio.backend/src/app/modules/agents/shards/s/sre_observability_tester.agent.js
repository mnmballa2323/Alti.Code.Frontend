...
class SREObservabilityTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSREObservabilitySystem(objective) {
    logger.info(
      `💻 [SREObservabilityTesterAgent] Analyzing SRE Observability Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Observability Tester Target',
      );
...
export const sREObservabilityTesterAgent = Object.freeze(
  new SREObservabilityTesterAgent(),
);
