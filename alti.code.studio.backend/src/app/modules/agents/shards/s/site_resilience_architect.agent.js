...
class SiteResilienceArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteResilienceSystem(objective) {
    logger.info(
      `💻 [SiteResilienceArchitectAgent] Analyzing Site Resilience Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Resilience Architect Target',
      );
...
export const siteResilienceArchitectAgent = Object.freeze(
  new SiteResilienceArchitectAgent(),
);
