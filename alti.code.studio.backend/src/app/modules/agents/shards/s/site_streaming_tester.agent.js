...
class SiteStreamingTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteStreamingSystem(objective) {
        logger.info(`💻 [SiteStreamingTesterAgent] Analyzing Site Streaming Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Streaming Tester Target");
...
export const siteStreamingTesterAgent = Object.freeze(new SiteStreamingTesterAgent());
