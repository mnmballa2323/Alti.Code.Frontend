...
class SystemsDataLakeDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsDataLakeSystem(objective) {
    logger.info(
      `💻 [SystemsDataLakeDeveloperAgent] Analyzing Systems DataLake Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems DataLake Developer Target',
      );
...
export const systemsDataLakeDeveloperAgent = Object.freeze(
  new SystemsDataLakeDeveloperAgent(),
);
