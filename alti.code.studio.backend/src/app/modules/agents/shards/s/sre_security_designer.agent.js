...
class SRESecurityDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSRESecuritySystem(objective) {
    logger.info(
      `💻 [SRESecurityDesignerAgent] Analyzing SRE Security Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Security Designer Target',
      );
...
export const sRESecurityDesignerAgent = Object.freeze(
  new SRESecurityDesignerAgent(),
);
