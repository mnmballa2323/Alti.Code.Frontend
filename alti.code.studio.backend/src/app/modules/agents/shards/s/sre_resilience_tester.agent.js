...
class SREResilienceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSREResilienceSystem(objective) {
    logger.info(
      `💻 [SREResilienceTesterAgent] Analyzing SRE Resilience Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Resilience Tester Target',
      );
...
export const sREResilienceTesterAgent = Object.freeze(
  new SREResilienceTesterAgent(),
);
