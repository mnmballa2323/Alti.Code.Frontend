...
class SRECachingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSRECachingSystem(objective) {
    logger.info(
      `💻 [SRECachingAuditorAgent] Analyzing SRE Caching Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Caching Auditor Target',
      );
...
export const sRECachingAuditorAgent = Object.freeze(
  new SRECachingAuditorAgent(),
);
