...
class SREDataLakeDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSREDataLakeSystem(objective) {
    logger.info(
      `💻 [SREDataLakeDeveloperAgent] Analyzing SRE DataLake Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE DataLake Developer Target',
      );
...
export const sREDataLakeDeveloperAgent = Object.freeze(
  new SREDataLakeDeveloperAgent(),
);
