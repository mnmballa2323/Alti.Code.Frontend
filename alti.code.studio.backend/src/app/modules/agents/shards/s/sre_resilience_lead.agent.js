...
class SREResilienceLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSREResilienceSystem(objective) {
    logger.info(
      `💻 [SREResilienceLeadAgent] Analyzing SRE Resilience Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Resilience Lead Target',
      );
...
export const sREResilienceLeadAgent = Object.freeze(
  new SREResilienceLeadAgent(),
);
