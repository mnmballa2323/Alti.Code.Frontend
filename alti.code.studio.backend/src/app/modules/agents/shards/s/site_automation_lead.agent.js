...
class SiteAutomationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteAutomationSystem(objective) {
    logger.info(
      `💻 [SiteAutomationLeadAgent] Analyzing Site Automation Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Automation Lead Target',
      );
...
export const siteAutomationLeadAgent = Object.freeze(
  new SiteAutomationLeadAgent(),
);
