...
class SystemsTestingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsTestingSystem(objective) {
    logger.info(
      `💻 [SystemsTestingDesignerAgent] Analyzing Systems Testing Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Testing Designer Target',
      );
...
export const systemsTestingDesignerAgent = Object.freeze(
  new SystemsTestingDesignerAgent(),
);
