...
class SiteTestingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteTestingSystem(objective) {
    logger.info(
      `💻 [SiteTestingManagerAgent] Analyzing Site Testing Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Testing Manager Target',
      );
...
export const siteTestingManagerAgent = Object.freeze(
  new SiteTestingManagerAgent(),
);
