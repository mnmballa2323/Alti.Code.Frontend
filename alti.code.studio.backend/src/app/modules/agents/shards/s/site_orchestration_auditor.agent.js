...
class SiteOrchestrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteOrchestrationSystem(objective) {
    logger.info(
      `💻 [SiteOrchestrationAuditorAgent] Analyzing Site Orchestration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Orchestration Auditor Target',
      );
...
export const siteOrchestrationAuditorAgent = Object.freeze(
  new SiteOrchestrationAuditorAgent(),
);
