...
class SREEngineeringTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSREEngineeringSystem(objective) {
    logger.info(
      `💻 [SREEngineeringTesterAgent] Analyzing SRE Engineering Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Engineering Tester Target',
      );
...
export const sREEngineeringTesterAgent = Object.freeze(
  new SREEngineeringTesterAgent(),
);
