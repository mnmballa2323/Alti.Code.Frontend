...
class SREMicroservicesAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREMicroservicesSystem(objective) {
    logger.info(
      `💻 [SREMicroservicesAuditorAgent] Analyzing SRE Microservices Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Microservices Auditor Target',
      );
...
export const sREMicroservicesAuditorAgent = Object.freeze(
  new SREMicroservicesAuditorAgent(),
);
