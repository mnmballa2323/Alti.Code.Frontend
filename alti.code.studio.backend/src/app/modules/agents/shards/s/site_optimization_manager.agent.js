...
class SiteOptimizationManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteOptimizationSystem(objective) {
        logger.info(`💻 [SiteOptimizationManagerAgent] Analyzing Site Optimization Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Optimization Manager Target");
...
export const siteOptimizationManagerAgent = Object.freeze(new SiteOptimizationManagerAgent());
