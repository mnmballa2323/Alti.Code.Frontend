...
class SiteMigrationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteMigrationSystem(objective) {
        logger.info(`💻 [SiteMigrationLeadAgent] Analyzing Site Migration Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Migration Lead Target");
...
export const siteMigrationLeadAgent = Object.freeze(new SiteMigrationLeadAgent());
