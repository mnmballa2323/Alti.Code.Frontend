...
class SystemsDataLakeDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsDataLakeSystem(objective) {
        logger.info(`💻 [SystemsDataLakeDesignerAgent] Analyzing Systems DataLake Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems DataLake Designer Target");
...
export const systemsDataLakeDesignerAgent = Object.freeze(new SystemsDataLakeDesignerAgent());
