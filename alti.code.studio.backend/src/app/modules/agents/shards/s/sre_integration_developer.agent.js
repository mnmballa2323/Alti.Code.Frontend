...
class SREIntegrationDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSREIntegrationSystem(objective) {
    logger.info(
      `💻 [SREIntegrationDeveloperAgent] Analyzing SRE Integration Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Integration Developer Target',
      );
...
export const sREIntegrationDeveloperAgent = Object.freeze(
  new SREIntegrationDeveloperAgent(),
);
