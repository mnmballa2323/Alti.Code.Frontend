...
class SREMicroservicesEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREMicroservicesSystem(objective) {
    logger.info(
      `💻 [SREMicroservicesEngineerAgent] Analyzing SRE Microservices Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Microservices Engineer Target',
      );
...
export const sREMicroservicesEngineerAgent = Object.freeze(
  new SREMicroservicesEngineerAgent(),
);
