...
class SiteOptimizationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteOptimizationSystem(objective) {
    logger.info(
      `💻 [SiteOptimizationTesterAgent] Analyzing Site Optimization Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Optimization Tester Target',
      );
...
export const siteOptimizationTesterAgent = Object.freeze(
  new SiteOptimizationTesterAgent(),
);
