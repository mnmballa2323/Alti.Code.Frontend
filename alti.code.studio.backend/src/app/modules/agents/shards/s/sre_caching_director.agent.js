...
class SRECachingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSRECachingSystem(objective) {
    logger.info(
      `💻 [SRECachingDirectorAgent] Analyzing SRE Caching Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Caching Director Target',
      );
...
export const sRECachingDirectorAgent = Object.freeze(
  new SRECachingDirectorAgent(),
);
