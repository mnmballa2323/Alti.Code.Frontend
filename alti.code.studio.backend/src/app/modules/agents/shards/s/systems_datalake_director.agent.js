...
class SystemsDataLakeDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsDataLakeSystem(objective) {
    logger.info(
      `💻 [SystemsDataLakeDirectorAgent] Analyzing Systems DataLake Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems DataLake Director Target',
      );
...
export const systemsDataLakeDirectorAgent = Object.freeze(
  new SystemsDataLakeDirectorAgent(),
);
