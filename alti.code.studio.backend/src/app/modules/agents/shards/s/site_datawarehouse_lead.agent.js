...
class SiteDataWarehouseLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteDataWarehouseSystem(objective) {
    logger.info(
      `💻 [SiteDataWarehouseLeadAgent] Analyzing Site DataWarehouse Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site DataWarehouse Lead Target',
      );
...
export const siteDataWarehouseLeadAgent = Object.freeze(
  new SiteDataWarehouseLeadAgent(),
);
