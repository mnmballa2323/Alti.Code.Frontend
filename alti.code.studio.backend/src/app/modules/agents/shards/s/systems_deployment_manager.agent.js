...
class SystemsDeploymentManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsDeploymentSystem(objective) {
    logger.info(
      `💻 [SystemsDeploymentManagerAgent] Analyzing Systems Deployment Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Deployment Manager Target',
      );
...
export const systemsDeploymentManagerAgent = Object.freeze(
  new SystemsDeploymentManagerAgent(),
);
