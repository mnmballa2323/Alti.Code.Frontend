...
class SREResilienceDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREResilienceSystem(objective) {
    logger.info(
      `💻 [SREResilienceDesignerAgent] Analyzing SRE Resilience Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Resilience Designer Target',
      );
...
export const sREResilienceDesignerAgent = Object.freeze(
  new SREResilienceDesignerAgent(),
);
