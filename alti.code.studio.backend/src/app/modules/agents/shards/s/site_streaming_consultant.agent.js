...
class SiteStreamingConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteStreamingSystem(objective) {
    logger.info(
      `💻 [SiteStreamingConsultantAgent] Analyzing Site Streaming Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Streaming Consultant Target',
      );
...
export const siteStreamingConsultantAgent = Object.freeze(
  new SiteStreamingConsultantAgent(),
);
