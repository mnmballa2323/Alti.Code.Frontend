...
class SiteCompliancePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteComplianceSystem(objective) {
        logger.info(`💻 [SiteCompliancePlannerAgent] Analyzing Site Compliance Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Compliance Planner Target");
...
export const siteCompliancePlannerAgent = Object.freeze(new SiteCompliancePlannerAgent());
