...
class SystemsAutomationManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsAutomationSystem(objective) {
        logger.info(`💻 [SystemsAutomationManagerAgent] Analyzing Systems Automation Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Automation Manager Target");
...
export const systemsAutomationManagerAgent = Object.freeze(new SystemsAutomationManagerAgent());
