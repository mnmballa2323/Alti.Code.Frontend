...
class SystemsStreamingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsStreamingSystem(objective) {
    logger.info(
      `💻 [SystemsStreamingLeadAgent] Analyzing Systems Streaming Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Streaming Lead Target',
      );
...
export const systemsStreamingLeadAgent = Object.freeze(
  new SystemsStreamingLeadAgent(),
);
