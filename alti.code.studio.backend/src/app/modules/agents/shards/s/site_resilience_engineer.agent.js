...
class SiteResilienceEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteResilienceSystem(objective) {
    logger.info(
      `💻 [SiteResilienceEngineerAgent] Analyzing Site Resilience Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Resilience Engineer Target',
      );
...
export const siteResilienceEngineerAgent = Object.freeze(
  new SiteResilienceEngineerAgent(),
);
