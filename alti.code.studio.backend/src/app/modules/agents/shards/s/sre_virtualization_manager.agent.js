...
class SREVirtualizationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREVirtualizationSystem(objective) {
    logger.info(
      `💻 [SREVirtualizationManagerAgent] Analyzing SRE Virtualization Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Virtualization Manager Target',
      );
...
export const sREVirtualizationManagerAgent = Object.freeze(
  new SREVirtualizationManagerAgent(),
);
