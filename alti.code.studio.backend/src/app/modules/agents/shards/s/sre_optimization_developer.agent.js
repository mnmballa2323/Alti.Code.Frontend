...
class SREOptimizationDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSREOptimizationSystem(objective) {
    logger.info(
      `💻 [SREOptimizationDeveloperAgent] Analyzing SRE Optimization Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Optimization Developer Target',
      );
...
export const sREOptimizationDeveloperAgent = Object.freeze(
  new SREOptimizationDeveloperAgent(),
);
