...
class SystemsSecurityManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsSecuritySystem(objective) {
    logger.info(
      `💻 [SystemsSecurityManagerAgent] Analyzing Systems Security Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Security Manager Target',
      );
...
export const systemsSecurityManagerAgent = Object.freeze(
  new SystemsSecurityManagerAgent(),
);
