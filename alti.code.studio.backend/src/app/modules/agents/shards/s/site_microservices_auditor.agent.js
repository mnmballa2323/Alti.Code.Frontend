...
class SiteMicroservicesAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteMicroservicesSystem(objective) {
    logger.info(
      `💻 [SiteMicroservicesAuditorAgent] Analyzing Site Microservices Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Microservices Auditor Target',
      );
...
export const siteMicroservicesAuditorAgent = Object.freeze(
  new SiteMicroservicesAuditorAgent(),
);
