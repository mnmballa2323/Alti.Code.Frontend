...
class SystemVerilogSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemVerilogSystem(objective) {
    logger.info(
      `💻 [SystemVerilogSpecialistAgent] Analyzing SystemVerilog requirements...`,
    );
...
export const SystemVerilogSpecialistAgentInstance = Object.freeze(
  new SystemVerilogSpecialistAgent(),
);
