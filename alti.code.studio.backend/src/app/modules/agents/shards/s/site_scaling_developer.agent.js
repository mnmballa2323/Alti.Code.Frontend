...
class SiteScalingDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteScalingSystem(objective) {
    logger.info(
      `💻 [SiteScalingDeveloperAgent] Analyzing Site Scaling Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Scaling Developer Target',
      );
...
export const siteScalingDeveloperAgent = Object.freeze(
  new SiteScalingDeveloperAgent(),
);
