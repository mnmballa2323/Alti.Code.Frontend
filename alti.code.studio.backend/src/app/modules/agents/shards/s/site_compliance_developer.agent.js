...
class SiteComplianceDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteComplianceSystem(objective) {
        logger.info(`💻 [SiteComplianceDeveloperAgent] Analyzing Site Compliance Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Compliance Developer Target");
...
export const siteComplianceDeveloperAgent = Object.freeze(new SiteComplianceDeveloperAgent());
