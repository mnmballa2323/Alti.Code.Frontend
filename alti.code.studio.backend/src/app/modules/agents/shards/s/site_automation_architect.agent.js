...
class SiteAutomationArchitectAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteAutomationSystem(objective) {
        logger.info(`💻 [SiteAutomationArchitectAgent] Analyzing Site Automation Architect specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Automation Architect Target");
...
export const siteAutomationArchitectAgent = Object.freeze(new SiteAutomationArchitectAgent());
