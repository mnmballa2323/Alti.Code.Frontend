...
class SystemsCachingEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsCachingSystem(objective) {
        logger.info(`💻 [SystemsCachingEngineerAgent] Analyzing Systems Caching Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Caching Engineer Target");
...
export const systemsCachingEngineerAgent = Object.freeze(new SystemsCachingEngineerAgent());
