...
class SiteProvisioningEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteProvisioningSystem(objective) {
    logger.info(
      `💻 [SiteProvisioningEngineerAgent] Analyzing Site Provisioning Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Provisioning Engineer Target',
      );
...
export const siteProvisioningEngineerAgent = Object.freeze(
  new SiteProvisioningEngineerAgent(),
);
