...
class SREStreamingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREStreamingSystem(objective) {
    logger.info(
      `💻 [SREStreamingAuditorAgent] Analyzing SRE Streaming Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Streaming Auditor Target',
      );
...
export const sREStreamingAuditorAgent = Object.freeze(
  new SREStreamingAuditorAgent(),
);
