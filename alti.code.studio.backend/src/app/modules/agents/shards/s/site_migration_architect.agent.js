...
class SiteMigrationArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteMigrationSystem(objective) {
    logger.info(
      `💻 [SiteMigrationArchitectAgent] Analyzing Site Migration Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Migration Architect Target',
      );
...
export const siteMigrationArchitectAgent = Object.freeze(
  new SiteMigrationArchitectAgent(),
);
