...
class SiteGovernanceEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteGovernanceSystem(objective) {
        logger.info(`💻 [SiteGovernanceEngineerAgent] Analyzing Site Governance Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Governance Engineer Target");
...
export const siteGovernanceEngineerAgent = Object.freeze(new SiteGovernanceEngineerAgent());
