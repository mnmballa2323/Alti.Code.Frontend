...
class SiteDataWarehousePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteDataWarehouseSystem(objective) {
    logger.info(
      `💻 [SiteDataWarehousePlannerAgent] Analyzing Site DataWarehouse Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site DataWarehouse Planner Target',
      );
...
export const siteDataWarehousePlannerAgent = Object.freeze(
  new SiteDataWarehousePlannerAgent(),
);
