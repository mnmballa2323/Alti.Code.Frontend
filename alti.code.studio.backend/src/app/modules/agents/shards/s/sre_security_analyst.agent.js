...
class SRESecurityAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSRESecuritySystem(objective) {
    logger.info(
      `💻 [SRESecurityAnalystAgent] Analyzing SRE Security Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Security Analyst Target',
      );
...
export const sRESecurityAnalystAgent = Object.freeze(
  new SRESecurityAnalystAgent(),
);
