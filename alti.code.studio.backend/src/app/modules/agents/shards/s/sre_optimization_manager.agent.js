...
class SREOptimizationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREOptimizationSystem(objective) {
    logger.info(
      `💻 [SREOptimizationManagerAgent] Analyzing SRE Optimization Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Optimization Manager Target',
      );
...
export const sREOptimizationManagerAgent = Object.freeze(
  new SREOptimizationManagerAgent(),
);
