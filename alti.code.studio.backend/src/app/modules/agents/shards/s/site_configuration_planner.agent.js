...
class SiteConfigurationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteConfigurationSystem(objective) {
    logger.info(
      `💻 [SiteConfigurationPlannerAgent] Analyzing Site Configuration Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Configuration Planner Target',
      );
...
export const siteConfigurationPlannerAgent = Object.freeze(
  new SiteConfigurationPlannerAgent(),
);
