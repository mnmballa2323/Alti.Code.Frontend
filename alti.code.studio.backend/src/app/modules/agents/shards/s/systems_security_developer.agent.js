...
class SystemsSecurityDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsSecuritySystem(objective) {
    logger.info(
      `💻 [SystemsSecurityDeveloperAgent] Analyzing Systems Security Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Security Developer Target',
      );
...
export const systemsSecurityDeveloperAgent = Object.freeze(
  new SystemsSecurityDeveloperAgent(),
);
