...
class SiteSecurityDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteSecuritySystem(objective) {
        logger.info(`💻 [SiteSecurityDesignerAgent] Analyzing Site Security Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Security Designer Target");
...
export const siteSecurityDesignerAgent = Object.freeze(new SiteSecurityDesignerAgent());
