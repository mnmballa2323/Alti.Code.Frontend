...
class SiteCachingDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteCachingSystem(objective) {
    logger.info(
      `💻 [SiteCachingDeveloperAgent] Analyzing Site Caching Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Caching Developer Target',
      );
...
export const siteCachingDeveloperAgent = Object.freeze(
  new SiteCachingDeveloperAgent(),
);
