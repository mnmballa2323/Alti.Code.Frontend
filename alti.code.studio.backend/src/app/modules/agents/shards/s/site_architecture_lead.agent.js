...
class SiteArchitectureLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteArchitectureSystem(objective) {
    logger.info(
      `💻 [SiteArchitectureLeadAgent] Analyzing Site Architecture Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Architecture Lead Target',
      );
...
export const siteArchitectureLeadAgent = Object.freeze(
  new SiteArchitectureLeadAgent(),
);
