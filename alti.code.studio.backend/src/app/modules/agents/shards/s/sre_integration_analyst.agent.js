...
class SREIntegrationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSREIntegrationSystem(objective) {
    logger.info(
      `💻 [SREIntegrationAnalystAgent] Analyzing SRE Integration Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Integration Analyst Target',
      );
...
export const sREIntegrationAnalystAgent = Object.freeze(
  new SREIntegrationAnalystAgent(),
);
