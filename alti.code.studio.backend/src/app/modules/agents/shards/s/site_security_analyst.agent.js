...
class SiteSecurityAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteSecuritySystem(objective) {
        logger.info(`💻 [SiteSecurityAnalystAgent] Analyzing Site Security Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Security Analyst Target");
...
export const siteSecurityAnalystAgent = Object.freeze(new SiteSecurityAnalystAgent());
