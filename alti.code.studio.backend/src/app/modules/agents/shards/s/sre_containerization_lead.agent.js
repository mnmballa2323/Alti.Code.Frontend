...
class SREContainerizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSREContainerizationSystem(objective) {
    logger.info(
      `💻 [SREContainerizationLeadAgent] Analyzing SRE Containerization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Containerization Lead Target',
      );
...
export const sREContainerizationLeadAgent = Object.freeze(
  new SREContainerizationLeadAgent(),
);
