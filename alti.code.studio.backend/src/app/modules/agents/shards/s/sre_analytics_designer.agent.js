...
class SREAnalyticsDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREAnalyticsSystem(objective) {
    logger.info(
      `💻 [SREAnalyticsDesignerAgent] Analyzing SRE Analytics Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Analytics Designer Target',
      );
...
export const sREAnalyticsDesignerAgent = Object.freeze(
  new SREAnalyticsDesignerAgent(),
);
