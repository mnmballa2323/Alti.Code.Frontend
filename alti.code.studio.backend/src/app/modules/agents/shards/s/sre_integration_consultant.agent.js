...
class SREIntegrationConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateSREIntegrationSystem(objective) {
    logger.info(
      `💻 [SREIntegrationConsultantAgent] Analyzing SRE Integration Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Integration Consultant Target',
      );
...
export const sREIntegrationConsultantAgent = Object.freeze(
  new SREIntegrationConsultantAgent(),
);
