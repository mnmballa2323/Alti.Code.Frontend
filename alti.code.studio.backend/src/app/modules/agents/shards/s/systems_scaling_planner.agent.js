...
class SystemsScalingPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsScalingSystem(objective) {
    logger.info(
      `💻 [SystemsScalingPlannerAgent] Analyzing Systems Scaling Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Scaling Planner Target',
      );
...
export const systemsScalingPlannerAgent = Object.freeze(
  new SystemsScalingPlannerAgent(),
);
