...
class SiteTestingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteTestingSystem(objective) {
    logger.info(
      `💻 [SiteTestingDirectorAgent] Analyzing Site Testing Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Testing Director Target',
      );
...
export const siteTestingDirectorAgent = Object.freeze(
  new SiteTestingDirectorAgent(),
);
