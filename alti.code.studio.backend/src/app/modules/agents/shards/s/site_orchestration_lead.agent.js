...
class SiteOrchestrationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteOrchestrationSystem(objective) {
        logger.info(`💻 [SiteOrchestrationLeadAgent] Analyzing Site Orchestration Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Orchestration Lead Target");
...
export const siteOrchestrationLeadAgent = Object.freeze(new SiteOrchestrationLeadAgent());
