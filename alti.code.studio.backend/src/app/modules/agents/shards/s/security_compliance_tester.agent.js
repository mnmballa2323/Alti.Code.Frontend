...
class SecurityComplianceTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSecurityComplianceSystem(objective) {
        logger.info(`💻 [SecurityComplianceTesterAgent] Analyzing Security Compliance Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Security Compliance Tester Target");
...
export const securityComplianceTesterAgent = Object.freeze(new SecurityComplianceTesterAgent());
