...
class SystemsDataLakeTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsDataLakeSystem(objective) {
        logger.info(`💻 [SystemsDataLakeTesterAgent] Analyzing Systems DataLake Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems DataLake Tester Target");
...
export const systemsDataLakeTesterAgent = Object.freeze(new SystemsDataLakeTesterAgent());
