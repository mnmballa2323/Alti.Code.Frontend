...
class SREGovernanceSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateSREGovernanceSystem(objective) {
    logger.info(
      `💻 [SREGovernanceSpecialistAgent] Analyzing SRE Governance Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Governance Specialist Target',
      );
...
export const sREGovernanceSpecialistAgent = Object.freeze(
  new SREGovernanceSpecialistAgent(),
);
