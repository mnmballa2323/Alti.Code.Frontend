...
class SystemsMigrationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsMigrationSystem(objective) {
    logger.info(
      `💻 [SystemsMigrationManagerAgent] Analyzing Systems Migration Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Migration Manager Target',
      );
...
export const systemsMigrationManagerAgent = Object.freeze(
  new SystemsMigrationManagerAgent(),
);
