...
class SystemsTelemetryDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsTelemetrySystem(objective) {
    logger.info(
      `💻 [SystemsTelemetryDesignerAgent] Analyzing Systems Telemetry Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Telemetry Designer Target',
      );
...
export const systemsTelemetryDesignerAgent = Object.freeze(
  new SystemsTelemetryDesignerAgent(),
);
