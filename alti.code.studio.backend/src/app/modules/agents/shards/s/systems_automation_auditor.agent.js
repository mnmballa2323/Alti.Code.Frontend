...
class SystemsAutomationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsAutomationSystem(objective) {
    logger.info(
      `💻 [SystemsAutomationAuditorAgent] Analyzing Systems Automation Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Automation Auditor Target',
      );
...
export const systemsAutomationAuditorAgent = Object.freeze(
  new SystemsAutomationAuditorAgent(),
);
