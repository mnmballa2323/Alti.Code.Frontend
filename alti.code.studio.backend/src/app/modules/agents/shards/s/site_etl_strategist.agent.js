...
class SiteETLStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteETLSystem(objective) {
    logger.info(
      `💻 [SiteETLStrategistAgent] Analyzing Site ETL Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site ETL Strategist Target',
      );
...
export const siteETLStrategistAgent = Object.freeze(
  new SiteETLStrategistAgent(),
);
