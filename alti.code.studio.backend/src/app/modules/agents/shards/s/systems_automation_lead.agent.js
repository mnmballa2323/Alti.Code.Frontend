...
class SystemsAutomationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsAutomationSystem(objective) {
    logger.info(
      `💻 [SystemsAutomationLeadAgent] Analyzing Systems Automation Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Automation Lead Target',
      );
...
export const systemsAutomationLeadAgent = Object.freeze(
  new SystemsAutomationLeadAgent(),
);
