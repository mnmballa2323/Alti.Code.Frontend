...
class SystemsCompliancePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsComplianceSystem(objective) {
        logger.info(`💻 [SystemsCompliancePlannerAgent] Analyzing Systems Compliance Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Compliance Planner Target");
...
export const systemsCompliancePlannerAgent = Object.freeze(new SystemsCompliancePlannerAgent());
