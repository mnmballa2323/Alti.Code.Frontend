...
class SiteAnalyticsSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteAnalyticsSystem(objective) {
    logger.info(
      `💻 [SiteAnalyticsSpecialistAgent] Analyzing Site Analytics Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Analytics Specialist Target',
      );
...
export const siteAnalyticsSpecialistAgent = Object.freeze(
  new SiteAnalyticsSpecialistAgent(),
);
