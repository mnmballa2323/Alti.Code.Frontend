...
class SystemsComplianceManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsComplianceSystem(objective) {
    logger.info(
      `💻 [SystemsComplianceManagerAgent] Analyzing Systems Compliance Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Compliance Manager Target',
      );
...
export const systemsComplianceManagerAgent = Object.freeze(
  new SystemsComplianceManagerAgent(),
);
