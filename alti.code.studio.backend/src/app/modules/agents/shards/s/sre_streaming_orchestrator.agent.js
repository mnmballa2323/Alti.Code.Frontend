...
class SREStreamingOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREStreamingSystem(objective) {
    logger.info(
      `💻 [SREStreamingOrchestratorAgent] Analyzing SRE Streaming Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Streaming Orchestrator Target',
      );
...
export const sREStreamingOrchestratorAgent = Object.freeze(
  new SREStreamingOrchestratorAgent(),
);
