...
class SystemsETLEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsETLSystem(objective) {
    logger.info(
      `💻 [SystemsETLEngineerAgent] Analyzing Systems ETL Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems ETL Engineer Target',
      );
...
export const systemsETLEngineerAgent = Object.freeze(
  new SystemsETLEngineerAgent(),
);
