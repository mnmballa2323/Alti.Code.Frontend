...
class SREAutomationDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREAutomationSystem(objective) {
    logger.info(
      `💻 [SREAutomationDesignerAgent] Analyzing SRE Automation Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Automation Designer Target',
      );
...
export const sREAutomationDesignerAgent = Object.freeze(
  new SREAutomationDesignerAgent(),
);
