...
class SREGovernanceConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateSREGovernanceSystem(objective) {
    logger.info(
      `💻 [SREGovernanceConsultantAgent] Analyzing SRE Governance Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Governance Consultant Target',
      );
...
export const sREGovernanceConsultantAgent = Object.freeze(
  new SREGovernanceConsultantAgent(),
);
