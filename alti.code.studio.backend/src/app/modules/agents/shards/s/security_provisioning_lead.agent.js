...
class SecurityProvisioningLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSecurityProvisioningSystem(objective) {
    logger.info(
      `💻 [SecurityProvisioningLeadAgent] Analyzing Security Provisioning Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Security Provisioning Lead Target',
      );
...
export const securityProvisioningLeadAgent = Object.freeze(
  new SecurityProvisioningLeadAgent(),
);
