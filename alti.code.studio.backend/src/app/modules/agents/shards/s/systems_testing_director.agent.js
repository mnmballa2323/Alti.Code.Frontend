...
class SystemsTestingDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsTestingSystem(objective) {
        logger.info(`💻 [SystemsTestingDirectorAgent] Analyzing Systems Testing Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Testing Director Target");
...
export const systemsTestingDirectorAgent = Object.freeze(new SystemsTestingDirectorAgent());
