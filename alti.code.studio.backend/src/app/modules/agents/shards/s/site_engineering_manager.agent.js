...
class SiteEngineeringManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteEngineeringSystem(objective) {
    logger.info(
      `💻 [SiteEngineeringManagerAgent] Analyzing Site Engineering Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Engineering Manager Target',
      );
...
export const siteEngineeringManagerAgent = Object.freeze(
  new SiteEngineeringManagerAgent(),
);
