...
class SiteTelemetryAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteTelemetrySystem(objective) {
        logger.info(`💻 [SiteTelemetryAuditorAgent] Analyzing Site Telemetry Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Telemetry Auditor Target");
...
export const siteTelemetryAuditorAgent = Object.freeze(new SiteTelemetryAuditorAgent());
