...
class SiteLoadBalancingAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteLoadBalancingSystem(objective) {
    logger.info(
      `💻 [SiteLoadBalancingAnalystAgent] Analyzing Site LoadBalancing Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site LoadBalancing Analyst Target',
      );
...
export const siteLoadBalancingAnalystAgent = Object.freeze(
  new SiteLoadBalancingAnalystAgent(),
);
