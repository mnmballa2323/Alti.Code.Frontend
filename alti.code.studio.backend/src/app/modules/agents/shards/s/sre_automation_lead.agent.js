...
class SREAutomationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSREAutomationSystem(objective) {
    logger.info(
      `💻 [SREAutomationLeadAgent] Analyzing SRE Automation Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Automation Lead Target',
      );
...
export const sREAutomationLeadAgent = Object.freeze(
  new SREAutomationLeadAgent(),
);
