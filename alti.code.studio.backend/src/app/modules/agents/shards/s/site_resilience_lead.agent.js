...
class SiteResilienceLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteResilienceSystem(objective) {
    logger.info(
      `💻 [SiteResilienceLeadAgent] Analyzing Site Resilience Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Resilience Lead Target',
      );
...
export const siteResilienceLeadAgent = Object.freeze(
  new SiteResilienceLeadAgent(),
);
