...
class SRECachingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSRECachingSystem(objective) {
    logger.info(
      `💻 [SRECachingEngineerAgent] Analyzing SRE Caching Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Caching Engineer Target',
      );
...
export const sRECachingEngineerAgent = Object.freeze(
  new SRECachingEngineerAgent(),
);
