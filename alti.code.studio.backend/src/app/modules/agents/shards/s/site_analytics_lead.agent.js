...
class SiteAnalyticsLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteAnalyticsSystem(objective) {
        logger.info(`💻 [SiteAnalyticsLeadAgent] Analyzing Site Analytics Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Analytics Lead Target");
...
export const siteAnalyticsLeadAgent = Object.freeze(new SiteAnalyticsLeadAgent());
