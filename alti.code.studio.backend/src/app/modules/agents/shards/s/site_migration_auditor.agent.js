...
class SiteMigrationAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteMigrationSystem(objective) {
        logger.info(`💻 [SiteMigrationAuditorAgent] Analyzing Site Migration Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Migration Auditor Target");
...
export const siteMigrationAuditorAgent = Object.freeze(new SiteMigrationAuditorAgent());
