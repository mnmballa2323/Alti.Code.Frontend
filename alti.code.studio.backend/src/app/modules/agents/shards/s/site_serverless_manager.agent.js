...
class SiteServerlessManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteServerlessSystem(objective) {
    logger.info(
      `💻 [SiteServerlessManagerAgent] Analyzing Site Serverless Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Serverless Manager Target',
      );
...
export const siteServerlessManagerAgent = Object.freeze(
  new SiteServerlessManagerAgent(),
);
