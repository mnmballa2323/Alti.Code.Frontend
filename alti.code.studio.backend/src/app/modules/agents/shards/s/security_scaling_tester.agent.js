...
class SecurityScalingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSecurityScalingSystem(objective) {
    logger.info(
      `💻 [SecurityScalingTesterAgent] Analyzing Security Scaling Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Security Scaling Tester Target',
      );
...
export const securityScalingTesterAgent = Object.freeze(
  new SecurityScalingTesterAgent(),
);
