...
class SystemsServerlessLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsServerlessSystem(objective) {
    logger.info(
      `💻 [SystemsServerlessLeadAgent] Analyzing Systems Serverless Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Serverless Lead Target',
      );
...
export const systemsServerlessLeadAgent = Object.freeze(
  new SystemsServerlessLeadAgent(),
);
