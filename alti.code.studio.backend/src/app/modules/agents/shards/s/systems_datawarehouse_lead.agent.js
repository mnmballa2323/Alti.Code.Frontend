...
class SystemsDataWarehouseLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsDataWarehouseSystem(objective) {
    logger.info(
      `💻 [SystemsDataWarehouseLeadAgent] Analyzing Systems DataWarehouse Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems DataWarehouse Lead Target',
      );
...
export const systemsDataWarehouseLeadAgent = Object.freeze(
  new SystemsDataWarehouseLeadAgent(),
);
