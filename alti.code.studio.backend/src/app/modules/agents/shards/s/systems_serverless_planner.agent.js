...
class SystemsServerlessPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsServerlessSystem(objective) {
    logger.info(
      `💻 [SystemsServerlessPlannerAgent] Analyzing Systems Serverless Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Serverless Planner Target',
      );
...
export const systemsServerlessPlannerAgent = Object.freeze(
  new SystemsServerlessPlannerAgent(),
);
