...
class SystemsCachingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsCachingSystem(objective) {
    logger.info(
      `💻 [SystemsCachingDesignerAgent] Analyzing Systems Caching Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Caching Designer Target',
      );
...
export const systemsCachingDesignerAgent = Object.freeze(
  new SystemsCachingDesignerAgent(),
);
