...
class SystemsIntegrationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsIntegrationSystem(objective) {
    logger.info(
      `💻 [SystemsIntegrationTesterAgent] Analyzing Systems Integration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Integration Tester Target',
      );
...
export const systemsIntegrationTesterAgent = Object.freeze(
  new SystemsIntegrationTesterAgent(),
);
