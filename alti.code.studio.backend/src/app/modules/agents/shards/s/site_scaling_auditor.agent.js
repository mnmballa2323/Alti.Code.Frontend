...
class SiteScalingAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteScalingSystem(objective) {
        logger.info(`💻 [SiteScalingAuditorAgent] Analyzing Site Scaling Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Scaling Auditor Target");
...
export const siteScalingAuditorAgent = Object.freeze(new SiteScalingAuditorAgent());
