...
class SecurityMigrationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSecurityMigrationSystem(objective) {
    logger.info(
      `💻 [SecurityMigrationPlannerAgent] Analyzing Security Migration Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Security Migration Planner Target',
      );
...
export const securityMigrationPlannerAgent = Object.freeze(
  new SecurityMigrationPlannerAgent(),
);
