...
class SystemsSecurityDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsSecuritySystem(objective) {
    logger.info(
      `💻 [SystemsSecurityDesignerAgent] Analyzing Systems Security Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Security Designer Target',
      );
...
export const systemsSecurityDesignerAgent = Object.freeze(
  new SystemsSecurityDesignerAgent(),
);
