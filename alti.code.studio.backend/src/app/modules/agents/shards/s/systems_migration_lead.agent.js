...
class SystemsMigrationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateSystemsMigrationSystem(objective) {
        logger.info(`💻 [SystemsMigrationLeadAgent] Analyzing Systems Migration Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Systems Migration Lead Target");
...
export const systemsMigrationLeadAgent = Object.freeze(new SystemsMigrationLeadAgent());
