...
class SystemsTestingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateSystemsTestingSystem(objective) {
    logger.info(
      `💻 [SystemsTestingEngineerAgent] Analyzing Systems Testing Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Systems Testing Engineer Target',
      );
...
export const systemsTestingEngineerAgent = Object.freeze(
  new SystemsTestingEngineerAgent(),
);
