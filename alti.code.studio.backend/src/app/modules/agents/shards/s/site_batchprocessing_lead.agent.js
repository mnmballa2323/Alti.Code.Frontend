...
class SiteBatchProcessingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteBatchProcessingSystem(objective) {
    logger.info(
      `💻 [SiteBatchProcessingLeadAgent] Analyzing Site BatchProcessing Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site BatchProcessing Lead Target',
      );
...
export const siteBatchProcessingLeadAgent = Object.freeze(
  new SiteBatchProcessingLeadAgent(),
);
