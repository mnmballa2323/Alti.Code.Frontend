...
class SiteTestingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteTestingSystem(objective) {
    logger.info(
      `💻 [SiteTestingTesterAgent] Analyzing Site Testing Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Testing Tester Target',
      );
...
export const siteTestingTesterAgent = Object.freeze(
  new SiteTestingTesterAgent(),
);
