...
class SREIntegrationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSREIntegrationSystem(objective) {
    logger.info(
      `💻 [SREIntegrationTesterAgent] Analyzing SRE Integration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Integration Tester Target',
      );
...
export const sREIntegrationTesterAgent = Object.freeze(
  new SREIntegrationTesterAgent(),
);
