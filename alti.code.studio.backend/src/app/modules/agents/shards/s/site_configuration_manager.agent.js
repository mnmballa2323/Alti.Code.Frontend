...
class SiteConfigurationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteConfigurationSystem(objective) {
    logger.info(
      `💻 [SiteConfigurationManagerAgent] Analyzing Site Configuration Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Configuration Manager Target',
      );
...
export const siteConfigurationManagerAgent = Object.freeze(
  new SiteConfigurationManagerAgent(),
);
