...
class SREProvisioningManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREProvisioningSystem(objective) {
    logger.info(
      `💻 [SREProvisioningManagerAgent] Analyzing SRE Provisioning Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Provisioning Manager Target',
      );
...
export const sREProvisioningManagerAgent = Object.freeze(
  new SREProvisioningManagerAgent(),
);
