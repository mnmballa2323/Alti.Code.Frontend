...
class SREResiliencePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateSREResilienceSystem(objective) {
        logger.info(`💻 [SREResiliencePlannerAgent] Analyzing SRE Resilience Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Resilience Planner Target");
...
export const sREResiliencePlannerAgent = Object.freeze(new SREResiliencePlannerAgent());
