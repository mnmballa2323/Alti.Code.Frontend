...
class SiteScalingStrategistAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteScalingSystem(objective) {
        logger.info(`💻 [SiteScalingStrategistAgent] Analyzing Site Scaling Strategist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Scaling Strategist Target");
...
export const siteScalingStrategistAgent = Object.freeze(new SiteScalingStrategistAgent());
