...
class SRETelemetryManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateSRETelemetrySystem(objective) {
        logger.info(`💻 [SRETelemetryManagerAgent] Analyzing SRE Telemetry Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Telemetry Manager Target");
...
export const sRETelemetryManagerAgent = Object.freeze(new SRETelemetryManagerAgent());
