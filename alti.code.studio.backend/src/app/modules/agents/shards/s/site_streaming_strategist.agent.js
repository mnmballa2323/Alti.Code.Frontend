...
class SiteStreamingStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteStreamingSystem(objective) {
    logger.info(
      `💻 [SiteStreamingStrategistAgent] Analyzing Site Streaming Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Streaming Strategist Target',
      );
...
export const siteStreamingStrategistAgent = Object.freeze(
  new SiteStreamingStrategistAgent(),
);
