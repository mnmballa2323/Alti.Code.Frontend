...
class SecurityTelemetryTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSecurityTelemetrySystem(objective) {
        logger.info(`💻 [SecurityTelemetryTesterAgent] Analyzing Security Telemetry Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Security Telemetry Tester Target");
...
export const securityTelemetryTesterAgent = Object.freeze(new SecurityTelemetryTesterAgent());
