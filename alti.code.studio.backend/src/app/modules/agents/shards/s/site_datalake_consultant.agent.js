...
class SiteDataLakeConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteDataLakeSystem(objective) {
    logger.info(
      `💻 [SiteDataLakeConsultantAgent] Analyzing Site DataLake Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site DataLake Consultant Target',
      );
...
export const siteDataLakeConsultantAgent = Object.freeze(
  new SiteDataLakeConsultantAgent(),
);
