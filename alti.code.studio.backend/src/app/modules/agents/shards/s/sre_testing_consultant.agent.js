...
class SRETestingConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateSRETestingSystem(objective) {
        logger.info(`💻 [SRETestingConsultantAgent] Analyzing SRE Testing Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Testing Consultant Target");
...
export const sRETestingConsultantAgent = Object.freeze(new SRETestingConsultantAgent());
