...
class SiteGovernanceAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteGovernanceSystem(objective) {
    logger.info(
      `💻 [SiteGovernanceAnalystAgent] Analyzing Site Governance Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Governance Analyst Target',
      );
...
export const siteGovernanceAnalystAgent = Object.freeze(
  new SiteGovernanceAnalystAgent(),
);
