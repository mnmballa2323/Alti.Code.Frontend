...
class SiteIntegrationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteIntegrationSystem(objective) {
    logger.info(
      `💻 [SiteIntegrationAnalystAgent] Analyzing Site Integration Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Integration Analyst Target',
      );
...
export const siteIntegrationAnalystAgent = Object.freeze(
  new SiteIntegrationAnalystAgent(),
);
