...
class SiteComplianceEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteComplianceSystem(objective) {
        logger.info(`💻 [SiteComplianceEngineerAgent] Analyzing Site Compliance Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Compliance Engineer Target");
...
export const siteComplianceEngineerAgent = Object.freeze(new SiteComplianceEngineerAgent());
