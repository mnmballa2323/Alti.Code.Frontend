...
class SiteTelemetryTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteTelemetrySystem(objective) {
    logger.info(
      `💻 [SiteTelemetryTesterAgent] Analyzing Site Telemetry Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Telemetry Tester Target',
      );
...
export const siteTelemetryTesterAgent = Object.freeze(
  new SiteTelemetryTesterAgent(),
);
