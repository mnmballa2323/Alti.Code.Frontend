...
class SREMigrationConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateSREMigrationSystem(objective) {
    logger.info(
      `💻 [SREMigrationConsultantAgent] Analyzing SRE Migration Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Migration Consultant Target',
      );
...
export const sREMigrationConsultantAgent = Object.freeze(
  new SREMigrationConsultantAgent(),
);
