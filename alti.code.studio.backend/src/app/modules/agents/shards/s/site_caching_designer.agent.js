...
class SiteCachingDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateSiteCachingSystem(objective) {
        logger.info(`💻 [SiteCachingDesignerAgent] Analyzing Site Caching Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Site Caching Designer Target");
...
export const siteCachingDesignerAgent = Object.freeze(new SiteCachingDesignerAgent());
