...
class SRESecurityDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateSRESecuritySystem(objective) {
        logger.info(`💻 [SRESecurityDirectorAgent] Analyzing SRE Security Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Security Director Target");
...
export const sRESecurityDirectorAgent = Object.freeze(new SRESecurityDirectorAgent());
