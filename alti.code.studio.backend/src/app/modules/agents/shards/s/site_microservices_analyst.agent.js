...
class SiteMicroservicesAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteMicroservicesSystem(objective) {
    logger.info(
      `💻 [SiteMicroservicesAnalystAgent] Analyzing Site Microservices Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Microservices Analyst Target',
      );
...
export const siteMicroservicesAnalystAgent = Object.freeze(
  new SiteMicroservicesAnalystAgent(),
);
