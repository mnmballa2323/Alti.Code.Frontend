...
class SecuritySecurityTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateSecuritySecuritySystem(objective) {
        logger.info(`💻 [SecuritySecurityTesterAgent] Analyzing Security Security Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Security Security Tester Target");
...
export const securitySecurityTesterAgent = Object.freeze(new SecuritySecurityTesterAgent());
