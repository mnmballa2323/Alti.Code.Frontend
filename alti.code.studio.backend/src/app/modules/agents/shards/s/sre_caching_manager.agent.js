...
class SRECachingManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateSRECachingSystem(objective) {
        logger.info(`💻 [SRECachingManagerAgent] Analyzing SRE Caching Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Caching Manager Target");
...
export const sRECachingManagerAgent = Object.freeze(new SRECachingManagerAgent());
