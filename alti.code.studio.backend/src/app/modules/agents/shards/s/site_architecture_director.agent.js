...
class SiteArchitectureDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateSiteArchitectureSystem(objective) {
    logger.info(
      `💻 [SiteArchitectureDirectorAgent] Analyzing Site Architecture Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Site Architecture Director Target',
      );
...
export const siteArchitectureDirectorAgent = Object.freeze(
  new SiteArchitectureDirectorAgent(),
);
