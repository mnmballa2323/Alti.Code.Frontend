...
class SREDeploymentManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREDeploymentSystem(objective) {
    logger.info(
      `💻 [SREDeploymentManagerAgent] Analyzing SRE Deployment Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Deployment Manager Target',
      );
...
export const sREDeploymentManagerAgent = Object.freeze(
  new SREDeploymentManagerAgent(),
);
