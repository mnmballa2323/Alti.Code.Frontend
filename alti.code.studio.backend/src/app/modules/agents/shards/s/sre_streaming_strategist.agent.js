...
class SREStreamingStrategistAgent extends GeminiCliBaseAgent {
    ...
    async generateSREStreamingSystem(objective) {
        logger.info(`💻 [SREStreamingStrategistAgent] Analyzing SRE Streaming Strategist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - SRE Streaming Strategist Target");
...
export const sREStreamingStrategistAgent = Object.freeze(new SREStreamingStrategistAgent());
