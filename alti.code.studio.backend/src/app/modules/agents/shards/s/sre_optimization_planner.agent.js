...
class SREOptimizationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateSREOptimizationSystem(objective) {
    logger.info(
      `💻 [SREOptimizationPlannerAgent] Analyzing SRE Optimization Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE Optimization Planner Target',
      );
...
export const sREOptimizationPlannerAgent = Object.freeze(
  new SREOptimizationPlannerAgent(),
);
