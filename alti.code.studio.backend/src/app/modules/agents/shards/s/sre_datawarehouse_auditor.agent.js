...
class SREDataWarehouseAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateSREDataWarehouseSystem(objective) {
    logger.info(
      `💻 [SREDataWarehouseAuditorAgent] Analyzing SRE DataWarehouse Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - SRE DataWarehouse Auditor Target',
      );
...
export const sREDataWarehouseAuditorAgent = Object.freeze(
  new SREDataWarehouseAuditorAgent(),
);
