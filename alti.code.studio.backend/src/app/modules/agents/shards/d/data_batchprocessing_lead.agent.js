...
class DataBatchProcessingLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateDataBatchProcessingSystem(objective) {
        logger.info(`💻 [DataBatchProcessingLeadAgent] Analyzing Data BatchProcessing Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data BatchProcessing Lead Target");
...
export const dataBatchProcessingLeadAgent = Object.freeze(new DataBatchProcessingLeadAgent());
