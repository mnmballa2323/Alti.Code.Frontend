...
class DevOpsSecurityDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsSecuritySystem(objective) {
    logger.info(
      `💻 [DevOpsSecurityDeveloperAgent] Analyzing DevOps Security Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Security Developer Target',
      );
...
export const devOpsSecurityDeveloperAgent = Object.freeze(
  new DevOpsSecurityDeveloperAgent(),
);
