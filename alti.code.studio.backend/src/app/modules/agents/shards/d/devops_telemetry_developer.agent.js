...
class DevOpsTelemetryDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsTelemetrySystem(objective) {
    logger.info(
      `💻 [DevOpsTelemetryDeveloperAgent] Analyzing DevOps Telemetry Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Telemetry Developer Target',
      );
...
export const devOpsTelemetryDeveloperAgent = Object.freeze(
  new DevOpsTelemetryDeveloperAgent(),
);
