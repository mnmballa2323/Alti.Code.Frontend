...
class DevOpsSecurityConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsSecuritySystem(objective) {
        logger.info(`💻 [DevOpsSecurityConsultantAgent] Analyzing DevOps Security Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Security Consultant Target");
...
export const devOpsSecurityConsultantAgent = Object.freeze(new DevOpsSecurityConsultantAgent());
