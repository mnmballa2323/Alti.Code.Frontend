...
class DevSecOpsETLSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateDevSecOpsETLSystem(objective) {
        logger.info(`💻 [DevSecOpsETLSpecialistAgent] Analyzing DevSecOps ETL Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevSecOps ETL Specialist Target");
...
export const devSecOpsETLSpecialistAgent = Object.freeze(new DevSecOpsETLSpecialistAgent());
