...
class DataETLConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateDataETLSystem(objective) {
        logger.info(`💻 [DataETLConsultantAgent] Analyzing Data ETL Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data ETL Consultant Target");
...
export const dataETLConsultantAgent = Object.freeze(new DataETLConsultantAgent());
