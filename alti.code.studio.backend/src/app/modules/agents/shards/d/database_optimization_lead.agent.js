...
class DatabaseOptimizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseOptimizationSystem(objective) {
    logger.info(
      `💻 [DatabaseOptimizationLeadAgent] Analyzing Database Optimization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Optimization Lead Target',
      );
...
export const databaseOptimizationLeadAgent = Object.freeze(
  new DatabaseOptimizationLeadAgent(),
);
