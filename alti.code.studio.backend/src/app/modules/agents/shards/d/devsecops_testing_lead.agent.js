...
class DevSecOpsTestingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDevSecOpsTestingSystem(objective) {
    logger.info(
      `💻 [DevSecOpsTestingLeadAgent] Analyzing DevSecOps Testing Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevSecOps Testing Lead Target',
      );
...
export const devSecOpsTestingLeadAgent = Object.freeze(
  new DevSecOpsTestingLeadAgent(),
);
