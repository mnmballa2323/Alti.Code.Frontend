...
class DataIntegrationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataIntegrationSystem(objective) {
    logger.info(
      `💻 [DataIntegrationPlannerAgent] Analyzing Data Integration Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Integration Planner Target',
      );
...
export const dataIntegrationPlannerAgent = Object.freeze(
  new DataIntegrationPlannerAgent(),
);
