...
class DevSecOpsETLEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevSecOpsETLSystem(objective) {
    logger.info(
      `💻 [DevSecOpsETLEngineerAgent] Analyzing DevSecOps ETL Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevSecOps ETL Engineer Target',
      );
...
export const devSecOpsETLEngineerAgent = Object.freeze(
  new DevSecOpsETLEngineerAgent(),
);
