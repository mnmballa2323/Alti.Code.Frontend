...
class DevOpsResiliencePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsResilienceSystem(objective) {
        logger.info(`💻 [DevOpsResiliencePlannerAgent] Analyzing DevOps Resilience Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Resilience Planner Target");
...
export const devOpsResiliencePlannerAgent = Object.freeze(new DevOpsResiliencePlannerAgent());
