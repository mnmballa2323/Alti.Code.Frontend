...
class DatabaseCachingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseCachingSystem(objective) {
    logger.info(
      `💻 [DatabaseCachingTesterAgent] Analyzing Database Caching Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Caching Tester Target',
      );
...
export const databaseCachingTesterAgent = Object.freeze(
  new DatabaseCachingTesterAgent(),
);
