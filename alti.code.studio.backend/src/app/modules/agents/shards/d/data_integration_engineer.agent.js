...
class DataIntegrationEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataIntegrationSystem(objective) {
        logger.info(`💻 [DataIntegrationEngineerAgent] Analyzing Data Integration Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Integration Engineer Target");
...
export const dataIntegrationEngineerAgent = Object.freeze(new DataIntegrationEngineerAgent());
