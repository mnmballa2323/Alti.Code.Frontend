...
class DevOpsDataLakeAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsDataLakeSystem(objective) {
    logger.info(
      `💻 [DevOpsDataLakeAnalystAgent] Analyzing DevOps DataLake Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps DataLake Analyst Target',
      );
...
export const devOpsDataLakeAnalystAgent = Object.freeze(
  new DevOpsDataLakeAnalystAgent(),
);
