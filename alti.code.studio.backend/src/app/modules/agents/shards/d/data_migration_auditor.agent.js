...
class DataMigrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataMigrationSystem(objective) {
    logger.info(
      `💻 [DataMigrationAuditorAgent] Analyzing Data Migration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Migration Auditor Target',
      );
...
export const dataMigrationAuditorAgent = Object.freeze(
  new DataMigrationAuditorAgent(),
);
