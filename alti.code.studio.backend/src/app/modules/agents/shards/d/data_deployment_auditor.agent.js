...
class DataDeploymentAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataDeploymentSystem(objective) {
    logger.info(
      `💻 [DataDeploymentAuditorAgent] Analyzing Data Deployment Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Deployment Auditor Target',
      );
...
export const dataDeploymentAuditorAgent = Object.freeze(
  new DataDeploymentAuditorAgent(),
);
