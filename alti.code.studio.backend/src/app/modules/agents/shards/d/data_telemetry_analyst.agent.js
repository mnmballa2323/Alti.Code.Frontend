...
class DataTelemetryAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDataTelemetrySystem(objective) {
    logger.info(
      `💻 [DataTelemetryAnalystAgent] Analyzing Data Telemetry Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Telemetry Analyst Target',
      );
...
export const dataTelemetryAnalystAgent = Object.freeze(
  new DataTelemetryAnalystAgent(),
);
