...
class DataServerlessManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataServerlessSystem(objective) {
        logger.info(`💻 [DataServerlessManagerAgent] Analyzing Data Serverless Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Serverless Manager Target");
...
export const dataServerlessManagerAgent = Object.freeze(new DataServerlessManagerAgent());
