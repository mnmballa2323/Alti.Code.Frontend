...
class DevOpsGovernanceDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsGovernanceSystem(objective) {
    logger.info(
      `💻 [DevOpsGovernanceDirectorAgent] Analyzing DevOps Governance Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Governance Director Target',
      );
...
export const devOpsGovernanceDirectorAgent = Object.freeze(
  new DevOpsGovernanceDirectorAgent(),
);
