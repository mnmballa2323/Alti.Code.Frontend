...
class DataComplianceLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDataComplianceSystem(objective) {
    logger.info(
      `💻 [DataComplianceLeadAgent] Analyzing Data Compliance Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Compliance Lead Target',
      );
...
export const dataComplianceLeadAgent = Object.freeze(
  new DataComplianceLeadAgent(),
);
