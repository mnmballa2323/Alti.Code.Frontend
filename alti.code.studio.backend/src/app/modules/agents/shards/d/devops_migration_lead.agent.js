...
class DevOpsMigrationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsMigrationSystem(objective) {
        logger.info(`💻 [DevOpsMigrationLeadAgent] Analyzing DevOps Migration Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Migration Lead Target");
...
export const devOpsMigrationLeadAgent = Object.freeze(new DevOpsMigrationLeadAgent());
