...
class DataMicroservicesPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataMicroservicesSystem(objective) {
    logger.info(
      `💻 [DataMicroservicesPlannerAgent] Analyzing Data Microservices Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Microservices Planner Target',
      );
...
export const dataMicroservicesPlannerAgent = Object.freeze(
  new DataMicroservicesPlannerAgent(),
);
