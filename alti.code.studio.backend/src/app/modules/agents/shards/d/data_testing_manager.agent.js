...
class DataTestingManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataTestingSystem(objective) {
        logger.info(`💻 [DataTestingManagerAgent] Analyzing Data Testing Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Testing Manager Target");
...
export const dataTestingManagerAgent = Object.freeze(new DataTestingManagerAgent());
