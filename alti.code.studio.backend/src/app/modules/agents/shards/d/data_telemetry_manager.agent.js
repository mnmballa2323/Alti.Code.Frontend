...
class DataTelemetryManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataTelemetrySystem(objective) {
        logger.info(`💻 [DataTelemetryManagerAgent] Analyzing Data Telemetry Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Telemetry Manager Target");
...
export const dataTelemetryManagerAgent = Object.freeze(new DataTelemetryManagerAgent());
