...
class DevOpsETLSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsETLSystem(objective) {
    logger.info(
      `💻 [DevOpsETLSpecialistAgent] Analyzing DevOps ETL Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps ETL Specialist Target',
      );
...
export const devOpsETLSpecialistAgent = Object.freeze(
  new DevOpsETLSpecialistAgent(),
);
