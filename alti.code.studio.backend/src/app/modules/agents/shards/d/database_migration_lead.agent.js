...
class DatabaseMigrationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseMigrationSystem(objective) {
    logger.info(
      `💻 [DatabaseMigrationLeadAgent] Analyzing Database Migration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Migration Lead Target',
      );
...
export const databaseMigrationLeadAgent = Object.freeze(
  new DatabaseMigrationLeadAgent(),
);
