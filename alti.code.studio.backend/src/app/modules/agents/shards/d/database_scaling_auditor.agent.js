...
class DatabaseScalingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseScalingSystem(objective) {
    logger.info(
      `💻 [DatabaseScalingAuditorAgent] Analyzing Database Scaling Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Scaling Auditor Target',
      );
...
export const databaseScalingAuditorAgent = Object.freeze(
  new DatabaseScalingAuditorAgent(),
);
