...
class DataDeploymentDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataDeploymentSystem(objective) {
    logger.info(
      `💻 [DataDeploymentDesignerAgent] Analyzing Data Deployment Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Deployment Designer Target',
      );
...
export const dataDeploymentDesignerAgent = Object.freeze(
  new DataDeploymentDesignerAgent(),
);
