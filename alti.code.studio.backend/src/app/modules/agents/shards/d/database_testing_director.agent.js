...
class DatabaseTestingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseTestingSystem(objective) {
    logger.info(
      `💻 [DatabaseTestingDirectorAgent] Analyzing Database Testing Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Testing Director Target',
      );
...
export const databaseTestingDirectorAgent = Object.freeze(
  new DatabaseTestingDirectorAgent(),
);
