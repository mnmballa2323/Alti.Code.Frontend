...
class DevOpsAnalyticsDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsAnalyticsSystem(objective) {
    logger.info(
      `💻 [DevOpsAnalyticsDirectorAgent] Analyzing DevOps Analytics Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Analytics Director Target',
      );
...
export const devOpsAnalyticsDirectorAgent = Object.freeze(
  new DevOpsAnalyticsDirectorAgent(),
);
