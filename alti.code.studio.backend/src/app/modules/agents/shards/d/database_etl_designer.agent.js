...
class DatabaseETLDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseETLSystem(objective) {
        logger.info(`💻 [DatabaseETLDesignerAgent] Analyzing Database ETL Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database ETL Designer Target");
...
export const databaseETLDesignerAgent = Object.freeze(new DatabaseETLDesignerAgent());
