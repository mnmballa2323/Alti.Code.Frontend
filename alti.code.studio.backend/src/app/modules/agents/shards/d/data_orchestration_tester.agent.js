...
class DataOrchestrationTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDataOrchestrationSystem(objective) {
        logger.info(`💻 [DataOrchestrationTesterAgent] Analyzing Data Orchestration Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Orchestration Tester Target");
...
export const dataOrchestrationTesterAgent = Object.freeze(new DataOrchestrationTesterAgent());
