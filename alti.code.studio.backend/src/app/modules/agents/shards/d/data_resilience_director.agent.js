...
class DataResilienceDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateDataResilienceSystem(objective) {
        logger.info(`💻 [DataResilienceDirectorAgent] Analyzing Data Resilience Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Resilience Director Target");
...
export const dataResilienceDirectorAgent = Object.freeze(new DataResilienceDirectorAgent());
