...
class DataTestingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataTestingSystem(objective) {
    logger.info(
      `💻 [DataTestingDirectorAgent] Analyzing Data Testing Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Testing Director Target',
      );
...
export const dataTestingDirectorAgent = Object.freeze(
  new DataTestingDirectorAgent(),
);
