...
class DataDataLakeDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateDataDataLakeSystem(objective) {
        logger.info(`💻 [DataDataLakeDirectorAgent] Analyzing Data DataLake Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data DataLake Director Target");
...
export const dataDataLakeDirectorAgent = Object.freeze(new DataDataLakeDirectorAgent());
