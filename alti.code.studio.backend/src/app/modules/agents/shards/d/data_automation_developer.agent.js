...
class DataAutomationDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateDataAutomationSystem(objective) {
    logger.info(
      `💻 [DataAutomationDeveloperAgent] Analyzing Data Automation Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Automation Developer Target',
      );
...
export const dataAutomationDeveloperAgent = Object.freeze(
  new DataAutomationDeveloperAgent(),
);
