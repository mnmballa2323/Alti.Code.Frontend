...
class DataTestingPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataTestingSystem(objective) {
    logger.info(
      `💻 [DataTestingPlannerAgent] Analyzing Data Testing Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Testing Planner Target',
      );
...
export const dataTestingPlannerAgent = Object.freeze(
  new DataTestingPlannerAgent(),
);
