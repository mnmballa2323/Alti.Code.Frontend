...
class DevOpsComplianceEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsComplianceSystem(objective) {
    logger.info(
      `💻 [DevOpsComplianceEngineerAgent] Analyzing DevOps Compliance Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Compliance Engineer Target',
      );
...
export const devOpsComplianceEngineerAgent = Object.freeze(
  new DevOpsComplianceEngineerAgent(),
);
