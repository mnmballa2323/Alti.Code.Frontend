...
class DevOpsGovernanceLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsGovernanceSystem(objective) {
    logger.info(
      `💻 [DevOpsGovernanceLeadAgent] Analyzing DevOps Governance Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Governance Lead Target',
      );
...
export const devOpsGovernanceLeadAgent = Object.freeze(
  new DevOpsGovernanceLeadAgent(),
);
