...
class DataDeploymentArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateDataDeploymentSystem(objective) {
    logger.info(
      `💻 [DataDeploymentArchitectAgent] Analyzing Data Deployment Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Deployment Architect Target',
      );
...
export const dataDeploymentArchitectAgent = Object.freeze(
  new DataDeploymentArchitectAgent(),
);
