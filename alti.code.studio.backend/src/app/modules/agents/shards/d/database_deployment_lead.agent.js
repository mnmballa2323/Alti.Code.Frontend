...
class DatabaseDeploymentLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseDeploymentSystem(objective) {
    logger.info(
      `💻 [DatabaseDeploymentLeadAgent] Analyzing Database Deployment Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Deployment Lead Target',
      );
...
export const databaseDeploymentLeadAgent = Object.freeze(
  new DatabaseDeploymentLeadAgent(),
);
