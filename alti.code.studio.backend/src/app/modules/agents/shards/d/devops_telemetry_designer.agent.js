...
class DevOpsTelemetryDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsTelemetrySystem(objective) {
    logger.info(
      `💻 [DevOpsTelemetryDesignerAgent] Analyzing DevOps Telemetry Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Telemetry Designer Target',
      );
...
export const devOpsTelemetryDesignerAgent = Object.freeze(
  new DevOpsTelemetryDesignerAgent(),
);
