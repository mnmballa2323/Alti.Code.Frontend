...
class DataTelemetryDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateDataTelemetrySystem(objective) {
        logger.info(`💻 [DataTelemetryDeveloperAgent] Analyzing Data Telemetry Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Telemetry Developer Target");
...
export const dataTelemetryDeveloperAgent = Object.freeze(new DataTelemetryDeveloperAgent());
