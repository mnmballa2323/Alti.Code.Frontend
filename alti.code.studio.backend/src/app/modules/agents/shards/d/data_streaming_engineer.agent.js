...
class DataStreamingEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataStreamingSystem(objective) {
        logger.info(`💻 [DataStreamingEngineerAgent] Analyzing Data Streaming Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Streaming Engineer Target");
...
export const dataStreamingEngineerAgent = Object.freeze(new DataStreamingEngineerAgent());
