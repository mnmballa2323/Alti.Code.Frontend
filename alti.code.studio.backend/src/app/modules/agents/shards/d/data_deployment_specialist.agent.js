...
class DataDeploymentSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateDataDeploymentSystem(objective) {
        logger.info(`💻 [DataDeploymentSpecialistAgent] Analyzing Data Deployment Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Deployment Specialist Target");
...
export const dataDeploymentSpecialistAgent = Object.freeze(new DataDeploymentSpecialistAgent());
