...
class DatabaseTelemetryPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseTelemetrySystem(objective) {
        logger.info(`💻 [DatabaseTelemetryPlannerAgent] Analyzing Database Telemetry Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database Telemetry Planner Target");
...
export const databaseTelemetryPlannerAgent = Object.freeze(new DatabaseTelemetryPlannerAgent());
