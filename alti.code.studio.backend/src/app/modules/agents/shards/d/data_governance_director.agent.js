...
class DataGovernanceDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateDataGovernanceSystem(objective) {
        logger.info(`💻 [DataGovernanceDirectorAgent] Analyzing Data Governance Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Governance Director Target");
...
export const dataGovernanceDirectorAgent = Object.freeze(new DataGovernanceDirectorAgent());
