...
class DataProvisioningPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataProvisioningSystem(objective) {
    logger.info(
      `💻 [DataProvisioningPlannerAgent] Analyzing Data Provisioning Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Provisioning Planner Target',
      );
...
export const dataProvisioningPlannerAgent = Object.freeze(
  new DataProvisioningPlannerAgent(),
);
