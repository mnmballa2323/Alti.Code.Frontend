...
class DevSecOpsDataLakePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevSecOpsDataLakeSystem(objective) {
    logger.info(
      `💻 [DevSecOpsDataLakePlannerAgent] Analyzing DevSecOps DataLake Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevSecOps DataLake Planner Target',
      );
...
export const devSecOpsDataLakePlannerAgent = Object.freeze(
  new DevSecOpsDataLakePlannerAgent(),
);
