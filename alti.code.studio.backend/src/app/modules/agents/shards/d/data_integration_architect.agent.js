...
class DataIntegrationArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateDataIntegrationSystem(objective) {
    logger.info(
      `💻 [DataIntegrationArchitectAgent] Analyzing Data Integration Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Integration Architect Target',
      );
...
export const dataIntegrationArchitectAgent = Object.freeze(
  new DataIntegrationArchitectAgent(),
);
