...
class DevSecOpsETLManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevSecOpsETLSystem(objective) {
    logger.info(
      `💻 [DevSecOpsETLManagerAgent] Analyzing DevSecOps ETL Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevSecOps ETL Manager Target',
      );
...
export const devSecOpsETLManagerAgent = Object.freeze(
  new DevSecOpsETLManagerAgent(),
);
