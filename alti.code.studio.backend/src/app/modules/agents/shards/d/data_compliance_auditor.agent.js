...
class DataComplianceAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataComplianceSystem(objective) {
    logger.info(
      `💻 [DataComplianceAuditorAgent] Analyzing Data Compliance Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Compliance Auditor Target',
      );
...
export const dataComplianceAuditorAgent = Object.freeze(
  new DataComplianceAuditorAgent(),
);
