...
class DatabaseMigrationManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseMigrationSystem(objective) {
        logger.info(`💻 [DatabaseMigrationManagerAgent] Analyzing Database Migration Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database Migration Manager Target");
...
export const databaseMigrationManagerAgent = Object.freeze(new DatabaseMigrationManagerAgent());
