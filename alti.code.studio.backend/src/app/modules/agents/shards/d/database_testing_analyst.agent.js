...
class DatabaseTestingAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseTestingSystem(objective) {
        logger.info(`💻 [DatabaseTestingAnalystAgent] Analyzing Database Testing Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database Testing Analyst Target");
...
export const databaseTestingAnalystAgent = Object.freeze(new DatabaseTestingAnalystAgent());
