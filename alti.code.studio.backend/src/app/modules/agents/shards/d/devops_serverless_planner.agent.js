...
class DevOpsServerlessPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsServerlessSystem(objective) {
    logger.info(
      `💻 [DevOpsServerlessPlannerAgent] Analyzing DevOps Serverless Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Serverless Planner Target',
      );
...
export const devOpsServerlessPlannerAgent = Object.freeze(
  new DevOpsServerlessPlannerAgent(),
);
