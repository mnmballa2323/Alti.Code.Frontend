...
class DevOpsCachingConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsCachingSystem(objective) {
    logger.info(
      `💻 [DevOpsCachingConsultantAgent] Analyzing DevOps Caching Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Caching Consultant Target',
      );
...
export const devOpsCachingConsultantAgent = Object.freeze(
  new DevOpsCachingConsultantAgent(),
);
