...
class DatabaseETLPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseETLSystem(objective) {
        logger.info(`💻 [DatabaseETLPlannerAgent] Analyzing Database ETL Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database ETL Planner Target");
...
export const databaseETLPlannerAgent = Object.freeze(new DatabaseETLPlannerAgent());
