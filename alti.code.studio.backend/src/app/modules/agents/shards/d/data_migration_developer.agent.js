...
class DataMigrationDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateDataMigrationSystem(objective) {
    logger.info(
      `💻 [DataMigrationDeveloperAgent] Analyzing Data Migration Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Migration Developer Target',
      );
...
export const dataMigrationDeveloperAgent = Object.freeze(
  new DataMigrationDeveloperAgent(),
);
