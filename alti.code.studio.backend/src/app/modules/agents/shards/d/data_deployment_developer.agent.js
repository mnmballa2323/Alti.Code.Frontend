...
class DataDeploymentDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateDataDeploymentSystem(objective) {
    logger.info(
      `💻 [DataDeploymentDeveloperAgent] Analyzing Data Deployment Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Deployment Developer Target',
      );
...
export const dataDeploymentDeveloperAgent = Object.freeze(
  new DataDeploymentDeveloperAgent(),
);
