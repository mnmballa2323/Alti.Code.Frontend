...
class DevOpsComplianceDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsComplianceSystem(objective) {
    logger.info(
      `💻 [DevOpsComplianceDirectorAgent] Analyzing DevOps Compliance Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Compliance Director Target',
      );
...
export const devOpsComplianceDirectorAgent = Object.freeze(
  new DevOpsComplianceDirectorAgent(),
);
