...
class DataGovernanceConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateDataGovernanceSystem(objective) {
    logger.info(
      `💻 [DataGovernanceConsultantAgent] Analyzing Data Governance Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Governance Consultant Target',
      );
...
export const dataGovernanceConsultantAgent = Object.freeze(
  new DataGovernanceConsultantAgent(),
);
