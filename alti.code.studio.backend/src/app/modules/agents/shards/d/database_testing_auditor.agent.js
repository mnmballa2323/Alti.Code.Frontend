...
class DatabaseTestingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseTestingSystem(objective) {
    logger.info(
      `💻 [DatabaseTestingAuditorAgent] Analyzing Database Testing Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Testing Auditor Target',
      );
...
export const databaseTestingAuditorAgent = Object.freeze(
  new DatabaseTestingAuditorAgent(),
);
