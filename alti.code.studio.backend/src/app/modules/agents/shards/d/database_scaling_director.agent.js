...
class DatabaseScalingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseScalingSystem(objective) {
    logger.info(
      `💻 [DatabaseScalingDirectorAgent] Analyzing Database Scaling Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Scaling Director Target',
      );
...
export const databaseScalingDirectorAgent = Object.freeze(
  new DatabaseScalingDirectorAgent(),
);
