...
class DatabaseAnalyticsAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseAnalyticsSystem(objective) {
    logger.info(
      `💻 [DatabaseAnalyticsAnalystAgent] Analyzing Database Analytics Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Analytics Analyst Target',
      );
...
export const databaseAnalyticsAnalystAgent = Object.freeze(
  new DatabaseAnalyticsAnalystAgent(),
);
