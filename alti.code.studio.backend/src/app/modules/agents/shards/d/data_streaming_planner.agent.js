...
class DataStreamingPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataStreamingSystem(objective) {
        logger.info(`💻 [DataStreamingPlannerAgent] Analyzing Data Streaming Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Streaming Planner Target");
...
export const dataStreamingPlannerAgent = Object.freeze(new DataStreamingPlannerAgent());
