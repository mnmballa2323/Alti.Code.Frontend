...
class DataGovernancePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataGovernanceSystem(objective) {
    logger.info(
      `💻 [DataGovernancePlannerAgent] Analyzing Data Governance Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Governance Planner Target',
      );
...
export const dataGovernancePlannerAgent = Object.freeze(
  new DataGovernancePlannerAgent(),
);
