...
class DatabaseTestingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseTestingSystem(objective) {
    logger.info(
      `💻 [DatabaseTestingTesterAgent] Analyzing Database Testing Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Testing Tester Target',
      );
...
export const databaseTestingTesterAgent = Object.freeze(
  new DatabaseTestingTesterAgent(),
);
