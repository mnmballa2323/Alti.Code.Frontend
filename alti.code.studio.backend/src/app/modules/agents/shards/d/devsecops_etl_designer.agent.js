...
class DevSecOpsETLDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateDevSecOpsETLSystem(objective) {
        logger.info(`💻 [DevSecOpsETLDesignerAgent] Analyzing DevSecOps ETL Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevSecOps ETL Designer Target");
...
export const devSecOpsETLDesignerAgent = Object.freeze(new DevSecOpsETLDesignerAgent());
