...
class DataContainerizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDataContainerizationSystem(objective) {
    logger.info(
      `💻 [DataContainerizationLeadAgent] Analyzing Data Containerization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Containerization Lead Target',
      );
...
export const dataContainerizationLeadAgent = Object.freeze(
  new DataContainerizationLeadAgent(),
);
