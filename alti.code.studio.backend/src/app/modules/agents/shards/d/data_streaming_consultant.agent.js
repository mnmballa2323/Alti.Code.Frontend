...
class DataStreamingConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateDataStreamingSystem(objective) {
    logger.info(
      `💻 [DataStreamingConsultantAgent] Analyzing Data Streaming Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Streaming Consultant Target',
      );
...
export const dataStreamingConsultantAgent = Object.freeze(
  new DataStreamingConsultantAgent(),
);
