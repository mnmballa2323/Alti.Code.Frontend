...
class DataIntegrationDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateDataIntegrationSystem(objective) {
        logger.info(`💻 [DataIntegrationDeveloperAgent] Analyzing Data Integration Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Integration Developer Target");
...
export const dataIntegrationDeveloperAgent = Object.freeze(new DataIntegrationDeveloperAgent());
