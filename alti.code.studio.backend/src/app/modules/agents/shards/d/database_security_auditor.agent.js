...
class DatabaseSecurityAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseSecuritySystem(objective) {
        logger.info(`💻 [DatabaseSecurityAuditorAgent] Analyzing Database Security Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database Security Auditor Target");
...
export const databaseSecurityAuditorAgent = Object.freeze(new DatabaseSecurityAuditorAgent());
