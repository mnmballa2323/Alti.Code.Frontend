...
class DataGovernanceDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataGovernanceSystem(objective) {
    logger.info(
      `💻 [DataGovernanceDesignerAgent] Analyzing Data Governance Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Governance Designer Target',
      );
...
export const dataGovernanceDesignerAgent = Object.freeze(
  new DataGovernanceDesignerAgent(),
);
