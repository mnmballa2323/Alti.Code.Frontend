...
class DatabaseMigrationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseMigrationSystem(objective) {
    logger.info(
      `💻 [DatabaseMigrationPlannerAgent] Analyzing Database Migration Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Migration Planner Target',
      );
...
export const databaseMigrationPlannerAgent = Object.freeze(
  new DatabaseMigrationPlannerAgent(),
);
