...
class DataIntegrationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDataIntegrationSystem(objective) {
    logger.info(
      `💻 [DataIntegrationAnalystAgent] Analyzing Data Integration Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Integration Analyst Target',
      );
...
export const dataIntegrationAnalystAgent = Object.freeze(
  new DataIntegrationAnalystAgent(),
);
