...
class DataProvisioningTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDataProvisioningSystem(objective) {
    logger.info(
      `💻 [DataProvisioningTesterAgent] Analyzing Data Provisioning Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Provisioning Tester Target',
      );
...
export const dataProvisioningTesterAgent = Object.freeze(
  new DataProvisioningTesterAgent(),
);
