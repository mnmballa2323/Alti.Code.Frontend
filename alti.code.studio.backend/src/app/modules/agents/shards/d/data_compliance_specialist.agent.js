...
class DataComplianceSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateDataComplianceSystem(objective) {
    logger.info(
      `💻 [DataComplianceSpecialistAgent] Analyzing Data Compliance Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Compliance Specialist Target',
      );
...
export const dataComplianceSpecialistAgent = Object.freeze(
  new DataComplianceSpecialistAgent(),
);
