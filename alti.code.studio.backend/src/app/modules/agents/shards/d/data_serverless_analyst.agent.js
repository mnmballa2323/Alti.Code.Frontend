...
class DataServerlessAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDataServerlessSystem(objective) {
    logger.info(
      `💻 [DataServerlessAnalystAgent] Analyzing Data Serverless Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Serverless Analyst Target',
      );
...
export const dataServerlessAnalystAgent = Object.freeze(
  new DataServerlessAnalystAgent(),
);
