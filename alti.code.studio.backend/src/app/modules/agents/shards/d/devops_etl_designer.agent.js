...
class DevOpsETLDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsETLSystem(objective) {
        logger.info(`💻 [DevOpsETLDesignerAgent] Analyzing DevOps ETL Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps ETL Designer Target");
...
export const devOpsETLDesignerAgent = Object.freeze(new DevOpsETLDesignerAgent());
