...
class DataSecurityDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateDataSecuritySystem(objective) {
        logger.info(`💻 [DataSecurityDirectorAgent] Analyzing Data Security Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Security Director Target");
...
export const dataSecurityDirectorAgent = Object.freeze(new DataSecurityDirectorAgent());
