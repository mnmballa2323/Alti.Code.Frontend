...
class DevOpsOptimizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsOptimizationSystem(objective) {
    logger.info(
      `💻 [DevOpsOptimizationLeadAgent] Analyzing DevOps Optimization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Optimization Lead Target',
      );
...
export const devOpsOptimizationLeadAgent = Object.freeze(
  new DevOpsOptimizationLeadAgent(),
);
