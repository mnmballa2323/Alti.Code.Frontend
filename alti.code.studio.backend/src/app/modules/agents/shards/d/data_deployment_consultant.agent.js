...
class DataDeploymentConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateDataDeploymentSystem(objective) {
        logger.info(`💻 [DataDeploymentConsultantAgent] Analyzing Data Deployment Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Deployment Consultant Target");
...
export const dataDeploymentConsultantAgent = Object.freeze(new DataDeploymentConsultantAgent());
