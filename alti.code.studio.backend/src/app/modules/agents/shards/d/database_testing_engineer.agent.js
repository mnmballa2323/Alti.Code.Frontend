...
class DatabaseTestingEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseTestingSystem(objective) {
        logger.info(`💻 [DatabaseTestingEngineerAgent] Analyzing Database Testing Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database Testing Engineer Target");
...
export const databaseTestingEngineerAgent = Object.freeze(new DatabaseTestingEngineerAgent());
