...
class DataSecurityDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataSecuritySystem(objective) {
    logger.info(
      `💻 [DataSecurityDesignerAgent] Analyzing Data Security Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Security Designer Target',
      );
...
export const dataSecurityDesignerAgent = Object.freeze(
  new DataSecurityDesignerAgent(),
);
