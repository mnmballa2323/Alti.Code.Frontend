...
class DatabaseProvisioningLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseProvisioningSystem(objective) {
    logger.info(
      `💻 [DatabaseProvisioningLeadAgent] Analyzing Database Provisioning Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Provisioning Lead Target',
      );
...
export const databaseProvisioningLeadAgent = Object.freeze(
  new DatabaseProvisioningLeadAgent(),
);
