...
class DevOpsMigrationManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsMigrationSystem(objective) {
        logger.info(`💻 [DevOpsMigrationManagerAgent] Analyzing DevOps Migration Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Migration Manager Target");
...
export const devOpsMigrationManagerAgent = Object.freeze(new DevOpsMigrationManagerAgent());
