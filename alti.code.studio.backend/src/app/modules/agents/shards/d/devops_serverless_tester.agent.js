...
class DevOpsServerlessTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsServerlessSystem(objective) {
        logger.info(`💻 [DevOpsServerlessTesterAgent] Analyzing DevOps Serverless Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Serverless Tester Target");
...
export const devOpsServerlessTesterAgent = Object.freeze(new DevOpsServerlessTesterAgent());
