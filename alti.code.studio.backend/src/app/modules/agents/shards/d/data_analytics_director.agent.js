...
class DataAnalyticsDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataAnalyticsSystem(objective) {
    logger.info(
      `💻 [DataAnalyticsDirectorAgent] Analyzing Data Analytics Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Analytics Director Target',
      );
...
export const dataAnalyticsDirectorAgent = Object.freeze(
  new DataAnalyticsDirectorAgent(),
);
