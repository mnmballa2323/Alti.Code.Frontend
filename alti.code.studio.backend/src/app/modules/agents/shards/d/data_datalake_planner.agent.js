...
class DataDataLakePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataDataLakeSystem(objective) {
        logger.info(`💻 [DataDataLakePlannerAgent] Analyzing Data DataLake Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data DataLake Planner Target");
...
export const dataDataLakePlannerAgent = Object.freeze(new DataDataLakePlannerAgent());
