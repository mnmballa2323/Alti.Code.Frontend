...
class DataSecurityStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateDataSecuritySystem(objective) {
    logger.info(
      `💻 [DataSecurityStrategistAgent] Analyzing Data Security Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Security Strategist Target',
      );
...
export const dataSecurityStrategistAgent = Object.freeze(
  new DataSecurityStrategistAgent(),
);
