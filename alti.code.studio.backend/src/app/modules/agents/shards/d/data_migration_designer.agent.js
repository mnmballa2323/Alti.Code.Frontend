...
class DataMigrationDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataMigrationSystem(objective) {
        logger.info(`💻 [DataMigrationDesignerAgent] Analyzing Data Migration Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Migration Designer Target");
...
export const dataMigrationDesignerAgent = Object.freeze(new DataMigrationDesignerAgent());
