...
class DataComplianceDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateDataComplianceSystem(objective) {
    logger.info(
      `💻 [DataComplianceDeveloperAgent] Analyzing Data Compliance Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Compliance Developer Target',
      );
...
export const dataComplianceDeveloperAgent = Object.freeze(
  new DataComplianceDeveloperAgent(),
);
