...
class DevOpsGovernanceDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsGovernanceSystem(objective) {
    logger.info(
      `💻 [DevOpsGovernanceDesignerAgent] Analyzing DevOps Governance Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Governance Designer Target',
      );
...
export const devOpsGovernanceDesignerAgent = Object.freeze(
  new DevOpsGovernanceDesignerAgent(),
);
