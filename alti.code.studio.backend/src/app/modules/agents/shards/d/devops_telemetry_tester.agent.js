...
class DevOpsTelemetryTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsTelemetrySystem(objective) {
        logger.info(`💻 [DevOpsTelemetryTesterAgent] Analyzing DevOps Telemetry Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Telemetry Tester Target");
...
export const devOpsTelemetryTesterAgent = Object.freeze(new DevOpsTelemetryTesterAgent());
