...
class DevOpsEngineeringManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsEngineeringSystem(objective) {
    logger.info(
      `💻 [DevOpsEngineeringManagerAgent] Analyzing DevOps Engineering Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Engineering Manager Target',
      );
...
export const devOpsEngineeringManagerAgent = Object.freeze(
  new DevOpsEngineeringManagerAgent(),
);
