...
class DataTestingOrchestratorAgent extends GeminiCliBaseAgent {
    ...
    async generateDataTestingSystem(objective) {
        logger.info(`💻 [DataTestingOrchestratorAgent] Analyzing Data Testing Orchestrator specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Testing Orchestrator Target");
...
export const dataTestingOrchestratorAgent = Object.freeze(new DataTestingOrchestratorAgent());
