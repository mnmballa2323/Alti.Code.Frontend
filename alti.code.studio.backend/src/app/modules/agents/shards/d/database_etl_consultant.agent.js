...
class DatabaseETLConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseETLSystem(objective) {
        logger.info(`💻 [DatabaseETLConsultantAgent] Analyzing Database ETL Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database ETL Consultant Target");
...
export const databaseETLConsultantAgent = Object.freeze(new DatabaseETLConsultantAgent());
