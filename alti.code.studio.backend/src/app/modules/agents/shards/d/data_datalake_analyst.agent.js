...
class DataDataLakeAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDataDataLakeSystem(objective) {
    logger.info(
      `💻 [DataDataLakeAnalystAgent] Analyzing Data DataLake Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data DataLake Analyst Target',
      );
...
export const dataDataLakeAnalystAgent = Object.freeze(
  new DataDataLakeAnalystAgent(),
);
