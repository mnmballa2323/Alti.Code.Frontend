...
class DevSecOpsIntegrationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDevSecOpsIntegrationSystem(objective) {
    logger.info(
      `💻 [DevSecOpsIntegrationLeadAgent] Analyzing DevSecOps Integration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevSecOps Integration Lead Target',
      );
...
export const devSecOpsIntegrationLeadAgent = Object.freeze(
  new DevSecOpsIntegrationLeadAgent(),
);
