...
class DataCachingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataCachingSystem(objective) {
    logger.info(
      `💻 [DataCachingManagerAgent] Analyzing Data Caching Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Caching Manager Target',
      );
...
export const dataCachingManagerAgent = Object.freeze(
  new DataCachingManagerAgent(),
);
