...
class DatabaseDataLakeDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseDataLakeSystem(objective) {
    logger.info(
      `💻 [DatabaseDataLakeDirectorAgent] Analyzing Database DataLake Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database DataLake Director Target',
      );
...
export const databaseDataLakeDirectorAgent = Object.freeze(
  new DatabaseDataLakeDirectorAgent(),
);
