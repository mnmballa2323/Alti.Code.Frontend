...
class DevOpsStreamingPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsStreamingSystem(objective) {
    logger.info(
      `💻 [DevOpsStreamingPlannerAgent] Analyzing DevOps Streaming Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Streaming Planner Target',
      );
...
export const devOpsStreamingPlannerAgent = Object.freeze(
  new DevOpsStreamingPlannerAgent(),
);
