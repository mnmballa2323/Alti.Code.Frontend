...
class DataDeploymentAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDataDeploymentSystem(objective) {
    logger.info(
      `💻 [DataDeploymentAnalystAgent] Analyzing Data Deployment Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Deployment Analyst Target',
      );
...
export const dataDeploymentAnalystAgent = Object.freeze(
  new DataDeploymentAnalystAgent(),
);
