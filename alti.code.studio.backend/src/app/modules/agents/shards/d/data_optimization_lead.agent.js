...
class DataOptimizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDataOptimizationSystem(objective) {
    logger.info(
      `💻 [DataOptimizationLeadAgent] Analyzing Data Optimization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Optimization Lead Target',
      );
...
export const dataOptimizationLeadAgent = Object.freeze(
  new DataOptimizationLeadAgent(),
);
