...
class DevSecOpsETLTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDevSecOpsETLSystem(objective) {
        logger.info(`💻 [DevSecOpsETLTesterAgent] Analyzing DevSecOps ETL Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevSecOps ETL Tester Target");
...
export const devSecOpsETLTesterAgent = Object.freeze(new DevSecOpsETLTesterAgent());
