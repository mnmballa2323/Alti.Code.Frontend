...
class DataObservabilityPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataObservabilitySystem(objective) {
    logger.info(
      `💻 [DataObservabilityPlannerAgent] Analyzing Data Observability Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Observability Planner Target',
      );
...
export const dataObservabilityPlannerAgent = Object.freeze(
  new DataObservabilityPlannerAgent(),
);
