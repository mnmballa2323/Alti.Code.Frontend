...
class DatabaseComplianceLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseComplianceSystem(objective) {
    logger.info(
      `💻 [DatabaseComplianceLeadAgent] Analyzing Database Compliance Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Compliance Lead Target',
      );
...
export const databaseComplianceLeadAgent = Object.freeze(
  new DatabaseComplianceLeadAgent(),
);
