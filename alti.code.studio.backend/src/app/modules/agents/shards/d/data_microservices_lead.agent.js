...
class DataMicroservicesLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDataMicroservicesSystem(objective) {
    logger.info(
      `💻 [DataMicroservicesLeadAgent] Analyzing Data Microservices Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Microservices Lead Target',
      );
...
export const dataMicroservicesLeadAgent = Object.freeze(
  new DataMicroservicesLeadAgent(),
);
