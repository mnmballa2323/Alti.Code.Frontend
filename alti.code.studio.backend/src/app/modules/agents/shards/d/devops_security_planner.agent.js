...
class DevOpsSecurityPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsSecuritySystem(objective) {
    logger.info(
      `💻 [DevOpsSecurityPlannerAgent] Analyzing DevOps Security Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Security Planner Target',
      );
...
export const devOpsSecurityPlannerAgent = Object.freeze(
  new DevOpsSecurityPlannerAgent(),
);
