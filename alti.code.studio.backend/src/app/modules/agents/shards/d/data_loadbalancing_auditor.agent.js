...
class DataLoadBalancingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataLoadBalancingSystem(objective) {
    logger.info(
      `💻 [DataLoadBalancingAuditorAgent] Analyzing Data LoadBalancing Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data LoadBalancing Auditor Target',
      );
...
export const dataLoadBalancingAuditorAgent = Object.freeze(
  new DataLoadBalancingAuditorAgent(),
);
