...
class DataTelemetryConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateDataTelemetrySystem(objective) {
    logger.info(
      `💻 [DataTelemetryConsultantAgent] Analyzing Data Telemetry Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Telemetry Consultant Target',
      );
...
export const dataTelemetryConsultantAgent = Object.freeze(
  new DataTelemetryConsultantAgent(),
);
