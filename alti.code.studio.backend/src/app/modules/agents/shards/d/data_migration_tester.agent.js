...
class DataMigrationTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDataMigrationSystem(objective) {
        logger.info(`💻 [DataMigrationTesterAgent] Analyzing Data Migration Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Migration Tester Target");
...
export const dataMigrationTesterAgent = Object.freeze(new DataMigrationTesterAgent());
