...
class DevSecOpsTestingManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateDevSecOpsTestingSystem(objective) {
        logger.info(`💻 [DevSecOpsTestingManagerAgent] Analyzing DevSecOps Testing Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevSecOps Testing Manager Target");
...
export const devSecOpsTestingManagerAgent = Object.freeze(new DevSecOpsTestingManagerAgent());
