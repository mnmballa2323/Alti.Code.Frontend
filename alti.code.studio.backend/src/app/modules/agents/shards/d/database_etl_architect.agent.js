...
class DatabaseETLArchitectAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseETLSystem(objective) {
        logger.info(`💻 [DatabaseETLArchitectAgent] Analyzing Database ETL Architect specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database ETL Architect Target");
...
export const databaseETLArchitectAgent = Object.freeze(new DatabaseETLArchitectAgent());
