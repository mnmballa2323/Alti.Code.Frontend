...
class DevOpsVirtualizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsVirtualizationSystem(objective) {
    logger.info(
      `💻 [DevOpsVirtualizationLeadAgent] Analyzing DevOps Virtualization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Virtualization Lead Target',
      );
...
export const devOpsVirtualizationLeadAgent = Object.freeze(
  new DevOpsVirtualizationLeadAgent(),
);
