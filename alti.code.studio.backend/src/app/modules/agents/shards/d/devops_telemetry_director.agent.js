...
class DevOpsTelemetryDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsTelemetrySystem(objective) {
        logger.info(`💻 [DevOpsTelemetryDirectorAgent] Analyzing DevOps Telemetry Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Telemetry Director Target");
...
export const devOpsTelemetryDirectorAgent = Object.freeze(new DevOpsTelemetryDirectorAgent());
