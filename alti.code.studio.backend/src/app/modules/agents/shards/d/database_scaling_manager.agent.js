...
class DatabaseScalingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseScalingSystem(objective) {
    logger.info(
      `💻 [DatabaseScalingManagerAgent] Analyzing Database Scaling Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Scaling Manager Target',
      );
...
export const databaseScalingManagerAgent = Object.freeze(
  new DatabaseScalingManagerAgent(),
);
