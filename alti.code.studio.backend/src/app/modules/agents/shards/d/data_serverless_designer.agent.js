...
class DataServerlessDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataServerlessSystem(objective) {
    logger.info(
      `💻 [DataServerlessDesignerAgent] Analyzing Data Serverless Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Serverless Designer Target',
      );
...
export const dataServerlessDesignerAgent = Object.freeze(
  new DataServerlessDesignerAgent(),
);
