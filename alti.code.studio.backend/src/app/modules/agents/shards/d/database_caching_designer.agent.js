...
class DatabaseCachingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseCachingSystem(objective) {
    logger.info(
      `💻 [DatabaseCachingDesignerAgent] Analyzing Database Caching Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Caching Designer Target',
      );
...
export const databaseCachingDesignerAgent = Object.freeze(
  new DatabaseCachingDesignerAgent(),
);
