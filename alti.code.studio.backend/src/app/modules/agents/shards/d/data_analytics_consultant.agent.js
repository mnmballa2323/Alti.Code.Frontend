...
class DataAnalyticsConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateDataAnalyticsSystem(objective) {
    logger.info(
      `💻 [DataAnalyticsConsultantAgent] Analyzing Data Analytics Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Analytics Consultant Target',
      );
...
export const dataAnalyticsConsultantAgent = Object.freeze(
  new DataAnalyticsConsultantAgent(),
);
