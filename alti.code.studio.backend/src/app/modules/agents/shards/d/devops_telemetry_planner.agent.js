...
class DevOpsTelemetryPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsTelemetrySystem(objective) {
    logger.info(
      `💻 [DevOpsTelemetryPlannerAgent] Analyzing DevOps Telemetry Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Telemetry Planner Target',
      );
...
export const devOpsTelemetryPlannerAgent = Object.freeze(
  new DevOpsTelemetryPlannerAgent(),
);
