...
class DevOpsEngineeringLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsEngineeringSystem(objective) {
    logger.info(
      `💻 [DevOpsEngineeringLeadAgent] Analyzing DevOps Engineering Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Engineering Lead Target',
      );
...
export const devOpsEngineeringLeadAgent = Object.freeze(
  new DevOpsEngineeringLeadAgent(),
);
