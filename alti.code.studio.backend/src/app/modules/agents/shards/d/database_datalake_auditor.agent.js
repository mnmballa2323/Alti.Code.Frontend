...
class DatabaseDataLakeAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseDataLakeSystem(objective) {
    logger.info(
      `💻 [DatabaseDataLakeAuditorAgent] Analyzing Database DataLake Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database DataLake Auditor Target',
      );
...
export const databaseDataLakeAuditorAgent = Object.freeze(
  new DatabaseDataLakeAuditorAgent(),
);
