...
class DataProvisioningManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataProvisioningSystem(objective) {
    logger.info(
      `💻 [DataProvisioningManagerAgent] Analyzing Data Provisioning Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Provisioning Manager Target',
      );
...
export const dataProvisioningManagerAgent = Object.freeze(
  new DataProvisioningManagerAgent(),
);
