...
class DevOpsDataWarehouseLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsDataWarehouseSystem(objective) {
    logger.info(
      `💻 [DevOpsDataWarehouseLeadAgent] Analyzing DevOps DataWarehouse Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps DataWarehouse Lead Target',
      );
...
export const devOpsDataWarehouseLeadAgent = Object.freeze(
  new DevOpsDataWarehouseLeadAgent(),
);
