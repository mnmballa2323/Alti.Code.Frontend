...
class DataCachingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDataCachingSystem(objective) {
    logger.info(
      `💻 [DataCachingTesterAgent] Analyzing Data Caching Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Caching Tester Target',
      );
...
export const dataCachingTesterAgent = Object.freeze(
  new DataCachingTesterAgent(),
);
