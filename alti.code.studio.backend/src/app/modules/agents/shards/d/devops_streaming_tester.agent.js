...
class DevOpsStreamingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsStreamingSystem(objective) {
    logger.info(
      `💻 [DevOpsStreamingTesterAgent] Analyzing DevOps Streaming Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Streaming Tester Target',
      );
...
export const devOpsStreamingTesterAgent = Object.freeze(
  new DevOpsStreamingTesterAgent(),
);
