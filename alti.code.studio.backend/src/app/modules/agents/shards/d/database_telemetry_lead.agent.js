...
class DatabaseTelemetryLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseTelemetrySystem(objective) {
    logger.info(
      `💻 [DatabaseTelemetryLeadAgent] Analyzing Database Telemetry Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Telemetry Lead Target',
      );
...
export const databaseTelemetryLeadAgent = Object.freeze(
  new DatabaseTelemetryLeadAgent(),
);
