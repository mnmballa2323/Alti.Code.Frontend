...
class DevOpsDeploymentDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsDeploymentSystem(objective) {
    logger.info(
      `💻 [DevOpsDeploymentDesignerAgent] Analyzing DevOps Deployment Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Deployment Designer Target',
      );
...
export const devOpsDeploymentDesignerAgent = Object.freeze(
  new DevOpsDeploymentDesignerAgent(),
);
