...
class DatabaseDeploymentTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseDeploymentSystem(objective) {
        logger.info(`💻 [DatabaseDeploymentTesterAgent] Analyzing Database Deployment Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database Deployment Tester Target");
...
export const databaseDeploymentTesterAgent = Object.freeze(new DatabaseDeploymentTesterAgent());
