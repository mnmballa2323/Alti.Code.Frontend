...
class DevOpsCachingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsCachingSystem(objective) {
    logger.info(
      `💻 [DevOpsCachingTesterAgent] Analyzing DevOps Caching Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Caching Tester Target',
      );
...
export const devOpsCachingTesterAgent = Object.freeze(
  new DevOpsCachingTesterAgent(),
);
