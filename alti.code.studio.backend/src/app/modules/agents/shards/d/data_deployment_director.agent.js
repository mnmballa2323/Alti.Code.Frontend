...
class DataDeploymentDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateDataDeploymentSystem(objective) {
        logger.info(`💻 [DataDeploymentDirectorAgent] Analyzing Data Deployment Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Deployment Director Target");
...
export const dataDeploymentDirectorAgent = Object.freeze(new DataDeploymentDirectorAgent());
