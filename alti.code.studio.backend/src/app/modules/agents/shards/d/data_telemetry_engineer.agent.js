...
class DataTelemetryEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataTelemetrySystem(objective) {
    logger.info(
      `💻 [DataTelemetryEngineerAgent] Analyzing Data Telemetry Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Telemetry Engineer Target',
      );
...
export const dataTelemetryEngineerAgent = Object.freeze(
  new DataTelemetryEngineerAgent(),
);
