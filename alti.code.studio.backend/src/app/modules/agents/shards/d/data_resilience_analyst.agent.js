...
class DataResilienceAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDataResilienceSystem(objective) {
    logger.info(
      `💻 [DataResilienceAnalystAgent] Analyzing Data Resilience Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Resilience Analyst Target',
      );
...
export const dataResilienceAnalystAgent = Object.freeze(
  new DataResilienceAnalystAgent(),
);
