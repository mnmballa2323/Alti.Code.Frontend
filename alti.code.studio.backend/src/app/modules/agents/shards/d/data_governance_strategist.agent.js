...
class DataGovernanceStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateDataGovernanceSystem(objective) {
    logger.info(
      `💻 [DataGovernanceStrategistAgent] Analyzing Data Governance Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Governance Strategist Target',
      );
...
export const dataGovernanceStrategistAgent = Object.freeze(
  new DataGovernanceStrategistAgent(),
);
