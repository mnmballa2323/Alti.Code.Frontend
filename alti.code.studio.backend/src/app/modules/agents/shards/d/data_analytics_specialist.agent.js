...
class DataAnalyticsSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateDataAnalyticsSystem(objective) {
    logger.info(
      `💻 [DataAnalyticsSpecialistAgent] Analyzing Data Analytics Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Analytics Specialist Target',
      );
...
export const dataAnalyticsSpecialistAgent = Object.freeze(
  new DataAnalyticsSpecialistAgent(),
);
