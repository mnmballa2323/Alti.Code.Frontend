...
class DataIntegrationDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataIntegrationSystem(objective) {
    logger.info(
      `💻 [DataIntegrationDirectorAgent] Analyzing Data Integration Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Integration Director Target',
      );
...
export const dataIntegrationDirectorAgent = Object.freeze(
  new DataIntegrationDirectorAgent(),
);
