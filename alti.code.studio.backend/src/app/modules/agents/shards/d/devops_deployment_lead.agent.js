...
class DevOpsDeploymentLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsDeploymentSystem(objective) {
    logger.info(
      `💻 [DevOpsDeploymentLeadAgent] Analyzing DevOps Deployment Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Deployment Lead Target',
      );
...
export const devOpsDeploymentLeadAgent = Object.freeze(
  new DevOpsDeploymentLeadAgent(),
);
