...
class DevOpsTelemetryAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsTelemetrySystem(objective) {
    logger.info(
      `💻 [DevOpsTelemetryAnalystAgent] Analyzing DevOps Telemetry Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Telemetry Analyst Target',
      );
...
export const devOpsTelemetryAnalystAgent = Object.freeze(
  new DevOpsTelemetryAnalystAgent(),
);
