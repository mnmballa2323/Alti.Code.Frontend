...
class DataSecurityManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataSecuritySystem(objective) {
    logger.info(
      `💻 [DataSecurityManagerAgent] Analyzing Data Security Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Security Manager Target',
      );
...
export const dataSecurityManagerAgent = Object.freeze(
  new DataSecurityManagerAgent(),
);
