...
class DatabaseSecurityEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseSecuritySystem(objective) {
        logger.info(`💻 [DatabaseSecurityEngineerAgent] Analyzing Database Security Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database Security Engineer Target");
...
export const databaseSecurityEngineerAgent = Object.freeze(new DatabaseSecurityEngineerAgent());
