...
class DataETLStrategistAgent extends GeminiCliBaseAgent {
    ...
    async generateDataETLSystem(objective) {
        logger.info(`💻 [DataETLStrategistAgent] Analyzing Data ETL Strategist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data ETL Strategist Target");
...
export const dataETLStrategistAgent = Object.freeze(new DataETLStrategistAgent());
