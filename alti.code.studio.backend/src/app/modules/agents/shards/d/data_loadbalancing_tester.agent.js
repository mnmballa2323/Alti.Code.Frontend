...
class DataLoadBalancingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDataLoadBalancingSystem(objective) {
    logger.info(
      `💻 [DataLoadBalancingTesterAgent] Analyzing Data LoadBalancing Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data LoadBalancing Tester Target',
      );
...
export const dataLoadBalancingTesterAgent = Object.freeze(
  new DataLoadBalancingTesterAgent(),
);
