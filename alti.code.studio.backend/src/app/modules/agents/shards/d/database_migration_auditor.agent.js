...
class DatabaseMigrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseMigrationSystem(objective) {
    logger.info(
      `💻 [DatabaseMigrationAuditorAgent] Analyzing Database Migration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Migration Auditor Target',
      );
...
export const databaseMigrationAuditorAgent = Object.freeze(
  new DatabaseMigrationAuditorAgent(),
);
