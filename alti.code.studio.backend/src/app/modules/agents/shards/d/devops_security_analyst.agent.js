...
class DevOpsSecurityAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsSecuritySystem(objective) {
    logger.info(
      `💻 [DevOpsSecurityAnalystAgent] Analyzing DevOps Security Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Security Analyst Target',
      );
...
export const devOpsSecurityAnalystAgent = Object.freeze(
  new DevOpsSecurityAnalystAgent(),
);
