...
class DataVirtualizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDataVirtualizationSystem(objective) {
    logger.info(
      `💻 [DataVirtualizationLeadAgent] Analyzing Data Virtualization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Virtualization Lead Target',
      );
...
export const dataVirtualizationLeadAgent = Object.freeze(
  new DataVirtualizationLeadAgent(),
);
