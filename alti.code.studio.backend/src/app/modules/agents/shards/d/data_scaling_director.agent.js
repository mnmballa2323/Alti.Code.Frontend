...
class DataScalingDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateDataScalingSystem(objective) {
        logger.info(`💻 [DataScalingDirectorAgent] Analyzing Data Scaling Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Scaling Director Target");
...
export const dataScalingDirectorAgent = Object.freeze(new DataScalingDirectorAgent());
