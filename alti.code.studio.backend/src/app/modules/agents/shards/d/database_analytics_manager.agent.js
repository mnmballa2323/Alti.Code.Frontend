...
class DatabaseAnalyticsManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseAnalyticsSystem(objective) {
    logger.info(
      `💻 [DatabaseAnalyticsManagerAgent] Analyzing Database Analytics Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Analytics Manager Target',
      );
...
export const databaseAnalyticsManagerAgent = Object.freeze(
  new DatabaseAnalyticsManagerAgent(),
);
