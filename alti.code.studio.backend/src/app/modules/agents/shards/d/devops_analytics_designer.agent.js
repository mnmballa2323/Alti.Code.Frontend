...
class DevOpsAnalyticsDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsAnalyticsSystem(objective) {
    logger.info(
      `💻 [DevOpsAnalyticsDesignerAgent] Analyzing DevOps Analytics Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Analytics Designer Target',
      );
...
export const devOpsAnalyticsDesignerAgent = Object.freeze(
  new DevOpsAnalyticsDesignerAgent(),
);
