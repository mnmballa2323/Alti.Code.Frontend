...
class DatabaseScalingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseScalingSystem(objective) {
    logger.info(
      `💻 [DatabaseScalingTesterAgent] Analyzing Database Scaling Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Scaling Tester Target',
      );
...
export const databaseScalingTesterAgent = Object.freeze(
  new DatabaseScalingTesterAgent(),
);
