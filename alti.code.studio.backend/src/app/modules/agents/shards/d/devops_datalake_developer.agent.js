...
class DevOpsDataLakeDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsDataLakeSystem(objective) {
        logger.info(`💻 [DevOpsDataLakeDeveloperAgent] Analyzing DevOps DataLake Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps DataLake Developer Target");
...
export const devOpsDataLakeDeveloperAgent = Object.freeze(new DevOpsDataLakeDeveloperAgent());
