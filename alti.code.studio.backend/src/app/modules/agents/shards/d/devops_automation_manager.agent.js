...
class DevOpsAutomationManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsAutomationSystem(objective) {
        logger.info(`💻 [DevOpsAutomationManagerAgent] Analyzing DevOps Automation Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Automation Manager Target");
...
export const devOpsAutomationManagerAgent = Object.freeze(new DevOpsAutomationManagerAgent());
