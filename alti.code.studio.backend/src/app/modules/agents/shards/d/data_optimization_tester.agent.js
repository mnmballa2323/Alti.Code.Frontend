...
class DataOptimizationTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDataOptimizationSystem(objective) {
        logger.info(`💻 [DataOptimizationTesterAgent] Analyzing Data Optimization Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Optimization Tester Target");
...
export const dataOptimizationTesterAgent = Object.freeze(new DataOptimizationTesterAgent());
