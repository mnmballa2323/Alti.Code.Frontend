...
class DevOpsMigrationArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsMigrationSystem(objective) {
    logger.info(
      `💻 [DevOpsMigrationArchitectAgent] Analyzing DevOps Migration Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Migration Architect Target',
      );
...
export const devOpsMigrationArchitectAgent = Object.freeze(
  new DevOpsMigrationArchitectAgent(),
);
