...
class DatabaseAnalyticsTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseAnalyticsSystem(objective) {
    logger.info(
      `💻 [DatabaseAnalyticsTesterAgent] Analyzing Database Analytics Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Analytics Tester Target',
      );
...
export const databaseAnalyticsTesterAgent = Object.freeze(
  new DatabaseAnalyticsTesterAgent(),
);
