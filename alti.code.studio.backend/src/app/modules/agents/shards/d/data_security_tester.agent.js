...
class DataSecurityTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDataSecuritySystem(objective) {
    logger.info(
      `💻 [DataSecurityTesterAgent] Analyzing Data Security Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Security Tester Target',
      );
...
export const dataSecurityTesterAgent = Object.freeze(
  new DataSecurityTesterAgent(),
);
