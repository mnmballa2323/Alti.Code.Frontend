...
class DataTelemetryDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataTelemetrySystem(objective) {
    logger.info(
      `💻 [DataTelemetryDesignerAgent] Analyzing Data Telemetry Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Telemetry Designer Target',
      );
...
export const dataTelemetryDesignerAgent = Object.freeze(
  new DataTelemetryDesignerAgent(),
);
