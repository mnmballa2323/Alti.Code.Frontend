...
class DataTestingTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDataTestingSystem(objective) {
        logger.info(`💻 [DataTestingTesterAgent] Analyzing Data Testing Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Testing Tester Target");
...
export const dataTestingTesterAgent = Object.freeze(new DataTestingTesterAgent());
