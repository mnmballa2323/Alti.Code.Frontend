...
class DevOpsDataLakeLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsDataLakeSystem(objective) {
    logger.info(
      `💻 [DevOpsDataLakeLeadAgent] Analyzing DevOps DataLake Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps DataLake Lead Target',
      );
...
export const devOpsDataLakeLeadAgent = Object.freeze(
  new DevOpsDataLakeLeadAgent(),
);
