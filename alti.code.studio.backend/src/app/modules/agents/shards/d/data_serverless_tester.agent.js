...
class DataServerlessTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDataServerlessSystem(objective) {
        logger.info(`💻 [DataServerlessTesterAgent] Analyzing Data Serverless Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Serverless Tester Target");
...
export const dataServerlessTesterAgent = Object.freeze(new DataServerlessTesterAgent());
