...
class DevSecOpsEngineeringLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDevSecOpsEngineeringSystem(objective) {
    logger.info(
      `💻 [DevSecOpsEngineeringLeadAgent] Analyzing DevSecOps Engineering Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevSecOps Engineering Lead Target',
      );
...
export const devSecOpsEngineeringLeadAgent = Object.freeze(
  new DevSecOpsEngineeringLeadAgent(),
);
