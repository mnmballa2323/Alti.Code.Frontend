...
class DataDataLakeTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDataDataLakeSystem(objective) {
    logger.info(
      `💻 [DataDataLakeTesterAgent] Analyzing Data DataLake Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data DataLake Tester Target',
      );
...
export const dataDataLakeTesterAgent = Object.freeze(
  new DataDataLakeTesterAgent(),
);
