...
class DataAnalyticsPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataAnalyticsSystem(objective) {
    logger.info(
      `💻 [DataAnalyticsPlannerAgent] Analyzing Data Analytics Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Analytics Planner Target',
      );
...
export const dataAnalyticsPlannerAgent = Object.freeze(
  new DataAnalyticsPlannerAgent(),
);
