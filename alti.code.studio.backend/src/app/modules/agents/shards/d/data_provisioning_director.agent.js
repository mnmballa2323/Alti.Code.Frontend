...
class DataProvisioningDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataProvisioningSystem(objective) {
    logger.info(
      `💻 [DataProvisioningDirectorAgent] Analyzing Data Provisioning Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Provisioning Director Target',
      );
...
export const dataProvisioningDirectorAgent = Object.freeze(
  new DataProvisioningDirectorAgent(),
);
