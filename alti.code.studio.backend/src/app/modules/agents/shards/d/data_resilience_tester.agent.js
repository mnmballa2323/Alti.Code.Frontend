...
class DataResilienceTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDataResilienceSystem(objective) {
        logger.info(`💻 [DataResilienceTesterAgent] Analyzing Data Resilience Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Resilience Tester Target");
...
export const dataResilienceTesterAgent = Object.freeze(new DataResilienceTesterAgent());
