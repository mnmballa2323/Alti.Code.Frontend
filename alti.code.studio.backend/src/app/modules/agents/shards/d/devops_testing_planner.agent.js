...
class DevOpsTestingPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsTestingSystem(objective) {
    logger.info(
      `💻 [DevOpsTestingPlannerAgent] Analyzing DevOps Testing Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Testing Planner Target',
      );
...
export const devOpsTestingPlannerAgent = Object.freeze(
  new DevOpsTestingPlannerAgent(),
);
