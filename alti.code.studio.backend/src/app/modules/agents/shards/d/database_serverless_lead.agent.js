...
class DatabaseServerlessLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseServerlessSystem(objective) {
    logger.info(
      `💻 [DatabaseServerlessLeadAgent] Analyzing Database Serverless Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Serverless Lead Target',
      );
...
export const databaseServerlessLeadAgent = Object.freeze(
  new DatabaseServerlessLeadAgent(),
);
