...
class DevOpsETLEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsETLSystem(objective) {
        logger.info(`💻 [DevOpsETLEngineerAgent] Analyzing DevOps ETL Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps ETL Engineer Target");
...
export const devOpsETLEngineerAgent = Object.freeze(new DevOpsETLEngineerAgent());
