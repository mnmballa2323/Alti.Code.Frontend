...
class DevOpsCachingEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsCachingSystem(objective) {
        logger.info(`💻 [DevOpsCachingEngineerAgent] Analyzing DevOps Caching Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Caching Engineer Target");
...
export const devOpsCachingEngineerAgent = Object.freeze(new DevOpsCachingEngineerAgent());
