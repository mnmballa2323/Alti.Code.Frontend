...
class DatabaseDataLakeLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseDataLakeSystem(objective) {
    logger.info(
      `💻 [DatabaseDataLakeLeadAgent] Analyzing Database DataLake Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database DataLake Lead Target',
      );
...
export const databaseDataLakeLeadAgent = Object.freeze(
  new DatabaseDataLakeLeadAgent(),
);
