...
class DataObservabilityManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataObservabilitySystem(objective) {
    logger.info(
      `💻 [DataObservabilityManagerAgent] Analyzing Data Observability Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Observability Manager Target',
      );
...
export const dataObservabilityManagerAgent = Object.freeze(
  new DataObservabilityManagerAgent(),
);
