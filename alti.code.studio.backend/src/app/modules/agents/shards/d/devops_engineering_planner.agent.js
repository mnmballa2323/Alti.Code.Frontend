...
class DevOpsEngineeringPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsEngineeringSystem(objective) {
    logger.info(
      `💻 [DevOpsEngineeringPlannerAgent] Analyzing DevOps Engineering Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Engineering Planner Target',
      );
...
export const devOpsEngineeringPlannerAgent = Object.freeze(
  new DevOpsEngineeringPlannerAgent(),
);
