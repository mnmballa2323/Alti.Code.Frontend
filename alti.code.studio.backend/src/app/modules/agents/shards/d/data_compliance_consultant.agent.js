...
class DataComplianceConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateDataComplianceSystem(objective) {
        logger.info(`💻 [DataComplianceConsultantAgent] Analyzing Data Compliance Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Compliance Consultant Target");
...
export const dataComplianceConsultantAgent = Object.freeze(new DataComplianceConsultantAgent());
