...
class DatabaseETLAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseETLSystem(objective) {
    logger.info(
      `💻 [DatabaseETLAuditorAgent] Analyzing Database ETL Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database ETL Auditor Target',
      );
...
export const databaseETLAuditorAgent = Object.freeze(
  new DatabaseETLAuditorAgent(),
);
