...
class DataObservabilityAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateDataObservabilitySystem(objective) {
        logger.info(`💻 [DataObservabilityAuditorAgent] Analyzing Data Observability Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Observability Auditor Target");
...
export const dataObservabilityAuditorAgent = Object.freeze(new DataObservabilityAuditorAgent());
