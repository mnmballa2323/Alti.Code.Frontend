...
class DataServerlessLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDataServerlessSystem(objective) {
    logger.info(
      `💻 [DataServerlessLeadAgent] Analyzing Data Serverless Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Serverless Lead Target',
      );
...
export const dataServerlessLeadAgent = Object.freeze(
  new DataServerlessLeadAgent(),
);
