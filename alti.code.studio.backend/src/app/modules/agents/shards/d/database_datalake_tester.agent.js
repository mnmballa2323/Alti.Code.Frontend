...
class DatabaseDataLakeTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseDataLakeSystem(objective) {
    logger.info(
      `💻 [DatabaseDataLakeTesterAgent] Analyzing Database DataLake Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database DataLake Tester Target',
      );
...
export const databaseDataLakeTesterAgent = Object.freeze(
  new DatabaseDataLakeTesterAgent(),
);
