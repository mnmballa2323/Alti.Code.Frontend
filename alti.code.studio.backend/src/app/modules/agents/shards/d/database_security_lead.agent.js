...
class DatabaseSecurityLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseSecuritySystem(objective) {
    logger.info(
      `💻 [DatabaseSecurityLeadAgent] Analyzing Database Security Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Security Lead Target',
      );
...
export const databaseSecurityLeadAgent = Object.freeze(
  new DatabaseSecurityLeadAgent(),
);
