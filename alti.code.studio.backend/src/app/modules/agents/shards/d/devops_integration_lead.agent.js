...
class DevOpsIntegrationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsIntegrationSystem(objective) {
    logger.info(
      `💻 [DevOpsIntegrationLeadAgent] Analyzing DevOps Integration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Integration Lead Target',
      );
...
export const devOpsIntegrationLeadAgent = Object.freeze(
  new DevOpsIntegrationLeadAgent(),
);
