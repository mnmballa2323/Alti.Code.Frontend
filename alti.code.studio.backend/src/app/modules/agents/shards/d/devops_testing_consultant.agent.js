...
class DevOpsTestingConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsTestingSystem(objective) {
        logger.info(`💻 [DevOpsTestingConsultantAgent] Analyzing DevOps Testing Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Testing Consultant Target");
...
export const devOpsTestingConsultantAgent = Object.freeze(new DevOpsTestingConsultantAgent());
