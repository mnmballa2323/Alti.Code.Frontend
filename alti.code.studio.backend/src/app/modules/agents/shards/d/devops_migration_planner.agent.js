...
class DevOpsMigrationPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsMigrationSystem(objective) {
        logger.info(`💻 [DevOpsMigrationPlannerAgent] Analyzing DevOps Migration Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Migration Planner Target");
...
export const devOpsMigrationPlannerAgent = Object.freeze(new DevOpsMigrationPlannerAgent());
