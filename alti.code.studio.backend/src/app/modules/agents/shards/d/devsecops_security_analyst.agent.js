...
class DevSecOpsSecurityAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDevSecOpsSecuritySystem(objective) {
    logger.info(
      `💻 [DevSecOpsSecurityAnalystAgent] Analyzing DevSecOps Security Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevSecOps Security Analyst Target',
      );
...
export const devSecOpsSecurityAnalystAgent = Object.freeze(
  new DevSecOpsSecurityAnalystAgent(),
);
