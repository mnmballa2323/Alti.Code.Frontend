...
class DatabaseTestingPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseTestingSystem(objective) {
        logger.info(`💻 [DatabaseTestingPlannerAgent] Analyzing Database Testing Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database Testing Planner Target");
...
export const databaseTestingPlannerAgent = Object.freeze(new DatabaseTestingPlannerAgent());
