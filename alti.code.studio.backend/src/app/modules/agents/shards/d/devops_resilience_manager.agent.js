...
class DevOpsResilienceManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsResilienceSystem(objective) {
    logger.info(
      `💻 [DevOpsResilienceManagerAgent] Analyzing DevOps Resilience Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Resilience Manager Target',
      );
...
export const devOpsResilienceManagerAgent = Object.freeze(
  new DevOpsResilienceManagerAgent(),
);
