...
class DataStreamingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDataStreamingSystem(objective) {
    logger.info(
      `💻 [DataStreamingTesterAgent] Analyzing Data Streaming Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Streaming Tester Target',
      );
...
export const dataStreamingTesterAgent = Object.freeze(
  new DataStreamingTesterAgent(),
);
