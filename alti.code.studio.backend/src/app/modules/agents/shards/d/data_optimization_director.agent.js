...
class DataOptimizationDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataOptimizationSystem(objective) {
    logger.info(
      `💻 [DataOptimizationDirectorAgent] Analyzing Data Optimization Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Optimization Director Target',
      );
...
export const dataOptimizationDirectorAgent = Object.freeze(
  new DataOptimizationDirectorAgent(),
);
