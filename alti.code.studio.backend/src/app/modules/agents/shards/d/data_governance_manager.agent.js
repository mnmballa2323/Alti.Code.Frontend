...
class DataGovernanceManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataGovernanceSystem(objective) {
    logger.info(
      `💻 [DataGovernanceManagerAgent] Analyzing Data Governance Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Governance Manager Target',
      );
...
export const dataGovernanceManagerAgent = Object.freeze(
  new DataGovernanceManagerAgent(),
);
