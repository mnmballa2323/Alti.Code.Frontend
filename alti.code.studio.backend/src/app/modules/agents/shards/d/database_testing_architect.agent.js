...
class DatabaseTestingArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseTestingSystem(objective) {
    logger.info(
      `💻 [DatabaseTestingArchitectAgent] Analyzing Database Testing Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Testing Architect Target',
      );
...
export const databaseTestingArchitectAgent = Object.freeze(
  new DatabaseTestingArchitectAgent(),
);
