...
class DevOpsDeploymentPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsDeploymentSystem(objective) {
    logger.info(
      `💻 [DevOpsDeploymentPlannerAgent] Analyzing DevOps Deployment Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Deployment Planner Target',
      );
...
export const devOpsDeploymentPlannerAgent = Object.freeze(
  new DevOpsDeploymentPlannerAgent(),
);
