...
class DevOpsAnalyticsLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsAnalyticsSystem(objective) {
    logger.info(
      `💻 [DevOpsAnalyticsLeadAgent] Analyzing DevOps Analytics Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Analytics Lead Target',
      );
...
export const devOpsAnalyticsLeadAgent = Object.freeze(
  new DevOpsAnalyticsLeadAgent(),
);
