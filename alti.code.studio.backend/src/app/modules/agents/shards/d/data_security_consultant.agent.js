...
class DataSecurityConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateDataSecuritySystem(objective) {
        logger.info(`💻 [DataSecurityConsultantAgent] Analyzing Data Security Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Security Consultant Target");
...
export const dataSecurityConsultantAgent = Object.freeze(new DataSecurityConsultantAgent());
