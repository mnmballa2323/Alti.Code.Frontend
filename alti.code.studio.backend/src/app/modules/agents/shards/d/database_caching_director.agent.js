...
class DatabaseCachingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseCachingSystem(objective) {
    logger.info(
      `💻 [DatabaseCachingDirectorAgent] Analyzing Database Caching Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Caching Director Target',
      );
...
export const databaseCachingDirectorAgent = Object.freeze(
  new DatabaseCachingDirectorAgent(),
);
