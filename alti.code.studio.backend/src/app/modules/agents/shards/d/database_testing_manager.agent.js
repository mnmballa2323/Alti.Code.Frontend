...
class DatabaseTestingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseTestingSystem(objective) {
    logger.info(
      `💻 [DatabaseTestingManagerAgent] Analyzing Database Testing Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Testing Manager Target',
      );
...
export const databaseTestingManagerAgent = Object.freeze(
  new DatabaseTestingManagerAgent(),
);
