...
class DataOrchestrationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDataOrchestrationSystem(objective) {
    logger.info(
      `💻 [DataOrchestrationAnalystAgent] Analyzing Data Orchestration Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Orchestration Analyst Target',
      );
...
export const dataOrchestrationAnalystAgent = Object.freeze(
  new DataOrchestrationAnalystAgent(),
);
