...
class DevOpsAnalyticsTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsAnalyticsSystem(objective) {
        logger.info(`💻 [DevOpsAnalyticsTesterAgent] Analyzing DevOps Analytics Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Analytics Tester Target");
...
export const devOpsAnalyticsTesterAgent = Object.freeze(new DevOpsAnalyticsTesterAgent());
