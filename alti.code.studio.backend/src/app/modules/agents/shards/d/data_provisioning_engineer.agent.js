...
class DataProvisioningEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataProvisioningSystem(objective) {
        logger.info(`💻 [DataProvisioningEngineerAgent] Analyzing Data Provisioning Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Provisioning Engineer Target");
...
export const dataProvisioningEngineerAgent = Object.freeze(new DataProvisioningEngineerAgent());
