...
class DataTelemetryTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDataTelemetrySystem(objective) {
    logger.info(
      `💻 [DataTelemetryTesterAgent] Analyzing Data Telemetry Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Telemetry Tester Target',
      );
...
export const dataTelemetryTesterAgent = Object.freeze(
  new DataTelemetryTesterAgent(),
);
