...
class DevOpsTestingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsTestingSystem(objective) {
    logger.info(
      `💻 [DevOpsTestingTesterAgent] Analyzing DevOps Testing Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Testing Tester Target',
      );
...
export const devOpsTestingTesterAgent = Object.freeze(
  new DevOpsTestingTesterAgent(),
);
