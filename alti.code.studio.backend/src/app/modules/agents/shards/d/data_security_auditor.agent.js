...
class DataSecurityAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataSecuritySystem(objective) {
    logger.info(
      `💻 [DataSecurityAuditorAgent] Analyzing Data Security Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Security Auditor Target',
      );
...
export const dataSecurityAuditorAgent = Object.freeze(
  new DataSecurityAuditorAgent(),
);
