...
class DataStreamingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataStreamingSystem(objective) {
    logger.info(
      `💻 [DataStreamingManagerAgent] Analyzing Data Streaming Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Streaming Manager Target',
      );
...
export const dataStreamingManagerAgent = Object.freeze(
  new DataStreamingManagerAgent(),
);
