...
class DatabaseComplianceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseComplianceSystem(objective) {
    logger.info(
      `💻 [DatabaseComplianceTesterAgent] Analyzing Database Compliance Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Compliance Tester Target',
      );
...
export const databaseComplianceTesterAgent = Object.freeze(
  new DatabaseComplianceTesterAgent(),
);
