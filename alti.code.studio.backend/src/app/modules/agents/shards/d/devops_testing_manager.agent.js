...
class DevOpsTestingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsTestingSystem(objective) {
    logger.info(
      `💻 [DevOpsTestingManagerAgent] Analyzing DevOps Testing Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Testing Manager Target',
      );
...
export const devOpsTestingManagerAgent = Object.freeze(
  new DevOpsTestingManagerAgent(),
);
