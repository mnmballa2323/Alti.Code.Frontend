...
class DevOpsServerlessAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsServerlessSystem(objective) {
    logger.info(
      `💻 [DevOpsServerlessAnalystAgent] Analyzing DevOps Serverless Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Serverless Analyst Target',
      );
...
export const devOpsServerlessAnalystAgent = Object.freeze(
  new DevOpsServerlessAnalystAgent(),
);
