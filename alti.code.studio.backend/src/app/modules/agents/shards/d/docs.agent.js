...
class DocsAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Autonomously manages semantic version bumps, CHANGELOG generation, and updates Mintlify documentation via the `mintlify` OpenClaw skill.';
...
export const docsAgent = Object.freeze(new DocsAgent());
