...
class DataAutomationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDataAutomationSystem(objective) {
    logger.info(
      `💻 [DataAutomationLeadAgent] Analyzing Data Automation Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Automation Lead Target',
      );
...
export const dataAutomationLeadAgent = Object.freeze(
  new DataAutomationLeadAgent(),
);
