...
class DevOpsResilienceDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsResilienceSystem(objective) {
        logger.info(`💻 [DevOpsResilienceDirectorAgent] Analyzing DevOps Resilience Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Resilience Director Target");
...
export const devOpsResilienceDirectorAgent = Object.freeze(new DevOpsResilienceDirectorAgent());
