...
class DataResilienceLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateDataResilienceSystem(objective) {
        logger.info(`💻 [DataResilienceLeadAgent] Analyzing Data Resilience Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Resilience Lead Target");
...
export const dataResilienceLeadAgent = Object.freeze(new DataResilienceLeadAgent());
