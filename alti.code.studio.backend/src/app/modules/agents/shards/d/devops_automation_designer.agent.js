...
class DevOpsAutomationDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsAutomationSystem(objective) {
    logger.info(
      `💻 [DevOpsAutomationDesignerAgent] Analyzing DevOps Automation Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Automation Designer Target',
      );
...
export const devOpsAutomationDesignerAgent = Object.freeze(
  new DevOpsAutomationDesignerAgent(),
);
