...
class DevOpsDeploymentManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsDeploymentSystem(objective) {
        logger.info(`💻 [DevOpsDeploymentManagerAgent] Analyzing DevOps Deployment Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Deployment Manager Target");
...
export const devOpsDeploymentManagerAgent = Object.freeze(new DevOpsDeploymentManagerAgent());
