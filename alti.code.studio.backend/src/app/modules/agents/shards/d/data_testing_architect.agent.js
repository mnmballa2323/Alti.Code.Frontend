...
class DataTestingArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateDataTestingSystem(objective) {
    logger.info(
      `💻 [DataTestingArchitectAgent] Analyzing Data Testing Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Testing Architect Target',
      );
...
export const dataTestingArchitectAgent = Object.freeze(
  new DataTestingArchitectAgent(),
);
