...
class DataServerlessDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataServerlessSystem(objective) {
    logger.info(
      `💻 [DataServerlessDirectorAgent] Analyzing Data Serverless Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Serverless Director Target',
      );
...
export const dataServerlessDirectorAgent = Object.freeze(
  new DataServerlessDirectorAgent(),
);
