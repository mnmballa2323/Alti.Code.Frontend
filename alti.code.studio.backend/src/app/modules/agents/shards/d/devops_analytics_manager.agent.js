...
class DevOpsAnalyticsManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsAnalyticsSystem(objective) {
        logger.info(`💻 [DevOpsAnalyticsManagerAgent] Analyzing DevOps Analytics Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Analytics Manager Target");
...
export const devOpsAnalyticsManagerAgent = Object.freeze(new DevOpsAnalyticsManagerAgent());
