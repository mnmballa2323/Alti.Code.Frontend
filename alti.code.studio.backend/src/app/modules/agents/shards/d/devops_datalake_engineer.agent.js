...
class DevOpsDataLakeEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsDataLakeSystem(objective) {
    logger.info(
      `💻 [DevOpsDataLakeEngineerAgent] Analyzing DevOps DataLake Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps DataLake Engineer Target',
      );
...
export const devOpsDataLakeEngineerAgent = Object.freeze(
  new DevOpsDataLakeEngineerAgent(),
);
