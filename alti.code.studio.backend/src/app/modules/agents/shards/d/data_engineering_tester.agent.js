...
class DataEngineeringTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDataEngineeringSystem(objective) {
        logger.info(`💻 [DataEngineeringTesterAgent] Analyzing Data Engineering Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Engineering Tester Target");
...
export const dataEngineeringTesterAgent = Object.freeze(new DataEngineeringTesterAgent());
