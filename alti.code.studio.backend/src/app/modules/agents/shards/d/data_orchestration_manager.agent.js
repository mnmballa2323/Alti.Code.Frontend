...
class DataOrchestrationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataOrchestrationSystem(objective) {
    logger.info(
      `💻 [DataOrchestrationManagerAgent] Analyzing Data Orchestration Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Orchestration Manager Target',
      );
...
export const dataOrchestrationManagerAgent = Object.freeze(
  new DataOrchestrationManagerAgent(),
);
