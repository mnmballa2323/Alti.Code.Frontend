...
class DevOpsTelemetryEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsTelemetrySystem(objective) {
    logger.info(
      `💻 [DevOpsTelemetryEngineerAgent] Analyzing DevOps Telemetry Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Telemetry Engineer Target',
      );
...
export const devOpsTelemetryEngineerAgent = Object.freeze(
  new DevOpsTelemetryEngineerAgent(),
);
