...
class DataCachingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataCachingSystem(objective) {
    logger.info(
      `💻 [DataCachingDirectorAgent] Analyzing Data Caching Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Caching Director Target',
      );
...
export const dataCachingDirectorAgent = Object.freeze(
  new DataCachingDirectorAgent(),
);
