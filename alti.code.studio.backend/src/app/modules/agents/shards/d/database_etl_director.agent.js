...
class DatabaseETLDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseETLSystem(objective) {
        logger.info(`💻 [DatabaseETLDirectorAgent] Analyzing Database ETL Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database ETL Director Target");
...
export const databaseETLDirectorAgent = Object.freeze(new DatabaseETLDirectorAgent());
