...
class DevSecOpsTestingDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateDevSecOpsTestingSystem(objective) {
        logger.info(`💻 [DevSecOpsTestingDesignerAgent] Analyzing DevSecOps Testing Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevSecOps Testing Designer Target");
...
export const devSecOpsTestingDesignerAgent = Object.freeze(new DevSecOpsTestingDesignerAgent());
