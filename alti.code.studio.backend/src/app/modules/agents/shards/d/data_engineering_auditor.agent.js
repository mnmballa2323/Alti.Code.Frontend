...
class DataEngineeringAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataEngineeringSystem(objective) {
    logger.info(
      `💻 [DataEngineeringAuditorAgent] Analyzing Data Engineering Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Engineering Auditor Target',
      );
...
export const dataEngineeringAuditorAgent = Object.freeze(
  new DataEngineeringAuditorAgent(),
);
