...
class DataMigrationSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateDataMigrationSystem(objective) {
        logger.info(`💻 [DataMigrationSpecialistAgent] Analyzing Data Migration Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Migration Specialist Target");
...
export const dataMigrationSpecialistAgent = Object.freeze(new DataMigrationSpecialistAgent());
