...
class DevOpsIntegrationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsIntegrationSystem(objective) {
    logger.info(
      `💻 [DevOpsIntegrationAnalystAgent] Analyzing DevOps Integration Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Integration Analyst Target',
      );
...
export const devOpsIntegrationAnalystAgent = Object.freeze(
  new DevOpsIntegrationAnalystAgent(),
);
