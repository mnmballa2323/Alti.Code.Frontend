...
class DevOpsGovernanceEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsGovernanceSystem(objective) {
    logger.info(
      `💻 [DevOpsGovernanceEngineerAgent] Analyzing DevOps Governance Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Governance Engineer Target',
      );
...
export const devOpsGovernanceEngineerAgent = Object.freeze(
  new DevOpsGovernanceEngineerAgent(),
);
