...
class DatabaseMigrationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseMigrationSystem(objective) {
    logger.info(
      `💻 [DatabaseMigrationAnalystAgent] Analyzing Database Migration Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Migration Analyst Target',
      );
...
export const databaseMigrationAnalystAgent = Object.freeze(
  new DatabaseMigrationAnalystAgent(),
);
