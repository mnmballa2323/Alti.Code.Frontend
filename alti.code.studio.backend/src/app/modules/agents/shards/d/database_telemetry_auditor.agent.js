...
class DatabaseTelemetryAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseTelemetrySystem(objective) {
    logger.info(
      `💻 [DatabaseTelemetryAuditorAgent] Analyzing Database Telemetry Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Telemetry Auditor Target',
      );
...
export const databaseTelemetryAuditorAgent = Object.freeze(
  new DatabaseTelemetryAuditorAgent(),
);
