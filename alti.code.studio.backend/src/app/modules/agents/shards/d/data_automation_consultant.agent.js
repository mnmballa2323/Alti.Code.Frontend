...
class DataAutomationConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateDataAutomationSystem(objective) {
    logger.info(
      `💻 [DataAutomationConsultantAgent] Analyzing Data Automation Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Automation Consultant Target',
      );
...
export const dataAutomationConsultantAgent = Object.freeze(
  new DataAutomationConsultantAgent(),
);
