...
class DataResilienceConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateDataResilienceSystem(objective) {
        logger.info(`💻 [DataResilienceConsultantAgent] Analyzing Data Resilience Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Resilience Consultant Target");
...
export const dataResilienceConsultantAgent = Object.freeze(new DataResilienceConsultantAgent());
