...
class DevOpsTestingDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsTestingSystem(objective) {
        logger.info(`💻 [DevOpsTestingDesignerAgent] Analyzing DevOps Testing Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Testing Designer Target");
...
export const devOpsTestingDesignerAgent = Object.freeze(new DevOpsTestingDesignerAgent());
