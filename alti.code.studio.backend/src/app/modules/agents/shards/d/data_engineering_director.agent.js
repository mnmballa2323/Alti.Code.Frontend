...
class DataEngineeringDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateDataEngineeringSystem(objective) {
        logger.info(`💻 [DataEngineeringDirectorAgent] Analyzing Data Engineering Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Engineering Director Target");
...
export const dataEngineeringDirectorAgent = Object.freeze(new DataEngineeringDirectorAgent());
