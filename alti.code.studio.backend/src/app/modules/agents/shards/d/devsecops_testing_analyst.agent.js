...
class DevSecOpsTestingAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDevSecOpsTestingSystem(objective) {
    logger.info(
      `💻 [DevSecOpsTestingAnalystAgent] Analyzing DevSecOps Testing Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevSecOps Testing Analyst Target',
      );
...
export const devSecOpsTestingAnalystAgent = Object.freeze(
  new DevSecOpsTestingAnalystAgent(),
);
