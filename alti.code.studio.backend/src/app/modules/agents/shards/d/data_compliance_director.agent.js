...
class DataComplianceDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataComplianceSystem(objective) {
    logger.info(
      `💻 [DataComplianceDirectorAgent] Analyzing Data Compliance Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Compliance Director Target',
      );
...
export const dataComplianceDirectorAgent = Object.freeze(
  new DataComplianceDirectorAgent(),
);
