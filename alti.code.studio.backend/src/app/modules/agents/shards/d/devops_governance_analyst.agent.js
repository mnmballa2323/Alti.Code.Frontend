...
class DevOpsGovernanceAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsGovernanceSystem(objective) {
        logger.info(`💻 [DevOpsGovernanceAnalystAgent] Analyzing DevOps Governance Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Governance Analyst Target");
...
export const devOpsGovernanceAnalystAgent = Object.freeze(new DevOpsGovernanceAnalystAgent());
