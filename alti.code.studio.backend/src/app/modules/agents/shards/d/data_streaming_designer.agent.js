...
class DataStreamingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataStreamingSystem(objective) {
    logger.info(
      `💻 [DataStreamingDesignerAgent] Analyzing Data Streaming Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Streaming Designer Target',
      );
...
export const dataStreamingDesignerAgent = Object.freeze(
  new DataStreamingDesignerAgent(),
);
