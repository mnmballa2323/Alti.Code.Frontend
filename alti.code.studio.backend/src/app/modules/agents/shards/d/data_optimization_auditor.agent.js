...
class DataOptimizationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataOptimizationSystem(objective) {
    logger.info(
      `💻 [DataOptimizationAuditorAgent] Analyzing Data Optimization Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Optimization Auditor Target',
      );
...
export const dataOptimizationAuditorAgent = Object.freeze(
  new DataOptimizationAuditorAgent(),
);
