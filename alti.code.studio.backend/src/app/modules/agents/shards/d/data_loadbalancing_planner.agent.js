...
class DataLoadBalancingPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataLoadBalancingSystem(objective) {
        logger.info(`💻 [DataLoadBalancingPlannerAgent] Analyzing Data LoadBalancing Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data LoadBalancing Planner Target");
...
export const dataLoadBalancingPlannerAgent = Object.freeze(new DataLoadBalancingPlannerAgent());
