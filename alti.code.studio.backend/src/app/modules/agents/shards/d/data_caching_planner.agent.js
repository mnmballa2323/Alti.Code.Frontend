...
class DataCachingPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataCachingSystem(objective) {
    logger.info(
      `💻 [DataCachingPlannerAgent] Analyzing Data Caching Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Caching Planner Target',
      );
...
export const dataCachingPlannerAgent = Object.freeze(
  new DataCachingPlannerAgent(),
);
