...
class DataConfigurationManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataConfigurationSystem(objective) {
        logger.info(`💻 [DataConfigurationManagerAgent] Analyzing Data Configuration Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Configuration Manager Target");
...
export const dataConfigurationManagerAgent = Object.freeze(new DataConfigurationManagerAgent());
