...
class DataEngineeringManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataEngineeringSystem(objective) {
        logger.info(`💻 [DataEngineeringManagerAgent] Analyzing Data Engineering Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Engineering Manager Target");
...
export const dataEngineeringManagerAgent = Object.freeze(new DataEngineeringManagerAgent());
