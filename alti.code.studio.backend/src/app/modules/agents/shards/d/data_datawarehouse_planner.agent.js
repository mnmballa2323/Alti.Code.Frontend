...
class DataDataWarehousePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataDataWarehouseSystem(objective) {
    logger.info(
      `💻 [DataDataWarehousePlannerAgent] Analyzing Data DataWarehouse Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data DataWarehouse Planner Target',
      );
...
export const dataDataWarehousePlannerAgent = Object.freeze(
  new DataDataWarehousePlannerAgent(),
);
