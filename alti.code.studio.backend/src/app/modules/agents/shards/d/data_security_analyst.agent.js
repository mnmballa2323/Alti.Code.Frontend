...
class DataSecurityAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateDataSecuritySystem(objective) {
        logger.info(`💻 [DataSecurityAnalystAgent] Analyzing Data Security Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Security Analyst Target");
...
export const dataSecurityAnalystAgent = Object.freeze(new DataSecurityAnalystAgent());
