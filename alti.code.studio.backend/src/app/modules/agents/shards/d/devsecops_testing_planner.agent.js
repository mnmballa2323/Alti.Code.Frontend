...
class DevSecOpsTestingPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateDevSecOpsTestingSystem(objective) {
        logger.info(`💻 [DevSecOpsTestingPlannerAgent] Analyzing DevSecOps Testing Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevSecOps Testing Planner Target");
...
export const devSecOpsTestingPlannerAgent = Object.freeze(new DevSecOpsTestingPlannerAgent());
