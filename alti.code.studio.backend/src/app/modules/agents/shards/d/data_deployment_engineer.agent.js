...
class DataDeploymentEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataDeploymentSystem(objective) {
    logger.info(
      `💻 [DataDeploymentEngineerAgent] Analyzing Data Deployment Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Deployment Engineer Target',
      );
...
export const dataDeploymentEngineerAgent = Object.freeze(
  new DataDeploymentEngineerAgent(),
);
