...
class DevOpsStreamingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsStreamingSystem(objective) {
    logger.info(
      `💻 [DevOpsStreamingManagerAgent] Analyzing DevOps Streaming Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Streaming Manager Target',
      );
...
export const devOpsStreamingManagerAgent = Object.freeze(
  new DevOpsStreamingManagerAgent(),
);
