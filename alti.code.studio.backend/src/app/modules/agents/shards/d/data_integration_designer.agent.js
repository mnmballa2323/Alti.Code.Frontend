...
class DataIntegrationDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataIntegrationSystem(objective) {
    logger.info(
      `💻 [DataIntegrationDesignerAgent] Analyzing Data Integration Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Integration Designer Target',
      );
...
export const dataIntegrationDesignerAgent = Object.freeze(
  new DataIntegrationDesignerAgent(),
);
