...
class DataEngineeringDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateDataEngineeringSystem(objective) {
        logger.info(`💻 [DataEngineeringDeveloperAgent] Analyzing Data Engineering Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Engineering Developer Target");
...
export const dataEngineeringDeveloperAgent = Object.freeze(new DataEngineeringDeveloperAgent());
