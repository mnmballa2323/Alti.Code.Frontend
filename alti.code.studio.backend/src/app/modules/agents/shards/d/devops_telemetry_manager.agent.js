...
class DevOpsTelemetryManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsTelemetrySystem(objective) {
        logger.info(`💻 [DevOpsTelemetryManagerAgent] Analyzing DevOps Telemetry Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Telemetry Manager Target");
...
export const devOpsTelemetryManagerAgent = Object.freeze(new DevOpsTelemetryManagerAgent());
