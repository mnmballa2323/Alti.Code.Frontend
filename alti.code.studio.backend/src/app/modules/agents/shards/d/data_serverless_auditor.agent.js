...
class DataServerlessAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateDataServerlessSystem(objective) {
        logger.info(`💻 [DataServerlessAuditorAgent] Analyzing Data Serverless Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Serverless Auditor Target");
...
export const dataServerlessAuditorAgent = Object.freeze(new DataServerlessAuditorAgent());
