...
class DataComplianceAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateDataComplianceSystem(objective) {
        logger.info(`💻 [DataComplianceAnalystAgent] Analyzing Data Compliance Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Compliance Analyst Target");
...
export const dataComplianceAnalystAgent = Object.freeze(new DataComplianceAnalystAgent());
