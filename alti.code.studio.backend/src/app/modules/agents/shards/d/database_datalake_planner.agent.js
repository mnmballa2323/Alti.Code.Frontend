...
class DatabaseDataLakePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseDataLakeSystem(objective) {
    logger.info(
      `💻 [DatabaseDataLakePlannerAgent] Analyzing Database DataLake Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database DataLake Planner Target',
      );
...
export const databaseDataLakePlannerAgent = Object.freeze(
  new DatabaseDataLakePlannerAgent(),
);
