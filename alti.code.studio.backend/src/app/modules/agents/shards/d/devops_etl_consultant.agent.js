...
class DevOpsETLConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsETLSystem(objective) {
        logger.info(`💻 [DevOpsETLConsultantAgent] Analyzing DevOps ETL Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps ETL Consultant Target");
...
export const devOpsETLConsultantAgent = Object.freeze(new DevOpsETLConsultantAgent());
