...
class DevOpsResilienceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsResilienceSystem(objective) {
    logger.info(
      `💻 [DevOpsResilienceTesterAgent] Analyzing DevOps Resilience Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Resilience Tester Target',
      );
...
export const devOpsResilienceTesterAgent = Object.freeze(
  new DevOpsResilienceTesterAgent(),
);
