...
class DevOpsObservabilityLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsObservabilitySystem(objective) {
    logger.info(
      `💻 [DevOpsObservabilityLeadAgent] Analyzing DevOps Observability Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Observability Lead Target',
      );
...
export const devOpsObservabilityLeadAgent = Object.freeze(
  new DevOpsObservabilityLeadAgent(),
);
