...
class DatabaseCachingAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseCachingSystem(objective) {
    logger.info(
      `💻 [DatabaseCachingAnalystAgent] Analyzing Database Caching Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Caching Analyst Target',
      );
...
export const databaseCachingAnalystAgent = Object.freeze(
  new DatabaseCachingAnalystAgent(),
);
