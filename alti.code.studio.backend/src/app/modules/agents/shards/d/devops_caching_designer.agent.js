...
class DevOpsCachingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsCachingSystem(objective) {
    logger.info(
      `💻 [DevOpsCachingDesignerAgent] Analyzing DevOps Caching Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Caching Designer Target',
      );
...
export const devOpsCachingDesignerAgent = Object.freeze(
  new DevOpsCachingDesignerAgent(),
);
