...
class DataLoadBalancingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataLoadBalancingSystem(objective) {
    logger.info(
      `💻 [DataLoadBalancingManagerAgent] Analyzing Data LoadBalancing Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data LoadBalancing Manager Target',
      );
...
export const dataLoadBalancingManagerAgent = Object.freeze(
  new DataLoadBalancingManagerAgent(),
);
