...
class DataComplianceEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataComplianceSystem(objective) {
        logger.info(`💻 [DataComplianceEngineerAgent] Analyzing Data Compliance Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Compliance Engineer Target");
...
export const dataComplianceEngineerAgent = Object.freeze(new DataComplianceEngineerAgent());
