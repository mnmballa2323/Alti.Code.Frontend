...
class DataResilienceDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateDataResilienceSystem(objective) {
    logger.info(
      `💻 [DataResilienceDeveloperAgent] Analyzing Data Resilience Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Resilience Developer Target',
      );
...
export const dataResilienceDeveloperAgent = Object.freeze(
  new DataResilienceDeveloperAgent(),
);
