...
class DevOpsStreamingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsStreamingSystem(objective) {
    logger.info(
      `💻 [DevOpsStreamingDirectorAgent] Analyzing DevOps Streaming Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Streaming Director Target',
      );
...
export const devOpsStreamingDirectorAgent = Object.freeze(
  new DevOpsStreamingDirectorAgent(),
);
