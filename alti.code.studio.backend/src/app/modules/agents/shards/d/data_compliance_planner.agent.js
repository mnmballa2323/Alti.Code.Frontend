...
class DataCompliancePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataComplianceSystem(objective) {
    logger.info(
      `💻 [DataCompliancePlannerAgent] Analyzing Data Compliance Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Compliance Planner Target',
      );
...
export const dataCompliancePlannerAgent = Object.freeze(
  new DataCompliancePlannerAgent(),
);
