...
class DevSecOpsTelemetryTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDevSecOpsTelemetrySystem(objective) {
        logger.info(`💻 [DevSecOpsTelemetryTesterAgent] Analyzing DevSecOps Telemetry Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevSecOps Telemetry Tester Target");
...
export const devSecOpsTelemetryTesterAgent = Object.freeze(new DevSecOpsTelemetryTesterAgent());
