...
class DataProvisioningLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDataProvisioningSystem(objective) {
    logger.info(
      `💻 [DataProvisioningLeadAgent] Analyzing Data Provisioning Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Provisioning Lead Target',
      );
...
export const dataProvisioningLeadAgent = Object.freeze(
  new DataProvisioningLeadAgent(),
);
