...
class DataResilienceDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataResilienceSystem(objective) {
    logger.info(
      `💻 [DataResilienceDesignerAgent] Analyzing Data Resilience Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Resilience Designer Target',
      );
...
export const dataResilienceDesignerAgent = Object.freeze(
  new DataResilienceDesignerAgent(),
);
