...
class DevOpsSecurityDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsSecuritySystem(objective) {
    logger.info(
      `💻 [DevOpsSecurityDesignerAgent] Analyzing DevOps Security Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Security Designer Target',
      );
...
export const devOpsSecurityDesignerAgent = Object.freeze(
  new DevOpsSecurityDesignerAgent(),
);
