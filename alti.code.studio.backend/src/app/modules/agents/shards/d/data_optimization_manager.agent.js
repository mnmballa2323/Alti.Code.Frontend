...
class DataOptimizationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataOptimizationSystem(objective) {
    logger.info(
      `💻 [DataOptimizationManagerAgent] Analyzing Data Optimization Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Optimization Manager Target',
      );
...
export const dataOptimizationManagerAgent = Object.freeze(
  new DataOptimizationManagerAgent(),
);
