...
class DataTelemetryPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataTelemetrySystem(objective) {
        logger.info(`💻 [DataTelemetryPlannerAgent] Analyzing Data Telemetry Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Telemetry Planner Target");
...
export const dataTelemetryPlannerAgent = Object.freeze(new DataTelemetryPlannerAgent());
