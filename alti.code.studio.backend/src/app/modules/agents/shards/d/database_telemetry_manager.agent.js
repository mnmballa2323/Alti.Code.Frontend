...
class DatabaseTelemetryManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseTelemetrySystem(objective) {
    logger.info(
      `💻 [DatabaseTelemetryManagerAgent] Analyzing Database Telemetry Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Telemetry Manager Target',
      );
...
export const databaseTelemetryManagerAgent = Object.freeze(
  new DatabaseTelemetryManagerAgent(),
);
