...
class DataServerlessConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateDataServerlessSystem(objective) {
    logger.info(
      `💻 [DataServerlessConsultantAgent] Analyzing Data Serverless Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Serverless Consultant Target',
      );
...
export const dataServerlessConsultantAgent = Object.freeze(
  new DataServerlessConsultantAgent(),
);
