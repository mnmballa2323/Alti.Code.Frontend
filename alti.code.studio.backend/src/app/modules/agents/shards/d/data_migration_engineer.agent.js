...
class DataMigrationEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataMigrationSystem(objective) {
    logger.info(
      `💻 [DataMigrationEngineerAgent] Analyzing Data Migration Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Migration Engineer Target',
      );
...
export const dataMigrationEngineerAgent = Object.freeze(
  new DataMigrationEngineerAgent(),
);
