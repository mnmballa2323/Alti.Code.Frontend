...
class DataIntegrationManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataIntegrationSystem(objective) {
        logger.info(`💻 [DataIntegrationManagerAgent] Analyzing Data Integration Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Integration Manager Target");
...
export const dataIntegrationManagerAgent = Object.freeze(new DataIntegrationManagerAgent());
