...
class DataConfigurationTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDataConfigurationSystem(objective) {
        logger.info(`💻 [DataConfigurationTesterAgent] Analyzing Data Configuration Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Configuration Tester Target");
...
export const dataConfigurationTesterAgent = Object.freeze(new DataConfigurationTesterAgent());
