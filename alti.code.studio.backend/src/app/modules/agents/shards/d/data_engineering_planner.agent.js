...
class DataEngineeringPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataEngineeringSystem(objective) {
        logger.info(`💻 [DataEngineeringPlannerAgent] Analyzing Data Engineering Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Engineering Planner Target");
...
export const dataEngineeringPlannerAgent = Object.freeze(new DataEngineeringPlannerAgent());
