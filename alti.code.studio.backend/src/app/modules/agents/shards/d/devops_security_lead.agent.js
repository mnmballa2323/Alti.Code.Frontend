...
class DevOpsSecurityLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsSecuritySystem(objective) {
    logger.info(
      `💻 [DevOpsSecurityLeadAgent] Analyzing DevOps Security Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Security Lead Target',
      );
...
export const devOpsSecurityLeadAgent = Object.freeze(
  new DevOpsSecurityLeadAgent(),
);
