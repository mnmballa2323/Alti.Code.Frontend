...
class DatabaseCachingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseCachingSystem(objective) {
    logger.info(
      `💻 [DatabaseCachingManagerAgent] Analyzing Database Caching Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Caching Manager Target',
      );
...
export const databaseCachingManagerAgent = Object.freeze(
  new DatabaseCachingManagerAgent(),
);
