...
class DataAutomationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDataAutomationSystem(objective) {
    logger.info(
      `💻 [DataAutomationTesterAgent] Analyzing Data Automation Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Automation Tester Target',
      );
...
export const dataAutomationTesterAgent = Object.freeze(
  new DataAutomationTesterAgent(),
);
