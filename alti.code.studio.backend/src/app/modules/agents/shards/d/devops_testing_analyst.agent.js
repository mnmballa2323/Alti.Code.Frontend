...
class DevOpsTestingAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsTestingSystem(objective) {
    logger.info(
      `💻 [DevOpsTestingAnalystAgent] Analyzing DevOps Testing Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Testing Analyst Target',
      );
...
export const devOpsTestingAnalystAgent = Object.freeze(
  new DevOpsTestingAnalystAgent(),
);
