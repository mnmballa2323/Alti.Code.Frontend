...
class DataCachingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataCachingSystem(objective) {
    logger.info(
      `💻 [DataCachingEngineerAgent] Analyzing Data Caching Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Caching Engineer Target',
      );
...
export const dataCachingEngineerAgent = Object.freeze(
  new DataCachingEngineerAgent(),
);
