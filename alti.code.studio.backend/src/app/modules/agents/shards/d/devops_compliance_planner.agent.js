...
class DevOpsCompliancePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsComplianceSystem(objective) {
    logger.info(
      `💻 [DevOpsCompliancePlannerAgent] Analyzing DevOps Compliance Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Compliance Planner Target',
      );
...
export const devOpsCompliancePlannerAgent = Object.freeze(
  new DevOpsCompliancePlannerAgent(),
);
