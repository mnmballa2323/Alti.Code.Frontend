...
class DataETLOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataETLSystem(objective) {
    logger.info(
      `💻 [DataETLOrchestratorAgent] Analyzing Data ETL Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data ETL Orchestrator Target',
      );
...
export const dataETLOrchestratorAgent = Object.freeze(
  new DataETLOrchestratorAgent(),
);
