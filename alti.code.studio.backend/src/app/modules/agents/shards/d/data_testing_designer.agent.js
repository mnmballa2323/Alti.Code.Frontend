...
class DataTestingDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataTestingSystem(objective) {
        logger.info(`💻 [DataTestingDesignerAgent] Analyzing Data Testing Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Testing Designer Target");
...
export const dataTestingDesignerAgent = Object.freeze(new DataTestingDesignerAgent());
