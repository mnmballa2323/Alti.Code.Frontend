...
class DataAutomationPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataAutomationSystem(objective) {
        logger.info(`💻 [DataAutomationPlannerAgent] Analyzing Data Automation Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Automation Planner Target");
...
export const dataAutomationPlannerAgent = Object.freeze(new DataAutomationPlannerAgent());
