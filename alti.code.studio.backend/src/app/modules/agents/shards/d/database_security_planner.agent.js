...
class DatabaseSecurityPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseSecuritySystem(objective) {
        logger.info(`💻 [DatabaseSecurityPlannerAgent] Analyzing Database Security Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database Security Planner Target");
...
export const databaseSecurityPlannerAgent = Object.freeze(new DatabaseSecurityPlannerAgent());
