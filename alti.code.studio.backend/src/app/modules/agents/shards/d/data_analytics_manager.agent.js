...
class DataAnalyticsManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataAnalyticsSystem(objective) {
        logger.info(`💻 [DataAnalyticsManagerAgent] Analyzing Data Analytics Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Analytics Manager Target");
...
export const dataAnalyticsManagerAgent = Object.freeze(new DataAnalyticsManagerAgent());
