...
class DevOpsGovernanceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsGovernanceSystem(objective) {
    logger.info(
      `💻 [DevOpsGovernanceTesterAgent] Analyzing DevOps Governance Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Governance Tester Target',
      );
...
export const devOpsGovernanceTesterAgent = Object.freeze(
  new DevOpsGovernanceTesterAgent(),
);
