...
class DatabaseETLDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseETLSystem(objective) {
        logger.info(`💻 [DatabaseETLDeveloperAgent] Analyzing Database ETL Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database ETL Developer Target");
...
export const databaseETLDeveloperAgent = Object.freeze(new DatabaseETLDeveloperAgent());
