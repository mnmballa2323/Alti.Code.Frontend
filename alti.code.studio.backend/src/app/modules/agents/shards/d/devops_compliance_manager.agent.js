...
class DevOpsComplianceManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsComplianceSystem(objective) {
    logger.info(
      `💻 [DevOpsComplianceManagerAgent] Analyzing DevOps Compliance Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Compliance Manager Target',
      );
...
export const devOpsComplianceManagerAgent = Object.freeze(
  new DevOpsComplianceManagerAgent(),
);
