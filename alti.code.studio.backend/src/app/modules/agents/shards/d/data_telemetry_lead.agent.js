...
class DataTelemetryLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDataTelemetrySystem(objective) {
    logger.info(
      `💻 [DataTelemetryLeadAgent] Analyzing Data Telemetry Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Telemetry Lead Target',
      );
...
export const dataTelemetryLeadAgent = Object.freeze(
  new DataTelemetryLeadAgent(),
);
