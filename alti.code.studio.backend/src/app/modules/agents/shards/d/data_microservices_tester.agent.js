...
class DataMicroservicesTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDataMicroservicesSystem(objective) {
    logger.info(
      `💻 [DataMicroservicesTesterAgent] Analyzing Data Microservices Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Microservices Tester Target',
      );
...
export const dataMicroservicesTesterAgent = Object.freeze(
  new DataMicroservicesTesterAgent(),
);
