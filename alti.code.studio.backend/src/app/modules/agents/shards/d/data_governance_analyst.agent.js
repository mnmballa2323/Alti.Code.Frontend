...
class DataGovernanceAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDataGovernanceSystem(objective) {
    logger.info(
      `💻 [DataGovernanceAnalystAgent] Analyzing Data Governance Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Governance Analyst Target',
      );
...
export const dataGovernanceAnalystAgent = Object.freeze(
  new DataGovernanceAnalystAgent(),
);
