...
class DevSecOpsMigrationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDevSecOpsMigrationSystem(objective) {
    logger.info(
      `💻 [DevSecOpsMigrationTesterAgent] Analyzing DevSecOps Migration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevSecOps Migration Tester Target',
      );
...
export const devSecOpsMigrationTesterAgent = Object.freeze(
  new DevSecOpsMigrationTesterAgent(),
);
