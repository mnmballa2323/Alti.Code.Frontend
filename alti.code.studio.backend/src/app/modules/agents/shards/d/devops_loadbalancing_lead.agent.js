...
class DevOpsLoadBalancingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsLoadBalancingSystem(objective) {
    logger.info(
      `💻 [DevOpsLoadBalancingLeadAgent] Analyzing DevOps LoadBalancing Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps LoadBalancing Lead Target',
      );
...
export const devOpsLoadBalancingLeadAgent = Object.freeze(
  new DevOpsLoadBalancingLeadAgent(),
);
