...
class DataOrchestrationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDataOrchestrationSystem(objective) {
    logger.info(
      `💻 [DataOrchestrationLeadAgent] Analyzing Data Orchestration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Orchestration Lead Target',
      );
...
export const dataOrchestrationLeadAgent = Object.freeze(
  new DataOrchestrationLeadAgent(),
);
