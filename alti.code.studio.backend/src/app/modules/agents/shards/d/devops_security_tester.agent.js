...
class DevOpsSecurityTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsSecuritySystem(objective) {
    logger.info(
      `💻 [DevOpsSecurityTesterAgent] Analyzing DevOps Security Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Security Tester Target',
      );
...
export const devOpsSecurityTesterAgent = Object.freeze(
  new DevOpsSecurityTesterAgent(),
);
