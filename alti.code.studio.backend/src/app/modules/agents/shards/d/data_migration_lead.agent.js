...
class DataMigrationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDataMigrationSystem(objective) {
    logger.info(
      `💻 [DataMigrationLeadAgent] Analyzing Data Migration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Migration Lead Target',
      );
...
export const dataMigrationLeadAgent = Object.freeze(
  new DataMigrationLeadAgent(),
);
