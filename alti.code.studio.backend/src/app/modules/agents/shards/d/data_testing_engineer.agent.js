...
class DataTestingEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataTestingSystem(objective) {
        logger.info(`💻 [DataTestingEngineerAgent] Analyzing Data Testing Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Testing Engineer Target");
...
export const dataTestingEngineerAgent = Object.freeze(new DataTestingEngineerAgent());
