...
class DataSecurityDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateDataSecuritySystem(objective) {
        logger.info(`💻 [DataSecurityDeveloperAgent] Analyzing Data Security Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Security Developer Target");
...
export const dataSecurityDeveloperAgent = Object.freeze(new DataSecurityDeveloperAgent());
