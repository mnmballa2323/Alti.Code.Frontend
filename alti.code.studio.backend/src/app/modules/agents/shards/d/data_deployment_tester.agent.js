...
class DataDeploymentTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDataDeploymentSystem(objective) {
    logger.info(
      `💻 [DataDeploymentTesterAgent] Analyzing Data Deployment Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Deployment Tester Target',
      );
...
export const dataDeploymentTesterAgent = Object.freeze(
  new DataDeploymentTesterAgent(),
);
