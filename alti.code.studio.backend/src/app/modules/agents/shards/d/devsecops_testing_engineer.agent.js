...
class DevSecOpsTestingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevSecOpsTestingSystem(objective) {
    logger.info(
      `💻 [DevSecOpsTestingEngineerAgent] Analyzing DevSecOps Testing Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevSecOps Testing Engineer Target',
      );
...
export const devSecOpsTestingEngineerAgent = Object.freeze(
  new DevSecOpsTestingEngineerAgent(),
);
