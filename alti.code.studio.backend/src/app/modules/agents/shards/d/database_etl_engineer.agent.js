...
class DatabaseETLEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseETLSystem(objective) {
    logger.info(
      `💻 [DatabaseETLEngineerAgent] Analyzing Database ETL Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database ETL Engineer Target',
      );
...
export const databaseETLEngineerAgent = Object.freeze(
  new DatabaseETLEngineerAgent(),
);
