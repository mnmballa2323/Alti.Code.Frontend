...
class DataEngineeringDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataEngineeringSystem(objective) {
    logger.info(
      `💻 [DataEngineeringDesignerAgent] Analyzing Data Engineering Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Engineering Designer Target',
      );
...
export const dataEngineeringDesignerAgent = Object.freeze(
  new DataEngineeringDesignerAgent(),
);
