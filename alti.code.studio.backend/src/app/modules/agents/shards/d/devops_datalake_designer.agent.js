...
class DevOpsDataLakeDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsDataLakeSystem(objective) {
    logger.info(
      `💻 [DevOpsDataLakeDesignerAgent] Analyzing DevOps DataLake Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps DataLake Designer Target',
      );
...
export const devOpsDataLakeDesignerAgent = Object.freeze(
  new DevOpsDataLakeDesignerAgent(),
);
