...
class DevOpsMigrationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsMigrationSystem(objective) {
    logger.info(
      `💻 [DevOpsMigrationTesterAgent] Analyzing DevOps Migration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Migration Tester Target',
      );
...
export const devOpsMigrationTesterAgent = Object.freeze(
  new DevOpsMigrationTesterAgent(),
);
