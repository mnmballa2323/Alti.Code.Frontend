...
class DatabaseDataLakeEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseDataLakeSystem(objective) {
    logger.info(
      `💻 [DatabaseDataLakeEngineerAgent] Analyzing Database DataLake Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database DataLake Engineer Target',
      );
...
export const databaseDataLakeEngineerAgent = Object.freeze(
  new DatabaseDataLakeEngineerAgent(),
);
