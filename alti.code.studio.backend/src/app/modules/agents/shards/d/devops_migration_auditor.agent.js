...
class DevOpsMigrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsMigrationSystem(objective) {
    logger.info(
      `💻 [DevOpsMigrationAuditorAgent] Analyzing DevOps Migration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Migration Auditor Target',
      );
...
export const devOpsMigrationAuditorAgent = Object.freeze(
  new DevOpsMigrationAuditorAgent(),
);
