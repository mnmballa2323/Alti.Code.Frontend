...
class DevOpsStreamingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsStreamingSystem(objective) {
    logger.info(
      `💻 [DevOpsStreamingAuditorAgent] Analyzing DevOps Streaming Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Streaming Auditor Target',
      );
...
export const devOpsStreamingAuditorAgent = Object.freeze(
  new DevOpsStreamingAuditorAgent(),
);
