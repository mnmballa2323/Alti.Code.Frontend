...
class DatabaseAutomationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseAutomationSystem(objective) {
        logger.info(`💻 [DatabaseAutomationLeadAgent] Analyzing Database Automation Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database Automation Lead Target");
...
export const databaseAutomationLeadAgent = Object.freeze(new DatabaseAutomationLeadAgent());
