...
class DataMigrationManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataMigrationSystem(objective) {
        logger.info(`💻 [DataMigrationManagerAgent] Analyzing Data Migration Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Migration Manager Target");
...
export const dataMigrationManagerAgent = Object.freeze(new DataMigrationManagerAgent());
