...
class DataServerlessDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateDataServerlessSystem(objective) {
    logger.info(
      `💻 [DataServerlessDeveloperAgent] Analyzing Data Serverless Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Serverless Developer Target',
      );
...
export const dataServerlessDeveloperAgent = Object.freeze(
  new DataServerlessDeveloperAgent(),
);
