...
class DataMicroservicesManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataMicroservicesSystem(objective) {
        logger.info(`💻 [DataMicroservicesManagerAgent] Analyzing Data Microservices Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Microservices Manager Target");
...
export const dataMicroservicesManagerAgent = Object.freeze(new DataMicroservicesManagerAgent());
