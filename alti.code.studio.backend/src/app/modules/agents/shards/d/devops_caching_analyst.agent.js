...
class DevOpsCachingAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsCachingSystem(objective) {
    logger.info(
      `💻 [DevOpsCachingAnalystAgent] Analyzing DevOps Caching Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Caching Analyst Target',
      );
...
export const devOpsCachingAnalystAgent = Object.freeze(
  new DevOpsCachingAnalystAgent(),
);
