...
class DevSecOpsMigrationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDevSecOpsMigrationSystem(objective) {
    logger.info(
      `💻 [DevSecOpsMigrationLeadAgent] Analyzing DevSecOps Migration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevSecOps Migration Lead Target',
      );
...
export const devSecOpsMigrationLeadAgent = Object.freeze(
  new DevSecOpsMigrationLeadAgent(),
);
