...
class DevOpsETLOrchestratorAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsETLSystem(objective) {
        logger.info(`💻 [DevOpsETLOrchestratorAgent] Analyzing DevOps ETL Orchestrator specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps ETL Orchestrator Target");
...
export const devOpsETLOrchestratorAgent = Object.freeze(new DevOpsETLOrchestratorAgent());
