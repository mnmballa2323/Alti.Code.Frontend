...
class DatabaseTestingLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseTestingSystem(objective) {
        logger.info(`💻 [DatabaseTestingLeadAgent] Analyzing Database Testing Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database Testing Lead Target");
...
export const databaseTestingLeadAgent = Object.freeze(new DatabaseTestingLeadAgent());
