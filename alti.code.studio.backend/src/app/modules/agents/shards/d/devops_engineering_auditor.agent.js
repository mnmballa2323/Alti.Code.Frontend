...
class DevOpsEngineeringAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsEngineeringSystem(objective) {
    logger.info(
      `💻 [DevOpsEngineeringAuditorAgent] Analyzing DevOps Engineering Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Engineering Auditor Target',
      );
...
export const devOpsEngineeringAuditorAgent = Object.freeze(
  new DevOpsEngineeringAuditorAgent(),
);
