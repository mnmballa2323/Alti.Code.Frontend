...
class DevSecOpsIntegrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDevSecOpsIntegrationSystem(objective) {
    logger.info(
      `💻 [DevSecOpsIntegrationAuditorAgent] Analyzing DevSecOps Integration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevSecOps Integration Auditor Target',
      );
...
export const devSecOpsIntegrationAuditorAgent = Object.freeze(
  new DevSecOpsIntegrationAuditorAgent(),
);
