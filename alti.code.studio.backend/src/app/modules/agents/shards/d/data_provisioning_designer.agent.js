...
class DataProvisioningDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataProvisioningSystem(objective) {
    logger.info(
      `💻 [DataProvisioningDesignerAgent] Analyzing Data Provisioning Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Provisioning Designer Target',
      );
...
export const dataProvisioningDesignerAgent = Object.freeze(
  new DataProvisioningDesignerAgent(),
);
