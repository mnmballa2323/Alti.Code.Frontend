...
class DataObservabilityTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDataObservabilitySystem(objective) {
        logger.info(`💻 [DataObservabilityTesterAgent] Analyzing Data Observability Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Observability Tester Target");
...
export const dataObservabilityTesterAgent = Object.freeze(new DataObservabilityTesterAgent());
