...
class DataGovernanceLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateDataGovernanceSystem(objective) {
        logger.info(`💻 [DataGovernanceLeadAgent] Analyzing Data Governance Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Governance Lead Target");
...
export const dataGovernanceLeadAgent = Object.freeze(new DataGovernanceLeadAgent());
