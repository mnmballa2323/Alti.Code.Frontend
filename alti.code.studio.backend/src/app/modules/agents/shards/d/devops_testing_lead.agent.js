...
class DevOpsTestingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsTestingSystem(objective) {
    logger.info(
      `💻 [DevOpsTestingLeadAgent] Analyzing DevOps Testing Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Testing Lead Target',
      );
...
export const devOpsTestingLeadAgent = Object.freeze(
  new DevOpsTestingLeadAgent(),
);
