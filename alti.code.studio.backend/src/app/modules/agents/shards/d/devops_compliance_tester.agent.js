...
class DevOpsComplianceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsComplianceSystem(objective) {
    logger.info(
      `💻 [DevOpsComplianceTesterAgent] Analyzing DevOps Compliance Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Compliance Tester Target',
      );
...
export const devOpsComplianceTesterAgent = Object.freeze(
  new DevOpsComplianceTesterAgent(),
);
