...
class DatabaseGovernanceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseGovernanceSystem(objective) {
    logger.info(
      `💻 [DatabaseGovernanceTesterAgent] Analyzing Database Governance Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Governance Tester Target',
      );
...
export const databaseGovernanceTesterAgent = Object.freeze(
  new DatabaseGovernanceTesterAgent(),
);
