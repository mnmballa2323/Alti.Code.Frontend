...
class DatabaseETLOrchestratorAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseETLSystem(objective) {
        logger.info(`💻 [DatabaseETLOrchestratorAgent] Analyzing Database ETL Orchestrator specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database ETL Orchestrator Target");
...
export const databaseETLOrchestratorAgent = Object.freeze(new DatabaseETLOrchestratorAgent());
