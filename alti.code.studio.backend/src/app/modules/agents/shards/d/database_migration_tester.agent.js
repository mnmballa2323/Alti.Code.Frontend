...
class DatabaseMigrationTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseMigrationSystem(objective) {
        logger.info(`💻 [DatabaseMigrationTesterAgent] Analyzing Database Migration Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database Migration Tester Target");
...
export const databaseMigrationTesterAgent = Object.freeze(new DatabaseMigrationTesterAgent());
