...
class DataOrchestrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataOrchestrationSystem(objective) {
    logger.info(
      `💻 [DataOrchestrationAuditorAgent] Analyzing Data Orchestration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Orchestration Auditor Target',
      );
...
export const dataOrchestrationAuditorAgent = Object.freeze(
  new DataOrchestrationAuditorAgent(),
);
