...
class DevSecOpsETLDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateDevSecOpsETLSystem(objective) {
    logger.info(
      `💻 [DevSecOpsETLDeveloperAgent] Analyzing DevSecOps ETL Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevSecOps ETL Developer Target',
      );
...
export const devSecOpsETLDeveloperAgent = Object.freeze(
  new DevSecOpsETLDeveloperAgent(),
);
