...
class DataCachingDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateDataCachingSystem(objective) {
        logger.info(`💻 [DataCachingDeveloperAgent] Analyzing Data Caching Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Caching Developer Target");
...
export const dataCachingDeveloperAgent = Object.freeze(new DataCachingDeveloperAgent());
