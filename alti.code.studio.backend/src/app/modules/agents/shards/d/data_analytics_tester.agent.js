...
class DataAnalyticsTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDataAnalyticsSystem(objective) {
    logger.info(
      `💻 [DataAnalyticsTesterAgent] Analyzing Data Analytics Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Analytics Tester Target',
      );
...
export const dataAnalyticsTesterAgent = Object.freeze(
  new DataAnalyticsTesterAgent(),
);
