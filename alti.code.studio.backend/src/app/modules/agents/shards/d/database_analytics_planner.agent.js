...
class DatabaseAnalyticsPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseAnalyticsSystem(objective) {
    logger.info(
      `💻 [DatabaseAnalyticsPlannerAgent] Analyzing Database Analytics Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Analytics Planner Target',
      );
...
export const databaseAnalyticsPlannerAgent = Object.freeze(
  new DatabaseAnalyticsPlannerAgent(),
);
