...
class DatabaseAnalyticsAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseAnalyticsSystem(objective) {
    logger.info(
      `💻 [DatabaseAnalyticsAuditorAgent] Analyzing Database Analytics Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Analytics Auditor Target',
      );
...
export const databaseAnalyticsAuditorAgent = Object.freeze(
  new DatabaseAnalyticsAuditorAgent(),
);
