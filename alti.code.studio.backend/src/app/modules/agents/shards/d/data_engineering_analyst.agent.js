...
class DataEngineeringAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDataEngineeringSystem(objective) {
    logger.info(
      `💻 [DataEngineeringAnalystAgent] Analyzing Data Engineering Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Engineering Analyst Target',
      );
...
export const dataEngineeringAnalystAgent = Object.freeze(
  new DataEngineeringAnalystAgent(),
);
