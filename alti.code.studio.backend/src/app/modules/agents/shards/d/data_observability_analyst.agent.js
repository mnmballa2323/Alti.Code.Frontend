...
class DataObservabilityAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDataObservabilitySystem(objective) {
    logger.info(
      `💻 [DataObservabilityAnalystAgent] Analyzing Data Observability Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Observability Analyst Target',
      );
...
export const dataObservabilityAnalystAgent = Object.freeze(
  new DataObservabilityAnalystAgent(),
);
