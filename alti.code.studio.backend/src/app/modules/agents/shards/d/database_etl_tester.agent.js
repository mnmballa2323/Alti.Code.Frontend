...
class DatabaseETLTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseETLSystem(objective) {
        logger.info(`💻 [DatabaseETLTesterAgent] Analyzing Database ETL Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database ETL Tester Target");
...
export const databaseETLTesterAgent = Object.freeze(new DatabaseETLTesterAgent());
