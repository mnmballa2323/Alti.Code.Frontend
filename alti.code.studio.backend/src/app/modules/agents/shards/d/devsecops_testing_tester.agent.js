...
class DevSecOpsTestingTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateDevSecOpsTestingSystem(objective) {
        logger.info(`💻 [DevSecOpsTestingTesterAgent] Analyzing DevSecOps Testing Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevSecOps Testing Tester Target");
...
export const devSecOpsTestingTesterAgent = Object.freeze(new DevSecOpsTestingTesterAgent());
