...
class DataProvisioningAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateDataProvisioningSystem(objective) {
    logger.info(
      `💻 [DataProvisioningAnalystAgent] Analyzing Data Provisioning Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Provisioning Analyst Target',
      );
...
export const dataProvisioningAnalystAgent = Object.freeze(
  new DataProvisioningAnalystAgent(),
);
