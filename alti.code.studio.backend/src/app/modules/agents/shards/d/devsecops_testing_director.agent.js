...
class DevSecOpsTestingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateDevSecOpsTestingSystem(objective) {
    logger.info(
      `💻 [DevSecOpsTestingDirectorAgent] Analyzing DevSecOps Testing Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevSecOps Testing Director Target',
      );
...
export const devSecOpsTestingDirectorAgent = Object.freeze(
  new DevSecOpsTestingDirectorAgent(),
);
