...
class DevSecOpsDataLakeTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDevSecOpsDataLakeSystem(objective) {
    logger.info(
      `💻 [DevSecOpsDataLakeTesterAgent] Analyzing DevSecOps DataLake Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevSecOps DataLake Tester Target',
      );
...
export const devSecOpsDataLakeTesterAgent = Object.freeze(
  new DevSecOpsDataLakeTesterAgent(),
);
