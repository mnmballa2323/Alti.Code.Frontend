...
class DataSecurityOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataSecuritySystem(objective) {
    logger.info(
      `💻 [DataSecurityOrchestratorAgent] Analyzing Data Security Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Security Orchestrator Target',
      );
...
export const dataSecurityOrchestratorAgent = Object.freeze(
  new DataSecurityOrchestratorAgent(),
);
