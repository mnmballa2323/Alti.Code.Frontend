...
class DataSecurityArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateDataSecuritySystem(objective) {
    logger.info(
      `💻 [DataSecurityArchitectAgent] Analyzing Data Security Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Security Architect Target',
      );
...
export const dataSecurityArchitectAgent = Object.freeze(
  new DataSecurityArchitectAgent(),
);
