...
class DataIntegrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataIntegrationSystem(objective) {
    logger.info(
      `💻 [DataIntegrationAuditorAgent] Analyzing Data Integration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Integration Auditor Target',
      );
...
export const dataIntegrationAuditorAgent = Object.freeze(
  new DataIntegrationAuditorAgent(),
);
