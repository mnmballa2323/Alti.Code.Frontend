...
class DevOpsMigrationDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsMigrationSystem(objective) {
        logger.info(`💻 [DevOpsMigrationDirectorAgent] Analyzing DevOps Migration Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Migration Director Target");
...
export const devOpsMigrationDirectorAgent = Object.freeze(new DevOpsMigrationDirectorAgent());
