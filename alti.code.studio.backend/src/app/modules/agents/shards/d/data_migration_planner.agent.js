...
class DataMigrationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateDataMigrationSystem(objective) {
    logger.info(
      `💻 [DataMigrationPlannerAgent] Analyzing Data Migration Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Migration Planner Target',
      );
...
export const dataMigrationPlannerAgent = Object.freeze(
  new DataMigrationPlannerAgent(),
);
