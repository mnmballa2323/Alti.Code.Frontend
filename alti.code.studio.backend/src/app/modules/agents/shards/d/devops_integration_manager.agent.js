...
class DevOpsIntegrationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDevOpsIntegrationSystem(objective) {
    logger.info(
      `💻 [DevOpsIntegrationManagerAgent] Analyzing DevOps Integration Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - DevOps Integration Manager Target',
      );
...
export const devOpsIntegrationManagerAgent = Object.freeze(
  new DevOpsIntegrationManagerAgent(),
);
