...
class DevOpsMigrationAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsMigrationSystem(objective) {
        logger.info(`💻 [DevOpsMigrationAnalystAgent] Analyzing DevOps Migration Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Migration Analyst Target");
...
export const devOpsMigrationAnalystAgent = Object.freeze(new DevOpsMigrationAnalystAgent());
