...
class DatabaseResilienceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseResilienceSystem(objective) {
    logger.info(
      `💻 [DatabaseResilienceTesterAgent] Analyzing Database Resilience Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database Resilience Tester Target',
      );
...
export const databaseResilienceTesterAgent = Object.freeze(
  new DatabaseResilienceTesterAgent(),
);
