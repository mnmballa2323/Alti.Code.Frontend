...
class DevOpsGovernanceManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateDevOpsGovernanceSystem(objective) {
        logger.info(`💻 [DevOpsGovernanceManagerAgent] Analyzing DevOps Governance Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - DevOps Governance Manager Target");
...
export const devOpsGovernanceManagerAgent = Object.freeze(new DevOpsGovernanceManagerAgent());
