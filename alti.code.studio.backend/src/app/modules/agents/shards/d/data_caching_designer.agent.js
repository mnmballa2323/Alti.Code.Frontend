...
class DataCachingDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateDataCachingSystem(objective) {
        logger.info(`💻 [DataCachingDesignerAgent] Analyzing Data Caching Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Caching Designer Target");
...
export const dataCachingDesignerAgent = Object.freeze(new DataCachingDesignerAgent());
