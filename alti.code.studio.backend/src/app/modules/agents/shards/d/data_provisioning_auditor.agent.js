...
class DataProvisioningAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateDataProvisioningSystem(objective) {
    logger.info(
      `💻 [DataProvisioningAuditorAgent] Analyzing Data Provisioning Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Provisioning Auditor Target',
      );
...
export const dataProvisioningAuditorAgent = Object.freeze(
  new DataProvisioningAuditorAgent(),
);
