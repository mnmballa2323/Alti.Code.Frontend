...
class DatabaseEngineeringLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateDatabaseEngineeringSystem(objective) {
        logger.info(`💻 [DatabaseEngineeringLeadAgent] Analyzing Database Engineering Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Database Engineering Lead Target");
...
export const databaseEngineeringLeadAgent = Object.freeze(new DatabaseEngineeringLeadAgent());
