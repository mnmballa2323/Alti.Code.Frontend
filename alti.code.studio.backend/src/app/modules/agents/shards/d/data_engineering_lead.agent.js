...
class DataEngineeringLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateDataEngineeringSystem(objective) {
        logger.info(`💻 [DataEngineeringLeadAgent] Analyzing Data Engineering Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Data Engineering Lead Target");
...
export const dataEngineeringLeadAgent = Object.freeze(new DataEngineeringLeadAgent());
