...
class DataStreamingSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateDataStreamingSystem(objective) {
    logger.info(
      `💻 [DataStreamingSpecialistAgent] Analyzing Data Streaming Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Data Streaming Specialist Target',
      );
...
export const dataStreamingSpecialistAgent = Object.freeze(
  new DataStreamingSpecialistAgent(),
);
