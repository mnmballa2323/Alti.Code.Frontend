...
class DatabaseETLManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseETLSystem(objective) {
    logger.info(
      `💻 [DatabaseETLManagerAgent] Analyzing Database ETL Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database ETL Manager Target',
      );
...
export const databaseETLManagerAgent = Object.freeze(
  new DatabaseETLManagerAgent(),
);
