...
class DatabaseETLStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateDatabaseETLSystem(objective) {
    logger.info(
      `💻 [DatabaseETLStrategistAgent] Analyzing Database ETL Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Database ETL Strategist Target',
      );
...
export const databaseETLStrategistAgent = Object.freeze(
  new DatabaseETLStrategistAgent(),
);
