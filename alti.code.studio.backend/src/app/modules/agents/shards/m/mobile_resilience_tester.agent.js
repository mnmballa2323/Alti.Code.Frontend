...
class MobileResilienceTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileResilienceSystem(objective) {
        logger.info(`💻 [MobileResilienceTesterAgent] Analyzing Mobile Resilience Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Resilience Tester Target");
...
export const mobileResilienceTesterAgent = Object.freeze(new MobileResilienceTesterAgent());
