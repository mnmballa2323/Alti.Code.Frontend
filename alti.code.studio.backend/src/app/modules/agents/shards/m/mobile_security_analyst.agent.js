...
class MobileSecurityAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileSecuritySystem(objective) {
    logger.info(
      `💻 [MobileSecurityAnalystAgent] Analyzing Mobile Security Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Security Analyst Target',
      );
...
export const mobileSecurityAnalystAgent = Object.freeze(
  new MobileSecurityAnalystAgent(),
);
