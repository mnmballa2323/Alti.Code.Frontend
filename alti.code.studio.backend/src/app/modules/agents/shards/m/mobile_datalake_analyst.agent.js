...
class MobileDataLakeAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileDataLakeSystem(objective) {
    logger.info(
      `💻 [MobileDataLakeAnalystAgent] Analyzing Mobile DataLake Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile DataLake Analyst Target',
      );
...
export const mobileDataLakeAnalystAgent = Object.freeze(
  new MobileDataLakeAnalystAgent(),
);
