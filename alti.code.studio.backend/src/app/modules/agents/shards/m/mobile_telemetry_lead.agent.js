...
class MobileTelemetryLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileTelemetrySystem(objective) {
    logger.info(
      `💻 [MobileTelemetryLeadAgent] Analyzing Mobile Telemetry Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Telemetry Lead Target',
      );
...
export const mobileTelemetryLeadAgent = Object.freeze(
  new MobileTelemetryLeadAgent(),
);
