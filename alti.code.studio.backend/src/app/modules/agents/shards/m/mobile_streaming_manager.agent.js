...
class MobileStreamingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileStreamingSystem(objective) {
    logger.info(
      `💻 [MobileStreamingManagerAgent] Analyzing Mobile Streaming Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Streaming Manager Target',
      );
...
export const mobileStreamingManagerAgent = Object.freeze(
  new MobileStreamingManagerAgent(),
);
