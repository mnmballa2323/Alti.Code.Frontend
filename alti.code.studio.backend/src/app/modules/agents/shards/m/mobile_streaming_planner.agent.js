...
class MobileStreamingPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileStreamingSystem(objective) {
    logger.info(
      `💻 [MobileStreamingPlannerAgent] Analyzing Mobile Streaming Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Streaming Planner Target',
      );
...
export const mobileStreamingPlannerAgent = Object.freeze(
  new MobileStreamingPlannerAgent(),
);
