...
class MobileServerlessPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileServerlessSystem(objective) {
    logger.info(
      `💻 [MobileServerlessPlannerAgent] Analyzing Mobile Serverless Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Serverless Planner Target',
      );
...
export const mobileServerlessPlannerAgent = Object.freeze(
  new MobileServerlessPlannerAgent(),
);
