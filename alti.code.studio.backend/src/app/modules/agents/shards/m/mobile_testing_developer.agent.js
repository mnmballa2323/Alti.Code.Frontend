...
class MobileTestingDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileTestingSystem(objective) {
    logger.info(
      `💻 [MobileTestingDeveloperAgent] Analyzing Mobile Testing Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Testing Developer Target',
      );
...
export const mobileTestingDeveloperAgent = Object.freeze(
  new MobileTestingDeveloperAgent(),
);
