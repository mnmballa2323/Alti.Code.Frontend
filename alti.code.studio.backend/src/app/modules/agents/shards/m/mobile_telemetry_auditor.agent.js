...
class MobileTelemetryAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileTelemetrySystem(objective) {
        logger.info(`💻 [MobileTelemetryAuditorAgent] Analyzing Mobile Telemetry Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Telemetry Auditor Target");
...
export const mobileTelemetryAuditorAgent = Object.freeze(new MobileTelemetryAuditorAgent());
