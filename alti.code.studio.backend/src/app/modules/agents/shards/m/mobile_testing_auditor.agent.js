...
class MobileTestingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileTestingSystem(objective) {
    logger.info(
      `💻 [MobileTestingAuditorAgent] Analyzing Mobile Testing Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Testing Auditor Target',
      );
...
export const mobileTestingAuditorAgent = Object.freeze(
  new MobileTestingAuditorAgent(),
);
