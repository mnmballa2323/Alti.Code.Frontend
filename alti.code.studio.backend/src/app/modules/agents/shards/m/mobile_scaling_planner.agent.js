...
class MobileScalingPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileScalingSystem(objective) {
    logger.info(
      `💻 [MobileScalingPlannerAgent] Analyzing Mobile Scaling Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Scaling Planner Target',
      );
...
export const mobileScalingPlannerAgent = Object.freeze(
  new MobileScalingPlannerAgent(),
);
