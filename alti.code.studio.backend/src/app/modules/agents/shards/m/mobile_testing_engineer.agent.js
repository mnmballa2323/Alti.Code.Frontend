...
class MobileTestingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileTestingSystem(objective) {
    logger.info(
      `💻 [MobileTestingEngineerAgent] Analyzing Mobile Testing Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Testing Engineer Target',
      );
...
export const mobileTestingEngineerAgent = Object.freeze(
  new MobileTestingEngineerAgent(),
);
