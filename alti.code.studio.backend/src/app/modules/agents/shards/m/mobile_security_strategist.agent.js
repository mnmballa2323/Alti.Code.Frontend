...
class MobileSecurityStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileSecuritySystem(objective) {
    logger.info(
      `💻 [MobileSecurityStrategistAgent] Analyzing Mobile Security Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Security Strategist Target',
      );
...
export const mobileSecurityStrategistAgent = Object.freeze(
  new MobileSecurityStrategistAgent(),
);
