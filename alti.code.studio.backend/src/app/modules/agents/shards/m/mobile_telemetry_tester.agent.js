...
class MobileTelemetryTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileTelemetrySystem(objective) {
    logger.info(
      `💻 [MobileTelemetryTesterAgent] Analyzing Mobile Telemetry Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Telemetry Tester Target',
      );
...
export const mobileTelemetryTesterAgent = Object.freeze(
  new MobileTelemetryTesterAgent(),
);
