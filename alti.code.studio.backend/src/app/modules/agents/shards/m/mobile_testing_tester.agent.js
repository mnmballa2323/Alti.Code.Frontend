...
class MobileTestingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileTestingSystem(objective) {
    logger.info(
      `💻 [MobileTestingTesterAgent] Analyzing Mobile Testing Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Testing Tester Target',
      );
...
export const mobileTestingTesterAgent = Object.freeze(
  new MobileTestingTesterAgent(),
);
