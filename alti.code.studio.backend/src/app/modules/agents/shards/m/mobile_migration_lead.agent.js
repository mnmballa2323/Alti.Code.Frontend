...
class MobileMigrationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileMigrationSystem(objective) {
    logger.info(
      `💻 [MobileMigrationLeadAgent] Analyzing Mobile Migration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Migration Lead Target',
      );
...
export const mobileMigrationLeadAgent = Object.freeze(
  new MobileMigrationLeadAgent(),
);
