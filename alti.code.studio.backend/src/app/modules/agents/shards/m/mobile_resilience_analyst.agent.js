...
class MobileResilienceAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileResilienceSystem(objective) {
    logger.info(
      `💻 [MobileResilienceAnalystAgent] Analyzing Mobile Resilience Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Resilience Analyst Target',
      );
...
export const mobileResilienceAnalystAgent = Object.freeze(
  new MobileResilienceAnalystAgent(),
);
