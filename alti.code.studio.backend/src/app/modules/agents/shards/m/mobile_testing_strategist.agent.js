...
class MobileTestingStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileTestingSystem(objective) {
    logger.info(
      `💻 [MobileTestingStrategistAgent] Analyzing Mobile Testing Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Testing Strategist Target',
      );
...
export const mobileTestingStrategistAgent = Object.freeze(
  new MobileTestingStrategistAgent(),
);
