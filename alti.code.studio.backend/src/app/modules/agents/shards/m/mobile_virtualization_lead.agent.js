...
class MobileVirtualizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileVirtualizationSystem(objective) {
    logger.info(
      `💻 [MobileVirtualizationLeadAgent] Analyzing Mobile Virtualization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Virtualization Lead Target',
      );
...
export const mobileVirtualizationLeadAgent = Object.freeze(
  new MobileVirtualizationLeadAgent(),
);
