...
class MobileDataLakePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileDataLakeSystem(objective) {
    logger.info(
      `💻 [MobileDataLakePlannerAgent] Analyzing Mobile DataLake Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile DataLake Planner Target',
      );
...
export const mobileDataLakePlannerAgent = Object.freeze(
  new MobileDataLakePlannerAgent(),
);
