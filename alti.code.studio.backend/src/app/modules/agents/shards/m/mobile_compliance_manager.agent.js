...
class MobileComplianceManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileComplianceSystem(objective) {
    logger.info(
      `💻 [MobileComplianceManagerAgent] Analyzing Mobile Compliance Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Compliance Manager Target',
      );
...
export const mobileComplianceManagerAgent = Object.freeze(
  new MobileComplianceManagerAgent(),
);
