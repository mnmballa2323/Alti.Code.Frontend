...
class MobileResiliencePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileResilienceSystem(objective) {
    logger.info(
      `💻 [MobileResiliencePlannerAgent] Analyzing Mobile Resilience Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Resilience Planner Target',
      );
...
export const mobileResiliencePlannerAgent = Object.freeze(
  new MobileResiliencePlannerAgent(),
);
