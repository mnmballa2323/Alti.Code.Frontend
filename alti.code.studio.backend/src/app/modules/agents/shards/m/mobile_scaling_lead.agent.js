...
class MobileScalingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileScalingSystem(objective) {
    logger.info(
      `💻 [MobileScalingLeadAgent] Analyzing Mobile Scaling Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Scaling Lead Target',
      );
...
export const mobileScalingLeadAgent = Object.freeze(
  new MobileScalingLeadAgent(),
);
