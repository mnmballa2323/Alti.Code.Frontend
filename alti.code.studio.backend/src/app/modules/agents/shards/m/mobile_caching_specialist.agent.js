...
class MobileCachingSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileCachingSystem(objective) {
    logger.info(
      `💻 [MobileCachingSpecialistAgent] Analyzing Mobile Caching Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Caching Specialist Target',
      );
...
export const mobileCachingSpecialistAgent = Object.freeze(
  new MobileCachingSpecialistAgent(),
);
