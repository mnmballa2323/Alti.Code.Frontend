...
class MobileOptimizationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileOptimizationSystem(objective) {
    logger.info(
      `💻 [MobileOptimizationTesterAgent] Analyzing Mobile Optimization Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Optimization Tester Target',
      );
...
export const mobileOptimizationTesterAgent = Object.freeze(
  new MobileOptimizationTesterAgent(),
);
