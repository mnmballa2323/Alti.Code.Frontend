...
class MobileCachingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileCachingSystem(objective) {
    logger.info(
      `💻 [MobileCachingAuditorAgent] Analyzing Mobile Caching Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Caching Auditor Target',
      );
...
export const mobileCachingAuditorAgent = Object.freeze(
  new MobileCachingAuditorAgent(),
);
