...
class MobileAutomationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileAutomationSystem(objective) {
    logger.info(
      `💻 [MobileAutomationTesterAgent] Analyzing Mobile Automation Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Automation Tester Target',
      );
...
export const mobileAutomationTesterAgent = Object.freeze(
  new MobileAutomationTesterAgent(),
);
