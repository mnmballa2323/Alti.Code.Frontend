...
class MobileAnalyticsManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileAnalyticsSystem(objective) {
    logger.info(
      `💻 [MobileAnalyticsManagerAgent] Analyzing Mobile Analytics Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Analytics Manager Target',
      );
...
export const mobileAnalyticsManagerAgent = Object.freeze(
  new MobileAnalyticsManagerAgent(),
);
