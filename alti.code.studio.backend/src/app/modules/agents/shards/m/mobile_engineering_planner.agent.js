...
class MobileEngineeringPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileEngineeringSystem(objective) {
    logger.info(
      `💻 [MobileEngineeringPlannerAgent] Analyzing Mobile Engineering Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Engineering Planner Target',
      );
...
export const mobileEngineeringPlannerAgent = Object.freeze(
  new MobileEngineeringPlannerAgent(),
);
