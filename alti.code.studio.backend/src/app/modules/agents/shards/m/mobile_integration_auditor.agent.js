...
class MobileIntegrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileIntegrationSystem(objective) {
    logger.info(
      `💻 [MobileIntegrationAuditorAgent] Analyzing Mobile Integration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Integration Auditor Target',
      );
...
export const mobileIntegrationAuditorAgent = Object.freeze(
  new MobileIntegrationAuditorAgent(),
);
