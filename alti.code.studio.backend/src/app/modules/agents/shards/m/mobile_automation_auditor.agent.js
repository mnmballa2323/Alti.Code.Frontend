...
class MobileAutomationAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileAutomationSystem(objective) {
        logger.info(`💻 [MobileAutomationAuditorAgent] Analyzing Mobile Automation Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Automation Auditor Target");
...
export const mobileAutomationAuditorAgent = Object.freeze(new MobileAutomationAuditorAgent());
