...
class MobileAutomationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileAutomationSystem(objective) {
    logger.info(
      `💻 [MobileAutomationAnalystAgent] Analyzing Mobile Automation Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Automation Analyst Target',
      );
...
export const mobileAutomationAnalystAgent = Object.freeze(
  new MobileAutomationAnalystAgent(),
);
