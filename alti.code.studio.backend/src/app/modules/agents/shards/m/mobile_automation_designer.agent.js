...
class MobileAutomationDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileAutomationSystem(objective) {
        logger.info(`💻 [MobileAutomationDesignerAgent] Analyzing Mobile Automation Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Automation Designer Target");
...
export const mobileAutomationDesignerAgent = Object.freeze(new MobileAutomationDesignerAgent());
