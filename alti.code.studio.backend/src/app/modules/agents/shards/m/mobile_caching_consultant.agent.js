...
class MobileCachingConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileCachingSystem(objective) {
        logger.info(`💻 [MobileCachingConsultantAgent] Analyzing Mobile Caching Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Caching Consultant Target");
...
export const mobileCachingConsultantAgent = Object.freeze(new MobileCachingConsultantAgent());
