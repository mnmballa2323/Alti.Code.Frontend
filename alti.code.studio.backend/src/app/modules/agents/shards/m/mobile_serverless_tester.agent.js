...
class MobileServerlessTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileServerlessSystem(objective) {
        logger.info(`💻 [MobileServerlessTesterAgent] Analyzing Mobile Serverless Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Serverless Tester Target");
...
export const mobileServerlessTesterAgent = Object.freeze(new MobileServerlessTesterAgent());
