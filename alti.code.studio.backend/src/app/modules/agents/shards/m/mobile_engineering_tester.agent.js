...
class MobileEngineeringTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileEngineeringSystem(objective) {
    logger.info(
      `💻 [MobileEngineeringTesterAgent] Analyzing Mobile Engineering Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Engineering Tester Target',
      );
...
export const mobileEngineeringTesterAgent = Object.freeze(
  new MobileEngineeringTesterAgent(),
);
