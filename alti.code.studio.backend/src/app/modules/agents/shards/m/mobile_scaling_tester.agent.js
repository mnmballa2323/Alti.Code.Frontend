...
class MobileScalingTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileScalingSystem(objective) {
        logger.info(`💻 [MobileScalingTesterAgent] Analyzing Mobile Scaling Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Scaling Tester Target");
...
export const mobileScalingTesterAgent = Object.freeze(new MobileScalingTesterAgent());
