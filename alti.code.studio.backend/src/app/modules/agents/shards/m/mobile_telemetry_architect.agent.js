...
class MobileTelemetryArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileTelemetrySystem(objective) {
    logger.info(
      `💻 [MobileTelemetryArchitectAgent] Analyzing Mobile Telemetry Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Telemetry Architect Target',
      );
...
export const mobileTelemetryArchitectAgent = Object.freeze(
  new MobileTelemetryArchitectAgent(),
);
