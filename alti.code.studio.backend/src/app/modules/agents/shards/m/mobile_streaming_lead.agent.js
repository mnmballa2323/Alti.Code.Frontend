...
class MobileStreamingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileStreamingSystem(objective) {
    logger.info(
      `💻 [MobileStreamingLeadAgent] Analyzing Mobile Streaming Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Streaming Lead Target',
      );
...
export const mobileStreamingLeadAgent = Object.freeze(
  new MobileStreamingLeadAgent(),
);
