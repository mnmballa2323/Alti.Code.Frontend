...
class MobileGovernanceAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileGovernanceSystem(objective) {
        logger.info(`💻 [MobileGovernanceAuditorAgent] Analyzing Mobile Governance Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Governance Auditor Target");
...
export const mobileGovernanceAuditorAgent = Object.freeze(new MobileGovernanceAuditorAgent());
