...
class MobileCachingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileCachingSystem(objective) {
    logger.info(
      `💻 [MobileCachingDirectorAgent] Analyzing Mobile Caching Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Caching Director Target',
      );
...
export const mobileCachingDirectorAgent = Object.freeze(
  new MobileCachingDirectorAgent(),
);
