...
class MobileSecurityAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileSecuritySystem(objective) {
        logger.info(`💻 [MobileSecurityAuditorAgent] Analyzing Mobile Security Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Security Auditor Target");
...
export const mobileSecurityAuditorAgent = Object.freeze(new MobileSecurityAuditorAgent());
