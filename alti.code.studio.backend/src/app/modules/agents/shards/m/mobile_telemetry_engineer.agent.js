...
class MobileTelemetryEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileTelemetrySystem(objective) {
    logger.info(
      `💻 [MobileTelemetryEngineerAgent] Analyzing Mobile Telemetry Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Telemetry Engineer Target',
      );
...
export const mobileTelemetryEngineerAgent = Object.freeze(
  new MobileTelemetryEngineerAgent(),
);
