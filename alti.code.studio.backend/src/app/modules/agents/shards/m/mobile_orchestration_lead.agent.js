...
class MobileOrchestrationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileOrchestrationSystem(objective) {
    logger.info(
      `💻 [MobileOrchestrationLeadAgent] Analyzing Mobile Orchestration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Orchestration Lead Target',
      );
...
export const mobileOrchestrationLeadAgent = Object.freeze(
  new MobileOrchestrationLeadAgent(),
);
