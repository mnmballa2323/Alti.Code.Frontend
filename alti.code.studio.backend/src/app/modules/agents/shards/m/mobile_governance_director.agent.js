...
class MobileGovernanceDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileGovernanceSystem(objective) {
    logger.info(
      `💻 [MobileGovernanceDirectorAgent] Analyzing Mobile Governance Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Governance Director Target',
      );
...
export const mobileGovernanceDirectorAgent = Object.freeze(
  new MobileGovernanceDirectorAgent(),
);
