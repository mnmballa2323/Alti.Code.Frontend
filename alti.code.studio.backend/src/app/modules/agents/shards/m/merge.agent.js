...
class MergeAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Final approving authority for Pull Requests, executing the script-first deterministic OpenClaw `merge-pr` skill.';
...
export const mergeAgent = Object.freeze(new MergeAgent());
