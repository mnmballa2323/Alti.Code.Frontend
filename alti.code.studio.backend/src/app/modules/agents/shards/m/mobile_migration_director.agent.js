...
class MobileMigrationDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileMigrationSystem(objective) {
    logger.info(
      `💻 [MobileMigrationDirectorAgent] Analyzing Mobile Migration Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Migration Director Target',
      );
...
export const mobileMigrationDirectorAgent = Object.freeze(
  new MobileMigrationDirectorAgent(),
);
