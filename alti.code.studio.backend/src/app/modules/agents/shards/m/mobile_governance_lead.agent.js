...
class MobileGovernanceLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileGovernanceSystem(objective) {
    logger.info(
      `💻 [MobileGovernanceLeadAgent] Analyzing Mobile Governance Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Governance Lead Target',
      );
...
export const mobileGovernanceLeadAgent = Object.freeze(
  new MobileGovernanceLeadAgent(),
);
