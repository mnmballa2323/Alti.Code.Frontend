...
class MobileComplianceDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileComplianceSystem(objective) {
        logger.info(`💻 [MobileComplianceDirectorAgent] Analyzing Mobile Compliance Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Compliance Director Target");
...
export const mobileComplianceDirectorAgent = Object.freeze(new MobileComplianceDirectorAgent());
