...
class MobileSecurityEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileSecuritySystem(objective) {
    logger.info(
      `💻 [MobileSecurityEngineerAgent] Analyzing Mobile Security Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Security Engineer Target',
      );
...
export const mobileSecurityEngineerAgent = Object.freeze(
  new MobileSecurityEngineerAgent(),
);
