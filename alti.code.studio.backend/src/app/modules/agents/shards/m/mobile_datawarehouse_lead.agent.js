...
class MobileDataWarehouseLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileDataWarehouseSystem(objective) {
        logger.info(`💻 [MobileDataWarehouseLeadAgent] Analyzing Mobile DataWarehouse Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile DataWarehouse Lead Target");
...
export const mobileDataWarehouseLeadAgent = Object.freeze(new MobileDataWarehouseLeadAgent());
