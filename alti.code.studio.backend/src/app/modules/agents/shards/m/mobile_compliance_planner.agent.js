...
class MobileCompliancePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileComplianceSystem(objective) {
    logger.info(
      `💻 [MobileCompliancePlannerAgent] Analyzing Mobile Compliance Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Compliance Planner Target',
      );
...
export const mobileCompliancePlannerAgent = Object.freeze(
  new MobileCompliancePlannerAgent(),
);
