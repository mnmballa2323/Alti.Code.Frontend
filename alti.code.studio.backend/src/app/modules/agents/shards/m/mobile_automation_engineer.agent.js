...
class MobileAutomationEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileAutomationSystem(objective) {
    logger.info(
      `💻 [MobileAutomationEngineerAgent] Analyzing Mobile Automation Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Automation Engineer Target',
      );
...
export const mobileAutomationEngineerAgent = Object.freeze(
  new MobileAutomationEngineerAgent(),
);
