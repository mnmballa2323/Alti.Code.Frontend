...
class MobileSecurityArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileSecuritySystem(objective) {
    logger.info(
      `💻 [MobileSecurityArchitectAgent] Analyzing Mobile Security Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Security Architect Target',
      );
...
export const mobileSecurityArchitectAgent = Object.freeze(
  new MobileSecurityArchitectAgent(),
);
