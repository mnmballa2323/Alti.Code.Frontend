...
class MobileAnalyticsAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileAnalyticsSystem(objective) {
    logger.info(
      `💻 [MobileAnalyticsAnalystAgent] Analyzing Mobile Analytics Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Analytics Analyst Target',
      );
...
export const mobileAnalyticsAnalystAgent = Object.freeze(
  new MobileAnalyticsAnalystAgent(),
);
