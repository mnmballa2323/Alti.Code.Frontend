...
class MobileMigrationPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileMigrationSystem(objective) {
        logger.info(`💻 [MobileMigrationPlannerAgent] Analyzing Mobile Migration Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Migration Planner Target");
...
export const mobileMigrationPlannerAgent = Object.freeze(new MobileMigrationPlannerAgent());
