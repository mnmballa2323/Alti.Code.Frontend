...
class MobileCachingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileCachingSystem(objective) {
    logger.info(
      `💻 [MobileCachingDesignerAgent] Analyzing Mobile Caching Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Caching Designer Target',
      );
...
export const mobileCachingDesignerAgent = Object.freeze(
  new MobileCachingDesignerAgent(),
);
