...
class MobileETLDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileETLSystem(objective) {
        logger.info(`💻 [MobileETLDesignerAgent] Analyzing Mobile ETL Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile ETL Designer Target");
...
export const mobileETLDesignerAgent = Object.freeze(new MobileETLDesignerAgent());
