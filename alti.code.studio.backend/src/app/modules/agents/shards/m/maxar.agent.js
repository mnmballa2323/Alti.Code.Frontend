...
class MaxarAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Geospatial imagery intelligence, tasking, and high-res Maxar satellite image processing.';
...
export const maxarAgent = Object.freeze(new MaxarAgent());
