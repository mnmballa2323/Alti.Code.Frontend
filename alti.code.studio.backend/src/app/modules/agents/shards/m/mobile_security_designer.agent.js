...
class MobileSecurityDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileSecuritySystem(objective) {
    logger.info(
      `💻 [MobileSecurityDesignerAgent] Analyzing Mobile Security Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Security Designer Target',
      );
...
export const mobileSecurityDesignerAgent = Object.freeze(
  new MobileSecurityDesignerAgent(),
);
