...
class MobileTestingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileTestingSystem(objective) {
    logger.info(
      `💻 [MobileTestingDesignerAgent] Analyzing Mobile Testing Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Testing Designer Target',
      );
...
export const mobileTestingDesignerAgent = Object.freeze(
  new MobileTestingDesignerAgent(),
);
