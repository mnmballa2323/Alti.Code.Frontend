...
class MobileStreamingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileStreamingSystem(objective) {
    logger.info(
      `💻 [MobileStreamingDirectorAgent] Analyzing Mobile Streaming Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Streaming Director Target',
      );
...
export const mobileStreamingDirectorAgent = Object.freeze(
  new MobileStreamingDirectorAgent(),
);
