...
class MobileProvisioningLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileProvisioningSystem(objective) {
    logger.info(
      `💻 [MobileProvisioningLeadAgent] Analyzing Mobile Provisioning Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Provisioning Lead Target',
      );
...
export const mobileProvisioningLeadAgent = Object.freeze(
  new MobileProvisioningLeadAgent(),
);
