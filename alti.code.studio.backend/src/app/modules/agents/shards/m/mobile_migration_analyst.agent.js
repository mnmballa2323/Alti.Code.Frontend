...
class MobileMigrationAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileMigrationSystem(objective) {
        logger.info(`💻 [MobileMigrationAnalystAgent] Analyzing Mobile Migration Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Migration Analyst Target");
...
export const mobileMigrationAnalystAgent = Object.freeze(new MobileMigrationAnalystAgent());
