...
class MobileDeploymentAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileDeploymentSystem(objective) {
    logger.info(
      `💻 [MobileDeploymentAnalystAgent] Analyzing Mobile Deployment Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Deployment Analyst Target',
      );
...
export const mobileDeploymentAnalystAgent = Object.freeze(
  new MobileDeploymentAnalystAgent(),
);
