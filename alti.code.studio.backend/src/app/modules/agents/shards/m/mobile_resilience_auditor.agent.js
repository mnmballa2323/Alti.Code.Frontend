...
class MobileResilienceAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileResilienceSystem(objective) {
        logger.info(`💻 [MobileResilienceAuditorAgent] Analyzing Mobile Resilience Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Resilience Auditor Target");
...
export const mobileResilienceAuditorAgent = Object.freeze(new MobileResilienceAuditorAgent());
