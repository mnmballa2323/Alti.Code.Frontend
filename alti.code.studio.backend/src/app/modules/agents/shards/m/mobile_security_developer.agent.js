...
class MobileSecurityDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileSecuritySystem(objective) {
    logger.info(
      `💻 [MobileSecurityDeveloperAgent] Analyzing Mobile Security Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Security Developer Target',
      );
...
export const mobileSecurityDeveloperAgent = Object.freeze(
  new MobileSecurityDeveloperAgent(),
);
