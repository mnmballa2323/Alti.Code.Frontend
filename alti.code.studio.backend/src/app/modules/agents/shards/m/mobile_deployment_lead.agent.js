...
class MobileDeploymentLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileDeploymentSystem(objective) {
        logger.info(`💻 [MobileDeploymentLeadAgent] Analyzing Mobile Deployment Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Deployment Lead Target");
...
export const mobileDeploymentLeadAgent = Object.freeze(new MobileDeploymentLeadAgent());
