...
class MobileIntegrationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileIntegrationSystem(objective) {
    logger.info(
      `💻 [MobileIntegrationPlannerAgent] Analyzing Mobile Integration Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Integration Planner Target',
      );
...
export const mobileIntegrationPlannerAgent = Object.freeze(
  new MobileIntegrationPlannerAgent(),
);
