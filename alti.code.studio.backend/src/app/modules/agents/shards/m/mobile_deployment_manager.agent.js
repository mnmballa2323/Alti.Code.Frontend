...
class MobileDeploymentManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileDeploymentSystem(objective) {
    logger.info(
      `💻 [MobileDeploymentManagerAgent] Analyzing Mobile Deployment Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Deployment Manager Target',
      );
...
export const mobileDeploymentManagerAgent = Object.freeze(
  new MobileDeploymentManagerAgent(),
);
