...
class MobileGovernanceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileGovernanceSystem(objective) {
    logger.info(
      `💻 [MobileGovernanceTesterAgent] Analyzing Mobile Governance Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Governance Tester Target',
      );
...
export const mobileGovernanceTesterAgent = Object.freeze(
  new MobileGovernanceTesterAgent(),
);
