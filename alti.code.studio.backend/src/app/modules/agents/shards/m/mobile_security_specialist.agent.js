...
class MobileSecuritySpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileSecuritySystem(objective) {
        logger.info(`💻 [MobileSecuritySpecialistAgent] Analyzing Mobile Security Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Security Specialist Target");
...
export const mobileSecuritySpecialistAgent = Object.freeze(new MobileSecuritySpecialistAgent());
