...
class MobileETLEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileETLSystem(objective) {
    logger.info(
      `💻 [MobileETLEngineerAgent] Analyzing Mobile ETL Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile ETL Engineer Target',
      );
...
export const mobileETLEngineerAgent = Object.freeze(
  new MobileETLEngineerAgent(),
);
