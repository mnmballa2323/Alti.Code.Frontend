...
class MobileDeploymentDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileDeploymentSystem(objective) {
    logger.info(
      `💻 [MobileDeploymentDirectorAgent] Analyzing Mobile Deployment Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Deployment Director Target',
      );
...
export const mobileDeploymentDirectorAgent = Object.freeze(
  new MobileDeploymentDirectorAgent(),
);
