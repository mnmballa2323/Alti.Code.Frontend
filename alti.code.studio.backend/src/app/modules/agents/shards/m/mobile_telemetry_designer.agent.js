...
class MobileTelemetryDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileTelemetrySystem(objective) {
    logger.info(
      `💻 [MobileTelemetryDesignerAgent] Analyzing Mobile Telemetry Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Telemetry Designer Target',
      );
...
export const mobileTelemetryDesignerAgent = Object.freeze(
  new MobileTelemetryDesignerAgent(),
);
