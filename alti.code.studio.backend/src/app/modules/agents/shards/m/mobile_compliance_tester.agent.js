...
class MobileComplianceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileComplianceSystem(objective) {
    logger.info(
      `💻 [MobileComplianceTesterAgent] Analyzing Mobile Compliance Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Compliance Tester Target',
      );
...
export const mobileComplianceTesterAgent = Object.freeze(
  new MobileComplianceTesterAgent(),
);
