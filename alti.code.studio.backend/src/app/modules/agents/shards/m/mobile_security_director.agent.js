...
class MobileSecurityDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileSecuritySystem(objective) {
    logger.info(
      `💻 [MobileSecurityDirectorAgent] Analyzing Mobile Security Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Security Director Target',
      );
...
export const mobileSecurityDirectorAgent = Object.freeze(
  new MobileSecurityDirectorAgent(),
);
