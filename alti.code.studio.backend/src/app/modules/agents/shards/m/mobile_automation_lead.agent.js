...
class MobileAutomationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileAutomationSystem(objective) {
        logger.info(`💻 [MobileAutomationLeadAgent] Analyzing Mobile Automation Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Automation Lead Target");
...
export const mobileAutomationLeadAgent = Object.freeze(new MobileAutomationLeadAgent());
