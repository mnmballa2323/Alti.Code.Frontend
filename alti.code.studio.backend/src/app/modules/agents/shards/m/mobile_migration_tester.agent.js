...
class MobileMigrationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileMigrationSystem(objective) {
    logger.info(
      `💻 [MobileMigrationTesterAgent] Analyzing Mobile Migration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Migration Tester Target',
      );
...
export const mobileMigrationTesterAgent = Object.freeze(
  new MobileMigrationTesterAgent(),
);
