...
class MobileAnalyticsAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileAnalyticsSystem(objective) {
        logger.info(`💻 [MobileAnalyticsAuditorAgent] Analyzing Mobile Analytics Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Analytics Auditor Target");
...
export const mobileAnalyticsAuditorAgent = Object.freeze(new MobileAnalyticsAuditorAgent());
