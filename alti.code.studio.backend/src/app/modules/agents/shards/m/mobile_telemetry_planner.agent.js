...
class MobileTelemetryPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileTelemetrySystem(objective) {
        logger.info(`💻 [MobileTelemetryPlannerAgent] Analyzing Mobile Telemetry Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Telemetry Planner Target");
...
export const mobileTelemetryPlannerAgent = Object.freeze(new MobileTelemetryPlannerAgent());
