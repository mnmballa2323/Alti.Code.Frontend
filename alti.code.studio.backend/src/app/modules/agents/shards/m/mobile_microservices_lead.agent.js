...
class MobileMicroservicesLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileMicroservicesSystem(objective) {
        logger.info(`💻 [MobileMicroservicesLeadAgent] Analyzing Mobile Microservices Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Microservices Lead Target");
...
export const mobileMicroservicesLeadAgent = Object.freeze(new MobileMicroservicesLeadAgent());
