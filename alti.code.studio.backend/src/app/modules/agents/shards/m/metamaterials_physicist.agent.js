...
class MetamaterialsPhysicistAgent extends GeminiCliBaseAgent {
  ...
  async generateMetamaterialsSystem(objective) {
    logger.info(
      `🪞 [MetamaterialsPhysicist] Analyzing negative refraction and sub-wavelength acoustics...`,
    );
...
export const metamaterialsPhysicistAgent = Object.freeze(
  new MetamaterialsPhysicistAgent(),
);
