...
class MobileCachingEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileCachingSystem(objective) {
        logger.info(`💻 [MobileCachingEngineerAgent] Analyzing Mobile Caching Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Caching Engineer Target");
...
export const mobileCachingEngineerAgent = Object.freeze(new MobileCachingEngineerAgent());
