...
class MobileComplianceAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileComplianceSystem(objective) {
    logger.info(
      `💻 [MobileComplianceAnalystAgent] Analyzing Mobile Compliance Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Compliance Analyst Target',
      );
...
export const mobileComplianceAnalystAgent = Object.freeze(
  new MobileComplianceAnalystAgent(),
);
