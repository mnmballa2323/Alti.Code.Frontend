...
class MobileAnalyticsTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileAnalyticsSystem(objective) {
    logger.info(
      `💻 [MobileAnalyticsTesterAgent] Analyzing Mobile Analytics Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Analytics Tester Target',
      );
...
export const mobileAnalyticsTesterAgent = Object.freeze(
  new MobileAnalyticsTesterAgent(),
);
