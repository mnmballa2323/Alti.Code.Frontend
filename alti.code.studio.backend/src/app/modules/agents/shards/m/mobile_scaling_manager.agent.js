...
class MobileScalingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileScalingSystem(objective) {
    logger.info(
      `💻 [MobileScalingManagerAgent] Analyzing Mobile Scaling Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Scaling Manager Target',
      );
...
export const mobileScalingManagerAgent = Object.freeze(
  new MobileScalingManagerAgent(),
);
