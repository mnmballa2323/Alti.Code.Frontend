...
class MobileLoadBalancingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileLoadBalancingSystem(objective) {
    logger.info(
      `💻 [MobileLoadBalancingLeadAgent] Analyzing Mobile LoadBalancing Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile LoadBalancing Lead Target',
      );
...
export const mobileLoadBalancingLeadAgent = Object.freeze(
  new MobileLoadBalancingLeadAgent(),
);
