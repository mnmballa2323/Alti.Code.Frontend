...
class MobileAnalyticsDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileAnalyticsSystem(objective) {
    logger.info(
      `💻 [MobileAnalyticsDeveloperAgent] Analyzing Mobile Analytics Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Analytics Developer Target',
      );
...
export const mobileAnalyticsDeveloperAgent = Object.freeze(
  new MobileAnalyticsDeveloperAgent(),
);
