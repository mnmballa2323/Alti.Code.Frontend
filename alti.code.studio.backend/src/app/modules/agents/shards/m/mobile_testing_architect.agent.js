...
class MobileTestingArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileTestingSystem(objective) {
    logger.info(
      `💻 [MobileTestingArchitectAgent] Analyzing Mobile Testing Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Testing Architect Target',
      );
...
export const mobileTestingArchitectAgent = Object.freeze(
  new MobileTestingArchitectAgent(),
);
