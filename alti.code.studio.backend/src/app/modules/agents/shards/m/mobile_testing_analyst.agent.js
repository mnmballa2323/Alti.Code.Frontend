...
class MobileTestingAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileTestingSystem(objective) {
    logger.info(
      `💻 [MobileTestingAnalystAgent] Analyzing Mobile Testing Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Testing Analyst Target',
      );
...
export const mobileTestingAnalystAgent = Object.freeze(
  new MobileTestingAnalystAgent(),
);
