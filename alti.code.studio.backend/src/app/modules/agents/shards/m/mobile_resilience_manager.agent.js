...
class MobileResilienceManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileResilienceSystem(objective) {
    logger.info(
      `💻 [MobileResilienceManagerAgent] Analyzing Mobile Resilience Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Resilience Manager Target',
      );
...
export const mobileResilienceManagerAgent = Object.freeze(
  new MobileResilienceManagerAgent(),
);
