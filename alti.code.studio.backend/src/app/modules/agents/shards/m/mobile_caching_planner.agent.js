...
class MobileCachingPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileCachingSystem(objective) {
    logger.info(
      `💻 [MobileCachingPlannerAgent] Analyzing Mobile Caching Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Caching Planner Target',
      );
...
export const mobileCachingPlannerAgent = Object.freeze(
  new MobileCachingPlannerAgent(),
);
