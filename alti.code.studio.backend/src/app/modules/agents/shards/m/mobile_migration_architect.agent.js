...
class MobileMigrationArchitectAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileMigrationSystem(objective) {
        logger.info(`💻 [MobileMigrationArchitectAgent] Analyzing Mobile Migration Architect specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Migration Architect Target");
...
export const mobileMigrationArchitectAgent = Object.freeze(new MobileMigrationArchitectAgent());
