...
class MobileServerlessManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileServerlessSystem(objective) {
    logger.info(
      `💻 [MobileServerlessManagerAgent] Analyzing Mobile Serverless Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Serverless Manager Target',
      );
...
export const mobileServerlessManagerAgent = Object.freeze(
  new MobileServerlessManagerAgent(),
);
