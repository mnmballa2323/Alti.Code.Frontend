...
class MobileEngineeringManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileEngineeringSystem(objective) {
    logger.info(
      `💻 [MobileEngineeringManagerAgent] Analyzing Mobile Engineering Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Engineering Manager Target',
      );
...
export const mobileEngineeringManagerAgent = Object.freeze(
  new MobileEngineeringManagerAgent(),
);
