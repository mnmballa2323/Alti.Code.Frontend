...
class MobileDataLakeDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileDataLakeSystem(objective) {
    logger.info(
      `💻 [MobileDataLakeDirectorAgent] Analyzing Mobile DataLake Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile DataLake Director Target',
      );
...
export const mobileDataLakeDirectorAgent = Object.freeze(
  new MobileDataLakeDirectorAgent(),
);
