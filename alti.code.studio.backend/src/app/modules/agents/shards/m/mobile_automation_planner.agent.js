...
class MobileAutomationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileAutomationSystem(objective) {
    logger.info(
      `💻 [MobileAutomationPlannerAgent] Analyzing Mobile Automation Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Automation Planner Target',
      );
...
export const mobileAutomationPlannerAgent = Object.freeze(
  new MobileAutomationPlannerAgent(),
);
