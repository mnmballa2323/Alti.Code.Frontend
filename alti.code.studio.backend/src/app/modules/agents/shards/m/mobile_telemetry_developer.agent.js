...
class MobileTelemetryDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileTelemetrySystem(objective) {
    logger.info(
      `💻 [MobileTelemetryDeveloperAgent] Analyzing Mobile Telemetry Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Telemetry Developer Target',
      );
...
export const mobileTelemetryDeveloperAgent = Object.freeze(
  new MobileTelemetryDeveloperAgent(),
);
