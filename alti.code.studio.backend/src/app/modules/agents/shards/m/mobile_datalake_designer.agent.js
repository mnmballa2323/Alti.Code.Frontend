...
class MobileDataLakeDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileDataLakeSystem(objective) {
    logger.info(
      `💻 [MobileDataLakeDesignerAgent] Analyzing Mobile DataLake Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile DataLake Designer Target',
      );
...
export const mobileDataLakeDesignerAgent = Object.freeze(
  new MobileDataLakeDesignerAgent(),
);
