...
class MobileServerlessAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileServerlessSystem(objective) {
        logger.info(`💻 [MobileServerlessAuditorAgent] Analyzing Mobile Serverless Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Serverless Auditor Target");
...
export const mobileServerlessAuditorAgent = Object.freeze(new MobileServerlessAuditorAgent());
