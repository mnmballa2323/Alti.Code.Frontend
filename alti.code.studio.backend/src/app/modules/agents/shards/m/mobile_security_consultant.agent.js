...
class MobileSecurityConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileSecuritySystem(objective) {
    logger.info(
      `💻 [MobileSecurityConsultantAgent] Analyzing Mobile Security Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Security Consultant Target',
      );
...
export const mobileSecurityConsultantAgent = Object.freeze(
  new MobileSecurityConsultantAgent(),
);
