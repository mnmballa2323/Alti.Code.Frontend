...
class MobileGovernancePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateMobileGovernanceSystem(objective) {
        logger.info(`💻 [MobileGovernancePlannerAgent] Analyzing Mobile Governance Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Mobile Governance Planner Target");
...
export const mobileGovernancePlannerAgent = Object.freeze(new MobileGovernancePlannerAgent());
