...
class MobileDeploymentAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileDeploymentSystem(objective) {
    logger.info(
      `💻 [MobileDeploymentAuditorAgent] Analyzing Mobile Deployment Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Deployment Auditor Target',
      );
...
export const mobileDeploymentAuditorAgent = Object.freeze(
  new MobileDeploymentAuditorAgent(),
);
