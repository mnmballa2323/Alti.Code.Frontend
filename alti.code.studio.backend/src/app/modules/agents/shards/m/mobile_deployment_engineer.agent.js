...
class MobileDeploymentEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileDeploymentSystem(objective) {
    logger.info(
      `💻 [MobileDeploymentEngineerAgent] Analyzing Mobile Deployment Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Deployment Engineer Target',
      );
...
export const mobileDeploymentEngineerAgent = Object.freeze(
  new MobileDeploymentEngineerAgent(),
);
