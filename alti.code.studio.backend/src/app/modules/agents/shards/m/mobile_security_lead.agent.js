...
class MobileSecurityLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileSecuritySystem(objective) {
    logger.info(
      `💻 [MobileSecurityLeadAgent] Analyzing Mobile Security Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Security Lead Target',
      );
...
export const mobileSecurityLeadAgent = Object.freeze(
  new MobileSecurityLeadAgent(),
);
