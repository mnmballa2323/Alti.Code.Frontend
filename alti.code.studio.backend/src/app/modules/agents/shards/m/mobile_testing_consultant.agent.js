...
class MobileTestingConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileTestingSystem(objective) {
    logger.info(
      `💻 [MobileTestingConsultantAgent] Analyzing Mobile Testing Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Testing Consultant Target',
      );
...
export const mobileTestingConsultantAgent = Object.freeze(
  new MobileTestingConsultantAgent(),
);
