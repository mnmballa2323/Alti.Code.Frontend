...
class MobileIntegrationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileIntegrationSystem(objective) {
    logger.info(
      `💻 [MobileIntegrationTesterAgent] Analyzing Mobile Integration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Integration Tester Target',
      );
...
export const mobileIntegrationTesterAgent = Object.freeze(
  new MobileIntegrationTesterAgent(),
);
