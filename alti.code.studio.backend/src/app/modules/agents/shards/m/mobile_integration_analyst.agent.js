...
class MobileIntegrationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateMobileIntegrationSystem(objective) {
    logger.info(
      `💻 [MobileIntegrationAnalystAgent] Analyzing Mobile Integration Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mobile Integration Analyst Target',
      );
...
export const mobileIntegrationAnalystAgent = Object.freeze(
  new MobileIntegrationAnalystAgent(),
);
