...
class EnterpriseAnalyticsLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseAnalyticsSystem(objective) {
    logger.info(
      `💻 [EnterpriseAnalyticsLeadAgent] Analyzing Enterprise Analytics Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise Analytics Lead Target',
      );
...
export const enterpriseAnalyticsLeadAgent = Object.freeze(
  new EnterpriseAnalyticsLeadAgent(),
);
