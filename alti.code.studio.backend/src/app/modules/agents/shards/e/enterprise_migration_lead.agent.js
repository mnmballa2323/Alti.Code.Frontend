...
class EnterpriseMigrationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateEnterpriseMigrationSystem(objective) {
        logger.info(`💻 [EnterpriseMigrationLeadAgent] Analyzing Enterprise Migration Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Enterprise Migration Lead Target");
...
export const enterpriseMigrationLeadAgent = Object.freeze(new EnterpriseMigrationLeadAgent());
