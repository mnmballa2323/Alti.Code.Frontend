...
class EnterpriseTestingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseTestingSystem(objective) {
    logger.info(
      `💻 [EnterpriseTestingAuditorAgent] Analyzing Enterprise Testing Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise Testing Auditor Target',
      );
...
export const enterpriseTestingAuditorAgent = Object.freeze(
  new EnterpriseTestingAuditorAgent(),
);
