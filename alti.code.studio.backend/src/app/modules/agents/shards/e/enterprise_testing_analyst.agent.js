...
class EnterpriseTestingAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseTestingSystem(objective) {
    logger.info(
      `💻 [EnterpriseTestingAnalystAgent] Analyzing Enterprise Testing Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise Testing Analyst Target',
      );
...
export const enterpriseTestingAnalystAgent = Object.freeze(
  new EnterpriseTestingAnalystAgent(),
);
