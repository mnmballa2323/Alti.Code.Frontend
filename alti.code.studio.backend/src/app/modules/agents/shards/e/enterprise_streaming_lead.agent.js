...
class EnterpriseStreamingLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateEnterpriseStreamingSystem(objective) {
        logger.info(`💻 [EnterpriseStreamingLeadAgent] Analyzing Enterprise Streaming Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Enterprise Streaming Lead Target");
...
export const enterpriseStreamingLeadAgent = Object.freeze(new EnterpriseStreamingLeadAgent());
