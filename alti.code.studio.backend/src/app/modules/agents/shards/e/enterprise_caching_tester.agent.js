...
class EnterpriseCachingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseCachingSystem(objective) {
    logger.info(
      `💻 [EnterpriseCachingTesterAgent] Analyzing Enterprise Caching Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise Caching Tester Target',
      );
...
export const enterpriseCachingTesterAgent = Object.freeze(
  new EnterpriseCachingTesterAgent(),
);
