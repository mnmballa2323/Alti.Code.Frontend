...
class EnterpriseETLAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseETLSystem(objective) {
    logger.info(
      `💻 [EnterpriseETLAnalystAgent] Analyzing Enterprise ETL Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise ETL Analyst Target',
      );
...
export const enterpriseETLAnalystAgent = Object.freeze(
  new EnterpriseETLAnalystAgent(),
);
