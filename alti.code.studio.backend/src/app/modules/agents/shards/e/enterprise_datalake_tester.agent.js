...
class EnterpriseDataLakeTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseDataLakeSystem(objective) {
    logger.info(
      `💻 [EnterpriseDataLakeTesterAgent] Analyzing Enterprise DataLake Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise DataLake Tester Target',
      );
...
export const enterpriseDataLakeTesterAgent = Object.freeze(
  new EnterpriseDataLakeTesterAgent(),
);
