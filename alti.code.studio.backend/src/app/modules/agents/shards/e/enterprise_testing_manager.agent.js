...
class EnterpriseTestingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseTestingSystem(objective) {
    logger.info(
      `💻 [EnterpriseTestingManagerAgent] Analyzing Enterprise Testing Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise Testing Manager Target',
      );
...
export const enterpriseTestingManagerAgent = Object.freeze(
  new EnterpriseTestingManagerAgent(),
);
