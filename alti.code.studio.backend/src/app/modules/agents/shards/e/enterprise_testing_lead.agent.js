...
class EnterpriseTestingLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateEnterpriseTestingSystem(objective) {
        logger.info(`💻 [EnterpriseTestingLeadAgent] Analyzing Enterprise Testing Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Enterprise Testing Lead Target");
...
export const enterpriseTestingLeadAgent = Object.freeze(new EnterpriseTestingLeadAgent());
