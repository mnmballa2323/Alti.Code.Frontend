...
class EnterpriseETLArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseETLSystem(objective) {
    logger.info(
      `💻 [EnterpriseETLArchitectAgent] Analyzing Enterprise ETL Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise ETL Architect Target',
      );
...
export const enterpriseETLArchitectAgent = Object.freeze(
  new EnterpriseETLArchitectAgent(),
);
