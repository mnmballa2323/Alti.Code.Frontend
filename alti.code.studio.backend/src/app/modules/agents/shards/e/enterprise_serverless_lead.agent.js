...
class EnterpriseServerlessLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseServerlessSystem(objective) {
    logger.info(
      `💻 [EnterpriseServerlessLeadAgent] Analyzing Enterprise Serverless Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise Serverless Lead Target',
      );
...
export const enterpriseServerlessLeadAgent = Object.freeze(
  new EnterpriseServerlessLeadAgent(),
);
