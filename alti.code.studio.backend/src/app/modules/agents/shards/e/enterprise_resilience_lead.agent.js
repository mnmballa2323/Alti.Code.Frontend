...
class EnterpriseResilienceLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseResilienceSystem(objective) {
    logger.info(
      `💻 [EnterpriseResilienceLeadAgent] Analyzing Enterprise Resilience Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise Resilience Lead Target',
      );
...
export const enterpriseResilienceLeadAgent = Object.freeze(
  new EnterpriseResilienceLeadAgent(),
);
