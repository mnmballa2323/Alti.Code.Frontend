...
class EnterpriseETLDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseETLSystem(objective) {
    logger.info(
      `💻 [EnterpriseETLDirectorAgent] Analyzing Enterprise ETL Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise ETL Director Target',
      );
...
export const enterpriseETLDirectorAgent = Object.freeze(
  new EnterpriseETLDirectorAgent(),
);
