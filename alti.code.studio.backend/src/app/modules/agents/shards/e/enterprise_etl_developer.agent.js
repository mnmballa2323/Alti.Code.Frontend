...
class EnterpriseETLDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseETLSystem(objective) {
    logger.info(
      `💻 [EnterpriseETLDeveloperAgent] Analyzing Enterprise ETL Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise ETL Developer Target',
      );
...
export const enterpriseETLDeveloperAgent = Object.freeze(
  new EnterpriseETLDeveloperAgent(),
);
