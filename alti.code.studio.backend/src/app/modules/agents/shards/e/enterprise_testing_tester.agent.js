...
class EnterpriseTestingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseTestingSystem(objective) {
    logger.info(
      `💻 [EnterpriseTestingTesterAgent] Analyzing Enterprise Testing Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise Testing Tester Target',
      );
...
export const enterpriseTestingTesterAgent = Object.freeze(
  new EnterpriseTestingTesterAgent(),
);
