...
class EnterpriseTestingPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseTestingSystem(objective) {
    logger.info(
      `💻 [EnterpriseTestingPlannerAgent] Analyzing Enterprise Testing Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise Testing Planner Target',
      );
...
export const enterpriseTestingPlannerAgent = Object.freeze(
  new EnterpriseTestingPlannerAgent(),
);
