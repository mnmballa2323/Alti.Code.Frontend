...
class EnterpriseCachingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseCachingSystem(objective) {
    logger.info(
      `💻 [EnterpriseCachingManagerAgent] Analyzing Enterprise Caching Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise Caching Manager Target',
      );
...
export const enterpriseCachingManagerAgent = Object.freeze(
  new EnterpriseCachingManagerAgent(),
);
