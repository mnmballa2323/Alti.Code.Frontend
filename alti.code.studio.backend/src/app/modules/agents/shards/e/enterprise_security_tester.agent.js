...
class EnterpriseSecurityTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseSecuritySystem(objective) {
    logger.info(
      `💻 [EnterpriseSecurityTesterAgent] Analyzing Enterprise Security Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise Security Tester Target',
      );
...
export const enterpriseSecurityTesterAgent = Object.freeze(
  new EnterpriseSecurityTesterAgent(),
);
