...
class EnterpriseETLSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseETLSystem(objective) {
    logger.info(
      `💻 [EnterpriseETLSpecialistAgent] Analyzing Enterprise ETL Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise ETL Specialist Target',
      );
...
export const enterpriseETLSpecialistAgent = Object.freeze(
  new EnterpriseETLSpecialistAgent(),
);
