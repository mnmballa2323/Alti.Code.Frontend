...
class EnterpriseETLConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateEnterpriseETLSystem(objective) {
    logger.info(
      `💻 [EnterpriseETLConsultantAgent] Analyzing Enterprise ETL Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Enterprise ETL Consultant Target',
      );
...
export const enterpriseETLConsultantAgent = Object.freeze(
  new EnterpriseETLConsultantAgent(),
);
