...
class ZeroTrustArchitectAgent extends GeminiCliBaseAgent {
    ...
    async generateArchitecture(objective) {
        logger.info(`🛡️ [ZeroTrustArchitectAgent] Engineering zero-trust architecture...`);
...
export const zeroTrustArchitectAgent = Object.freeze(new ZeroTrustArchitectAgent());
