...
class SpannerDistributedSqlAgent extends GeminiCliBaseAgent {
    ...
    async generateSchema(objective) {
        logger.info(`🗄️ [SpannerDistributedSqlAgent] Architecting distributed Spanner schema...`);
...
export const spannerDistributedSqlAgent = Object.freeze(new SpannerDistributedSqlAgent());
