...
class KubernetesOperatorBuilderAgent extends GeminiCliBaseAgent {
  ...
  async generateOperator(objective) {
    logger.info(
      `☸️ [KubernetesOperatorBuilderAgent] Building K8s Operator CRDs...`,
    );
    ...
    try {
      ...
      logger.error(
        `❌ [KubernetesOperatorBuilderAgent] Failed: ${err.message}`,
      );
      throw err;
    }
  }
}
export const kubernetesOperatorBuilderAgent = Object.freeze(
  new KubernetesOperatorBuilderAgent(),
);
