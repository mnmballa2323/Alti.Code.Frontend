...
class MainframeModernizationAgent extends GeminiCliBaseAgent {
  ...
  async modernizeCode(objective) {
    logger.info(
      `🏗️ [MainframeModernizationAgent] Modernizing legacy mainframe components...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Mainframe Modernization Target',
      );
...
export const mainframeModernizationAgent = Object.freeze(
  new MainframeModernizationAgent(),
);
