...
class BackendGovernanceManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendGovernanceSystem(objective) {
    logger.info(
      `💻 [BackendGovernanceManagerAgent] Analyzing Backend Governance Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Governance Manager Target',
      );
...
export const backendGovernanceManagerAgent = Object.freeze(
  new BackendGovernanceManagerAgent(),
);
