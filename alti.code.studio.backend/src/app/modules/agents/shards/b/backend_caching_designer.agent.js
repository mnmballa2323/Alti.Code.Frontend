...
class BackendCachingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendCachingSystem(objective) {
    logger.info(
      `💻 [BackendCachingDesignerAgent] Analyzing Backend Caching Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Caching Designer Target',
      );
...
export const backendCachingDesignerAgent = Object.freeze(
  new BackendCachingDesignerAgent(),
);
