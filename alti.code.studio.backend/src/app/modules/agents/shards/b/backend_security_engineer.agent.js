...
class BackendSecurityEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendSecuritySystem(objective) {
    logger.info(
      `💻 [BackendSecurityEngineerAgent] Analyzing Backend Security Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Security Engineer Target',
      );
...
export const backendSecurityEngineerAgent = Object.freeze(
  new BackendSecurityEngineerAgent(),
);
