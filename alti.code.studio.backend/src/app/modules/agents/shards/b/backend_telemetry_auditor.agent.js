...
class BackendTelemetryAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendTelemetrySystem(objective) {
    logger.info(
      `💻 [BackendTelemetryAuditorAgent] Analyzing Backend Telemetry Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Telemetry Auditor Target',
      );
...
export const backendTelemetryAuditorAgent = Object.freeze(
  new BackendTelemetryAuditorAgent(),
);
