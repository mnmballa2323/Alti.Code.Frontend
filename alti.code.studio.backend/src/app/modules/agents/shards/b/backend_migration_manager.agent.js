...
class BackendMigrationManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendMigrationSystem(objective) {
        logger.info(`💻 [BackendMigrationManagerAgent] Analyzing Backend Migration Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Migration Manager Target");
...
export const backendMigrationManagerAgent = Object.freeze(new BackendMigrationManagerAgent());
