...
class BackendETLDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendETLSystem(objective) {
        logger.info(`💻 [BackendETLDeveloperAgent] Analyzing Backend ETL Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend ETL Developer Target");
...
export const backendETLDeveloperAgent = Object.freeze(new BackendETLDeveloperAgent());
