...
class BackendComplianceAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendComplianceSystem(objective) {
    logger.info(
      `💻 [BackendComplianceAuditorAgent] Analyzing Backend Compliance Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Compliance Auditor Target',
      );
...
export const backendComplianceAuditorAgent = Object.freeze(
  new BackendComplianceAuditorAgent(),
);
