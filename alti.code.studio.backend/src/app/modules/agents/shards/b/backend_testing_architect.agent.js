...
class BackendTestingArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendTestingSystem(objective) {
    logger.info(
      `💻 [BackendTestingArchitectAgent] Analyzing Backend Testing Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Testing Architect Target',
      );
...
export const backendTestingArchitectAgent = Object.freeze(
  new BackendTestingArchitectAgent(),
);
