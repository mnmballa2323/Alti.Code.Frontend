...
class BackendAutomationManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendAutomationSystem(objective) {
        logger.info(`💻 [BackendAutomationManagerAgent] Analyzing Backend Automation Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Automation Manager Target");
...
export const backendAutomationManagerAgent = Object.freeze(new BackendAutomationManagerAgent());
