...
class BackendScalingManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendScalingSystem(objective) {
        logger.info(`💻 [BackendScalingManagerAgent] Analyzing Backend Scaling Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Scaling Manager Target");
...
export const backendScalingManagerAgent = Object.freeze(new BackendScalingManagerAgent());
