...
class BackendETLSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendETLSystem(objective) {
    logger.info(
      `💻 [BackendETLSpecialistAgent] Analyzing Backend ETL Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend ETL Specialist Target',
      );
...
export const backendETLSpecialistAgent = Object.freeze(
  new BackendETLSpecialistAgent(),
);
