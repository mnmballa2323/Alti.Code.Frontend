...
class BackendDeploymentTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendDeploymentSystem(objective) {
        logger.info(`💻 [BackendDeploymentTesterAgent] Analyzing Backend Deployment Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Deployment Tester Target");
...
export const backendDeploymentTesterAgent = Object.freeze(new BackendDeploymentTesterAgent());
