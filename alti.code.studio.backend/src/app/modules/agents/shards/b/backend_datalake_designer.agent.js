...
class BackendDataLakeDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendDataLakeSystem(objective) {
        logger.info(`💻 [BackendDataLakeDesignerAgent] Analyzing Backend DataLake Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend DataLake Designer Target");
...
export const backendDataLakeDesignerAgent = Object.freeze(new BackendDataLakeDesignerAgent());
