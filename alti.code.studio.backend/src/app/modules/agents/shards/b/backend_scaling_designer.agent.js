...
class BackendScalingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendScalingSystem(objective) {
    logger.info(
      `💻 [BackendScalingDesignerAgent] Analyzing Backend Scaling Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Scaling Designer Target',
      );
...
export const backendScalingDesignerAgent = Object.freeze(
  new BackendScalingDesignerAgent(),
);
