...
class BackendTelemetryManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendTelemetrySystem(objective) {
        logger.info(`💻 [BackendTelemetryManagerAgent] Analyzing Backend Telemetry Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Telemetry Manager Target");
...
export const backendTelemetryManagerAgent = Object.freeze(new BackendTelemetryManagerAgent());
