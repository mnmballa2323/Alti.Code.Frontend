...
class BackendServerlessManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendServerlessSystem(objective) {
    logger.info(
      `💻 [BackendServerlessManagerAgent] Analyzing Backend Serverless Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Serverless Manager Target',
      );
...
export const backendServerlessManagerAgent = Object.freeze(
  new BackendServerlessManagerAgent(),
);
