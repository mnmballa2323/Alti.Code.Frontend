...
class BackendResilienceManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendResilienceSystem(objective) {
        logger.info(`💻 [BackendResilienceManagerAgent] Analyzing Backend Resilience Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Resilience Manager Target");
...
export const backendResilienceManagerAgent = Object.freeze(new BackendResilienceManagerAgent());
