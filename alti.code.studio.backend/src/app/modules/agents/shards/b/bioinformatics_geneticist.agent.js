...
class BioinformaticsGeneticistAgent extends GeminiCliBaseAgent {
    ...
    async generateBioinformaticsSystem(biotechObjective) {
        logger.info(`🧬 [BioinformaticsGeneticist] Analyzing objective for DNA sequencing and protein folding...`);
...
${biotechObjective}
        ...
        try {
            ...
            logger.info(`✅ [BioinformaticsGeneticist] Bioinformatics architecture generated successfully.`);
            return cleanCode;
        } catch (err) {
            logger.error(`❌ [BioinformaticsGeneticist] Failed to generate bioinformatics system: ${err.message}`);
            throw err;
        }
    }
}

export const bioinformaticsGeneticistAgent = Object.freeze(new BioinformaticsGeneticistAgent());
