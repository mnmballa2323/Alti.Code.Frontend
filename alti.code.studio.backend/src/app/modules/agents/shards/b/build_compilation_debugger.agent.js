...
class BuildCompilationDebuggerAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'CI/CD Build & Compilation Debugger Specialist — Analyzes webpack, turbopack, typescript, or ESLint build logs to pinpoint and automatically repair compiler and syntax crashes.';
    this.capabilities = [
      'build-repair',
      'compiler-debugging',
      'typescript-errors',
...
export const buildCompilationDebuggerAgent =
  new BuildCompilationDebuggerAgent();
