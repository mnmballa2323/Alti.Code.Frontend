...
class BackendCachingPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendCachingSystem(objective) {
        logger.info(`💻 [BackendCachingPlannerAgent] Analyzing Backend Caching Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Caching Planner Target");
...
export const backendCachingPlannerAgent = Object.freeze(new BackendCachingPlannerAgent());
