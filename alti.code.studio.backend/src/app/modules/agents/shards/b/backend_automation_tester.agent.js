...
class BackendAutomationTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendAutomationSystem(objective) {
        logger.info(`💻 [BackendAutomationTesterAgent] Analyzing Backend Automation Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Automation Tester Target");
...
export const backendAutomationTesterAgent = Object.freeze(new BackendAutomationTesterAgent());
