...
class BackendIntegrationTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendIntegrationSystem(objective) {
        logger.info(`💻 [BackendIntegrationTesterAgent] Analyzing Backend Integration Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Integration Tester Target");
...
export const backendIntegrationTesterAgent = Object.freeze(new BackendIntegrationTesterAgent());
