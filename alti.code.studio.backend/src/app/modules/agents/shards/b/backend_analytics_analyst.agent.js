...
class BackendAnalyticsAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendAnalyticsSystem(objective) {
    logger.info(
      `💻 [BackendAnalyticsAnalystAgent] Analyzing Backend Analytics Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Analytics Analyst Target',
      );
...
export const backendAnalyticsAnalystAgent = Object.freeze(
  new BackendAnalyticsAnalystAgent(),
);
