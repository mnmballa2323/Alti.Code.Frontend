...
class BackendDataWarehouseLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendDataWarehouseSystem(objective) {
    logger.info(
      `💻 [BackendDataWarehouseLeadAgent] Analyzing Backend DataWarehouse Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend DataWarehouse Lead Target',
      );
...
export const backendDataWarehouseLeadAgent = Object.freeze(
  new BackendDataWarehouseLeadAgent(),
);
