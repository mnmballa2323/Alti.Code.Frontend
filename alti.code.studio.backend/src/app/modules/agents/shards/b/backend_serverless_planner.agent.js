...
class BackendServerlessPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendServerlessSystem(objective) {
    logger.info(
      `💻 [BackendServerlessPlannerAgent] Analyzing Backend Serverless Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Serverless Planner Target',
      );
...
export const backendServerlessPlannerAgent = Object.freeze(
  new BackendServerlessPlannerAgent(),
);
