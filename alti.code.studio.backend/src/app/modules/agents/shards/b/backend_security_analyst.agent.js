...
class BackendSecurityAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendSecuritySystem(objective) {
        logger.info(`💻 [BackendSecurityAnalystAgent] Analyzing Backend Security Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Security Analyst Target");
...
export const backendSecurityAnalystAgent = Object.freeze(new BackendSecurityAnalystAgent());
