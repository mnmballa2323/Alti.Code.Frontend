...
class BackendScalingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendScalingSystem(objective) {
    logger.info(
      `💻 [BackendScalingLeadAgent] Analyzing Backend Scaling Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Scaling Lead Target',
      );
...
export const backendScalingLeadAgent = Object.freeze(
  new BackendScalingLeadAgent(),
);
