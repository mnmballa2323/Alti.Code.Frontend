...
class BackendETLAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendETLSystem(objective) {
    logger.info(
      `💻 [BackendETLAnalystAgent] Analyzing Backend ETL Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend ETL Analyst Target',
      );
...
export const backendETLAnalystAgent = Object.freeze(
  new BackendETLAnalystAgent(),
);
