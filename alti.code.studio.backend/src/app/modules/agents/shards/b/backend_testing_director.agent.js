...
class BackendTestingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendTestingSystem(objective) {
    logger.info(
      `💻 [BackendTestingDirectorAgent] Analyzing Backend Testing Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Testing Director Target',
      );
...
export const backendTestingDirectorAgent = Object.freeze(
  new BackendTestingDirectorAgent(),
);
