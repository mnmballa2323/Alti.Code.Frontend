...
class BackendComplianceTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendComplianceSystem(objective) {
        logger.info(`💻 [BackendComplianceTesterAgent] Analyzing Backend Compliance Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Compliance Tester Target");
...
export const backendComplianceTesterAgent = Object.freeze(new BackendComplianceTesterAgent());
