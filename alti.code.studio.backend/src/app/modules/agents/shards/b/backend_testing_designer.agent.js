...
class BackendTestingDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendTestingSystem(objective) {
        logger.info(`💻 [BackendTestingDesignerAgent] Analyzing Backend Testing Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Testing Designer Target");
...
export const backendTestingDesignerAgent = Object.freeze(new BackendTestingDesignerAgent());
