...
class BackendGovernanceAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendGovernanceSystem(objective) {
    logger.info(
      `💻 [BackendGovernanceAnalystAgent] Analyzing Backend Governance Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Governance Analyst Target',
      );
...
export const backendGovernanceAnalystAgent = Object.freeze(
  new BackendGovernanceAnalystAgent(),
);
