...
class BackendProvisioningLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendProvisioningSystem(objective) {
    logger.info(
      `💻 [BackendProvisioningLeadAgent] Analyzing Backend Provisioning Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Provisioning Lead Target',
      );
...
export const backendProvisioningLeadAgent = Object.freeze(
  new BackendProvisioningLeadAgent(),
);
