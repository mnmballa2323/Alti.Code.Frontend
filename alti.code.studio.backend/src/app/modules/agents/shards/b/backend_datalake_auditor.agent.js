...
class BackendDataLakeAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendDataLakeSystem(objective) {
    logger.info(
      `💻 [BackendDataLakeAuditorAgent] Analyzing Backend DataLake Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend DataLake Auditor Target',
      );
...
export const backendDataLakeAuditorAgent = Object.freeze(
  new BackendDataLakeAuditorAgent(),
);
