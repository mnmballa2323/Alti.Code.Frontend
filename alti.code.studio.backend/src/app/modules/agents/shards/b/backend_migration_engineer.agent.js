...
class BackendMigrationEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendMigrationSystem(objective) {
        logger.info(`💻 [BackendMigrationEngineerAgent] Analyzing Backend Migration Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Migration Engineer Target");
...
export const backendMigrationEngineerAgent = Object.freeze(new BackendMigrationEngineerAgent());
