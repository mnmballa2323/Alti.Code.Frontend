...
class BackendResiliencePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendResilienceSystem(objective) {
        logger.info(`💻 [BackendResiliencePlannerAgent] Analyzing Backend Resilience Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Resilience Planner Target");
...
export const backendResiliencePlannerAgent = Object.freeze(new BackendResiliencePlannerAgent());
