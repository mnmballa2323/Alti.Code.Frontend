...
class BackendDeploymentLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendDeploymentSystem(objective) {
    logger.info(
      `💻 [BackendDeploymentLeadAgent] Analyzing Backend Deployment Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Deployment Lead Target',
      );
...
export const backendDeploymentLeadAgent = Object.freeze(
  new BackendDeploymentLeadAgent(),
);
