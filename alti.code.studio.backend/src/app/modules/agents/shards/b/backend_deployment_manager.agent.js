...
class BackendDeploymentManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendDeploymentSystem(objective) {
    logger.info(
      `💻 [BackendDeploymentManagerAgent] Analyzing Backend Deployment Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Deployment Manager Target',
      );
...
export const backendDeploymentManagerAgent = Object.freeze(
  new BackendDeploymentManagerAgent(),
);
