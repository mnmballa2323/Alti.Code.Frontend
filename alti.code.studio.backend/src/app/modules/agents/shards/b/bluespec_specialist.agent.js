...
class BluespecSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateBluespecSystem(objective) {
        logger.info(`💻 [BluespecSpecialistAgent] Analyzing Bluespec requirements...`);
...
export const BluespecSpecialistAgentInstance = Object.freeze(new BluespecSpecialistAgent());
