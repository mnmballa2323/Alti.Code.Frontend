...
class BackendTestingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendTestingSystem(objective) {
    logger.info(
      `💻 [BackendTestingTesterAgent] Analyzing Backend Testing Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Testing Tester Target',
      );
...
export const backendTestingTesterAgent = Object.freeze(
  new BackendTestingTesterAgent(),
);
