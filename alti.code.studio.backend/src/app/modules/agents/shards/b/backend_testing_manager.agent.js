...
class BackendTestingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendTestingSystem(objective) {
    logger.info(
      `💻 [BackendTestingManagerAgent] Analyzing Backend Testing Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Testing Manager Target',
      );
...
export const backendTestingManagerAgent = Object.freeze(
  new BackendTestingManagerAgent(),
);
