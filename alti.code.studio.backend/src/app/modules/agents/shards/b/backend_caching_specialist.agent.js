...
class BackendCachingSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendCachingSystem(objective) {
    logger.info(
      `💻 [BackendCachingSpecialistAgent] Analyzing Backend Caching Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Caching Specialist Target',
      );
...
export const backendCachingSpecialistAgent = Object.freeze(
  new BackendCachingSpecialistAgent(),
);
