...
class BackendServerlessTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendServerlessSystem(objective) {
    logger.info(
      `💻 [BackendServerlessTesterAgent] Analyzing Backend Serverless Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Serverless Tester Target',
      );
...
export const backendServerlessTesterAgent = Object.freeze(
  new BackendServerlessTesterAgent(),
);
