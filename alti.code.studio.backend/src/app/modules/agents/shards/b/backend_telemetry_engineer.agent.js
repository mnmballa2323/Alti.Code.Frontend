...
class BackendTelemetryEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendTelemetrySystem(objective) {
        logger.info(`💻 [BackendTelemetryEngineerAgent] Analyzing Backend Telemetry Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Telemetry Engineer Target");
...
export const backendTelemetryEngineerAgent = Object.freeze(new BackendTelemetryEngineerAgent());
