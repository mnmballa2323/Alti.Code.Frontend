...
class BackendDataLakeAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendDataLakeSystem(objective) {
    logger.info(
      `💻 [BackendDataLakeAnalystAgent] Analyzing Backend DataLake Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend DataLake Analyst Target',
      );
...
export const backendDataLakeAnalystAgent = Object.freeze(
  new BackendDataLakeAnalystAgent(),
);
