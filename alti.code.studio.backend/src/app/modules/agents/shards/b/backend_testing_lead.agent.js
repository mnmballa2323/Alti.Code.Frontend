...
class BackendTestingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendTestingSystem(objective) {
    logger.info(
      `💻 [BackendTestingLeadAgent] Analyzing Backend Testing Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Testing Lead Target',
      );
...
export const backendTestingLeadAgent = Object.freeze(
  new BackendTestingLeadAgent(),
);
