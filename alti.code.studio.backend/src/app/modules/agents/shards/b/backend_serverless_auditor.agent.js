...
class BackendServerlessAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendServerlessSystem(objective) {
    logger.info(
      `💻 [BackendServerlessAuditorAgent] Analyzing Backend Serverless Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Serverless Auditor Target',
      );
...
export const backendServerlessAuditorAgent = Object.freeze(
  new BackendServerlessAuditorAgent(),
);
