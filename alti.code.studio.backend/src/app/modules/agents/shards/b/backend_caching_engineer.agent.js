...
class BackendCachingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendCachingSystem(objective) {
    logger.info(
      `💻 [BackendCachingEngineerAgent] Analyzing Backend Caching Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Caching Engineer Target',
      );
...
export const backendCachingEngineerAgent = Object.freeze(
  new BackendCachingEngineerAgent(),
);
