...
class BackendScalingAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendScalingSystem(objective) {
        logger.info(`💻 [BackendScalingAuditorAgent] Analyzing Backend Scaling Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Scaling Auditor Target");
...
export const backendScalingAuditorAgent = Object.freeze(new BackendScalingAuditorAgent());
