...
class BackendEngineeringTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendEngineeringSystem(objective) {
        logger.info(`💻 [BackendEngineeringTesterAgent] Analyzing Backend Engineering Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Engineering Tester Target");
...
export const backendEngineeringTesterAgent = Object.freeze(new BackendEngineeringTesterAgent());
