...
class BackendDeploymentAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendDeploymentSystem(objective) {
    logger.info(
      `💻 [BackendDeploymentAuditorAgent] Analyzing Backend Deployment Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Deployment Auditor Target',
      );
...
export const backendDeploymentAuditorAgent = Object.freeze(
  new BackendDeploymentAuditorAgent(),
);
