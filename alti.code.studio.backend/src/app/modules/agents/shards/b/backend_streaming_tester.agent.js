...
class BackendStreamingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendStreamingSystem(objective) {
    logger.info(
      `💻 [BackendStreamingTesterAgent] Analyzing Backend Streaming Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Streaming Tester Target',
      );
...
export const backendStreamingTesterAgent = Object.freeze(
  new BackendStreamingTesterAgent(),
);
