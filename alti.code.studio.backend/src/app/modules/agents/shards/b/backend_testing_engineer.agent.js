...
class BackendTestingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendTestingSystem(objective) {
    logger.info(
      `💻 [BackendTestingEngineerAgent] Analyzing Backend Testing Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Testing Engineer Target',
      );
...
export const backendTestingEngineerAgent = Object.freeze(
  new BackendTestingEngineerAgent(),
);
