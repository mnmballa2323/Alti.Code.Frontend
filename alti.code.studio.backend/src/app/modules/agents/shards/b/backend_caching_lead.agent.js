...
class BackendCachingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendCachingSystem(objective) {
    logger.info(
      `💻 [BackendCachingLeadAgent] Analyzing Backend Caching Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Caching Lead Target',
      );
...
export const backendCachingLeadAgent = Object.freeze(
  new BackendCachingLeadAgent(),
);
