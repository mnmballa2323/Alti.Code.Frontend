...
class BackendSecurityTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendSecuritySystem(objective) {
    logger.info(
      `💻 [BackendSecurityTesterAgent] Analyzing Backend Security Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Security Tester Target',
      );
...
export const backendSecurityTesterAgent = Object.freeze(
  new BackendSecurityTesterAgent(),
);
