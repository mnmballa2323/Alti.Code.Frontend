...
class BackendTestingPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendTestingSystem(objective) {
    logger.info(
      `💻 [BackendTestingPlannerAgent] Analyzing Backend Testing Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Testing Planner Target',
      );
...
export const backendTestingPlannerAgent = Object.freeze(
  new BackendTestingPlannerAgent(),
);
