...
class BackendAnalyticsAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendAnalyticsSystem(objective) {
        logger.info(`💻 [BackendAnalyticsAuditorAgent] Analyzing Backend Analytics Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Analytics Auditor Target");
...
export const backendAnalyticsAuditorAgent = Object.freeze(new BackendAnalyticsAuditorAgent());
