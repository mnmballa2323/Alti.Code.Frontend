...
class BackendAutomationAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendAutomationSystem(objective) {
        logger.info(`💻 [BackendAutomationAuditorAgent] Analyzing Backend Automation Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Automation Auditor Target");
...
export const backendAutomationAuditorAgent = Object.freeze(new BackendAutomationAuditorAgent());
