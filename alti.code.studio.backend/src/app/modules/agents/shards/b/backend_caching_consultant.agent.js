...
class BackendCachingConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendCachingSystem(objective) {
        logger.info(`💻 [BackendCachingConsultantAgent] Analyzing Backend Caching Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Caching Consultant Target");
...
export const backendCachingConsultantAgent = Object.freeze(new BackendCachingConsultantAgent());
