...
class BackendScalingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendScalingSystem(objective) {
    logger.info(
      `💻 [BackendScalingEngineerAgent] Analyzing Backend Scaling Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Scaling Engineer Target',
      );
...
export const backendScalingEngineerAgent = Object.freeze(
  new BackendScalingEngineerAgent(),
);
