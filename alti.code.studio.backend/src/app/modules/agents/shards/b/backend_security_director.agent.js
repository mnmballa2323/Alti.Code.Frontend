...
class BackendSecurityDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendSecuritySystem(objective) {
        logger.info(`💻 [BackendSecurityDirectorAgent] Analyzing Backend Security Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Security Director Target");
...
export const backendSecurityDirectorAgent = Object.freeze(new BackendSecurityDirectorAgent());
