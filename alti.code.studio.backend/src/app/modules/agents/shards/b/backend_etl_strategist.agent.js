...
class BackendETLStrategistAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendETLSystem(objective) {
        logger.info(`💻 [BackendETLStrategistAgent] Analyzing Backend ETL Strategist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend ETL Strategist Target");
...
export const backendETLStrategistAgent = Object.freeze(new BackendETLStrategistAgent());
