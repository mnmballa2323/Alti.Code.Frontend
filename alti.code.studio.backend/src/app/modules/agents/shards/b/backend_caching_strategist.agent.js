...
class BackendCachingStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendCachingSystem(objective) {
    logger.info(
      `💻 [BackendCachingStrategistAgent] Analyzing Backend Caching Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Caching Strategist Target',
      );
...
export const backendCachingStrategistAgent = Object.freeze(
  new BackendCachingStrategistAgent(),
);
