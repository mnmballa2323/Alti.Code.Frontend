...
class BackendScalingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendScalingSystem(objective) {
    logger.info(
      `💻 [BackendScalingTesterAgent] Analyzing Backend Scaling Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Scaling Tester Target',
      );
...
export const backendScalingTesterAgent = Object.freeze(
  new BackendScalingTesterAgent(),
);
