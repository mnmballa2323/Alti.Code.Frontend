...
class BackendScalingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendScalingSystem(objective) {
    logger.info(
      `💻 [BackendScalingDirectorAgent] Analyzing Backend Scaling Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Scaling Director Target',
      );
...
export const backendScalingDirectorAgent = Object.freeze(
  new BackendScalingDirectorAgent(),
);
