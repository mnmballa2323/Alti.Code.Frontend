...
class BackendSecurityManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendSecuritySystem(objective) {
        logger.info(`💻 [BackendSecurityManagerAgent] Analyzing Backend Security Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Security Manager Target");
...
export const backendSecurityManagerAgent = Object.freeze(new BackendSecurityManagerAgent());
