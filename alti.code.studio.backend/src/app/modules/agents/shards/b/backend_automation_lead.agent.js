...
class BackendAutomationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendAutomationSystem(objective) {
        logger.info(`💻 [BackendAutomationLeadAgent] Analyzing Backend Automation Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Automation Lead Target");
...
export const backendAutomationLeadAgent = Object.freeze(new BackendAutomationLeadAgent());
