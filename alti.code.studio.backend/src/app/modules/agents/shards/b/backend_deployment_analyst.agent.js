...
class BackendDeploymentAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendDeploymentSystem(objective) {
    logger.info(
      `💻 [BackendDeploymentAnalystAgent] Analyzing Backend Deployment Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Deployment Analyst Target',
      );
...
export const backendDeploymentAnalystAgent = Object.freeze(
  new BackendDeploymentAnalystAgent(),
);
