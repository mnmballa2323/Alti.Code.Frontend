...
class BackendCachingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendCachingSystem(objective) {
    logger.info(
      `💻 [BackendCachingTesterAgent] Analyzing Backend Caching Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Caching Tester Target',
      );
...
export const backendCachingTesterAgent = Object.freeze(
  new BackendCachingTesterAgent(),
);
