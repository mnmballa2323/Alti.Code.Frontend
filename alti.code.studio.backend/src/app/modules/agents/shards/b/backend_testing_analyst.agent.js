...
class BackendTestingAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendTestingSystem(objective) {
    logger.info(
      `💻 [BackendTestingAnalystAgent] Analyzing Backend Testing Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Testing Analyst Target',
      );
...
export const backendTestingAnalystAgent = Object.freeze(
  new BackendTestingAnalystAgent(),
);
