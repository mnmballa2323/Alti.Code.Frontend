...
class BackendResilienceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendResilienceSystem(objective) {
    logger.info(
      `💻 [BackendResilienceTesterAgent] Analyzing Backend Resilience Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Resilience Tester Target',
      );
...
export const backendResilienceTesterAgent = Object.freeze(
  new BackendResilienceTesterAgent(),
);
