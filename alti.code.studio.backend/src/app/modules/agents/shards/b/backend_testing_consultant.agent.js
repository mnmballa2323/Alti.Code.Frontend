...
class BackendTestingConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendTestingSystem(objective) {
        logger.info(`💻 [BackendTestingConsultantAgent] Analyzing Backend Testing Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Testing Consultant Target");
...
export const backendTestingConsultantAgent = Object.freeze(new BackendTestingConsultantAgent());
