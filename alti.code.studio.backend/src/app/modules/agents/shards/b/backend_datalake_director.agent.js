...
class BackendDataLakeDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendDataLakeSystem(objective) {
    logger.info(
      `💻 [BackendDataLakeDirectorAgent] Analyzing Backend DataLake Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend DataLake Director Target',
      );
...
export const backendDataLakeDirectorAgent = Object.freeze(
  new BackendDataLakeDirectorAgent(),
);
