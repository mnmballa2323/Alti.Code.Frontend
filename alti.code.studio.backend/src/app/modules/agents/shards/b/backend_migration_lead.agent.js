...
class BackendMigrationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendMigrationSystem(objective) {
        logger.info(`💻 [BackendMigrationLeadAgent] Analyzing Backend Migration Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Migration Lead Target");
...
export const backendMigrationLeadAgent = Object.freeze(new BackendMigrationLeadAgent());
