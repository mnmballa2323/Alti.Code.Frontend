...
class BackendSecurityAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendSecuritySystem(objective) {
    logger.info(
      `💻 [BackendSecurityAuditorAgent] Analyzing Backend Security Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Security Auditor Target',
      );
...
export const backendSecurityAuditorAgent = Object.freeze(
  new BackendSecurityAuditorAgent(),
);
