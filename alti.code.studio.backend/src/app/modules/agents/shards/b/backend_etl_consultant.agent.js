...
class BackendETLConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendETLSystem(objective) {
    logger.info(
      `💻 [BackendETLConsultantAgent] Analyzing Backend ETL Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend ETL Consultant Target',
      );
...
export const backendETLConsultantAgent = Object.freeze(
  new BackendETLConsultantAgent(),
);
