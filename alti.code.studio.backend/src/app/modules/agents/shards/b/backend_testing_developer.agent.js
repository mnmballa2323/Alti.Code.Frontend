...
class BackendTestingDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendTestingSystem(objective) {
        logger.info(`💻 [BackendTestingDeveloperAgent] Analyzing Backend Testing Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Testing Developer Target");
...
export const backendTestingDeveloperAgent = Object.freeze(new BackendTestingDeveloperAgent());
