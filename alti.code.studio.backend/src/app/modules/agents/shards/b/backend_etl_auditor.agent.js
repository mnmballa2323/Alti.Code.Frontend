...
class BackendETLAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendETLSystem(objective) {
        logger.info(`💻 [BackendETLAuditorAgent] Analyzing Backend ETL Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend ETL Auditor Target");
...
export const backendETLAuditorAgent = Object.freeze(new BackendETLAuditorAgent());
