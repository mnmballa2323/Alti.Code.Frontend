...
class BackendStreamingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendStreamingSystem(objective) {
    logger.info(
      `💻 [BackendStreamingDesignerAgent] Analyzing Backend Streaming Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Streaming Designer Target',
      );
...
export const backendStreamingDesignerAgent = Object.freeze(
  new BackendStreamingDesignerAgent(),
);
