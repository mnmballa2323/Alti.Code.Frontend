...
class BackendDataLakePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendDataLakeSystem(objective) {
        logger.info(`💻 [BackendDataLakePlannerAgent] Analyzing Backend DataLake Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend DataLake Planner Target");
...
export const backendDataLakePlannerAgent = Object.freeze(new BackendDataLakePlannerAgent());
