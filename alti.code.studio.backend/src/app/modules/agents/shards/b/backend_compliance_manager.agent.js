...
class BackendComplianceManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendComplianceSystem(objective) {
    logger.info(
      `💻 [BackendComplianceManagerAgent] Analyzing Backend Compliance Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Compliance Manager Target',
      );
...
export const backendComplianceManagerAgent = Object.freeze(
  new BackendComplianceManagerAgent(),
);
