...
class BackendTestingStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendTestingSystem(objective) {
    logger.info(
      `💻 [BackendTestingStrategistAgent] Analyzing Backend Testing Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Testing Strategist Target',
      );
...
export const backendTestingStrategistAgent = Object.freeze(
  new BackendTestingStrategistAgent(),
);
