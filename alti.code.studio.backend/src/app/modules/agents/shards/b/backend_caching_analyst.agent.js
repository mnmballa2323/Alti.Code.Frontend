...
class BackendCachingAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendCachingSystem(objective) {
        logger.info(`💻 [BackendCachingAnalystAgent] Analyzing Backend Caching Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Caching Analyst Target");
...
export const backendCachingAnalystAgent = Object.freeze(new BackendCachingAnalystAgent());
