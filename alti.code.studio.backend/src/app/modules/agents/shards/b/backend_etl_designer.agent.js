...
class BackendETLDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendETLSystem(objective) {
    logger.info(
      `💻 [BackendETLDesignerAgent] Analyzing Backend ETL Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend ETL Designer Target',
      );
...
export const backendETLDesignerAgent = Object.freeze(
  new BackendETLDesignerAgent(),
);
