...
class BackendETLPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendETLSystem(objective) {
        logger.info(`💻 [BackendETLPlannerAgent] Analyzing Backend ETL Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend ETL Planner Target");
...
export const backendETLPlannerAgent = Object.freeze(new BackendETLPlannerAgent());
