...
class BackendIntegrationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendIntegrationSystem(objective) {
        logger.info(`💻 [BackendIntegrationLeadAgent] Analyzing Backend Integration Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Integration Lead Target");
...
export const backendIntegrationLeadAgent = Object.freeze(new BackendIntegrationLeadAgent());
