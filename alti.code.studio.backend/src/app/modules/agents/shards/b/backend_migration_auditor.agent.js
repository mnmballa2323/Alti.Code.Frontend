...
class BackendMigrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendMigrationSystem(objective) {
    logger.info(
      `💻 [BackendMigrationAuditorAgent] Analyzing Backend Migration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Migration Auditor Target',
      );
...
export const backendMigrationAuditorAgent = Object.freeze(
  new BackendMigrationAuditorAgent(),
);
