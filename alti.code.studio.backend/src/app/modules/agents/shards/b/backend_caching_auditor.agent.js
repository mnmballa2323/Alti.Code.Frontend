...
class BackendCachingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendCachingSystem(objective) {
    logger.info(
      `💻 [BackendCachingAuditorAgent] Analyzing Backend Caching Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Caching Auditor Target',
      );
...
export const backendCachingAuditorAgent = Object.freeze(
  new BackendCachingAuditorAgent(),
);
