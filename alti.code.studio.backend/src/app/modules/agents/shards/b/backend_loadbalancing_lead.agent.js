...
class BackendLoadBalancingLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendLoadBalancingSystem(objective) {
        logger.info(`💻 [BackendLoadBalancingLeadAgent] Analyzing Backend LoadBalancing Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend LoadBalancing Lead Target");
...
export const backendLoadBalancingLeadAgent = Object.freeze(new BackendLoadBalancingLeadAgent());
