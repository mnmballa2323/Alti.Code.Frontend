...
class BackendEngineeringLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendEngineeringSystem(objective) {
    logger.info(
      `💻 [BackendEngineeringLeadAgent] Analyzing Backend Engineering Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Engineering Lead Target',
      );
...
export const backendEngineeringLeadAgent = Object.freeze(
  new BackendEngineeringLeadAgent(),
);
