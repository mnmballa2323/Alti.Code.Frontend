...
class BackendResilienceAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendResilienceSystem(objective) {
        logger.info(`💻 [BackendResilienceAnalystAgent] Analyzing Backend Resilience Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Resilience Analyst Target");
...
export const backendResilienceAnalystAgent = Object.freeze(new BackendResilienceAnalystAgent());
