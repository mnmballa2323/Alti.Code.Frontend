...
class BackendCachingDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendCachingSystem(objective) {
        logger.info(`💻 [BackendCachingDirectorAgent] Analyzing Backend Caching Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Caching Director Target");
...
export const backendCachingDirectorAgent = Object.freeze(new BackendCachingDirectorAgent());
