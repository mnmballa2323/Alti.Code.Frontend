...
class BackendMigrationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendMigrationSystem(objective) {
    logger.info(
      `💻 [BackendMigrationPlannerAgent] Analyzing Backend Migration Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Migration Planner Target',
      );
...
export const backendMigrationPlannerAgent = Object.freeze(
  new BackendMigrationPlannerAgent(),
);
