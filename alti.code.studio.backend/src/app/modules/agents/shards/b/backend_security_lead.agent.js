...
class BackendSecurityLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendSecuritySystem(objective) {
    logger.info(
      `💻 [BackendSecurityLeadAgent] Analyzing Backend Security Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Security Lead Target',
      );
...
export const backendSecurityLeadAgent = Object.freeze(
  new BackendSecurityLeadAgent(),
);
