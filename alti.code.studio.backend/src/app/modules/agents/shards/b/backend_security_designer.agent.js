...
class BackendSecurityDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendSecuritySystem(objective) {
    logger.info(
      `💻 [BackendSecurityDesignerAgent] Analyzing Backend Security Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Security Designer Target',
      );
...
export const backendSecurityDesignerAgent = Object.freeze(
  new BackendSecurityDesignerAgent(),
);
