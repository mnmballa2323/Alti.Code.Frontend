...
class BackendETLArchitectAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendETLSystem(objective) {
        logger.info(`💻 [BackendETLArchitectAgent] Analyzing Backend ETL Architect specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend ETL Architect Target");
...
export const backendETLArchitectAgent = Object.freeze(new BackendETLArchitectAgent());
