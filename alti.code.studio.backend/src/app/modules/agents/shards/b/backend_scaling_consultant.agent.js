...
class BackendScalingConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendScalingSystem(objective) {
    logger.info(
      `💻 [BackendScalingConsultantAgent] Analyzing Backend Scaling Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Scaling Consultant Target',
      );
...
export const backendScalingConsultantAgent = Object.freeze(
  new BackendScalingConsultantAgent(),
);
