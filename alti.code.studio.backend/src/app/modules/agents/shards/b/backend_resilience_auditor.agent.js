...
class BackendResilienceAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendResilienceSystem(objective) {
    logger.info(
      `💻 [BackendResilienceAuditorAgent] Analyzing Backend Resilience Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Resilience Auditor Target',
      );
...
export const backendResilienceAuditorAgent = Object.freeze(
  new BackendResilienceAuditorAgent(),
);
