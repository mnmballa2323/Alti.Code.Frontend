...
class BreakerAgent {
    ...
    this.vulnerabilityPatterns = [
      {
        ...
        regex: /(password|secret|key|token)\s*=\s*['"][a-zA-Z0-9]{10,}['"]/i,
      },
  ...
  async attack(targetDir) {
    ...
    try {
      ...
      logger.info(
        `⚔️ Breaker: Attack complete. Found ${vulnerabilities.length} vulnerabilities.`,
      );
...
export const breakerAgent = Object.freeze(new BreakerAgent());
