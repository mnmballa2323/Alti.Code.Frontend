...
class BackendETLEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendETLSystem(objective) {
    logger.info(
      `💻 [BackendETLEngineerAgent] Analyzing Backend ETL Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend ETL Engineer Target',
      );
...
export const backendETLEngineerAgent = Object.freeze(
  new BackendETLEngineerAgent(),
);
