...
class BackendTestingSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendTestingSystem(objective) {
        logger.info(`💻 [BackendTestingSpecialistAgent] Analyzing Backend Testing Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Testing Specialist Target");
...
export const backendTestingSpecialistAgent = Object.freeze(new BackendTestingSpecialistAgent());
