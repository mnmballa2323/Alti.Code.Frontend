...
class BackendScalingSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendScalingSystem(objective) {
    logger.info(
      `💻 [BackendScalingSpecialistAgent] Analyzing Backend Scaling Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Scaling Specialist Target',
      );
...
export const backendScalingSpecialistAgent = Object.freeze(
  new BackendScalingSpecialistAgent(),
);
