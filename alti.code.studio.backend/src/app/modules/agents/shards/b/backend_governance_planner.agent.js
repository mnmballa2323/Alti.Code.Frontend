...
class BackendGovernancePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendGovernanceSystem(objective) {
    logger.info(
      `💻 [BackendGovernancePlannerAgent] Analyzing Backend Governance Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Governance Planner Target',
      );
...
export const backendGovernancePlannerAgent = Object.freeze(
  new BackendGovernancePlannerAgent(),
);
