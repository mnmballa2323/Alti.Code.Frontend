...
class BackendDataLakeArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendDataLakeSystem(objective) {
    logger.info(
      `💻 [BackendDataLakeArchitectAgent] Analyzing Backend DataLake Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend DataLake Architect Target',
      );
...
export const backendDataLakeArchitectAgent = Object.freeze(
  new BackendDataLakeArchitectAgent(),
);
