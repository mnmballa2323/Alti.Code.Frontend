...
class BackendDataLakeTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendDataLakeSystem(objective) {
    logger.info(
      `💻 [BackendDataLakeTesterAgent] Analyzing Backend DataLake Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend DataLake Tester Target',
      );
...
export const backendDataLakeTesterAgent = Object.freeze(
  new BackendDataLakeTesterAgent(),
);
