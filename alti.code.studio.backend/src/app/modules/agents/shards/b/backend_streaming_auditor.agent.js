...
class BackendStreamingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateBackendStreamingSystem(objective) {
    logger.info(
      `💻 [BackendStreamingAuditorAgent] Analyzing Backend Streaming Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Backend Streaming Auditor Target',
      );
...
export const backendStreamingAuditorAgent = Object.freeze(
  new BackendStreamingAuditorAgent(),
);
