...
class BackendStreamingEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateBackendStreamingSystem(objective) {
        logger.info(`💻 [BackendStreamingEngineerAgent] Analyzing Backend Streaming Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Backend Streaming Engineer Target");
...
export const backendStreamingEngineerAgent = Object.freeze(new BackendStreamingEngineerAgent());
