...
class ReleaseServerlessAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateReleaseServerlessSystem(objective) {
        logger.info(`💻 [ReleaseServerlessAnalystAgent] Analyzing Release Serverless Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Release Serverless Analyst Target");
...
export const releaseServerlessAnalystAgent = Object.freeze(new ReleaseServerlessAnalystAgent());
