...
class ReleaseMigrationDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseMigrationSystem(objective) {
    logger.info(
      `💻 [ReleaseMigrationDirectorAgent] Analyzing Release Migration Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Migration Director Target',
      );
...
export const releaseMigrationDirectorAgent = Object.freeze(
  new ReleaseMigrationDirectorAgent(),
);
