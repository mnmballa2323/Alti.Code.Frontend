...
class ReleaseTestingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseTestingSystem(objective) {
    logger.info(
      `💻 [ReleaseTestingDesignerAgent] Analyzing Release Testing Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Testing Designer Target',
      );
...
export const releaseTestingDesignerAgent = Object.freeze(
  new ReleaseTestingDesignerAgent(),
);
