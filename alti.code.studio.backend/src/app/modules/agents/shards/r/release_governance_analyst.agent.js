...
class ReleaseGovernanceAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseGovernanceSystem(objective) {
    logger.info(
      `💻 [ReleaseGovernanceAnalystAgent] Analyzing Release Governance Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Governance Analyst Target',
      );
...
export const releaseGovernanceAnalystAgent = Object.freeze(
  new ReleaseGovernanceAnalystAgent(),
);
