...
class ReleaseOrchestrationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseOrchestrationSystem(objective) {
    logger.info(
      `💻 [ReleaseOrchestrationLeadAgent] Analyzing Release Orchestration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Orchestration Lead Target',
      );
...
export const releaseOrchestrationLeadAgent = Object.freeze(
  new ReleaseOrchestrationLeadAgent(),
);
