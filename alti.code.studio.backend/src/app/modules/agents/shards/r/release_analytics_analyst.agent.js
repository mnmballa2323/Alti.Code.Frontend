...
class ReleaseAnalyticsAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseAnalyticsSystem(objective) {
    logger.info(
      `💻 [ReleaseAnalyticsAnalystAgent] Analyzing Release Analytics Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Analytics Analyst Target',
      );
...
export const releaseAnalyticsAnalystAgent = Object.freeze(
  new ReleaseAnalyticsAnalystAgent(),
);
