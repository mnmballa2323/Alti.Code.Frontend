...
class ReleaseETLAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateReleaseETLSystem(objective) {
        logger.info(`💻 [ReleaseETLAuditorAgent] Analyzing Release ETL Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Release ETL Auditor Target");
...
export const releaseETLAuditorAgent = Object.freeze(new ReleaseETLAuditorAgent());
