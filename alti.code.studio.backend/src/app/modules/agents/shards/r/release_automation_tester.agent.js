...
class ReleaseAutomationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseAutomationSystem(objective) {
    logger.info(
      `💻 [ReleaseAutomationTesterAgent] Analyzing Release Automation Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Automation Tester Target',
      );
...
export const releaseAutomationTesterAgent = Object.freeze(
  new ReleaseAutomationTesterAgent(),
);
