...
class ReleaseAnalyticsAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseAnalyticsSystem(objective) {
    logger.info(
      `💻 [ReleaseAnalyticsAuditorAgent] Analyzing Release Analytics Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Analytics Auditor Target',
      );
...
export const releaseAnalyticsAuditorAgent = Object.freeze(
  new ReleaseAnalyticsAuditorAgent(),
);
