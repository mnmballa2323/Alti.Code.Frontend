...
class ReleaseGovernanceAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseGovernanceSystem(objective) {
    logger.info(
      `💻 [ReleaseGovernanceAuditorAgent] Analyzing Release Governance Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Governance Auditor Target',
      );
...
export const releaseGovernanceAuditorAgent = Object.freeze(
  new ReleaseGovernanceAuditorAgent(),
);
