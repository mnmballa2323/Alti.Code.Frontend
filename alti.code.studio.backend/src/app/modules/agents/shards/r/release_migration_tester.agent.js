...
class ReleaseMigrationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseMigrationSystem(objective) {
    logger.info(
      `💻 [ReleaseMigrationTesterAgent] Analyzing Release Migration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Migration Tester Target',
      );
...
export const releaseMigrationTesterAgent = Object.freeze(
  new ReleaseMigrationTesterAgent(),
);
