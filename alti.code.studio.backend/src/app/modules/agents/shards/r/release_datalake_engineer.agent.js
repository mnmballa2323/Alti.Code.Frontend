...
class ReleaseDataLakeEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateReleaseDataLakeSystem(objective) {
        logger.info(`💻 [ReleaseDataLakeEngineerAgent] Analyzing Release DataLake Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Release DataLake Engineer Target");
...
export const releaseDataLakeEngineerAgent = Object.freeze(new ReleaseDataLakeEngineerAgent());
