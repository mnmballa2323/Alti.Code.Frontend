...
class ReleaseMigrationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseMigrationSystem(objective) {
    logger.info(
      `💻 [ReleaseMigrationManagerAgent] Analyzing Release Migration Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Migration Manager Target',
      );
...
export const releaseMigrationManagerAgent = Object.freeze(
  new ReleaseMigrationManagerAgent(),
);
