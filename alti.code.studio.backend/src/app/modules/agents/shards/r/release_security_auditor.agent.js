...
class ReleaseSecurityAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseSecuritySystem(objective) {
    logger.info(
      `💻 [ReleaseSecurityAuditorAgent] Analyzing Release Security Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Security Auditor Target',
      );
...
export const releaseSecurityAuditorAgent = Object.freeze(
  new ReleaseSecurityAuditorAgent(),
);
