...
class ReleaseTestingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseTestingSystem(objective) {
    logger.info(
      `💻 [ReleaseTestingAuditorAgent] Analyzing Release Testing Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Testing Auditor Target',
      );
...
export const releaseTestingAuditorAgent = Object.freeze(
  new ReleaseTestingAuditorAgent(),
);
