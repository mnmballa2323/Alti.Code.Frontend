...
class ReleaseTelemetryDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseTelemetrySystem(objective) {
    logger.info(
      `💻 [ReleaseTelemetryDirectorAgent] Analyzing Release Telemetry Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Telemetry Director Target',
      );
...
export const releaseTelemetryDirectorAgent = Object.freeze(
  new ReleaseTelemetryDirectorAgent(),
);
