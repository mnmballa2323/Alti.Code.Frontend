...
class ReleaseTestingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseTestingSystem(objective) {
    logger.info(
      `💻 [ReleaseTestingLeadAgent] Analyzing Release Testing Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Testing Lead Target',
      );
...
export const releaseTestingLeadAgent = Object.freeze(
  new ReleaseTestingLeadAgent(),
);
