...
class ReleaseMigrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseMigrationSystem(objective) {
    logger.info(
      `💻 [ReleaseMigrationAuditorAgent] Analyzing Release Migration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Migration Auditor Target',
      );
...
export const releaseMigrationAuditorAgent = Object.freeze(
  new ReleaseMigrationAuditorAgent(),
);
