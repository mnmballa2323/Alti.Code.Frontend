...
class ReleaseEngineeringTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseEngineeringSystem(objective) {
    logger.info(
      `💻 [ReleaseEngineeringTesterAgent] Analyzing Release Engineering Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Engineering Tester Target',
      );
...
export const releaseEngineeringTesterAgent = Object.freeze(
  new ReleaseEngineeringTesterAgent(),
);
