...
class ReleaseTelemetryEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseTelemetrySystem(objective) {
    logger.info(
      `💻 [ReleaseTelemetryEngineerAgent] Analyzing Release Telemetry Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Telemetry Engineer Target',
      );
...
export const releaseTelemetryEngineerAgent = Object.freeze(
  new ReleaseTelemetryEngineerAgent(),
);
