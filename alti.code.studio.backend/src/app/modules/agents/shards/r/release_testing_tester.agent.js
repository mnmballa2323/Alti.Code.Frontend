...
class ReleaseTestingTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateReleaseTestingSystem(objective) {
        logger.info(`💻 [ReleaseTestingTesterAgent] Analyzing Release Testing Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Release Testing Tester Target");
...
export const releaseTestingTesterAgent = Object.freeze(new ReleaseTestingTesterAgent());
