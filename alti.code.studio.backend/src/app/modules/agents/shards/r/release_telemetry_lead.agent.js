...
class ReleaseTelemetryLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseTelemetrySystem(objective) {
    logger.info(
      `💻 [ReleaseTelemetryLeadAgent] Analyzing Release Telemetry Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Telemetry Lead Target',
      );
...
export const releaseTelemetryLeadAgent = Object.freeze(
  new ReleaseTelemetryLeadAgent(),
);
