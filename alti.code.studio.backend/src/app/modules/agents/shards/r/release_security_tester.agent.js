...
class ReleaseSecurityTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseSecuritySystem(objective) {
    logger.info(
      `💻 [ReleaseSecurityTesterAgent] Analyzing Release Security Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Security Tester Target',
      );
...
export const releaseSecurityTesterAgent = Object.freeze(
  new ReleaseSecurityTesterAgent(),
);
