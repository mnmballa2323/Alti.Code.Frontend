...
class ReleaseDataLakeManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseDataLakeSystem(objective) {
    logger.info(
      `💻 [ReleaseDataLakeManagerAgent] Analyzing Release DataLake Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release DataLake Manager Target',
      );
...
export const releaseDataLakeManagerAgent = Object.freeze(
  new ReleaseDataLakeManagerAgent(),
);
