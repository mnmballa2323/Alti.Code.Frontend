...
class ReleaseAutomationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseAutomationSystem(objective) {
    logger.info(
      `💻 [ReleaseAutomationLeadAgent] Analyzing Release Automation Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Automation Lead Target',
      );
...
export const releaseAutomationLeadAgent = Object.freeze(
  new ReleaseAutomationLeadAgent(),
);
