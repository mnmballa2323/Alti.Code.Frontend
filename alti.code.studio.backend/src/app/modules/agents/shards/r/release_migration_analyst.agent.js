...
class ReleaseMigrationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseMigrationSystem(objective) {
    logger.info(
      `💻 [ReleaseMigrationAnalystAgent] Analyzing Release Migration Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Migration Analyst Target',
      );
...
export const releaseMigrationAnalystAgent = Object.freeze(
  new ReleaseMigrationAnalystAgent(),
);
