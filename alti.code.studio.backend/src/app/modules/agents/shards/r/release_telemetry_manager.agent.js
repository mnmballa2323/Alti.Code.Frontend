...
class ReleaseTelemetryManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseTelemetrySystem(objective) {
    logger.info(
      `💻 [ReleaseTelemetryManagerAgent] Analyzing Release Telemetry Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Telemetry Manager Target',
      );
...
export const releaseTelemetryManagerAgent = Object.freeze(
  new ReleaseTelemetryManagerAgent(),
);
