...
class ReleaseDataLakeDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateReleaseDataLakeSystem(objective) {
        logger.info(`💻 [ReleaseDataLakeDirectorAgent] Analyzing Release DataLake Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Release DataLake Director Target");
...
export const releaseDataLakeDirectorAgent = Object.freeze(new ReleaseDataLakeDirectorAgent());
