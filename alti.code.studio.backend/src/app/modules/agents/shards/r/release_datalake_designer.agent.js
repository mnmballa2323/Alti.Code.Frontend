...
class ReleaseDataLakeDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseDataLakeSystem(objective) {
    logger.info(
      `💻 [ReleaseDataLakeDesignerAgent] Analyzing Release DataLake Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release DataLake Designer Target',
      );
...
export const releaseDataLakeDesignerAgent = Object.freeze(
  new ReleaseDataLakeDesignerAgent(),
);
