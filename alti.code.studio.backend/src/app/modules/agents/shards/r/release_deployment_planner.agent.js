...
class ReleaseDeploymentPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseDeploymentSystem(objective) {
    logger.info(
      `💻 [ReleaseDeploymentPlannerAgent] Analyzing Release Deployment Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Deployment Planner Target',
      );
...
export const releaseDeploymentPlannerAgent = Object.freeze(
  new ReleaseDeploymentPlannerAgent(),
);
