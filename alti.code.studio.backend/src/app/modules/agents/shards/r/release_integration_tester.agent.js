...
class ReleaseIntegrationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseIntegrationSystem(objective) {
    logger.info(
      `💻 [ReleaseIntegrationTesterAgent] Analyzing Release Integration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Integration Tester Target',
      );
...
export const releaseIntegrationTesterAgent = Object.freeze(
  new ReleaseIntegrationTesterAgent(),
);
