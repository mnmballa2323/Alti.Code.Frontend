...
class ReasonMLSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateReasonMLSystem(objective) {
        logger.info(`💻 [ReasonMLSpecialistAgent] Analyzing ReasonML requirements...`);
...
export const ReasonMLSpecialistAgentInstance = Object.freeze(new ReasonMLSpecialistAgent());
