...
class ReleaseETLEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseETLSystem(objective) {
    logger.info(
      `💻 [ReleaseETLEngineerAgent] Analyzing Release ETL Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release ETL Engineer Target',
      );
...
export const releaseETLEngineerAgent = Object.freeze(
  new ReleaseETLEngineerAgent(),
);
