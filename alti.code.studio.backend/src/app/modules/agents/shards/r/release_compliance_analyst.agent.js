...
class ReleaseComplianceAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseComplianceSystem(objective) {
    logger.info(
      `💻 [ReleaseComplianceAnalystAgent] Analyzing Release Compliance Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Compliance Analyst Target',
      );
...
export const releaseComplianceAnalystAgent = Object.freeze(
  new ReleaseComplianceAnalystAgent(),
);
