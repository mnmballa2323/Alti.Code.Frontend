...
class ReleaseAnalyticsDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseAnalyticsSystem(objective) {
    logger.info(
      `💻 [ReleaseAnalyticsDesignerAgent] Analyzing Release Analytics Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Analytics Designer Target',
      );
...
export const releaseAnalyticsDesignerAgent = Object.freeze(
  new ReleaseAnalyticsDesignerAgent(),
);
