...
class ReleaseResilienceLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseResilienceSystem(objective) {
    logger.info(
      `💻 [ReleaseResilienceLeadAgent] Analyzing Release Resilience Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Resilience Lead Target',
      );
...
export const releaseResilienceLeadAgent = Object.freeze(
  new ReleaseResilienceLeadAgent(),
);
