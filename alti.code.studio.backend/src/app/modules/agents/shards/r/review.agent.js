...
class ReviewAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Autonomous PR reviewer. Leverages the OpenClaw `review-pr` skill to provide structured, deterministic critiques of generated code.';
...
export const reviewAgent = Object.freeze(new ReviewAgent());
