...
class ReleaseEngineeringLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseEngineeringSystem(objective) {
    logger.info(
      `💻 [ReleaseEngineeringLeadAgent] Analyzing Release Engineering Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Engineering Lead Target',
      );
...
export const releaseEngineeringLeadAgent = Object.freeze(
  new ReleaseEngineeringLeadAgent(),
);
