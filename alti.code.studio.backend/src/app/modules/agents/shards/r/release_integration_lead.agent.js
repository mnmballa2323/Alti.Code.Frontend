...
class ReleaseIntegrationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateReleaseIntegrationSystem(objective) {
        logger.info(`💻 [ReleaseIntegrationLeadAgent] Analyzing Release Integration Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Release Integration Lead Target");
...
export const releaseIntegrationLeadAgent = Object.freeze(new ReleaseIntegrationLeadAgent());
