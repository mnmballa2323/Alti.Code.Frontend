...
class ReleaseDataLakeTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseDataLakeSystem(objective) {
    logger.info(
      `💻 [ReleaseDataLakeTesterAgent] Analyzing Release DataLake Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release DataLake Tester Target',
      );
...
export const releaseDataLakeTesterAgent = Object.freeze(
  new ReleaseDataLakeTesterAgent(),
);
