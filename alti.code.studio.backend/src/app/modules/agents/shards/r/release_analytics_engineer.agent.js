...
class ReleaseAnalyticsEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseAnalyticsSystem(objective) {
    logger.info(
      `💻 [ReleaseAnalyticsEngineerAgent] Analyzing Release Analytics Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Analytics Engineer Target',
      );
...
export const releaseAnalyticsEngineerAgent = Object.freeze(
  new ReleaseAnalyticsEngineerAgent(),
);
