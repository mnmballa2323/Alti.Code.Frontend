...
class ReleaseMigrationEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseMigrationSystem(objective) {
    logger.info(
      `💻 [ReleaseMigrationEngineerAgent] Analyzing Release Migration Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Migration Engineer Target',
      );
...
export const releaseMigrationEngineerAgent = Object.freeze(
  new ReleaseMigrationEngineerAgent(),
);
