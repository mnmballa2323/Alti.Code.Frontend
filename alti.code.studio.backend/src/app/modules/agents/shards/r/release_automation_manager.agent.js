...
class ReleaseAutomationManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateReleaseAutomationSystem(objective) {
        logger.info(`💻 [ReleaseAutomationManagerAgent] Analyzing Release Automation Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Release Automation Manager Target");
...
export const releaseAutomationManagerAgent = Object.freeze(new ReleaseAutomationManagerAgent());
