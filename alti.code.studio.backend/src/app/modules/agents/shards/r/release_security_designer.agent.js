...
class ReleaseSecurityDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseSecuritySystem(objective) {
    logger.info(
      `💻 [ReleaseSecurityDesignerAgent] Analyzing Release Security Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Security Designer Target',
      );
...
export const releaseSecurityDesignerAgent = Object.freeze(
  new ReleaseSecurityDesignerAgent(),
);
