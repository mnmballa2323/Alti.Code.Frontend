...
class ReleaseSecurityManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseSecuritySystem(objective) {
    logger.info(
      `💻 [ReleaseSecurityManagerAgent] Analyzing Release Security Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Security Manager Target',
      );
...
export const releaseSecurityManagerAgent = Object.freeze(
  new ReleaseSecurityManagerAgent(),
);
