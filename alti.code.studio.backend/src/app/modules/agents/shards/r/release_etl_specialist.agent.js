...
class ReleaseETLSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseETLSystem(objective) {
    logger.info(
      `💻 [ReleaseETLSpecialistAgent] Analyzing Release ETL Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release ETL Specialist Target',
      );
...
export const releaseETLSpecialistAgent = Object.freeze(
  new ReleaseETLSpecialistAgent(),
);
