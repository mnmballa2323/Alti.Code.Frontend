...
class ReleaseSecurityEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseSecuritySystem(objective) {
    logger.info(
      `💻 [ReleaseSecurityEngineerAgent] Analyzing Release Security Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Security Engineer Target',
      );
...
export const releaseSecurityEngineerAgent = Object.freeze(
  new ReleaseSecurityEngineerAgent(),
);
