...
class ReleaseETLAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseETLSystem(objective) {
    logger.info(
      `💻 [ReleaseETLAnalystAgent] Analyzing Release ETL Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release ETL Analyst Target',
      );
...
export const releaseETLAnalystAgent = Object.freeze(
  new ReleaseETLAnalystAgent(),
);
