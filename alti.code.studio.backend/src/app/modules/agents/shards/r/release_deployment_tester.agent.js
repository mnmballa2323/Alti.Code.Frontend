...
class ReleaseDeploymentTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseDeploymentSystem(objective) {
    logger.info(
      `💻 [ReleaseDeploymentTesterAgent] Analyzing Release Deployment Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Deployment Tester Target',
      );
...
export const releaseDeploymentTesterAgent = Object.freeze(
  new ReleaseDeploymentTesterAgent(),
);
