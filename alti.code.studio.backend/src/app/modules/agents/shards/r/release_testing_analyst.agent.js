...
class ReleaseTestingAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateReleaseTestingSystem(objective) {
        logger.info(`💻 [ReleaseTestingAnalystAgent] Analyzing Release Testing Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Release Testing Analyst Target");
...
export const releaseTestingAnalystAgent = Object.freeze(new ReleaseTestingAnalystAgent());
