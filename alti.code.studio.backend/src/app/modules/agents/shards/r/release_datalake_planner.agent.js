...
class ReleaseDataLakePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseDataLakeSystem(objective) {
    logger.info(
      `💻 [ReleaseDataLakePlannerAgent] Analyzing Release DataLake Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release DataLake Planner Target',
      );
...
export const releaseDataLakePlannerAgent = Object.freeze(
  new ReleaseDataLakePlannerAgent(),
);
