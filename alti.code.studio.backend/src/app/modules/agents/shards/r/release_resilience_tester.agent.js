...
class ReleaseResilienceTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateReleaseResilienceSystem(objective) {
        logger.info(`💻 [ReleaseResilienceTesterAgent] Analyzing Release Resilience Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Release Resilience Tester Target");
...
export const releaseResilienceTesterAgent = Object.freeze(new ReleaseResilienceTesterAgent());
