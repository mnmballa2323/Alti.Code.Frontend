...
class ReleaseServerlessManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateReleaseServerlessSystem(objective) {
        logger.info(`💻 [ReleaseServerlessManagerAgent] Analyzing Release Serverless Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Release Serverless Manager Target");
...
export const releaseServerlessManagerAgent = Object.freeze(new ReleaseServerlessManagerAgent());
