...
class ReleaseServerlessTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateReleaseServerlessSystem(objective) {
        logger.info(`💻 [ReleaseServerlessTesterAgent] Analyzing Release Serverless Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Release Serverless Tester Target");
...
export const releaseServerlessTesterAgent = Object.freeze(new ReleaseServerlessTesterAgent());
