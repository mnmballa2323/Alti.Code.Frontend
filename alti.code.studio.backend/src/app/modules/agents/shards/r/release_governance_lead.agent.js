...
class ReleaseGovernanceLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseGovernanceSystem(objective) {
    logger.info(
      `💻 [ReleaseGovernanceLeadAgent] Analyzing Release Governance Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Governance Lead Target',
      );
...
export const releaseGovernanceLeadAgent = Object.freeze(
  new ReleaseGovernanceLeadAgent(),
);
