...
class ReleaseDataLakeLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseDataLakeSystem(objective) {
    logger.info(
      `💻 [ReleaseDataLakeLeadAgent] Analyzing Release DataLake Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release DataLake Lead Target',
      );
...
export const releaseDataLakeLeadAgent = Object.freeze(
  new ReleaseDataLakeLeadAgent(),
);
