...
class RagContextOptimizerAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'RAG Context & Token Optimizer Specialist — Analyzes token bloat and prunes redundant document context to keep AI reasoning cheap, fast, and highly focused.';
        this.capabilities = ['rag-optimization', 'token-pruning', 'context-summarization', 'vector-search-tuning'];
