...
class ReleaseDataLakeAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseDataLakeSystem(objective) {
    logger.info(
      `💻 [ReleaseDataLakeAnalystAgent] Analyzing Release DataLake Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release DataLake Analyst Target',
      );
...
export const releaseDataLakeAnalystAgent = Object.freeze(
  new ReleaseDataLakeAnalystAgent(),
);
