...
class ReleaseMicroservicesLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseMicroservicesSystem(objective) {
    logger.info(
      `💻 [ReleaseMicroservicesLeadAgent] Analyzing Release Microservices Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Microservices Lead Target',
      );
...
export const releaseMicroservicesLeadAgent = Object.freeze(
  new ReleaseMicroservicesLeadAgent(),
);
