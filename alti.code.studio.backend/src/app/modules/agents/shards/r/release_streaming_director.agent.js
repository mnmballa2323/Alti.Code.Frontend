...
class ReleaseStreamingDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateReleaseStreamingSystem(objective) {
        logger.info(`💻 [ReleaseStreamingDirectorAgent] Analyzing Release Streaming Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Release Streaming Director Target");
...
export const releaseStreamingDirectorAgent = Object.freeze(new ReleaseStreamingDirectorAgent());
