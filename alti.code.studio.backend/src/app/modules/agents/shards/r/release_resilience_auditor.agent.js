...
class ReleaseResilienceAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseResilienceSystem(objective) {
    logger.info(
      `💻 [ReleaseResilienceAuditorAgent] Analyzing Release Resilience Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Resilience Auditor Target',
      );
...
export const releaseResilienceAuditorAgent = Object.freeze(
  new ReleaseResilienceAuditorAgent(),
);
