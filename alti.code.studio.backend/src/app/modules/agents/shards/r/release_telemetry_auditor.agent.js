...
class ReleaseTelemetryAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateReleaseTelemetrySystem(objective) {
        logger.info(`💻 [ReleaseTelemetryAuditorAgent] Analyzing Release Telemetry Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Release Telemetry Auditor Target");
...
export const releaseTelemetryAuditorAgent = Object.freeze(new ReleaseTelemetryAuditorAgent());
