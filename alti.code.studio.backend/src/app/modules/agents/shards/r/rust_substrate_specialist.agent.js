...
class RustSubstrateSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateRustSubstrateSystem(objective) {
        logger.info(`💻 [RustSubstrateSpecialistAgent] Analyzing Rust Substrate requirements...`);
...
export const RustSubstrateSpecialistAgentInstance = Object.freeze(new RustSubstrateSpecialistAgent());
