...
class ReleaseCachingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseCachingSystem(objective) {
    logger.info(
      `💻 [ReleaseCachingAuditorAgent] Analyzing Release Caching Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Caching Auditor Target',
      );
...
export const releaseCachingAuditorAgent = Object.freeze(
  new ReleaseCachingAuditorAgent(),
);
