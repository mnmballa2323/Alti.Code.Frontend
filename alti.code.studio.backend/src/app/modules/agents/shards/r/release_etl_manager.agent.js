...
class ReleaseETLManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateReleaseETLSystem(objective) {
        logger.info(`💻 [ReleaseETLManagerAgent] Analyzing Release ETL Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Release ETL Manager Target");
...
export const releaseETLManagerAgent = Object.freeze(new ReleaseETLManagerAgent());
