...
class ReleaseDataWarehouseLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateReleaseDataWarehouseSystem(objective) {
        logger.info(`💻 [ReleaseDataWarehouseLeadAgent] Analyzing Release DataWarehouse Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Release DataWarehouse Lead Target");
...
export const releaseDataWarehouseLeadAgent = Object.freeze(new ReleaseDataWarehouseLeadAgent());
