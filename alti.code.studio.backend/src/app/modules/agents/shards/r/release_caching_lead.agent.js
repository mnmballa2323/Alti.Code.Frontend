...
class ReleaseCachingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseCachingSystem(objective) {
    logger.info(
      `💻 [ReleaseCachingLeadAgent] Analyzing Release Caching Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Caching Lead Target',
      );
...
export const releaseCachingLeadAgent = Object.freeze(
  new ReleaseCachingLeadAgent(),
);
