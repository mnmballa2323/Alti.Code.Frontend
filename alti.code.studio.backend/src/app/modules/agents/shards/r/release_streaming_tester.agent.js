...
class ReleaseStreamingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseStreamingSystem(objective) {
    logger.info(
      `💻 [ReleaseStreamingTesterAgent] Analyzing Release Streaming Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Streaming Tester Target',
      );
...
export const releaseStreamingTesterAgent = Object.freeze(
  new ReleaseStreamingTesterAgent(),
);
