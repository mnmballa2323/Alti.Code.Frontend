...
class ReleaseObservabilityLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseObservabilitySystem(objective) {
    logger.info(
      `💻 [ReleaseObservabilityLeadAgent] Analyzing Release Observability Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Observability Lead Target',
      );
...
export const releaseObservabilityLeadAgent = Object.freeze(
  new ReleaseObservabilityLeadAgent(),
);
