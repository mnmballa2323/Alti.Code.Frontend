...
class ReleaseCompliancePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateReleaseComplianceSystem(objective) {
        logger.info(`💻 [ReleaseCompliancePlannerAgent] Analyzing Release Compliance Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Release Compliance Planner Target");
...
export const releaseCompliancePlannerAgent = Object.freeze(new ReleaseCompliancePlannerAgent());
