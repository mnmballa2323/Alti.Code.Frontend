...
class ReleaseOptimizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseOptimizationSystem(objective) {
    logger.info(
      `💻 [ReleaseOptimizationLeadAgent] Analyzing Release Optimization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Optimization Lead Target',
      );
...
export const releaseOptimizationLeadAgent = Object.freeze(
  new ReleaseOptimizationLeadAgent(),
);
