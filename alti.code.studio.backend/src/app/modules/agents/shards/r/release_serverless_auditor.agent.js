...
class ReleaseServerlessAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseServerlessSystem(objective) {
    logger.info(
      `💻 [ReleaseServerlessAuditorAgent] Analyzing Release Serverless Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Serverless Auditor Target',
      );
...
export const releaseServerlessAuditorAgent = Object.freeze(
  new ReleaseServerlessAuditorAgent(),
);
