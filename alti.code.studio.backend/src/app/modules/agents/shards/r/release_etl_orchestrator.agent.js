...
class ReleaseETLOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseETLSystem(objective) {
    logger.info(
      `💻 [ReleaseETLOrchestratorAgent] Analyzing Release ETL Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release ETL Orchestrator Target',
      );
...
export const releaseETLOrchestratorAgent = Object.freeze(
  new ReleaseETLOrchestratorAgent(),
);
