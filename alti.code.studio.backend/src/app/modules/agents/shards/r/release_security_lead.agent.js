...
class ReleaseSecurityLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseSecuritySystem(objective) {
    logger.info(
      `💻 [ReleaseSecurityLeadAgent] Analyzing Release Security Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release Security Lead Target',
      );
...
export const releaseSecurityLeadAgent = Object.freeze(
  new ReleaseSecurityLeadAgent(),
);
