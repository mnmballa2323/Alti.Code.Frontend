...
class RefactorDebtScrubberAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Refactor & Technical Debt Scrubber Specialist — Analyzes code components to eliminate spaghetti structures, excessive nesting, and duplicated logic, optimizing code maintainability.';
        this.capabilities = ['code-refactoring', 'tech-debt-elimination', 'complexity-reduction', 'modular-design', 'dry-principles'];
