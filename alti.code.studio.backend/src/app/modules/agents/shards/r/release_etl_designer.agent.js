...
class ReleaseETLDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseETLSystem(objective) {
    logger.info(
      `💻 [ReleaseETLDesignerAgent] Analyzing Release ETL Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release ETL Designer Target',
      );
...
export const releaseETLDesignerAgent = Object.freeze(
  new ReleaseETLDesignerAgent(),
);
