...
class ReleaseETLDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateReleaseETLSystem(objective) {
    logger.info(
      `💻 [ReleaseETLDirectorAgent] Analyzing Release ETL Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Release ETL Director Target',
      );
...
export const releaseETLDirectorAgent = Object.freeze(
  new ReleaseETLDirectorAgent(),
);
