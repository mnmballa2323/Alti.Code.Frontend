...
class AIDeploymentDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIDeploymentSystem(objective) {
    logger.info(
      `💻 [AIDeploymentDirectorAgent] Analyzing AI Deployment Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Deployment Director Target',
      );
...
export const aIDeploymentDirectorAgent = Object.freeze(
  new AIDeploymentDirectorAgent(),
);
