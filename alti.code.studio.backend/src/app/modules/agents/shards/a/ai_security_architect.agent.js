...
class AISecurityArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateAISecuritySystem(objective) {
    logger.info(
      `💻 [AISecurityArchitectAgent] Analyzing AI Security Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Security Architect Target',
      );
...
export const aISecurityArchitectAgent = Object.freeze(
  new AISecurityArchitectAgent(),
);
