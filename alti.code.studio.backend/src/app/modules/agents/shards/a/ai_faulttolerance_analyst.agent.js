...
class AIFaultToleranceAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateAIFaultToleranceSystem(objective) {
    logger.info(
      `💻 [AIFaultToleranceAnalystAgent] Analyzing AI FaultTolerance Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI FaultTolerance Analyst Target',
      );
...
export const aIFaultToleranceAnalystAgent = Object.freeze(
  new AIFaultToleranceAnalystAgent(),
);
