...
class AIDataLakeManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIDataLakeSystem(objective) {
    logger.info(
      `💻 [AIDataLakeManagerAgent] Analyzing AI DataLake Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI DataLake Manager Target',
      );
...
export const aIDataLakeManagerAgent = Object.freeze(
  new AIDataLakeManagerAgent(),
);
