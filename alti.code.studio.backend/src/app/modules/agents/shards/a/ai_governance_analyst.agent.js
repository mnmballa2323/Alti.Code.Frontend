...
class AIGovernanceAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateAIGovernanceSystem(objective) {
    logger.info(
      `💻 [AIGovernanceAnalystAgent] Analyzing AI Governance Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Governance Analyst Target',
      );
...
export const aIGovernanceAnalystAgent = Object.freeze(
  new AIGovernanceAnalystAgent(),
);
