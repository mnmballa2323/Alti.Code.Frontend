...
class AITestingEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateAITestingSystem(objective) {
        logger.info(`💻 [AITestingEngineerAgent] Analyzing AI Testing Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Testing Engineer Target");
...
export const aITestingEngineerAgent = Object.freeze(new AITestingEngineerAgent());
