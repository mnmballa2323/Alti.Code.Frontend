...
class AIGovernancePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateAIGovernanceSystem(objective) {
        logger.info(`💻 [AIGovernancePlannerAgent] Analyzing AI Governance Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Governance Planner Target");
...
export const aIGovernancePlannerAgent = Object.freeze(new AIGovernancePlannerAgent());
