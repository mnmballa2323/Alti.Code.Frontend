...
class AITelemetryDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateAITelemetrySystem(objective) {
    logger.info(
      `💻 [AITelemetryDesignerAgent] Analyzing AI Telemetry Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Telemetry Designer Target',
      );
...
export const aITelemetryDesignerAgent = Object.freeze(
  new AITelemetryDesignerAgent(),
);
