...
class AIDataWarehouseDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateAIDataWarehouseSystem(objective) {
        logger.info(`💻 [AIDataWarehouseDirectorAgent] Analyzing AI DataWarehouse Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI DataWarehouse Director Target");
...
export const aIDataWarehouseDirectorAgent = Object.freeze(new AIDataWarehouseDirectorAgent());
