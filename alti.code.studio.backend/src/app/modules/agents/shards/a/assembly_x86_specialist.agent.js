...
class x86AssemblySpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generatex86AssemblySystem(objective) {
    logger.info(
      `💻 [x86AssemblySpecialistAgent] Analyzing x86 Assembly requirements...`,
    );
...
export const x86AssemblySpecialistAgentInstance = Object.freeze(
  new x86AssemblySpecialistAgent(),
);
