...
class AIAutomationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIAutomationSystem(objective) {
    logger.info(
      `💻 [AIAutomationAuditorAgent] Analyzing AI Automation Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Automation Auditor Target',
      );
...
export const aIAutomationAuditorAgent = Object.freeze(
  new AIAutomationAuditorAgent(),
);
