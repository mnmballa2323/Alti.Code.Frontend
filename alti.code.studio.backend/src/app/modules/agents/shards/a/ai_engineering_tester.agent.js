...
class AIEngineeringTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateAIEngineeringSystem(objective) {
        logger.info(`💻 [AIEngineeringTesterAgent] Analyzing AI Engineering Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Engineering Tester Target");
...
export const aIEngineeringTesterAgent = Object.freeze(new AIEngineeringTesterAgent());
