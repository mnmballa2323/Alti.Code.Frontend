...
class AIObservabilityPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateAIObservabilitySystem(objective) {
        logger.info(`💻 [AIObservabilityPlannerAgent] Analyzing AI Observability Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Observability Planner Target");
...
export const aIObservabilityPlannerAgent = Object.freeze(new AIObservabilityPlannerAgent());
