...
class AITestingOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateAITestingSystem(objective) {
    logger.info(
      `💻 [AITestingOrchestratorAgent] Analyzing AI Testing Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Testing Orchestrator Target',
      );
...
export const aITestingOrchestratorAgent = Object.freeze(
  new AITestingOrchestratorAgent(),
);
