...
class AIVirtualizationDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIVirtualizationSystem(objective) {
    logger.info(
      `💻 [AIVirtualizationDesignerAgent] Analyzing AI Virtualization Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Virtualization Designer Target',
      );
...
export const aIVirtualizationDesignerAgent = Object.freeze(
  new AIVirtualizationDesignerAgent(),
);
