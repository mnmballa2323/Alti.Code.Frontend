...
class AIOrchestrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIOrchestrationSystem(objective) {
    logger.info(
      `💻 [AIOrchestrationAuditorAgent] Analyzing AI Orchestration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Orchestration Auditor Target',
      );
...
export const aIOrchestrationAuditorAgent = Object.freeze(
  new AIOrchestrationAuditorAgent(),
);
