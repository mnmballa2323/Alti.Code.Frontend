...
class AIAutomationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIAutomationSystem(objective) {
    logger.info(
      `💻 [AIAutomationManagerAgent] Analyzing AI Automation Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Automation Manager Target',
      );
...
export const aIAutomationManagerAgent = Object.freeze(
  new AIAutomationManagerAgent(),
);
