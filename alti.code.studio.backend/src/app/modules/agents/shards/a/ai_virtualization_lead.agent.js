...
class AIVirtualizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateAIVirtualizationSystem(objective) {
    logger.info(
      `💻 [AIVirtualizationLeadAgent] Analyzing AI Virtualization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Virtualization Lead Target',
      );
...
export const aIVirtualizationLeadAgent = Object.freeze(
  new AIVirtualizationLeadAgent(),
);
