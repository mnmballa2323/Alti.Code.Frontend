...
class AIDataWarehouseDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIDataWarehouseSystem(objective) {
    logger.info(
      `💻 [AIDataWarehouseDesignerAgent] Analyzing AI DataWarehouse Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI DataWarehouse Designer Target',
      );
...
export const aIDataWarehouseDesignerAgent = Object.freeze(
  new AIDataWarehouseDesignerAgent(),
);
