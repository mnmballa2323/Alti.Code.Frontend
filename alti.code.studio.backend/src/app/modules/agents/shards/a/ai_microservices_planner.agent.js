...
class AIMicroservicesPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateAIMicroservicesSystem(objective) {
        logger.info(`💻 [AIMicroservicesPlannerAgent] Analyzing AI Microservices Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Microservices Planner Target");
...
export const aIMicroservicesPlannerAgent = Object.freeze(new AIMicroservicesPlannerAgent());
