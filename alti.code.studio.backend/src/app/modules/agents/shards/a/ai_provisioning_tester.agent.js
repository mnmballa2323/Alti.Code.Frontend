...
class AIProvisioningTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateAIProvisioningSystem(objective) {
    logger.info(
      `💻 [AIProvisioningTesterAgent] Analyzing AI Provisioning Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Provisioning Tester Target',
      );
...
export const aIProvisioningTesterAgent = Object.freeze(
  new AIProvisioningTesterAgent(),
);
