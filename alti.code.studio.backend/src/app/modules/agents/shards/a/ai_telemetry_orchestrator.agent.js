...
class AITelemetryOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateAITelemetrySystem(objective) {
    logger.info(
      `💻 [AITelemetryOrchestratorAgent] Analyzing AI Telemetry Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Telemetry Orchestrator Target',
      );
...
export const aITelemetryOrchestratorAgent = Object.freeze(
  new AITelemetryOrchestratorAgent(),
);
