...
class AIServerlessEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIServerlessSystem(objective) {
    logger.info(
      `💻 [AIServerlessEngineerAgent] Analyzing AI Serverless Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Serverless Engineer Target',
      );
...
export const aIServerlessEngineerAgent = Object.freeze(
  new AIServerlessEngineerAgent(),
);
