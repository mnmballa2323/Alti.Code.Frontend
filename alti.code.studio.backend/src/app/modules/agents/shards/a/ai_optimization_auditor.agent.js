...
class AIOptimizationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIOptimizationSystem(objective) {
    logger.info(
      `💻 [AIOptimizationAuditorAgent] Analyzing AI Optimization Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Optimization Auditor Target',
      );
...
export const aIOptimizationAuditorAgent = Object.freeze(
  new AIOptimizationAuditorAgent(),
);
