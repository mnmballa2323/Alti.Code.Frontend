...
class AIStreamingAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateAIStreamingSystem(objective) {
    logger.info(
      `💻 [AIStreamingAnalystAgent] Analyzing AI Streaming Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Streaming Analyst Target',
      );
...
export const aIStreamingAnalystAgent = Object.freeze(
  new AIStreamingAnalystAgent(),
);
