...
class AnsibleYAMLSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateAnsibleYAMLSystem(objective) {
    logger.info(
      `💻 [AnsibleYAMLSpecialistAgent] Analyzing Ansible (YAML) requirements...`,
    );
...
export const AnsibleYAMLSpecialistAgentInstance = Object.freeze(
  new AnsibleYAMLSpecialistAgent(),
);
