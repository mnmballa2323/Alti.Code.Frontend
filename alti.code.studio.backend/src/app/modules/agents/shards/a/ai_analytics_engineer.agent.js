...
class AIAnalyticsEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIAnalyticsSystem(objective) {
    logger.info(
      `💻 [AIAnalyticsEngineerAgent] Analyzing AI Analytics Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Analytics Engineer Target',
      );
...
export const aIAnalyticsEngineerAgent = Object.freeze(
  new AIAnalyticsEngineerAgent(),
);
