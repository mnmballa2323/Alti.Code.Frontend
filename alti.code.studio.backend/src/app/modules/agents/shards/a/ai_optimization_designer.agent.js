...
class AIOptimizationDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateAIOptimizationSystem(objective) {
        logger.info(`💻 [AIOptimizationDesignerAgent] Analyzing AI Optimization Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Optimization Designer Target");
...
export const aIOptimizationDesignerAgent = Object.freeze(new AIOptimizationDesignerAgent());
