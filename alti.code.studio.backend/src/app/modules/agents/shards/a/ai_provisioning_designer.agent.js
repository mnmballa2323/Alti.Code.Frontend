...
class AIProvisioningDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIProvisioningSystem(objective) {
    logger.info(
      `💻 [AIProvisioningDesignerAgent] Analyzing AI Provisioning Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Provisioning Designer Target',
      );
...
export const aIProvisioningDesignerAgent = Object.freeze(
  new AIProvisioningDesignerAgent(),
);
