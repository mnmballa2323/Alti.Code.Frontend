...
class AIServerlessDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateAIServerlessSystem(objective) {
    logger.info(
      `💻 [AIServerlessDeveloperAgent] Analyzing AI Serverless Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Serverless Developer Target',
      );
...
export const aIServerlessDeveloperAgent = Object.freeze(
  new AIServerlessDeveloperAgent(),
);
