...
class AIEngineeringAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateAIEngineeringSystem(objective) {
        logger.info(`💻 [AIEngineeringAuditorAgent] Analyzing AI Engineering Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Engineering Auditor Target");
...
export const aIEngineeringAuditorAgent = Object.freeze(new AIEngineeringAuditorAgent());
