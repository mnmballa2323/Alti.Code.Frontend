...
class AITelemetryTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateAITelemetrySystem(objective) {
    logger.info(
      `💻 [AITelemetryTesterAgent] Analyzing AI Telemetry Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Telemetry Tester Target',
      );
...
export const aITelemetryTesterAgent = Object.freeze(
  new AITelemetryTesterAgent(),
);
