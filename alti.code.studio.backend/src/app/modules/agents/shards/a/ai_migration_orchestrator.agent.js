...
class AIMigrationOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIMigrationSystem(objective) {
    logger.info(
      `💻 [AIMigrationOrchestratorAgent] Analyzing AI Migration Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Migration Orchestrator Target',
      );
...
export const aIMigrationOrchestratorAgent = Object.freeze(
  new AIMigrationOrchestratorAgent(),
);
