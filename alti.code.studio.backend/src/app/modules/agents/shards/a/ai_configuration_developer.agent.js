...
class AIConfigurationDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateAIConfigurationSystem(objective) {
    logger.info(
      `💻 [AIConfigurationDeveloperAgent] Analyzing AI Configuration Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Configuration Developer Target',
      );
...
export const aIConfigurationDeveloperAgent = Object.freeze(
  new AIConfigurationDeveloperAgent(),
);
