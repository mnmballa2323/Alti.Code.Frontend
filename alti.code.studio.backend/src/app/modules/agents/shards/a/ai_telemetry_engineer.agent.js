...
class AITelemetryEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateAITelemetrySystem(objective) {
    logger.info(
      `💻 [AITelemetryEngineerAgent] Analyzing AI Telemetry Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Telemetry Engineer Target',
      );
...
export const aITelemetryEngineerAgent = Object.freeze(
  new AITelemetryEngineerAgent(),
);
