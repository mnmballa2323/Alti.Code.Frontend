...
class AIFaultToleranceAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIFaultToleranceSystem(objective) {
    logger.info(
      `💻 [AIFaultToleranceAuditorAgent] Analyzing AI FaultTolerance Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI FaultTolerance Auditor Target',
      );
...
export const aIFaultToleranceAuditorAgent = Object.freeze(
  new AIFaultToleranceAuditorAgent(),
);
