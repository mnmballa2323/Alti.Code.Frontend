...
class AIConfigurationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateAIConfigurationSystem(objective) {
    logger.info(
      `💻 [AIConfigurationTesterAgent] Analyzing AI Configuration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Configuration Tester Target',
      );
...
export const aIConfigurationTesterAgent = Object.freeze(
  new AIConfigurationTesterAgent(),
);
