...
class AIBatchProcessingPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIBatchProcessingSystem(objective) {
    logger.info(
      `💻 [AIBatchProcessingPlannerAgent] Analyzing AI BatchProcessing Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI BatchProcessing Planner Target',
      );
...
export const aIBatchProcessingPlannerAgent = Object.freeze(
  new AIBatchProcessingPlannerAgent(),
);
