...
class AIFaultToleranceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateAIFaultToleranceSystem(objective) {
    logger.info(
      `💻 [AIFaultToleranceTesterAgent] Analyzing AI FaultTolerance Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI FaultTolerance Tester Target',
      );
...
export const aIFaultToleranceTesterAgent = Object.freeze(
  new AIFaultToleranceTesterAgent(),
);
