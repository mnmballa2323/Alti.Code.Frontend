...
class AIStreamingConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateAIStreamingSystem(objective) {
    logger.info(
      `💻 [AIStreamingConsultantAgent] Analyzing AI Streaming Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Streaming Consultant Target',
      );
...
export const aIStreamingConsultantAgent = Object.freeze(
  new AIStreamingConsultantAgent(),
);
