...
class AILoadBalancingAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateAILoadBalancingSystem(objective) {
        logger.info(`💻 [AILoadBalancingAuditorAgent] Analyzing AI LoadBalancing Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI LoadBalancing Auditor Target");
...
export const aILoadBalancingAuditorAgent = Object.freeze(new AILoadBalancingAuditorAgent());
