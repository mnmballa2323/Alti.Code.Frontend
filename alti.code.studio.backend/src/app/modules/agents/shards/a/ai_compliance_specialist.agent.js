...
class AIComplianceSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateAIComplianceSystem(objective) {
    logger.info(
      `💻 [AIComplianceSpecialistAgent] Analyzing AI Compliance Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Compliance Specialist Target',
      );
...
export const aIComplianceSpecialistAgent = Object.freeze(
  new AIComplianceSpecialistAgent(),
);
