...
class AIObservabilityLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateAIObservabilitySystem(objective) {
        logger.info(`💻 [AIObservabilityLeadAgent] Analyzing AI Observability Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Observability Lead Target");
...
export const aIObservabilityLeadAgent = Object.freeze(new AIObservabilityLeadAgent());
