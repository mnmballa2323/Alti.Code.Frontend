...
class AISecuritySpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateAISecuritySystem(objective) {
        logger.info(`💻 [AISecuritySpecialistAgent] Analyzing AI Security Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Security Specialist Target");
...
export const aISecuritySpecialistAgent = Object.freeze(new AISecuritySpecialistAgent());
