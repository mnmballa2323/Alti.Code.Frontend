...
class AIArchitectureConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateAIArchitectureSystem(objective) {
    logger.info(
      `💻 [AIArchitectureConsultantAgent] Analyzing AI Architecture Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Architecture Consultant Target',
      );
...
export const aIArchitectureConsultantAgent = Object.freeze(
  new AIArchitectureConsultantAgent(),
);
