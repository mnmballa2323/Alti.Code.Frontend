...
class AIIntegrationSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateAIIntegrationSystem(objective) {
    logger.info(
      `💻 [AIIntegrationSpecialistAgent] Analyzing AI Integration Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Integration Specialist Target',
      );
...
export const aIIntegrationSpecialistAgent = Object.freeze(
  new AIIntegrationSpecialistAgent(),
);
