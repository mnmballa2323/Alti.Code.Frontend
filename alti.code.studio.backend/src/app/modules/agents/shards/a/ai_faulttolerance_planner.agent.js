...
class AIFaultTolerancePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIFaultToleranceSystem(objective) {
    logger.info(
      `💻 [AIFaultTolerancePlannerAgent] Analyzing AI FaultTolerance Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI FaultTolerance Planner Target',
      );
...
export const aIFaultTolerancePlannerAgent = Object.freeze(
  new AIFaultTolerancePlannerAgent(),
);
