...
class AISecurityPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateAISecuritySystem(objective) {
        logger.info(`💻 [AISecurityPlannerAgent] Analyzing AI Security Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Security Planner Target");
...
export const aISecurityPlannerAgent = Object.freeze(new AISecurityPlannerAgent());
