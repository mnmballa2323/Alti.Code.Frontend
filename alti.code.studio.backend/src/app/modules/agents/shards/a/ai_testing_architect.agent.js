...
class AITestingArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateAITestingSystem(objective) {
    logger.info(
      `💻 [AITestingArchitectAgent] Analyzing AI Testing Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Testing Architect Target',
      );
...
export const aITestingArchitectAgent = Object.freeze(
  new AITestingArchitectAgent(),
);
