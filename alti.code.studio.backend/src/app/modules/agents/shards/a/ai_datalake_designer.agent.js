...
class AIDataLakeDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIDataLakeSystem(objective) {
    logger.info(
      `💻 [AIDataLakeDesignerAgent] Analyzing AI DataLake Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI DataLake Designer Target',
      );
...
export const aIDataLakeDesignerAgent = Object.freeze(
  new AIDataLakeDesignerAgent(),
);
