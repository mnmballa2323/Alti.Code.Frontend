...
class AIOptimizationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIOptimizationSystem(objective) {
    logger.info(
      `💻 [AIOptimizationManagerAgent] Analyzing AI Optimization Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Optimization Manager Target',
      );
...
export const aIOptimizationManagerAgent = Object.freeze(
  new AIOptimizationManagerAgent(),
);
