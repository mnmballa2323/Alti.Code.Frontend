...
class AIVirtualizationEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIVirtualizationSystem(objective) {
    logger.info(
      `💻 [AIVirtualizationEngineerAgent] Analyzing AI Virtualization Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Virtualization Engineer Target',
      );
...
export const aIVirtualizationEngineerAgent = Object.freeze(
  new AIVirtualizationEngineerAgent(),
);
