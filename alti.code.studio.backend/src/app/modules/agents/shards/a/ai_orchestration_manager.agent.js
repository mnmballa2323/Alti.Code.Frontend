...
class AIOrchestrationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIOrchestrationSystem(objective) {
    logger.info(
      `💻 [AIOrchestrationManagerAgent] Analyzing AI Orchestration Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Orchestration Manager Target',
      );
...
export const aIOrchestrationManagerAgent = Object.freeze(
  new AIOrchestrationManagerAgent(),
);
