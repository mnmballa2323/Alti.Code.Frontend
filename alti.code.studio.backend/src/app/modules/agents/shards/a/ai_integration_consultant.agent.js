...
class AIIntegrationConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateAIIntegrationSystem(objective) {
        logger.info(`💻 [AIIntegrationConsultantAgent] Analyzing AI Integration Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Integration Consultant Target");
...
export const aIIntegrationConsultantAgent = Object.freeze(new AIIntegrationConsultantAgent());
