...
class AIServerlessPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIServerlessSystem(objective) {
    logger.info(
      `💻 [AIServerlessPlannerAgent] Analyzing AI Serverless Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Serverless Planner Target',
      );
...
export const aIServerlessPlannerAgent = Object.freeze(
  new AIServerlessPlannerAgent(),
);
