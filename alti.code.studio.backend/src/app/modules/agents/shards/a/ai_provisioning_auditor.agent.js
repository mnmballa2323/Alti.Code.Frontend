...
class AIProvisioningAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIProvisioningSystem(objective) {
    logger.info(
      `💻 [AIProvisioningAuditorAgent] Analyzing AI Provisioning Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Provisioning Auditor Target',
      );
...
export const aIProvisioningAuditorAgent = Object.freeze(
  new AIProvisioningAuditorAgent(),
);
