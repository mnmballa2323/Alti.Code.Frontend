...
class AITestingDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateAITestingSystem(objective) {
        logger.info(`💻 [AITestingDirectorAgent] Analyzing AI Testing Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Testing Director Target");
...
export const aITestingDirectorAgent = Object.freeze(new AITestingDirectorAgent());
