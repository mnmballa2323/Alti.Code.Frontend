...
class AIResilienceConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateAIResilienceSystem(objective) {
        logger.info(`💻 [AIResilienceConsultantAgent] Analyzing AI Resilience Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Resilience Consultant Target");
...
export const aIResilienceConsultantAgent = Object.freeze(new AIResilienceConsultantAgent());
