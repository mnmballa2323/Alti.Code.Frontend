...
class AIEngineeringDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIEngineeringSystem(objective) {
    logger.info(
      `💻 [AIEngineeringDirectorAgent] Analyzing AI Engineering Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Engineering Director Target',
      );
...
export const aIEngineeringDirectorAgent = Object.freeze(
  new AIEngineeringDirectorAgent(),
);
