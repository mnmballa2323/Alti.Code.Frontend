...
class AIConfigurationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateAIConfigurationSystem(objective) {
    logger.info(
      `💻 [AIConfigurationLeadAgent] Analyzing AI Configuration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Configuration Lead Target',
      );
...
export const aIConfigurationLeadAgent = Object.freeze(
  new AIConfigurationLeadAgent(),
);
