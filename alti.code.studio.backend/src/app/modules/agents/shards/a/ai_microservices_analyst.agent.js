...
class AIMicroservicesAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateAIMicroservicesSystem(objective) {
    logger.info(
      `💻 [AIMicroservicesAnalystAgent] Analyzing AI Microservices Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Microservices Analyst Target',
      );
...
export const aIMicroservicesAnalystAgent = Object.freeze(
  new AIMicroservicesAnalystAgent(),
);
