...
class AIComplianceManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIComplianceSystem(objective) {
    logger.info(
      `💻 [AIComplianceManagerAgent] Analyzing AI Compliance Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Compliance Manager Target',
      );
...
export const aIComplianceManagerAgent = Object.freeze(
  new AIComplianceManagerAgent(),
);
