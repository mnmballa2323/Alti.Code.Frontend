...
class AIResilienceOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIResilienceSystem(objective) {
    logger.info(
      `💻 [AIResilienceOrchestratorAgent] Analyzing AI Resilience Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Resilience Orchestrator Target',
      );
...
export const aIResilienceOrchestratorAgent = Object.freeze(
  new AIResilienceOrchestratorAgent(),
);
