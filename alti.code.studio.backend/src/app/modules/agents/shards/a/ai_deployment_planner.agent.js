...
class AIDeploymentPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIDeploymentSystem(objective) {
    logger.info(
      `💻 [AIDeploymentPlannerAgent] Analyzing AI Deployment Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Deployment Planner Target',
      );
...
export const aIDeploymentPlannerAgent = Object.freeze(
  new AIDeploymentPlannerAgent(),
);
