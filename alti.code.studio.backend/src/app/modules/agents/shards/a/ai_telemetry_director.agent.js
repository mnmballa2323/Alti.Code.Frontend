...
class AITelemetryDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateAITelemetrySystem(objective) {
        logger.info(`💻 [AITelemetryDirectorAgent] Analyzing AI Telemetry Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Telemetry Director Target");
...
export const aITelemetryDirectorAgent = Object.freeze(new AITelemetryDirectorAgent());
