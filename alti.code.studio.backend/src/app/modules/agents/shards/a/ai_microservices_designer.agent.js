...
class AIMicroservicesDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIMicroservicesSystem(objective) {
    logger.info(
      `💻 [AIMicroservicesDesignerAgent] Analyzing AI Microservices Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Microservices Designer Target',
      );
...
export const aIMicroservicesDesignerAgent = Object.freeze(
  new AIMicroservicesDesignerAgent(),
);
