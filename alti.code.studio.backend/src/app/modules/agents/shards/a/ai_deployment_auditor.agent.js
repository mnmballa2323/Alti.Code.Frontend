...
class AIDeploymentAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIDeploymentSystem(objective) {
    logger.info(
      `💻 [AIDeploymentAuditorAgent] Analyzing AI Deployment Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Deployment Auditor Target',
      );
...
export const aIDeploymentAuditorAgent = Object.freeze(
  new AIDeploymentAuditorAgent(),
);
