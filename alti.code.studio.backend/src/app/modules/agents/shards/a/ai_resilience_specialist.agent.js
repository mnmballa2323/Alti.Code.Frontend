...
class AIResilienceSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateAIResilienceSystem(objective) {
    logger.info(
      `💻 [AIResilienceSpecialistAgent] Analyzing AI Resilience Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Resilience Specialist Target',
      );
...
export const aIResilienceSpecialistAgent = Object.freeze(
  new AIResilienceSpecialistAgent(),
);
