...
class AIObservabilityTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateAIObservabilitySystem(objective) {
    logger.info(
      `💻 [AIObservabilityTesterAgent] Analyzing AI Observability Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Observability Tester Target',
      );
...
export const aIObservabilityTesterAgent = Object.freeze(
  new AIObservabilityTesterAgent(),
);
