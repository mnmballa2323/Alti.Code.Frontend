...
class AIProvisioningLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateAIProvisioningSystem(objective) {
    logger.info(
      `💻 [AIProvisioningLeadAgent] Analyzing AI Provisioning Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Provisioning Lead Target',
      );
...
export const aIProvisioningLeadAgent = Object.freeze(
  new AIProvisioningLeadAgent(),
);
