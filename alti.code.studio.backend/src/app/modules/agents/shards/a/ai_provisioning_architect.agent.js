...
class AIProvisioningArchitectAgent extends GeminiCliBaseAgent {
    ...
    async generateAIProvisioningSystem(objective) {
        logger.info(`💻 [AIProvisioningArchitectAgent] Analyzing AI Provisioning Architect specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Provisioning Architect Target");
...
export const aIProvisioningArchitectAgent = Object.freeze(new AIProvisioningArchitectAgent());
