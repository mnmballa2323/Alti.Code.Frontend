...
class AISecurityManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateAISecuritySystem(objective) {
        logger.info(`💻 [AISecurityManagerAgent] Analyzing AI Security Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Security Manager Target");
...
export const aISecurityManagerAgent = Object.freeze(new AISecurityManagerAgent());
