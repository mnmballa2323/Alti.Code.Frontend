...
class AILoadBalancingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateAILoadBalancingSystem(objective) {
    logger.info(
      `💻 [AILoadBalancingLeadAgent] Analyzing AI LoadBalancing Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI LoadBalancing Lead Target',
      );
...
export const aILoadBalancingLeadAgent = Object.freeze(
  new AILoadBalancingLeadAgent(),
);
