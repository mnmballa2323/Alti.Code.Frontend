...
class AIResilienceAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIResilienceSystem(objective) {
    logger.info(
      `💻 [AIResilienceAuditorAgent] Analyzing AI Resilience Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Resilience Auditor Target',
      );
...
export const aIResilienceAuditorAgent = Object.freeze(
  new AIResilienceAuditorAgent(),
);
