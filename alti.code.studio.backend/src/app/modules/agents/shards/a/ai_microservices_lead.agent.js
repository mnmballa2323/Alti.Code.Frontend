...
class AIMicroservicesLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateAIMicroservicesSystem(objective) {
    logger.info(
      `💻 [AIMicroservicesLeadAgent] Analyzing AI Microservices Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Microservices Lead Target',
      );
...
export const aIMicroservicesLeadAgent = Object.freeze(
  new AIMicroservicesLeadAgent(),
);
