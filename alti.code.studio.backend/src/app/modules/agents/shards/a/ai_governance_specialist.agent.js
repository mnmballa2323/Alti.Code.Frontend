...
class AIGovernanceSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateAIGovernanceSystem(objective) {
    logger.info(
      `💻 [AIGovernanceSpecialistAgent] Analyzing AI Governance Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Governance Specialist Target',
      );
...
export const aIGovernanceSpecialistAgent = Object.freeze(
  new AIGovernanceSpecialistAgent(),
);
