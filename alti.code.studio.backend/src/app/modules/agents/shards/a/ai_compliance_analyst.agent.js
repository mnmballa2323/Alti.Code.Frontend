...
class AIComplianceAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateAIComplianceSystem(objective) {
        logger.info(`💻 [AIComplianceAnalystAgent] Analyzing AI Compliance Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Compliance Analyst Target");
...
export const aIComplianceAnalystAgent = Object.freeze(new AIComplianceAnalystAgent());
