...
class AIIntegrationTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateAIIntegrationSystem(objective) {
        logger.info(`💻 [AIIntegrationTesterAgent] Analyzing AI Integration Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Integration Tester Target");
...
export const aIIntegrationTesterAgent = Object.freeze(new AIIntegrationTesterAgent());
