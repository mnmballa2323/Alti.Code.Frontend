...
class AIResilienceAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateAIResilienceSystem(objective) {
    logger.info(
      `💻 [AIResilienceAnalystAgent] Analyzing AI Resilience Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Resilience Analyst Target',
      );
...
export const aIResilienceAnalystAgent = Object.freeze(
  new AIResilienceAnalystAgent(),
);
