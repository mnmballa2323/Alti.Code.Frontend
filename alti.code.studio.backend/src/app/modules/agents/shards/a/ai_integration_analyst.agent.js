...
class AIIntegrationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateAIIntegrationSystem(objective) {
    logger.info(
      `💻 [AIIntegrationAnalystAgent] Analyzing AI Integration Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Integration Analyst Target',
      );
...
export const aIIntegrationAnalystAgent = Object.freeze(
  new AIIntegrationAnalystAgent(),
);
