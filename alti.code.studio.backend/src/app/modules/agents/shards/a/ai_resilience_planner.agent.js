...
class AIResiliencePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateAIResilienceSystem(objective) {
        logger.info(`💻 [AIResiliencePlannerAgent] Analyzing AI Resilience Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Resilience Planner Target");
...
export const aIResiliencePlannerAgent = Object.freeze(new AIResiliencePlannerAgent());
