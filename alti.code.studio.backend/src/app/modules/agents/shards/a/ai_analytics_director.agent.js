...
class AIAnalyticsDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIAnalyticsSystem(objective) {
    logger.info(
      `💻 [AIAnalyticsDirectorAgent] Analyzing AI Analytics Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Analytics Director Target',
      );
...
export const aIAnalyticsDirectorAgent = Object.freeze(
  new AIAnalyticsDirectorAgent(),
);
