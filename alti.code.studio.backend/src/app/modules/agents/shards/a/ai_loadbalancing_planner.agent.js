...
class AILoadBalancingPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateAILoadBalancingSystem(objective) {
        logger.info(`💻 [AILoadBalancingPlannerAgent] Analyzing AI LoadBalancing Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI LoadBalancing Planner Target");
...
export const aILoadBalancingPlannerAgent = Object.freeze(new AILoadBalancingPlannerAgent());
