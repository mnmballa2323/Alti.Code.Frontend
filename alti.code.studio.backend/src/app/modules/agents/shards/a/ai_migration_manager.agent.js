...
class AIMigrationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIMigrationSystem(objective) {
    logger.info(
      `💻 [AIMigrationManagerAgent] Analyzing AI Migration Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Migration Manager Target',
      );
...
export const aIMigrationManagerAgent = Object.freeze(
  new AIMigrationManagerAgent(),
);
