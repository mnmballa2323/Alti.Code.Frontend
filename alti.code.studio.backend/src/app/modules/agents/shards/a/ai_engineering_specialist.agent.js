...
class AIEngineeringSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateAIEngineeringSystem(objective) {
    logger.info(
      `💻 [AIEngineeringSpecialistAgent] Analyzing AI Engineering Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Engineering Specialist Target',
      );
...
export const aIEngineeringSpecialistAgent = Object.freeze(
  new AIEngineeringSpecialistAgent(),
);
