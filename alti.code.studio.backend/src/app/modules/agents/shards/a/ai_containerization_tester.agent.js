...
class AIContainerizationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateAIContainerizationSystem(objective) {
    logger.info(
      `💻 [AIContainerizationTesterAgent] Analyzing AI Containerization Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Containerization Tester Target',
      );
...
export const aIContainerizationTesterAgent = Object.freeze(
  new AIContainerizationTesterAgent(),
);
