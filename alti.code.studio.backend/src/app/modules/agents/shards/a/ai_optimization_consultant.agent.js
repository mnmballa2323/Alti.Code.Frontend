...
class AIOptimizationConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateAIOptimizationSystem(objective) {
        logger.info(`💻 [AIOptimizationConsultantAgent] Analyzing AI Optimization Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Optimization Consultant Target");
...
export const aIOptimizationConsultantAgent = Object.freeze(new AIOptimizationConsultantAgent());
