...
class AIMigrationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIMigrationSystem(objective) {
    logger.info(
      `💻 [AIMigrationPlannerAgent] Analyzing AI Migration Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Migration Planner Target',
      );
...
export const aIMigrationPlannerAgent = Object.freeze(
  new AIMigrationPlannerAgent(),
);
