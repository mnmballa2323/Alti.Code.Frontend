...
class AIVirtualizationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIVirtualizationSystem(objective) {
    logger.info(
      `💻 [AIVirtualizationPlannerAgent] Analyzing AI Virtualization Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Virtualization Planner Target',
      );
...
export const aIVirtualizationPlannerAgent = Object.freeze(
  new AIVirtualizationPlannerAgent(),
);
