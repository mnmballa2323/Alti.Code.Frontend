...
class AIObservabilityEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateAIObservabilitySystem(objective) {
        logger.info(`💻 [AIObservabilityEngineerAgent] Analyzing AI Observability Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Observability Engineer Target");
...
export const aIObservabilityEngineerAgent = Object.freeze(new AIObservabilityEngineerAgent());
