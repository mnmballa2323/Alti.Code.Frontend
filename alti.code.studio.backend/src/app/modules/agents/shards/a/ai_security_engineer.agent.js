...
class AISecurityEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateAISecuritySystem(objective) {
    logger.info(
      `💻 [AISecurityEngineerAgent] Analyzing AI Security Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Security Engineer Target',
      );
...
export const aISecurityEngineerAgent = Object.freeze(
  new AISecurityEngineerAgent(),
);
