...
class AIOrchestrationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateAIOrchestrationSystem(objective) {
    logger.info(
      `💻 [AIOrchestrationAnalystAgent] Analyzing AI Orchestration Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Orchestration Analyst Target',
      );
...
export const aIOrchestrationAnalystAgent = Object.freeze(
  new AIOrchestrationAnalystAgent(),
);
