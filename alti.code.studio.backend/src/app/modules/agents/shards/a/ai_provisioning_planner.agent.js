...
class AIProvisioningPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIProvisioningSystem(objective) {
    logger.info(
      `💻 [AIProvisioningPlannerAgent] Analyzing AI Provisioning Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Provisioning Planner Target',
      );
...
export const aIProvisioningPlannerAgent = Object.freeze(
  new AIProvisioningPlannerAgent(),
);
