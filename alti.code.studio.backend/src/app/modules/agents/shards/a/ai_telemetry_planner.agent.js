...
class AITelemetryPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateAITelemetrySystem(objective) {
    logger.info(
      `💻 [AITelemetryPlannerAgent] Analyzing AI Telemetry Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Telemetry Planner Target',
      );
...
export const aITelemetryPlannerAgent = Object.freeze(
  new AITelemetryPlannerAgent(),
);
