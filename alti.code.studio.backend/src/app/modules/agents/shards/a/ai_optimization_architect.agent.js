...
class AIOptimizationArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateAIOptimizationSystem(objective) {
    logger.info(
      `💻 [AIOptimizationArchitectAgent] Analyzing AI Optimization Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Optimization Architect Target',
      );
...
export const aIOptimizationArchitectAgent = Object.freeze(
  new AIOptimizationArchitectAgent(),
);
