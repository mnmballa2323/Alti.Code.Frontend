...
class AIResilienceDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateAIResilienceSystem(objective) {
        logger.info(`💻 [AIResilienceDirectorAgent] Analyzing AI Resilience Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Resilience Director Target");
...
export const aIResilienceDirectorAgent = Object.freeze(new AIResilienceDirectorAgent());
