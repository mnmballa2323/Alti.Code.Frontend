...
class ApiDesignAgent extends BaseSpecialistAgent {
    constructor() {
        ...
        this.description = 'Architecture specialist enforcing OpenAPI/GraphQL schemas and contract-first API development.';
...
export const apiDesignAgent = Object.freeze(new ApiDesignAgent());
