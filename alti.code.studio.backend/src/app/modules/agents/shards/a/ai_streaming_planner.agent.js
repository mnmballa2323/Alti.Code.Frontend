...
class AIStreamingPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIStreamingSystem(objective) {
    logger.info(
      `💻 [AIStreamingPlannerAgent] Analyzing AI Streaming Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Streaming Planner Target',
      );
...
export const aIStreamingPlannerAgent = Object.freeze(
  new AIStreamingPlannerAgent(),
);
