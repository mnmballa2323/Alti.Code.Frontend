...
class AIMicroservicesManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIMicroservicesSystem(objective) {
    logger.info(
      `💻 [AIMicroservicesManagerAgent] Analyzing AI Microservices Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Microservices Manager Target',
      );
...
export const aIMicroservicesManagerAgent = Object.freeze(
  new AIMicroservicesManagerAgent(),
);
