...
class AIVirtualizationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateAIVirtualizationSystem(objective) {
    logger.info(
      `💻 [AIVirtualizationAnalystAgent] Analyzing AI Virtualization Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Virtualization Analyst Target',
      );
...
export const aIVirtualizationAnalystAgent = Object.freeze(
  new AIVirtualizationAnalystAgent(),
);
