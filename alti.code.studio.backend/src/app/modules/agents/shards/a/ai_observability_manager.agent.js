...
class AIObservabilityManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIObservabilitySystem(objective) {
    logger.info(
      `💻 [AIObservabilityManagerAgent] Analyzing AI Observability Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Observability Manager Target',
      );
...
export const aIObservabilityManagerAgent = Object.freeze(
  new AIObservabilityManagerAgent(),
);
