...
class ActionScriptSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateActionScriptSystem(objective) {
    logger.info(
      `💻 [ActionScriptSpecialistAgent] Analyzing ActionScript requirements...`,
    );
...
export const ActionScriptSpecialistAgentInstance = Object.freeze(
  new ActionScriptSpecialistAgent(),
);
