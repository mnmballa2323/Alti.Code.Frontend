...
class AIDataLakeSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateAIDataLakeSystem(objective) {
    logger.info(
      `💻 [AIDataLakeSpecialistAgent] Analyzing AI DataLake Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI DataLake Specialist Target',
      );
...
export const aIDataLakeSpecialistAgent = Object.freeze(
  new AIDataLakeSpecialistAgent(),
);
