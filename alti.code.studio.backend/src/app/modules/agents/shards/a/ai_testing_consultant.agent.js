...
class AITestingConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateAITestingSystem(objective) {
    logger.info(
      `💻 [AITestingConsultantAgent] Analyzing AI Testing Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Testing Consultant Target',
      );
...
export const aITestingConsultantAgent = Object.freeze(
  new AITestingConsultantAgent(),
);
