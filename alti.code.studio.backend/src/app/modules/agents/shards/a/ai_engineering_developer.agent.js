...
class AIEngineeringDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateAIEngineeringSystem(objective) {
        logger.info(`💻 [AIEngineeringDeveloperAgent] Analyzing AI Engineering Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Engineering Developer Target");
...
export const aIEngineeringDeveloperAgent = Object.freeze(new AIEngineeringDeveloperAgent());
