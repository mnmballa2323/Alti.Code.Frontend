...
class AIStreamingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIStreamingSystem(objective) {
    logger.info(
      `💻 [AIStreamingManagerAgent] Analyzing AI Streaming Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Streaming Manager Target',
      );
...
export const aIStreamingManagerAgent = Object.freeze(
  new AIStreamingManagerAgent(),
);
