...
class AILoadBalancingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateAILoadBalancingSystem(objective) {
    logger.info(
      `💻 [AILoadBalancingDesignerAgent] Analyzing AI LoadBalancing Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI LoadBalancing Designer Target',
      );
...
export const aILoadBalancingDesignerAgent = Object.freeze(
  new AILoadBalancingDesignerAgent(),
);
