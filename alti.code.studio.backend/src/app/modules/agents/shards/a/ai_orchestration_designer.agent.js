...
class AIOrchestrationDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIOrchestrationSystem(objective) {
    logger.info(
      `💻 [AIOrchestrationDesignerAgent] Analyzing AI Orchestration Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Orchestration Designer Target',
      );
...
export const aIOrchestrationDesignerAgent = Object.freeze(
  new AIOrchestrationDesignerAgent(),
);
