...
class AIMicroservicesDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateAIMicroservicesSystem(objective) {
        logger.info(`💻 [AIMicroservicesDirectorAgent] Analyzing AI Microservices Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Microservices Director Target");
...
export const aIMicroservicesDirectorAgent = Object.freeze(new AIMicroservicesDirectorAgent());
