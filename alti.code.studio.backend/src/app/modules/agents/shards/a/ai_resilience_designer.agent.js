...
class AIResilienceDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIResilienceSystem(objective) {
    logger.info(
      `💻 [AIResilienceDesignerAgent] Analyzing AI Resilience Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Resilience Designer Target',
      );
...
export const aIResilienceDesignerAgent = Object.freeze(
  new AIResilienceDesignerAgent(),
);
