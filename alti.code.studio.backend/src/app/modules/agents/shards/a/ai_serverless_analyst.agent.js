...
class AIServerlessAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateAIServerlessSystem(objective) {
    logger.info(
      `💻 [AIServerlessAnalystAgent] Analyzing AI Serverless Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Serverless Analyst Target',
      );
...
export const aIServerlessAnalystAgent = Object.freeze(
  new AIServerlessAnalystAgent(),
);
