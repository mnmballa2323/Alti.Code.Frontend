...
class AITelemetrySpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateAITelemetrySystem(objective) {
        logger.info(`💻 [AITelemetrySpecialistAgent] Analyzing AI Telemetry Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Telemetry Specialist Target");
...
export const aITelemetrySpecialistAgent = Object.freeze(new AITelemetrySpecialistAgent());
