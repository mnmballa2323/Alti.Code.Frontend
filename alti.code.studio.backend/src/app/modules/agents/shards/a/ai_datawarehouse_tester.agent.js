...
class AIDataWarehouseTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateAIDataWarehouseSystem(objective) {
        logger.info(`💻 [AIDataWarehouseTesterAgent] Analyzing AI DataWarehouse Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI DataWarehouse Tester Target");
...
export const aIDataWarehouseTesterAgent = Object.freeze(new AIDataWarehouseTesterAgent());
