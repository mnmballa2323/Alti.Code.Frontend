...
class AIOrchestrationDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIOrchestrationSystem(objective) {
    logger.info(
      `💻 [AIOrchestrationDirectorAgent] Analyzing AI Orchestration Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Orchestration Director Target',
      );
...
export const aIOrchestrationDirectorAgent = Object.freeze(
  new AIOrchestrationDirectorAgent(),
);
