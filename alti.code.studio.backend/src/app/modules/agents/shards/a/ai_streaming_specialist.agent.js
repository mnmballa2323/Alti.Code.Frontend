...
class AIStreamingSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateAIStreamingSystem(objective) {
        logger.info(`💻 [AIStreamingSpecialistAgent] Analyzing AI Streaming Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Streaming Specialist Target");
...
export const aIStreamingSpecialistAgent = Object.freeze(new AIStreamingSpecialistAgent());
