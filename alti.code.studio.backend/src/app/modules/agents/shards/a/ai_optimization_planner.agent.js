...
class AIOptimizationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIOptimizationSystem(objective) {
    logger.info(
      `💻 [AIOptimizationPlannerAgent] Analyzing AI Optimization Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Optimization Planner Target',
      );
...
export const aIOptimizationPlannerAgent = Object.freeze(
  new AIOptimizationPlannerAgent(),
);
