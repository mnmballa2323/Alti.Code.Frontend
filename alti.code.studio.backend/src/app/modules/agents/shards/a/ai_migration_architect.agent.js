...
class AIMigrationArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateAIMigrationSystem(objective) {
    logger.info(
      `💻 [AIMigrationArchitectAgent] Analyzing AI Migration Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Migration Architect Target',
      );
...
export const aIMigrationArchitectAgent = Object.freeze(
  new AIMigrationArchitectAgent(),
);
