...
class AIDataWarehouseAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateAIDataWarehouseSystem(objective) {
    logger.info(
      `💻 [AIDataWarehouseAnalystAgent] Analyzing AI DataWarehouse Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI DataWarehouse Analyst Target',
      );
...
export const aIDataWarehouseAnalystAgent = Object.freeze(
  new AIDataWarehouseAnalystAgent(),
);
