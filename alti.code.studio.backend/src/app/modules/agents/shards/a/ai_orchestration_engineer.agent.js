...
class AIOrchestrationEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIOrchestrationSystem(objective) {
    logger.info(
      `💻 [AIOrchestrationEngineerAgent] Analyzing AI Orchestration Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Orchestration Engineer Target',
      );
...
export const aIOrchestrationEngineerAgent = Object.freeze(
  new AIOrchestrationEngineerAgent(),
);
