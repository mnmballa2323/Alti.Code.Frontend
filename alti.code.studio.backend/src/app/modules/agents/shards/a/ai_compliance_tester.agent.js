...
class AIComplianceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateAIComplianceSystem(objective) {
    logger.info(
      `💻 [AIComplianceTesterAgent] Analyzing AI Compliance Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Compliance Tester Target',
      );
...
export const aIComplianceTesterAgent = Object.freeze(
  new AIComplianceTesterAgent(),
);
