...
class AIOptimizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateAIOptimizationSystem(objective) {
    logger.info(
      `💻 [AIOptimizationLeadAgent] Analyzing AI Optimization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Optimization Lead Target',
      );
...
export const aIOptimizationLeadAgent = Object.freeze(
  new AIOptimizationLeadAgent(),
);
