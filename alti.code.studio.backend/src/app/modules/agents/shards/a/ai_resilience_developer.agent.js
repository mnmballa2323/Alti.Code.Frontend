...
class AIResilienceDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateAIResilienceSystem(objective) {
    logger.info(
      `💻 [AIResilienceDeveloperAgent] Analyzing AI Resilience Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Resilience Developer Target',
      );
...
export const aIResilienceDeveloperAgent = Object.freeze(
  new AIResilienceDeveloperAgent(),
);
