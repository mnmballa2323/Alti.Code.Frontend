...
class AIGovernanceDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateAIGovernanceSystem(objective) {
        logger.info(`💻 [AIGovernanceDeveloperAgent] Analyzing AI Governance Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Governance Developer Target");
...
export const aIGovernanceDeveloperAgent = Object.freeze(new AIGovernanceDeveloperAgent());
