...
class AxiomAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Log management specialist for Axiom: structured logging via REST API and SDK, APL query language, datasets, Next.js/Vercel integration (next-axiom), OpenTelemetry ingestion, and real-time log streaming.';
