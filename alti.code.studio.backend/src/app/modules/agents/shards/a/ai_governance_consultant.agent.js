...
class AIGovernanceConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateAIGovernanceSystem(objective) {
        logger.info(`💻 [AIGovernanceConsultantAgent] Analyzing AI Governance Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Governance Consultant Target");
...
export const aIGovernanceConsultantAgent = Object.freeze(new AIGovernanceConsultantAgent());
