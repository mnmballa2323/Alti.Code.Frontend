...
class AIDataLakeAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateAIDataLakeSystem(objective) {
    logger.info(
      `💻 [AIDataLakeAnalystAgent] Analyzing AI DataLake Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI DataLake Analyst Target',
      );
...
export const aIDataLakeAnalystAgent = Object.freeze(
  new AIDataLakeAnalystAgent(),
);
