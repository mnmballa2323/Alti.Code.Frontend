...
class AIIntegrationManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateAIIntegrationSystem(objective) {
        logger.info(`💻 [AIIntegrationManagerAgent] Analyzing AI Integration Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Integration Manager Target");
...
export const aIIntegrationManagerAgent = Object.freeze(new AIIntegrationManagerAgent());
