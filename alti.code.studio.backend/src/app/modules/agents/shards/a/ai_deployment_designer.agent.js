...
class AIDeploymentDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIDeploymentSystem(objective) {
    logger.info(
      `💻 [AIDeploymentDesignerAgent] Analyzing AI Deployment Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Deployment Designer Target',
      );
...
export const aIDeploymentDesignerAgent = Object.freeze(
  new AIDeploymentDesignerAgent(),
);
