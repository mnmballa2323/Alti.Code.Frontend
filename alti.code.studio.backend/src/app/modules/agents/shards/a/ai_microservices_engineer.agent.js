...
class AIMicroservicesEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIMicroservicesSystem(objective) {
    logger.info(
      `💻 [AIMicroservicesEngineerAgent] Analyzing AI Microservices Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Microservices Engineer Target',
      );
...
export const aIMicroservicesEngineerAgent = Object.freeze(
  new AIMicroservicesEngineerAgent(),
);
