...
class AIEngineeringConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateAIEngineeringSystem(objective) {
    logger.info(
      `💻 [AIEngineeringConsultantAgent] Analyzing AI Engineering Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Engineering Consultant Target',
      );
...
export const aIEngineeringConsultantAgent = Object.freeze(
  new AIEngineeringConsultantAgent(),
);
