...
class AIETLOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIETLSystem(objective) {
    logger.info(
      `💻 [AIETLOrchestratorAgent] Analyzing AI ETL Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI ETL Orchestrator Target',
      );
...
export const aIETLOrchestratorAgent = Object.freeze(
  new AIETLOrchestratorAgent(),
);
