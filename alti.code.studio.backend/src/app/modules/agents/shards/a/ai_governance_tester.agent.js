...
class AIGovernanceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateAIGovernanceSystem(objective) {
    logger.info(
      `💻 [AIGovernanceTesterAgent] Analyzing AI Governance Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Governance Tester Target',
      );
...
export const aIGovernanceTesterAgent = Object.freeze(
  new AIGovernanceTesterAgent(),
);
