...
class AIGovernanceDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIGovernanceSystem(objective) {
    logger.info(
      `💻 [AIGovernanceDesignerAgent] Analyzing AI Governance Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Governance Designer Target',
      );
...
export const aIGovernanceDesignerAgent = Object.freeze(
  new AIGovernanceDesignerAgent(),
);
