...
class AIOrchestrationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateAIOrchestrationSystem(objective) {
    logger.info(
      `💻 [AIOrchestrationTesterAgent] Analyzing AI Orchestration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Orchestration Tester Target',
      );
...
export const aIOrchestrationTesterAgent = Object.freeze(
  new AIOrchestrationTesterAgent(),
);
