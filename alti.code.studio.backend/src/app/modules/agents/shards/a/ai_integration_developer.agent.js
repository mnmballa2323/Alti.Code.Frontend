...
class AIIntegrationDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateAIIntegrationSystem(objective) {
    logger.info(
      `💻 [AIIntegrationDeveloperAgent] Analyzing AI Integration Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Integration Developer Target',
      );
...
export const aIIntegrationDeveloperAgent = Object.freeze(
  new AIIntegrationDeveloperAgent(),
);
