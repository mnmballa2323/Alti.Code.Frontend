...
class AITelemetryConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateAITelemetrySystem(objective) {
    logger.info(
      `💻 [AITelemetryConsultantAgent] Analyzing AI Telemetry Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Telemetry Consultant Target',
      );
...
export const aITelemetryConsultantAgent = Object.freeze(
  new AITelemetryConsultantAgent(),
);
