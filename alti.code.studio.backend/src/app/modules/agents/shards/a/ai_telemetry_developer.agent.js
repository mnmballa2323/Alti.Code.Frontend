...
class AITelemetryDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateAITelemetrySystem(objective) {
    logger.info(
      `💻 [AITelemetryDeveloperAgent] Analyzing AI Telemetry Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Telemetry Developer Target',
      );
...
export const aITelemetryDeveloperAgent = Object.freeze(
  new AITelemetryDeveloperAgent(),
);
