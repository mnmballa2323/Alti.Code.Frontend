...
class AIEngineeringManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateAIEngineeringSystem(objective) {
        logger.info(`💻 [AIEngineeringManagerAgent] Analyzing AI Engineering Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Engineering Manager Target");
...
export const aIEngineeringManagerAgent = Object.freeze(new AIEngineeringManagerAgent());
