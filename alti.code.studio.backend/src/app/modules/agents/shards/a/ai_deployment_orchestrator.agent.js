...
class AIDeploymentOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIDeploymentSystem(objective) {
    logger.info(
      `💻 [AIDeploymentOrchestratorAgent] Analyzing AI Deployment Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Deployment Orchestrator Target',
      );
...
export const aIDeploymentOrchestratorAgent = Object.freeze(
  new AIDeploymentOrchestratorAgent(),
);
