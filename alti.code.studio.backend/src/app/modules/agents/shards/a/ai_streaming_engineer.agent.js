...
class AIStreamingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIStreamingSystem(objective) {
    logger.info(
      `💻 [AIStreamingEngineerAgent] Analyzing AI Streaming Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Streaming Engineer Target',
      );
...
export const aIStreamingEngineerAgent = Object.freeze(
  new AIStreamingEngineerAgent(),
);
