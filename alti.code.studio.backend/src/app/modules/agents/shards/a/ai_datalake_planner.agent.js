...
class AIDataLakePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIDataLakeSystem(objective) {
    logger.info(
      `💻 [AIDataLakePlannerAgent] Analyzing AI DataLake Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI DataLake Planner Target',
      );
...
export const aIDataLakePlannerAgent = Object.freeze(
  new AIDataLakePlannerAgent(),
);
