...
class AIEngineeringPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateAIEngineeringSystem(objective) {
        logger.info(`💻 [AIEngineeringPlannerAgent] Analyzing AI Engineering Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Engineering Planner Target");
...
export const aIEngineeringPlannerAgent = Object.freeze(new AIEngineeringPlannerAgent());
