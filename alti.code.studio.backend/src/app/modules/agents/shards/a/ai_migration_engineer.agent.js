...
class AIMigrationEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateAIMigrationSystem(objective) {
        logger.info(`💻 [AIMigrationEngineerAgent] Analyzing AI Migration Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Migration Engineer Target");
...
export const aIMigrationEngineerAgent = Object.freeze(new AIMigrationEngineerAgent());
