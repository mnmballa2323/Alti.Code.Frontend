...
class AIProvisioningSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateAIProvisioningSystem(objective) {
        logger.info(`💻 [AIProvisioningSpecialistAgent] Analyzing AI Provisioning Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Provisioning Specialist Target");
...
export const aIProvisioningSpecialistAgent = Object.freeze(new AIProvisioningSpecialistAgent());
