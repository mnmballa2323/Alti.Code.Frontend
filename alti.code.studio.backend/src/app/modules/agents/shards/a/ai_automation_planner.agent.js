...
class AIAutomationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIAutomationSystem(objective) {
    logger.info(
      `💻 [AIAutomationPlannerAgent] Analyzing AI Automation Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Automation Planner Target',
      );
...
export const aIAutomationPlannerAgent = Object.freeze(
  new AIAutomationPlannerAgent(),
);
