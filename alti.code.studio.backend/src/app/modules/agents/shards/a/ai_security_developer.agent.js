...
class AISecurityDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateAISecuritySystem(objective) {
    logger.info(
      `💻 [AISecurityDeveloperAgent] Analyzing AI Security Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Security Developer Target',
      );
...
export const aISecurityDeveloperAgent = Object.freeze(
  new AISecurityDeveloperAgent(),
);
