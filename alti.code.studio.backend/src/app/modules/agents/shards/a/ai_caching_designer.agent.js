...
class AICachingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateAICachingSystem(objective) {
    logger.info(
      `💻 [AICachingDesignerAgent] Analyzing AI Caching Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Caching Designer Target',
      );
...
export const aICachingDesignerAgent = Object.freeze(
  new AICachingDesignerAgent(),
);
