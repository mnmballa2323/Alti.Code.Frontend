...
class AIResilienceManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIResilienceSystem(objective) {
    logger.info(
      `💻 [AIResilienceManagerAgent] Analyzing AI Resilience Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Resilience Manager Target',
      );
...
export const aIResilienceManagerAgent = Object.freeze(
  new AIResilienceManagerAgent(),
);
