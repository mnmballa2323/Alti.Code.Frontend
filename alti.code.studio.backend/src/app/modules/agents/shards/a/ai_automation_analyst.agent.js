...
class AIAutomationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateAIAutomationSystem(objective) {
    logger.info(
      `💻 [AIAutomationAnalystAgent] Analyzing AI Automation Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Automation Analyst Target',
      );
...
export const aIAutomationAnalystAgent = Object.freeze(
  new AIAutomationAnalystAgent(),
);
