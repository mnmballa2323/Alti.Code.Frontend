...
class AIServerlessTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateAIServerlessSystem(objective) {
    logger.info(
      `💻 [AIServerlessTesterAgent] Analyzing AI Serverless Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Serverless Tester Target',
      );
...
export const aIServerlessTesterAgent = Object.freeze(
  new AIServerlessTesterAgent(),
);
