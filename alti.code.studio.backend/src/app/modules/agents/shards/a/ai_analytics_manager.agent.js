...
class AIAnalyticsManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateAIAnalyticsSystem(objective) {
        logger.info(`💻 [AIAnalyticsManagerAgent] Analyzing AI Analytics Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Analytics Manager Target");
...
export const aIAnalyticsManagerAgent = Object.freeze(new AIAnalyticsManagerAgent());
