...
class AIEngineeringLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateAIEngineeringSystem(objective) {
    logger.info(
      `💻 [AIEngineeringLeadAgent] Analyzing AI Engineering Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Engineering Lead Target',
      );
...
export const aIEngineeringLeadAgent = Object.freeze(
  new AIEngineeringLeadAgent(),
);
