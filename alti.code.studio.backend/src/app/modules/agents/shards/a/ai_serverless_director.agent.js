...
class AIServerlessDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIServerlessSystem(objective) {
    logger.info(
      `💻 [AIServerlessDirectorAgent] Analyzing AI Serverless Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Serverless Director Target',
      );
...
export const aIServerlessDirectorAgent = Object.freeze(
  new AIServerlessDirectorAgent(),
);
