...
class AICachingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateAICachingSystem(objective) {
    logger.info(
      `💻 [AICachingDirectorAgent] Analyzing AI Caching Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Caching Director Target',
      );
...
export const aICachingDirectorAgent = Object.freeze(
  new AICachingDirectorAgent(),
);
