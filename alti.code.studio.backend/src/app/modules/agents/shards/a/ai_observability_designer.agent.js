...
class AIObservabilityDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIObservabilitySystem(objective) {
    logger.info(
      `💻 [AIObservabilityDesignerAgent] Analyzing AI Observability Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Observability Designer Target',
      );
...
export const aIObservabilityDesignerAgent = Object.freeze(
  new AIObservabilityDesignerAgent(),
);
