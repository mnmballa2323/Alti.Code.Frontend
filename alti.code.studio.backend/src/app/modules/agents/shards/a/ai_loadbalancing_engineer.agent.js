...
class AILoadBalancingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateAILoadBalancingSystem(objective) {
    logger.info(
      `💻 [AILoadBalancingEngineerAgent] Analyzing AI LoadBalancing Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI LoadBalancing Engineer Target',
      );
...
export const aILoadBalancingEngineerAgent = Object.freeze(
  new AILoadBalancingEngineerAgent(),
);
