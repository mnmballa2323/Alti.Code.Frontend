...
class AISecurityOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateAISecuritySystem(objective) {
    logger.info(
      `💻 [AISecurityOrchestratorAgent] Analyzing AI Security Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Security Orchestrator Target',
      );
...
export const aISecurityOrchestratorAgent = Object.freeze(
  new AISecurityOrchestratorAgent(),
);
