...
class AIMigrationAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateAIMigrationSystem(objective) {
        logger.info(`💻 [AIMigrationAnalystAgent] Analyzing AI Migration Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Migration Analyst Target");
...
export const aIMigrationAnalystAgent = Object.freeze(new AIMigrationAnalystAgent());
