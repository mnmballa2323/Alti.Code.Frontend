...
class AIAnalyticsConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateAIAnalyticsSystem(objective) {
    logger.info(
      `💻 [AIAnalyticsConsultantAgent] Analyzing AI Analytics Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Analytics Consultant Target',
      );
...
export const aIAnalyticsConsultantAgent = Object.freeze(
  new AIAnalyticsConsultantAgent(),
);
