...
class AIServerlessConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateAIServerlessSystem(objective) {
        logger.info(`💻 [AIServerlessConsultantAgent] Analyzing AI Serverless Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Serverless Consultant Target");
...
export const aIServerlessConsultantAgent = Object.freeze(new AIServerlessConsultantAgent());
