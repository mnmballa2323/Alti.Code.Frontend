...
class AISecurityAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateAISecuritySystem(objective) {
    logger.info(
      `💻 [AISecurityAuditorAgent] Analyzing AI Security Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Security Auditor Target',
      );
...
export const aISecurityAuditorAgent = Object.freeze(
  new AISecurityAuditorAgent(),
);
