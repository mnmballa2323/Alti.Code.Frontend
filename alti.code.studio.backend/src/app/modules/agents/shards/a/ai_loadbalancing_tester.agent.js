...
class AILoadBalancingTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateAILoadBalancingSystem(objective) {
        logger.info(`💻 [AILoadBalancingTesterAgent] Analyzing AI LoadBalancing Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI LoadBalancing Tester Target");
...
export const aILoadBalancingTesterAgent = Object.freeze(new AILoadBalancingTesterAgent());
