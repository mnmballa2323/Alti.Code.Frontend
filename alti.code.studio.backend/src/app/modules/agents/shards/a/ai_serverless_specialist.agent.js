...
class AIServerlessSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateAIServerlessSystem(objective) {
    logger.info(
      `💻 [AIServerlessSpecialistAgent] Analyzing AI Serverless Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Serverless Specialist Target',
      );
...
export const aIServerlessSpecialistAgent = Object.freeze(
  new AIServerlessSpecialistAgent(),
);
