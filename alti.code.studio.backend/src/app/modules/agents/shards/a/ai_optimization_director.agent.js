...
class AIOptimizationDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIOptimizationSystem(objective) {
    logger.info(
      `💻 [AIOptimizationDirectorAgent] Analyzing AI Optimization Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Optimization Director Target',
      );
...
export const aIOptimizationDirectorAgent = Object.freeze(
  new AIOptimizationDirectorAgent(),
);
