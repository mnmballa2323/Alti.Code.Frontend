...
class AIObservabilityDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateAIObservabilitySystem(objective) {
        logger.info(`💻 [AIObservabilityDirectorAgent] Analyzing AI Observability Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Observability Director Target");
...
export const aIObservabilityDirectorAgent = Object.freeze(new AIObservabilityDirectorAgent());
