...
class AIAnalyticsPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateAIAnalyticsSystem(objective) {
        logger.info(`💻 [AIAnalyticsPlannerAgent] Analyzing AI Analytics Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI Analytics Planner Target");
...
export const aIAnalyticsPlannerAgent = Object.freeze(new AIAnalyticsPlannerAgent());
