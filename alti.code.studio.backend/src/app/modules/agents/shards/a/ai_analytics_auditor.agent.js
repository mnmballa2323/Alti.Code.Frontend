...
class AIAnalyticsAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateAIAnalyticsSystem(objective) {
    logger.info(
      `💻 [AIAnalyticsAuditorAgent] Analyzing AI Analytics Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Analytics Auditor Target',
      );
...
export const aIAnalyticsAuditorAgent = Object.freeze(
  new AIAnalyticsAuditorAgent(),
);
