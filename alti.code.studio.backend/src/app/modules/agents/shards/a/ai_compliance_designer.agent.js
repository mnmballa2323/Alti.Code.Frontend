...
class AIComplianceDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIComplianceSystem(objective) {
    logger.info(
      `💻 [AIComplianceDesignerAgent] Analyzing AI Compliance Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Compliance Designer Target',
      );
...
export const aIComplianceDesignerAgent = Object.freeze(
  new AIComplianceDesignerAgent(),
);
