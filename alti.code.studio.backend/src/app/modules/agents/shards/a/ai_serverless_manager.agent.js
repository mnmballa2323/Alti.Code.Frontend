...
class AIServerlessManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateAIServerlessSystem(objective) {
    logger.info(
      `💻 [AIServerlessManagerAgent] Analyzing AI Serverless Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI Serverless Manager Target',
      );
...
export const aIServerlessManagerAgent = Object.freeze(
  new AIServerlessManagerAgent(),
);
