...
class AIFaultToleranceEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateAIFaultToleranceSystem(objective) {
        logger.info(`💻 [AIFaultToleranceEngineerAgent] Analyzing AI FaultTolerance Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - AI FaultTolerance Engineer Target");
...
export const aIFaultToleranceEngineerAgent = Object.freeze(new AIFaultToleranceEngineerAgent());
