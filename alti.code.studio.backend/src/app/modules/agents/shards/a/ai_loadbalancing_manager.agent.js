...
class AILoadBalancingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateAILoadBalancingSystem(objective) {
    logger.info(
      `💻 [AILoadBalancingManagerAgent] Analyzing AI LoadBalancing Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - AI LoadBalancing Manager Target',
      );
...
export const aILoadBalancingManagerAgent = Object.freeze(
  new AILoadBalancingManagerAgent(),
);
