...
class UIMigrationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIMigrationSystem(objective) {
    logger.info(
      `💻 [UIMigrationPlannerAgent] Analyzing UI Migration Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Migration Planner Target',
      );
...
export const uIMigrationPlannerAgent = Object.freeze(
  new UIMigrationPlannerAgent(),
);
