...
class UIEngineeringConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateUIEngineeringSystem(objective) {
    logger.info(
      `💻 [UIEngineeringConsultantAgent] Analyzing UI Engineering Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Engineering Consultant Target',
      );
...
export const uIEngineeringConsultantAgent = Object.freeze(
  new UIEngineeringConsultantAgent(),
);
