...
class UXProvisioningLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateUXProvisioningSystem(objective) {
    logger.info(
      `💻 [UXProvisioningLeadAgent] Analyzing UX Provisioning Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Provisioning Lead Target',
      );
...
export const uXProvisioningLeadAgent = Object.freeze(
  new UXProvisioningLeadAgent(),
);
