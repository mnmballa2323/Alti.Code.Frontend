...
class UXMigrationDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateUXMigrationSystem(objective) {
        logger.info(`💻 [UXMigrationDirectorAgent] Analyzing UX Migration Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UX Migration Director Target");
...
export const uXMigrationDirectorAgent = Object.freeze(new UXMigrationDirectorAgent());
