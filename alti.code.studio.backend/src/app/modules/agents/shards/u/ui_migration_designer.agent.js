...
class UIMigrationDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIMigrationSystem(objective) {
    logger.info(
      `💻 [UIMigrationDesignerAgent] Analyzing UI Migration Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Migration Designer Target',
      );
...
export const uIMigrationDesignerAgent = Object.freeze(
  new UIMigrationDesignerAgent(),
);
