...
class UIMigrationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateUIMigrationSystem(objective) {
    logger.info(
      `💻 [UIMigrationAnalystAgent] Analyzing UI Migration Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Migration Analyst Target',
      );
...
export const uIMigrationAnalystAgent = Object.freeze(
  new UIMigrationAnalystAgent(),
);
