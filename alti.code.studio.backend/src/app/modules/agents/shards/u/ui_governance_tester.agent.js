...
class UIGovernanceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateUIGovernanceSystem(objective) {
    logger.info(
      `💻 [UIGovernanceTesterAgent] Analyzing UI Governance Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Governance Tester Target',
      );
...
export const uIGovernanceTesterAgent = Object.freeze(
  new UIGovernanceTesterAgent(),
);
