...
class UXAnalyticsDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateUXAnalyticsSystem(objective) {
    logger.info(
      `💻 [UXAnalyticsDeveloperAgent] Analyzing UX Analytics Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Analytics Developer Target',
      );
...
export const uXAnalyticsDeveloperAgent = Object.freeze(
  new UXAnalyticsDeveloperAgent(),
);
