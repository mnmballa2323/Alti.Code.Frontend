...
class UXMicroservicesDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUXMicroservicesSystem(objective) {
    logger.info(
      `💻 [UXMicroservicesDirectorAgent] Analyzing UX Microservices Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Microservices Director Target',
      );
...
export const uXMicroservicesDirectorAgent = Object.freeze(
  new UXMicroservicesDirectorAgent(),
);
