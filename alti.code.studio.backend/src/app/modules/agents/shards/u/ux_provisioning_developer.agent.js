...
class UXProvisioningDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateUXProvisioningSystem(objective) {
    logger.info(
      `💻 [UXProvisioningDeveloperAgent] Analyzing UX Provisioning Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Provisioning Developer Target',
      );
...
export const uXProvisioningDeveloperAgent = Object.freeze(
  new UXProvisioningDeveloperAgent(),
);
