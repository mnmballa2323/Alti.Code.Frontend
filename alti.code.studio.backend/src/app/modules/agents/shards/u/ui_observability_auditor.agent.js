...
class UIObservabilityAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIObservabilitySystem(objective) {
    logger.info(
      `💻 [UIObservabilityAuditorAgent] Analyzing UI Observability Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Observability Auditor Target',
      );
...
export const uIObservabilityAuditorAgent = Object.freeze(
  new UIObservabilityAuditorAgent(),
);
