...
class UITelemetryTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateUITelemetrySystem(objective) {
        logger.info(`💻 [UITelemetryTesterAgent] Analyzing UI Telemetry Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Telemetry Tester Target");
...
export const uITelemetryTesterAgent = Object.freeze(new UITelemetryTesterAgent());
