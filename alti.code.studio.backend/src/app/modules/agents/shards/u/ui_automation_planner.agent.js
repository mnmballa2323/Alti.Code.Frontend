...
class UIAutomationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIAutomationSystem(objective) {
    logger.info(
      `💻 [UIAutomationPlannerAgent] Analyzing UI Automation Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Automation Planner Target',
      );
...
export const uIAutomationPlannerAgent = Object.freeze(
  new UIAutomationPlannerAgent(),
);
