...
class UIOrchestrationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateUIOrchestrationSystem(objective) {
    logger.info(
      `💻 [UIOrchestrationLeadAgent] Analyzing UI Orchestration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Orchestration Lead Target',
      );
...
export const uIOrchestrationLeadAgent = Object.freeze(
  new UIOrchestrationLeadAgent(),
);
