...
class UXOptimizationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateUXOptimizationSystem(objective) {
    logger.info(
      `💻 [UXOptimizationAuditorAgent] Analyzing UX Optimization Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Optimization Auditor Target',
      );
...
export const uXOptimizationAuditorAgent = Object.freeze(
  new UXOptimizationAuditorAgent(),
);
