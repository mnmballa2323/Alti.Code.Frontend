...
class UXTelemetryDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateUXTelemetrySystem(objective) {
    logger.info(
      `💻 [UXTelemetryDesignerAgent] Analyzing UX Telemetry Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Telemetry Designer Target',
      );
...
export const uXTelemetryDesignerAgent = Object.freeze(
  new UXTelemetryDesignerAgent(),
);
