...
class UIComplianceDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIComplianceSystem(objective) {
    logger.info(
      `💻 [UIComplianceDirectorAgent] Analyzing UI Compliance Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Compliance Director Target',
      );
...
export const uIComplianceDirectorAgent = Object.freeze(
  new UIComplianceDirectorAgent(),
);
