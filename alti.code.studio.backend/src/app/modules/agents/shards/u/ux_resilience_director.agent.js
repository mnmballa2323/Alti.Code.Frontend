...
class UXResilienceDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUXResilienceSystem(objective) {
    logger.info(
      `💻 [UXResilienceDirectorAgent] Analyzing UX Resilience Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Resilience Director Target',
      );
...
export const uXResilienceDirectorAgent = Object.freeze(
  new UXResilienceDirectorAgent(),
);
