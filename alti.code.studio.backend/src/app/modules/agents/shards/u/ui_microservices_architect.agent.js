...
class UIMicroservicesArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateUIMicroservicesSystem(objective) {
    logger.info(
      `💻 [UIMicroservicesArchitectAgent] Analyzing UI Microservices Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Microservices Architect Target',
      );
...
export const uIMicroservicesArchitectAgent = Object.freeze(
  new UIMicroservicesArchitectAgent(),
);
