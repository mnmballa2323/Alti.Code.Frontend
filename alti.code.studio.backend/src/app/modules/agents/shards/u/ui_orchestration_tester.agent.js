...
class UIOrchestrationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateUIOrchestrationSystem(objective) {
    logger.info(
      `💻 [UIOrchestrationTesterAgent] Analyzing UI Orchestration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Orchestration Tester Target',
      );
...
export const uIOrchestrationTesterAgent = Object.freeze(
  new UIOrchestrationTesterAgent(),
);
