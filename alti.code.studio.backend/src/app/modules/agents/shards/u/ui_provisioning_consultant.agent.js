...
class UIProvisioningConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateUIProvisioningSystem(objective) {
    logger.info(
      `💻 [UIProvisioningConsultantAgent] Analyzing UI Provisioning Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Provisioning Consultant Target',
      );
...
export const uIProvisioningConsultantAgent = Object.freeze(
  new UIProvisioningConsultantAgent(),
);
