...
class UIDataLakeDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIDataLakeSystem(objective) {
    logger.info(
      `💻 [UIDataLakeDesignerAgent] Analyzing UI DataLake Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI DataLake Designer Target',
      );
...
export const uIDataLakeDesignerAgent = Object.freeze(
  new UIDataLakeDesignerAgent(),
);
