...
class UXIntegrationConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateUXIntegrationSystem(objective) {
    logger.info(
      `💻 [UXIntegrationConsultantAgent] Analyzing UX Integration Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Integration Consultant Target',
      );
...
export const uXIntegrationConsultantAgent = Object.freeze(
  new UXIntegrationConsultantAgent(),
);
