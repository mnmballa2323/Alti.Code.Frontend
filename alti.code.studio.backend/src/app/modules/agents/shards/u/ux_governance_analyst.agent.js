...
class UXGovernanceAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateUXGovernanceSystem(objective) {
    logger.info(
      `💻 [UXGovernanceAnalystAgent] Analyzing UX Governance Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Governance Analyst Target',
      );
...
export const uXGovernanceAnalystAgent = Object.freeze(
  new UXGovernanceAnalystAgent(),
);
