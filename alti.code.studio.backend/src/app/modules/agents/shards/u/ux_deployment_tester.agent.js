...
class UXDeploymentTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateUXDeploymentSystem(objective) {
    logger.info(
      `💻 [UXDeploymentTesterAgent] Analyzing UX Deployment Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Deployment Tester Target',
      );
...
export const uXDeploymentTesterAgent = Object.freeze(
  new UXDeploymentTesterAgent(),
);
