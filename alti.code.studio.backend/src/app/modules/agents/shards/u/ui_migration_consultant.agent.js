...
class UIMigrationConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateUIMigrationSystem(objective) {
    logger.info(
      `💻 [UIMigrationConsultantAgent] Analyzing UI Migration Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Migration Consultant Target',
      );
...
export const uIMigrationConsultantAgent = Object.freeze(
  new UIMigrationConsultantAgent(),
);
