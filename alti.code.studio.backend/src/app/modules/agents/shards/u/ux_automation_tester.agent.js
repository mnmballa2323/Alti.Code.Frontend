...
class UXAutomationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateUXAutomationSystem(objective) {
    logger.info(
      `💻 [UXAutomationTesterAgent] Analyzing UX Automation Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Automation Tester Target',
      );
...
export const uXAutomationTesterAgent = Object.freeze(
  new UXAutomationTesterAgent(),
);
