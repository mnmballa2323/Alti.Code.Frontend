...
class UISecuritySpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateUISecuritySystem(objective) {
    logger.info(
      `💻 [UISecuritySpecialistAgent] Analyzing UI Security Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Security Specialist Target',
      );
...
export const uISecuritySpecialistAgent = Object.freeze(
  new UISecuritySpecialistAgent(),
);
