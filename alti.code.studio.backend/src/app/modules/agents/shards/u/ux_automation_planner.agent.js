...
class UXAutomationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateUXAutomationSystem(objective) {
    logger.info(
      `💻 [UXAutomationPlannerAgent] Analyzing UX Automation Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Automation Planner Target',
      );
...
export const uXAutomationPlannerAgent = Object.freeze(
  new UXAutomationPlannerAgent(),
);
