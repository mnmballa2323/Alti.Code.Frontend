...
class UXAutomationDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateUXAutomationSystem(objective) {
    logger.info(
      `💻 [UXAutomationDesignerAgent] Analyzing UX Automation Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Automation Designer Target',
      );
...
export const uXAutomationDesignerAgent = Object.freeze(
  new UXAutomationDesignerAgent(),
);
