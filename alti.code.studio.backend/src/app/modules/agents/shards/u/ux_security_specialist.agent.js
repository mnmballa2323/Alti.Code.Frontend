...
class UXSecuritySpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateUXSecuritySystem(objective) {
    logger.info(
      `💻 [UXSecuritySpecialistAgent] Analyzing UX Security Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Security Specialist Target',
      );
...
export const uXSecuritySpecialistAgent = Object.freeze(
  new UXSecuritySpecialistAgent(),
);
