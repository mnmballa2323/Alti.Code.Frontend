...
class UIDeploymentConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateUIDeploymentSystem(objective) {
    logger.info(
      `💻 [UIDeploymentConsultantAgent] Analyzing UI Deployment Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Deployment Consultant Target',
      );
...
export const uIDeploymentConsultantAgent = Object.freeze(
  new UIDeploymentConsultantAgent(),
);
