...
class UITelemetryAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateUITelemetrySystem(objective) {
    logger.info(
      `💻 [UITelemetryAnalystAgent] Analyzing UI Telemetry Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Telemetry Analyst Target',
      );
...
export const uITelemetryAnalystAgent = Object.freeze(
  new UITelemetryAnalystAgent(),
);
