...
class UIAnalyticsDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIAnalyticsSystem(objective) {
    logger.info(
      `💻 [UIAnalyticsDesignerAgent] Analyzing UI Analytics Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Analytics Designer Target',
      );
...
export const uIAnalyticsDesignerAgent = Object.freeze(
  new UIAnalyticsDesignerAgent(),
);
