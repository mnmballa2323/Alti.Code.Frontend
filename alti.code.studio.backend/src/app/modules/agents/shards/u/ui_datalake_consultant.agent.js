...
class UIDataLakeConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateUIDataLakeSystem(objective) {
    logger.info(
      `💻 [UIDataLakeConsultantAgent] Analyzing UI DataLake Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI DataLake Consultant Target',
      );
...
export const uIDataLakeConsultantAgent = Object.freeze(
  new UIDataLakeConsultantAgent(),
);
