...
class UIComplianceConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateUIComplianceSystem(objective) {
    logger.info(
      `💻 [UIComplianceConsultantAgent] Analyzing UI Compliance Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Compliance Consultant Target',
      );
...
export const uIComplianceConsultantAgent = Object.freeze(
  new UIComplianceConsultantAgent(),
);
