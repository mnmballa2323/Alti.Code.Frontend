...
class UXTelemetryAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateUXTelemetrySystem(objective) {
    logger.info(
      `💻 [UXTelemetryAnalystAgent] Analyzing UX Telemetry Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Telemetry Analyst Target',
      );
...
export const uXTelemetryAnalystAgent = Object.freeze(
  new UXTelemetryAnalystAgent(),
);
