...
class UXAnalyticsDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUXAnalyticsSystem(objective) {
    logger.info(
      `💻 [UXAnalyticsDirectorAgent] Analyzing UX Analytics Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Analytics Director Target',
      );
...
export const uXAnalyticsDirectorAgent = Object.freeze(
  new UXAnalyticsDirectorAgent(),
);
