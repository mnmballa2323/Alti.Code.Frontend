...
class UIServerlessEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIServerlessSystem(objective) {
    logger.info(
      `💻 [UIServerlessEngineerAgent] Analyzing UI Serverless Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Serverless Engineer Target',
      );
...
export const uIServerlessEngineerAgent = Object.freeze(
  new UIServerlessEngineerAgent(),
);
