...
class UIOptimizationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIOptimizationSystem(objective) {
    logger.info(
      `💻 [UIOptimizationAuditorAgent] Analyzing UI Optimization Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Optimization Auditor Target',
      );
...
export const uIOptimizationAuditorAgent = Object.freeze(
  new UIOptimizationAuditorAgent(),
);
