...
class UITelemetryDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUITelemetrySystem(objective) {
    logger.info(
      `💻 [UITelemetryDirectorAgent] Analyzing UI Telemetry Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Telemetry Director Target',
      );
...
export const uITelemetryDirectorAgent = Object.freeze(
  new UITelemetryDirectorAgent(),
);
