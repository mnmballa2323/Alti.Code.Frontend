...
class UITestingArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateUITestingSystem(objective) {
    logger.info(
      `💻 [UITestingArchitectAgent] Analyzing UI Testing Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Testing Architect Target',
      );
...
export const uITestingArchitectAgent = Object.freeze(
  new UITestingArchitectAgent(),
);
