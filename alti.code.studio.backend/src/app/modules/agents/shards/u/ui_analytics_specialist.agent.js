...
class UIAnalyticsSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateUIAnalyticsSystem(objective) {
    logger.info(
      `💻 [UIAnalyticsSpecialistAgent] Analyzing UI Analytics Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Analytics Specialist Target',
      );
...
export const uIAnalyticsSpecialistAgent = Object.freeze(
  new UIAnalyticsSpecialistAgent(),
);
