...
class UIOptimizationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIOptimizationSystem(objective) {
    logger.info(
      `💻 [UIOptimizationManagerAgent] Analyzing UI Optimization Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Optimization Manager Target',
      );
...
export const uIOptimizationManagerAgent = Object.freeze(
  new UIOptimizationManagerAgent(),
);
