...
class UXMicroservicesManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateUXMicroservicesSystem(objective) {
    logger.info(
      `💻 [UXMicroservicesManagerAgent] Analyzing UX Microservices Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Microservices Manager Target',
      );
...
export const uXMicroservicesManagerAgent = Object.freeze(
  new UXMicroservicesManagerAgent(),
);
