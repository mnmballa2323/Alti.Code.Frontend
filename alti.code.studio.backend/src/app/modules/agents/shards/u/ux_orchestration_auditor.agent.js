...
class UXOrchestrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateUXOrchestrationSystem(objective) {
    logger.info(
      `💻 [UXOrchestrationAuditorAgent] Analyzing UX Orchestration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Orchestration Auditor Target',
      );
...
export const uXOrchestrationAuditorAgent = Object.freeze(
  new UXOrchestrationAuditorAgent(),
);
