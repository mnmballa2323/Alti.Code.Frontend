...
class UIDeploymentAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIDeploymentSystem(objective) {
    logger.info(
      `💻 [UIDeploymentAuditorAgent] Analyzing UI Deployment Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Deployment Auditor Target',
      );
...
export const uIDeploymentAuditorAgent = Object.freeze(
  new UIDeploymentAuditorAgent(),
);
