...
class UIAutomationTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateUIAutomationSystem(objective) {
        logger.info(`💻 [UIAutomationTesterAgent] Analyzing UI Automation Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Automation Tester Target");
...
export const uIAutomationTesterAgent = Object.freeze(new UIAutomationTesterAgent());
