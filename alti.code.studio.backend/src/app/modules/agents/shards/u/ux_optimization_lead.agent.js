...
class UXOptimizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateUXOptimizationSystem(objective) {
    logger.info(
      `💻 [UXOptimizationLeadAgent] Analyzing UX Optimization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Optimization Lead Target',
      );
...
export const uXOptimizationLeadAgent = Object.freeze(
  new UXOptimizationLeadAgent(),
);
