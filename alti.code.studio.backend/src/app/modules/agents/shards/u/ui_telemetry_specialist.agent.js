...
class UITelemetrySpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateUITelemetrySystem(objective) {
    logger.info(
      `💻 [UITelemetrySpecialistAgent] Analyzing UI Telemetry Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Telemetry Specialist Target',
      );
...
export const uITelemetrySpecialistAgent = Object.freeze(
  new UITelemetrySpecialistAgent(),
);
