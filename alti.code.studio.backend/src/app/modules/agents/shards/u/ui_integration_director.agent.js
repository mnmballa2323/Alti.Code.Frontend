...
class UIIntegrationDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIIntegrationSystem(objective) {
    logger.info(
      `💻 [UIIntegrationDirectorAgent] Analyzing UI Integration Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Integration Director Target',
      );
...
export const uIIntegrationDirectorAgent = Object.freeze(
  new UIIntegrationDirectorAgent(),
);
