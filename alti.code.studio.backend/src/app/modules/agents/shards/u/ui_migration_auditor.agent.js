...
class UIMigrationAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateUIMigrationSystem(objective) {
        logger.info(`💻 [UIMigrationAuditorAgent] Analyzing UI Migration Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Migration Auditor Target");
...
export const uIMigrationAuditorAgent = Object.freeze(new UIMigrationAuditorAgent());
