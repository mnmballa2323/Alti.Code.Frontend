...
class UIDataLakeAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateUIDataLakeSystem(objective) {
    logger.info(
      `💻 [UIDataLakeAnalystAgent] Analyzing UI DataLake Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI DataLake Analyst Target',
      );
...
export const uIDataLakeAnalystAgent = Object.freeze(
  new UIDataLakeAnalystAgent(),
);
