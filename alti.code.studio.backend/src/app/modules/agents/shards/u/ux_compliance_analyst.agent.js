...
class UXComplianceAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateUXComplianceSystem(objective) {
    logger.info(
      `💻 [UXComplianceAnalystAgent] Analyzing UX Compliance Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Compliance Analyst Target',
      );
...
export const uXComplianceAnalystAgent = Object.freeze(
  new UXComplianceAnalystAgent(),
);
