...
class UXSecurityDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateUXSecuritySystem(objective) {
    logger.info(
      `💻 [UXSecurityDesignerAgent] Analyzing UX Security Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Security Designer Target',
      );
...
export const uXSecurityDesignerAgent = Object.freeze(
  new UXSecurityDesignerAgent(),
);
