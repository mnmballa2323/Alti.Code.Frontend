...
class UISecurityAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateUISecuritySystem(objective) {
    logger.info(
      `💻 [UISecurityAuditorAgent] Analyzing UI Security Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Security Auditor Target',
      );
...
export const uISecurityAuditorAgent = Object.freeze(
  new UISecurityAuditorAgent(),
);
