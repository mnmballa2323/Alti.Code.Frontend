...
class UIDataWarehouseAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIDataWarehouseSystem(objective) {
    logger.info(
      `💻 [UIDataWarehouseAuditorAgent] Analyzing UI DataWarehouse Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI DataWarehouse Auditor Target',
      );
...
export const uIDataWarehouseAuditorAgent = Object.freeze(
  new UIDataWarehouseAuditorAgent(),
);
