...
class UIMicroservicesLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateUIMicroservicesSystem(objective) {
    logger.info(
      `💻 [UIMicroservicesLeadAgent] Analyzing UI Microservices Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Microservices Lead Target',
      );
...
export const uIMicroservicesLeadAgent = Object.freeze(
  new UIMicroservicesLeadAgent(),
);
