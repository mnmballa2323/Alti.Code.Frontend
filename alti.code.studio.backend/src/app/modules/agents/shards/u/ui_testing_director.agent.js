...
class UITestingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUITestingSystem(objective) {
    logger.info(
      `💻 [UITestingDirectorAgent] Analyzing UI Testing Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Testing Director Target',
      );
...
export const uITestingDirectorAgent = Object.freeze(
  new UITestingDirectorAgent(),
);
