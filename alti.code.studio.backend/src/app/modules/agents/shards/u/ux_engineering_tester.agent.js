...
class UXEngineeringTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateUXEngineeringSystem(objective) {
    logger.info(
      `💻 [UXEngineeringTesterAgent] Analyzing UX Engineering Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Engineering Tester Target',
      );
...
export const uXEngineeringTesterAgent = Object.freeze(
  new UXEngineeringTesterAgent(),
);
