...
class UIProvisioningAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateUIProvisioningSystem(objective) {
        logger.info(`💻 [UIProvisioningAuditorAgent] Analyzing UI Provisioning Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Provisioning Auditor Target");
...
export const uIProvisioningAuditorAgent = Object.freeze(new UIProvisioningAuditorAgent());
