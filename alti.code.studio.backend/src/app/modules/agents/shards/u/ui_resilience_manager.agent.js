...
class UIResilienceManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIResilienceSystem(objective) {
    logger.info(
      `💻 [UIResilienceManagerAgent] Analyzing UI Resilience Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Resilience Manager Target',
      );
...
export const uIResilienceManagerAgent = Object.freeze(
  new UIResilienceManagerAgent(),
);
