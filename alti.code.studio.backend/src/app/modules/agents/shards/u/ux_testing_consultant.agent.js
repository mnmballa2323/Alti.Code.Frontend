...
class UXTestingConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateUXTestingSystem(objective) {
    logger.info(
      `💻 [UXTestingConsultantAgent] Analyzing UX Testing Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Testing Consultant Target',
      );
...
export const uXTestingConsultantAgent = Object.freeze(
  new UXTestingConsultantAgent(),
);
