...
class UXTelemetryDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUXTelemetrySystem(objective) {
    logger.info(
      `💻 [UXTelemetryDirectorAgent] Analyzing UX Telemetry Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Telemetry Director Target',
      );
...
export const uXTelemetryDirectorAgent = Object.freeze(
  new UXTelemetryDirectorAgent(),
);
