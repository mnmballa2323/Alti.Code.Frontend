...
class UXTelemetrySpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateUXTelemetrySystem(objective) {
        logger.info(`💻 [UXTelemetrySpecialistAgent] Analyzing UX Telemetry Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UX Telemetry Specialist Target");
...
export const uXTelemetrySpecialistAgent = Object.freeze(new UXTelemetrySpecialistAgent());
