...
class UXServerlessTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateUXServerlessSystem(objective) {
        logger.info(`💻 [UXServerlessTesterAgent] Analyzing UX Serverless Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UX Serverless Tester Target");
...
export const uXServerlessTesterAgent = Object.freeze(new UXServerlessTesterAgent());
