...
class UXTestingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUXTestingSystem(objective) {
    logger.info(
      `💻 [UXTestingDirectorAgent] Analyzing UX Testing Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Testing Director Target',
      );
...
export const uXTestingDirectorAgent = Object.freeze(
  new UXTestingDirectorAgent(),
);
