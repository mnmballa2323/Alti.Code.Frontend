...
class UITestingDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateUITestingSystem(objective) {
    logger.info(
      `💻 [UITestingDeveloperAgent] Analyzing UI Testing Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Testing Developer Target',
      );
...
export const uITestingDeveloperAgent = Object.freeze(
  new UITestingDeveloperAgent(),
);
