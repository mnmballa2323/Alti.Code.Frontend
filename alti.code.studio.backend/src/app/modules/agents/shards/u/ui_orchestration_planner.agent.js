...
class UIOrchestrationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIOrchestrationSystem(objective) {
    logger.info(
      `💻 [UIOrchestrationPlannerAgent] Analyzing UI Orchestration Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Orchestration Planner Target',
      );
...
export const uIOrchestrationPlannerAgent = Object.freeze(
  new UIOrchestrationPlannerAgent(),
);
