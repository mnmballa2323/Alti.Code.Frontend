...
class UITestingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateUITestingSystem(objective) {
    logger.info(
      `💻 [UITestingDesignerAgent] Analyzing UI Testing Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Testing Designer Target',
      );
...
export const uITestingDesignerAgent = Object.freeze(
  new UITestingDesignerAgent(),
);
