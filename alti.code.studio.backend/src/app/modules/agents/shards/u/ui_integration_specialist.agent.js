...
class UIIntegrationSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateUIIntegrationSystem(objective) {
    logger.info(
      `💻 [UIIntegrationSpecialistAgent] Analyzing UI Integration Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Integration Specialist Target',
      );
...
export const uIIntegrationSpecialistAgent = Object.freeze(
  new UIIntegrationSpecialistAgent(),
);
