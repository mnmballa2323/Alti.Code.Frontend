...
class UIResilienceDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIResilienceSystem(objective) {
    logger.info(
      `💻 [UIResilienceDesignerAgent] Analyzing UI Resilience Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Resilience Designer Target',
      );
...
export const uIResilienceDesignerAgent = Object.freeze(
  new UIResilienceDesignerAgent(),
);
