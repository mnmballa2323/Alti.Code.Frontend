...
class UILoadBalancingAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateUILoadBalancingSystem(objective) {
    logger.info(
      `💻 [UILoadBalancingAnalystAgent] Analyzing UI LoadBalancing Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI LoadBalancing Analyst Target',
      );
...
export const uILoadBalancingAnalystAgent = Object.freeze(
  new UILoadBalancingAnalystAgent(),
);
