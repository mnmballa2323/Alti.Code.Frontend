...
class UXAnalyticsConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateUXAnalyticsSystem(objective) {
    logger.info(
      `💻 [UXAnalyticsConsultantAgent] Analyzing UX Analytics Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Analytics Consultant Target',
      );
...
export const uXAnalyticsConsultantAgent = Object.freeze(
  new UXAnalyticsConsultantAgent(),
);
