...
class UXMigrationSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateUXMigrationSystem(objective) {
    logger.info(
      `💻 [UXMigrationSpecialistAgent] Analyzing UX Migration Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Migration Specialist Target',
      );
...
export const uXMigrationSpecialistAgent = Object.freeze(
  new UXMigrationSpecialistAgent(),
);
