...
class UXDataWarehouseEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateUXDataWarehouseSystem(objective) {
    logger.info(
      `💻 [UXDataWarehouseEngineerAgent] Analyzing UX DataWarehouse Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX DataWarehouse Engineer Target',
      );
...
export const uXDataWarehouseEngineerAgent = Object.freeze(
  new UXDataWarehouseEngineerAgent(),
);
