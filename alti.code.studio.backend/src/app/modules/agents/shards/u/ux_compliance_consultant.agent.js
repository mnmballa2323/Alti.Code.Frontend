...
class UXComplianceConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateUXComplianceSystem(objective) {
    logger.info(
      `💻 [UXComplianceConsultantAgent] Analyzing UX Compliance Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Compliance Consultant Target',
      );
...
export const uXComplianceConsultantAgent = Object.freeze(
  new UXComplianceConsultantAgent(),
);
