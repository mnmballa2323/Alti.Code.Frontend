...
class UIDataLakeAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIDataLakeSystem(objective) {
    logger.info(
      `💻 [UIDataLakeAuditorAgent] Analyzing UI DataLake Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI DataLake Auditor Target',
      );
...
export const uIDataLakeAuditorAgent = Object.freeze(
  new UIDataLakeAuditorAgent(),
);
