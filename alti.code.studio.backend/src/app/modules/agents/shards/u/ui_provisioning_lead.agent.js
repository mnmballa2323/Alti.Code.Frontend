...
class UIProvisioningLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateUIProvisioningSystem(objective) {
    logger.info(
      `💻 [UIProvisioningLeadAgent] Analyzing UI Provisioning Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Provisioning Lead Target',
      );
...
export const uIProvisioningLeadAgent = Object.freeze(
  new UIProvisioningLeadAgent(),
);
