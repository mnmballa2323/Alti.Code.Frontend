...
class UIDataWarehouseLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateUIDataWarehouseSystem(objective) {
    logger.info(
      `💻 [UIDataWarehouseLeadAgent] Analyzing UI DataWarehouse Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI DataWarehouse Lead Target',
      );
...
export const uIDataWarehouseLeadAgent = Object.freeze(
  new UIDataWarehouseLeadAgent(),
);
