...
class UXArchitectureConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateUXArchitectureSystem(objective) {
    logger.info(
      `💻 [UXArchitectureConsultantAgent] Analyzing UX Architecture Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Architecture Consultant Target',
      );
...
export const uXArchitectureConsultantAgent = Object.freeze(
  new UXArchitectureConsultantAgent(),
);
