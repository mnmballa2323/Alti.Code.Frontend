...
class UIDataWarehouseManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIDataWarehouseSystem(objective) {
    logger.info(
      `💻 [UIDataWarehouseManagerAgent] Analyzing UI DataWarehouse Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI DataWarehouse Manager Target',
      );
...
export const uIDataWarehouseManagerAgent = Object.freeze(
  new UIDataWarehouseManagerAgent(),
);
