...
class UXIntegrationSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateUXIntegrationSystem(objective) {
    logger.info(
      `💻 [UXIntegrationSpecialistAgent] Analyzing UX Integration Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Integration Specialist Target',
      );
...
export const uXIntegrationSpecialistAgent = Object.freeze(
  new UXIntegrationSpecialistAgent(),
);
