...
class UXResiliencePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateUXResilienceSystem(objective) {
    logger.info(
      `💻 [UXResiliencePlannerAgent] Analyzing UX Resilience Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Resilience Planner Target',
      );
...
export const uXResiliencePlannerAgent = Object.freeze(
  new UXResiliencePlannerAgent(),
);
