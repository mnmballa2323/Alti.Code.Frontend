...
class UIDataWarehouseEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIDataWarehouseSystem(objective) {
    logger.info(
      `💻 [UIDataWarehouseEngineerAgent] Analyzing UI DataWarehouse Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI DataWarehouse Engineer Target',
      );
...
export const uIDataWarehouseEngineerAgent = Object.freeze(
  new UIDataWarehouseEngineerAgent(),
);
