...
class UIOptimizationDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIOptimizationSystem(objective) {
    logger.info(
      `💻 [UIOptimizationDirectorAgent] Analyzing UI Optimization Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Optimization Director Target',
      );
...
export const uIOptimizationDirectorAgent = Object.freeze(
  new UIOptimizationDirectorAgent(),
);
