...
class UITelemetryStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateUITelemetrySystem(objective) {
    logger.info(
      `💻 [UITelemetryStrategistAgent] Analyzing UI Telemetry Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Telemetry Strategist Target',
      );
...
export const uITelemetryStrategistAgent = Object.freeze(
  new UITelemetryStrategistAgent(),
);
