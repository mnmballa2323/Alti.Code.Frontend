...
class UXSecurityConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateUXSecuritySystem(objective) {
    logger.info(
      `💻 [UXSecurityConsultantAgent] Analyzing UX Security Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Security Consultant Target',
      );
...
export const uXSecurityConsultantAgent = Object.freeze(
  new UXSecurityConsultantAgent(),
);
