...
class UIMicroservicesDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIMicroservicesSystem(objective) {
    logger.info(
      `💻 [UIMicroservicesDirectorAgent] Analyzing UI Microservices Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Microservices Director Target',
      );
...
export const uIMicroservicesDirectorAgent = Object.freeze(
  new UIMicroservicesDirectorAgent(),
);
