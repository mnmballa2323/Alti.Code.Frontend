...
class UIStreamingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIStreamingSystem(objective) {
    logger.info(
      `💻 [UIStreamingAuditorAgent] Analyzing UI Streaming Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Streaming Auditor Target',
      );
...
export const uIStreamingAuditorAgent = Object.freeze(
  new UIStreamingAuditorAgent(),
);
