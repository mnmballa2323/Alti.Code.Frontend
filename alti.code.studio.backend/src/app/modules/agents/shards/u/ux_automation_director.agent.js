...
class UXAutomationDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUXAutomationSystem(objective) {
    logger.info(
      `💻 [UXAutomationDirectorAgent] Analyzing UX Automation Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Automation Director Target',
      );
...
export const uXAutomationDirectorAgent = Object.freeze(
  new UXAutomationDirectorAgent(),
);
