...
class UXStreamingConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateUXStreamingSystem(objective) {
    logger.info(
      `💻 [UXStreamingConsultantAgent] Analyzing UX Streaming Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Streaming Consultant Target',
      );
...
export const uXStreamingConsultantAgent = Object.freeze(
  new UXStreamingConsultantAgent(),
);
