...
class UIAutomationConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateUIAutomationSystem(objective) {
    logger.info(
      `💻 [UIAutomationConsultantAgent] Analyzing UI Automation Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Automation Consultant Target',
      );
...
export const uIAutomationConsultantAgent = Object.freeze(
  new UIAutomationConsultantAgent(),
);
