...
class UIVirtualizationManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateUIVirtualizationSystem(objective) {
        logger.info(`💻 [UIVirtualizationManagerAgent] Analyzing UI Virtualization Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Virtualization Manager Target");
...
export const uIVirtualizationManagerAgent = Object.freeze(new UIVirtualizationManagerAgent());
