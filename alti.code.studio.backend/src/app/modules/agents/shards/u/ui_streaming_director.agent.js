...
class UIStreamingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIStreamingSystem(objective) {
    logger.info(
      `💻 [UIStreamingDirectorAgent] Analyzing UI Streaming Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Streaming Director Target',
      );
...
export const uIStreamingDirectorAgent = Object.freeze(
  new UIStreamingDirectorAgent(),
);
