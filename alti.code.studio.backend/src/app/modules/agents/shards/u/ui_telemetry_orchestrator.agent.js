...
class UITelemetryOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateUITelemetrySystem(objective) {
    logger.info(
      `💻 [UITelemetryOrchestratorAgent] Analyzing UI Telemetry Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Telemetry Orchestrator Target',
      );
...
export const uITelemetryOrchestratorAgent = Object.freeze(
  new UITelemetryOrchestratorAgent(),
);
