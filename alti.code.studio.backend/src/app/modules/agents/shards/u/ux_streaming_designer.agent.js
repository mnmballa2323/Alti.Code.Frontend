...
class UXStreamingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateUXStreamingSystem(objective) {
    logger.info(
      `💻 [UXStreamingDesignerAgent] Analyzing UX Streaming Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Streaming Designer Target',
      );
...
export const uXStreamingDesignerAgent = Object.freeze(
  new UXStreamingDesignerAgent(),
);
