...
class UIObservabilityDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIObservabilitySystem(objective) {
    logger.info(
      `💻 [UIObservabilityDesignerAgent] Analyzing UI Observability Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Observability Designer Target',
      );
...
export const uIObservabilityDesignerAgent = Object.freeze(
  new UIObservabilityDesignerAgent(),
);
