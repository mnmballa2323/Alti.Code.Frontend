...
class UXProvisioningAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateUXProvisioningSystem(objective) {
    logger.info(
      `💻 [UXProvisioningAuditorAgent] Analyzing UX Provisioning Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Provisioning Auditor Target',
      );
...
export const uXProvisioningAuditorAgent = Object.freeze(
  new UXProvisioningAuditorAgent(),
);
