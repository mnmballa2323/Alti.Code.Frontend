...
class UXTestingSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateUXTestingSystem(objective) {
    logger.info(
      `💻 [UXTestingSpecialistAgent] Analyzing UX Testing Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Testing Specialist Target',
      );
...
export const uXTestingSpecialistAgent = Object.freeze(
  new UXTestingSpecialistAgent(),
);
