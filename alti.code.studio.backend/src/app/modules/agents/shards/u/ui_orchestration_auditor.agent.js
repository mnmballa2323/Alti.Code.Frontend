...
class UIOrchestrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIOrchestrationSystem(objective) {
    logger.info(
      `💻 [UIOrchestrationAuditorAgent] Analyzing UI Orchestration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Orchestration Auditor Target',
      );
...
export const uIOrchestrationAuditorAgent = Object.freeze(
  new UIOrchestrationAuditorAgent(),
);
