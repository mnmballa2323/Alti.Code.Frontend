...
class UXStreamingAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateUXStreamingSystem(objective) {
        logger.info(`💻 [UXStreamingAuditorAgent] Analyzing UX Streaming Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UX Streaming Auditor Target");
...
export const uXStreamingAuditorAgent = Object.freeze(new UXStreamingAuditorAgent());
