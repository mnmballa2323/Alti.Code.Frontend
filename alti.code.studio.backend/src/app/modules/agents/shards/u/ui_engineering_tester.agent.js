...
class UIEngineeringTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateUIEngineeringSystem(objective) {
        logger.info(`💻 [UIEngineeringTesterAgent] Analyzing UI Engineering Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Engineering Tester Target");
...
export const uIEngineeringTesterAgent = Object.freeze(new UIEngineeringTesterAgent());
