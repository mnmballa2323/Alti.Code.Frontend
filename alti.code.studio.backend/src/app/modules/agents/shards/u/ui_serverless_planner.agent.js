...
class UIServerlessPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateUIServerlessSystem(objective) {
        logger.info(`💻 [UIServerlessPlannerAgent] Analyzing UI Serverless Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Serverless Planner Target");
...
export const uIServerlessPlannerAgent = Object.freeze(new UIServerlessPlannerAgent());
