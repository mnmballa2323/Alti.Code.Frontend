...
class UIServerlessDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIServerlessSystem(objective) {
    logger.info(
      `💻 [UIServerlessDirectorAgent] Analyzing UI Serverless Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Serverless Director Target',
      );
...
export const uIServerlessDirectorAgent = Object.freeze(
  new UIServerlessDirectorAgent(),
);
