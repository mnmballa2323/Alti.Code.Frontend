...
class UIObservabilityManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIObservabilitySystem(objective) {
    logger.info(
      `💻 [UIObservabilityManagerAgent] Analyzing UI Observability Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Observability Manager Target',
      );
...
export const uIObservabilityManagerAgent = Object.freeze(
  new UIObservabilityManagerAgent(),
);
