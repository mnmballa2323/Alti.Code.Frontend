...
class UIDataWarehouseDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIDataWarehouseSystem(objective) {
    logger.info(
      `💻 [UIDataWarehouseDirectorAgent] Analyzing UI DataWarehouse Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI DataWarehouse Director Target',
      );
...
export const uIDataWarehouseDirectorAgent = Object.freeze(
  new UIDataWarehouseDirectorAgent(),
);
