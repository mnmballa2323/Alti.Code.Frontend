...
class UXStreamingTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateUXStreamingSystem(objective) {
        logger.info(`💻 [UXStreamingTesterAgent] Analyzing UX Streaming Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UX Streaming Tester Target");
...
export const uXStreamingTesterAgent = Object.freeze(new UXStreamingTesterAgent());
