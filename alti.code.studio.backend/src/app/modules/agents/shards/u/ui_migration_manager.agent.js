...
class UIMigrationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIMigrationSystem(objective) {
    logger.info(
      `💻 [UIMigrationManagerAgent] Analyzing UI Migration Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Migration Manager Target',
      );
...
export const uIMigrationManagerAgent = Object.freeze(
  new UIMigrationManagerAgent(),
);
