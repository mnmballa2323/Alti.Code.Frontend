...
class UIAutomationAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateUIAutomationSystem(objective) {
        logger.info(`💻 [UIAutomationAuditorAgent] Analyzing UI Automation Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Automation Auditor Target");
...
export const uIAutomationAuditorAgent = Object.freeze(new UIAutomationAuditorAgent());
