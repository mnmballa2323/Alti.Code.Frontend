...
class UIDataLakeEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIDataLakeSystem(objective) {
    logger.info(
      `💻 [UIDataLakeEngineerAgent] Analyzing UI DataLake Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI DataLake Engineer Target',
      );
...
export const uIDataLakeEngineerAgent = Object.freeze(
  new UIDataLakeEngineerAgent(),
);
