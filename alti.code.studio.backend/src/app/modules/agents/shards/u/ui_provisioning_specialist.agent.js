...
class UIProvisioningSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateUIProvisioningSystem(objective) {
    logger.info(
      `💻 [UIProvisioningSpecialistAgent] Analyzing UI Provisioning Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Provisioning Specialist Target',
      );
...
export const uIProvisioningSpecialistAgent = Object.freeze(
  new UIProvisioningSpecialistAgent(),
);
