...
class UITestingStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateUITestingSystem(objective) {
    logger.info(
      `💻 [UITestingStrategistAgent] Analyzing UI Testing Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Testing Strategist Target',
      );
...
export const uITestingStrategistAgent = Object.freeze(
  new UITestingStrategistAgent(),
);
