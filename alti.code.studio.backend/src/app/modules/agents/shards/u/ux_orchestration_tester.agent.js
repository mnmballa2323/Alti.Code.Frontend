...
class UXOrchestrationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateUXOrchestrationSystem(objective) {
    logger.info(
      `💻 [UXOrchestrationTesterAgent] Analyzing UX Orchestration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Orchestration Tester Target',
      );
...
export const uXOrchestrationTesterAgent = Object.freeze(
  new UXOrchestrationTesterAgent(),
);
