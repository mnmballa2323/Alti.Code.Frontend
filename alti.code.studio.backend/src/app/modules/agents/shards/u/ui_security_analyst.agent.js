...
class UISecurityAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateUISecuritySystem(objective) {
        logger.info(`💻 [UISecurityAnalystAgent] Analyzing UI Security Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Security Analyst Target");
...
export const uISecurityAnalystAgent = Object.freeze(new UISecurityAnalystAgent());
