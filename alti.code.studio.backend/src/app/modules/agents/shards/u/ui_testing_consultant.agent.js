...
class UITestingConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateUITestingSystem(objective) {
    logger.info(
      `💻 [UITestingConsultantAgent] Analyzing UI Testing Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Testing Consultant Target',
      );
...
export const uITestingConsultantAgent = Object.freeze(
  new UITestingConsultantAgent(),
);
