...
class UIServerlessManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateUIServerlessSystem(objective) {
        logger.info(`💻 [UIServerlessManagerAgent] Analyzing UI Serverless Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Serverless Manager Target");
...
export const uIServerlessManagerAgent = Object.freeze(new UIServerlessManagerAgent());
