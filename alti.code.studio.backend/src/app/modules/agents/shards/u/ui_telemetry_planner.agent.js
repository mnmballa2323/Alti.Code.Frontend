...
class UITelemetryPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateUITelemetrySystem(objective) {
    logger.info(
      `💻 [UITelemetryPlannerAgent] Analyzing UI Telemetry Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Telemetry Planner Target',
      );
...
export const uITelemetryPlannerAgent = Object.freeze(
  new UITelemetryPlannerAgent(),
);
