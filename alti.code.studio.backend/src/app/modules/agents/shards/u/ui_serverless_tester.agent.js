...
class UIServerlessTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateUIServerlessSystem(objective) {
    logger.info(
      `💻 [UIServerlessTesterAgent] Analyzing UI Serverless Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Serverless Tester Target',
      );
...
export const uIServerlessTesterAgent = Object.freeze(
  new UIServerlessTesterAgent(),
);
