...
class UIGovernanceDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateUIGovernanceSystem(objective) {
    logger.info(
      `💻 [UIGovernanceDeveloperAgent] Analyzing UI Governance Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Governance Developer Target',
      );
...
export const uIGovernanceDeveloperAgent = Object.freeze(
  new UIGovernanceDeveloperAgent(),
);
