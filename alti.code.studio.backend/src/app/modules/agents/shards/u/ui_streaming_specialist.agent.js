...
class UIStreamingSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateUIStreamingSystem(objective) {
    logger.info(
      `💻 [UIStreamingSpecialistAgent] Analyzing UI Streaming Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Streaming Specialist Target',
      );
...
export const uIStreamingSpecialistAgent = Object.freeze(
  new UIStreamingSpecialistAgent(),
);
