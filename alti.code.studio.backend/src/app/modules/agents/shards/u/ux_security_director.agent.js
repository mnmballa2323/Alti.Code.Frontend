...
class UXSecurityDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUXSecuritySystem(objective) {
    logger.info(
      `💻 [UXSecurityDirectorAgent] Analyzing UX Security Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Security Director Target',
      );
...
export const uXSecurityDirectorAgent = Object.freeze(
  new UXSecurityDirectorAgent(),
);
