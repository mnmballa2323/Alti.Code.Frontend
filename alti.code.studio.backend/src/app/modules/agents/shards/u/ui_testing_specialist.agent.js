...
class UITestingSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateUITestingSystem(objective) {
        logger.info(`💻 [UITestingSpecialistAgent] Analyzing UI Testing Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Testing Specialist Target");
...
export const uITestingSpecialistAgent = Object.freeze(new UITestingSpecialistAgent());
