...
class UIIntegrationConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateUIIntegrationSystem(objective) {
        logger.info(`💻 [UIIntegrationConsultantAgent] Analyzing UI Integration Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Integration Consultant Target");
...
export const uIIntegrationConsultantAgent = Object.freeze(new UIIntegrationConsultantAgent());
