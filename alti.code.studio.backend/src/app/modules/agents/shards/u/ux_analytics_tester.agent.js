...
class UXAnalyticsTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateUXAnalyticsSystem(objective) {
    logger.info(
      `💻 [UXAnalyticsTesterAgent] Analyzing UX Analytics Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Analytics Tester Target',
      );
...
export const uXAnalyticsTesterAgent = Object.freeze(
  new UXAnalyticsTesterAgent(),
);
