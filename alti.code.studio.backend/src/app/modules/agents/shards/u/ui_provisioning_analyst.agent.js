...
class UIProvisioningAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateUIProvisioningSystem(objective) {
    logger.info(
      `💻 [UIProvisioningAnalystAgent] Analyzing UI Provisioning Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Provisioning Analyst Target',
      );
...
export const uIProvisioningAnalystAgent = Object.freeze(
  new UIProvisioningAnalystAgent(),
);
