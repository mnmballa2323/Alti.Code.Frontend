...
class UIStreamingStrategistAgent extends GeminiCliBaseAgent {
  ...
  async generateUIStreamingSystem(objective) {
    logger.info(
      `💻 [UIStreamingStrategistAgent] Analyzing UI Streaming Strategist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Streaming Strategist Target',
      );
...
export const uIStreamingStrategistAgent = Object.freeze(
  new UIStreamingStrategistAgent(),
);
