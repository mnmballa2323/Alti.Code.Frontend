...
class UIDataLakeOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIDataLakeSystem(objective) {
    logger.info(
      `💻 [UIDataLakeOrchestratorAgent] Analyzing UI DataLake Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI DataLake Orchestrator Target',
      );
...
export const uIDataLakeOrchestratorAgent = Object.freeze(
  new UIDataLakeOrchestratorAgent(),
);
