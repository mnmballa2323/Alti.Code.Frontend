...
class UIEngineeringManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIEngineeringSystem(objective) {
    logger.info(
      `💻 [UIEngineeringManagerAgent] Analyzing UI Engineering Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Engineering Manager Target',
      );
...
export const uIEngineeringManagerAgent = Object.freeze(
  new UIEngineeringManagerAgent(),
);
