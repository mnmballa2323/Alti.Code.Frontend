...
class UIResilienceDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIResilienceSystem(objective) {
    logger.info(
      `💻 [UIResilienceDirectorAgent] Analyzing UI Resilience Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Resilience Director Target',
      );
...
export const uIResilienceDirectorAgent = Object.freeze(
  new UIResilienceDirectorAgent(),
);
