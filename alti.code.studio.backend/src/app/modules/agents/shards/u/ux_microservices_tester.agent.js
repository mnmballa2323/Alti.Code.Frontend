...
class UXMicroservicesTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateUXMicroservicesSystem(objective) {
    logger.info(
      `💻 [UXMicroservicesTesterAgent] Analyzing UX Microservices Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Microservices Tester Target',
      );
...
export const uXMicroservicesTesterAgent = Object.freeze(
  new UXMicroservicesTesterAgent(),
);
