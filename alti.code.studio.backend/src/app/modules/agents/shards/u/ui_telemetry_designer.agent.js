...
class UITelemetryDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateUITelemetrySystem(objective) {
        logger.info(`💻 [UITelemetryDesignerAgent] Analyzing UI Telemetry Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Telemetry Designer Target");
...
export const uITelemetryDesignerAgent = Object.freeze(new UITelemetryDesignerAgent());
