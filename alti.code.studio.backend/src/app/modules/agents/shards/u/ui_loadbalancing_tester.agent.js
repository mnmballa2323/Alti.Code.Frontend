...
class UILoadBalancingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateUILoadBalancingSystem(objective) {
    logger.info(
      `💻 [UILoadBalancingTesterAgent] Analyzing UI LoadBalancing Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI LoadBalancing Tester Target',
      );
...
export const uILoadBalancingTesterAgent = Object.freeze(
  new UILoadBalancingTesterAgent(),
);
