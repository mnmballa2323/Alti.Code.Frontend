...
class UXSecurityManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateUXSecuritySystem(objective) {
    logger.info(
      `💻 [UXSecurityManagerAgent] Analyzing UX Security Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Security Manager Target',
      );
...
export const uXSecurityManagerAgent = Object.freeze(
  new UXSecurityManagerAgent(),
);
