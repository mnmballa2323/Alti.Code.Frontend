...
class UIServerlessAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateUIServerlessSystem(objective) {
        logger.info(`💻 [UIServerlessAuditorAgent] Analyzing UI Serverless Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Serverless Auditor Target");
...
export const uIServerlessAuditorAgent = Object.freeze(new UIServerlessAuditorAgent());
