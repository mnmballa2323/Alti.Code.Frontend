...
class UIOptimizationTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateUIOptimizationSystem(objective) {
        logger.info(`💻 [UIOptimizationTesterAgent] Analyzing UI Optimization Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Optimization Tester Target");
...
export const uIOptimizationTesterAgent = Object.freeze(new UIOptimizationTesterAgent());
