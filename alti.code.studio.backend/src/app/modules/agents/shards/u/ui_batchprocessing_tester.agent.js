...
class UIBatchProcessingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateUIBatchProcessingSystem(objective) {
    logger.info(
      `💻 [UIBatchProcessingTesterAgent] Analyzing UI BatchProcessing Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI BatchProcessing Tester Target',
      );
...
export const uIBatchProcessingTesterAgent = Object.freeze(
  new UIBatchProcessingTesterAgent(),
);
