...
class UIMicroservicesTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateUIMicroservicesSystem(objective) {
    logger.info(
      `💻 [UIMicroservicesTesterAgent] Analyzing UI Microservices Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Microservices Tester Target',
      );
...
export const uIMicroservicesTesterAgent = Object.freeze(
  new UIMicroservicesTesterAgent(),
);
