...
class UIAutomationSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateUIAutomationSystem(objective) {
    logger.info(
      `💻 [UIAutomationSpecialistAgent] Analyzing UI Automation Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Automation Specialist Target',
      );
...
export const uIAutomationSpecialistAgent = Object.freeze(
  new UIAutomationSpecialistAgent(),
);
