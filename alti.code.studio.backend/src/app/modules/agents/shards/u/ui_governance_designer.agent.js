...
class UIGovernanceDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIGovernanceSystem(objective) {
    logger.info(
      `💻 [UIGovernanceDesignerAgent] Analyzing UI Governance Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Governance Designer Target',
      );
...
export const uIGovernanceDesignerAgent = Object.freeze(
  new UIGovernanceDesignerAgent(),
);
