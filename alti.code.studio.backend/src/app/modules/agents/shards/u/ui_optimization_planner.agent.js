...
class UIOptimizationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIOptimizationSystem(objective) {
    logger.info(
      `💻 [UIOptimizationPlannerAgent] Analyzing UI Optimization Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Optimization Planner Target',
      );
...
export const uIOptimizationPlannerAgent = Object.freeze(
  new UIOptimizationPlannerAgent(),
);
