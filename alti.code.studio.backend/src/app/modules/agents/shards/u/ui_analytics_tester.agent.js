...
class UIAnalyticsTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateUIAnalyticsSystem(objective) {
    logger.info(
      `💻 [UIAnalyticsTesterAgent] Analyzing UI Analytics Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Analytics Tester Target',
      );
...
export const uIAnalyticsTesterAgent = Object.freeze(
  new UIAnalyticsTesterAgent(),
);
