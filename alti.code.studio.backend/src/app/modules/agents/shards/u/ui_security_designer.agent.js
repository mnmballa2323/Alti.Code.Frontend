...
class UISecurityDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateUISecuritySystem(objective) {
    logger.info(
      `💻 [UISecurityDesignerAgent] Analyzing UI Security Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Security Designer Target',
      );
...
export const uISecurityDesignerAgent = Object.freeze(
  new UISecurityDesignerAgent(),
);
