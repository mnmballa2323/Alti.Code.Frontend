...
class UIDataWarehouseDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateUIDataWarehouseSystem(objective) {
    logger.info(
      `💻 [UIDataWarehouseDeveloperAgent] Analyzing UI DataWarehouse Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI DataWarehouse Developer Target',
      );
...
export const uIDataWarehouseDeveloperAgent = Object.freeze(
  new UIDataWarehouseDeveloperAgent(),
);
