...
class UITelemetryDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateUITelemetrySystem(objective) {
        logger.info(`💻 [UITelemetryDeveloperAgent] Analyzing UI Telemetry Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Telemetry Developer Target");
...
export const uITelemetryDeveloperAgent = Object.freeze(new UITelemetryDeveloperAgent());
