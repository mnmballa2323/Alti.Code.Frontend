...
class UIDataLakeDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIDataLakeSystem(objective) {
    logger.info(
      `💻 [UIDataLakeDirectorAgent] Analyzing UI DataLake Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI DataLake Director Target',
      );
...
export const uIDataLakeDirectorAgent = Object.freeze(
  new UIDataLakeDirectorAgent(),
);
