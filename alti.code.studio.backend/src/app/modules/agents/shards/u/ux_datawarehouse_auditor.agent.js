...
class UXDataWarehouseAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateUXDataWarehouseSystem(objective) {
    logger.info(
      `💻 [UXDataWarehouseAuditorAgent] Analyzing UX DataWarehouse Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX DataWarehouse Auditor Target',
      );
...
export const uXDataWarehouseAuditorAgent = Object.freeze(
  new UXDataWarehouseAuditorAgent(),
);
