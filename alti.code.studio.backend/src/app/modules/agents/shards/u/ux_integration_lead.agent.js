...
class UXIntegrationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateUXIntegrationSystem(objective) {
    logger.info(
      `💻 [UXIntegrationLeadAgent] Analyzing UX Integration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Integration Lead Target',
      );
...
export const uXIntegrationLeadAgent = Object.freeze(
  new UXIntegrationLeadAgent(),
);
