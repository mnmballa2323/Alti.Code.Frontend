...
class UIServerlessDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateUIServerlessSystem(objective) {
        logger.info(`💻 [UIServerlessDesignerAgent] Analyzing UI Serverless Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Serverless Designer Target");
...
export const uIServerlessDesignerAgent = Object.freeze(new UIServerlessDesignerAgent());
