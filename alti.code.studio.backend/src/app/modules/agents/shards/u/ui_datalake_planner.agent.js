...
class UIDataLakePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIDataLakeSystem(objective) {
    logger.info(
      `💻 [UIDataLakePlannerAgent] Analyzing UI DataLake Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI DataLake Planner Target',
      );
...
export const uIDataLakePlannerAgent = Object.freeze(
  new UIDataLakePlannerAgent(),
);
