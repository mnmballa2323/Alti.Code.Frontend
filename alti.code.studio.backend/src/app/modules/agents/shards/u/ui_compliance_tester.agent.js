...
class UIComplianceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateUIComplianceSystem(objective) {
    logger.info(
      `💻 [UIComplianceTesterAgent] Analyzing UI Compliance Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Compliance Tester Target',
      );
...
export const uIComplianceTesterAgent = Object.freeze(
  new UIComplianceTesterAgent(),
);
