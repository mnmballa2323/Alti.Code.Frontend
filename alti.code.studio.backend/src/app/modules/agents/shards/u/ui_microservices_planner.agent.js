...
class UIMicroservicesPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateUIMicroservicesSystem(objective) {
    logger.info(
      `💻 [UIMicroservicesPlannerAgent] Analyzing UI Microservices Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Microservices Planner Target',
      );
...
export const uIMicroservicesPlannerAgent = Object.freeze(
  new UIMicroservicesPlannerAgent(),
);
