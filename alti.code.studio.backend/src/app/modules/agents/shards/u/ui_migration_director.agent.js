...
class UIMigrationDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIMigrationSystem(objective) {
    logger.info(
      `💻 [UIMigrationDirectorAgent] Analyzing UI Migration Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Migration Director Target',
      );
...
export const uIMigrationDirectorAgent = Object.freeze(
  new UIMigrationDirectorAgent(),
);
