...
class UXStreamingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUXStreamingSystem(objective) {
    logger.info(
      `💻 [UXStreamingDirectorAgent] Analyzing UX Streaming Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Streaming Director Target',
      );
...
export const uXStreamingDirectorAgent = Object.freeze(
  new UXStreamingDirectorAgent(),
);
