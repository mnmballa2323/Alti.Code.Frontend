...
class UITelemetryEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateUITelemetrySystem(objective) {
        logger.info(`💻 [UITelemetryEngineerAgent] Analyzing UI Telemetry Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Telemetry Engineer Target");
...
export const uITelemetryEngineerAgent = Object.freeze(new UITelemetryEngineerAgent());
