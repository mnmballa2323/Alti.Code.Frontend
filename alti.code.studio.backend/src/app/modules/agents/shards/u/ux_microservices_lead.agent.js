...
class UXMicroservicesLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateUXMicroservicesSystem(objective) {
    logger.info(
      `💻 [UXMicroservicesLeadAgent] Analyzing UX Microservices Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Microservices Lead Target',
      );
...
export const uXMicroservicesLeadAgent = Object.freeze(
  new UXMicroservicesLeadAgent(),
);
