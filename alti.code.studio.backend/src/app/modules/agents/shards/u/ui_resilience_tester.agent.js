...
class UIResilienceTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateUIResilienceSystem(objective) {
        logger.info(`💻 [UIResilienceTesterAgent] Analyzing UI Resilience Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Resilience Tester Target");
...
export const uIResilienceTesterAgent = Object.freeze(new UIResilienceTesterAgent());
