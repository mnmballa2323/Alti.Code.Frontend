...
class UIGovernanceSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateUIGovernanceSystem(objective) {
    logger.info(
      `💻 [UIGovernanceSpecialistAgent] Analyzing UI Governance Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Governance Specialist Target',
      );
...
export const uIGovernanceSpecialistAgent = Object.freeze(
  new UIGovernanceSpecialistAgent(),
);
