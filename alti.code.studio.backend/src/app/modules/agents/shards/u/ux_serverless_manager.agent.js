...
class UXServerlessManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateUXServerlessSystem(objective) {
        logger.info(`💻 [UXServerlessManagerAgent] Analyzing UX Serverless Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UX Serverless Manager Target");
...
export const uXServerlessManagerAgent = Object.freeze(new UXServerlessManagerAgent());
