...
class UICompliancePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateUIComplianceSystem(objective) {
        logger.info(`💻 [UICompliancePlannerAgent] Analyzing UI Compliance Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UI Compliance Planner Target");
...
export const uICompliancePlannerAgent = Object.freeze(new UICompliancePlannerAgent());
