...
class UXDataWarehouseManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateUXDataWarehouseSystem(objective) {
    logger.info(
      `💻 [UXDataWarehouseManagerAgent] Analyzing UX DataWarehouse Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX DataWarehouse Manager Target',
      );
...
export const uXDataWarehouseManagerAgent = Object.freeze(
  new UXDataWarehouseManagerAgent(),
);
