...
class UICachingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateUICachingSystem(objective) {
    logger.info(
      `💻 [UICachingDesignerAgent] Analyzing UI Caching Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Caching Designer Target',
      );
...
export const uICachingDesignerAgent = Object.freeze(
  new UICachingDesignerAgent(),
);
