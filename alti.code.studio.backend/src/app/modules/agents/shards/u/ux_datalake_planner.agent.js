...
class UXDataLakePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateUXDataLakeSystem(objective) {
    logger.info(
      `💻 [UXDataLakePlannerAgent] Analyzing UX DataLake Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX DataLake Planner Target',
      );
...
export const uXDataLakePlannerAgent = Object.freeze(
  new UXDataLakePlannerAgent(),
);
