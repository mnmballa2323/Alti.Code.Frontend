...
class UIEngineeringDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateUIEngineeringSystem(objective) {
    logger.info(
      `💻 [UIEngineeringDirectorAgent] Analyzing UI Engineering Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UI Engineering Director Target',
      );
...
export const uIEngineeringDirectorAgent = Object.freeze(
  new UIEngineeringDirectorAgent(),
);
