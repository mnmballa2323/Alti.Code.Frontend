...
class UXSecurityAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateUXSecuritySystem(objective) {
    logger.info(
      `💻 [UXSecurityAuditorAgent] Analyzing UX Security Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Security Auditor Target',
      );
...
export const uXSecurityAuditorAgent = Object.freeze(
  new UXSecurityAuditorAgent(),
);
