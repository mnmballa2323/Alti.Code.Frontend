...
class UXOrchestrationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateUXOrchestrationSystem(objective) {
    logger.info(
      `💻 [UXOrchestrationPlannerAgent] Analyzing UX Orchestration Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - UX Orchestration Planner Target',
      );
...
export const uXOrchestrationPlannerAgent = Object.freeze(
  new UXOrchestrationPlannerAgent(),
);
