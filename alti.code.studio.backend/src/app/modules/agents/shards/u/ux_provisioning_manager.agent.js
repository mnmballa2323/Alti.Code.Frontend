...
class UXProvisioningManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateUXProvisioningSystem(objective) {
        logger.info(`💻 [UXProvisioningManagerAgent] Analyzing UX Provisioning Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - UX Provisioning Manager Target");
...
export const uXProvisioningManagerAgent = Object.freeze(new UXProvisioningManagerAgent());
