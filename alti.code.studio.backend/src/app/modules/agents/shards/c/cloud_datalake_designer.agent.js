...
class CloudDataLakeDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudDataLakeSystem(objective) {
    logger.info(
      `💻 [CloudDataLakeDesignerAgent] Analyzing Cloud DataLake Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud DataLake Designer Target',
      );
...
export const cloudDataLakeDesignerAgent = Object.freeze(
  new CloudDataLakeDesignerAgent(),
);
