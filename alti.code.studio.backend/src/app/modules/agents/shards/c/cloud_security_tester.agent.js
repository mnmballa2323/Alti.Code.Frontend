...
class CloudSecurityTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudSecuritySystem(objective) {
        logger.info(`💻 [CloudSecurityTesterAgent] Analyzing Cloud Security Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Security Tester Target");
...
export const cloudSecurityTesterAgent = Object.freeze(new CloudSecurityTesterAgent());
