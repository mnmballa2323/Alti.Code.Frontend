...
class CloudResilienceDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudResilienceSystem(objective) {
        logger.info(`💻 [CloudResilienceDeveloperAgent] Analyzing Cloud Resilience Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Resilience Developer Target");
...
export const cloudResilienceDeveloperAgent = Object.freeze(new CloudResilienceDeveloperAgent());
