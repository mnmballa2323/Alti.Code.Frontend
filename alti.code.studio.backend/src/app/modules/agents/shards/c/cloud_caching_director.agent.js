...
class CloudCachingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudCachingSystem(objective) {
    logger.info(
      `💻 [CloudCachingDirectorAgent] Analyzing Cloud Caching Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Caching Director Target',
      );
...
export const cloudCachingDirectorAgent = Object.freeze(
  new CloudCachingDirectorAgent(),
);
