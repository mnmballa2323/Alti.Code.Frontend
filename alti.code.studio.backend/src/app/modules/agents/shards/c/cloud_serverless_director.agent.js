...
class CloudServerlessDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudServerlessSystem(objective) {
    logger.info(
      `💻 [CloudServerlessDirectorAgent] Analyzing Cloud Serverless Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Serverless Director Target',
      );
...
export const cloudServerlessDirectorAgent = Object.freeze(
  new CloudServerlessDirectorAgent(),
);
