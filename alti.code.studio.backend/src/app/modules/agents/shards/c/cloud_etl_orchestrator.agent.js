...
class CloudETLOrchestratorAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudETLSystem(objective) {
        logger.info(`💻 [CloudETLOrchestratorAgent] Analyzing Cloud ETL Orchestrator specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud ETL Orchestrator Target");
...
export const cloudETLOrchestratorAgent = Object.freeze(new CloudETLOrchestratorAgent());
