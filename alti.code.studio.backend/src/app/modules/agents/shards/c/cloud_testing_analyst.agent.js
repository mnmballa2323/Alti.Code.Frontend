...
class CloudTestingAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudTestingSystem(objective) {
    logger.info(
      `💻 [CloudTestingAnalystAgent] Analyzing Cloud Testing Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Testing Analyst Target',
      );
...
export const cloudTestingAnalystAgent = Object.freeze(
  new CloudTestingAnalystAgent(),
);
