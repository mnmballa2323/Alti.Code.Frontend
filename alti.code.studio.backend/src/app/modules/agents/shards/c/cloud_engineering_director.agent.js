...
class CloudEngineeringDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudEngineeringSystem(objective) {
        logger.info(`💻 [CloudEngineeringDirectorAgent] Analyzing Cloud Engineering Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Engineering Director Target");
...
export const cloudEngineeringDirectorAgent = Object.freeze(new CloudEngineeringDirectorAgent());
