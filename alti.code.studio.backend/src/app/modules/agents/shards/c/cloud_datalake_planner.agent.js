...
class CloudDataLakePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudDataLakeSystem(objective) {
    logger.info(
      `💻 [CloudDataLakePlannerAgent] Analyzing Cloud DataLake Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud DataLake Planner Target',
      );
...
export const cloudDataLakePlannerAgent = Object.freeze(
  new CloudDataLakePlannerAgent(),
);
