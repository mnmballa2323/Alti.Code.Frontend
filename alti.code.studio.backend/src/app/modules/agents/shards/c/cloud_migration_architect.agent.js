...
class CloudMigrationArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudMigrationSystem(objective) {
    logger.info(
      `💻 [CloudMigrationArchitectAgent] Analyzing Cloud Migration Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Migration Architect Target',
      );
...
export const cloudMigrationArchitectAgent = Object.freeze(
  new CloudMigrationArchitectAgent(),
);
