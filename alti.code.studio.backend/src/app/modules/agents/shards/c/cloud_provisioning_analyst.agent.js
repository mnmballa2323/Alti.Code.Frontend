...
class CloudProvisioningAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudProvisioningSystem(objective) {
    logger.info(
      `💻 [CloudProvisioningAnalystAgent] Analyzing Cloud Provisioning Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Provisioning Analyst Target',
      );
...
export const cloudProvisioningAnalystAgent = Object.freeze(
  new CloudProvisioningAnalystAgent(),
);
