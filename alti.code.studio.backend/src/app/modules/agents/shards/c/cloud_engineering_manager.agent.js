...
class CloudEngineeringManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudEngineeringSystem(objective) {
    logger.info(
      `💻 [CloudEngineeringManagerAgent] Analyzing Cloud Engineering Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Engineering Manager Target',
      );
...
export const cloudEngineeringManagerAgent = Object.freeze(
  new CloudEngineeringManagerAgent(),
);
