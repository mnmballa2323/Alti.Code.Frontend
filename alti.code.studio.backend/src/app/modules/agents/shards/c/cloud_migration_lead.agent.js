...
class CloudMigrationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudMigrationSystem(objective) {
        logger.info(`💻 [CloudMigrationLeadAgent] Analyzing Cloud Migration Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Migration Lead Target");
...
export const cloudMigrationLeadAgent = Object.freeze(new CloudMigrationLeadAgent());
