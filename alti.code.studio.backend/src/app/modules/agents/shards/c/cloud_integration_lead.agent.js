...
class CloudIntegrationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudIntegrationSystem(objective) {
    logger.info(
      `💻 [CloudIntegrationLeadAgent] Analyzing Cloud Integration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Integration Lead Target',
      );
...
export const cloudIntegrationLeadAgent = Object.freeze(
  new CloudIntegrationLeadAgent(),
);
