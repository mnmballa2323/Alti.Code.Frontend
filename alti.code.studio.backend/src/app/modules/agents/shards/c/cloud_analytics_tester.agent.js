...
class CloudAnalyticsTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudAnalyticsSystem(objective) {
    logger.info(
      `💻 [CloudAnalyticsTesterAgent] Analyzing Cloud Analytics Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Analytics Tester Target',
      );
...
export const cloudAnalyticsTesterAgent = Object.freeze(
  new CloudAnalyticsTesterAgent(),
);
