...
class CloudDataLakeAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudDataLakeSystem(objective) {
        logger.info(`💻 [CloudDataLakeAnalystAgent] Analyzing Cloud DataLake Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud DataLake Analyst Target");
...
export const cloudDataLakeAnalystAgent = Object.freeze(new CloudDataLakeAnalystAgent());
