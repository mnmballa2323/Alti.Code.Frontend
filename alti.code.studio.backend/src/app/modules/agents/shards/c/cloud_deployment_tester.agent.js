...
class CloudDeploymentTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudDeploymentSystem(objective) {
    logger.info(
      `💻 [CloudDeploymentTesterAgent] Analyzing Cloud Deployment Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Deployment Tester Target',
      );
...
export const cloudDeploymentTesterAgent = Object.freeze(
  new CloudDeploymentTesterAgent(),
);
