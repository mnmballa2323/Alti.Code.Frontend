...
class CloudAutomationManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudAutomationSystem(objective) {
        logger.info(`💻 [CloudAutomationManagerAgent] Analyzing Cloud Automation Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Automation Manager Target");
...
export const cloudAutomationManagerAgent = Object.freeze(new CloudAutomationManagerAgent());
