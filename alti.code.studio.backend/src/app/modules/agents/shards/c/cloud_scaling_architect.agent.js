...
class CloudScalingArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudScalingSystem(objective) {
    logger.info(
      `💻 [CloudScalingArchitectAgent] Analyzing Cloud Scaling Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Scaling Architect Target',
      );
...
export const cloudScalingArchitectAgent = Object.freeze(
  new CloudScalingArchitectAgent(),
);
