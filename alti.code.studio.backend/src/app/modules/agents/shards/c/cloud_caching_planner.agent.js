...
class CloudCachingPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudCachingSystem(objective) {
    logger.info(
      `💻 [CloudCachingPlannerAgent] Analyzing Cloud Caching Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Caching Planner Target',
      );
...
export const cloudCachingPlannerAgent = Object.freeze(
  new CloudCachingPlannerAgent(),
);
