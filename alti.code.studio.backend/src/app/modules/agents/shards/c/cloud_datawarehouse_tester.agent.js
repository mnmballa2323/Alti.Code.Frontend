...
class CloudDataWarehouseTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudDataWarehouseSystem(objective) {
    logger.info(
      `💻 [CloudDataWarehouseTesterAgent] Analyzing Cloud DataWarehouse Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud DataWarehouse Tester Target',
      );
...
export const cloudDataWarehouseTesterAgent = Object.freeze(
  new CloudDataWarehouseTesterAgent(),
);
