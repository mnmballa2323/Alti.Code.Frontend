...
class CloudProvisioningTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudProvisioningSystem(objective) {
        logger.info(`💻 [CloudProvisioningTesterAgent] Analyzing Cloud Provisioning Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Provisioning Tester Target");
...
export const cloudProvisioningTesterAgent = Object.freeze(new CloudProvisioningTesterAgent());
