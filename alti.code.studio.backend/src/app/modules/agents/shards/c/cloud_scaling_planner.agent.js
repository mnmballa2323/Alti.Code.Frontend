...
class CloudScalingPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudScalingSystem(objective) {
    logger.info(
      `💻 [CloudScalingPlannerAgent] Analyzing Cloud Scaling Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Scaling Planner Target',
      );
...
export const cloudScalingPlannerAgent = Object.freeze(
  new CloudScalingPlannerAgent(),
);
