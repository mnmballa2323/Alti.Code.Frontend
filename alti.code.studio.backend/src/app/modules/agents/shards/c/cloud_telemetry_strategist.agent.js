...
class CloudTelemetryStrategistAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudTelemetrySystem(objective) {
        logger.info(`💻 [CloudTelemetryStrategistAgent] Analyzing Cloud Telemetry Strategist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Telemetry Strategist Target");
...
export const cloudTelemetryStrategistAgent = Object.freeze(new CloudTelemetryStrategistAgent());
