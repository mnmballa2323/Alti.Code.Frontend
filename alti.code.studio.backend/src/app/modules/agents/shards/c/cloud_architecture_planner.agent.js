...
class CloudArchitecturePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudArchitectureSystem(objective) {
    logger.info(
      `💻 [CloudArchitecturePlannerAgent] Analyzing Cloud Architecture Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Architecture Planner Target',
      );
...
export const cloudArchitecturePlannerAgent = Object.freeze(
  new CloudArchitecturePlannerAgent(),
);
