...
class CloudAnalyticsDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudAnalyticsSystem(objective) {
    logger.info(
      `💻 [CloudAnalyticsDeveloperAgent] Analyzing Cloud Analytics Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Analytics Developer Target',
      );
...
export const cloudAnalyticsDeveloperAgent = Object.freeze(
  new CloudAnalyticsDeveloperAgent(),
);
