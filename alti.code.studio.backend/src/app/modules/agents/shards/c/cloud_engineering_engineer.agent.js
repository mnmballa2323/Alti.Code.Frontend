...
class CloudEngineeringEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudEngineeringSystem(objective) {
    logger.info(
      `💻 [CloudEngineeringEngineerAgent] Analyzing Cloud Engineering Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Engineering Engineer Target',
      );
...
export const cloudEngineeringEngineerAgent = Object.freeze(
  new CloudEngineeringEngineerAgent(),
);
