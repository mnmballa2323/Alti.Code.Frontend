...
class CloudTestingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudTestingSystem(objective) {
    logger.info(
      `💻 [CloudTestingManagerAgent] Analyzing Cloud Testing Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Testing Manager Target',
      );
...
export const cloudTestingManagerAgent = Object.freeze(
  new CloudTestingManagerAgent(),
);
