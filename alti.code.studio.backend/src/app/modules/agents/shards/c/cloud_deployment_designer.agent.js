...
class CloudDeploymentDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudDeploymentSystem(objective) {
    logger.info(
      `💻 [CloudDeploymentDesignerAgent] Analyzing Cloud Deployment Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Deployment Designer Target',
      );
...
export const cloudDeploymentDesignerAgent = Object.freeze(
  new CloudDeploymentDesignerAgent(),
);
