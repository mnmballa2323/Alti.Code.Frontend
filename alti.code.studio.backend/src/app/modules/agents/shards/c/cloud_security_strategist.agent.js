...
class CloudSecurityStrategistAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudSecuritySystem(objective) {
        logger.info(`💻 [CloudSecurityStrategistAgent] Analyzing Cloud Security Strategist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Security Strategist Target");
...
export const cloudSecurityStrategistAgent = Object.freeze(new CloudSecurityStrategistAgent());
