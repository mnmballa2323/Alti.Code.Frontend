...
class CloudScalingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudScalingSystem(objective) {
    logger.info(
      `💻 [CloudScalingManagerAgent] Analyzing Cloud Scaling Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Scaling Manager Target',
      );
...
export const cloudScalingManagerAgent = Object.freeze(
  new CloudScalingManagerAgent(),
);
