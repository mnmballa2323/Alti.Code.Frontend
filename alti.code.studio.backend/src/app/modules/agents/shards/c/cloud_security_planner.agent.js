...
class CloudSecurityPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudSecuritySystem(objective) {
    logger.info(
      `💻 [CloudSecurityPlannerAgent] Analyzing Cloud Security Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Security Planner Target',
      );
...
export const cloudSecurityPlannerAgent = Object.freeze(
  new CloudSecurityPlannerAgent(),
);
