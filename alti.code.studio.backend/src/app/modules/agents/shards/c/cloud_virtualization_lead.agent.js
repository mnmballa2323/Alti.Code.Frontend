...
class CloudVirtualizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudVirtualizationSystem(objective) {
    logger.info(
      `💻 [CloudVirtualizationLeadAgent] Analyzing Cloud Virtualization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Virtualization Lead Target',
      );
...
export const cloudVirtualizationLeadAgent = Object.freeze(
  new CloudVirtualizationLeadAgent(),
);
