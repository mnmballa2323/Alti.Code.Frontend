...
class CloudAutomationEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudAutomationSystem(objective) {
    logger.info(
      `💻 [CloudAutomationEngineerAgent] Analyzing Cloud Automation Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Automation Engineer Target',
      );
...
export const cloudAutomationEngineerAgent = Object.freeze(
  new CloudAutomationEngineerAgent(),
);
