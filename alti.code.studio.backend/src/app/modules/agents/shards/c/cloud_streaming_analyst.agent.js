...
class CloudStreamingAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudStreamingSystem(objective) {
    logger.info(
      `💻 [CloudStreamingAnalystAgent] Analyzing Cloud Streaming Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Streaming Analyst Target',
      );
...
export const cloudStreamingAnalystAgent = Object.freeze(
  new CloudStreamingAnalystAgent(),
);
