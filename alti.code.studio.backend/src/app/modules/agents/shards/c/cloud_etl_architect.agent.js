...
class CloudETLArchitectAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudETLSystem(objective) {
        logger.info(`💻 [CloudETLArchitectAgent] Analyzing Cloud ETL Architect specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud ETL Architect Target");
...
export const cloudETLArchitectAgent = Object.freeze(new CloudETLArchitectAgent());
