...
class CloudTelemetryManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudTelemetrySystem(objective) {
        logger.info(`💻 [CloudTelemetryManagerAgent] Analyzing Cloud Telemetry Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Telemetry Manager Target");
...
export const cloudTelemetryManagerAgent = Object.freeze(new CloudTelemetryManagerAgent());
