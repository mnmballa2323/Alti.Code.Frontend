...
class CloudDataLakeEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudDataLakeSystem(objective) {
    logger.info(
      `💻 [CloudDataLakeEngineerAgent] Analyzing Cloud DataLake Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud DataLake Engineer Target',
      );
...
export const cloudDataLakeEngineerAgent = Object.freeze(
  new CloudDataLakeEngineerAgent(),
);
