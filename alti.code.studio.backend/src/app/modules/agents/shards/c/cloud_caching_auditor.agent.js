...
class CloudCachingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudCachingSystem(objective) {
    logger.info(
      `💻 [CloudCachingAuditorAgent] Analyzing Cloud Caching Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Caching Auditor Target',
      );
...
export const cloudCachingAuditorAgent = Object.freeze(
  new CloudCachingAuditorAgent(),
);
