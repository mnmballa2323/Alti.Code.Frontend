...
class CloudStreamingDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudStreamingSystem(objective) {
        logger.info(`💻 [CloudStreamingDirectorAgent] Analyzing Cloud Streaming Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Streaming Director Target");
...
export const cloudStreamingDirectorAgent = Object.freeze(new CloudStreamingDirectorAgent());
