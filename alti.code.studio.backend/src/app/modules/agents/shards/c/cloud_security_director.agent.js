...
class CloudSecurityDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudSecuritySystem(objective) {
        logger.info(`💻 [CloudSecurityDirectorAgent] Analyzing Cloud Security Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Security Director Target");
...
export const cloudSecurityDirectorAgent = Object.freeze(new CloudSecurityDirectorAgent());
