...
class CiPipelineOptimizerAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'CI/CD Workflow & Build Pipeline Optimizer Specialist — Reviews GitHub Actions YAMLs, Drone configurations, Dockerfile caching structures, and dependency package caches (npm/pnpm/yarn) to trim build times, optimize parallel tasks, and auto-heal compilation errors.';
    this.capabilities = [
      'cicd-optimization',
      'docker-caching',
      'pipeline-profiling',
