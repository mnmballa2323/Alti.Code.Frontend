...
class CloudETLDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudETLSystem(objective) {
    logger.info(
      `💻 [CloudETLDeveloperAgent] Analyzing Cloud ETL Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud ETL Developer Target',
      );
...
export const cloudETLDeveloperAgent = Object.freeze(
  new CloudETLDeveloperAgent(),
);
