...
class CloudOrchestrationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudOrchestrationSystem(objective) {
    logger.info(
      `💻 [CloudOrchestrationLeadAgent] Analyzing Cloud Orchestration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Orchestration Lead Target',
      );
...
export const cloudOrchestrationLeadAgent = Object.freeze(
  new CloudOrchestrationLeadAgent(),
);
