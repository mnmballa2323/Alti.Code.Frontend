...
class CloudMicroservicesTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudMicroservicesSystem(objective) {
        logger.info(`💻 [CloudMicroservicesTesterAgent] Analyzing Cloud Microservices Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Microservices Tester Target");
...
export const cloudMicroservicesTesterAgent = Object.freeze(new CloudMicroservicesTesterAgent());
