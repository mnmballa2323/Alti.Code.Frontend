...
class CloudMigrationDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudMigrationSystem(objective) {
    logger.info(
      `💻 [CloudMigrationDesignerAgent] Analyzing Cloud Migration Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Migration Designer Target',
      );
...
export const cloudMigrationDesignerAgent = Object.freeze(
  new CloudMigrationDesignerAgent(),
);
