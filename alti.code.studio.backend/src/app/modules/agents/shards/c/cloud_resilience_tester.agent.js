...
class CloudResilienceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudResilienceSystem(objective) {
    logger.info(
      `💻 [CloudResilienceTesterAgent] Analyzing Cloud Resilience Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Resilience Tester Target',
      );
...
export const cloudResilienceTesterAgent = Object.freeze(
  new CloudResilienceTesterAgent(),
);
