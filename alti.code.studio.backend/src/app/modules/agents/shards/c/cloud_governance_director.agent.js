...
class CloudGovernanceDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudGovernanceSystem(objective) {
    logger.info(
      `💻 [CloudGovernanceDirectorAgent] Analyzing Cloud Governance Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Governance Director Target',
      );
...
export const cloudGovernanceDirectorAgent = Object.freeze(
  new CloudGovernanceDirectorAgent(),
);
