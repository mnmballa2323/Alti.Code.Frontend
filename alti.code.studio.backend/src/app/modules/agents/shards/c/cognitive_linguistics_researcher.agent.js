...
class CognitiveLinguisticsResearcherAgent extends GeminiCliBaseAgent {
    ...
    async generateLinguisticsSystem(objective) {
        logger.info(`🗣️ [CognitiveLinguisticsResearcher] Analyzing semantic trees and syntax architectures...`);
        ...
        try {
            ...
            logger.error(`❌ [CognitiveLinguisticsResearcher] Failed: ${err.message}`);
            throw err;
        }
    }
}
export const cognitiveLinguisticsResearcherAgent = Object.freeze(new CognitiveLinguisticsResearcherAgent());
