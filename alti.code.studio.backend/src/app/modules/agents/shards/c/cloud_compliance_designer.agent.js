...
class CloudComplianceDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudComplianceSystem(objective) {
    logger.info(
      `💻 [CloudComplianceDesignerAgent] Analyzing Cloud Compliance Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Compliance Designer Target',
      );
...
export const cloudComplianceDesignerAgent = Object.freeze(
  new CloudComplianceDesignerAgent(),
);
