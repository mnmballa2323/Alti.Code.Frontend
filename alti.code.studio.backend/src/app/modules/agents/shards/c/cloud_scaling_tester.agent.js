...
class CloudScalingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudScalingSystem(objective) {
    logger.info(
      `💻 [CloudScalingTesterAgent] Analyzing Cloud Scaling Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Scaling Tester Target',
      );
...
export const cloudScalingTesterAgent = Object.freeze(
  new CloudScalingTesterAgent(),
);
