...
class CloudScalingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudScalingSystem(objective) {
    logger.info(
      `💻 [CloudScalingDesignerAgent] Analyzing Cloud Scaling Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Scaling Designer Target',
      );
...
export const cloudScalingDesignerAgent = Object.freeze(
  new CloudScalingDesignerAgent(),
);
