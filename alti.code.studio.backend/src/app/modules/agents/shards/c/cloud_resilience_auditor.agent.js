...
class CloudResilienceAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudResilienceSystem(objective) {
    logger.info(
      `💻 [CloudResilienceAuditorAgent] Analyzing Cloud Resilience Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Resilience Auditor Target',
      );
...
export const cloudResilienceAuditorAgent = Object.freeze(
  new CloudResilienceAuditorAgent(),
);
