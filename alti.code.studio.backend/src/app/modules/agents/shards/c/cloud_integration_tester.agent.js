...
class CloudIntegrationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudIntegrationSystem(objective) {
    logger.info(
      `💻 [CloudIntegrationTesterAgent] Analyzing Cloud Integration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Integration Tester Target',
      );
...
export const cloudIntegrationTesterAgent = Object.freeze(
  new CloudIntegrationTesterAgent(),
);
