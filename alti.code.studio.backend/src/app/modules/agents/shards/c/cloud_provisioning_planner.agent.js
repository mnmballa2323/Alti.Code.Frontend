...
class CloudProvisioningPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudProvisioningSystem(objective) {
    logger.info(
      `💻 [CloudProvisioningPlannerAgent] Analyzing Cloud Provisioning Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Provisioning Planner Target',
      );
...
export const cloudProvisioningPlannerAgent = Object.freeze(
  new CloudProvisioningPlannerAgent(),
);
