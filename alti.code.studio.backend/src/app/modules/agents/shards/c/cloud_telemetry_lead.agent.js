...
class CloudTelemetryLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudTelemetrySystem(objective) {
        logger.info(`💻 [CloudTelemetryLeadAgent] Analyzing Cloud Telemetry Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Telemetry Lead Target");
...
export const cloudTelemetryLeadAgent = Object.freeze(new CloudTelemetryLeadAgent());
