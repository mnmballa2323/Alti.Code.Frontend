...
class CloudCachingConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudCachingSystem(objective) {
    logger.info(
      `💻 [CloudCachingConsultantAgent] Analyzing Cloud Caching Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Caching Consultant Target',
      );
...
export const cloudCachingConsultantAgent = Object.freeze(
  new CloudCachingConsultantAgent(),
);
