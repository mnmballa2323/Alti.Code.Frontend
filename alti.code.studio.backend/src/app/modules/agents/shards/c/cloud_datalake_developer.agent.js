...
class CloudDataLakeDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudDataLakeSystem(objective) {
        logger.info(`💻 [CloudDataLakeDeveloperAgent] Analyzing Cloud DataLake Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud DataLake Developer Target");
...
export const cloudDataLakeDeveloperAgent = Object.freeze(new CloudDataLakeDeveloperAgent());
