...
class CloudResilienceEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudResilienceSystem(objective) {
    logger.info(
      `💻 [CloudResilienceEngineerAgent] Analyzing Cloud Resilience Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Resilience Engineer Target',
      );
...
export const cloudResilienceEngineerAgent = Object.freeze(
  new CloudResilienceEngineerAgent(),
);
