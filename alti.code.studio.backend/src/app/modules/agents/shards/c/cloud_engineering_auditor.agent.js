...
class CloudEngineeringAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudEngineeringSystem(objective) {
    logger.info(
      `💻 [CloudEngineeringAuditorAgent] Analyzing Cloud Engineering Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Engineering Auditor Target',
      );
...
export const cloudEngineeringAuditorAgent = Object.freeze(
  new CloudEngineeringAuditorAgent(),
);
