...
class CloudServerlessDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudServerlessSystem(objective) {
    logger.info(
      `💻 [CloudServerlessDeveloperAgent] Analyzing Cloud Serverless Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Serverless Developer Target',
      );
...
export const cloudServerlessDeveloperAgent = Object.freeze(
  new CloudServerlessDeveloperAgent(),
);
