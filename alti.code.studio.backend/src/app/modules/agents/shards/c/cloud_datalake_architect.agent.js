...
class CloudDataLakeArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudDataLakeSystem(objective) {
    logger.info(
      `💻 [CloudDataLakeArchitectAgent] Analyzing Cloud DataLake Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud DataLake Architect Target',
      );
...
export const cloudDataLakeArchitectAgent = Object.freeze(
  new CloudDataLakeArchitectAgent(),
);
