...
class CloudTelemetryDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudTelemetrySystem(objective) {
        logger.info(`💻 [CloudTelemetryDeveloperAgent] Analyzing Cloud Telemetry Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Telemetry Developer Target");
...
export const cloudTelemetryDeveloperAgent = Object.freeze(new CloudTelemetryDeveloperAgent());
