...
class CloudServerlessTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudServerlessSystem(objective) {
        logger.info(`💻 [CloudServerlessTesterAgent] Analyzing Cloud Serverless Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Serverless Tester Target");
...
export const cloudServerlessTesterAgent = Object.freeze(new CloudServerlessTesterAgent());
