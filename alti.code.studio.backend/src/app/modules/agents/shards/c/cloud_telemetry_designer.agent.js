...
class CloudTelemetryDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudTelemetrySystem(objective) {
        logger.info(`💻 [CloudTelemetryDesignerAgent] Analyzing Cloud Telemetry Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Telemetry Designer Target");
...
export const cloudTelemetryDesignerAgent = Object.freeze(new CloudTelemetryDesignerAgent());
