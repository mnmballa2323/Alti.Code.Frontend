...
class CloudIntegrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudIntegrationSystem(objective) {
    logger.info(
      `💻 [CloudIntegrationAuditorAgent] Analyzing Cloud Integration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Integration Auditor Target',
      );
...
export const cloudIntegrationAuditorAgent = Object.freeze(
  new CloudIntegrationAuditorAgent(),
);
