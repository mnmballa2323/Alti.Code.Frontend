...
class CloudTelemetryAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudTelemetrySystem(objective) {
    logger.info(
      `💻 [CloudTelemetryAuditorAgent] Analyzing Cloud Telemetry Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Telemetry Auditor Target',
      );
...
export const cloudTelemetryAuditorAgent = Object.freeze(
  new CloudTelemetryAuditorAgent(),
);
