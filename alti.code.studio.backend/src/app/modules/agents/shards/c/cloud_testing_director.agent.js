...
class CloudTestingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudTestingSystem(objective) {
    logger.info(
      `💻 [CloudTestingDirectorAgent] Analyzing Cloud Testing Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Testing Director Target',
      );
...
export const cloudTestingDirectorAgent = Object.freeze(
  new CloudTestingDirectorAgent(),
);
