...
class CloudOptimizationAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudOptimizationSystem(objective) {
    logger.info(
      `💻 [CloudOptimizationAnalystAgent] Analyzing Cloud Optimization Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Optimization Analyst Target',
      );
...
export const cloudOptimizationAnalystAgent = Object.freeze(
  new CloudOptimizationAnalystAgent(),
);
