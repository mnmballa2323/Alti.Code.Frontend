...
class CloudDeploymentManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudDeploymentSystem(objective) {
        logger.info(`💻 [CloudDeploymentManagerAgent] Analyzing Cloud Deployment Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Deployment Manager Target");
...
export const cloudDeploymentManagerAgent = Object.freeze(new CloudDeploymentManagerAgent());
