...
class CloudComplianceTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudComplianceSystem(objective) {
        logger.info(`💻 [CloudComplianceTesterAgent] Analyzing Cloud Compliance Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Compliance Tester Target");
...
export const cloudComplianceTesterAgent = Object.freeze(new CloudComplianceTesterAgent());
