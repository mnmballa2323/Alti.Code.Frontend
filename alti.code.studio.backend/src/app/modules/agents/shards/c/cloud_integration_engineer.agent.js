...
class CloudIntegrationEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudIntegrationSystem(objective) {
    logger.info(
      `💻 [CloudIntegrationEngineerAgent] Analyzing Cloud Integration Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Integration Engineer Target',
      );
...
export const cloudIntegrationEngineerAgent = Object.freeze(
  new CloudIntegrationEngineerAgent(),
);
