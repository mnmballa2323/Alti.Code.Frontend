...
class CloudTelemetryEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudTelemetrySystem(objective) {
        logger.info(`💻 [CloudTelemetryEngineerAgent] Analyzing Cloud Telemetry Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Telemetry Engineer Target");
...
export const cloudTelemetryEngineerAgent = Object.freeze(new CloudTelemetryEngineerAgent());
