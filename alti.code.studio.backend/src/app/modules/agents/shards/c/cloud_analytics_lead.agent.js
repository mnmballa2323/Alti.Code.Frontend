...
class CloudAnalyticsLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudAnalyticsSystem(objective) {
    logger.info(
      `💻 [CloudAnalyticsLeadAgent] Analyzing Cloud Analytics Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Analytics Lead Target',
      );
...
export const cloudAnalyticsLeadAgent = Object.freeze(
  new CloudAnalyticsLeadAgent(),
);
