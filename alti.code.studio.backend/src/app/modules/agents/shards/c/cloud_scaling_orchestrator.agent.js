...
class CloudScalingOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudScalingSystem(objective) {
    logger.info(
      `💻 [CloudScalingOrchestratorAgent] Analyzing Cloud Scaling Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Scaling Orchestrator Target',
      );
...
export const cloudScalingOrchestratorAgent = Object.freeze(
  new CloudScalingOrchestratorAgent(),
);
