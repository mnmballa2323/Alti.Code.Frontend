...
class CloudTelemetryDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudTelemetrySystem(objective) {
        logger.info(`💻 [CloudTelemetryDirectorAgent] Analyzing Cloud Telemetry Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Telemetry Director Target");
...
export const cloudTelemetryDirectorAgent = Object.freeze(new CloudTelemetryDirectorAgent());
