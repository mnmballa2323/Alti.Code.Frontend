...
class CloudResiliencePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudResilienceSystem(objective) {
        logger.info(`💻 [CloudResiliencePlannerAgent] Analyzing Cloud Resilience Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Resilience Planner Target");
...
export const cloudResiliencePlannerAgent = Object.freeze(new CloudResiliencePlannerAgent());
