...
class CloudProvisioningAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudProvisioningSystem(objective) {
        logger.info(`💻 [CloudProvisioningAuditorAgent] Analyzing Cloud Provisioning Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Provisioning Auditor Target");
...
export const cloudProvisioningAuditorAgent = Object.freeze(new CloudProvisioningAuditorAgent());
