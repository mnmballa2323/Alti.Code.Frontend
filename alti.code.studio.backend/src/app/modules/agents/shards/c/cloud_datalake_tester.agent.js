...
class CloudDataLakeTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudDataLakeSystem(objective) {
    logger.info(
      `💻 [CloudDataLakeTesterAgent] Analyzing Cloud DataLake Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud DataLake Tester Target',
      );
...
export const cloudDataLakeTesterAgent = Object.freeze(
  new CloudDataLakeTesterAgent(),
);
