...
class CloudStreamingArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudStreamingSystem(objective) {
    logger.info(
      `💻 [CloudStreamingArchitectAgent] Analyzing Cloud Streaming Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Streaming Architect Target',
      );
...
export const cloudStreamingArchitectAgent = Object.freeze(
  new CloudStreamingArchitectAgent(),
);
