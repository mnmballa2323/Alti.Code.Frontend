...
class CloudOptimizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudOptimizationSystem(objective) {
    logger.info(
      `💻 [CloudOptimizationLeadAgent] Analyzing Cloud Optimization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Optimization Lead Target',
      );
...
export const cloudOptimizationLeadAgent = Object.freeze(
  new CloudOptimizationLeadAgent(),
);
