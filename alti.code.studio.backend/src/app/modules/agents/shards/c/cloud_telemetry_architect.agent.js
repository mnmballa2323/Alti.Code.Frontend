...
class CloudTelemetryArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudTelemetrySystem(objective) {
    logger.info(
      `💻 [CloudTelemetryArchitectAgent] Analyzing Cloud Telemetry Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Telemetry Architect Target',
      );
...
export const cloudTelemetryArchitectAgent = Object.freeze(
  new CloudTelemetryArchitectAgent(),
);
