...
class CloudAnalyticsPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudAnalyticsSystem(objective) {
    logger.info(
      `💻 [CloudAnalyticsPlannerAgent] Analyzing Cloud Analytics Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Analytics Planner Target',
      );
...
export const cloudAnalyticsPlannerAgent = Object.freeze(
  new CloudAnalyticsPlannerAgent(),
);
