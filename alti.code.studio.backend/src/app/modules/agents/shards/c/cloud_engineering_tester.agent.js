...
class CloudEngineeringTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudEngineeringSystem(objective) {
    logger.info(
      `💻 [CloudEngineeringTesterAgent] Analyzing Cloud Engineering Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Engineering Tester Target',
      );
...
export const cloudEngineeringTesterAgent = Object.freeze(
  new CloudEngineeringTesterAgent(),
);
