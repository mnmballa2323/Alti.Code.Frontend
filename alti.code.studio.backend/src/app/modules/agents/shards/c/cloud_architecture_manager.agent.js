...
class CloudArchitectureManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudArchitectureSystem(objective) {
    logger.info(
      `💻 [CloudArchitectureManagerAgent] Analyzing Cloud Architecture Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Architecture Manager Target',
      );
...
export const cloudArchitectureManagerAgent = Object.freeze(
  new CloudArchitectureManagerAgent(),
);
