...
class CloudServerlessLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudServerlessSystem(objective) {
        logger.info(`💻 [CloudServerlessLeadAgent] Analyzing Cloud Serverless Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Serverless Lead Target");
...
export const cloudServerlessLeadAgent = Object.freeze(new CloudServerlessLeadAgent());
