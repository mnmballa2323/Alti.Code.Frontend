...
class CloudTelemetrySpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudTelemetrySystem(objective) {
        logger.info(`💻 [CloudTelemetrySpecialistAgent] Analyzing Cloud Telemetry Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Telemetry Specialist Target");
...
export const cloudTelemetrySpecialistAgent = Object.freeze(new CloudTelemetrySpecialistAgent());
