...
class CloudMigrationDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudMigrationSystem(objective) {
    logger.info(
      `💻 [CloudMigrationDirectorAgent] Analyzing Cloud Migration Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Migration Director Target',
      );
...
export const cloudMigrationDirectorAgent = Object.freeze(
  new CloudMigrationDirectorAgent(),
);
