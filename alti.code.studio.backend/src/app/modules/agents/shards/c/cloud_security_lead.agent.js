...
class CloudSecurityLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudSecuritySystem(objective) {
    logger.info(
      `💻 [CloudSecurityLeadAgent] Analyzing Cloud Security Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Security Lead Target',
      );
...
export const cloudSecurityLeadAgent = Object.freeze(
  new CloudSecurityLeadAgent(),
);
