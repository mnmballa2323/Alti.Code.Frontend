...
class CloudAutomationDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudAutomationSystem(objective) {
        logger.info(`💻 [CloudAutomationDesignerAgent] Analyzing Cloud Automation Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Automation Designer Target");
...
export const cloudAutomationDesignerAgent = Object.freeze(new CloudAutomationDesignerAgent());
