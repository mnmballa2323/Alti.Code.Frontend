...
class CloudConfigurationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudConfigurationSystem(objective) {
    logger.info(
      `💻 [CloudConfigurationLeadAgent] Analyzing Cloud Configuration Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Configuration Lead Target',
      );
...
export const cloudConfigurationLeadAgent = Object.freeze(
  new CloudConfigurationLeadAgent(),
);
