...
class CloudOptimizationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudOptimizationSystem(objective) {
    logger.info(
      `💻 [CloudOptimizationManagerAgent] Analyzing Cloud Optimization Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Optimization Manager Target',
      );
...
export const cloudOptimizationManagerAgent = Object.freeze(
  new CloudOptimizationManagerAgent(),
);
