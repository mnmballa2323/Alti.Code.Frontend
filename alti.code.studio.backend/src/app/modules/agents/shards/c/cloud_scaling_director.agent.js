...
class CloudScalingDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudScalingSystem(objective) {
    logger.info(
      `💻 [CloudScalingDirectorAgent] Analyzing Cloud Scaling Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Scaling Director Target',
      );
...
export const cloudScalingDirectorAgent = Object.freeze(
  new CloudScalingDirectorAgent(),
);
