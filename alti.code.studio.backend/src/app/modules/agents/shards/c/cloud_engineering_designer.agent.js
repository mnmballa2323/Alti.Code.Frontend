...
class CloudEngineeringDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudEngineeringSystem(objective) {
    logger.info(
      `💻 [CloudEngineeringDesignerAgent] Analyzing Cloud Engineering Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Engineering Designer Target',
      );
...
export const cloudEngineeringDesignerAgent = Object.freeze(
  new CloudEngineeringDesignerAgent(),
);
