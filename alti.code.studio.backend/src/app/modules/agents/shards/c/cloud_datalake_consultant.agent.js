...
class CloudDataLakeConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudDataLakeSystem(objective) {
    logger.info(
      `💻 [CloudDataLakeConsultantAgent] Analyzing Cloud DataLake Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud DataLake Consultant Target',
      );
...
export const cloudDataLakeConsultantAgent = Object.freeze(
  new CloudDataLakeConsultantAgent(),
);
