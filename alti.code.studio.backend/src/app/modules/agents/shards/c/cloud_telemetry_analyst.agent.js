...
class CloudTelemetryAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudTelemetrySystem(objective) {
    logger.info(
      `💻 [CloudTelemetryAnalystAgent] Analyzing Cloud Telemetry Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Telemetry Analyst Target',
      );
...
export const cloudTelemetryAnalystAgent = Object.freeze(
  new CloudTelemetryAnalystAgent(),
);
