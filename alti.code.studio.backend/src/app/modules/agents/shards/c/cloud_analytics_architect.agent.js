...
class CloudAnalyticsArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudAnalyticsSystem(objective) {
    logger.info(
      `💻 [CloudAnalyticsArchitectAgent] Analyzing Cloud Analytics Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Analytics Architect Target',
      );
...
export const cloudAnalyticsArchitectAgent = Object.freeze(
  new CloudAnalyticsArchitectAgent(),
);
