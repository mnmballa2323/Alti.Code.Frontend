...
class CloudSecurityManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudSecuritySystem(objective) {
        logger.info(`💻 [CloudSecurityManagerAgent] Analyzing Cloud Security Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Security Manager Target");
...
export const cloudSecurityManagerAgent = Object.freeze(new CloudSecurityManagerAgent());
