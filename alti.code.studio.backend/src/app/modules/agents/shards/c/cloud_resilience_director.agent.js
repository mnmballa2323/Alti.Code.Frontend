...
class CloudResilienceDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudResilienceSystem(objective) {
    logger.info(
      `💻 [CloudResilienceDirectorAgent] Analyzing Cloud Resilience Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Resilience Director Target',
      );
...
export const cloudResilienceDirectorAgent = Object.freeze(
  new CloudResilienceDirectorAgent(),
);
