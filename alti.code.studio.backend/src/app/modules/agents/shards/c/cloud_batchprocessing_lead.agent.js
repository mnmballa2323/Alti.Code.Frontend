...
class CloudBatchProcessingLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudBatchProcessingSystem(objective) {
        logger.info(`💻 [CloudBatchProcessingLeadAgent] Analyzing Cloud BatchProcessing Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud BatchProcessing Lead Target");
...
export const cloudBatchProcessingLeadAgent = Object.freeze(new CloudBatchProcessingLeadAgent());
