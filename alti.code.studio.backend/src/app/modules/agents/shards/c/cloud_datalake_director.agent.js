...
class CloudDataLakeDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudDataLakeSystem(objective) {
        logger.info(`💻 [CloudDataLakeDirectorAgent] Analyzing Cloud DataLake Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud DataLake Director Target");
...
export const cloudDataLakeDirectorAgent = Object.freeze(new CloudDataLakeDirectorAgent());
