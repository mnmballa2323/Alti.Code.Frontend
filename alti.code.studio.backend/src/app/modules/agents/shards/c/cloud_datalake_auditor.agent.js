...
class CloudDataLakeAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudDataLakeSystem(objective) {
    logger.info(
      `💻 [CloudDataLakeAuditorAgent] Analyzing Cloud DataLake Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud DataLake Auditor Target',
      );
...
export const cloudDataLakeAuditorAgent = Object.freeze(
  new CloudDataLakeAuditorAgent(),
);
