...
class CloudMigrationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudMigrationSystem(objective) {
    logger.info(
      `💻 [CloudMigrationPlannerAgent] Analyzing Cloud Migration Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Migration Planner Target',
      );
...
export const cloudMigrationPlannerAgent = Object.freeze(
  new CloudMigrationPlannerAgent(),
);
