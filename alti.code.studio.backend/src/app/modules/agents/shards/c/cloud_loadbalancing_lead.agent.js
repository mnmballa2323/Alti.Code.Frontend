...
class CloudLoadBalancingLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudLoadBalancingSystem(objective) {
        logger.info(`💻 [CloudLoadBalancingLeadAgent] Analyzing Cloud LoadBalancing Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud LoadBalancing Lead Target");
...
export const cloudLoadBalancingLeadAgent = Object.freeze(new CloudLoadBalancingLeadAgent());
