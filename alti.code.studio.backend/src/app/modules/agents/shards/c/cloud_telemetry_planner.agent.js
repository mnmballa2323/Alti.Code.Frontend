...
class CloudTelemetryPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudTelemetrySystem(objective) {
    logger.info(
      `💻 [CloudTelemetryPlannerAgent] Analyzing Cloud Telemetry Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Telemetry Planner Target',
      );
...
export const cloudTelemetryPlannerAgent = Object.freeze(
  new CloudTelemetryPlannerAgent(),
);
