...
class CloudGovernanceDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudGovernanceSystem(objective) {
        logger.info(`💻 [CloudGovernanceDesignerAgent] Analyzing Cloud Governance Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Governance Designer Target");
...
export const cloudGovernanceDesignerAgent = Object.freeze(new CloudGovernanceDesignerAgent());
