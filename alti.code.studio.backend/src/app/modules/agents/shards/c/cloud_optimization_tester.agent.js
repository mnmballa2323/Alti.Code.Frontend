...
class CloudOptimizationTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudOptimizationSystem(objective) {
        logger.info(`💻 [CloudOptimizationTesterAgent] Analyzing Cloud Optimization Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Optimization Tester Target");
...
export const cloudOptimizationTesterAgent = Object.freeze(new CloudOptimizationTesterAgent());
