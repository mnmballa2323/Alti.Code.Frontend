...
class CloudAnalyticsSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudAnalyticsSystem(objective) {
    logger.info(
      `💻 [CloudAnalyticsSpecialistAgent] Analyzing Cloud Analytics Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Analytics Specialist Target',
      );
...
export const cloudAnalyticsSpecialistAgent = Object.freeze(
  new CloudAnalyticsSpecialistAgent(),
);
