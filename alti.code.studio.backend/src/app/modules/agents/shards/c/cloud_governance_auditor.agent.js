...
class CloudGovernanceAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudGovernanceSystem(objective) {
    logger.info(
      `💻 [CloudGovernanceAuditorAgent] Analyzing Cloud Governance Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Governance Auditor Target',
      );
...
export const cloudGovernanceAuditorAgent = Object.freeze(
  new CloudGovernanceAuditorAgent(),
);
