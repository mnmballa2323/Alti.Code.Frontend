...
class CloudTestingPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudTestingSystem(objective) {
    logger.info(
      `💻 [CloudTestingPlannerAgent] Analyzing Cloud Testing Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Testing Planner Target',
      );
...
export const cloudTestingPlannerAgent = Object.freeze(
  new CloudTestingPlannerAgent(),
);
