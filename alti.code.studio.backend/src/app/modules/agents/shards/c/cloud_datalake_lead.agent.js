...
class CloudDataLakeLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudDataLakeSystem(objective) {
    logger.info(
      `💻 [CloudDataLakeLeadAgent] Analyzing Cloud DataLake Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud DataLake Lead Target',
      );
...
export const cloudDataLakeLeadAgent = Object.freeze(
  new CloudDataLakeLeadAgent(),
);
