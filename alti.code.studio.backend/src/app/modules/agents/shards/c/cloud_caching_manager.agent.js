...
class CloudCachingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudCachingSystem(objective) {
    logger.info(
      `💻 [CloudCachingManagerAgent] Analyzing Cloud Caching Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Caching Manager Target',
      );
...
export const cloudCachingManagerAgent = Object.freeze(
  new CloudCachingManagerAgent(),
);
