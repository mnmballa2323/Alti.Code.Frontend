...
class CloudGovernanceArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudGovernanceSystem(objective) {
    logger.info(
      `💻 [CloudGovernanceArchitectAgent] Analyzing Cloud Governance Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Governance Architect Target',
      );
...
export const cloudGovernanceArchitectAgent = Object.freeze(
  new CloudGovernanceArchitectAgent(),
);
