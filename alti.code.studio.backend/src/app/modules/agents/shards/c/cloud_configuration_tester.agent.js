...
class CloudConfigurationTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudConfigurationSystem(objective) {
        logger.info(`💻 [CloudConfigurationTesterAgent] Analyzing Cloud Configuration Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Configuration Tester Target");
...
export const cloudConfigurationTesterAgent = Object.freeze(new CloudConfigurationTesterAgent());
