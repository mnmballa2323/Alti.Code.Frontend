...
class CloudResilienceLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudResilienceSystem(objective) {
        logger.info(`💻 [CloudResilienceLeadAgent] Analyzing Cloud Resilience Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Resilience Lead Target");
...
export const cloudResilienceLeadAgent = Object.freeze(new CloudResilienceLeadAgent());
