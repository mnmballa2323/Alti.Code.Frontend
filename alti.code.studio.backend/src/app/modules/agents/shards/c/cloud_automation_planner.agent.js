...
class CloudAutomationPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudAutomationSystem(objective) {
    logger.info(
      `💻 [CloudAutomationPlannerAgent] Analyzing Cloud Automation Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Automation Planner Target',
      );
...
export const cloudAutomationPlannerAgent = Object.freeze(
  new CloudAutomationPlannerAgent(),
);
