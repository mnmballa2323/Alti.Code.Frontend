...
class CloudServerlessEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudServerlessSystem(objective) {
    logger.info(
      `💻 [CloudServerlessEngineerAgent] Analyzing Cloud Serverless Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Serverless Engineer Target',
      );
...
export const cloudServerlessEngineerAgent = Object.freeze(
  new CloudServerlessEngineerAgent(),
);
