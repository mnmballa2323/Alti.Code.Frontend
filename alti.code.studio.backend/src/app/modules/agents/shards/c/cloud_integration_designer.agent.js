...
class CloudIntegrationDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudIntegrationSystem(objective) {
    logger.info(
      `💻 [CloudIntegrationDesignerAgent] Analyzing Cloud Integration Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Integration Designer Target',
      );
...
export const cloudIntegrationDesignerAgent = Object.freeze(
  new CloudIntegrationDesignerAgent(),
);
