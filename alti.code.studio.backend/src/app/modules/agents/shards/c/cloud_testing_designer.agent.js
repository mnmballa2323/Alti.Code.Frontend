...
class CloudTestingDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudTestingSystem(objective) {
        logger.info(`💻 [CloudTestingDesignerAgent] Analyzing Cloud Testing Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Testing Designer Target");
...
export const cloudTestingDesignerAgent = Object.freeze(new CloudTestingDesignerAgent());
