...
class CloudObservabilityTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudObservabilitySystem(objective) {
    logger.info(
      `💻 [CloudObservabilityTesterAgent] Analyzing Cloud Observability Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Observability Tester Target',
      );
...
export const cloudObservabilityTesterAgent = Object.freeze(
  new CloudObservabilityTesterAgent(),
);
