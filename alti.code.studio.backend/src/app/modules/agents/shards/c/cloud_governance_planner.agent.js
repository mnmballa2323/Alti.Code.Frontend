...
class CloudGovernancePlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudGovernanceSystem(objective) {
    logger.info(
      `💻 [CloudGovernancePlannerAgent] Analyzing Cloud Governance Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Governance Planner Target',
      );
...
export const cloudGovernancePlannerAgent = Object.freeze(
  new CloudGovernancePlannerAgent(),
);
