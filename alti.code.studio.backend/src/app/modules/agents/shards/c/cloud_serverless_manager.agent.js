...
class CloudServerlessManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudServerlessSystem(objective) {
        logger.info(`💻 [CloudServerlessManagerAgent] Analyzing Cloud Serverless Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Serverless Manager Target");
...
export const cloudServerlessManagerAgent = Object.freeze(new CloudServerlessManagerAgent());
