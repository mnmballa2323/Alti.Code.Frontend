...
class CloudTestingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudTestingSystem(objective) {
    logger.info(
      `💻 [CloudTestingEngineerAgent] Analyzing Cloud Testing Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Testing Engineer Target',
      );
...
export const cloudTestingEngineerAgent = Object.freeze(
  new CloudTestingEngineerAgent(),
);
