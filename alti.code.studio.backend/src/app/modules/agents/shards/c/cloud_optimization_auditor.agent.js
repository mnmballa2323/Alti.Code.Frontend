...
class CloudOptimizationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudOptimizationSystem(objective) {
    logger.info(
      `💻 [CloudOptimizationAuditorAgent] Analyzing Cloud Optimization Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Optimization Auditor Target',
      );
...
export const cloudOptimizationAuditorAgent = Object.freeze(
  new CloudOptimizationAuditorAgent(),
);
