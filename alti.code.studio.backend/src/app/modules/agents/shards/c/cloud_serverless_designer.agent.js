...
class CloudServerlessDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudServerlessSystem(objective) {
        logger.info(`💻 [CloudServerlessDesignerAgent] Analyzing Cloud Serverless Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Serverless Designer Target");
...
export const cloudServerlessDesignerAgent = Object.freeze(new CloudServerlessDesignerAgent());
