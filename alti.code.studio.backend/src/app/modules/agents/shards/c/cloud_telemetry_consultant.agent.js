...
class CloudTelemetryConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudTelemetrySystem(objective) {
        logger.info(`💻 [CloudTelemetryConsultantAgent] Analyzing Cloud Telemetry Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Telemetry Consultant Target");
...
export const cloudTelemetryConsultantAgent = Object.freeze(new CloudTelemetryConsultantAgent());
