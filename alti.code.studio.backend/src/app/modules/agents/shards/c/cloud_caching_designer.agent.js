...
class CloudCachingDesignerAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudCachingSystem(objective) {
        logger.info(`💻 [CloudCachingDesignerAgent] Analyzing Cloud Caching Designer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Caching Designer Target");
...
export const cloudCachingDesignerAgent = Object.freeze(new CloudCachingDesignerAgent());
