...
class CloudScalingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudScalingSystem(objective) {
    logger.info(
      `💻 [CloudScalingEngineerAgent] Analyzing Cloud Scaling Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Scaling Engineer Target',
      );
...
export const cloudScalingEngineerAgent = Object.freeze(
  new CloudScalingEngineerAgent(),
);
