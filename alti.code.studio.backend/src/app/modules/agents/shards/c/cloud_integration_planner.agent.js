...
class CloudIntegrationPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudIntegrationSystem(objective) {
        logger.info(`💻 [CloudIntegrationPlannerAgent] Analyzing Cloud Integration Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Integration Planner Target");
...
export const cloudIntegrationPlannerAgent = Object.freeze(new CloudIntegrationPlannerAgent());
