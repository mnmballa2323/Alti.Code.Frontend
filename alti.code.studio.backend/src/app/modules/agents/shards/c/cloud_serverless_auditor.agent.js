...
class CloudServerlessAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudServerlessSystem(objective) {
    logger.info(
      `💻 [CloudServerlessAuditorAgent] Analyzing Cloud Serverless Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Serverless Auditor Target',
      );
...
export const cloudServerlessAuditorAgent = Object.freeze(
  new CloudServerlessAuditorAgent(),
);
