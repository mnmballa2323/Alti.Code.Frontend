...
class CloudComplianceAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudComplianceSystem(objective) {
    logger.info(
      `💻 [CloudComplianceAnalystAgent] Analyzing Cloud Compliance Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Compliance Analyst Target',
      );
...
export const cloudComplianceAnalystAgent = Object.freeze(
  new CloudComplianceAnalystAgent(),
);
