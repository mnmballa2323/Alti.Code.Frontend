...
class CloudMigrationManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudMigrationSystem(objective) {
    logger.info(
      `💻 [CloudMigrationManagerAgent] Analyzing Cloud Migration Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Migration Manager Target',
      );
...
export const cloudMigrationManagerAgent = Object.freeze(
  new CloudMigrationManagerAgent(),
);
