...
class CloudSecurityAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudSecuritySystem(objective) {
    logger.info(
      `💻 [CloudSecurityAnalystAgent] Analyzing Cloud Security Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Security Analyst Target',
      );
...
export const cloudSecurityAnalystAgent = Object.freeze(
  new CloudSecurityAnalystAgent(),
);
