...
class CloudAnalyticsDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudAnalyticsSystem(objective) {
        logger.info(`💻 [CloudAnalyticsDirectorAgent] Analyzing Cloud Analytics Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Analytics Director Target");
...
export const cloudAnalyticsDirectorAgent = Object.freeze(new CloudAnalyticsDirectorAgent());
