...
class CloudMigrationSpecialistAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudMigrationSystem(objective) {
        logger.info(`💻 [CloudMigrationSpecialistAgent] Analyzing Cloud Migration Specialist specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Migration Specialist Target");
...
export const cloudMigrationSpecialistAgent = Object.freeze(new CloudMigrationSpecialistAgent());
