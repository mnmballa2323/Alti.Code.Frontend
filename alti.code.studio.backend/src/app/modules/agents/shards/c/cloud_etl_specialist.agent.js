...
class CloudETLSpecialistAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudETLSystem(objective) {
    logger.info(
      `💻 [CloudETLSpecialistAgent] Analyzing Cloud ETL Specialist specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud ETL Specialist Target',
      );
...
export const cloudETLSpecialistAgent = Object.freeze(
  new CloudETLSpecialistAgent(),
);
