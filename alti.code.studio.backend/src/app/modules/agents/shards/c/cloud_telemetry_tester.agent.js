...
class CloudTelemetryTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudTelemetrySystem(objective) {
        logger.info(`💻 [CloudTelemetryTesterAgent] Analyzing Cloud Telemetry Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Telemetry Tester Target");
...
export const cloudTelemetryTesterAgent = Object.freeze(new CloudTelemetryTesterAgent());
