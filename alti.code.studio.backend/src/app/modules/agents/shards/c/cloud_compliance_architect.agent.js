...
class CloudComplianceArchitectAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudComplianceSystem(objective) {
    logger.info(
      `💻 [CloudComplianceArchitectAgent] Analyzing Cloud Compliance Architect specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Compliance Architect Target',
      );
...
export const cloudComplianceArchitectAgent = Object.freeze(
  new CloudComplianceArchitectAgent(),
);
