...
class CloudScalingAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudScalingSystem(objective) {
        logger.info(`💻 [CloudScalingAuditorAgent] Analyzing Cloud Scaling Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Scaling Auditor Target");
...
export const cloudScalingAuditorAgent = Object.freeze(new CloudScalingAuditorAgent());
