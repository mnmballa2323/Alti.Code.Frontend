...
class CloudMigrationConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudMigrationSystem(objective) {
        logger.info(`💻 [CloudMigrationConsultantAgent] Analyzing Cloud Migration Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Migration Consultant Target");
...
export const cloudMigrationConsultantAgent = Object.freeze(new CloudMigrationConsultantAgent());
