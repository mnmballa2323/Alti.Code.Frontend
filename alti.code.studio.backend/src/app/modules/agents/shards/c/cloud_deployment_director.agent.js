...
class CloudDeploymentDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudDeploymentSystem(objective) {
    logger.info(
      `💻 [CloudDeploymentDirectorAgent] Analyzing Cloud Deployment Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Deployment Director Target',
      );
...
export const cloudDeploymentDirectorAgent = Object.freeze(
  new CloudDeploymentDirectorAgent(),
);
