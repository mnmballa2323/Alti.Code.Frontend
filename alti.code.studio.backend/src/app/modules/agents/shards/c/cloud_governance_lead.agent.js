...
class CloudGovernanceLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudGovernanceSystem(objective) {
    logger.info(
      `💻 [CloudGovernanceLeadAgent] Analyzing Cloud Governance Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Governance Lead Target',
      );
...
export const cloudGovernanceLeadAgent = Object.freeze(
  new CloudGovernanceLeadAgent(),
);
