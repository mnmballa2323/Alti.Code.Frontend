...
class CloudScalingConsultantAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudScalingSystem(objective) {
        logger.info(`💻 [CloudScalingConsultantAgent] Analyzing Cloud Scaling Consultant specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Scaling Consultant Target");
...
export const cloudScalingConsultantAgent = Object.freeze(new CloudScalingConsultantAgent());
