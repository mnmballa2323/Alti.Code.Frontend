...
class CloudResilienceAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudResilienceSystem(objective) {
        logger.info(`💻 [CloudResilienceAnalystAgent] Analyzing Cloud Resilience Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Resilience Analyst Target");
...
export const cloudResilienceAnalystAgent = Object.freeze(new CloudResilienceAnalystAgent());
