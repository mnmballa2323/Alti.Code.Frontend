...
class CloudSecurityDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateCloudSecuritySystem(objective) {
        logger.info(`💻 [CloudSecurityDeveloperAgent] Analyzing Cloud Security Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Cloud Security Developer Target");
...
export const cloudSecurityDeveloperAgent = Object.freeze(new CloudSecurityDeveloperAgent());
