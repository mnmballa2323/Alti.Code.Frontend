...
class CloudResilienceManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudResilienceSystem(objective) {
    logger.info(
      `💻 [CloudResilienceManagerAgent] Analyzing Cloud Resilience Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Resilience Manager Target',
      );
...
export const cloudResilienceManagerAgent = Object.freeze(
  new CloudResilienceManagerAgent(),
);
