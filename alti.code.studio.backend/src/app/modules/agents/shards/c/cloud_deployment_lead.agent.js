...
class CloudDeploymentLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateCloudDeploymentSystem(objective) {
    logger.info(
      `💻 [CloudDeploymentLeadAgent] Analyzing Cloud Deployment Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Cloud Deployment Lead Target',
      );
...
export const cloudDeploymentLeadAgent = Object.freeze(
  new CloudDeploymentLeadAgent(),
);
