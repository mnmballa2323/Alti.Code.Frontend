...
class FrontendTestingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendTestingSystem(objective) {
    logger.info(
      `💻 [FrontendTestingLeadAgent] Analyzing Frontend Testing Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Testing Lead Target',
      );
...
export const frontendTestingLeadAgent = Object.freeze(
  new FrontendTestingLeadAgent(),
);
