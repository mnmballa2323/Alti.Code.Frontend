...
class FullStackDataLakeManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackDataLakeSystem(objective) {
    logger.info(
      `💻 [FullStackDataLakeManagerAgent] Analyzing FullStack DataLake Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack DataLake Manager Target',
      );
...
export const fullStackDataLakeManagerAgent = Object.freeze(
  new FullStackDataLakeManagerAgent(),
);
