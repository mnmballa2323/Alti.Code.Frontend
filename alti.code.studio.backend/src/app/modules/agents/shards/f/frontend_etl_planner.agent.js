...
class FrontendETLPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendETLSystem(objective) {
    logger.info(
      `💻 [FrontendETLPlannerAgent] Analyzing Frontend ETL Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend ETL Planner Target',
      );
...
export const frontendETLPlannerAgent = Object.freeze(
  new FrontendETLPlannerAgent(),
);
