...
class FullStackETLConsultantAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackETLSystem(objective) {
    logger.info(
      `💻 [FullStackETLConsultantAgent] Analyzing FullStack ETL Consultant specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack ETL Consultant Target',
      );
...
export const fullStackETLConsultantAgent = Object.freeze(
  new FullStackETLConsultantAgent(),
);
