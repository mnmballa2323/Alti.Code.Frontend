...
class FrontendDataLakeTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendDataLakeSystem(objective) {
    logger.info(
      `💻 [FrontendDataLakeTesterAgent] Analyzing Frontend DataLake Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend DataLake Tester Target',
      );
...
export const frontendDataLakeTesterAgent = Object.freeze(
  new FrontendDataLakeTesterAgent(),
);
