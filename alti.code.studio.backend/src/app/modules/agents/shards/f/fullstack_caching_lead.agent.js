...
class FullStackCachingLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateFullStackCachingSystem(objective) {
        logger.info(`💻 [FullStackCachingLeadAgent] Analyzing FullStack Caching Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - FullStack Caching Lead Target");
...
export const fullStackCachingLeadAgent = Object.freeze(new FullStackCachingLeadAgent());
