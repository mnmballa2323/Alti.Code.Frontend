...
class FigmaAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Creative specialist for translating Figma designs into pixel-perfect React components and design tokens.';
...
export const figmaAgent = Object.freeze(new FigmaAgent());
