...
class FullStackCachingTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackCachingSystem(objective) {
    logger.info(
      `💻 [FullStackCachingTesterAgent] Analyzing FullStack Caching Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack Caching Tester Target',
      );
...
export const fullStackCachingTesterAgent = Object.freeze(
  new FullStackCachingTesterAgent(),
);
