...
class FrontendTestingAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateFrontendTestingSystem(objective) {
        logger.info(`💻 [FrontendTestingAnalystAgent] Analyzing Frontend Testing Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Frontend Testing Analyst Target");
...
export const frontendTestingAnalystAgent = Object.freeze(new FrontendTestingAnalystAgent());
