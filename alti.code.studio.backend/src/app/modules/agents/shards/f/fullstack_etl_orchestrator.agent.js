...
class FullStackETLOrchestratorAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackETLSystem(objective) {
    logger.info(
      `💻 [FullStackETLOrchestratorAgent] Analyzing FullStack ETL Orchestrator specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack ETL Orchestrator Target',
      );
...
export const fullStackETLOrchestratorAgent = Object.freeze(
  new FullStackETLOrchestratorAgent(),
);
