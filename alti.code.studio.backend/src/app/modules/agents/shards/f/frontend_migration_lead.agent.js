...
class FrontendMigrationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateFrontendMigrationSystem(objective) {
        logger.info(`💻 [FrontendMigrationLeadAgent] Analyzing Frontend Migration Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Frontend Migration Lead Target");
...
export const frontendMigrationLeadAgent = Object.freeze(new FrontendMigrationLeadAgent());
