...
class FullStackTestingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackTestingSystem(objective) {
    logger.info(
      `💻 [FullStackTestingAuditorAgent] Analyzing FullStack Testing Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack Testing Auditor Target',
      );
...
export const fullStackTestingAuditorAgent = Object.freeze(
  new FullStackTestingAuditorAgent(),
);
