...
class FrontendDeploymentTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendDeploymentSystem(objective) {
    logger.info(
      `💻 [FrontendDeploymentTesterAgent] Analyzing Frontend Deployment Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Deployment Tester Target',
      );
...
export const frontendDeploymentTesterAgent = Object.freeze(
  new FrontendDeploymentTesterAgent(),
);
