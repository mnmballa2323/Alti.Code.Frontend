...
class FullStackTestingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackTestingSystem(objective) {
    logger.info(
      `💻 [FullStackTestingDesignerAgent] Analyzing FullStack Testing Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack Testing Designer Target',
      );
...
export const fullStackTestingDesignerAgent = Object.freeze(
  new FullStackTestingDesignerAgent(),
);
