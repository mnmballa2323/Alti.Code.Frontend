...
class FullStackETLAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateFullStackETLSystem(objective) {
        logger.info(`💻 [FullStackETLAuditorAgent] Analyzing FullStack ETL Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - FullStack ETL Auditor Target");
...
export const fullStackETLAuditorAgent = Object.freeze(new FullStackETLAuditorAgent());
