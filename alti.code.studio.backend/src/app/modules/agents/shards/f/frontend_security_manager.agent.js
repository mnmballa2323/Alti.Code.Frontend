...
class FrontendSecurityManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendSecuritySystem(objective) {
    logger.info(
      `💻 [FrontendSecurityManagerAgent] Analyzing Frontend Security Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Security Manager Target',
      );
...
export const frontendSecurityManagerAgent = Object.freeze(
  new FrontendSecurityManagerAgent(),
);
