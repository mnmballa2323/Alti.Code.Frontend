...
class FullStackSecurityAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateFullStackSecuritySystem(objective) {
        logger.info(`💻 [FullStackSecurityAuditorAgent] Analyzing FullStack Security Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - FullStack Security Auditor Target");
...
export const fullStackSecurityAuditorAgent = Object.freeze(new FullStackSecurityAuditorAgent());
