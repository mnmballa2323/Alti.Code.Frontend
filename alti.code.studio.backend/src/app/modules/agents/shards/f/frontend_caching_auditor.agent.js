...
class FrontendCachingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendCachingSystem(objective) {
    logger.info(
      `💻 [FrontendCachingAuditorAgent] Analyzing Frontend Caching Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Caching Auditor Target',
      );
...
export const frontendCachingAuditorAgent = Object.freeze(
  new FrontendCachingAuditorAgent(),
);
