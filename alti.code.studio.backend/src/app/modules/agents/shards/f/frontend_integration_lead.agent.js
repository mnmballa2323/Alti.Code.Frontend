...
class FrontendIntegrationLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateFrontendIntegrationSystem(objective) {
        logger.info(`💻 [FrontendIntegrationLeadAgent] Analyzing Frontend Integration Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Frontend Integration Lead Target");
...
export const frontendIntegrationLeadAgent = Object.freeze(new FrontendIntegrationLeadAgent());
