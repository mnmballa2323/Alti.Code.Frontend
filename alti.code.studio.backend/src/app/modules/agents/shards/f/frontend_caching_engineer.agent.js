...
class FrontendCachingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendCachingSystem(objective) {
    logger.info(
      `💻 [FrontendCachingEngineerAgent] Analyzing Frontend Caching Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Caching Engineer Target',
      );
...
export const frontendCachingEngineerAgent = Object.freeze(
  new FrontendCachingEngineerAgent(),
);
