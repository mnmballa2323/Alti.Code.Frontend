...
class FrontendComplianceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendComplianceSystem(objective) {
    logger.info(
      `💻 [FrontendComplianceTesterAgent] Analyzing Frontend Compliance Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Compliance Tester Target',
      );
...
export const frontendComplianceTesterAgent = Object.freeze(
  new FrontendComplianceTesterAgent(),
);
