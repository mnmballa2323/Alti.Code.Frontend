...
class FrontendETLAuditorAgent extends GeminiCliBaseAgent {
    ...
    async generateFrontendETLSystem(objective) {
        logger.info(`💻 [FrontendETLAuditorAgent] Analyzing Frontend ETL Auditor specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Frontend ETL Auditor Target");
...
export const frontendETLAuditorAgent = Object.freeze(new FrontendETLAuditorAgent());
