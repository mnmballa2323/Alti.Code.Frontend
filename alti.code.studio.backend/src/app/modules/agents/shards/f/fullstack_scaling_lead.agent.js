...
class FullStackScalingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackScalingSystem(objective) {
    logger.info(
      `💻 [FullStackScalingLeadAgent] Analyzing FullStack Scaling Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack Scaling Lead Target',
      );
...
export const fullStackScalingLeadAgent = Object.freeze(
  new FullStackScalingLeadAgent(),
);
