...
class FrontendETLTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendETLSystem(objective) {
    logger.info(
      `💻 [FrontendETLTesterAgent] Analyzing Frontend ETL Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend ETL Tester Target',
      );
...
export const frontendETLTesterAgent = Object.freeze(
  new FrontendETLTesterAgent(),
);
