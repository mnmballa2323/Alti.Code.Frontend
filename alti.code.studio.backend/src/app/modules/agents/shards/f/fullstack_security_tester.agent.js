...
class FullStackSecurityTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackSecuritySystem(objective) {
    logger.info(
      `💻 [FullStackSecurityTesterAgent] Analyzing FullStack Security Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack Security Tester Target',
      );
...
export const fullStackSecurityTesterAgent = Object.freeze(
  new FullStackSecurityTesterAgent(),
);
