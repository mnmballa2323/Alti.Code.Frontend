...
class FrontendSecurityDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateFrontendSecuritySystem(objective) {
        logger.info(`💻 [FrontendSecurityDirectorAgent] Analyzing Frontend Security Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Frontend Security Director Target");
...
export const frontendSecurityDirectorAgent = Object.freeze(new FrontendSecurityDirectorAgent());
