...
class FullStackTestingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackTestingSystem(objective) {
    logger.info(
      `💻 [FullStackTestingEngineerAgent] Analyzing FullStack Testing Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack Testing Engineer Target',
      );
...
export const fullStackTestingEngineerAgent = Object.freeze(
  new FullStackTestingEngineerAgent(),
);
