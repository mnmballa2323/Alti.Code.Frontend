...
class FullStackDataLakePlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateFullStackDataLakeSystem(objective) {
        logger.info(`💻 [FullStackDataLakePlannerAgent] Analyzing FullStack DataLake Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - FullStack DataLake Planner Target");
...
export const fullStackDataLakePlannerAgent = Object.freeze(new FullStackDataLakePlannerAgent());
