...
class FullStackTestingDirectorAgent extends GeminiCliBaseAgent {
    ...
    async generateFullStackTestingSystem(objective) {
        logger.info(`💻 [FullStackTestingDirectorAgent] Analyzing FullStack Testing Director specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - FullStack Testing Director Target");
...
export const fullStackTestingDirectorAgent = Object.freeze(new FullStackTestingDirectorAgent());
