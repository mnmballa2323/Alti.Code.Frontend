...
class FrontendMigrationPlannerAgent extends GeminiCliBaseAgent {
    ...
    async generateFrontendMigrationSystem(objective) {
        logger.info(`💻 [FrontendMigrationPlannerAgent] Analyzing Frontend Migration Planner specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Frontend Migration Planner Target");
...
export const frontendMigrationPlannerAgent = Object.freeze(new FrontendMigrationPlannerAgent());
