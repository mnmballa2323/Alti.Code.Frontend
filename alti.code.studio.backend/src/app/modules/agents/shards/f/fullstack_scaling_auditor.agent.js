...
class FullStackScalingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackScalingSystem(objective) {
    logger.info(
      `💻 [FullStackScalingAuditorAgent] Analyzing FullStack Scaling Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack Scaling Auditor Target',
      );
...
export const fullStackScalingAuditorAgent = Object.freeze(
  new FullStackScalingAuditorAgent(),
);
