...
class FullStackETLDirectorAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackETLSystem(objective) {
    logger.info(
      `💻 [FullStackETLDirectorAgent] Analyzing FullStack ETL Director specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack ETL Director Target',
      );
...
export const fullStackETLDirectorAgent = Object.freeze(
  new FullStackETLDirectorAgent(),
);
