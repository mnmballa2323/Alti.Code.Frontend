...
class FrontendServerlessTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendServerlessSystem(objective) {
    logger.info(
      `💻 [FrontendServerlessTesterAgent] Analyzing Frontend Serverless Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Serverless Tester Target',
      );
...
export const frontendServerlessTesterAgent = Object.freeze(
  new FrontendServerlessTesterAgent(),
);
