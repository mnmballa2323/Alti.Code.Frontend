...
class FullStackCachingManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateFullStackCachingSystem(objective) {
        logger.info(`💻 [FullStackCachingManagerAgent] Analyzing FullStack Caching Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - FullStack Caching Manager Target");
...
export const fullStackCachingManagerAgent = Object.freeze(new FullStackCachingManagerAgent());
