...
class FullStackETLDeveloperAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackETLSystem(objective) {
    logger.info(
      `💻 [FullStackETLDeveloperAgent] Analyzing FullStack ETL Developer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack ETL Developer Target',
      );
...
export const fullStackETLDeveloperAgent = Object.freeze(
  new FullStackETLDeveloperAgent(),
);
