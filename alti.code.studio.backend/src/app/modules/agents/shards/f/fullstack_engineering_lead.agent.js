...
class FullStackEngineeringLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackEngineeringSystem(objective) {
    logger.info(
      `💻 [FullStackEngineeringLeadAgent] Analyzing FullStack Engineering Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack Engineering Lead Target',
      );
...
export const fullStackEngineeringLeadAgent = Object.freeze(
  new FullStackEngineeringLeadAgent(),
);
