...
class FullStackDataLakeLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackDataLakeSystem(objective) {
    logger.info(
      `💻 [FullStackDataLakeLeadAgent] Analyzing FullStack DataLake Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack DataLake Lead Target',
      );
...
export const fullStackDataLakeLeadAgent = Object.freeze(
  new FullStackDataLakeLeadAgent(),
);
