...
class FrontendCachingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendCachingSystem(objective) {
    logger.info(
      `💻 [FrontendCachingDesignerAgent] Analyzing Frontend Caching Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Caching Designer Target',
      );
...
export const frontendCachingDesignerAgent = Object.freeze(
  new FrontendCachingDesignerAgent(),
);
