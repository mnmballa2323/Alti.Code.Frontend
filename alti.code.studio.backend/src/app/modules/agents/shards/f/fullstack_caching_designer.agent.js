...
class FullStackCachingDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackCachingSystem(objective) {
    logger.info(
      `💻 [FullStackCachingDesignerAgent] Analyzing FullStack Caching Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack Caching Designer Target',
      );
...
export const fullStackCachingDesignerAgent = Object.freeze(
  new FullStackCachingDesignerAgent(),
);
