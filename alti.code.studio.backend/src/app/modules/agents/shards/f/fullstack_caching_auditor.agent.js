...
class FullStackCachingAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackCachingSystem(objective) {
    logger.info(
      `💻 [FullStackCachingAuditorAgent] Analyzing FullStack Caching Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack Caching Auditor Target',
      );
...
export const fullStackCachingAuditorAgent = Object.freeze(
  new FullStackCachingAuditorAgent(),
);
