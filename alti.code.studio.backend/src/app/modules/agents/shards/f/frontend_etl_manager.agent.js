...
class FrontendETLManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendETLSystem(objective) {
    logger.info(
      `💻 [FrontendETLManagerAgent] Analyzing Frontend ETL Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend ETL Manager Target',
      );
...
export const frontendETLManagerAgent = Object.freeze(
  new FrontendETLManagerAgent(),
);
