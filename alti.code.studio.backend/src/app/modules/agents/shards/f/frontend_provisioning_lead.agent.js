...
class FrontendProvisioningLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendProvisioningSystem(objective) {
    logger.info(
      `💻 [FrontendProvisioningLeadAgent] Analyzing Frontend Provisioning Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Provisioning Lead Target',
      );
...
export const frontendProvisioningLeadAgent = Object.freeze(
  new FrontendProvisioningLeadAgent(),
);
