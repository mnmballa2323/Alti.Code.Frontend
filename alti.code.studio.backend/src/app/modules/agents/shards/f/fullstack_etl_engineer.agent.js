...
class FullStackETLEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateFullStackETLSystem(objective) {
        logger.info(`💻 [FullStackETLEngineerAgent] Analyzing FullStack ETL Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - FullStack ETL Engineer Target");
...
export const fullStackETLEngineerAgent = Object.freeze(new FullStackETLEngineerAgent());
