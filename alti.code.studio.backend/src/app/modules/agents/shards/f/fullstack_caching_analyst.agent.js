...
class FullStackCachingAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackCachingSystem(objective) {
    logger.info(
      `💻 [FullStackCachingAnalystAgent] Analyzing FullStack Caching Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack Caching Analyst Target',
      );
...
export const fullStackCachingAnalystAgent = Object.freeze(
  new FullStackCachingAnalystAgent(),
);
