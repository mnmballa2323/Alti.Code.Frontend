...
class FrontendDataLakeEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendDataLakeSystem(objective) {
    logger.info(
      `💻 [FrontendDataLakeEngineerAgent] Analyzing Frontend DataLake Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend DataLake Engineer Target',
      );
...
export const frontendDataLakeEngineerAgent = Object.freeze(
  new FrontendDataLakeEngineerAgent(),
);
