...
class FrontendETLEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendETLSystem(objective) {
    logger.info(
      `💻 [FrontendETLEngineerAgent] Analyzing Frontend ETL Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend ETL Engineer Target',
      );
...
export const frontendETLEngineerAgent = Object.freeze(
  new FrontendETLEngineerAgent(),
);
