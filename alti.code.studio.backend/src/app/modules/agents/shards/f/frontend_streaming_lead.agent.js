...
class FrontendStreamingLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendStreamingSystem(objective) {
    logger.info(
      `💻 [FrontendStreamingLeadAgent] Analyzing Frontend Streaming Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Streaming Lead Target',
      );
...
export const frontendStreamingLeadAgent = Object.freeze(
  new FrontendStreamingLeadAgent(),
);
