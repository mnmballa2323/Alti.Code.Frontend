...
class FrontendSecurityLeadAgent extends GeminiCliBaseAgent {
    ...
    async generateFrontendSecuritySystem(objective) {
        logger.info(`💻 [FrontendSecurityLeadAgent] Analyzing Frontend Security Lead specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Frontend Security Lead Target");
...
export const frontendSecurityLeadAgent = Object.freeze(new FrontendSecurityLeadAgent());
