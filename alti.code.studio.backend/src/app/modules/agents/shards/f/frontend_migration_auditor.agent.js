...
class FrontendMigrationAuditorAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendMigrationSystem(objective) {
    logger.info(
      `💻 [FrontendMigrationAuditorAgent] Analyzing Frontend Migration Auditor specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Migration Auditor Target',
      );
...
export const frontendMigrationAuditorAgent = Object.freeze(
  new FrontendMigrationAuditorAgent(),
);
