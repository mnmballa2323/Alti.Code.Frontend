...
class FrontendOptimizationLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendOptimizationSystem(objective) {
    logger.info(
      `💻 [FrontendOptimizationLeadAgent] Analyzing Frontend Optimization Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Optimization Lead Target',
      );
...
export const frontendOptimizationLeadAgent = Object.freeze(
  new FrontendOptimizationLeadAgent(),
);
