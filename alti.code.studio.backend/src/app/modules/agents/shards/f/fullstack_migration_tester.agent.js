...
class FullStackMigrationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackMigrationSystem(objective) {
    logger.info(
      `💻 [FullStackMigrationTesterAgent] Analyzing FullStack Migration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack Migration Tester Target',
      );
...
export const fullStackMigrationTesterAgent = Object.freeze(
  new FullStackMigrationTesterAgent(),
);
