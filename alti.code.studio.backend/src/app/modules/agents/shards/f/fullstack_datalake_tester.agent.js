...
class FullStackDataLakeTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateFullStackDataLakeSystem(objective) {
        logger.info(`💻 [FullStackDataLakeTesterAgent] Analyzing FullStack DataLake Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - FullStack DataLake Tester Target");
...
export const fullStackDataLakeTesterAgent = Object.freeze(new FullStackDataLakeTesterAgent());
