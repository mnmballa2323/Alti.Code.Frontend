...
class FullStackETLManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackETLSystem(objective) {
    logger.info(
      `💻 [FullStackETLManagerAgent] Analyzing FullStack ETL Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack ETL Manager Target',
      );
...
export const fullStackETLManagerAgent = Object.freeze(
  new FullStackETLManagerAgent(),
);
