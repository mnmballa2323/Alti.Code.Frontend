...
class FrontendETLDeveloperAgent extends GeminiCliBaseAgent {
    ...
    async generateFrontendETLSystem(objective) {
        logger.info(`💻 [FrontendETLDeveloperAgent] Analyzing Frontend ETL Developer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Frontend ETL Developer Target");
...
export const frontendETLDeveloperAgent = Object.freeze(new FrontendETLDeveloperAgent());
