...
class FrontendTestingEngineerAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendTestingSystem(objective) {
    logger.info(
      `💻 [FrontendTestingEngineerAgent] Analyzing Frontend Testing Engineer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Testing Engineer Target',
      );
...
export const frontendTestingEngineerAgent = Object.freeze(
  new FrontendTestingEngineerAgent(),
);
