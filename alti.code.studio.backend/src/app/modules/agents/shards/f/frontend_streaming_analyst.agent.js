...
class FrontendStreamingAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendStreamingSystem(objective) {
    logger.info(
      `💻 [FrontendStreamingAnalystAgent] Analyzing Frontend Streaming Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Streaming Analyst Target',
      );
...
export const frontendStreamingAnalystAgent = Object.freeze(
  new FrontendStreamingAnalystAgent(),
);
