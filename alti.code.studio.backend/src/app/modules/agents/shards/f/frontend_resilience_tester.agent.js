...
class FrontendResilienceTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendResilienceSystem(objective) {
    logger.info(
      `💻 [FrontendResilienceTesterAgent] Analyzing Frontend Resilience Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Resilience Tester Target',
      );
...
export const frontendResilienceTesterAgent = Object.freeze(
  new FrontendResilienceTesterAgent(),
);
