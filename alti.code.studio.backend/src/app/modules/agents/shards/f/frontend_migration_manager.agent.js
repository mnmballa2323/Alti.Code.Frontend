...
class FrontendMigrationManagerAgent extends GeminiCliBaseAgent {
    ...
    async generateFrontendMigrationSystem(objective) {
        logger.info(`💻 [FrontendMigrationManagerAgent] Analyzing Frontend Migration Manager specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - Frontend Migration Manager Target");
...
export const frontendMigrationManagerAgent = Object.freeze(new FrontendMigrationManagerAgent());
