...
class FullStackScalingTesterAgent extends GeminiCliBaseAgent {
    ...
    async generateFullStackScalingSystem(objective) {
        logger.info(`💻 [FullStackScalingTesterAgent] Analyzing FullStack Scaling Tester specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - FullStack Scaling Tester Target");
...
export const fullStackScalingTesterAgent = Object.freeze(new FullStackScalingTesterAgent());
