...
class FullStackETLAnalystAgent extends GeminiCliBaseAgent {
    ...
    async generateFullStackETLSystem(objective) {
        logger.info(`💻 [FullStackETLAnalystAgent] Analyzing FullStack ETL Analyst specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - FullStack ETL Analyst Target");
...
export const fullStackETLAnalystAgent = Object.freeze(new FullStackETLAnalystAgent());
