...
class FullStackETLDesignerAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackETLSystem(objective) {
    logger.info(
      `💻 [FullStackETLDesignerAgent] Analyzing FullStack ETL Designer specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack ETL Designer Target',
      );
...
export const fullStackETLDesignerAgent = Object.freeze(
  new FullStackETLDesignerAgent(),
);
