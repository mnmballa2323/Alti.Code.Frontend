...
class FullStackCachingPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackCachingSystem(objective) {
    logger.info(
      `💻 [FullStackCachingPlannerAgent] Analyzing FullStack Caching Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack Caching Planner Target',
      );
...
export const fullStackCachingPlannerAgent = Object.freeze(
  new FullStackCachingPlannerAgent(),
);
