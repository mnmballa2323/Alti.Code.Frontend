...
class FrontendMigrationTesterAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendMigrationSystem(objective) {
    logger.info(
      `💻 [FrontendMigrationTesterAgent] Analyzing Frontend Migration Tester specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Migration Tester Target',
      );
...
export const frontendMigrationTesterAgent = Object.freeze(
  new FrontendMigrationTesterAgent(),
);
