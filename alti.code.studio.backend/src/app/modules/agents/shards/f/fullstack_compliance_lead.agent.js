...
class FullStackComplianceLeadAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackComplianceSystem(objective) {
    logger.info(
      `💻 [FullStackComplianceLeadAgent] Analyzing FullStack Compliance Lead specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack Compliance Lead Target',
      );
...
export const fullStackComplianceLeadAgent = Object.freeze(
  new FullStackComplianceLeadAgent(),
);
