...
class FrontendAnalyticsPlannerAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendAnalyticsSystem(objective) {
    logger.info(
      `💻 [FrontendAnalyticsPlannerAgent] Analyzing Frontend Analytics Planner specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Analytics Planner Target',
      );
...
export const frontendAnalyticsPlannerAgent = Object.freeze(
  new FrontendAnalyticsPlannerAgent(),
);
