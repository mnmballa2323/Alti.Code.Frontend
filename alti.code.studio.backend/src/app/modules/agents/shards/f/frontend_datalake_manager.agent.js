...
class FrontendDataLakeManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendDataLakeSystem(objective) {
    logger.info(
      `💻 [FrontendDataLakeManagerAgent] Analyzing Frontend DataLake Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend DataLake Manager Target',
      );
...
export const frontendDataLakeManagerAgent = Object.freeze(
  new FrontendDataLakeManagerAgent(),
);
