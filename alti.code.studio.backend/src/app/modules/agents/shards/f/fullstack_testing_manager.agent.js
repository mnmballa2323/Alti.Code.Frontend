...
class FullStackTestingManagerAgent extends GeminiCliBaseAgent {
  ...
  async generateFullStackTestingSystem(objective) {
    logger.info(
      `💻 [FullStackTestingManagerAgent] Analyzing FullStack Testing Manager specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - FullStack Testing Manager Target',
      );
...
export const fullStackTestingManagerAgent = Object.freeze(
  new FullStackTestingManagerAgent(),
);
