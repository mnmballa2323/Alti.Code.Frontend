...
class FrontendAnalyticsAnalystAgent extends GeminiCliBaseAgent {
  ...
  async generateFrontendAnalyticsSystem(objective) {
    logger.info(
      `💻 [FrontendAnalyticsAnalystAgent] Analyzing Frontend Analytics Analyst specifications...`,
    );
    ...
    try {
      const output = await this._invoke(
        prompt,
        'N/A - Frontend Analytics Analyst Target',
      );
...
export const frontendAnalyticsAnalystAgent = Object.freeze(
  new FrontendAnalyticsAnalystAgent(),
);
