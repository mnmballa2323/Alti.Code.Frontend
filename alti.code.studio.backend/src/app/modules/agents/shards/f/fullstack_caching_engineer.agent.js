...
class FullStackCachingEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateFullStackCachingSystem(objective) {
        logger.info(`💻 [FullStackCachingEngineerAgent] Analyzing FullStack Caching Engineer specifications...`);
        ...
        try {
            const output = await this._invoke(prompt, "N/A - FullStack Caching Engineer Target");
...
export const fullStackCachingEngineerAgent = Object.freeze(new FullStackCachingEngineerAgent());
