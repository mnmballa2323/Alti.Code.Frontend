...
class FpgaHdlEngineerAgent extends GeminiCliBaseAgent {
    ...
    async generateHardwareDescription(softwareAlgorithm) {
        logger.info(`🔌 [FpgaHdlEngineer] Translating software algorithm into Hardware Description Language (HDL)...`);
...
${softwareAlgorithm}
        ...
        try {
            ...
            logger.error(`❌ [FpgaHdlEngineer] Failed to generate HDL: ${err.message}`);
            throw err;
        }
    }
}
