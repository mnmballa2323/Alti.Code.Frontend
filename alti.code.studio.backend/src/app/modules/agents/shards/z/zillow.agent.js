...
class ZillowAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Real estate data specialist for Zillow: Bridge Interactive API (MLS listings, property details, Zestimate AVM), rental listing data, Walk Score API for walkability, and real estate market trends for PropTech applications.';
...
export const zillowAgent = Object.freeze(new ZillowAgent());
