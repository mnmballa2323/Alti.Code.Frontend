...
class HuggingfaceHubAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Machine Learning inference expert handling HuggingFace Transformers pipelines, LoRA fine-tuning parameter math, vLLM continuous batching, and GGUF quantization.';
...
export const huggingfaceHubAgent = Object.freeze(new HuggingfaceHubAgent());
