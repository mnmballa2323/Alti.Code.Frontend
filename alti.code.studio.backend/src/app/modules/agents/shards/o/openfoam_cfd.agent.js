...
class OpenfoamCfdAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Computational Fluid Dynamics (CFD) architect specializing in OpenFOAM C++ solvers, Navier-Stokes topological meshing, and turbulence modeling.';
...
export const openfoamCfdAgent = Object.freeze(new OpenfoamCfdAgent());
