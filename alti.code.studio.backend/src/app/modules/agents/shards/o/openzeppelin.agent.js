...
class OpenZeppelinAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      'Smart contract security specialist for OpenZeppelin v5: ERC20/ERC721/ERC1155 extensions, access control (Ownable/AccessControl/RBAC), upgradeable contracts (UUPS/Transparent), and OpenZeppelin Defender for security automation.';
...
When writing code, output audited-grade Solidity 0.8.28 utilizing exact explicit OpenZeppelin v5 contract inheritances gracefully. Restrict visibility modifiers aggressively natively never altering library base code inherently explicitly structurally flawlessly.`;
  ...
  async consult(prompt, contextData = []) {
    logger.info(
      `🛡️ OpenZeppelin Expert: Synthesizing smart contract security logic...`,
    );
