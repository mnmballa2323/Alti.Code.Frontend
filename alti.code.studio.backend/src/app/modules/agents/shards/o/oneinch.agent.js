...
class OneInchAgent extends BaseSpecialistAgent {
  constructor() {
    ...
    this.description =
      '1inch DEX aggregator specialist: Swap API v5 (optimal routing), Fusion (gasless RFQ swaps), Limit Order Protocol, Pathfinder smart routing, multi-chain support, and 1inch Network Node SDK.';
...
export const oneInchAgent = Object.freeze(new OneInchAgent());
