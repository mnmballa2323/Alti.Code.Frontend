...
router.get(
  '/groups/:groupId/issues_statistics',
  GitlabController.getGroupIssuesStatistics,
);
router.get(
  '/projects/:projectId/issues_statistics',
  GitlabController.getProjectIssuesStatistics,
);

router.get(
  '/application/statistics',
  GitlabController.getApplicationStatistics,
);
...
router.post(
  '/projects/:projectId/hooks/:hookId/test/:trigger',
  GitlabController.testProjectHook,
);
router.get(
  '/projects/:projectId/hooks/:hookId/deliveries',
  GitlabController.listProjectHookDeliveries,
);
router.get(
  '/projects/:projectId/hooks/:hookId/deliveries/:deliveryId',
  GitlabController.getProjectHookDelivery,
);
router.post(
  '/projects/:projectId/hooks/:hookId/deliveries/:deliveryId/resubmit',
  GitlabController.resubmitProjectHookDelivery,
);

router.post(
  '/groups/:groupId/hooks/:hookId/test/:trigger',
  GitlabController.testGroupHook,
);
