...
router.get('/context', (req, res) =>
  steeringController.getActiveContext(req, res),
);
router.post('/init-defaults', (req, res) =>
  steeringController.initDefaults(req, res),
);
router.get('/:filename', (req, res) =>
  steeringController.getSteering(req, res),
);
router.put('/:filename', (req, res) =>
  steeringController.updateSteering(req, res),
);
router.delete('/:filename', (req, res) =>
  steeringController.deleteSteering(req, res),
);
