...
class SteeringController {
    ...
    async createSteering(req, res) {
        try {
            ...
            const file = await steeringService.createSteering(name, content, { scope, inclusion, filePatterns });
    ...
    async updateSteering(req, res) {
        try {
            ...
            const file = await steeringService.updateSteering(req.params.filename, content, metaPatch);
            res.json({ success: true, file });
        } catch (err) {
    ...
    async deleteSteering(req, res) {
        try {
            ...
            res.json({ success: true, message: `Steering file ${req.params.filename} deleted.` });
        } catch (err) {
    ...
    async initDefaults(req, res) {
        try {
            ...
            res.json({ success: true, message: 'Default steering files initialized.' });
        } catch (err) {
