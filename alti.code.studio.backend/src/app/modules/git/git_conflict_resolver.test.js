...
describe('GitConflictResolverService Tests', () => {
    ...
    it('should skip resolving if no conflict markers exist', async () => {
        ...
        const result = await gitConflictResolverService.resolveConflicts(cleanContent, 'src/index.js');
...
console.log(a, b);
        ...
        const result = await gitConflictResolverService.resolveConflicts(conflictingContent, 'src/app.js');
