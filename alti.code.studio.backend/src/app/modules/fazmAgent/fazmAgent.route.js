...
// ─── Public Endpoints ───
router.get('/v1/vertex/jwks', FazmAgentController.jwks);

router.get('/.well-known/openid-configuration', FazmAgentController.oidcConfig);
...
router.post('/api/auth/magic-link/verify', FazmAgentController.verifyMagicLink);
