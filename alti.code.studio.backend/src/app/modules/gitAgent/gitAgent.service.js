...
const commitChanges = async (message, { skipStage = false } = {}) => {
    ...
    try {
        ...
        const sha = await gitIsomorphic.commit({
            ...
            author: { name: 'Alti.Code.Studio Agent', email: 'agent@alti.code.studio' }
        });
...
const initializeRepository = async (repoName, description = '', isPrivate = true) => {
    ...
    const readmeContent = `# ${repoName}\n\n${description}\n\n*This repository and architecture was autonomously generated by the Alti.Code.Studio Genesis Engine.*`;
...
This Pull Request was autonomously generated by the **Alti.Code.Studio Sentinel Crawler** to resolve a confirmed vulnerability or issue in this repository.
