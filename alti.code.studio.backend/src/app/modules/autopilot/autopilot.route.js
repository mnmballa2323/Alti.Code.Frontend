...
router.post('/heartbeat', (req, res) =>
  autopilotController.processHeartbeat(req, res),
);
...
router.post('/sessions', (req, res) =>
  autopilotController.launchSession(req, res),
);
router.get('/sessions', (req, res) =>
  autopilotController.listSessions(req, res),
);
router.get('/sessions/:id', (req, res) =>
  autopilotController.getSession(req, res),
);

// Supervised mode controls
router.post('/sessions/:id/approve', (req, res) =>
  autopilotController.approveHunk(req, res),
);
router.post('/sessions/:id/reject', (req, res) =>
  autopilotController.rejectHunk(req, res),
);
router.post('/sessions/:id/interrupt', (req, res) =>
  autopilotController.interruptSession(req, res),
);
router.post('/sessions/:id/revert', (req, res) =>
  autopilotController.revertSession(req, res),
);
