...
3. Enforce surgical code updates — every line touched must serve a direct mathematical or functional purpose.
  ...
  },
  {
    name: 'yc_security',
    description:
      'Zero-Trust SaaS Security and Credentials Auditor Prompt Instructions',
    systemInstruction: `
...
3. Prevent SQL injection via parameterized queries and XSS via high-grade input sanitization.
  ...
  },
  {
    name: 'yc_qa',
    description:
      'Comprehensive Test Suite and Quality Gate Prompt Instructions',
    systemInstruction: `
...
export async function seedInitialSkills() {
  logger.info(
    '🔌 [SkillOptSeeder] Bootstrapping Skill Catalog catalyst seeding...',
  );
  try {
    ...
    logger.info(
      '✅ [SkillOptSeeder] Skill Catalog bootstrapped successfully with 4 core developer agents.',
    );
  } catch (err) {
