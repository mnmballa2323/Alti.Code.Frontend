...
export const schemaTool = {
  name: 'manage_schema',
  description:
    'Modify the database schema using natural language options. Generates and applies SQL migrations.',
  inputSchema: {
    type: 'object',
    properties: {
      description: {
        type: 'string',
        description:
          "Description of the schema change (e.g., 'Add a Users table with email and password').",
      },
    },
