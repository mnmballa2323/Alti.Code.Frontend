...
export const devopsTool = {
  ...
  description:
    'Generates CI/CD deployment pipelines (e.g., GitHub Actions) and container setups (Docker Compose) targeting a specific cloud provider.',
  inputSchema: {
    type: 'object',
    properties: {
      provider: {
      ...
      region: {
        type: 'string',
        description:
          'Optional cloud region (e.g., us-central1, us-east-1). Defaults to provider generic.',
      },
    },
    required: ['provider'],
  },
    ...
    try {
      ...
      return {
        ...
        content: [
          {
            type: 'text',
            text: `❌ Failed to generate DevOps pipeline: ${error.message}`,
          },
        ],
      };
    }
