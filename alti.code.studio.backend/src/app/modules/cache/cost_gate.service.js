...
class CostGateService {
    ...
    setBudgetCeiling(ceiling) {
        ...
        logger.info(`💰 CostGate: Custom budget ceiling updated to: $${ceiling.toFixed(2)}`);
    }
    ...
    checkBudget(promptText) {
        ...
        logger.debug(`CostGate: Budget check passed. Estimated potential cost: $${potentialTotal.toFixed(4)}`);
    }
    ...
    recordSessionCost(promptText, responseText) {
        ...
        logger.info(`💰 CostGate: Recorded query cost: $${queryCost.toFixed(4)}. Total Session Cost: $${this.runningCost.toFixed(4)}`);
