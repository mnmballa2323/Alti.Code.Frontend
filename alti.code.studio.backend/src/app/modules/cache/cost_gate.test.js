...
describe('CostGateService Tests', () => {
    ...
    it('should record query cost and accumulate total costs correctly', () => {
        const queryCost = costGateService.recordSessionCost('Short prompt', 'Response text');
    ...
    it('should throw an error and block execution when budget ceiling is exceeded', () => {
        ...
        expect(() => {
            costGateService.checkBudget('Very long prompt that will exceed the extremely low budget ceiling limit.');
