...
if (resourcesPkg.Resource) {
  ...
  if (resourcesPkg.default)
    logger.info(
      'OTel Resources Default Keys:',
      Object.keys(resourcesPkg.default),
    );
  ...
  logger.warn(
    '⚠️ Could not find Resource constructor in @opentelemetry/resources. Using empty resource.',
  );
