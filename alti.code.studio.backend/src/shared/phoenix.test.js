...
describe('The Phoenix Protocol (Phase 17 - Autonomous Self-Healing)', () => {
    ...
    it('should intercept a fatal crash, extract the localized function, and synthesize a codebase patch', async () => {
        ...
        const result = await phoenixService.handleFatalCrash(fatalError, 'uncaughtException');
        ...
        expect(astService.extractFunction).toHaveBeenCalledWith(mockSourceCode, 'getUserProfile');
        ...
        expect(geminiPrompt).toContain('TypeError: Cannot read properties of undefined');
