...
describe('Real-Time Reverse Engineering (Phase 25 - The Demystifier)', () => {
    ...
    at processTicksAndRejections (node:internal/process/task_queues:96:5)`;
        ...
        const expectedTranslation = "The crash occurred because the codebase attempted to call `.toLowerCase()` on an array element inside `obj.payload`, but the payload was undefined or missing expected string properties.";
        ...
        expect(fs.readFile).toHaveBeenCalledWith('/mock/node_modules/weird-package/dist/index.min.js', 'utf8');
        ...
        expect(GeminiAiService.generateContent.mock.calls[0][0]).toContain('toLowerCase');
