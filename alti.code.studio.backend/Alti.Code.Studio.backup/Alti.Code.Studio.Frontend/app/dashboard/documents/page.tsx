...
function DocumentsPage() {
  ...
  return (
    <div className="w-full h-full p-6 relative" style={{ pointerEvents: 'auto' }}>
        ...
        <div className="flex items-center gap-5">
          {history.length > 0 ? (
            <div className="flex gap-5">
              <Button className="bg-default-100 text-black" onClick={handleCreateFile}>
                Create file
              </Button>
              <Button className="bg-default-100 text-black" onClick={handleFileFocus}>
                Upload file
              </Button>
              <input
                ref={inputRef}
      ...
      {isModelOpen && (
        <div className="fixed inset-0 flex justify-center items-center z-50">
          ...
          <div className="bg-default-50 rounded-xl p-4 w-full max-w-md shadow-lg relative flex flex-col gap-6 z-10">
            ...
            <Input label="Folder Name" variant="bordered" size="sm" />
