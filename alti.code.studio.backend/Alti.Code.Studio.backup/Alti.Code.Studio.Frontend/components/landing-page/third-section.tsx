...
function ThirdSection() {
  const items = [
    ...
    },
    {
      ...
      des: "Experience true end-to-end automation that transforms requirements into production ready code without manual intervention. Our multi-step reasoning engine breaks down complex features, considers edge cases, and handles the complete development workflow including planning, coding, testing, documentation, and deployment to the cloud of your choice, while maintaining enterprise-grade security and scalability standards throughout the entire process.",
      bulletsTitle: [
      ...
      bulletDesc: [
        ...
        "Plan, code, test, document, and deploy with end-to-end automation for complete development.",
    ...
    },
    {
      ...
      des: "Built on claude technology with intelligent routing for optimal speed and performance across many native tool integrations including GitHub, Jira, AWS, and Kubernetes. Enterprise-grade security features SOC 2 compliance, encrypted storage, and flexible on-premises deployment options. Simple configuration lets you define standards, approval workflows, and deployment rules that align perfectly with your organization's governance and special requirements.",
      bulletsTitle: [
        "Select Model",
        "Tool Integrations",
        "Enterprise Security",
      ...
      bulletDesc: [
        ...
        "Native connections to GitHub, Jira, AWS, Kubernetes, and your entire toolchain.",
