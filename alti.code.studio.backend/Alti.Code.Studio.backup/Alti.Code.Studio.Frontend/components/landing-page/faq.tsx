...
const faqs = [
  ...
  },
  {
    ...
    content: "Our base pricing is $250 per user per month with a 10 user minimum. For deployments over 100 users, we offer enterprise packages with additional features like dedicated support and custom software license agreements."
  },
  {
