...
const comments: Comment[] = [
  ...
  {
    id: 3,
    author: "Thank you so much for these tips! I never thought these simple steps and trick will be so helpful!",
    content: "",
    time: "5 hours ago",
...
const similarPosts: SimilarPost[] = [
  {
    ...
    image: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=300&q=80"
  },
  {
    id: 2,
    title: "Do these every single day and you will become a more creative person",
    image: "https://images.unsplash.com/photo-1513475382585-d06e58bcb0e0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=300&q=80"
  },
  {
    id: 3,
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <article className="bg-white">
            ...
            {/* Similar Posts */}
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-6">Similar posts</h3>
