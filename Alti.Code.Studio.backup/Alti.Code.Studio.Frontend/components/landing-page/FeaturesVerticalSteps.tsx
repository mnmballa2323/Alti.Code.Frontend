                    ...
                    <div className="flex-1 text-left">
                      <div>
                        ...
                        >
                          ...
                          {Array.isArray(step.bulletsTitle) && Array.isArray(step.bulletDesc) && (
                            <ul className="mt-2 ml-4 list-disc text-xs text-default-500">
                              {step.bulletsTitle.map((bTitle:any, bIdx:any) => (
                                <li key={bIdx} className="mb-1">
                                  <span className="font-semibold text-default-700">{bTitle}</span>
                                  {step.bulletDesc && step.bulletDesc[bIdx] && (
                                    <span className="ml-1 text-default-500">- {step.bulletDesc[bIdx]}</span>
                                  )}
                                </li>
                              ))}
                            </ul>
