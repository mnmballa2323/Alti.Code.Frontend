"use client";
import { cn, type DateValue, type SharedSelection } from "@heroui/react";
import { Icon } from "@iconify/react";
import { useMemo } from "react";
import { format } from "date-fns";

import { DurationEnum, type TimeSlot } from "./calender";
  ...
  return (
    ...
    >
      ...
      <p className="mb-4 text-small text-default-500">
        See how Fortune 500 companies deploy private and secure AI chatbots
        without sending data to third party cloud provider.
      </p>
