...
import { DurationEnum, durations, type TimeSlot } from "./calender";
import CalendarTimeSelect from "./calender-time-select";
import CalendarBookingForm from "./calender-booking-form";
import CalendarBookingConfirmation from "./calender-booking-conformation";
    ...
    <div className="flex w-[393px] flex-col items-center gap-5 rounded-large bg-default-50 shadow-small lg:w-fit lg:flex-row lg:items-start lg:px-6">
      ...
      <Calendar
        ...
        classNames={{
          ...
          gridBodyRow: "gap-x-1 px-3 mb-1 first:mt-4 last:mb-0 !border-0",
          gridWrapper: "pb-3",
          cell: "p-1.5 w-full",
          cellButton:
            "w-full h-9 rounded-medium data-[selected]:shadow-[0_2px_12px_0] data-[selected]:shadow-primary-300 data-[selected]:!bg-black text-small font-medium ",
        }}
