    ...
    <section className="w-full py-32 bg-white text-black px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
        ...
        <div className="w-full flex flex-col gap-4 lg:order-1">
          <div
            className="w-full max-w-[420px] mx-auto lg:ml-0 lg:mr-auto bg-zinc-100 hover:bg-zinc-200 hover:-translate-y-1 transition-all duration-300 rounded-[32px] overflow-hidden p-6 flex flex-col gap-5 text-black min-h-[370px] relative group border"
            style={{
              borderColor: "#2563EB",
