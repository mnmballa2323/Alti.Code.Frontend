...
function FeatureCard({
  ...
  return (
    <motion.div
      className="flex flex-col items-start text-left p-8 rounded-3xl bg-zinc-100 hover:bg-zinc-200 hover:-translate-y-1 transition-all duration-300 relative group overflow-hidden border"
      style={{
        borderColor: "#2563EB",
