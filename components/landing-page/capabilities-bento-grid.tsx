    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-12 gap-4 lg:gap-4 xl:gap-5 auto-rows-auto lg:auto-rows-[150px] xl:auto-rows-[180px]">
          ...
          <motion.div
            className="col-span-12 lg:col-span-6 rounded-[32px] bg-zinc-100 hover:bg-zinc-200 px-5 py-2.5 xl:px-6 xl:py-3.5 flex flex-col lg:flex-row gap-5 lg:gap-6 justify-between items-center transition-all duration-500 overflow-hidden relative group border"
            style={{
              borderColor: "#2563EB",
          ...
          >
            ...
            <div className="flex-1 bg-[#050015] border border-zinc-200 rounded-2xl p-2 xl:p-2.5 font-mono text-[9px] xl:text-[10px] text-zinc-600 flex flex-col justify-between shadow-inner select-none w-full max-w-sm relative z-10">
              <div className="flex items-center gap-1.5 pb-1.5 border-b border-zinc-200 text-zinc-500">
                ...
                <span className="w-2 h-2 rounded-full bg-blue-900/50" />
                <span className="w-2 h-2 rounded-full bg-blue-900/50" />
                <span className="ml-2">ipc_stream::localhost:5001</span>
              </div>
              <div>
          ...
          <motion.div
            className="col-span-12 sm:col-span-6 lg:col-span-3 rounded-[32px] bg-zinc-100 hover:bg-zinc-200 px-5 py-2.5 xl:px-6 xl:py-3.5 flex flex-col justify-center transition-all duration-500 overflow-hidden relative group border"
            style={{
              borderColor: "#2563EB",
              boxShadow: "0 4px 20px rgba(37, 99, 235, 0.15)",
            }}
          ...
          >
            <div className="flex flex-col gap-2 xl:gap-3 relative z-10">
              ...
              <p className="text-xs xl:text-sm text-zinc-600 leading-relaxed font-medium">
                Instead of regex matching, agents build Abstract Syntax Trees to
                surgically modify nodes with precision.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="flex flex-col gap-2 xl:gap-3 relative z-10">
              ...
              <p className="text-xs xl:text-sm text-zinc-600 leading-relaxed font-medium">
                25,000 specialist agents stay synchronized via a gossip network,
                propagating state in sub 10ms.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="flex flex-col gap-2 xl:gap-3 relative z-10">
              ...
              <p className="text-xs xl:text-sm text-zinc-600 leading-relaxed font-medium">
                Saves up to 80% on inference. Prefix caching detects identical
                requests and serves them all with zero delay.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="flex flex-col gap-2 xl:gap-3 relative z-10">
              ...
              <p className="text-xs xl:text-sm text-zinc-600 leading-relaxed font-medium">
                Our agent automatically coordinates submodules, matching
                revisions and verifying integrity across repos.
              </p>
            </div>
          </motion.div>
          ...
          {/* Card 7: SEDE */}
          <motion.div
            className="col-span-12 lg:col-span-6 rounded-[32px] bg-zinc-100 hover:bg-zinc-200 px-5 py-2.5 xl:px-6 xl:py-3.5 flex flex-col justify-center transition-all duration-500 overflow-hidden relative group border"
            style={{
              borderColor: "#2563EB",
              boxShadow: "0 4px 20px rgba(37, 99, 235, 0.15)",
            }}
          ...
          >
            <div className="flex flex-col gap-2 xl:gap-3 relative z-10">
              ...
              <p className="text-xs xl:text-sm text-zinc-600 leading-relaxed font-medium">
                The IDE works while you sleep, autonomously noticing bugs,
                writing comprehensive test cases, fixing complex issues locally,
                and seamlessly pushing fully verified commits.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="flex flex-col gap-2 xl:gap-3 relative z-10">
              ...
              <p className="text-xs xl:text-sm text-zinc-600 leading-relaxed font-medium">
                Deep native integration with Terraform and ArgoCD enables fully
                automated, highly available continuous deployment from Git,
                while managing cloud infrastructure.
              </p>
            </div>
          </motion.div>
        </div>
