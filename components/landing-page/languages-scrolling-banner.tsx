        ...
        <div className="relative w-full overflow-hidden py-4 select-none">
          ...
          <div className="flex animate-scroll-languages hover:[animation-play-state:paused] gap-6 px-4">
            {marqueeLanguages.map((lang, idx) => (
              <div
                key={idx}
                className="flex items-center gap-3.5 px-6 py-3.5 rounded-2xl bg-zinc-100 dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800/60 shadow-[0_2px_8px_rgba(0,0,0,0.01)] whitespace-nowrap group hover:bg-white dark:hover:bg-zinc-900 transition-all duration-300 cursor-pointer"
                style={
                  {
                    ...
                    boxShadow: `0 4px 20px rgba(${lang.rgb}, 0.15)`,
