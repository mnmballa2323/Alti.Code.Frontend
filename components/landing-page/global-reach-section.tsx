      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-12 items-center text-center relative z-10">
        ...
        <div className="flex flex-col gap-6 max-w-4xl w-full px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium max-w-3xl mx-auto">
            Running natively on secure, air-gapped enterprise environments, inso
            code orchestrates complex software development swarms across global
            natural languages and national compliance jurisdictions with
          ...
          >
            <div className="flex animate-scroll-left hover:[animation-play-state:paused] gap-4 px-4">
              {marqueeLanguages.map((lang, idx) => (
                <div
                  key={`lang-${idx}`}
                  className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-zinc-100 dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800/60 shadow-[0_2px_8px_rgba(0,0,0,0.01)] hover:bg-white dark:hover:bg-zinc-900 transition-all duration-300 cursor-pointer shrink-0"
                  style={{
                    borderColor: "#2563EB",
            ...
            <div className="flex animate-scroll-right hover:[animation-play-state:paused] gap-4 px-4">
              {marqueeJurisdictions.map((juri, idx) => (
                <div
                  ...
                  className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-zinc-100 dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800/60 shadow-[0_2px_8px_rgba(0,0,0,0.01)] hover:bg-white dark:hover:bg-zinc-900 transition-all duration-300 cursor-pointer shrink-0"
                  style={{
                    borderColor: juri.color,
                    boxShadow: `0 4px 20px rgba(${juri.rgb}, 0.15)`,
                  }}
                >
                  <Icon
                    className="w-5 h-5 shrink-0 object-contain rounded-full shadow-sm"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-7xl px-4 mt-8">
          ...
          <motion.div
            className="flex flex-col items-start text-left p-8 rounded-[32px] bg-zinc-100 dark:bg-zinc-900/40 hover:bg-zinc-200 dark:hover:bg-zinc-900/80 hover:-translate-y-1 transition-all duration-300 relative group overflow-hidden border"
            id="card-translation"
          ...
          >
            ...
            <p className="text-sm md:text-base text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
              Deploy sovereign code execution daemons and secure agent swarms
              inside local VPC boundaries, strictly respecting regional privacy
              constraints such as GDPR, HIPAA, and SecNumCloud for total
              isolation.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm md:text-base text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
              ...
              mapping cryptographic keys, software packages, and open-source
              licenses directly to each sovereign market's standards.
            </p>
          </motion.div>
        </div>
      </div>
