...
export function RegisterModal() {
  ...
  const handleVerifyOtp = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await signIn("credentials", {
        redirect: false,
        email,
        password: otp, // Temporarily passing OTP as password until backend is fully hooked up
        isOtpFlow: true,
      });
  ...
  return (
    ...
    >
      ...
      >
        <DialogTitle className="sr-only" id="register-title">
          Register
        </DialogTitle>
