                ...
                <div className="flex flex-col gap-8">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    >
                      ...
                      <SelectItem key="gemini-3.6-flash">
                        Gemini 3.6 Flash
                      </SelectItem>
                      ...
                      <SelectItem key="grok-4.1-fast">Grok 4.1 Fast</SelectItem>
                      <SelectItem key="grok-4.20">Grok 4.20</SelectItem>
                      <SelectItem key="llama-3.1">Llama 3.1</SelectItem>
                      <SelectItem key="llama-3.2">Llama 3.2</SelectItem>
                      <SelectItem key="llama-3.3">Llama 3.3</SelectItem>
                      <SelectItem key="llama-4">Llama 4</SelectItem>
                      <SelectItem key="code-llama">Code Llama</SelectItem>

                      <SelectItem key="codestral-2">Codestral 2</SelectItem>
                    </Select>
                  </div>
