...
export default function CloudProviderDashboard({
  ...
  const credentialCategories = [
    {
      ...
      items: [
        {
          name: "Production App",
          key: "sk-prod-8f92...a1b2",
          full: "sk-prod-8f92je83mf9201ma1b2",
          date: "Created Mar 12, 2026",
        },
        {
          name: "Development Bot",
          key: "sk-dev-44x1...p9q0",
          full: "sk-dev-44x1ldo93mc847p9q0",
    ...
    },
    {
      ...
      items: [
        {
          name: "Billing Sync Events",
          key: "whsec_8x9...2mP",
          full: "whsec_8x9Lkj21PqM2mP",
    ...
    },
    {
      ...
      items: [
        {
          name: "michael-macbook-pro",
          key: "SHA256:d8a9f.../x1b",
          full: "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABgQC...",
          date: "Last used 2 days ago",
        },
        {
          name: "ci-cd-runner",
          key: "SHA256:a91mP.../z9q",
          full: "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAI...",
          date: "Last used 10 mins ago",
        },
      ],
    },
  ];
  ...
  return (
    <div className="w-full max-w-6xl mx-auto space-y-8 pb-10">
      {/* Header Banner */}
      <div
        className={`relative w-full h-32 rounded-2xl overflow-hidden flex items-center px-8 border border-neutral-200 dark:border-neutral-800 bg-gradient-to-r from-white to-neutral-50 dark:from-neutral-900 dark:to-neutral-900/50`}
      >
        <div
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          ...
          <div
            key={i}
            className="bg-white dark:bg-neutral-900 rounded-2xl p-5 border border-neutral-200 dark:border-neutral-800 shadow-sm flex flex-col justify-between"
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <div
                className={`p-2 rounded-lg bg-neutral-50 dark:bg-neutral-800 text-${themeColorClass}`}
              >
              ...
              <table className="w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-neutral-100 dark:divide-neutral-800/50">
                  {mockModels.map((model, i) => (
                    ...
                    >
                      <td className="px-5 py-4 font-medium text-neutral-900 dark:text-neutral-200">
                        {model.name}
                      </td>
                      <td className="px-5 py-4 text-neutral-600 dark:text-neutral-400">
                        {model.tokens}
                      </td>
                      <td className="px-5 py-4 text-neutral-900 dark:text-white font-semibold text-right">
                        {model.spend}
                      </td>
                    </tr>
                  ))}
        ...
        <div className="space-y-4">
          <div className="mb-2">
            ...
            <p className="text-sm text-neutral-500 mt-1">
              Manage all authentication and connection secrets for this
              provider.
            </p>
          </div>
                    ...
                    {category.items.length === 0 ? (
                      <div className="text-center py-6 bg-neutral-50 dark:bg-neutral-950 rounded-xl border border-neutral-200 dark:border-neutral-800 border-dashed">
                        <p className="text-sm text-neutral-500">
                          No {category.title.toLowerCase()} configured.
                        </p>
                      </div>
                    ) : (
                      category.items.map((item, i) => {
                        ...
                        return (
                          <div
                            key={i}
                            className="flex items-center justify-between p-4 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-950"
                          >
                            <div>
                            ...
                            <div className="flex items-center gap-1">
                              <button
                                ...
                                onClick={() =>
                                  setShowKey(
                                    showKey === uniqueId ? null : uniqueId,
                                  )
                                }
                              >
