...
function PromptInputFullLineComponent({
  ...
  leftActionsOverride?: React.ReactNode;
  showModelDropdown?: boolean;
  showRagToggle?: boolean;
  singleHeight?: boolean;
}) {
    ...
    const fetchCustomAgents = async () => {
      try {
        const res = await axios.get(
          `${process.env.NEXT_PUBLIC_API_URL || "http://localhost:5001/api/v1"}/agents/custom`,
  ...
  return (
    <>
      {queuedMessages.length > 0 && (
        <div className="mx-auto w-full max-w-4xl flex flex-col mb-4 overflow-hidden bg-content2 dark:bg-content1 rounded-lg border border-default-200 shadow-lg relative z-50">
      ...
      {singleHeight ? (
        ...
        >
          ...
          <input
            ref={inputRef as any}
            autoFocus
            className="flex-1 bg-transparent text-[14px] leading-normal font-normal text-foreground placeholder:text-zinc-400 placeholder:font-normal py-0 px-2 border-none outline-none focus:outline-none focus:ring-0 focus-visible:ring-0 shadow-none min-w-0"
            name="content"
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  className="inso-send-btn bg-[#161b22] text-white hover:bg-[#161b22]/90 dark:bg-primary dark:text-primary-foreground shadow-sm size-7 flex items-center justify-center rounded-md transition-all cursor-pointer"
                  type="button"
        ...
        >
          ...
          <div className="flex w-full flex-row items-center justify-between px-4 pb-3 pt-2 mt-1 border-t border-gray-200/50 dark:border-zinc-800/30 min-h-[44px]">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {showModelDropdown && (
                    ...
                    >
                      <DropdownTrigger>
                        <button
                          className="group flex items-center justify-center gap-1.5 px-2.5 h-[28px] rounded-md text-[12px] font-normal transition-all cursor-pointer bg-gray-100 dark:bg-gray-800/50 text-gray-500 dark:text-gray-400 border border-transparent dark:border-white/5 hover:bg-gray-200 dark:hover:bg-gray-700/50 hover:text-gray-900 dark:hover:text-white shrink-0 outline-none"
                          type="button"
                        >
                      ...
                      >
                        ...
                        {(mockCloudProvider === "gcp" ||
                          ...
                          <DropdownSection
                            classNames={{
                              heading:
                                "text-[10px] font-bold tracking-wider text-zinc-500 uppercase px-2 mb-1 mt-1",
                            }}
                            title="Google Gemini"
                          >
                            <DropdownItem
                        ...
                        <DropdownSection
                          classNames={{
                            heading:
                              "text-[10px] font-bold tracking-wider text-zinc-500 uppercase px-2 mb-1 mt-2.5",
                          }}
                        ...
                        >
                          <DropdownItem
                            ...
                            onPress={() => setDefaultModel("grok-4.1-fast")}
                          >
                            Grok 4.1 Fast
                          </DropdownItem>
                          <DropdownItem
                            ...
                            onPress={() => setDefaultModel("grok-4.20")}
                          >
                            Grok 4.20
                          </DropdownItem>
                        </DropdownSection>
                        ...
                        >
                          <DropdownItem
                            ...
                            onPress={() => setDefaultModel("llama-3.1")}
                          >
                            Llama 3.1
                          </DropdownItem>
                          <DropdownItem
                            ...
                            onPress={() => setDefaultModel("llama-3.2")}
                          >
                            Llama 3.2
                          </DropdownItem>
                          <DropdownItem
                            ...
                            onPress={() => setDefaultModel("llama-3.3")}
                          >
                            Llama 3.3
                          </DropdownItem>
                          <DropdownItem
                            ...
                            onPress={() => setDefaultModel("llama-4")}
                          >
                            Llama 4
                          </DropdownItem>
                          <DropdownItem
                            ...
                            onPress={() => setDefaultModel("code-llama")}
                          >
                            Code Llama
                          </DropdownItem>
                        </DropdownSection>
                        ...
                        >
                          <DropdownItem
                            ...
                            onPress={() => setDefaultModel("codestral-2")}
                          >
                            Codestral 2
                          </DropdownItem>
                        </DropdownSection>
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <input
                            readOnly
                            checked={selectedRagSources.includes(
                              "knowledge_hub",
                            )}
                            className="rounded border-gray-300 text-primary focus:ring-primary size-3.5"
                            type="checkbox"
  ...
  return (
    <div className="flex w-full flex-col gap-4 px-4 pb-6 mb-2 !z-50">
      <PromptInputFullLineComponent
        ...
        leftActionsOverride={leftActionsOverride}
        placeholder={placeholder}
        prompt={prompt}
