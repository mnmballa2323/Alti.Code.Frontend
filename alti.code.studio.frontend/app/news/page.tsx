  ...
  return (
    <>
      <Head>
        ...
        <meta
          content="A modern blog about productivity, creativity, and travel"
          name="description"
        />
        ...
        <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="space-y-6">
            {blogPosts.map((post, index) => (
              <article
                key={post.id}
                className={`bg-white rounded-none shadow-none pb-6 ${index < blogPosts.length - 1 ? "border-b border-gray-100" : ""}`}
              >
