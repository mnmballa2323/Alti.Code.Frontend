...
function FunctionsPageContent() {
  ...
  const fetchFunctions = useCallback(async () => {
    ...
    try {
      ...
      if (res.data?.success) {
        ...
        window.dispatchEvent(new CustomEvent("sync-functions", { detail: list }));
  ...
  useEffect(() => {
    ...
    window.addEventListener("select-function", handleSelectFunction);
    window.addEventListener("new-function", handleNewFunction);

    return () => {
      window.removeEventListener("select-function", handleSelectFunction);
      window.removeEventListener("new-function", handleNewFunction);
    };
  }, []);
