            ...
            <div className="w-full border-t border-neutral-900 pt-8 text-left">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-sm text-neutral-200">Run the Installer</h3>
                    <p className="text-xs text-neutral-400 mt-1 leading-relaxed">
                      Locate <code className="bg-neutral-900 px-1.5 py-0.5 rounded border border-neutral-800 font-mono text-[10px] text-indigo-300">Alti-Code-Studio-setup.exe</code> in your Downloads folder and double-click it.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-sm text-neutral-200">Follow Steps</h3>
                    <p className="text-xs text-neutral-400 mt-1 leading-relaxed">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-sm text-neutral-200">Launch Alti Code Studio</h3>
                    <p className="text-xs text-neutral-400 mt-1 leading-relaxed">
