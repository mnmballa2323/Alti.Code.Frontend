...
const MCP_REPOS = [
  {
    name: "servers",
    description:
      "Official reference implementations for databases, developer tools, and filesystem servers.",
  ...
  },
  {
    name: "typescript-sdk",
    description:
      "Official TypeScript/JavaScript SDK to build custom Model Context Protocol clients and servers.",
    license: "MIT",
    lang: "TypeScript",
  ...
  },
  {
    name: "python-sdk",
    description:
      "Official Python SDK to build custom Model Context Protocol clients and servers.",
    license: "MIT",
    lang: "Python",
  ...
  },
  {
    name: "inspector",
    description:
      "Official interactive developer tool to inspect, debug, and trace MCP connections.",
    license: "MIT",
    lang: "TypeScript",
  ...
  },
  {
    ...
    description:
      "Official protocol specifications, schema definitions, and enhancement proposals (SEPs).",
    license: "MIT",
    lang: "Markdown / JSON",
  ...
  },
  {
    name: "go-sdk",
    description:
      "Official Go SDK to build custom Model Context Protocol clients and servers.",
    license: "MIT",
    lang: "Go",
  ...
  },
  {
    name: "rust-sdk",
    description:
      "Official Rust SDK to build custom Model Context Protocol clients and servers.",
    license: "MIT",
    lang: "Rust",
  ...
  },
  {
    name: "ext-auth",
    description:
      "Official supplementary specification defining authorization mechanisms for MCP connections.",
    license: "Apache 2.0",
    lang: "Specification",
...
export default function ConnectAppsPage() {
  ...
  const [idleTab, setIdleTab] = useState<"action-hub" | "mcp-explorer">(
    "action-hub",
  );
                    ...
                    <>
                      <div className="flex flex-col items-center gap-4">
                        ...
                        <p className="text-sm text-default-500 max-w-md leading-relaxed">
                          Connect and prompt individual web applications
                          securely. Select an application in the sidebar to
                          configure authentication and interact with its tools
                          in a focused, zero-hallucination agent session.
                        </p>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full text-left">
                        ...
                        <div className="p-5 border border-default-200 dark:border-default-100/50 rounded-2xl flex flex-col gap-2.5 bg-[#f4f4f5]/30 dark:bg-default-50/5 hover:border-default-300 dark:hover:border-default-100 transition-all">
                          ...
                          <p className="text-xs text-default-500 leading-normal">
                            SOC2/HIPAA compliant architecture. Zero data
                            retention and strict no-training policies enforced.
                          </p>
                        </div>
                      </div>
                    </>
                    ...
                    <div className="w-full flex flex-col gap-6 text-left">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-xs text-default-500 max-w-2xl leading-relaxed">
                          Browse and integrate official, secure repositories
                          directly from the{" "}
                          <a
                          ...
                          organization. All reference packages are fully
                          licensed under Apache-2.0 or MIT for open enterprise
                          deployment.
                        </p>
                      </div>
                          ...
                          >
                            <div className="flex items-start justify-between">
                              <div className="flex items-center gap-2.5">
                                <div
                                  className={`w-8 h-8 rounded-lg bg-gradient-to-br ${repo.color} flex items-center justify-center text-white text-base shadow-sm`}
                                >
                                  <Icon icon={repo.icon} />
                                </div>
                                <div className="flex flex-col">
                                  ...
                                  >
                                    <span>{repo.name}</span>
                                    <Icon
                                      className="rotate-90 text-[10px]"
                                      icon="solar:arrow-left-up-bold"
                                    />
                                  </a>
                  ...
                  <div className="w-full p-8 border border-default-200 dark:border-default-100/50 bg-[#F9F9FB]/50 dark:bg-[#0E0E10]/30 rounded-3xl shadow-sm flex flex-col items-center text-center gap-6">
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <p className="text-xs text-default-500 leading-relaxed px-2">
                        ...
                        {selectedApp.name} actions directly within Alti.
                      </p>
                    </div>
