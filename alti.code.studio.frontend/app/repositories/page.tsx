          ...
          <div className="w-full max-w-2xl flex flex-col gap-8">
            <div className="bg-danger-50/50 dark:bg-danger-500/10 border-l-4 border-danger p-4 rounded-r-xl">
              ...
              <p className="text-danger-800 dark:text-danger-200 text-xs font-medium">
                The entire system MUST strictly adhere to the Tri-Cloud Inference Strategy. There are absolutely NO EXCEPTIONS. Direct SDK connections to foundational models are blocked and forbidden for security reasons. Repository syncs enforce this at all layers.
              </p>
            </div>
