              ...
              <AnimatePresence>
                {previewUrl && (
                  <motion.div
                    ...
                    className="w-full flex flex-col gap-2.5 pt-2"
                  >
                    <style
                    ...
                    <div className="w-full rounded-2xl border border-default-200 dark:border-default-100 overflow-hidden bg-default-50/50 dark:bg-default-50/5 transition-all duration-300">
                      {previewUrl.includes("figma.com") ? (
                        ...
                        <div className="p-5 flex flex-col gap-4 bg-gradient-to-br from-indigo-500/5 to-purple-500/5 dark:from-indigo-500/10 dark:to-purple-500/10 min-h-[170px] justify-between relative group">
                          <div className="flex items-start justify-between w-full">
                            <div className="flex items-center gap-3">
                              <div className="p-2 bg-black dark:bg-[#1E1E1E] rounded-xl flex items-center justify-center shadow-md">
                                <svg width="14" height="20" viewBox="0 0 18 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div className="flex flex-col">
                                <span className="text-xs font-bold text-default-800">Figma Canvas Anchor</span>
                                <span className="text-[9px] text-default-400">Design System Anchor Node</span>
                              </div>
                            </div>
                            <span className="px-2 py-0.5 bg-indigo-500/10 text-indigo-500 dark:text-indigo-400 text-[9px] font-bold tracking-wider uppercase rounded-full border border-indigo-500/20 shadow-sm">
                              Connected
                            </span>
                          </div>

                          <div className="flex flex-col gap-1.5 border border-dashed border-default-200 dark:border-default-100 rounded-xl p-3 bg-white/40 dark:bg-black/20 backdrop-blur-sm shadow-sm select-none">
                            <div className="flex items-center gap-2">
                              <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 animate-pulse" />
                              <span className="text-[10px] font-mono text-default-600 truncate max-w-[280px]">
                                {newAssetName || "Untitled Brand Design"}
                              </span>
                            </div>
                            <div className="flex gap-2.5">
                              <div className="h-4 px-2 bg-default-100 dark:bg-default-200/50 rounded flex items-center text-[8px] text-default-400">Frame</div>
                              <div className="h-4 px-2 bg-default-100 dark:bg-default-200/50 rounded flex items-center text-[8px] text-default-400">Vector Guidelines</div>
                              <div className="h-4 px-2 bg-default-100 dark:bg-default-200/50 rounded flex items-center text-[8px] text-default-400">Typography</div>
                            </div>
                          </div>

                          <div className="flex items-center justify-between pt-1">
                            <span className="text-[9px] text-default-400 max-w-[240px] truncate font-mono">
                              {previewUrl}
                            </span>
                            <a
                              href={previewUrl}
                              ...
                              className="flex items-center gap-1 text-[9px] font-bold text-primary hover:underline transition-all"
                            >
                              Open Figma <ExternalLink size={10} />
                            </a>
                          </div>
                        </div>
                      ) : !previewError ? (
                        /* Image Preview Card (SVG/PNG/JPG) */
                        <div className="bg-checkered-grid p-6 min-h-[200px] flex items-center justify-center relative group">
                          <img
                            src={previewUrl}
                            alt={newAssetName || "Brand Asset Live Preview"}
                            className={`max-h-[160px] max-w-[90%] object-contain drop-shadow-md select-none transition-all duration-300 ${
                          ...
                          {hasImageLoaded && (
                            <div className="absolute bottom-3 right-3 px-2 py-0.5 bg-black/75 backdrop-blur-md text-white text-[9px] font-bold tracking-widest uppercase rounded-md border border-white/10 shadow-lg pointer-events-none select-none">
                        ...
                        <div className="p-4 flex items-center gap-3.5 bg-default-100/50 dark:bg-default-500/5 min-h-[80px]">
                          <div className="p-2.5 bg-default-200 dark:bg-default-100 rounded-xl text-default-500 flex items-center justify-center shadow-sm">
                            <FileText size={20} />
                          </div>
                          ...
                          <span className="px-2 py-0.5 bg-default-200 dark:bg-default-100 text-default-500 text-[8px] font-bold uppercase tracking-wider rounded-md border border-default-300/30">
                            Document
                          </span>
                        </div>
                      )}
