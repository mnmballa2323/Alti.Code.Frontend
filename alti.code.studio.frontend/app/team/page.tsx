...
export default function TeamPage() {
  ...
  return (
    <div className="flex-1 w-full min-h-screen bg-transparent px-6 pb-6 pt-0 lg:px-10 lg:pb-10 lg:pt-0 font-sans text-zinc-900 dark:text-zinc-100 overflow-y-auto relative">
      ...
      <div className="sticky top-0 z-50 max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4 mb-6 py-4 bg-[#0B1121]/95 backdrop-blur-xl border-b border-zinc-200/50 dark:border-white/5 -mx-6 px-6 lg:-mx-10 lg:px-10">
