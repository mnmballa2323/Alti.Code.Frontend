      ...
      <div className="space-y-6 pb-12">
        ...
        <div className="flex justify-center w-full border-b border-neutral-100 dark:border-neutral-800/80 pb-6 mb-2">
          <div className="flex gap-2 bg-neutral-100 dark:bg-neutral-900 p-1.5 rounded-2xl border border-neutral-200/50 dark:border-neutral-800 shrink-0 shadow-sm">
            ...
            <button
              ...
              onClick={() => setActiveTab("azure_gov")}
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {data.models.map((model) => {
            ...
            const inputRatio =
              totalStaticTokens > 0
                ? model.inputTokens / totalStaticTokens
                : 0.8;
            ...
            const coords = values.map((val, i) => {
              ...
              const y =
                yOffset + chartHeight - (val / yScaleCeiling) * chartHeight;
            ...
            const activeHover =
              isHovered && hoveredIndex !== null && hoveredIndex < values.length
                ? {
                    index: hoveredIndex,
                    x:
                      xOffset +
                    ...
                    y:
                      yOffset +
                      chartHeight -
                      (values[hoveredIndex] / yScaleCeiling) * chartHeight,
                  }
                : null;
            const activeValue = activeHover
              ? values[activeHover.index]
              : values[values.length - 1];
            const activeLabel = activeHover
                ...
                >
                  ...
                  <div className="flex gap-6 text-right sm:text-right">
                    <div>
                      ...
                      <span className="text-xs font-mono font-bold text-neutral-750 dark:text-neutral-355">
                        {model.tokensIn}
                      </span>
                    </div>
                    <div>
