    ...
    <section className="w-full py-32 bg-[#030014] text-white px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 items-center gap-16 lg:gap-24 relative z-10">
        ...
        <div className="lg:col-span-5 w-full lg:w-[130%] lg:translate-x-8">
          <div className="border border-white/10 rounded-[32px] shadow-xl p-6 md:p-8 flex flex-col gap-6 select-none relative lg:h-[460px] overflow-hidden justify-between lightning-glow-card-active">
            {/* Header */}
            ...
            <div className="relative flex-1 overflow-hidden min-h-0 py-1">
              <div className="relative flex flex-col gap-8 pl-4">
                ...
                <div className="absolute left-[34px] sm:left-[122px] top-4 bottom-4 w-[2px] bg-white/10" />
                    ...
                    >
                      ...
                      <div
                        className={`relative z-10 w-9 h-9 rounded-xl border flex items-center justify-center shrink-0 transition-all duration-300 ${
                          isHovered
                            ...
                            : "bg-[#0A0A0A] border-white/10 text-zinc-400 group-hover:border-white/30"
                        }`}
                      >
                      ...
                      <div className="flex-1 min-w-0 flex flex-col gap-1.5">
                        ...
                        {(event.rawText || event.redactedText) && (
                          <div
                            className={`mt-2 p-3.5 bg-white/5 border border-white/10 rounded-xl font-mono text-[9px] flex flex-col gap-2 overflow-hidden transition-all duration-300 ${
                              isHovered ? "border-blue-500/20 shadow-sm" : ""
                            }`}
                          >
                            {event.rawText && (
                              <div className="text-zinc-500 line-through truncate">
                                <span className="text-[8px] font-bold text-red-400 bg-red-950/40 border border-red-900/50 px-1 py-0.5 rounded mr-1.5 font-sans uppercase">
                                  Source
                                </span>
                                {event.rawText}
                              </div>
                            ...
                            {event.redactedText && (
                              <div className="text-emerald-400 font-bold truncate">
                                <span className="text-[8px] font-bold text-emerald-400 bg-emerald-950/40 border border-emerald-900/50 px-1 py-0.5 rounded mr-1.5 font-sans uppercase">
                                  Redacted
                                </span>
                                {event.redactedText}
                              </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-[#050015] to-transparent pointer-events-none z-20" />
            </div>

            {/* Footer */}
            <div className="border-t border-white/10 pt-4 flex items-center justify-between text-[10px] text-zinc-500 font-semibold font-mono shrink-0">
