...
const providers = [
  {
    ...
    models: [
      {
        name: "GPT-5.5",
        role: "DevSecOps & CISO Auditing",
        description: "Enforces data-sovereign code scans, military-grade security checks, and automated compliance auditing.",
        tags: ["CISO Audit", "Code Verification", "Compliance"],
    ...
    models: [
      {
        ...
        tags: ["TDD Loop", "Code Generation", "Local CLI"],
        metric: { label: "Speed", value: "99%" }
      },
      {
        name: "Claude Opus 4.6",
        role: "Architecture & Multi-Repo Synthesis",
        description: "Resolves complex multi-repository dependencies, deep architectural planning, and consensus logic.",
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-4">
                    {provider.models.map((model, mIdx) => (
                      <div
                        key={mIdx}
                        className="flex flex-col gap-3 p-5 rounded-2xl bg-white/70 dark:bg-black/30 border border-gray-100 dark:border-gray-900 shadow-sm hover:border-gray-200 dark:hover:border-gray-700 dark:hover:bg-black/60 transition-all duration-300"
                      >
                        ...
                        <div className="flex items-center justify-between gap-4">
                          ...
                          <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-gray-100 dark:bg-gray-900 text-gray-400 dark:text-gray-500 uppercase tracking-wider">
                        ...
                        <div className="flex flex-wrap gap-1.5 pt-1">
                          {model.tags.map((tag, tIdx) => (
                            <span
                              key={tIdx}
                              className="text-[9px] font-bold px-2 py-0.5 rounded bg-gray-100/50 dark:bg-gray-900/50 text-gray-400 dark:text-gray-500 border border-gray-100 dark:border-gray-800/30"
                            >
                              {tag}
                            </span>
                          ))}
