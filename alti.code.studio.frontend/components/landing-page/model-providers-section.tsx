...
const providers = [
  {
    ...
    glowClass: "/10 /2 ",
    borderHoverClass:
      "hover:border-zinc-300 dark:hover:border-zinc-300 hover:shadow-lg hover:shadow-orange-500/5",
    models: [
      {
  ...
  },
  {
    ...
    glowClass: "/10 /2 ",
    borderHoverClass:
      "hover:border-zinc-300 dark:hover:border-zinc-300 hover:shadow-lg hover:shadow-blue-500/5",
    models: [
      {
          ...
          {providers.map((provider, idx) => (
            <div
              ...
              className={cn(
                ...
                "bg-white/60 dark:bg-zinc-950/40 backdrop-blur-md border-zinc-200 dark:border-zinc-200 shadow-sm",
            ...
            >
              ...
              <div
                className={cn(
                  "absolute top-0 right-0 w-32 h-32 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none z-0",
                  provider.glowClass,
                )}
              />
