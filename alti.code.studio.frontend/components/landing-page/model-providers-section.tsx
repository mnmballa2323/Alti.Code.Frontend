...
const providers = [
 ...
 brand: "Claude Models",
 glowClass: "/10 /2 ",
 borderHoverClass: "hover:border-zinc-300 dark:hover:border-zinc-300 hover:shadow-lg hover:shadow-orange-500/5",
 models: [
 {
 ...
 brand: "Gemini Models",
 glowClass: "/10 /2 ",
 borderHoverClass: "hover:border-zinc-300 dark:hover:border-zinc-300 hover:shadow-lg hover:shadow-blue-500/5",
 models: [
 {
...
export default function ModelProvidersSection() {
 return (
 <section
 className="relative w-full py-32 bg-zinc-100/40 dark:bg-[#030303] text-black dark:text-black px-4 sm:px-6 lg:px-8 border-y border-zinc-200 dark:border-zinc-900 transition-colors duration-300 overflow-hidden"
 ...
 <h3 className="text-3xl sm:text-3xl md:text-4xl font-bold tracking-tight text-black dark:text-black leading-tight">
 Sovereign AI Restriction
 </h3>
 <p className="text-lg text-gray-500 dark:text-gray-400 leading-relaxed font-normal max-w-5xl">
 ...
 <div
 key={idx}
 className={cn( "group relative flex items-center justify-center p-8 rounded-[24px] border transition-all duration-500 h-28 overflow-hidden", "bg-white/60 dark:bg-zinc-950/40 backdrop-blur-md border-zinc-200 dark:border-zinc-200 shadow-sm",
 provider.borderHoverClass,
 )}
 >
 {/* Glowing decorative gradient behind the provider card */}
 <div
 className={cn( "absolute top-0 right-0 w-32 h-32 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none z-0",
 provider.glowClass,
 )}
 />

 <span className="relative z-10 text-2xl font-bold tracking-tight text-black dark:text-black leading-tight group-hover:scale-105 transition-transform duration-300">
 {provider.name}
 </span>
 </div>
 ))}
 ...
 {/* Legal Disclaimer */}
 <p className="text-[10px] text-zinc-600 dark:text-zinc-500 leading-relaxed font-normal max-w-4xl text-center">
