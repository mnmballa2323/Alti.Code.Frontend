        ...
        <div className="flex-1 flex flex-col gap-10">
          <div className="flex flex-col gap-6">
            ...
            <p className="text-xl text-zinc-400 leading-relaxed max-w-3xl font-medium">
              Forget chatbots and basic auto-regressive models. Inso Code
              provisions a dynamically coordinated network of 25,000 specialized
              AI agents that execute complex tasks in parallel. From database
              design and API connectors to automated security sweeps, each
              subagent collaborates with the swarm to run test suites, resolve
              compile errors, and deliver production-ready code to your repo in
              seconds.
            </p>
          </div>
        </div>
