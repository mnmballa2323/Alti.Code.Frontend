...
export default function AgentForgeSection() {
 ...
 let currentStep = 0;
 const logsList = [ "Initializing Inso Agent Forge Engine...", "Analyzing workspace files: read 12 source files...", "Extracted 4 schemas and 18 route definitions.", "Generating agent prompt with Vertex AI Gemini 3.1 Pro...", "Prompt synthesized. Compiling specialized agent tools...", "Injecting safe file read/write guardrails...", "Running test suite: 18 unit tests created...", "Test 1-18 passed. 100% code coverage achieved.", "Generating unique cryptographic identifier...", "Broadcasting metadata to gossip mesh (active nodes: 50,000)...", "Agent Forge Complete. Agent online.",
 ];
 ...
 <h3 className="text-3xl md:text-4xl font-bold tracking-tight leading-[1.1] text-black lg:whitespace-nowrap">
 ...
 <div className="w-full max-w-[420px] mx-auto lg:ml-0 lg:mr-auto bg-zinc-100  border border-zinc-200 hover:border-zinc-300 hover:bg-zinc-200 hover:-translate-y-1   transition-all duration-300 rounded-[32px] overflow-hidden p-6 flex flex-col gap-5 text-black min-h-[370px] relative group ">
 {/* Card Absolute Glow */}
 ...
 <p
 className={`text-xs font-bold leading-none ${step.status === "running" ? "text-black" : step.status === "success" ? "text-zinc-700" : "text-zinc-500"}`}
 >
 {step.label}
 </p>
 </div>
 ...
 {/* Console Output */}
 <div className="md:col-span-6 flex flex-col bg-black/40 border border-zinc-200 rounded-2xl p-4 font-mono text-[9px] text-zinc-600 select-none overflow-hidden h-[180px] md:h-full relative">
