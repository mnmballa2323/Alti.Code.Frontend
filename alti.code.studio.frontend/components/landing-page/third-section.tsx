...
function ThirdSection() {
 ...
 bulletsTitle: [ "Universal Data Ingestion", " Semantic Code Search", "Architectural Awareness", "Live Repository Sync",
 ],
 bulletDesc: [ "Connect repos, docs, designs, and databases. Your AI sees the full picture of your codebase.", "Find solutions by describing what you need, not just searching keywords and wasting your time.", "Generates code that follows your existing architecture patterns and style guides.", "Stays current with every commit and deployment on your cloud in real-time.",
 ],
 },
 {
 ...
 bulletsTitle: [ "Multi-Step Reasoning", "Full Development Workflow ", "Quality Assurance", "Safe Sandbox Testing",
 ],
 bulletDesc: [ "Breaks down complex features and considers edge cases before coding and deploying.", "Plan, code, test, document, and deploy with end- automation for complete development.", "Built-in code reviews for security, performance, documentation, optimization, and best practice.", " Tests all changes in isolated environments before deploying to cloud and going live.",
 ],
 },
 {
 ...
 bulletsTitle: [ "Debug & Fix Assistant", "Smart Documentation ", "Team Knowledge Capture", "Code Actions",
 ],
 bulletDesc: [ " Analyzes logs, traces issues, and implements fixes across your entire development stack.", " Auto generates and maintains READMEs, API docs, and guides for smart documentation.", "Learns from your code reviews and design decisions to optimize the perfomance.", " Creates meaningful commits, detailed PRs, and deployment notifications automatically.",
 ],
 },
 {
 ...
 bulletsTitle: [ "Select Model", "Tool Integrations", "Enterprise Security", "Governance Controls",
 ],
 bulletDesc: [ "Choose between powerful models for optimal speed and maximum development efficiency.", "Native connections to GitHub, Jira, GCP, Kubernetes, and your entire toolchain.", "SOC 2 compliance, encrypted storage, and on-premises deployment options for enterprise.", "Define standards, approval workflows, and deployment rules with simple configuration.",
 ],
 },
 ];
 ...
 description: "Laying a robust foundation is key to ensuring the stability and growth of any project.",
 },
 {
 ...
 description: "Please choose the official address for your business or residence from the list provided",
 },
 {
 title: "Payment",
