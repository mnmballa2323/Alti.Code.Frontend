...
const SYMBOLS = [ "{ }", "< />", "=>", "()", "⌘", "/*", "*/", "&&", "||", "01", "AI", "API", "[]", ">_", "===", "++", "+=", "${}", "->", "::", "NaN", "404", "git", "npm", "ts", "js", "go", "rs", "py", "{}", "()", "$", "@", "!", "?:", "<T>", "/>", "~/", "IL5", "IL6", "GCP", "SQL", "CSS", "HTML", "C++", "C#", "K8s", "Docker", "Blob", "VM", "Postgres", "Redis", "TCP", "HTTP", "REST", "JSON", "YAML", "SSH", "Linux", "React", "Vue", "Angular", "Swift", "Kotlin", "Java", "PHP", "Ruby", "Dart", "GraphQL", "DevOps", "CI/CD", "0x", "127.0.0.1", "localhost", "sudo", "bash",
];
