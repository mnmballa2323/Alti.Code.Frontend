    ...
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="h-[24vh] lg:h-[20vh] bg-black flex items-center justify-center  px-4">
        <div className="text-center flex flex-col h-full pt-12 lg:pt-12 items-center justify-start">
          <h1 className="font-bold text-[28px] md:text-[36px] lg:text-[42px] font-secondary leading-tight text-white">
            Secure AI IDE for Enterprise Teams
          </h1>
          <p className="font-normal text-center text-lg md:text-xl lg:text-2xl text-white/80 mt-3">
      ...
      <div className="h-[75vh] mt-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <div className="text-center text-white">
            ...
            {/* <Button className="bg-white/20 backdrop-blur-sm text-white hover:bg-white/30 transition-all duration-300">
              Get Started
            </Button> */}
          </div>
        </div>
