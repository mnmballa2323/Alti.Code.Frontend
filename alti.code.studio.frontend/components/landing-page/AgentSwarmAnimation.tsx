...
export default function AgentSwarmAnimation() {
  ...
  const innerNodes = [
    { name: "Code Swarm", icon: Code, angle: 0, color: "from-cyan-500 to-blue-500", glow: "rgba(6,182,212,0.4)" },
    { name: "DB Gateway", icon: Database, angle: 180, color: "from-rose-500 to-pink-500", glow: "rgba(244,63,94,0.4)" },
  ];

  // Floating node items for orbit ring 2 (outer)
  const outerNodes = [
    { name: "Research Agent", icon: Search, angle: 30, color: "from-amber-500 to-orange-500", glow: "rgba(245,158,11,0.4)" },
    { name: "Zero Trust Node", icon: Shield, angle: 150, color: "from-emerald-500 to-teal-500", glow: "rgba(16,185,129,0.4)" },
    { name: "Cloud Hub", icon: Cloud, angle: 270, color: "from-violet-500 to-purple-500", glow: "rgba(139,92,246,0.4)" },
  ];
