...
export default function AgentSwarmAnimation() {
 ...
 return (
 <div className="relative w-full max-w-[450px] aspect-square flex items-center justify-center bg-gray-50/30 dark:bg-zinc-900/30 border border-zinc-200 dark:border-zinc-200 rounded-3xl p-8 shadow-xl overflow-hidden backdrop-blur-md mx-auto">
 ...
 className="absolute w-[250px] h-[250px] /20 /20 rounded-full blur-[60px] pointer-events-none"
 transition={{
 duration: 6,
 repeat: Infinity,
 ease: "easeInOut",
 ...
 className="w-16 h-16 rounded-full flex items-center justify-center text-black border border-zinc-300 relative z-20 cursor-pointer"
 transition={{
 duration: 3,
 repeat: Infinity,
 ease: "easeInOut",
 ...
 <motion.div
 animate={{ rotate: 360 }}
 className="absolute w-[180px] h-[180px] rounded-full border border-dashed border-gray-200 dark:border-zinc-200 flex items-center justify-center pointer-events-none"
 ...
 >
 <div
 className={`w-10 h-10 rounded-full ${node.color} p-[1px] flex items-center justify-center cursor-pointer`}
 style={{ boxShadow: `0 0 15px ${node.glow}` }}
 >
 <div className="w-full h-full rounded-full bg-white dark:bg-zinc-950 flex items-center justify-center text-gray-700 dark:text-zinc-700">
 ...
 <motion.div
 animate={{ rotate: -360 }}
 className="absolute w-[280px] h-[280px] rounded-full border border-dashed border-gray-200 dark:border-zinc-200 flex items-center justify-center pointer-events-none"
