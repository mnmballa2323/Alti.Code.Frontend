...
const plans = [
 ...
 features: [ "Single tenant deployment", "Google Cloud host", "Dedicated infrastructure", "Enhanced security & data isolation",
 ],
...
export default function PricingSection() {
 ...
 <div
 key={idx}
 className="relative flex flex-col justify-between p-6 xl:p-8 rounded-[32px] bg-zinc-100 border border-zinc-200 transition-all duration-300"
 >
 <div className="flex-1 flex flex-col justify-between mb-8">
 <div>
 {/* Plan Name */}
 <div className="mb-6">
 <h3 className="text-lg font-bold text-black tracking-tight text-left whitespace-nowrap">
 {plan.name}
 </h3>
 </div>
