...
function PreFooter() {
 ...
 return (
 <div className="landing-footer w-full bg-black text-white py-6 md:py-8 lg:py-10 relative z-20">
 ...
 © {new Date().getFullYear()} Inso Code, Inc. All rights reserved.
 </p>
 </div>
 </div>
 </div>
 ...
 <Icon
 className="absolute top-3 right-3 dark:text-black text-black cursor-pointer w-5 h-5 hover:scale-110 transition-transform"
 icon="ei:close"
 onClick={() => {
 dispatch(setContactModel(false));
 }}
